...
export const DEFAULT_QUICK_SIM_PROFILES: Record<StageProfile, QuickSimProfileParameters> = {
  Flat:            { baseSpeedKmh: 43, groupThreshold: 3.0, gapFactor: 0.060, gapExponent: 1.3, noiseSigma: 0.15, incidentLossMultiplier: 1.2, severeDnfChance: 0.25, breakawayShrinkExponent: 1.5 },
  Rolling:         { baseSpeedKmh: 42, groupThreshold: 2.2, gapFactor: 0.100, gapExponent: 1.3, noiseSigma: 0.18, incidentLossMultiplier: 1.4, severeDnfChance: 0.25, breakawayShrinkExponent: 1.5 },
  Hilly:           { baseSpeedKmh: 40, groupThreshold: 1.6, gapFactor: 0.180, gapExponent: 1.4, noiseSigma: 0.20, incidentLossMultiplier: 1.7, severeDnfChance: 0.28, breakawayShrinkExponent: 1.5 },
  Hilly_Difficult: { baseSpeedKmh: 38, groupThreshold: 1.2, gapFactor: 0.260, gapExponent: 1.4, noiseSigma: 0.22, incidentLossMultiplier: 2.0, severeDnfChance: 0.30, breakawayShrinkExponent: 1.5 },
  Cobble:          { baseSpeedKmh: 39, groupThreshold: 1.0, gapFactor: 0.300, gapExponent: 1.5, noiseSigma: 0.30, incidentLossMultiplier: 2.4, severeDnfChance: 0.35, breakawayShrinkExponent: 1.4 },
  Cobble_Hill:     { baseSpeedKmh: 39, groupThreshold: 1.0, gapFactor: 0.300, gapExponent: 1.5, noiseSigma: 0.30, incidentLossMultiplier: 2.4, severeDnfChance: 0.35, breakawayShrinkExponent: 1.4 },
  Medium_Mountain: { baseSpeedKmh: 36, groupThreshold: 0.9, gapFactor: 0.340, gapExponent: 1.5, noiseSigma: 0.22, incidentLossMultiplier: 2.2, severeDnfChance: 0.30, breakawayShrinkExponent: 1.6 },
  Mountain:        { baseSpeedKmh: 34, groupThreshold: 0.6, gapFactor: 0.450, gapExponent: 1.6, noiseSigma: 0.24, incidentLossMultiplier: 2.6, severeDnfChance: 0.30, breakawayShrinkExponent: 1.7 },
  High_Mountain:   { baseSpeedKmh: 32, groupThreshold: 0.4, gapFactor: 0.580, gapExponent: 1.7, noiseSigma: 0.26, incidentLossMultiplier: 3.0, severeDnfChance: 0.32, breakawayShrinkExponent: 1.8 },
  ITT:             { baseSpeedKmh: 48, groupThreshold: 0.0, gapFactor: 0.700, gapExponent: 1.0, noiseSigma: 0.10, incidentLossMultiplier: 1.0, severeDnfChance: 0.20, breakawayShrinkExponent: 1.0 },
  TTT:             { baseSpeedKmh: 52, groupThreshold: 0.0, gapFactor: 0.700, gapExponent: 1.0, noiseSigma: 0.08, incidentLossMultiplier: 1.0, severeDnfChance: 0.20, breakawayShrinkExponent: 1.0 },
};
