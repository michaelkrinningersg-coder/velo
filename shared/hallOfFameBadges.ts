...
export function computeRiderBadgeTiers(input: RiderBadgeTierInput): RiderBadgeTier[] {
  ...
  return [
    ...
    // Kontinentale Meister (AO/AM/AF x Elite/U23/Junioren).
    single('contAoChampionRoad', contAoChampionRoadTitles >= 1),
    single('contAoChampionItt', contAoChampionIttTitles >= 1),
    single('contAoU23ChampionRoad', contAoU23ChampionRoadTitles >= 1),
    single('contAoU23ChampionItt', contAoU23ChampionIttTitles >= 1),
    single('contAoJuniorChampionRoad', contAoJuniorChampionRoadTitles >= 1),
    single('contAoJuniorChampionItt', contAoJuniorChampionIttTitles >= 1),
    single('contAmChampionRoad', contAmChampionRoadTitles >= 1),
    single('contAmChampionItt', contAmChampionIttTitles >= 1),
    single('contAmU23ChampionRoad', contAmU23ChampionRoadTitles >= 1),
    single('contAmU23ChampionItt', contAmU23ChampionIttTitles >= 1),
    single('contAmJuniorChampionRoad', contAmJuniorChampionRoadTitles >= 1),
    single('contAmJuniorChampionItt', contAmJuniorChampionIttTitles >= 1),
    single('contAfChampionRoad', contAfChampionRoadTitles >= 1),
    single('contAfChampionItt', contAfChampionIttTitles >= 1),
    single('contAfU23ChampionRoad', contAfU23ChampionRoadTitles >= 1),
    single('contAfU23ChampionItt', contAfU23ChampionIttTitles >= 1),
    single('contAfJuniorChampionRoad', contAfJuniorChampionRoadTitles >= 1),
    single('contAfJuniorChampionItt', contAfJuniorChampionIttTitles >= 1),
