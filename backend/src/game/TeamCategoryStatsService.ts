...
export class TeamCategoryStatsService {
  ...
  private getProfileColumn(profile: string): string | null {
    switch (profile) {
  ...
  public recordStageResult(
    ...
    let colToIncrement = '';
    if (!isStageRace) {
      if (rank === 1) colToIncrement = 'one_day_wins';
      else if (rank === 2) colToIncrement = 'one_day_second';
      else if (rank === 3) colToIncrement = 'one_day_third';
      else if (rank > 3 && rank <= 10) colToIncrement = 'one_day_top_ten';
    } else {
      if (rank === 1) colToIncrement = 'stage_wins';
      else if (rank === 2) colToIncrement = 'stage_second';
      else if (rank === 3) colToIncrement = 'stage_third';
      else if (rank > 3 && rank <= 10) colToIncrement = 'stage_top_ten';
    }
  ...
  public recordGcResult(
    ...
    if (resultTypeId === 2 || resultTypeId === 6) { // Individual GC or Team GC
      if (rank === 1) colToIncrement = 'gc_wins';
      else if (rank === 2) colToIncrement = 'gc_second';
      else if (rank === 3) colToIncrement = 'gc_third';
      else if (rank > 3 && rank <= 10) colToIncrement = 'gc_top_ten';
    } else if (resultTypeId === 3) {
      if (rank === 1) colToIncrement = 'points_wins';
    } else if (resultTypeId === 4) {
      if (rank === 1) colToIncrement = 'mountain_wins';
    } else if (resultTypeId === 5) {
      if (rank === 1) colToIncrement = 'youth_wins';
    } else if (resultTypeId === 7) {
      if (rank === 1) colToIncrement = 'breakaway_wins';
    }

    if (!colToIncrement) return;
