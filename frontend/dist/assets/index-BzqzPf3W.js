(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();function ti(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Nr(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function ct(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function or(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function De(e,t={}){const a=t.strong===!1?"span":"strong",r=Nr("app-rider-link-label",t.labelClassName),s=`<${a} class="${r}">${ti(e)}</${a}>`;if(t.riderId==null)return s;const n=['type="button"','class="'+Nr("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${s}</button>`}function it(e,t,a=!0,r=""){const s=a===!1?"span":"strong",n=`<${s} class="app-team-link-label">${ti(e)}</${s}>`;return t==null?n:`<button type="button" class="${Nr("app-team-link",r)}" data-team-id="${t}">${n}</button>`}function ai(e,t){return t?t instanceof Map?t.get(e)??0:t[e]??0:0}function ri(e){return Math.round(e*10)/10}function si(e,t){const a=e;return(t==null?void 0:t.distanceKm)??a.distanceKm??0}function ni(e,t){const a=e;return(t==null?void 0:t.elevationGainMeters)??a.elevationGainMeters??0}function ii(e,t){return t+(e.formBonus??0)+(e.raceFormBonus??0)}function il(e,t){return e.skills.stamina*(t/300)}function oi(e,t,a){return e.skills.timeTrial+ii(e,t)+e.skills.mountain*(a/500)}function ol(e,t,a,r){const s=il(e,a),n=ii(e,r);switch(t.profile){case"Flat":return .8*e.skills.sprint+.15*e.skills.acceleration+.05*e.skills.flat+n+s;case"Rolling":return .7*e.skills.sprint+.2*e.skills.acceleration+.1*e.skills.hill+n+s;case"Hilly":return .45*e.skills.sprint+.1*e.skills.flat+.45*e.skills.hill+n+s;case"Hilly_Difficult":return .2*e.skills.sprint+.1*e.skills.flat+.7*e.skills.hill+n+s;case"Medium_Mountain":return .05*e.skills.sprint+.1*e.skills.flat+.35*e.skills.hill+.45*e.skills.mediumMountain+.05*e.skills.mountain+n+s;case"Mountain":return .05*e.skills.hill+.2*e.skills.mediumMountain+.75*e.skills.mountain+n+s;case"High_Mountain":return e.skills.mountain+n+s;case"Cobble":return .3*e.skills.sprint+.2*e.skills.flat+.5*e.skills.cobble+n+s;case"Cobble_Hill":return .3*e.skills.sprint+.2*e.skills.flat+.2*e.skills.hill+.3*e.skills.cobble+n+s;default:return .8*e.skills.sprint+.2*e.skills.flat+n+s}}function ll(e,t,a,r,s){return t.profile==="ITT"||t.profile==="TTT"?oi(e,s,r):ol(e,t,a,s)}function dl(e,t){var a;return{rank:t,kind:"rider",effectiveSkill:ri(e.effectiveSkill),teamId:e.rider.activeTeamId??0,teamName:e.teamName,displayName:`${e.rider.firstName} ${e.rider.lastName}`,roleLabel:((a=e.rider.role)==null?void 0:a.name)??"–",riderId:e.rider.id}}function li(e,t,a,r){si(a,r);const s=ni(a,r),n=new Map(t.map(o=>[o.id,o]));if(a.profile==="TTT"){const o=new Map;for(const l of e){if(l.activeTeamId==null)continue;const p=o.get(l.activeTeamId)??[];p.push(l),o.set(l.activeTeamId,p)}return[...o.entries()].map(([l,p])=>{const u=n.get(l),f=p.map(v=>oi(v,ai(v.id,r==null?void 0:r.dailyFormByRiderId),s)).sort((v,T)=>T-v).slice(0,5),g=f.length,b=g>0?f.reduce((v,T)=>v+T,0)/g:0,y=Math.max(0,5-g)*2;return{team:u??{id:l,name:`Team ${l}`,abbreviation:"---",divisionId:0,u23TeamId:null,isPlayerTeam:!1,countryCode:"---",colorPrimary:"#000000",colorSecondary:"#ffffff",aiFocus1:0,aiFocus2:0,aiFocus3:0},score:b-y}}).sort((l,p)=>p.score-l.score||l.team.id-p.team.id).slice(0,20).map((l,p)=>({rank:p+1,kind:"team",effectiveSkill:ri(l.score),teamId:l.team.id,teamName:l.team.name,displayName:l.team.name,roleLabel:"TTT"}))}return(r!=null?Wa(e,t,a,r):Wa(e,t,a)).sort((o,d)=>d.effectiveSkill-o.effectiveSkill||o.rider.id-d.rider.id).slice(0,20).map((o,d)=>dl(o,d+1))}function Wa(e,t,a,r){const s=si(a,r),n=ni(a,r),i=new Map(t.map(o=>[o.id,o]));return e.map(o=>{var d;return{rider:o,teamName:o.activeTeamId!=null?((d=i.get(o.activeTeamId))==null?void 0:d.name)??`Team ${o.activeTeamId}`:"—",effectiveSkill:ll(o,a,s,n,ai(o.id,r==null?void 0:r.dailyFormByRiderId))}}).sort((o,d)=>d.effectiveSkill-o.effectiveSkill||o.rider.id-d.rider.id)}const c={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,draftHistory:null,injuries:null,draftSelectedSeason:null,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1,autoProgressTargetDate:null,raceProgramsPayload:null,raceProgramsActiveTab:"calendar-cols",raceProgramsDirty:!1,raceProgramsSaving:!1};let aa=null;function cl(e){aa=e}let Xr=!1;function Bs(e){Xr=e}let di=null;function Hs(e){di=e}let Lr=null;function Gs(e){Lr=e}let ut=!1;function ci(e){ut=e}function h(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function oe(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function ja(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),r=Math.floor(e%60),s=String(a).padStart(2,"0"),n=String(r).padStart(2,"0");return t>0?`${t}:${s}:${n}`:`${a}:${n}`}function vr(e){return e==null||e===0?"–":`+${ja(e)}`}const Aa=2,Dr=3,ui=4;function mi(e){return`/jersey/Jer_${e}.png`}function Ct(e,t){var r;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((r=c.teams.find(s=>s.id===e))==null?void 0:r.name)??`Team ${e}`;return`
    <span class="results-team-jersey" title="${S(a)}" aria-label="${S(a)}">
      ...
      >
    </span>`}function Xt(e,t){return`<span class="results-jersey-cell">${Ct(e,t)}</span>`}function ot(e){return e&&de(e)||'<span class="results-flag-placeholder" aria-hidden="true"></span>'}function Gt(e){var a;if(e==null)return null;const t=Re(e);return((a=t==null?void 0:t.country)==null?void 0:a.code3)??(t==null?void 0:t.nationality)??null}function Re(e){return e==null?null:c.riders.find(t=>t.id===e)??null}function vt(e){return e==null?null:c.races.find(t=>t.id===e)??null}function Oa(e){var t;if(e==null)return null;for(const a of c.races){const r=(t=a.stages)==null?void 0:t.find(s=>s.id===e);if(r)return{race:a,stage:r}}return null}function Qt(e,t=!0,a=!1,r=null,s=null){const n=De(e,{riderId:r,teamId:s,strong:t,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return`<span class="results-participant${a?" is-breakaway":""}">${n}</span>`}function ul(e){return`<span class="results-status-badge ${e?"results-status-badge-otl":"results-status-badge-dnf"}">${e?"OTL":"DNF"}</span>`}function _r(e,t){return e?e.startsWith("crash:")?`Sturz · ${e.slice(6)}`:e==="mechanical"?"Defekt":e:t?"Außerhalb des Zeitlimits":"Aufgegeben"}function ml(e,t){return e==null||t==null||t===0?'<span class="results-gc-delta results-gc-delta-neutral">●</span>':t>0?`<span class="results-gc-delta results-gc-delta-up"><span class="results-gc-delta-symbol">▲</span><span>${t}</span></span>`:`<span class="results-gc-delta results-gc-delta-down"><span class="results-gc-delta-symbol">▼</span><span>${Math.abs(t)}</span></span>`}function pl(e,t){return e==="sprint_intermediate"?`Sprint · ${t}`:e==="climb_top"||e==="finish_hill"||e==="finish_mountain"?`Bergwertung · ${t}`:t}const Ze={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OMA:"om",OTH:"un"};function de(e){const t=Ze[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}function gl(e,t){return e?`<span class="country-chip">${de(e.code3)}<span>${S(e.name)}</span></span>`:t?S(t):"–"}function Ar(e){return`${e.toFixed(2).replace(".",",")} km`}function Br(e){return`${Math.round(e)} hm`}const fl=new Set;function Qr(e){document.querySelectorAll(".screen").forEach(t=>t.classList.add("hidden")),h(`screen-${e}`).classList.remove("hidden")}function qe(e){h(`modal-${e}`).classList.remove("hidden")}function Ue(e){h(`modal-${e}`).classList.add("hidden")}function zs(e){if(e==null||e<=0)return"—";const t=Math.floor(e/60),a=Math.floor(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function pi(){var l,p;const e=c.realtimeBootstrap;if(!e)return;const t=h("instant-sim-favorites"),a=h("instant-sim-gc");if(!t||!a)return;const s=li(e.riders,e.teams,e.stage,{distanceKm:(l=e.stageSummary)==null?void 0:l.distanceKm,elevationGainMeters:(p=e.stageSummary)==null?void 0:p.elevationGainMeters}).slice(0,10),n=new Map(e.gcStandings.map(u=>[u.riderId,u]));let i=`
    <h3>
      <span>Etappen-Favoriten</span>
      <span style="font-size: 0.75rem; color: #94a3b8; font-weight: normal;">Top 10</span>
    </h3>
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const u of s){const m=e.riders.find(R=>R.id===u.riderId);if(!m)continue;const f=Gt(m.id)??"un",g=Ze[f]??"un",b=e.teams.find(R=>R.id===m.activeTeamId),y=(b==null?void 0:b.abbreviation)??"—",v=n.get(m.id),T=v?`GC ${v.rank} (${v.rank===1?"Gelb":zs(v.gapSeconds)})`:"GC –";i+=`
    ...
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const u of o){const m=e.riders.find(T=>T.id===u.riderId);if(!m)continue;const f=Gt(m.id)??"un",g=Ze[f]??"un",b=e.teams.find(T=>T.id===m.activeTeamId),y=(b==null?void 0:b.abbreviation)??"—",v=u.rank===1?"Gelb":zs(u.gapSeconds);d+=`
      <div class="instant-sim-rider-card">
        <div class="instant-sim-jersey-column">
          <img src="/jersey/Jer_${m.activeTeamId}.png" class="instant-sim-large-jersey" onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';">
        </div>
  ...
  `).join("")}async function kl(e){Me("Karriere wird geladen…");const t=await V.loadSave(e);if($e(),!t.success){alert("Fehler beim Laden: "+t.error);return}c.currentSave=t.data??null,await nl()}async function $l(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;Me("Löschen…");const a=await V.deleteSave(e);if($e(),!a.success){alert("Fehler: "+a.error);return}await pa()}async function xl(){const e=await V.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){h("btn-delete-all-careers").classList.add("hidden"),h("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){Me("Alle Karrieren werden gelöscht…");try{for(const a of t){const r=await V.deleteSave(a.filename);if(!r.success){alert(`Fehler beim Löschen von "${a.careerName}": ${r.error??"Unbekannter Fehler"}`);break}}}finally{$e()}await pa()}}function Tl(){h("btn-new-career").addEventListener("click",async()=>{var s;ca("new-career-error"),h("input-career-name").value="";const a=h("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',qe("newCareer");const r=await V.getAvailableTeams();if(!r.success||!((s=r.data)!=null&&s.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=r.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),h("btn-cancel-new").addEventListener("click",()=>Ue("newCareer")),h("btn-confirm-new").addEventListener("click",async()=>{const a=h("input-career-name").value.trim(),r=h("input-team-id").value;if(!a||!r){Mt("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const s=Number(r),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;ca("new-career-error"),Me("Neue Karriere wird erstellt…");const o=await V.createSave(i,a,s);if(!o.success){$e(),Mt("new-career-error",o.error??"Unbekannter Fehler.");return}const d=await V.loadSave(i);if($e(),Ue("newCareer"),!d.success){alert("Fehler: "+d.error);return}c.currentSave=d.data??null,await nl()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>pa());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{xl()}),h("saves-list").addEventListener("click",async a=>{const r=a.target.closest("button[data-save-action]");if(!r)return;const{saveAction:s,filename:n,careerName:i}=r.dataset;if(n){if(s==="load"){await kl(n);return}s==="delete"&&await $l(n,i??n)}})}const wl="modulepreload",Ml=function(e){return"/"+e},Os={},vi=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(a.map(d=>{if(d=Ml(d),d in Os)return;Os[d]=!0;const l=d.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":wl,l||(u.as="script"),u.crossOrigin="",u.href=d,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((m,f)=>{u.addEventListener("load",m),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return s.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})},Rl={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function Il(e){const t=Rl[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const Cl=200;function ts(e){if(e.length===0)return[];const t=[];for(const a of e){const r=t[t.length-1];if(!r||Math.abs(r.distanceMeter-a.distanceMeter)>=Cl){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}r.riderIds.push(...a.riderIds),r.riderCount+=a.riderCount,r.distanceSum+=a.distanceMeter*a.riderCount,r.distanceMeter=r.distanceSum/r.riderCount}return t.map(({distanceSum:a,...r})=>r)}function as(e){if(e.length===0)return[];let t=0;for(let s=1;s<e.length;s+=1)e[s].riderCount>e[t].riderCount&&(t=s);let a=0,r=0;return e.map((s,n)=>{const i=n===t;let o;return i?o="P":n<t?(a+=1,o=`E${a}`):(r+=1,o=`A${r}`),{...s,label:o,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-s.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,s.distanceMeter-e[n+1].distanceMeter):null}})}function El(e,t=null){var a,r,s;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((r=e.find(n=>n.label==="P"))==null?void 0:r.label)??((s=e[0])==null?void 0:s.label)??null}function St(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function Vs(e,t,a,r){return`${r.type}:${e}:${t}:${a}`}function Fl(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:St(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function tt(e){const t=[];e.segments.forEach((s,n)=>{const i=n*2;(s.start_markers??[]).forEach((o,d)=>{t.push({key:Vs(n,"start",d,o),label:"",marker:o,kmMark:s.start_km,elevation:s.start_elevation,boundary:"start",sequence:i+d/100})}),(s.end_markers??[]).forEach((o,d)=>{t.push({key:Vs(n,"end",d,o),label:"",marker:o,kmMark:s.end_km,elevation:s.end_elevation,boundary:"end",sequence:i+1+d/100})})});const a=t.sort((s,n)=>s.kmMark-n.kmMark||s.sequence-n.sequence),r=new Map;return a.map(s=>{const n=(r.get(s.marker.type)??0)+1;return r.set(s.marker.type,n),{...s,label:s.marker.name??Fl(s.marker,n)}})}function Pl(e){const t=tt(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>St(a)).length}}function Vt(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Nl(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function Ke(e,t,a,r){return t<=0?r:r+e/t*(a-r*2)}function Va(e,t){const a=t/1e3,r=e.points;if(a<=r[0].kmMark)return r[0].elevation;for(let s=0;s<r.length-1;s+=1){const n=r[s],i=r[s+1];if(a>i.kmMark)continue;const o=Math.max(1e-4,i.kmMark-n.kmMark),d=(a-n.kmMark)/o;return n.elevation+(i.elevation-n.elevation)*d}return r[r.length-1].elevation}function Si(e){const t=e.points.map(p=>p.elevation),a=Math.min(...t),r=Math.max(...t),s=Math.max(1,r-a),n=Math.max(40,s*.08),i=Math.max(0,a-n),o=r+n;let d=Math.floor(i/50)*50,l=Math.ceil(o/50)*50;return l<=d&&(l=d+100),{axisMinElevation:d,axisMaxElevation:l}}function Xe(e,t,a,r,s,n){const i=Math.max(1,a-t);return r-n-(e-t)/i*(r-s-n)}function sa(e){return`${Math.round(e)} m`}function Us(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function Ys(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function ki(e,t,a,r,s,n,i,o,d){var g;const l=[],p=[];let u=null,m="#b91c1c";for(const b of tt(e)){const{marker:y,kmMark:v,elevation:T}=b;if(y.type==="climb_start"){p.push({kmMark:v,elevation:T,name:y.name});continue}if(St(y)){let R=-1;for(let I=p.length-1;I>=0;I-=1)if(y.name&&((g=p[I])==null?void 0:g.name)===y.name){R=I;break}const x=R>=0?p.splice(R,1)[0]:p.pop();x&&Math.max(0,v-x.kmMark),x&&Math.max(0,T-x.elevation);const $=Ys(y.cat,y.type),C=Us(y.cat);if(y.type==="finish_hill"||y.type==="finish_mountain"){u=y.cat??null,m=$.accentColor;continue}l.push({x:Ke(v*1e3,t,a,r),anchorY:Xe(T,o,d,s,n,i),primaryLabel:C??"Berg",secondaryLabel:sa(T),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:$.accentColor});continue}if(y.type==="sprint_intermediate"){const R=Ys(y.cat,y.type);l.push({x:Ke(v*1e3,t,a,r),anchorY:Xe(T,o,d,s,n,i),primaryLabel:"Sprint",secondaryLabel:sa(T),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:R.accentColor})}}const f=e.points[e.points.length-1];return l.push({x:Ke(f.kmMark*1e3,t,a,r),anchorY:Xe(f.elevation,o,d,s,n,i),primaryLabel:u?`${Us(u)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:sa(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:m}),l.sort((b,y)=>b.x-y.x)}function $i(e,t,a){const r=t+4,s=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
      ...
      <text x="${e.x.toFixed(1)}" y="${r.toFixed(1)}" text-anchor="end" transform="rotate(-90 ${e.x.toFixed(1)} ${r.toFixed(1)})" class="race-sim-marker-title" fill="${e.accentColor}">${Vt(n)}</text>
      <text x="${e.x.toFixed(1)}" y="${s.toFixed(1)}" text-anchor="start" transform="rotate(-90 ${e.x.toFixed(1)} ${s.toFixed(1)})" class="race-sim-marker-detail">${Vt(e.distanceLabel)}</text>
      ...
      <g class="race-sim-distance-tick">
        ...
        <text x="${d.toFixed(1)}" y="${u.toFixed(1)}" text-anchor="middle" class="race-sim-grid-label">${Vt(Nl(o))}</text>
      </g>`}).join("")}function Ll(e,t,a,r,s,n,i,o,d,l,p){const u=Ke(e.distanceMeter,a,r,n),m=Va(t,e.distanceMeter),f=Xe(m,d,l,s,i,o),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),b=e.riderCount>1?`<text x="${u.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${b}
    </g>`}function Dl(e,t,a,r,s,n,i,o,d,l,p){const u=new Map(p.riders.map(f=>[f.id,f])),m=new Map((p.teams??[]).map(f=>[f.id,f.abbreviation]));return e.filter(f=>f.riderCount===1).map(f=>{const g=f.riderIds[0];if(g==null)return"";const b=u.get(g);if(!b)return"";const y=Ke(f.distanceMeter,a,r,n),v=Va(t,f.distanceMeter),T=Xe(v,d,l,s,i,o),R=b.activeTeamId!=null?m.get(b.activeTeamId)??"":"",x=`${b.lastName} (${R})`,$=T-34,C=T-40;return`
        <g class="race-sim-itt-rider-label-group">
          ...
          <text x="${y.toFixed(1)}" y="${C.toFixed(1)}" text-anchor="middle" class="race-sim-marker-detail">${Vt(x)}</text>
        </g>`}).join("")}function _l(e,t,a,r,s,n,i,o,d,l,p){const u=Math.max(0,Math.min(l,e.distanceKm)),m=Math.max(0,Math.min(p,e.distanceKm));if(m<=u)return null;const f=[{kmMark:u,elevation:Va(e,u*1e3)},...e.points.filter(T=>T.kmMark>u&&T.kmMark<m),{kmMark:m,elevation:Va(e,m*1e3)}];if(f.length<2)return null;const g=s-i,b=f.map((T,R)=>{const x=Ke(T.kmMark*1e3,t,a,r),$=Xe(T.elevation,o,d,s,n,i);return`${R===0?"M":"L"} ${x.toFixed(1)} ${$.toFixed(1)}`}).join(" "),y=Ke(u*1e3,t,a,r),v=Ke(m*1e3,t,a,r);return`${b} L ${v.toFixed(1)} ${g.toFixed(1)} L ${y.toFixed(1)} ${g.toFixed(1)} Z`}function Al(e,t,a,r,s={}){const p=e.distanceKm*1e3,{axisMinElevation:u,axisMaxElevation:m}=Si(e),f=533,g=12,y=e.points.map(I=>{const P=Ke(I.kmMark*1e3,p,1584,28),F=Xe(I.elevation,u,m,634,168,101);return{x:P,y:F}}).map((I,P)=>`${P===0?"M":"L"} ${I.x.toFixed(1)} ${I.y.toFixed(1)}`).join(" "),v=`${y} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,T=s.selectedClimbRange!=null?_l(e,p,1584,28,634,168,101,u,m,s.selectedClimbRange.startKm,s.selectedClimbRange.endKm):null,R=ki(e,p,1584,28,634,168,101,u,m).map(I=>$i(I,g,f)).join(""),$=Array.from({length:5},(I,P)=>u+(m-u)/4*P).map(I=>{const P=Xe(I,u,m,634,168,101);return`
      ...
      <text x="${14 .toFixed(1)}" y="${(P+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${sa(I)}</text>`}).join(""),C=Ti(xi(e,p),e,p,1584,28,f);return`
    <svg viewBox="0 0 1584 634" role="img" aria-label="${Vt(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
      <defs>
    ...
    </svg>`}function Bl(e,t,a,r,s){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${Al(t,a,r,!1,s)}</div>`}function Hl(e,t,a,r,s,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const o=1584,d=634,l=28,p=168,u=101,{axisMinElevation:m,axisMaxElevation:f}=Si(t),g=d-u,b=12,y=Array.from({length:5},(K,w)=>m+(f-m)/4*w),v=ts(a.clusters),T=as(v),R=xi(t,a.stageDistanceMeters),$=t.points.map(K=>{const w=Ke(K.kmMark*1e3,a.stageDistanceMeters,o,l),A=Xe(K.elevation,m,f,d,p,u);return{x:w,y:A}}).map((K,w)=>`${w===0?"M":"L"} ${K.x.toFixed(1)} ${K.y.toFixed(1)}`).join(" "),C=`${$} L ${(o-l).toFixed(1)} ${g.toFixed(1)} L ${l.toFixed(1)} ${g.toFixed(1)} Z`,I=ki(t,a.stageDistanceMeters,o,l,d,p,u,m,f).map(K=>$i(K,b,g)).join(""),P=y.map(K=>{const w=Xe(K,m,f,d,p,u);return`
      ...
      <text x="${(l-14).toFixed(1)}" y="${(w+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${sa(K)}</text>`}).join(""),F=Ti(R,t,a.stageDistanceMeters,o,l,g),L=new Map(v.map((K,w)=>[K,T[w]??null])),H=v.map(K=>{var w;return Ll(K,t,a.stageDistanceMeters,o,d,l,p,u,m,f,((w=L.get(K))==null?void 0:w.label)===i)}).join(""),G=s.stage.profile==="ITT"?Dl(v,t,a.stageDistanceMeters,o,d,l,p,u,m,f,s):"";e.innerHTML=`
    <div class="race-sim-profile-layout${s.stage.profile==="ITT"?" race-sim-profile-layout-itt":""}">
      <div class="race-sim-profile-canvas-wrap">
        <svg viewBox="0 0 ${o} ${d}" role="img" aria-label="${Vt(r)}">
          <defs>
    ...
    <span class="${t}" aria-hidden="true">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function Rc(e){return e.riderId==null||e.riderTeamId==null?"":Hi(e.riderTeamId)}function Ic(e){const t=Ut(e.title);return e.riderId==null?`<strong class="race-sim-message-title">${t}</strong>`:`<button type="button" class="race-sim-message-title race-sim-message-rider-link" data-race-sim-group-rider-id="${e.riderId}">${t}</button>`}function Cc(e,t){return`<button type="button" class="race-sim-message-inline-name race-sim-message-rider-link" data-race-sim-group-rider-name="${Ut(e)}"${t!=null?` data-race-sim-group-rider-team-id="${t}"`:""}>${Ut(e)}</button>`}function Ec(e,t){if(t==="all")return!0;const a=Gi(e);return t==="attack"?a==="attack"||a==="counter_attack":a===t}function Fc(e){const t=e.detail?Ut(e.detail):"",a=(e.secondaryRiders??[]).map(s=>`${s.riderTeamId!=null?Hi(s.riderTeamId,"race-sim-message-inline-jersey"):""}${Cc(s.riderName,s.riderTeamId)}`).join(", ");if(!t&&a.length===0)return"";const r=a.length>0?`${t.length>0?" ":""}Reaktion: ${a}.`:"";return`<span class="race-sim-message-detail"> · ${t}${r}</span>`}function Gi(e){return e.title.includes("stürzt")||e.title.includes("Sturz")?"crash":e.title.includes("Defekt")?"mechanical":e.title.includes("Ausreißer")?"breakaway":e.type}function fn(e,t,a="all"){const r=t.filter(n=>Ec(n,a)),s=t.length===0?"Noch keine Events in dieser Etappe.":"Keine Meldungen in dieser Kategorie.";e.innerHTML=`
    ...
    <div class="race-sim-message-list">
      ${r.length===0?`<div class="race-sim-message-empty">${s}</div>`:r.map(n=>`
        <article class="race-sim-message-item" data-tone="${n.tone}" data-message-kind="${Ut(Gi(n))}">
    ...
    <div class="race-sim-favorites-column">
      ${n.map(i=>`
        <article class="race-sim-favorite-item${(()=>{const o=Oc(i,a);return o?` is-${o}-leader`:""})()}">
          ...
          ${ga(i.teamId,i.teamName)}
          <div class="race-sim-favorite-main">
                    ${fa(i.riderId,i.displayName,"race-sim-favorite-name")}
            <span class="race-sim-favorite-role" title="${Q(i.roleLabel)}">${Q(i.roleLabel)}</span>
            ${(()=>{const o=i.riderId!=null?s.get(i.riderId)??null:null;return o?`<span class="race-sim-favorite-gc">GC ${o.rank} · ${Q(Za(o.gapSeconds))}</span>`:""})()}
          </div>
          <strong class="race-sim-favorite-skill">${Hc(i.effectiveSkill)}</strong>
        </article>
      `).join("")}
    </div>
  `).join("")}</div>`}function ua(e,t){const a=e.riders.find(r=>r.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function dr(e,t){const a=e.riders.find(n=>n.id===t),r=(a==null?void 0:a.activeTeamId)??null,s=r!=null?e.teams.find(n=>n.id===r)??null:null;return{teamId:r,teamName:(s==null?void 0:s.name)??null}}function Yc(e,t,a,r={}){const s=(t??[]).slice(0,r.limit??8);return s.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${s.map(n=>{var u;const i=n.riderId??0,o=dr(e,i),d=ua(e,i),l=((u=r.distanceGapsByRiderId)==null?void 0:u.get(i))??null,p=[r.distanceGapClassName??"",Kc(l)].filter(m=>m.length>0).join(" ");return`
      <article class="race-sim-classification-row">
        <strong class="race-sim-favorite-rank">${n.rank}.</strong>
        ${ga(o.teamId,o.teamName)}
        <span class="race-sim-classification-main">
          ${fa(n.riderId,d,"race-sim-classification-name")}
      ...
      </article>`}).join("")}</div>`}function Ia(e,t,a,r,s,n={}){return`
    <section class="race-sim-classification-box race-sim-classification-box-${t}">
      <h4>${Q(e)}</h4>
      ${Yc(a,r,s,n)}
    </section>`}function Dt(e,t,a,r,s=!0){return`
    <details class="race-sim-overview-details ${a}" data-race-sim-overview-section="${r}" ${s?"open":""}>
      ...
      ${t}
    </details>`}function Ja(e,t,a,r){const s=new Map(t.map(n=>[n.riderId,n]));return e.riders.map(n=>{var d;const i=s.get(n.id)??null,o=((d=a.get(n.id))==null?void 0:d[r])??0;return{riderId:n.id,rank:(i==null?void 0:i.rank)??Number.MAX_SAFE_INTEGER,points:((i==null?void 0:i.points)??0)+o,timeSeconds:(i==null?void 0:i.timeSeconds)??null,gapSeconds:(i==null?void 0:i.gapSeconds)??null,stagePoints:o}}).sort((n,i)=>(i.points??0)-(n.points??0)||n.rank-i.rank||ua(e,n.riderId).localeCompare(ua(e,i.riderId),"de")).map((n,i)=>({...n,rank:i+1}))}function vn(e){const t=Zc(e)?e.stagePoints:0;return`${Q(Gc("points"in e?e.points:null))}${t>0?`<span class="race-sim-classification-stage-gain"><span class="race-sim-classification-stage-gain-arrow">▲</span><span class="race-sim-classification-stage-gain-amount">+${Q(t)}</span></span>`:""}`}function Zc(e){return"stagePoints"in e&&typeof e.stagePoints=="number"}function Sn(e,t){if(t==null)return new Map;const a=e.riders.find(r=>r.riderId===t)??null;return a?new Map(e.riders.map(r=>[r.riderId,a.distanceCoveredMeters-r.distanceCoveredMeters])):new Map}function Jc(e,t){return e.stageSummary.segments.find(a=>t>=a.start_km&&t<=a.end_km)??e.stageSummary.segments.find(a=>a.end_km>=t)??e.stageSummary.segments[e.stageSummary.segments.length-1]??null}function Ba(e,t){var r;const a=(r=e.race.category)==null?void 0:r.bonusSystem;return!a||t==null||t==="Sprint"?[]:bt(t==="HC"?a.pointsMountainHc:t==="1"?a.pointsMountainCat1:t==="2"?a.pointsMountainCat2:t==="3"?a.pointsMountainCat3:a.pointsMountainCat4)}function rs(e){var r;const t=(r=e.race.category)==null?void 0:r.bonusSystem;if(!t||e.stage.profile==="TTT")return[];if(!e.race.isStageRace)return bt(t.pointsOneDay);const a=!["ITT","TTT","Flat","Rolling","Hilly"].includes(e.stage.profile);return bt(a?t.pointsMountainStage:t.pointsSprintFinish)}function Wi(e){var t,a;return e.stage.profile==="ITT"||e.stage.profile==="TTT"?[]:bt((a=(t=e.race.category)==null?void 0:t.bonusSystem)==null?void 0:a.pointsSprintIntermediate)}function qc(e,t,a){let r=null;for(const s of e.stageSummary.segments){const n=Math.max(t,s.start_km),i=Math.min(a,s.end_km),o=Math.max(0,i-n);if(o<=0)continue;const d={lengthKm:o,gradient:s.gradient_percent};(r==null||d.gradient>r.gradient||d.gradient===r.gradient&&d.lengthKm>r.lengthKm)&&(r=d)}return r}function Mr(e,t,a,r=null){return e.entries.filter(s=>r==null||r.has(s.riderId)).map((s,n)=>({riderId:s.riderId,rank:s.rank,points:t[n]??0,pointsKind:a,crossingTimeSeconds:s.crossingTimeSeconds,gapSeconds:s.gapSeconds})).filter(s=>s.points>0)}function ss(e){const t=new Map;for(const a of e)for(const r of a.entries){const s=t.get(r.riderId)??{points:0,mountain:0};r.pointsKind==="mountain"?s.mountain+=r.points:s.points+=r.points,t.set(r.riderId,s)}return t}function Xc(e){return tt(e.stageSummary).filter(({marker:t})=>t.type==="finish_flat"||t.type==="finish_TT"||t.type==="finish_hill"||t.type==="finish_mountain").sort((t,a)=>a.kmMark-t.kmMark)[0]??null}function qa(e,t){const a=zi(e.stage.profile)?t.riderClockSeconds:t.finishTimeSeconds;return a!=null&&Number.isFinite(a)?Lc(a):null}function cr(e,t){const a=t.riders.filter(n=>n.finishStatus!=="dnf").map(n=>{const i=qa(e,n);return i==null?null:{rider:n,stageTimeSeconds:i,photoFinishScore:n.photoFinishScore,riderId:n.riderId}}).filter(n=>n!=null);if(a.length===0)return[];const r=Math.min(...a.map(n=>n.stageTimeSeconds));if(!Number.isFinite(r)||r<=0)return wr(a,e.stage.profile).map(n=>n.rider);const s=_c(e.stage.profile,a.map(n=>n.stageTimeSeconds));return s==null?wr(a,e.stage.profile).map(n=>n.rider):wr(a.filter(n=>n.stageTimeSeconds<=s),e.stage.profile).map(n=>n.rider)}function Qc(e,t){const a=rs(e);return a.length===0?[]:cr(e,t).map((r,s)=>({riderId:r.riderId,rank:s+1,points:a[s]??0,pointsKind:"points",crossingTimeSeconds:qa(e,r),gapSeconds:null})).filter(r=>r.points>0)}function eu(e,t){const a=cr(e,t).slice(0,20),r=a[0]!=null?qa(e,a[0])??0:0;return a.map((s,n)=>{const i=qa(e,s)??0;return{riderId:s.riderId,rank:n+1,crossingTimeSeconds:i,gapSeconds:Math.max(0,i-r),photoFinishScore:s.photoFinishScore}})}function tu(e,t){var a;return((a=cr(e,t)[0])==null?void 0:a.riderId)??null}function ns(e,t,a){var R,x;const r=tt(e.stageSummary),s=e.stageSummary.distanceKm*.75,n=a.isFinished?new Set(cr(e,a).map($=>$.riderId)):null,i=r.filter(({marker:$})=>$.type==="climb_start"),o=r.filter(({marker:$})=>St($)).sort(($,C)=>$.kmMark-C.kmMark).map(($,C)=>{var ne,q;const I=[...i].reverse().find(te=>te.kmMark<=$.kmMark)??null,P=Jc(e,$.kmMark),F=(I==null?void 0:I.kmMark)??(P==null?void 0:P.start_km)??$.kmMark,L=(I==null?void 0:I.elevation)??(P==null?void 0:P.start_elevation)??$.elevation,H=Math.max(0,$.kmMark-F),G=H>0?($.elevation-L)/(H*1e3)*100:(P==null?void 0:P.gradient_percent)??0,K=qc(e,F,$.kmMark),w=t.find(te=>te.markerKey===$.key)??null,A=Ba(e,(w==null?void 0:w.markerCategory)??$.marker.cat??null),U=w?Mr(w,A,"mountain",n):[],W=(w==null?void 0:w.markerCategory)??$.marker.cat??null;return{key:$.key,title:`${C+1}. Bergwertung`,label:$.label,categoryLabel:W?`Kat. ${W}`:null,categoryClassName:yn(W),kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:H,averageGradient:G,steepestSegmentLengthKm:(K==null?void 0:K.lengthKm)??null,steepestSegmentGradient:(K==null?void 0:K.gradient)??null,highlightMeta:$.kmMark>=s,leaderRiderId:((ne=U[0])==null?void 0:ne.riderId)??((q=w==null?void 0:w.entries[0])==null?void 0:q.riderId)??null,displayBadges:Ra(A,"mountain"),entries:U,timingEntries:(w==null?void 0:w.entries)??[],accent:"mountain"}}),d=r.filter(({marker:$})=>$.type==="sprint_intermediate").sort(($,C)=>$.kmMark-C.kmMark).map(($,C)=>{var L,H;const I=t.find(G=>G.markerKey===$.key)??null,P=Wi(e),F=I?Mr(I,P,"points",n):[];return{key:$.key,title:`${C+1}. Zwischensprint`,label:$.label,categoryLabel:null,categoryClassName:null,kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!1,leaderRiderId:((L=F[0])==null?void 0:L.riderId)??((H=I==null?void 0:I.entries[0])==null?void 0:H.riderId)??null,displayBadges:Ra(P,"points"),entries:F,timingEntries:(I==null?void 0:I.entries)??[],accent:"sprint"}}),l=Xc(e),p=Qc(e,a),u=l?t.find($=>$.markerKey===l.key)??null:null,m=u?Mr(u,Ba(e,u.markerCategory),"mountain",n):[],f=rs(e),g=u?Ba(e,u.markerCategory):[],b=e.stage.profile==="ITT"||e.stage.profile==="TTT"?eu(e,a):(u==null?void 0:u.entries)??[],y=((R=p[0])==null?void 0:R.riderId)??((x=m[0])==null?void 0:x.riderId)??tu(e,a),v={key:"finish",title:"Zielsprint",label:(l==null?void 0:l.label)??"Ziel",categoryLabel:u!=null&&u.markerCategory?`Kat. ${u.markerCategory}`:null,categoryClassName:yn((u==null?void 0:u.markerCategory)??null),kmMark:(l==null?void 0:l.kmMark)??e.stageSummary.distanceKm,kmToFinish:0,climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!!(u!=null&&u.markerCategory),leaderRiderId:y,displayBadges:[...Ra(f,"points"),...Ra(g,"mountain")],entries:[...p,...m],timingEntries:b,accent:"finish"};return[...[...d,...o].sort(($,C)=>$.kmMark-C.kmMark||$.title.localeCompare(C.title,"de")),v].filter($=>$.entries.length>0||$.timingEntries.length>0||$.accent!=="finish"||l!=null||a.isFinished)}function au(e,t){const a=new Map(t.entries.map(n=>[n.riderId,n])),r=(e.stage.profile==="ITT"||e.stage.profile==="TTT")&&t.key==="finish"?20:15,s=t.timingEntries.length>0?[...t.timingEntries].sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId).slice(0,r):t.entries.slice(0,r).map(n=>({riderId:n.riderId,rank:n.rank,crossingTimeSeconds:n.crossingTimeSeconds??0,gapSeconds:n.gapSeconds??0,photoFinishScore:0,pointsAwarded:n.points})).sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId);return s.length===0?'<div class="race-sim-stage-points-popover-empty">Noch keine Punkte vergeben.</div>':`
    <div class="race-sim-stage-points-popover-list">
      ${s.map(n=>{const i=dr(e,n.riderId),o=a.get(n.riderId)??null;return`
          <div class="race-sim-stage-points-popover-row">
            <strong>${n.rank}.</strong>
            ${ga(i.teamId,i.teamName)}
            ${fa(n.riderId,ua(e,n.riderId),"race-sim-stage-scoring-name")}
    ...
    </div>`}function kn(e,t){var a;return((a=e==null?void 0:e.find(r=>r.riderId===t))==null?void 0:a.points)??0}function $n(e,t){var a;return((a=e.filter(r=>r.riderId!=null&&t.has(r.riderId)).sort((r,s)=>r.rank-s.rank||r.riderId-s.riderId)[0])==null?void 0:a.riderId)??null}function Ca(e,t,a){if(!(!t||e.some(r=>r.riderId===t.riderId))){if(e.length<25){e.push(t);return}e[a]=t}}function ru(e,t,a,r,s){const n=new Set(e.riderIds),i=new Map(t.riders.map(f=>[f.riderId,f])),d=e.riderIds.map(f=>i.get(f)??null).filter(f=>f!=null).sort((f,g)=>{var b,y;return(((b=a.get(f.riderId))==null?void 0:b.rank)??Number.MAX_SAFE_INTEGER)-(((y=a.get(g.riderId))==null?void 0:y.rank)??Number.MAX_SAFE_INTEGER)||f.riderName.localeCompare(g.riderName,"de")||f.riderId-g.riderId}).slice(0,25),l=i.get($n(r,n)??-1)??null,p=i.get($n(s,n)??-1)??null,u=l!=null&&!d.some(f=>f.riderId===l.riderId),m=p!=null&&!d.some(f=>f.riderId===p.riderId);return d.length>=25&&u&&m&&l.riderId!==p.riderId?(Ca(d,l,23),Ca(d,p,24),d):(Ca(d,l,24),Ca(d,p,24),d)}function su(e,t){const a=[];return t.gcLeaderRiderId===e&&a.push("gc"),t.mountainLeaderRiderId===e&&a.push("mountain"),t.pointsLeaderRiderId===e&&a.push("points"),t.youthLeaderRiderId===e&&a.push("youth"),a}function nu(e){return e.includes("gc")?" is-gc-leader":e.includes("mountain")?" is-mountain-leader":e.includes("points")?" is-points-leader":e.includes("youth")?" is-youth-leader":""}function xn(e,t){return e==null?"—":`${t}${Math.round(e)} m`}function iu(e,t){const a=t.riders.filter(s=>e.riderIds.includes(s.riderId)).reduce((s,n)=>Math.max(s,n.distanceCoveredMeters),0),r=Math.max(0,t.leaderDistanceMeters-a);return r>0?`-${Math.round(r)} m`:"—"}function ou(e,t,a,r,s,n,i){if(a.length===0||e.stage.profile==="ITT"||e.stage.profile==="TTT")return"";const o=El(a,r),d=a.find(m=>m.label===o)??a[0],l=new Map(e.gcStandings.map(m=>[m.riderId,m])),p=ss(i),u=ru(d,t,l,s,n);return`
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-grid">
        ${u.map((m,f)=>{const g=l.get(m.riderId)??null,b=dr(e,m.riderId),y=p.get(m.riderId)??{points:0,mountain:0},v=kn(s,m.riderId),T=kn(n,m.riderId),R=su(m.riderId,e.classificationLeaders),x=R.length>0?R.map($=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[$]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${nu(R)}" title="${Q(x)}">${f+1}.</strong>
              ${ga(b.teamId,b.teamName)}
              <span class="race-sim-classification-main">
                ${fa(m.riderId,m.riderName,`race-sim-group-rider-name${m.isBreakaway?" is-breakaway":""}`)}
                <strong class="race-sim-group-detail">GC ${g?g.rank:"—"} · ${Q(g?Za(g.gapSeconds):"—")} · ${Q(m.gapToLeaderMeters>0?`+${Math.round(m.gapToLeaderMeters)} m`:"—")}</strong>
              </span>
    ...
    </section>`}function lu(e,t,a,r){const s=ns(t,a.markerClassifications,a),n=ss(s),i=Ja(t,t.pointsStandings,n,"points"),o=Ja(t,t.mountainStandings,n,"mountain"),d=as(ts(a.clusters));e.innerHTML=ou(t,a,d,r,i,o,s)}function du(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function cu(e){const t=tt(e.stageSummary),a=Wi(e)[0]??0,r=rs(e)[0]??0,s=t.filter(({marker:n})=>St(n)).reduce((n,{marker:i})=>n+(Ba(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+r,mountain:s}}function Tn(e){const t=cu(e);return`
    ...
    </span>`}function mu(e,t,a,r=null){const s=r??ns(e,t,a);return s.length===0?`
    ...
    <section class="race-sim-mountain-primes-box">
      ...
      <div class="race-sim-mountain-primes-list">
        ${s.map(n=>{const i=n.leaderRiderId!=null?dr(e,n.leaderRiderId):{teamId:null,teamName:null},o=n.leaderRiderId!=null?ua(e,n.leaderRiderId):"Noch offen";return`
          <details class="race-sim-mountain-prime-row race-sim-stage-points-event race-sim-stage-points-event-${n.accent}">
            ...
            <span class="race-sim-stage-points-leader">
              ${ga(i.teamId,i.teamName)}
              ${n.leaderRiderId!=null?fa(n.leaderRiderId,o,"race-sim-stage-scoring-leader-name"):`<strong>${Q(o)}</strong>`}
            </span>
            </summary>
    ...
    </section>`}function pu(e,t,a,r,s,n=new Set){var f,g;const i=ns(a,r,s),o=ss(i),d=Ja(a,a.pointsStandings,o,"points"),l=Ja(a,a.mountainStandings,o,"mountain"),p=Sn(s,((f=a.gcStandings[0])==null?void 0:f.riderId)??null),u=Sn(s,((g=a.youthStandings[0])==null?void 0:g.riderId)??null),m=b=>!n.has(b);e.innerHTML=`
    ${Dt("Stage Favorites",Uc(t,a.gcStandings,a.classificationLeaders),"race-sim-favorites-section","favorites",m("favorites"))}
    <section class="race-sim-classifications-section">
      ${Dt("GC",Ia("GC","gc",a,a.gcStandings,b=>Q(`GC ${b.rank} · ${Za(b.gapSeconds)}`),{limit:20,distanceGapsByRiderId:p}),"race-sim-overview-classification race-sim-overview-gc","gc",m("gc"))}
      ${Dt("Punktewertung",Ia("Punktewertung","points",a,d,vn),"race-sim-overview-classification race-sim-overview-points","points",m("points"))}
      ${Dt("Bergwertung",Ia("Bergwertung","mountain",a,l,vn),"race-sim-overview-classification race-sim-overview-mountain","mountain",m("mountain"))}
      ${Dt("Nachwuchsfahrerwertung",Ia("Nachwuchsfahrerwertung","youth",a,a.youthStandings,b=>Q(`${b.rank}. · ${Za(b.gapSeconds)}`),{distanceGapsByRiderId:u,distanceGapClassName:"is-compact"}),"race-sim-overview-classification race-sim-overview-youth","youth",m("youth"))}
    </section>
    ${Dt("Etappenwertungen",mu(a,r,s,i),"race-sim-overview-stage-scoring","stageScoring",m("stageScoring"))}
  `}const wn=new WeakMap,Qe=new WeakMap,Mn=new WeakMap,ji=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function X(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Oi(e){return e<=0?"—":`+${Math.round(e)} m`}function ia(e){const t=ji.format(e);return e>0?`+${t}`:t}function Rr(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function ce(e){return ji.format(e)}function Ft(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),r=Math.floor(t%3600/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Vi(e){return`+${Ft(e)}`}function Ui(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function is(e){return`${(e*3.6).toFixed(1)} km/h`}function gu(e){return`${ia(e)}%`}function zr(e){return`${e.toFixed(1).replace(".",",")} km`}function Yi(e){return`${zr(e.segmentStartKm)} - ${zr(e.segmentEndKm)}`}function fu(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function Zi(e){return e.replace(/_/g," ")}function Ji(e){return Zi(e)}function hu(e){return Zi(e)}function qi(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function bu(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function yu(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function Xi(e){return tt(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||St(t)).map(({key:t,label:a})=>({key:t,label:a}))}function vu(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function Su(e,t,a,r){var s;return a!=="ITT"&&a!=="TTT"?((s=r.get(t))==null?void 0:s.get(e.riderId))??null:e.splitTimes[t]??null}function Qi(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(s=>({label:s.key,displayLabel:s.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${s.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function ku(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function $u(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function eo(e){const t=wn.get(e);if(t)return t;const a=Xi(e),r={splitMarkers:a,columns:Qi(e,a,!1),riderById:new Map(e.riders.map(s=>[s.id,s])),teamById:new Map((e.teams??[]).map(s=>[s.id,s])),teamAbbreviationById:new Map((e.teams??[]).map(s=>[s.id,s.abbreviation])),teamNameById:new Map((e.teams??[]).map(s=>[s.id,s.name])),gcByRiderId:new Map((e.gcStandings??[]).map(s=>[s.riderId,s]))};return wn.set(e,r),r}function to(e,t){const a=e.parentElement,r=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!r)return"";const s=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const l=document.createElement("div");return l.className="race-sim-leaderboard-toolbar",r.insertAdjacentElement("beforebegin",l),l})(),n=os(e),i=ku(t),o=$u(i,n),d=Qe.get(e);return(d==null?void 0:d.layoutKey)===o||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(l=>l.width).join(" ")),s.innerHTML=`
    <button
      type="button"
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,r.innerHTML=t.map(l=>xu(l,n)).join(""),Qe.set(e,{layoutKey:o,orderedRiderIds:(d==null?void 0:d.orderedRiderIds)??[],rowsByRiderId:(d==null?void 0:d.rowsByRiderId)??new Map,openDetailRiderId:(d==null?void 0:d.openDetailRiderId)??null,openTeamId:(d==null?void 0:d.openTeamId)??null})),o}function rt(e,t){e.textContent!==t&&(e.textContent=t)}function Ea(e,t){e.title!==t&&(e.title=t)}function Fa(e,t){e.className!==t&&(e.className=t)}function Pa(e,t,a){return e.lastValues[t]!==a}function Na(e,t,a){e.lastValues[t]=a}function os(e){const t=Mn.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return Mn.set(e,a),a}function xu(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${X(e.label)}">${X(a)}</span>`;const r=!t.autoSort&&t.manualSortKey===e.sortKey,s=r?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
...
`)}function Fu(e){return ia(Math.max(-2.5,Math.min(2.5,e*2.5)))}function Pu(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function so(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${X(e.riderName)}">${X(e.riderName)}</button>`}function Nu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId)??"—",s=a.get(e.activeTeamId)??r;return`<span class="race-sim-team-code" title="${X(s)}">${X(r)}</span>`}function no(e){return`/jersey/Jer_${e}.png`}function Lu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId);if(!r)return"—";const s=a.get(e.activeTeamId)??r.name,n=no(e.activeTeamId);return`
    <span class="race-sim-team-visual" title="${X(s)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function Du(e){return e.hasSuperform?'<span class="race-sim-special-form-dot race-sim-special-form-dot-good" title="Superform"></span>':e.hasSupermalus?'<span class="race-sim-special-form-dot race-sim-special-form-dot-bad" title="Supermalus"></span>':""}function _u(e,t,a,r){var n;if(a!=="ITT"&&a!=="TTT"){const i=(n=r.get(t))==null?void 0:n.get(e.riderId);return i!=null?`${i}.`:"—"}const s=e.splitTimes[t];return s!=null?Ft(s):"—"}function io(e,t,a){const r=ro(e,t),s=[{label:"Terrain / Skill",value:`${Ji(e.activeTerrain)} / ${hu(e.skillName)}`},{label:"Aktiver Abschnitt",value:Yi(e)},{label:"Segmenthöhe",value:fu(e)},{label:"Basis",value:ce(e.baseSkill)},{label:"Team+",value:e.teamGroupBonus>0?`+${ce(e.teamGroupBonus)}`:"—"},{label:"S-Form",value:ia((t==null?void 0:t.formBonus)??0)},{label:"R-Form",value:ia((t==null?void 0:t.raceFormBonus)??0)},{label:"Fatigue",value:Rr((t==null?void 0:t.fatigueMalus)??0)},{label:"Langzeit",value:Rr((t==null?void 0:t.longTermFatigueMalus)??0)},{label:"Akut",value:Rr((t==null?void 0:t.shortTermFatigueMalus)??0)},{label:"Stamina",value:ce(e.staminaPenalty)},{label:"HM",value:ce(e.elevationPenalty)},{label:"T-Form",value:ia(e.dailyForm)},{label:"Zufall",value:Fu(e.microForm)},{label:"M_grad",value:`x${e.gradientModifier.toFixed(2).replace(".",",")}`},{label:"M_wind",value:`x${e.windModifier.toFixed(2).replace(".",",")}`},{label:"Draft",value:`x${e.draftModifier.toFixed(2).replace(".",",")}`},{label:"Draft Pack",value:Pu(e)},{label:"GC",value:a?String(a.rank):"—"},{label:"GC Gap",value:a?Ui(a.gapSeconds):"—"}];return`
    ...
    </section>`}function Au(e,t,a,r,s,n,i){const o=document.createElement("article");o.dataset.raceSimRiderRow=String(e.riderId);const d=document.createElement("div");d.className="race-sim-row-grid",o.appendChild(d);const l=document.createElement("strong");l.className="race-sim-row-rank",l.textContent="0.",d.appendChild(l);const p=document.createElement("span");p.className="race-sim-row-flag",p.innerHTML=t?Il(yu(t)):"—",d.appendChild(p);const u=document.createElement("span");u.className="race-sim-row-name",u.innerHTML=so(e,a),d.appendChild(u);const m=u.querySelector(".race-sim-row-name-btn");if(!m)throw new Error("race-sim-row-name-btn not found");const f=document.createElement("span");f.className="race-sim-row-team-visual",f.innerHTML=Lu(t,s,i),d.appendChild(f);const g=document.createElement("strong");g.className="race-sim-row-team",g.innerHTML=Nu(t,n,i),d.appendChild(g);const b=(L="")=>{const H=document.createElement("strong");return L&&(H.className=L),d.appendChild(H),H},y=b("race-sim-gap"),v=b("race-sim-cell-effective-skill"),T=b(),R=b(),x=b(),$=r.map(()=>b()),C=b(),I=b(),P=b("race-sim-form-state-cell"),F=document.createElement("div");return F.className="race-sim-row-detail-popover hidden",o.appendChild(F),{row:o,rankField:l,nameButton:m,gapField:y,clockField:x,splitFields:$,effectiveSkillField:v,gcRankField:T,gcGapField:R,gradientPercentField:C,speedField:I,formStateField:P,detailPanel:F,initialized:!1,lastValues:{}}}function Bu(e,t,a,r,s,n,i,o,d,l,p){const u=(r==null?void 0:r.formBonus)??0,m=(r==null?void 0:r.raceFormBonus)??0,f=d&&l>1?p.get(a.riderId)??null:null,g=Pe(a),b=i!=="ITT"&&i!=="TTT"?g?"DNF":"—":a.hasStarted?g?"DNF":a.riderClockSeconds!=null?Ft(a.riderClockSeconds):"—":Vi(a.startOffsetSeconds);Fa(e.row,`race-sim-row${t===1&&!g?" race-sim-row-leader":""}${s?" race-sim-row-detail-open":""}${g?" race-sim-row-dnf":""}`),rt(e.rankField,`${t}.`),rt(e.gapField,g?"DNF":Oi(a.gapToLeaderMeters)),rt(e.clockField,b),e.nameButton.setAttribute("aria-expanded",s?"true":"false"),Fa(e.nameButton,`race-sim-row-name-btn${a.isAttacking?" is-attacking":""}${a.isBreakaway?" is-breakaway":""}`),Ea(e.nameButton,a.isBreakaway?`${a.riderName} (Ausreißer)`:a.isAttacking?`${a.riderName} (Attacke aktiv)`:a.riderName),n.forEach((R,x)=>{const $=e.splitFields[x];if(!$)return;const C=_u(a,R.key,i,o);rt($,C),Ea($,R.label)}),Pa(e,"effectiveSkillValue",a.effectiveSkill)&&(rt(e.effectiveSkillField,ce(a.effectiveSkill)),Na(e,"effectiveSkillValue",a.effectiveSkill));const y=`race-sim-cell-effective-skill ${qi(a)}`;Pa(e,"effectiveSkillClass",y)&&(Fa(e.effectiveSkillField,y),Na(e,"effectiveSkillClass",y));const v=[a.baseSkill,a.effectiveSkill,a.teamGroupBonus,u,m,a.dailyForm,a.microForm,(r==null?void 0:r.fatigueMalus)??0,(r==null?void 0:r.longTermFatigueMalus)??0,(r==null?void 0:r.shortTermFatigueMalus)??0,a.staminaPenalty].join("|");Pa(e,"effectiveSkillTitleKey",v)&&(Ea(e.effectiveSkillField,Eu(a,r)),Na(e,"effectiveSkillTitleKey",v)),rt(e.gcRankField,f?String(f.rank):"—"),rt(e.gcGapField,f?Ui(f.gapSeconds):"—"),rt(e.gradientPercentField,gu(a.gradientPercent)),Fa(e.gradientPercentField,bu(a.gradientPercent)),Ea(e.gradientPercentField,`${Ji(a.activeTerrain)} · ${Yi(a)}`),rt(e.speedField,is(a.currentSpeedMps)),e.formStateField.innerHTML=Du(a);const T=[s?"open":"closed",a.activeTerrain,a.segmentStartKm,a.segmentEndKm,a.segmentStartElevation,a.segmentEndElevation,a.skillName,a.baseSkill,a.teamGroupBonus,u,m,(r==null?void 0:r.fatigueMalus)??0,a.staminaPenalty,a.elevationPenalty,a.dailyForm,a.microForm,a.gradientModifier,a.windModifier,a.draftModifier,a.draftNearbyRiderCount,a.draftPackFactor,(f==null?void 0:f.rank)??"—",(f==null?void 0:f.gapSeconds)??"—",a.skillBreakdown].join("|");Pa(e,"detailKey",T)&&(e.detailPanel.innerHTML=s?io(a,r,f):"",e.detailPanel.classList.toggle("hidden",!s),Na(e,"detailKey",T)),e.detailPanel.classList.toggle("hidden",!s),e.initialized=!0}function Hu(e,t){return`<button type="button" class="race-sim-row-name-btn" data-race-sim-ttt-team-toggle="${e.id}" aria-expanded="${t?"true":"false"}" title="${X(e.name)}">${X(e.name)}</button>`}function Gu(e){const t=no(e.id);return`
    ...
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${X(e.team.name)}">
      ...
      <div class="race-sim-rider-detail-grid">
        ...
        <div class="race-sim-rider-detail-item"><span>Speed</span><strong>${X(is(e.teamSpeedMps))}</strong></div>
        <div class="race-sim-rider-detail-item"><span>Teamuhr</span><strong>${X(e.teamClockSeconds!=null?Ft(e.teamClockSeconds):"—")}</strong></div>
        <div class="race-sim-rider-detail-item"><span>Distanz</span><strong>${X(zr(e.teamDistanceMeters/1e3))}</strong></div>
      </div>
        ...
        ${e.riders.map(n=>{const i=t.riderById.get(n.riderId)??null,o=a&&r>1?t.gcByRiderId.get(n.riderId)??null:null,d=s===n.riderId;return`
            <article class="race-sim-ttt-team-rider">
              <div class="race-sim-ttt-team-rider-head">
                ...
                <span>${X(n.riderClockSeconds!=null?Ft(n.riderClockSeconds):"—")}</span>
              </div>
              ${d?io(n,i,o):""}
            </article>`}).join("")}
      </div>
      ...
      <article class="race-sim-row${y===0?" race-sim-row-leader":""}${v?" race-sim-row-detail-open":""}">
        <div class="race-sim-row-grid">
          ...
          <span class="race-sim-row-name">${Hu(b.team,v)}</span>
          ...
          <strong>${X(b.teamClockSeconds!=null?Ft(b.teamClockSeconds):Vi(b.representative.startOffsetSeconds))}</strong>
          ${n.map(T=>`<strong>${X(b.splitTimes[T.key]!=null?Ft(b.splitTimes[T.key]):"—")}</strong>`).join("")}
          <strong class="race-sim-cell-effective-skill ${qi(b.representative)}">${X(ce(b.teamEffectiveSkill))}</strong>
          <strong>${X(is(b.teamSpeedMps))}</strong>
        </div>
        <div class="race-sim-row-detail-popover${v?"":" hidden"}">${v?Ku(b,s,a.race.isStageRace,a.stage.stageNumber,l.openDetailRiderId):""}</div>
      </article>`}).join(""),Qe.set(e,{layoutKey:d,orderedRiderIds:[],rowsByRiderId:new Map,openDetailRiderId:l.openDetailRiderId,openTeamId:l.openTeamId}),{totalMs:performance.now()-r,prepMs:0,sortMs:0,layoutMs:0,createRowsMs:0,removeRowsMs:0,orderCheckMs:0,reorderMs:0,visibilityMs:0,updateRowsMs:0,finalizeMs:0,rowsTotal:p.length,rowsCreated:p.length,rowsRemoved:0,rowsUpdated:p.length,rowsSkippedInvisible:0,orderChanged:1}}function En(e,t,a){if(a.stage.profile==="TTT")return Wu(e,t,a);const r=performance.now(),s={totalMs:0,prepMs:0,sortMs:0,layoutMs:0,createRowsMs:0,removeRowsMs:0,orderCheckMs:0,reorderMs:0,visibilityMs:0,updateRowsMs:0,finalizeMs:0,rowsTotal:t.riders.length,rowsCreated:0,rowsRemoved:0,rowsUpdated:0,rowsSkippedInvisible:0,orderChanged:0},n=performance.now(),i=eo(a),{splitMarkers:o}=i,d=vu(t),l=os(e),p=l.showSplitColumns?o:[],u=Qe.get(e);s.prepMs=performance.now()-n;const m=performance.now(),f=Ru(t.riders,a,o,d,l,i.riderById,i.gcByRiderId,i.teamAbbreviationById,(u==null?void 0:u.orderedRiderIds)??[]);s.sortMs=performance.now()-m;const g=u==null?void 0:u.layoutKey,b=performance.now(),y=to(e,Qi(a,p,l.showSplitColumns));s.layoutMs=performance.now()-b;const v=Qe.get(e)??{orderedRiderIds:[],rowsByRiderId:new Map,openDetailRiderId:null,openTeamId:null};g!=null&&g!==y&&(e.innerHTML="",v.rowsByRiderId.clear(),v.orderedRiderIds=[]);const T=f.map(F=>F.riderId),R=new Set(T),x=performance.now();for(const[F,L]of v.rowsByRiderId)R.has(F)||(L.row.remove(),v.rowsByRiderId.delete(F),s.rowsRemoved+=1);s.removeRowsMs=performance.now()-x;const $=performance.now();for(let F=0;F<f.length;F+=1){const L=f[F],H=i.riderById.get(L.riderId)??null;let G=v.rowsByRiderId.get(L.riderId);G||(G=Au(L,H,v.openDetailRiderId===L.riderId,p,i.teamById,i.teamAbbreviationById,i.teamNameById),v.rowsByRiderId.set(L.riderId,G),s.rowsCreated+=1)}s.createRowsMs=performance.now()-$;const C=performance.now(),I=v.orderedRiderIds.length===T.length&&v.orderedRiderIds.every((F,L)=>F===T[L]);s.orderCheckMs=performance.now()-C;const P=performance.now();if(!I){const F=document.createDocumentFragment();for(const L of T){const H=v.rowsByRiderId.get(L);H&&F.appendChild(H.row)}e.replaceChildren(F),s.orderChanged=1}s.reorderMs=performance.now()-P;for(let F=0;F<f.length;F+=1){const L=f[F],H=v.rowsByRiderId.get(L.riderId),G=i.riderById.get(L.riderId)??null;if(!H)continue;const K=performance.now();Bu(H,F+1,L,G,v.openDetailRiderId===L.riderId,p,a.stage.profile,d,a.race.isStageRace,a.stage.stageNumber,i.gcByRiderId),s.updateRowsMs+=performance.now()-K,s.rowsUpdated+=1}return Qe.set(e,{layoutKey:y,orderedRiderIds:T,rowsByRiderId:v.rowsByRiderId,openDetailRiderId:v.openDetailRiderId,openTeamId:v.openTeamId}),s.finalizeMs=performance.now()-(r+s.prepMs+s.sortMs+s.layoutMs+s.removeRowsMs+s.createRowsMs+s.orderCheckMs+s.reorderMs+s.visibilityMs+s.updateRowsMs),s.totalMs=performance.now()-r,s.finalizeMs=Math.max(0,s.totalMs-s.prepMs-s.sortMs-s.layoutMs-s.removeRowsMs-s.createRowsMs-s.orderCheckMs-s.reorderMs-s.visibilityMs-s.updateRowsMs),s}const ju=["Flat","Rolling","Hilly","Hilly_Difficult","Medium_Mountain","Mountain","High_Mountain","ITT","TTT","Cobble","Cobble_Hill"],Ou=["Flat","Hill","Medium_Mountain","Mountain","High_Mountain","Cobble","Cobble_Hill","Abfahrt","Sprint"],oo=["start","climb_start","climb_top","sprint_intermediate","finish_flat","finish_TT","finish_hill","finish_mountain"],lo=["Sprint","4","3","2","1","HC"],Xa=.2,Vu=7,Uu=100,Yu=3,Zu=50,Ju=-2,qu=1,Xu=2.5,Qu=-3,em=15,tm=200,am=600,rm=850;function Ae(e){return["finish_flat","finish_TT","finish_hill","finish_mountain"].includes(e)}function Qa(e){return e==="finish_hill"||e==="finish_mountain"}function er(e){return e!=null&&["HC","1","2","3","4"].includes(e)}function ls(e,t){return e==="climb_top"||Qa(e)&&er(t)}function ha(e){return Math.round(e*10)/10}function We(e){return Number(e.toFixed(2))}function wt(e){return`${e.toFixed(2).replace(".",",")} km`}function co(e){return`${Math.round(e)} hm`}function sm(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,60)||"stage_details"}function ds(e){return ju.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`).join("")}function nm(e){return Ou.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`).join("")}function im(e,t="start",a=0,r=1){const s=oo.filter(i=>t==="start"?i==="start"?a===0:i==="climb_start":i==="start"||i==="climb_start"?!1:Ae(i)?a===r-1:i==="climb_top"||i==="sprint_intermediate");return(s.includes(e)?s:[e,...s.filter(i=>i!==e)]).map(i=>`<option value="${i}"${i===e?" selected":""}>${S(i)}</option>`).join("")}function om(e){return['<option value="">–</option>',...lo.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`)].join("")}function Fn(e){return oo.indexOf(e)}function je(e){return[...e].sort((t,a)=>Fn(t.type)-Fn(a.type))}function ma(e){if(e.length===0)return[];const t=[{kmMark:0,elevation:e[0].startElevation,terrain:e[0].terrain,techLevel:e[0].techLevel,windExp:e[0].windExp,markers:je(e[0].markers)}];let a=0;return e.forEach(r=>{a=We(a+r.lengthKm);const s=Math.round(r.startElevation+r.lengthKm*1e3*(r.gradientPercent/100)),n=t[t.length-1];n.terrain=r.terrain,n.techLevel=r.techLevel,n.windExp=r.windExp,n.markers=je([...n.markers,...r.markers]),t.push({kmMark:a,elevation:s,terrain:r.terrain,techLevel:r.techLevel,windExp:r.windExp,markers:je(r.endMarkers)})}),t}function lm(e){return e?" stage-editor-input-invalid":""}function cs(e,t){const a=e.segments[t];if(!a)return[];const r=[],s=dm(e).get(t)??[];return a.lengthKm<Xa&&r.push(`Laenge unter ${Xa.toFixed(1).replace(".",",")} km.`),(a.techLevel<1||a.techLevel>10)&&r.push("Tech ausserhalb 1-10."),(a.windExp<1||a.windExp>10)&&r.push("Wind ausserhalb 1-10."),t===0&&!a.markers.some(n=>n.type==="start")&&r.push("Startmarker fehlt am ersten Segment."),t<e.segments.length-1&&a.endMarkers.some(n=>Ae(n.type))&&r.push("Finish nur am Endmarker des letzten Segments."),t>0&&a.markers.some(n=>n.type==="start")&&r.push("Startmarker nur am ersten Segment erlaubt."),t===e.segments.length-1&&!a.endMarkers.some(n=>Ae(n.type))&&r.push("Finishmarker fehlt am letzten Segmentende."),a.markers.forEach(n=>{Ae(n.type)&&r.push("Finishmarker gehoert in den Endmarker-Slot."),n.type==="climb_top"&&r.push("climb_top gehoert in den Endmarker-Slot."),n.type==="sprint_intermediate"&&r.push("Sprintmarker gehoert in den Endmarker-Slot.")}),a.endMarkers.forEach(n=>{(n.type==="start"||n.type==="climb_start")&&r.push(`${n.type} gehoert in den Startmarker-Slot.`),ls(n.type,n.cat)&&!er(n.cat)&&r.push(`${n.type} braucht Kategorie HC oder 1-4.`)}),[...a.markers,...a.endMarkers].forEach(n=>{n.type==="sprint_intermediate"&&n.cat!=null&&n.cat!=="Sprint"&&r.push("Sprintmarker erlaubt nur Kategorie Sprint."),Ae(n.type)&&!Qa(n.type)&&n.cat!=null&&r.push("finish_flat und finish_TT duerfen keine Kategorie haben."),Qa(n.type)&&n.cat!=null&&!er(n.cat)&&r.push(`${n.type} erlaubt nur Kategorie HC oder 1-4.`)}),r.push(...s),[...new Set(r)]}function dm(e){const t=new Map,a=[],r=(s,n)=>{const i=t.get(s)??[];i.push(n),t.set(s,i)};return e.segments.forEach((s,n)=>{s.markers.forEach(i=>{i.type==="climb_start"&&a.push({name:i.name??null,segmentIndex:n})}),s.endMarkers.forEach(i=>{var l;if(!ls(i.type,i.cat))return;if(!i.name){r(n,`${i.type} braucht einen Namen fuer die Paarbildung.`);return}let o=-1;for(let p=a.length-1;p>=0;p-=1)if(((l=a[p])==null?void 0:l.name)===i.name){o=p;break}const d=o>=0?o:a.length-1;if(d<0){r(n,`${i.type} "${i.name}" braucht einen vorherigen climb_start.`);return}a.splice(d,1)})}),a.forEach(s=>{const n=s.name?` "${s.name}"`:"";r(s.segmentIndex,`climb_start${n} braucht einen spaeteren climb_top oder kategorisierten finish_hill/finish_mountain.`)}),t}function cm(e){return e.type==="climb_top"?{...e,cat:e.cat&&["HC","1","2","3","4"].includes(e.cat)?e.cat:"4"}:Qa(e.type)?{...e,cat:er(e.cat)?e.cat:null}:e.type==="sprint_intermediate"?{...e,cat:e.cat==="Sprint"?e.cat:"Sprint"}:{...e,cat:null}}function uo(e){var a;const t={...e,segments:((a=e.segments)!=null&&a.length?e.segments:um(e.waypoints??[])).map(r=>({...r,startElevation:Math.round(r.startElevation),lengthKm:Number.isFinite(r.lengthKm)?We(r.lengthKm):Xa,gradientPercent:Number.isFinite(r.gradientPercent)?ha(r.gradientPercent):0,techLevel:Number.isFinite(r.techLevel)?r.techLevel:5,windExp:Number.isFinite(r.windExp)?r.windExp:5,markers:Pn(r.markers),endMarkers:Pn(r.endMarkers)})),waypoints:[]};return kt(t),t}function um(e){if(e.length<2)return[];const t=[];for(let a=0;a<e.length-1;a++){const r=e[a],s=e[a+1],n=We(s.kmMark-r.kmMark),i=s.elevation-r.elevation,o=ha(n>0?i/(n*10):0);t.push({startElevation:r.elevation,lengthKm:n,gradientPercent:o,techLevel:r.techLevel??5,windExp:r.windExp??5,terrain:r.terrain??"Flat",markers:r.markers??[],endMarkers:s.markers??[]})}return t}function Pn(e){return e?e.map(t=>({type:t.type,name:t.name??null,cat:t.cat??null})):[]}function mm(e,t,a){const r=e*a*8+t/12;return r>=95?"HC":r>=68?"1":r>=46?"2":r>=28?"3":"4"}function Nn(e){const t=[];let a=null,r=null,s=0;const n=i=>{if(a==null||i==null||i<=a){a=null,r=null,s=0;return}const o=e[a],d=e[i],l=d.kmMark-o.kmMark,p=Math.max(0,d.elevation-o.elevation),u=l>0?p/(l*10):0;p>=Uu&&u>=Yu&&t.push({startKm:We(o.kmMark),endKm:We(d.kmMark),distanceKm:We(l),gainMeters:Math.round(p),avgGradient:ha(u),category:mm(l,p,u),startIndex:a,topIndex:i,topElevation:Math.round(d.elevation)}),a=null,r=null,s=0};for(let i=1;i<e.length;i+=1){const o=e[i-1],d=e[i],l=d.elevation-o.elevation;if(a==null&&l>0){a=i-1,r=i,s=0;continue}if(a!=null){if(l>=0){(r==null||d.elevation>=e[r].elevation)&&(r=i),s=0;continue}s+=Math.abs(l),s>=Zu&&n(r)}}return n(r),t}function pm(e){const t=e.segments.some(s=>s.terrain==="Cobble_Hill"),a=e.segments.some(s=>s.terrain==="Cobble"),r=e.climbs.some(s=>s.category==="HC"||s.category==="1");return t?"Cobble_Hill":a?"Cobble":e.totalDistanceKm<=25&&e.elevationGainMeters<250?"ITT":r&&e.elevationGainMeters>=2800?"High_Mountain":r||e.elevationGainMeters>=1800?"Mountain":e.elevationGainMeters>=1100?"Medium_Mountain":e.elevationGainMeters>=700?"Hilly":e.elevationGainMeters>=350?"Rolling":"Flat"}function La(e){return e==="Cobble"||e==="Cobble_Hill"||e==="Sprint"}function gm(e){return e.gainMeters>=am&&e.topElevation>=rm?"Mountain":e.gainMeters>tm?"Medium_Mountain":"Hill"}function fm(e){return e.gradientPercent<Qu?"Abfahrt":e.gradientPercent<Xu||Math.max(0,e.lengthKm*1e3*(e.gradientPercent/100))<em?"Flat":"Hill"}function hm(e){if(e.segments.length===0)return;if(e.waypoints=ma(e.segments),e.sourceFormat==="csv"){const i=Nn(e.waypoints);e.climbs=i.map(({startIndex:o,topIndex:d,topElevation:l,...p})=>p);return}const t=e.segments.map(i=>i.manualTerrain||La(i.terrain)?i.terrain:fm(i)),a=Nn(e.waypoints);e.climbs=a.map(({startIndex:i,topIndex:o,topElevation:d,...l})=>l),a.forEach(i=>{const o=gm(i);if(o)for(let d=i.startIndex;d<i.topIndex;d+=1)e.segments[d].manualTerrain||La(t[d])||(t[d]=o)});let r=null,s=0;const n=i=>{if(r==null||s<=qu){r=null,s=0;return}for(let o=r;o<i;o+=1)!(e.segments[o].manualTerrain||La(t[o]))&&t[o]==="Flat"&&(t[o]="Abfahrt");r=null,s=0};for(let i=0;i<e.segments.length;i+=1){const o=e.segments[i];if(o&&o.gradientPercent<Ju){r==null&&(r=i),s+=o.lengthKm;continue}n(i)}n(e.segments.length),e.segments.forEach((i,o)=>{La(i.terrain)||(i.terrain=t[o])}),e.waypoints=ma(e.segments),e.suggestedProfile=pm(e)}function kt(e){bm(e),Ln(e),hm(e),e.waypoints=ma(e.segments),Ln(e)}function bm(e){if(e.segments.length===0){e.waypoints=[];return}let t=e.segments[0].startElevation;e.segments=e.segments.map((a,r)=>{const s={...a,startElevation:Math.round(r===0?a.startElevation:t),lengthKm:We(a.lengthKm),gradientPercent:ha(a.gradientPercent),markers:je(a.markers),endMarkers:je(a.endMarkers)};return t=Math.round(s.startElevation+s.lengthKm*1e3*(s.gradientPercent/100)),s}),e.waypoints=ma(e.segments)}function Ln(e){e.totalDistanceKm=We(e.segments.reduce((t,a)=>t+a.lengthKm,0)),e.elevationGainMeters=e.waypoints.reduce((t,a,r)=>{if(r===0)return 0;const s=a.elevation-e.waypoints[r-1].elevation;return t+Math.max(0,s)},0)}function mt(e){const t=e.segments[0],a=e.segments[e.segments.length-1];!t||!a||(t.markers.some(r=>r.type==="start")||(t.markers=je([{type:"start",name:null,cat:null},...t.markers])),a.endMarkers.some(r=>Ae(r.type))||(a.endMarkers=je([...a.endMarkers,{type:"finish_flat",name:null,cat:null}])),e.waypoints=ma(e.segments))}function ym(e,t,a,r){return e.length===0?"":`<div class="stage-editor-marker-list">${e.map((s,n)=>{const i=r==="start"&&t===0&&s.type==="start",o=e.filter(p=>Ae(p.type)).length,d=r==="end"&&t===a-1&&Ae(s.type)&&o===1,l=!(i||d);return`
    ...
    `).join(""))}function Tm(){const e=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked'),t=h("stage-editor-programs-selected-text");if(e.length===0)t.textContent="Keine Programme ausgewählt",t.classList.add("text-muted");else{const a=Array.from(e).map(r=>{var n;const s=(n=c.stageEditorPrograms)==null?void 0:n.find(i=>String(i.id)===r.value);return s?s.name:r.value});t.textContent=`${e.length} ausgewählt: ${a.join(", ")}`,t.classList.remove("text-muted")}}function us(e){return Math.round(e.startElevation+e.lengthKm*1e3*(e.gradientPercent/100))}function mo(){const e=c.stageEditorExistingStages.map(t=>t.stageId);return e.length>0?Math.max(...e)+1:1}function wm(){const e=[...c.stageEditorExistingStages.map(t=>t.raceId),...c.races.map(t=>t.id)];return e.length>0?Math.max(...e)+1:1}function Mm(e,t){let a=e;const r=new Set(c.stageEditorExistingStages.map(s=>s.stageId));for(;a>0&&r.has(a);)a+=t;if(a<=0)for(a=1;r.has(a);)a+=1;return a}function Rm(e,t){let a=e;const r=new Set([...c.stageEditorExistingStages.map(s=>s.raceId),...c.races.map(s=>s.id)]);for(;a>0&&r.has(a);)a+=t;if(a<=0)for(a=1;r.has(a);)a+=1;return a}function Im(e){var o;const t=h("stage-editor-profile");t.innerHTML=ds(e.suggestedProfile),t.value=e.suggestedProfile;const a=mo(),r=wm();h("stage-editor-stage-id").value=String(a),h("stage-editor-race-id").value=String(r),Kt=a,Wt=r;const s=h("stage-editor-details-file");s.value.trim()||(s.value=`${sm(e.routeName)}.csv`);const n=h("stage-editor-date");!n.value&&((o=c.gameState)!=null&&o.currentDate)&&(n.value=c.gameState.currentDate),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(d=>{d.checked=!0})}function Cm(e){h("stage-editor-stage-id").value=String(e.stageId),h("stage-editor-race-id").value=String(e.raceId),Kt=e.stageId,Wt=e.raceId,h("stage-editor-stage-number").value=String(e.stageNumber),h("stage-editor-date").value=e.date,h("stage-editor-details-file").value=e.detailsCsvFile;const t=h("stage-editor-profile");t.innerHTML=ds(e.profile),t.value=e.profile,h("stage-editor-final-spread-start").value=String(e.finalSpreadStartPercent),h("stage-editor-final-push-start").value=String(e.finalPushStartPercent),h("stage-editor-final-spread-difficulty").value=String(e.finalSpreadDifficultyMultiplier),h("stage-editor-crash-multiplier").value=String(e.crashIncidentMultiplier),h("stage-editor-mechanical-multiplier").value=String(e.mechanicalIncidentMultiplier);const a=(e.allowedWeather||"1|2|3|4|5|6|7").split("|").map(s=>s.trim());document.querySelectorAll('input[name="stage-editor-weather"]').forEach(s=>{s.checked=a.includes(s.value)})}function po(e){var r;if(!e)return["Noch keine Strecke importiert."];const t=[];return e.segments.length===0?(t.push("Mindestens ein Segment ist erforderlich."),t):((r=e.segments[0])!=null&&r.markers.some(s=>s.type==="start")||t.push("Das erste Segment muss als Start markiert sein."),(e.segments[e.segments.length-1].endMarkers??[]).some(s=>Ae(s.type))||t.push("Das letzte Segment muss per Endmarker als Ziel markiert sein."),e.segments.forEach((s,n)=>{cs(e,n).forEach(i=>{t.push(`Segment ${n+1}: ${i}`)}),[...s.markers??[],...s.endMarkers??[]].forEach(i=>{i.cat!=null&&!lo.includes(i.cat)&&t.push(`Segment ${n+1}: Ungültige Marker-Kategorie ${i.cat}.`)})}),t)}function go(){const e=[],t=Number(h("stage-editor-stage-id").value),a=Number(h("stage-editor-race-id").value),r=Number(h("stage-editor-stage-number").value),s=h("stage-editor-date").value.trim(),n=h("stage-editor-details-file").value.trim(),i=Number(h("stage-editor-final-spread-start").value),o=Number(h("stage-editor-final-push-start").value),d=Number(h("stage-editor-final-spread-difficulty").value),l=Number(h("stage-editor-crash-multiplier").value),p=Number(h("stage-editor-mechanical-multiplier").value);(!Number.isInteger(t)||t<=0)&&e.push("Stage-ID fehlt oder ist ungültig."),(!Number.isInteger(a)||a<=0)&&e.push("Race-ID fehlt oder ist ungültig."),(!Number.isInteger(r)||r<=0)&&e.push("Etappennummer fehlt oder ist ungültig."),/^\d{4}-\d{2}-\d{2}$/.test(s)||e.push("Datum muss im Format YYYY-MM-DD vorliegen."),(!/^[A-Za-z0-9_.-]+\.csv$/.test(n)||n.includes("/"))&&e.push("Details-Datei muss ein Dateiname mit .csv-Endung ohne Pfad sein."),(!Number.isFinite(i)||i<0||i>100)&&e.push("Final Spread Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(o)||o<0||o>100)&&e.push("Final Push Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(d)||d<=0)&&e.push("Final Spread Multiplikator muss groesser als 0 sein."),(!Number.isFinite(l)||l<=0)&&e.push("Sturz-Multiplikator muss groesser als 0 sein."),(!Number.isFinite(p)||p<=0)&&e.push("Defekt-Multiplikator muss groesser als 0 sein."),document.querySelectorAll('input[name="stage-editor-weather"]:checked').length===0&&e.push("Mindestens eine Wetterart muss ausgewählt sein."),c.stageEditorExistingStages.map(y=>y.stageId).includes(t)&&e.push(`Die Stage-ID ${t} existiert bereits in stages.csv.`);const f=h("stage-editor-new-race-checkbox").checked,g=[...c.stageEditorExistingStages.map(y=>y.raceId),...c.races.map(y=>y.id)];if(f){g.includes(a)&&e.push(`Die Race-ID ${a} existiert bereits.`);const y=h("stage-editor-race-name").value.trim(),v=Number(h("stage-editor-race-country").value),T=Number(h("stage-editor-race-category").value),R=Number(h("stage-editor-race-num-stages").value),x=h("stage-editor-race-start-date").value.trim(),$=h("stage-editor-race-end-date").value.trim(),C=Number(h("stage-editor-race-prestige").value);y||e.push("Rennname fehlt."),(!Number.isInteger(v)||v<=0)&&e.push("Land fehlt oder ist ungültig."),(!Number.isInteger(T)||T<=0)&&e.push("Kategorie fehlt oder ist ungültig."),(!Number.isInteger(R)||R<=0)&&e.push("Etappenanzahl muss eine positive Ganzzahl sein."),/^\d{4}-\d{2}-\d{2}$/.test(x)||e.push("Startdatum muss im Format YYYY-MM-DD vorliegen."),/^\d{4}-\d{2}-\d{2}$/.test($)||e.push("Enddatum muss im Format YYYY-MM-DD vorliegen."),(!Number.isInteger(C)||C<1||C>100)&&e.push("Prestige muss zwischen 1 und 100 liegen.")}else g.includes(a)||e.push(`Die Race-ID ${a} existiert nicht. Wenn Sie ein neues Rennen erstellen möchten, aktivieren Sie bitte 'Neues Rennen anlegen'.`);return h("stage-editor-program-checkbox").checked&&document.querySelectorAll('input[name="stage-editor-program-selection"]:checked').length===0&&e.push("Mindestens ein Programm muss ausgewählt sein."),e}function Em(){var a,r;const e=document.querySelectorAll('input[name="stage-editor-weather"]:checked'),t=Array.from(e).map(s=>s.value).join("|");return{stageId:Number(h("stage-editor-stage-id").value),raceId:Number(h("stage-editor-race-id").value),stageNumber:Number(h("stage-editor-stage-number").value),date:h("stage-editor-date").value.trim(),profile:h("stage-editor-profile").value,detailsCsvFile:h("stage-editor-details-file").value.trim(),startElevation:((r=(a=c.stageEditorDraft)==null?void 0:a.segments[0])==null?void 0:r.startElevation)??0,finalSpreadStartPercent:Number(h("stage-editor-final-spread-start").value),finalPushStartPercent:Number(h("stage-editor-final-push-start").value),finalSpreadDifficultyMultiplier:Number(h("stage-editor-final-spread-difficulty").value),crashIncidentMultiplier:Number(h("stage-editor-crash-multiplier").value),mechanicalIncidentMultiplier:Number(h("stage-editor-mechanical-multiplier").value),allowedWeather:t}}function Fm(e){return["distanceKm","elevationGainMeters","sprintCount","climbCount","profileScore"].includes(e)?"desc":"asc"}function Pm(e){return["gainMeters","distanceKm","avgGradient","maxGradient","climbScore"].includes(e)?"desc":"asc"}function ur(e,t,a){const s=(Math.max(t,Math.min(a,e))-t)/Math.max(1,a-t),n=Math.round(124-s*118),i=54,o=.14+s*.12,d=.26+s*.18;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${n};--stage-editor-score-lightness:${i}%;--stage-editor-score-bg-alpha:${o};--stage-editor-score-border-alpha:${d};`}">${Math.round(e)}</span>`}function ms(e){let t;e<=100?t=e/100*.45:e<=250?t=.45+(e-100)/150*.35:t=.8+Math.min(e-250,100)/100*.2;const a=Math.round(122-t*122),r=Math.round(40-t*22),s=.18+t*.3,n=.3+t*.4;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${s};--stage-editor-score-border-alpha:${n};`}">${Math.round(e)}</span>`}function Nm(e){if(e==null)return'<span class="stage-editor-category-empty">—</span>';const t=e==="HC"?"is-hc":`is-cat-${e}`,a=e==="HC"?"HC":String(e);return`<span class="stage-editor-climb-category-badge ${t}">${a}</span>`}function Lm(e,t,a,r){const s=r!=null?` data-stage-profile-open-climb-id="${S(r)}"`:"";return`<button class="dashboard-stage-profile-link" type="button" data-stage-profile-open-stage-id="${t}"${s}>${e}</button>`}function Dm(e){const t=i=>i!=null?`${i.toFixed(1).replace(".",",")} km`:"—",a=i=>i!=null?`${Math.round(i).toLocaleString("de-DE")} m`:"—",r=e.profileScore??e.score,s=[...c.stageEditorClimbRows??[]].filter(i=>i.stageId===e.stageId).sort((i,o)=>i.climbIndex-o.climbIndex),n=s.length===0?'<div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-compact"><span class="text-muted" style="grid-column:1/-1">Keine Bergwertungen</span></div>':`
      ...
      ${s.map(i=>`
        <div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-climbs">
          ...
          <span>${S(i.name)}</span>
          <span class="text-right">${ms(i.climbScore)}</span>
    ...
    </div>`}function fo(e,t,a,r,s,n,i,o){const d=o??ur(e,t,a);return`
    ...
    </th>`}function ea(){const e=h("stage-editor-stages-table"),t=h("stage-editor-stages-empty"),a=h("stage-editor-stages-meta"),r=e.querySelector("thead"),s=e.querySelector("tbody");if(!s)return;const n=c.stageEditorStagesSort.key,i=c.stageEditorStagesSort.direction;r&&(r.innerHTML=`<tr>
    ...
    <tr>
      ...
      <td>${fo(d.profileScore,0,100,d.stageId,Dm(d),fr({name:d.raceName},{stageNumber:d.stageNumber,profile:d.profile}))}</td>
      <td>${va(d.profile)}</td>
      <td>${wt(d.distanceKm)}</td>
      <td>${co(d.elevationGainMeters)}</td>
      <td>${d.sprintCount} Sprints</td>
      <td>${d.climbCount} Climbs</td>
    </tr>`).join(""),t.classList.toggle("hidden",o.length>0||c.stageEditorOverviewLoading),a.textContent=c.stageEditorOverviewLoading?"Etappenübersicht wird geladen...":`${c.stageEditorStageRows.length} vorhandene Etappen`}function ta(){const e=h("stage-editor-climbs-table"),t=h("stage-editor-climbs-empty"),a=h("stage-editor-climbs-meta"),r=e.querySelector("thead"),s=e.querySelector("tbody");if(!s)return;const n=c.stageEditorClimbsSort.key,i=c.stageEditorClimbsSort.direction;r&&(r.innerHTML=`<tr>
    ...
    <tr>
      ...
      <td>${Nm(d.category)}</td>
      <td>${fo(d.climbScore,0,350,d.stageId,_m(d),fr({name:d.raceName},{stageNumber:d.stageNumber,profile:"Mountain"}),d.id,ms(d.climbScore))}</td>
      <td>${de(d.countryCode||"")}</td>
      <td><strong>${S(d.raceName)}</strong></td>
      <td><strong>${S(ya({stageNumber:d.stageNumber}))}</strong></td>
        ...
        ${g.map(v=>`
          <div class="stage-editor-climb" style="padding: 0.5rem; background: rgba(255,255,255,0.03); border-radius: var(--radius-sm); border-left: 3px solid var(--accent);">
            ...
            <div style="font-size: 0.75rem; color: var(--text-300); display: flex; flex-wrap: wrap; gap: 0.5rem;">
              <span>${wt(v.startKm)} - ${wt(v.endKm)}</span>
              <span>·</span>
    ...
    `,r.innerHTML=y,n.innerHTML=_n(e),i.innerHTML=e.segments.map((v,T)=>`
    <tr data-segment-index="${T}" class="${cs(e,T).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;">
      <td class="stage-editor-cell-nr text-muted" style="text-align:center; font-weight:700;">${T+1}</td>
      <td class="stage-editor-cell-length"><input type="number" step="0.01" min="0.2" value="${v.lengthKm.toFixed(2)}" data-field="segmentLengthKm" class="${lm(v.lengthKm<Xa)}"></td>
      ...
      <td class="stage-editor-cell-terrain"><select data-field="terrain">${nm(v.terrain)}</select></td>
      <td class="stage-editor-cell-start-markers">
        ${Dn(v.markers,T,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${Dn(v.endMarkers,T,e.segments.length,"end")}
      </td>
      <td class="stage-editor-row-actions">
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          <div class="text-muted" style="min-width:3.5rem;">${us(v)} m</div>
          ${Wm(e,T)}
...
`)}`),ge();return}const t=h("stage-editor-new-race-checkbox").checked,a=h("stage-editor-program-checkbox").checked;let r;t&&(r={name:h("stage-editor-race-name").value.trim(),countryId:Number(h("stage-editor-race-country").value),categoryId:Number(h("stage-editor-race-category").value),isStageRace:Number(h("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(h("stage-editor-race-num-stages").value),startDate:h("stage-editor-race-start-date").value.trim(),endDate:h("stage-editor-race-end-date").value.trim(),prestige:Number(h("stage-editor-race-prestige").value)});let s;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');s=Array.from(n).map(i=>Number(i.value))}Me("CSV-Dateien werden erstellt……");try{const n=await V.exportStageRoute({metadata:Em(),draft:c.stageEditorDraft,newRace:t,raceDetails:r,updatePrograms:a,programIds:s});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}Hr(n.data.stagesFileName,n.data.stagesCsv),Hr(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=h("stage-editor-stage-number"),o=Number(i.value)||1;i.value=String(o+1);const d=h("stage-editor-date"),l=d.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const y=new Date(l);y.setDate(y.getDate()+1);const v=y.getFullYear(),T=String(y.getMonth()+1).padStart(2,"0"),R=String(y.getDate()).padStart(2,"0");d.value=`${v}-${T}-${R}`}await Promise.all([ho(!0),Am(!0)]);const p=mo();h("stage-editor-stage-id").value=String(p),Kt=p;const u=h("stage-editor-new-race-checkbox");u&&(u.checked=!1);const m=h("stage-editor-new-race-details");m&&(m.classList.add("hidden"),m.style.display="none");const f=h("stage-editor-program-checkbox");f&&(f.checked=!1);const g=h("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),Wt=Number(h("stage-editor-race-id").value),ge()}finally{$e()}}function qm(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",x=>{const $=x.target.closest("button[data-stage-profile-open-stage-id]");if($){const P=Number($.dataset.stageProfileOpenStageId);Number.isFinite(P)&&sr(P);return}const C=x.target.closest("button[data-stage-editor-stages-sort]");if(!C)return;const I=C.dataset.stageEditorStagesSort;c.stageEditorStagesSort.key===I?c.stageEditorStagesSort.direction=c.stageEditorStagesSort.direction==="asc"?"desc":"asc":c.stageEditorStagesSort={key:I,direction:Fm(I)},ea()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",x=>{const $=x.target.closest("button[data-stage-profile-open-stage-id]");if($){const P=Number($.dataset.stageProfileOpenStageId),F=$.dataset.stageProfileOpenClimbId??null;if(Number.isFinite(P)){let L=null;F&&c.stageEditorClimbRows&&(L=c.stageEditorClimbRows.find(H=>H.id===F)??null),sr(P,L)}return}const C=x.target.closest("button[data-stage-editor-climbs-sort]");if(!C)return;const I=C.dataset.stageEditorClimbsSort;c.stageEditorClimbsSort.key===I?c.stageEditorClimbsSort.direction=c.stageEditorClimbsSort.direction==="asc"?"desc":"asc":c.stageEditorClimbsSort={key:I,direction:Pm(I)},ta()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{Ym()});const r=document.getElementById("btn-stage-editor-load-existing");r&&r.addEventListener("click",()=>{Zm()});const s=document.getElementById("btn-stage-editor-export");s&&s.addEventListener("click",()=>{Jm()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",x=>{var C;const $=((C=x.target.files)==null?void 0:C[0])??null;h("stage-editor-file-hint").textContent=$?`${$.name} · ${($.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",x=>{const $=x.target,C=$.closest("tr[data-segment-index]"),I=$.dataset.field;if(!C||!I)return;const P=Number(C.dataset.segmentIndex);if(Number.isInteger(P)){if(I==="markerType"||I==="markerName"||I==="markerCat"){const F=Number($.dataset.markerIndex),L=$.dataset.markerScope;if(!Number.isInteger(F)||L!=="start"&&L!=="end")return;vm(P,F,L,I,$.value);return}jm(P,I,$.value)}}),i.addEventListener("click",x=>{const $=x.target.closest("button[data-segment-action]");if(!$)return;const C=Number($.dataset.segmentIndex);if(Number.isInteger(C)){if($.dataset.segmentAction==="insert"){Om(C);return}if($.dataset.segmentAction==="append"){Vm();return}if($.dataset.segmentAction==="add-marker"){const I=$.dataset.markerScope;if(I!=="start"&&I!=="end")return;Sm(C,I);return}if($.dataset.segmentAction==="remove-marker"){const I=Number($.dataset.markerIndex),P=$.dataset.markerScope;if(!Number.isInteger(I)||P!=="start"&&P!=="end")return;km(C,I,P);return}$.dataset.segmentAction==="delete"&&Um(C)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(x=>{const $=document.getElementById(x);$&&$.addEventListener("change",()=>ge())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(x=>{x.addEventListener("change",()=>ge())});const d=h("stage-editor-new-race-checkbox"),l=h("stage-editor-new-race-details"),p=h("stage-editor-program-checkbox"),u=h("stage-editor-program-details");d&&d.addEventListener("change",()=>{d.checked?(l&&(l.classList.remove("hidden"),l.style.display="grid"),p&&(p.checked=!0,u&&(u.classList.remove("hidden"),u.style.display="block"))):l&&(l.classList.add("hidden"),l.style.display="none"),ge()}),p&&p.addEventListener("change",()=>{p.checked?u&&(u.classList.remove("hidden"),u.style.display="block"):u&&(u.classList.add("hidden"),u.style.display="none"),ge()});const m=h("stage-editor-programs-dropdown-trigger"),f=h("stage-editor-programs-dropdown-menu"),g=h("btn-stage-editor-programs-ok");m&&f&&(m.addEventListener("click",x=>{x.stopPropagation();const $=f.style.display==="none"||!f.style.display;f.style.display=$?"flex":"none"}),g&&g.addEventListener("click",x=>{x.stopPropagation(),f.style.display="none",ge()}),document.addEventListener("click",x=>{const $=x.target;f.style.display==="flex"&&!f.contains($)&&$!==m&&!m.contains($)&&(f.style.display="none",ge())}));const b=h("stage-editor-programs-list");b&&b.addEventListener("change",x=>{x.target.name==="stage-editor-program-selection"&&Tm()});let y=!1,v=null;const T=h("stage-editor-stage-id"),R=h("stage-editor-race-id");if(T&&R){[T,R].forEach($=>{$.addEventListener("keydown",C=>{C.key!=="ArrowUp"&&C.key!=="ArrowDown"&&(y=!0,v&&clearTimeout(v))}),$.addEventListener("keyup",C=>{C.key!=="ArrowUp"&&C.key!=="ArrowDown"&&(v&&clearTimeout(v),v=setTimeout(()=>{y=!1},150))}),$.addEventListener("blur",()=>{y=!1})});const x=($,C)=>{const I=Number($.value);if(!Number.isInteger(I)||I<=0){C==="stage"?Kt=I:Wt=I;return}const F=I-(C==="stage"?Kt:Wt);if(!y&&(F===1||F===-1)){let L=I;C==="stage"?L=Mm(I,F):h("stage-editor-new-race-checkbox").checked&&(L=Rm(I,F)),$.value=String(L)}C==="stage"?Kt=Number($.value):Wt=Number($.value)};T.addEventListener("input",()=>{x(T,"stage"),ge()}),R.addEventListener("input",()=>{x(R,"race"),ge()})}}let lt=[],Ht=null,Le={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const _t=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"];function ps(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill" title="Team">${l?Ct(l,p):""} <span>${S(p)}</span></span>
        <span class="rider-stats-icon-pill" title="Rolle">${S(o)}</span>
        <span class="rider-stats-icon-pill" title="Formphase">${yi(u)} <span>Form</span></span>
        ${q}
      </div>
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;" title="Overall-Stärke">${yo(d)}</span>
      ...
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width ${y>14?"text-warning":""}" title="30-Tage Renntage">${re.rollingRaceDays} <span class="rider-stats-icon-pill-value">${y}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Langzeit-Fatigue">${re.longFatigue} <span class="rider-stats-icon-pill-value">${v}</span></span>
      ...
      <div class="rider-stats-header-col align-left">
        ${pt(re.stageRace,"Rundfahrten Punkte",H.stageRace,G)}
        ${pt(re.oneDay,"Eintagesrennen Punkte",H.oneDay,G)}
      ...
      <div class="rider-stats-header-col align-left">
        ${pt(re.flat,"Flach-Punkte",F.flat,L)}
        ${pt(re.hilly,"Hügel-Punkte",F.hilly,L)}
        ${pt(re.mediumMountain,"Mittelgebirge-Punkte",F.mediumMountain,L)}
      </div>
      <div class="rider-stats-header-col align-left">
        ${pt(re.mountain,"Hochgebirge-Punkte",F.mountain,L)}
        ${pt(re.timetrial,"Zeitfahren-Punkte",F.timetrial,L)}
        ${pt(re.cobble,"Kopfsteinpflaster-Punkte",F.cobble,L)}
      </div>
    </div>
  `}function Bn(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",r=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(r)}</strong>`}function Ve(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </defs>`,b=`<circle cx="${o}" cy="${d}" r="${l+8}" fill="url(#radarBgGrad)" stroke="rgba(255,255,255,0.06)" stroke-width="1" />`;let y="";for(let H=p;H<=u;H+=2.5){const G=l*((H-p)/m);if(G<1){y+=`<circle cx="${o}" cy="${d}" r="2" fill="rgba(255,255,255,0.25)" />`;continue}const K=f(G),w=H%5===0,A=w?1:.6,U=w?"none":"4,4",W=w?.4:.18;y+=`<polygon points="${K.join(" ")}" fill="none" stroke="rgba(255,255,255,${W})" stroke-width="${A}" stroke-dasharray="${U}" />`,w&&H>p&&(y+=`<text x="${o+5}" y="${d-G+4}" fill="rgba(255,255,255,0.45)" font-size="9" font-family="Inter, sans-serif" text-anchor="start">${H}</text>`)}let v="",T="";for(let H=0;H<6;H++){const G=H*Math.PI/3-Math.PI/2,K=o+l*Math.cos(G),w=d+l*Math.sin(G);v+=`<line x1="${o}" y1="${d}" x2="${K}" y2="${w}" stroke="rgba(255,255,255,0.15)" stroke-width="1" />`;const A=l+28,U=o+A*Math.cos(G),W=d+A*Math.sin(G),ne=Math.cos(G);let q="middle";ne>.15?q="start":ne<-.15&&(q="end");const te=a[r[H]]??p;T+=`<text x="${U}" y="${W}" fill="rgba(255,255,255,0.92)" font-size="11.5" font-weight="700" font-family="Inter, sans-serif" text-anchor="${q}" dominant-baseline="middle">${s[H]}</text>`,T+=`<text x="${U}" y="${W+14}" fill="rgba(255,255,255,0.50)" font-size="10" font-weight="500" font-family="Inter, sans-serif" text-anchor="${q}" dominant-baseline="middle">${te}</text>`}const R=[],x=[];r.forEach((H,G)=>{const K=a[H]??p,w=l*((Math.max(p,Math.min(u,K))-p)/m),A=G*Math.PI/3-Math.PI/2,U=o+w*Math.cos(A),W=d+w*Math.sin(A);R.push(`${U},${W}`),x.push(`<circle cx="${U}" cy="${W}" r="5" fill="#818cf8" stroke="#fff" stroke-width="2" filter="url(#dotGlow)"><title>${s[G]}: ${K}</title></circle>`)});const $=`<polygon points="${R.join(" ")}" fill="url(#riderFillGrad)" stroke="#818cf8" stroke-width="2.5" stroke-linejoin="round" filter="url(#radarGlow)" />`,I=[...[{key:"mountain",label:"Berg (MTN)"},{key:"hill",label:"Hügel (HIL)"},{key:"sprint",label:"Sprint (SPR)"},{key:"timeTrial",label:"Zeitfahren (TT)"},{key:"cobble",label:"Pflaster (COB)"},{key:"attack",label:"Angriff (ATT)"},{key:"mediumMountain",label:"Mittelgebirge (MDM)"},{key:"flat",label:"Flach (FLA)"},{key:"prologue",label:"Prolog (PRO)"},{key:"acceleration",label:"Beschleunigung (ACC)"}]].sort((H,G)=>{const K=a[H.key]??60;return(a[G.key]??60)-K}),P=[],F=[];I.forEach((H,G)=>{const K=a[H.key]??60,w=`
  ...
  `}function op(e){var j;if(!e)return`
    ...
    <div class="rider-compare-controls" style="display: flex; gap: 1.5rem; align-items: center; margin-bottom: 1rem; background: var(--bg-secondary); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid var(--border-primary);">
      ...
      <div class="form-group" style="margin: 0; display: flex; align-items: center; gap: 0.5rem;">
        ...
        <select id="rider-compare-rider-select" class="form-control" style="width: auto; background: var(--bg-900); color: var(--text-100); border: 1px solid var(--border-primary);" ${Ht==null?"disabled":""}>
          ${W}
        </select>
      </div>
    </div>
  `,q=e.currentSeasonRank??ar(e.riderId)??"–",te=[`
    ...
    `];lt.forEach((D,_)=>{const E=_t[_%_t.length],O=D.currentSeasonRank??ar(D.riderId)??"–";te.push(`
          ...
          ${l.raceBlocks.map(p=>`
            <section class="rider-stats-race-block">
              <div class="rider-stats-race-head">
                ...
                ${tr(p.raceCategoryName,p.isStageRace,p.rows.filter(u=>u.rowType==="stage_result").length||null)}
              </div>
              <div class="dashboard-race-stages-table-wrap rider-stats-table-wrap">
                <table class="data-table rider-stats-table">
                  <colgroup>
                  ...
                  <tbody>
                    ${p.rows.map(u=>{const m=u.rowType!=="stage_result",f=m?`${u.raceName} · ${fs(u.rowType)}`:u.stageName?`${u.raceName} · ${u.stageName}`:u.raceName;return`
                        <tr class="rider-stats-row${m?" rider-stats-row-final":""}">
                          <td>${S(oe(u.date))}</td>
                          <td>${cp(u)}</td>
                          <td>${up(u)}</td>
                          <td class="rider-stats-breakaway-col">${dp(u)}</td>
                          <td>${m?"":ps(u.rolledWeatherId,u.rolledWetterName)}</td>
                          <td>${m?ep(u.rowType):tr(u.raceCategoryName?u.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):u.raceCategoryName,u.isStageRace)}</td>
                          <td>${S(f)}</td>
                          <td class="status-cell">${hs(u)}</td>
                          <td>${m?"–":u.profile?`<button type="button" class="rider-stats-profile-badge-link" data-stage-profile-id="${u.stageId}" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex;">${va(u.profile)}</button>`:"–"}</td>
  ...
  `,m=l.length===0?'<tr><td colspan="9" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':l.map(g=>{const b=g.rowType!=="stage_result",y=b?`${g.raceName} · ${fs(g.rowType)}`:g.stageNumber&&g.isStageRace?`${g.raceName} · Etappe ${g.stageNumber}`:g.raceName;let v="–",T="–";g.finishStatus==="otl"?v=Pt("OTL","place"):g.finishStatus==="dnf"?v=Pt("DNF","place"):g.resultRank==null||(b?T=`<span class="rider-stats-final-type ${bo(g.rowType)}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${g.resultRank}</span>`:v=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${g.resultRank<=3?` rider-stats-rank-badge-top-${g.resultRank}`:""}">${S(String(g.resultRank))}</span>`);const R=b?"–":g.profile?`<button type="button" class="rider-stats-profile-badge-link" data-stage-profile-id="${g.stageId}" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex;">${va(g.profile)}</button>`:"–",x=!b&&g.stageScore!=null&&g.stageScore>0?ur(g.stageScore,0,350):"–",$=tr(g.raceCategoryName?g.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):g.raceCategoryName,g.isStageRace);return`
          <tr class="rider-stats-row${b?" rider-stats-row-final":""}">
            <td>${v}</td>
            <td>${T}</td>
            <td><strong>${S(y)}</strong>${b?"":ps(g.rolledWeatherId,g.rolledWetterName)}</td>
            <td class="status-cell">${hs(g)}</td>
            <td>${R}</td>
            <td>${x}</td>
            <td>${$}</td>
...
`+r.error);return}c.stageResults=r.data??null,c.stageResults&&(c.selectedResultsRaceId=c.stageResults.raceId,c.selectedResultsStageId=c.stageResults.stageId,c.selectedResultTypeId=((s=c.stageResults.classifications[0])==null?void 0:s.resultTypeId)??1,c.selectedResultsMarkerKey=Ye,c.selectedResultsSpecialView=null),c.selectedResultsRaceId!=null&&$o(c.selectedResultsRaceId),Ie()}async function $o(e){if(!c.seasonStandings){const a=await V.getSeasonStandings();a.success&&a.data&&(c.seasonStandings=a.data)}const t=await V.getRaceResultsRoster(e);t.success&&t.data?c.resultsRoster=t.data:c.resultsRoster=null}function Tp(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function Kn(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function wp(){const e=c.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=vt(c.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,r=[...e.entries].sort((y,v)=>v.overallRating-y.overallRating),s=new Set(r.slice(0,5).map(y=>y.riderId)),n=y=>{var T;const v=c.riders.find(R=>R.id===y);return((T=v==null?void 0:v.skills)==null?void 0:T.sprint)??0},o=[...e.entries.filter(y=>!s.has(y.riderId))].sort((y,v)=>{const T=n(y.riderId),R=n(v.riderId);return R!==T?R-T:v.overallRating-y.overallRating}),d=new Set(o.slice(0,5).map(y=>y.riderId));function l(y){switch(y){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return y}}const p=new Map;for(const y of e.entries){const v=y.teamId;p.has(v)||p.set(v,{teamId:y.teamId,teamName:y.teamName,riders:[],avgRating:0}),p.get(v).riders.push(y)}for(const y of p.values())y.avgRating=y.riders.reduce((v,T)=>v+T.overallRating,0)/y.riders.length;const u=y=>{let v=Number.POSITIVE_INFINITY;for(const T of y)!T.hasDropped&&T.gcRank!=null&&T.gcRank<v&&(v=T.gcRank);return v},m=y=>{var T;if(!((T=c.seasonStandings)!=null&&T.riderStandings))return 0;let v=0;for(const R of y){const x=c.seasonStandings.riderStandings.find($=>$.riderId===R.riderId);x&&x.points>v&&(v=x.points)}return v},f=y=>{if(y==null)return 0;const v=c.riders.filter(x=>x.activeTeamId===y);if(v.length===0)return 0;const T=v.map(x=>x.overallRating??0);T.sort((x,$)=>$-x);const R=T.slice(0,10);return R.length===0?0:R.reduce((x,$)=>x+$,0)/R.length},g=[...p.values()].sort((y,v)=>{const T=u(y.riders),R=u(v.riders);if((T!==Number.POSITIVE_INFINITY||R!==Number.POSITIVE_INFINITY)&&T!==R)return T-R;const x=m(y.riders),$=m(v.riders);if((x>0||$>0)&&x!==$)return $-x;const C=f(y.teamId),I=f(v.teamId);return Math.abs(C-I)>1e-4?I-C:(y.teamName??"").localeCompare(v.teamName??"","de")});for(const y of g)y.riders.sort((v,T)=>Kn(v.roleId)-Kn(T.roleId)||T.overallRating-v.overallRating||v.lastName.localeCompare(T.lastName,"de"));return`<div class="results-roster-grid">${g.map(y=>{const v=y.teamId!=null?Ct(y.teamId,y.teamName):"",T=y.riders.map(x=>{var j;const $=Tp(x.roleId),C=x.countryCode?Ze[x.countryCode]??x.countryCode.slice(0,2).toLowerCase():null,I=C?`<span class="fi fi-${C} results-roster-flag" title="${S(x.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',P=`${x.firstName.charAt(0)}. ${x.lastName}`,F=x.roleName??"–",L=x.specialization1?l(x.specialization1):null,H=x.specialization2?l(x.specialization2):null;let G=F;L&&(G+=` · ${L}`),H&&(G+=` · ${H}`);const K=`<span class="results-roster-overall-badge" style="color:${Mp(x.overallRating)}" title="Gesamtstärke: ${x.overallRating.toFixed(2)}">${x.overallRating.toFixed(2)}</span>`,w=x.hasDropped?" dropped":"";let A="";x.hasDropped?x.dropoutStatus==="dns"?A="DNS":x.dropoutStatus==="dnf"?A=((j=x.dropoutReason)==null?void 0:j.startsWith("OTL"))??!1?"OTL":"DNF":A="OUT":x.gcRank!=null&&(A=`${x.gcRank}`);let U="";if(x.hasDropped)U=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(x.dropoutReason||"")}">${A}</span>`;else if(x.gcRank!=null){let D="rider-stats-rank-badge-gc";x.gcRank===1?D="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":x.gcRank===2?D="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":x.gcRank===3&&(D="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),U=`<span class="rider-stats-rank-badge ${D}" title="GC Stand: Platz ${x.gcRank}">${x.gcRank}</span>`}const ne=`style="color: ${x.hasDropped?"var(--text-500)":$.color}; font-weight: bold;"`,q=s.has(x.riderId),te=d.has(x.riderId);return`<div class="results-roster-rider${w}">
  ...
  `}function Wn(e){const t=e.title||"";return t.includes("guten Tag")?1:t.includes("schlechten Tag")?2:t.includes("Formhöhepunkt")||t.includes("Formhoehepunkt")?3:t.includes("nicht am Start")?4:5}function Ha(e){var u,m,f,g,b,y,v,T,R,x;if(e==null||!c.stageResults)return"";const t=vt(c.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,r=c.stageResults.classifications,s=(m=(u=r.find($=>$.resultTypeId===Aa))==null?void 0:u.rows.find($=>$.rank===1))==null?void 0:m.riderId,n=(g=(f=r.find($=>$.resultTypeId===Dr))==null?void 0:f.rows.find($=>$.rank===1))==null?void 0:g.riderId,i=(y=(b=r.find($=>$.resultTypeId===ui))==null?void 0:b.rows.find($=>$.rank===1))==null?void 0:y.riderId,o=(T=(v=r.find($=>$.resultTypeId===5))==null?void 0:v.rows.find($=>$.rank===1))==null?void 0:T.riderId,d=(x=(R=r.find($=>$.resultTypeId===7))==null?void 0:R.rows.find($=>$.rank===1))==null?void 0:x.riderId,l=[],p=c.selectedResultTypeId;return e===s&&(p===Aa||p===1&&a||p!==1&&p!==Aa)&&l.push('<span class="jersey-dot jersey-dot-yellow" title="Gelbes Trikot (Gesamtwertung)"></span>'),e===n&&l.push('<span class="jersey-dot jersey-dot-green" title="Grünes Trikot (Punktewertung)"></span>'),e===i&&l.push('<span class="jersey-dot jersey-dot-red" title="Rotes Trikot (Bergwertung)"></span>'),e===o&&l.push('<span class="jersey-dot jersey-dot-white" title="Weißes Trikot (Nachwuchswertung)"></span>'),e===d&&l.push('<span class="jersey-dot jersey-dot-purple" title="Ausreißertrikot (Aktivste Fahrer)"></span>'),l.length===0?"":`<span class="jersey-dots-wrapper">${l.join("")}</span>`}function jn(e){if(!e)return"";let t=e;const a=[],r=[...c.riders].sort((n,i)=>{const o=`${n.firstName} ${n.lastName}`;return`${i.firstName} ${i.lastName}`.length-o.length});for(const n of r){const o=`${n.firstName} ${n.lastName}`.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"),d=new RegExp(`${o}(\\s+\\(\\d+\\.\\))?`,"g");d.test(t)&&(t=t.replace(d,l=>{const p=`__RIDER_LINK_${a.length}__`,u=De(l,{riderId:n.id,teamId:n.activeTeamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return a.push(u),p}))}let s=S(t);for(let n=0;n<a.length;n++)s=s.replace(`__RIDER_LINK_${n}__`,a[n]);return s}function Ie(){var _,E,O,z;c.riders.length===0&&V.getRiders().then(k=>{k.success&&k.data&&(c.riders=k.data,Ie())});const e=h("results-race-select"),t=h("results-stage-select"),a=h("results-type-tabs"),r=h("results-marker-tabs"),s=h("results-stage-meta"),n=h("results-empty"),i=h("results-table"),o=i.querySelector("thead tr"),d=h("results-tbody"),l=h("results-marker-classifications"),p=h("results-roster"),u=i.querySelector("colgroup");u&&u.remove(),i.style.tableLayout="",c.stageResults&&(c.selectedResultsRaceId=c.stageResults.raceId,c.selectedResultsStageId=c.stageResults.stageId),e.innerHTML='<option value="">– Rennen auswählen –</option>'+c.races.filter(k=>{var M;return(((M=k.stages)==null?void 0:M.length)??0)>0}).map(k=>`<option value="${k.id}"${k.id===c.selectedResultsRaceId?" selected":""}>${S(k.name)}</option>`).join("");const m=vt(c.selectedResultsRaceId),f=m==null?"":(m.stages??[]).map(k=>`<option value="${k.id}"${k.id===c.selectedResultsStageId?" selected":""}>${S(xp(m,k))}</option>`).join("");t.innerHTML='<option value="">– Etappe auswählen –</option>'+f;const g=((_=c.stageResults)==null?void 0:_.classifications.filter(k=>!(m&&!m.isStageRace&&k.resultTypeId!==1&&k.resultTypeId!==6)))??[],b=g.find(k=>k.resultTypeId===c.selectedResultTypeId)??g[0]??null,y=c.selectedResultsSpecialView==="nonFinishers",v=c.selectedResultsSpecialView==="events",T=c.selectedResultsSpecialView==="roster";if(b&&!y&&!v&&!T&&(c.selectedResultTypeId=b.resultTypeId),v){i.style.tableLayout="fixed";const k=document.createElement("colgroup");k.innerHTML=`
      <col style="width: 100px;">
      <col style="width: 240px;">
      <col style="width: auto;">
    `,i.insertBefore(k,i.firstChild)}if(!c.stageResults&&!T||!b&&!y&&!v&&!T){const k=Oa(c.selectedResultsStageId);s.textContent=k?`${k.race.name} · ${k.stage.profile} · ${oe(k.stage.date)}`:"Noch keine Etappe ausgewählt.",a.innerHTML="",r.innerHTML="",r.classList.add("hidden"),d.innerHTML="",l.innerHTML="",l.classList.add("hidden"),i.classList.add("hidden"),p.innerHTML="",p.classList.add("hidden"),n.classList.remove("hidden"),n.textContent=c.selectedResultsStageId!=null?"Für diese Etappe liegen noch keine Ergebnisse vor.":"Noch keine Ergebnisse geladen.";return}T?c.resultsRoster&&(s.textContent=`${c.resultsRoster.raceName} · Starterfeld`):c.stageResults&&(s.textContent=`${c.stageResults.raceName} · Etappe ${c.stageResults.stageNumber} · ${c.stageResults.profile} · ${oe(c.stageResults.date)}`);const R=c.stageResults?Oa(c.stageResults.stageId):null,x=(R==null?void 0:R.stage.distanceKm)??null,$=new Map,C=new Map,I=new Map;if(c.stageResults){const k=c.stageResults.classifications.find(M=>M.resultTypeId===1);if(k)for(const M of k.rows)M.riderId!=null&&M.points!=null&&M.points>0&&$.set(M.riderId,M.points),M.riderId!=null&&M.breakawayKms!=null&&M.breakawayKms>0&&I.set(M.riderId,M.breakawayKms);if(c.stageResults.markerClassifications){for(const M of c.stageResults.markerClassifications)if(bs(M.markerType,M.markerCategory)){for(const N of M.entries)if(N.riderId!=null&&N.pointsAwarded!=null&&N.pointsAwarded>0){const B=C.get(N.riderId)??0;C.set(N.riderId,B+N.pointsAwarded)}}}}const P=(b==null?void 0:b.resultTypeId)===Aa,F=(b==null?void 0:b.resultTypeId)===Dr||(b==null?void 0:b.resultTypeId)===ui,L=(b==null?void 0:b.resultTypeId)===5,H=(b==null?void 0:b.resultTypeId)===6,G=(b==null?void 0:b.resultTypeId)===7,K=P||F||L||H||G,w=g.map(k=>`
    <button
      type="button"
  ...
  `,ne=g.findIndex(k=>k.resultTypeName.toLocaleLowerCase("de").includes("team"));ne>=0?w.splice(ne+1,0,A,U,W):w.push(A,U,W),a.innerHTML=w.join("");const q=Sp(((E=c.stageResults)==null?void 0:E.markerClassifications)??[]);if(T){p.innerHTML=wp(),p.classList.remove("hidden"),i.classList.add("hidden"),r.innerHTML="",r.classList.add("hidden"),l.innerHTML="",l.classList.add("hidden"),n.classList.add("hidden");return}else p.innerHTML="",p.classList.add("hidden");const te=!y&&!v&&!T&&(b==null?void 0:b.resultTypeId)===1&&q.length>0,Y=te?c.selectedResultsMarkerKey??Ye:null,j=te&&Y!==Ye?q.find(k=>k.markerKey===Y)??null:null;if(te&&(c.selectedResultsMarkerKey=(j==null?void 0:j.markerKey)??Ye),v){const k=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"},{key:"superteam",label:"Superteam"}];r.innerHTML=k.map(M=>`
    ...
    `).join("")}else r.innerHTML=te?[`
        ...
        >${S(kp(k))}</button>
      `)].join(""):"";r.classList.toggle("hidden",!v&&!te);const D=y||v||!te||c.selectedResultsMarkerKey===Ye;if(o&&D&&(o.innerHTML=y?`
        <th>Etappe</th>
        <th>Status</th>
      ...
      <tr>
        ...
        <td>${Qt(k.riderName,!0,!1,k.riderId,k.teamId)}</td>
        <td class="results-flag-col-cell">${ot(k.countryCode)}</td>
        <td>${it(k.teamName||"–",k.teamId)}</td>
        <td>${S(_r(k.statusReason,k.isOtl))}</td>
      </tr>
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':v?[...((z=c.stageResults)==null?void 0:z.events)??[]].filter(k=>Ne==="all"?!0:Ne==="form"?!!(k.title&&(k.title.includes("guten Tag")||k.title.includes("schlechten Tag")||k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))):Ne==="attack"?(k.type==="attack"||k.type==="counter_attack")&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Ne==="breakaway"?!!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Ne==="incident"?(k.type==="incident"||!!(k.title&&k.title.includes("Massensturz")))&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Ne==="exit"?k.type==="dnf"||!!(k.title&&k.title.includes("nicht am Start")):Ne==="home"?!!(k.title&&(k.title.includes("Heimvorteil")||k.title.includes("Heimdruck"))):Ne==="weather"?!!(k.title&&k.title.startsWith("Wetterbericht:")):Ne==="superteam"?k.type==="superteam":!0).sort((k,M)=>{const N=k.kmMark??0,B=M.kmMark??0;if(Math.abs(N-B)>1e-4)return N-B;if(N===0){const me=Wn(k),fe=Wn(M);if(me!==fe)return me-fe}const Z=k.riderName??"",ie=M.riderName??"";return Z.localeCompare(ie,"de")}).map(k=>{var Lt,_s,As;const M=k.kmMark!=null?`${k.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",N=k.riderId,B=N!=null?Re(N):null,Z=k.riderTeamId??(B==null?void 0:B.activeTeamId)??null,ie=Z!=null?((Lt=c.teams.find(Sa=>Sa.id===Z))==null?void 0:Lt.name)??null:null;let me=Xt(Z,ie);const fe=!!(k.title&&k.title.startsWith("Wetterbericht:"));let be=k.title||"";if(fe){const Sa=(_s=c.stageResults)==null?void 0:_s.rolledWeatherId,yr=(As=c.stageResults)==null?void 0:As.rolledWetterName;me=`<span class="results-jersey-cell">${ps(Sa,yr)}</span>`,yr&&(be=`Wetterbericht: ${yr}`)}const ve=k.type==="superteam",ye=ve&&N==null,Se=fe||ye?"":ot(N!=null?Gt(N):null),at=fe?"":ye?it(ie||"–",Z):N!=null?Qt(k.riderName??"",!0,!1,N,Z):S(k.riderName||"–");let ee="";return k.title&&k.title.includes("guten Tag")?ee='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':k.title&&k.title.includes("schlechten Tag")?ee='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':k.title&&(k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))?ee='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':k.title&&k.title.includes("nicht am Start")?ee='<span class="event-badge event-badge-dns">DNS</span>':k.title&&k.title.includes("Massensturz")?ee='<span class="event-badge event-badge-masscrash">Massensturz</span>':k.type==="dnf"?ee='<span class="event-badge event-badge-dnf">DNF</span>':k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))?ee='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':k.type==="attack"?ee='<span class="event-badge event-badge-attack">Attacke</span>':k.type==="counter_attack"?ee='<span class="event-badge event-badge-counter">Konterattacke</span>':k.type==="incident"?k.title&&(k.title.toLowerCase().includes("defekt")||k.title.toLowerCase().includes("panne")||k.title.toLowerCase().includes("technisch"))?ee='<span class="event-badge event-badge-defect">Defekt</span>':ee='<span class="event-badge event-badge-crash">Sturz</span>':k.title&&k.title.includes("Super-Heimvorteil")?ee='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Heimbonus</span>':k.title&&k.title.includes("Heimdruck")?ee='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimmalus</span>':k.title&&k.title.includes("Heimvorteil")?ee='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':k.title&&k.title.startsWith("Wetterbericht:")?ee='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>':ve&&(ee='<span class="event-badge event-badge-superteam"><span class="event-icon">⚡</span> Superteam</span>'),`
          <tr>
            <td>${M}</td>
            <td>
          ...
          </tr>`}).join("")||'<tr><td colspan="3" class="results-empty-cell">Keine Ereignisse für diese Etappe.</td></tr>':D&&b?b.rows.map(k=>{const M=k.riderName??k.teamName,N=k.riderName?k.teamName:"–",B=Xt(k.teamId,k.teamName),Z=Qt(M,!0,k.isBreakaway===!0,k.riderId,k.teamId),ie=ot(Gt(k.riderId)),me=b.resultTypeId===1&&k.rank===1&&k.timeSeconds!=null&&x!=null,fe=k.timeSeconds!=null?`${ja(k.timeSeconds)}${me?` (${$p(x,k.timeSeconds)})`:""}`:"–",be=K?`<td class="results-gc-delta-cell">${ml(k.previousRank,k.rankDelta)}</td>`:"";if(F){let ye=k.points!=null?String(k.points):"–";if(k.points!=null&&k.riderId!=null&&b){const at=b.resultTypeId===Dr?$.get(k.riderId)??0:C.get(k.riderId)??0;at>0&&(ye+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${at}</span>`)}return`
          <tr>
            <td class="pos-${Math.min(k.rank,3)}">${k.rank}</td>
            ${be}
            <td class="results-jersey-col-cell">${B}</td>
            <td>${Z}${Ha(k.riderId)}</td>
            <td class="results-flag-col-cell">${ie}</td>
            <td>${it(N,k.teamId)}</td>
            <td class="results-points-cell">${ye}</td>
            <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
          </tr>`}if(G){let ye=k.breakawayKms!=null?`${k.breakawayKms.toFixed(1).replace(".",",")} km`:"–";if(k.breakawayKms!=null&&k.riderId!=null){const Se=I.get(k.riderId)??0;Se>0&&(ye+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${Se.toFixed(1).replace(".",",")} km</span>`)}return`
          <tr>
            <td class="pos-${Math.min(k.rank,3)}">${k.rank}</td>
            ${be}
            <td class="results-jersey-col-cell">${B}</td>
          ...
          <tr>
            ...
            <td class="results-flag-col-cell">${ie}</td>
            <td>${fe}</td>
            <td>${S(vr(k.gapSeconds))}</td>
            <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
          </tr>`;let ve=k.points!=null?String(k.points):"–";if(k.leadoutBonus!=null&&k.leadoutBonus>0&&k.leadoutRiderId!=null){const ye=Rp(k);ve=`
        ...
        <tr>
          ...
          <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
        </tr>`}).join(""):"",n.classList.toggle("hidden",!!b||y||v||T),i.classList.toggle("hidden",!D||T),j){const k=`
    ...
    <div class="team-detail-page-tabs" role="tablist" aria-label="Fahrer-Detailseite">
      ${ba.map(e=>{const t={skills:"Werte",form:"Saisonform",profile:"Fahrertyp & Peaks",preferences:"Programm & Mentoren"};return`
          <button
            type="button"
    ...
    <div class="team-detail-card">
      ...
      <div class="team-detail-meta" style="margin-top:0.75rem">
        ...
        <span class="text-muted">Sortierung: ${S(xs(c.teamTableSort.key))} ${c.teamTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${Co()}
...
`+(a.error??"Unbekannter Fehler")),!1;const r=a.data;c.realtimeBootstrap=r;const s=await Sc(r,o=>gi(o)),n=Lo(s,r),i=Do(s,r);return await Ko(e,n,s.markerClassifications,s.incidents,s.allEvents,t,i,s.superTeamId),!0}catch(a){return alert("Unerwarteter Fehler bei der Instant-Simulation: "+a.message),!1}finally{Hs(null),$e()}}function Ao(e){var r;const t=(r=c.rosterEditor)==null?void 0:r.teams.find(s=>s.team.id===e);if(!t)return 0;const a=new Set(c.rosterEditorSelectedRiderIds);return t.riders.filter(s=>a.has(s.rider.id)).length}function Bo(){return c.rosterEditor?c.rosterEditor.teams.every(e=>Ao(e.team.id)===e.riderLimit):!1}function Er(){const e=h("roster-editor-title"),t=h("roster-editor-meta"),a=h("roster-editor-body"),r=h("btn-apply-roster-editor"),s=c.rosterEditor;if(!s){e.textContent="Starterfeld bearbeiten",t.textContent="",a.innerHTML='<div class="results-empty">Kein Starterfeld geladen.</div>',r.disabled=!0;return}e.textContent="Starterfeld bearbeiten",t.textContent=s.race.isStageRace?`${s.race.name} · Etappe ${s.stage.stageNumber} · ${s.stage.profile}`:`${s.race.name} · ${s.stage.profile}`;const n=new Set(c.rosterEditorSelectedRiderIds);a.innerHTML=s.teams.map(i=>{const o=Ao(i.team.id),d=o===i.riderLimit?"roster-editor-team-count-ok":"roster-editor-team-count-bad";return`
      ...
      </section>`}).join(""),r.disabled=!Bo()}function Vr(){c.rosterEditor=null,c.rosterEditorSelectedRiderIds=[],ca("roster-editor-error"),Ue("rosterEditor")}function Ho(e,t){c.selectedRealtimeStageId=e.stage.id,c.realtimeBootstrap=e,c.realtimeError=null,t&&Nt("live-race"),Go().load(e,{autoplay:!0,resetSpeed:!0}),jt()}function Go(){let e=aa;if(!e){const t=h("race-sim-layout"),a=h("race-sim-empty");if(!t||!a)throw new Error("Simulation HTML elemente fehlen.");e=new vp({layout:t,emptyState:a,controlsHeader:h("race-sim-controls-header"),profile:h("race-sim-profile"),groupBox:h("race-sim-group-box"),messages:h("race-sim-messages-body"),favorites:h("race-sim-favorites-body"),sidebar:h("race-sim-sidebar-body"),controls:h("race-sim-controls"),meta:h("race-sim-stage-meta")},{onFinishRequested:(r,s)=>{const n=Lo(r,s),i=Do(r,s);Ko(s.stage.id,n,r.markerClassifications,r.incidents,r.allEvents,!1,i,r.superTeamId)}}),cl(e)}return e}async function Np(e){Me("Starterfeld wird geladen..."),ca("roster-editor-error");try{const t=await V.getRosterEditor(e);if(!t.success||!t.data){Mt("roster-editor-error",t.error??"Starterfeld konnte nicht geladen werden."),qe("rosterEditor"),Er();return}c.rosterEditor=t.data,c.rosterEditorSelectedRiderIds=t.data.teams.flatMap(a=>a.riders.filter(r=>r.isSelected).map(r=>r.rider.id)),Er(),qe("rosterEditor")}catch(t){c.rosterEditor=null,c.rosterEditorSelectedRiderIds=[],Mt("roster-editor-error",t.message),qe("rosterEditor"),Er()}finally{$e()}}async function Lp(){const e=c.rosterEditor;if(e){if(!Bo()){Mt("roster-editor-error","Dein Team muss genau die erlaubte Zahl an Fahrern stellen.");return}ca("roster-editor-error"),Me("Starterfeld wird übernommen...");try{const t=await V.applyRosterEditor(e.stage.id,{riderIds:c.rosterEditorSelectedRiderIds});if(!t.success||!t.data){Mt("roster-editor-error",t.error??"Starterfeld konnte nicht übernommen werden.");return}Vr(),Ho(t.data,!0)}catch(t){Mt("roster-editor-error",t.message)}finally{$e()}}}function jt(){var n,i;const e=h("race-sim-stage-select"),t=((n=c.gameStatus)==null?void 0:n.pendingStages)??[];t.some(o=>o.stageId===c.selectedRealtimeStageId)||(c.selectedRealtimeStageId=((i=t[0])==null?void 0:i.stageId)??null,c.realtimeBootstrap&&c.realtimeBootstrap.stage.id!==c.selectedRealtimeStageId&&(c.realtimeBootstrap=null)),e.innerHTML=t.length===0?'<option value="">– Keine offenen Etappen –</option>':t.map(o=>`
      <option value="${o.stageId}"${o.stageId===c.selectedRealtimeStageId?" selected":""}>${S(Pp(o.raceName,o.stageNumber,o.profile))}</option>
    `).join(""),e.disabled=t.length===0;const r=t.find(o=>o.stageId===c.selectedRealtimeStageId)??null,s=Go();if(!r){c.realtimeBootstrap=null,c.realtimeError=null,s.clear("Heute gibt es keine offenen Etappen für die Live-Simulation.");return}(!c.realtimeBootstrap||c.realtimeBootstrap.stage.id!==r.stageId)&&(c.realtimeError?s.clear(c.realtimeError):s.hide())}async function zo(e,t){if(Lr!==e){Gs(e),c.selectedRealtimeStageId=e,t&&Nt("live-race"),jt(),Me("Live-Simulation wird geladen...");try{const a=await V.getRealtimeSimulation(e);if(!a.success||!a.data){c.realtimeBootstrap=null,c.realtimeError=a.error??"Live-Simulation konnte nicht geladen werden.",jt(),alert(`Live-Simulation fehlgeschlagen:
`+(a.error??"Unbekannter Fehler"));return}Ho(a.data,!1)}catch(a){c.realtimeBootstrap=null,c.realtimeError=a.message,jt(),alert("Unerwarteter Fehler bei der Live-Simulation: "+a.message)}finally{Lr===e&&Gs(null),$e()}}}async function Ko(e,t,a,r,s,n=!1,i,o){if(!Xr){Bs(!0),Me("Live-Ergebnis wird gespeichert...");try{const d=await V.completeRealtimeSimulation(e,{entries:t,markerClassifications:a,incidents:r,events:s,leadoutContributions:i,superTeamId:o});if(!d.success){alert(`Live-Ergebnis konnte nicht gespeichert werden:
`+(d.error??"Unbekannter Fehler"));return}const l=d.data;c.selectedResultsRaceId=(l==null?void 0:l.raceId)??c.selectedResultsRaceId,c.selectedResultsStageId=(l==null?void 0:l.stageId)??e,c.selectedResultTypeId=1,c.realtimeBootstrap=null,c.realtimeError=null,await jr(e,!1),await Rs(),await Is(),await rr(),jt(),n||Nt("results")}catch(d){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+d.message)}finally{Bs(!1),$e()}}}function Dp(){h("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);c.selectedRealtimeStageId=Number.isFinite(t)?t:null,c.realtimeBootstrap&&c.realtimeBootstrap.stage.id!==c.selectedRealtimeStageId&&(c.realtimeBootstrap=null),c.realtimeError=null,zo(t,!1)})}function Ms(e){var r;const t=ct((r=e.category)==null?void 0:r.name),a=or(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function mr(e){var s,n;const t=ct((s=e.category)==null?void 0:s.name),a=or(t),r=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(r)}</span>`}function _p(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(r=>r.date).sort((r,s)=>r.localeCompare(s));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function pr(e){const{startDate:t,endDate:a}=_p(e);return t===a?oe(t):`${oe(t)} - ${oe(a)}`}function Ap(e){return e.stageId>0}async function Rs(){const[e,t]=await Promise.all([V.getGameState(),V.getGameStatus()]);if(!e.success){console.error(e.error);return}c.gameState=e.data??null,c.gameStatus=t.success?t.data??null:null,Bp(),we("dashboard")&&gr()}function Bp(){var s;if(!c.gameState)return;h("meta-date").textContent=c.gameState.formattedDate,h("meta-season").textContent=`Saison ${c.gameState.season}`;const e=h("meta-race-hint"),t=h("btn-advance-day"),a=h("pending-stages-list"),r=((s=c.gameStatus)==null?void 0:s.pendingStages)??[];r.length>0?(e.textContent=`${r.length} offene Etappe${r.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=r.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${oe(n.date)}`:`${n.profile} · ${oe(n.date)}`,o=Ap(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
  ...
  `,s.length===0?n+=`
    ...
    `:n+=s.map(i=>On(i)).join(""),e.innerHTML=n}function ya(e){return`Etappe ${e.stageNumber}`}function Wp(e){if(e.length===0)return"Keine Etappen";const t=new Map;return e.forEach(a=>{t.set(a.profile,(t.get(a.profile)??0)+1)}),Array.from(t.entries()).sort((a,r)=>r[1]!==a[1]?r[1]-a[1]:a[0].localeCompare(r[0])).map(([a,r])=>`${r}x ${a}`).join(" · ")}function jp(e){return`stage-profile-badge-${e.toLowerCase().replace(/_/g,"-")}`}function va(e){return`<span class="stage-profile-badge ${jp(e)}">${S(e)}</span>`}function fr(e,t){return`${e.name} · ${ya(t)} · ${t.profile}`}async function Op(e){var s;const t=c.stageSummariesByStageId[e];if(t)return t;const a=await V.getStageSummary(e);if(a.success&&a.data)return c.stageSummariesByStageId[e]=a.data,c.stageSummaryErrorsByStageId&&delete c.stageSummaryErrorsByStageId[e],a.data;const r=await V.getRealtimeSimulation(e);return r.success&&((s=r.data)!=null&&s.stageSummary)?(c.stageSummariesByStageId[e]=r.data.stageSummary,c.stageSummaryErrorsByStageId&&delete c.stageSummaryErrorsByStageId[e],r.data.stageSummary):(c.stageSummaryErrorsByStageId&&(c.stageSummaryErrorsByStageId[e]=a.error??r.error??"Etappenprofil konnte nicht geladen werden."),console.error("Stage-Summary-Laden fehlgeschlagen:",{stageId:e,stageSummaryError:a.error,realtimeFallbackError:r.error}),c.stageSummariesByStageId&&delete c.stageSummariesByStageId[e],!a.success||!a.data?null:a.data)}function Vp(){var d;const e=h("race-stages-title"),t=h("race-stages-meta"),a=h("race-stages-body"),r=vt(c.selectedDashboardRaceId);if(!r){e.textContent="Etappen",t.textContent="",a.innerHTML='<div class="results-empty">Rennen nicht gefunden.</div>';return}const s=r.stages??[],n=s.reduce((l,p)=>l+(p.distanceKm??0),0),i=s.reduce((l,p)=>l+(p.elevationGainMeters??0),0),o=Wp(s);if(e.textContent=r.name,t.textContent=`${pr(r)} · ${((d=r.country)==null?void 0:d.name)??`Land ${r.countryId}`} · ${r.isStageRace?`${r.numberOfStages} Etappen`:"Eintagesrennen"} · ${Ar(n)} · ${Br(i)} · ${o}`,s.length===0){a.innerHTML='<div class="results-empty">Für dieses Rennen sind keine Etappen vorhanden.</div>';return}a.innerHTML=`
        ...
        <tbody>
          ${s.map(l=>`
              <tr class="dashboard-race-stage-row">
                ...
                <td>${va(l.profile)}</td>
                <td>${l.distanceKm!=null?Ar(l.distanceKm):"–"}</td>
                <td>${l.elevationGainMeters!=null?Br(l.elevationGainMeters):"–"}</td>
                <td>
                  <button
                    type="button"
                    class="dashboard-stage-profile-link"
                    data-dashboard-stage-profile-id="${l.id}"
                    aria-label="Profil von ${S(fr(r,l))} öffnen"
                  >
                    Profil anzeigen
                  </button>
                </td>
    ...
    </div>`}async function Ur(e){vt(e)&&(c.selectedDashboardRaceId=e,Vp(),qe("raceStages"))}function Up(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
        ...
        <tbody>
          ${t.map(a=>{var r,s;return`
            <tr class="race-participants-row">
              ...
              <td><span class="race-participant-rider-cell">${de(Et(a.rider))}<strong>${S(_e(a.rider))}</strong></span></td>
              <td>${S(Yr(a.rider))}</td>
              <td>${S(yt(a.rider))}</td>
    ...
    </th>`}function Zp(e){const t=c.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,r)=>{var n,i,o,d;let s=0;switch(c.raceParticipantsSort.key){case"team":s=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=r.team)==null?void 0:i.name)??"","de");break;case"rider":s=_e(a.rider).localeCompare(_e(r.rider),"de");break;case"spec1":s=Yr(a.rider).localeCompare(Yr(r.rider),"de");break;case"role":s=yt(a.rider).localeCompare(yt(r.rider),"de");break;case"overall":s=a.rider.overallRating-r.rider.overallRating;break;case"phase":s=(a.rider.seasonFormPhase??"neutral").localeCompare(r.rider.seasonFormPhase??"neutral","de");break;default:s=(((o=a.program)==null?void 0:o.name)??"").localeCompare(((d=r.program)==null?void 0:d.name)??"","de")}return s*t||_e(a.rider).localeCompare(_e(r.rider),"de")})}function Yr(e){return e.specialization1!=null?ra(e.specialization1):"–"}async function Wo(e){const t=vt(e);c.selectedRaceParticipantsRaceId=e,h("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",h("race-participants-meta").textContent="Lade Programmfahrer ...",h("race-participants-body").innerHTML="",c.raceParticipants=[],qe("raceParticipants"),await jo()}async function jo(e=!1){const t=c.selectedRaceParticipantsRaceId;if(t==null)return;const a=vt(t);e&&(h("race-participants-meta").textContent="Lade Programmfahrer ...");const r=await V.getRaceProgramParticipants(t);if(!r.success||!r.data){h("race-participants-meta").textContent="",h("race-participants-body").innerHTML=`<div class="results-empty">${S(r.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}c.raceParticipants=r.data,h("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",h("race-participants-meta").textContent=`${r.data.length} Programmfahrer · ${a?pr(a):""}`,h("race-participants-body").innerHTML=Yp(c.raceParticipants)}async function sr(e,t=null){let a=Oa(e);if(!a&&c.stageEditorStageRows){const n=c.stageEditorStageRows.find(i=>i.stageId===e);n&&(a={race:{id:n.raceId,name:n.raceName,countryId:0,categoryId:0,isStageRace:!0,numberOfStages:1,startDate:"",endDate:"",prestige:0},stage:{id:n.stageId,raceId:n.raceId,stageNumber:n.stageNumber,date:"2026-01-01",profile:n.profile,startElevation:0,detailsCsvFile:"",distanceKm:n.distanceKm,elevationGainMeters:n.elevationGainMeters}})}if(!a)return;const r=await Op(e);if(!r){alert(c.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}c.selectedDashboardProfileStageId=e,h("stage-profile-title").textContent=`${a.race.name} · ${ya(a.stage)}`;const s=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";h("stage-profile-meta").textContent=`${oe(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?Ar(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?Br(a.stage.elevationGainMeters):"–"}${s}`,Bl(h("stage-profile-view"),r,a.stage.profile,fr(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),qe("stageProfile")}function Jp(){h("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const s=Number(t.dataset.editStageRoster);if(!Number.isFinite(s))return;Np(s);return}const a=e.target.closest("button[data-live-stage]");if(a){const s=Number(a.dataset.liveStage);if(!Number.isFinite(s))return;zo(s,!0);return}const r=e.target.closest("button[data-instant-stage]");if(r){const s=Number(r.dataset.instantStage);if(!Number.isFinite(s))return;_o(s)}}),h("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const s=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(s)&&Wo(s);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const r=Number(a.dataset.dashboardRaceId);Number.isFinite(r)&&Ur(r)}),h("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&sr(a)}),h("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const s=Number(t.dataset.riderProgramId);Number.isFinite(s)&&Cs(s);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const r=a.dataset.raceParticipantsSort;c.raceParticipantsSort.key===r?c.raceParticipantsSort.direction=c.raceParticipantsSort.direction==="asc"?"desc":"asc":c.raceParticipantsSort={key:r,direction:"asc"},jo()}),h("btn-advance-day").addEventListener("click",async()=>{await Oo()}),h("btn-auto-progress").addEventListener("click",()=>{qp()})}async function Oo(){Me("Tag wird fortgeschrieben...");try{const e=await V.advanceDay();if(!e.success)return alert(`Tageswechsel fehlgeschlagen:
`+(e.error??"Unbekannter Fehler")),!1;if(c.currentSave&&e.data&&(c.currentSave.currentSeason=e.data.season),await Rs(),await Is(),we("teams")){const{refreshTeamsViewData:t}=await vi(async()=>{const{refreshTeamsViewData:a}=await Promise.resolve().then(()=>Fp);return{refreshTeamsViewData:a}},void 0);await t()}return!0}catch(e){return alert("Unerwarteter Fehler beim Tageswechsel: "+e.message),!1}finally{$e()}}function Es(){const e=document.getElementById("btn-auto-progress");e&&(ut?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function qp(){ut?nr():Vo()}function Vo(){ut||(ci(!0),Es(),Xp())}function nr(){ut&&(ci(!1),c.autoProgressTargetDate=null,Es())}async function Xp(){var e,t;for(;ut;){const a=(e=c.gameState)==null?void 0:e.currentDate;if(c.autoProgressTargetDate&&a&&a>=c.autoProgressTargetDate){nr();break}const r=((t=c.gameStatus)==null?void 0:t.pendingStages)??[];let s=!1;if(r.length>0){const n=r[0];s=await _o(n.stageId,!0)}else s=await Oo();if(!s){nr();break}await new Promise(n=>setTimeout(n,100))}Es()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&ut){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),nr()}});const la=50;function Fs(){return[...vs,...Ss[c.riderMenuDetailPage]]}function Uo(e){return c.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${c.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function Yo(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=c.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </div>`}function Ga(){const e=h("riders-detail"),t=Fs(),a=Po(c.riders),r=a.length,s=Math.max(1,Math.ceil(r/la));c.riderMenuPage=Math.min(s,Math.max(1,c.riderMenuPage));const n=(c.riderMenuPage-1)*la,i=Math.min(r,n+la),o=a.slice(n,i);e.innerHTML=`
    <div class="team-detail-card">
      <div class="team-detail-header">
        <h3>Alle Fahrer</h3>
      </div>
      <div class="team-detail-meta" style="margin-top:0.75rem">
        <span>${r} Fahrer</span>
        <span class="text-muted">Sortierung: ${S(xs(c.riderMenuTableSort.key))} ${c.riderMenuTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${Zo()}
      <div class="team-detail-table-scroll">
        <table class="data-table data-table-teams">
      ...
      <section class="rider-team-editor-main">
        <div class="team-detail-card">
          <div class="rider-team-editor-toolbar">
            ...
            <div class="team-detail-meta">
              <span>${i}</span>
              <span class="text-muted">Sortierung: ${S(c.riderTeamEditorSort.key==="teamName"?"Team":((o=Da.find(d=>d.key===c.riderTeamEditorSort.key))==null?void 0:o.title)??c.riderTeamEditorSort.key)} ${c.riderTeamEditorSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
          ...
          <div class="team-detail-table-scroll rider-team-editor-table-scroll">
            <table class="data-table data-table-teams rider-team-editor-table">
              ...
              <tbody>
                ${s.length===0?`<tr><td colspan="${Da.length}" class="text-muted">${c.riderTeamEditorSelectedTeamKey?"Keine Fahrer im aktuellen Team.":"Bitte zuerst ein Team im Dropdown auswählen."}</td></tr>`:s.map(d=>`
                    <tr class="team-detail-row${qo(d.riderId)?" rider-team-editor-row-dirty":""}">
                      ${Da.map(l=>lg(d,l)).join("")}
                    </tr>
                  `).join("")}
              </tbody>
            </table>
...
`+a.error);return}c.draftHistory=a.data??null,we("draft")&&Zr()}function Zr(){const e=h("draft-table-container"),t=h("draft-season-select");if(!c.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(t.options.length===0){const i=c.currentSave.startSeason??2026;for(let o=c.currentSave.currentSeason;o>=i;o--){const d=document.createElement("option");d.value=o.toString(),d.textContent=`Saison ${o}`,t.appendChild(d)}c.draftSelectedSeason||(c.draftSelectedSeason=c.currentSave.currentSeason),t.value=c.draftSelectedSeason.toString(),t.onchange=o=>{const d=o.target;c.draftSelectedSeason=parseInt(d.value,10),Qo(c.draftSelectedSeason)}}if(!c.draftHistory){e.innerHTML='<div class="alert alert-info">Lade Draft Historie...</div>';return}if(c.draftHistory.rows.length===0){e.innerHTML='<div class="alert alert-info">Keine Draft-Einträge für diese Saison vorhanden.</div>';return}const a=[...c.draftHistory.rows].sort((i,o)=>{let d=0;const l=st.key;return l==="riderLastName"?d=i.riderLastName.localeCompare(o.riderLastName):l==="teamName"?d=i.teamName.localeCompare(o.teamName):l==="oldTeamName"?d=(i.oldTeamName||"").localeCompare(o.oldTeamName||""):l==="countryCode"?d=i.countryCode.localeCompare(o.countryCode):d=(i[l]??0)-(o[l]??0),st.asc?d:-d}),r=i=>st.key!==i?'<span class="sort-icon-placeholder"></span>':st.asc?" ▲":" ▼",s=i=>{st.key===i?st.asc=!st.asc:(st.key=i,st.asc=!0),Zr()};window.setDraftSort=s;let n=`
    <table class="data-table">
      ...
      <tbody>
  `;for(const i of a){const o=c.draftHistory.season-i.riderBirthYear;let d="-";i.oldTeamName&&(d=`<div style="display:flex; align-items:center; gap:0.5rem;">${Ct(i.oldTeamId,i.oldTeamName)} ${S(i.oldTeamName)}</div>`);const l=`<div style="display:flex; align-items:center; gap:0.5rem;">${Ct(i.teamId,i.teamName)} ${S(i.teamName)}</div>`;n+=`
      <tr>
...
`+t.error);return}c.injuries=t.data??[],we("injuries")&&Yn()}function Yn(){const e=h("injuries-table-container");if(!c.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(h("injuries-meta").textContent=c.injuries.length+" Ausfälle",c.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=Yt;let t="";const a=c.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),r=new Map;for(const n of a){const i=n.teamId;r.has(i)||r.set(i,[]),r.get(i).push(n)}for(const n of r.keys())r.get(n).sort((i,o)=>o.overallRating-i.overallRating);const s=Array.from(r.keys()).sort((n,i)=>{const o=r.get(n)[0].teamAbbreviation||"",d=r.get(i)[0].teamAbbreviation||"";return o.localeCompare(d)});if(s.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of s){const i=r.get(n),o=i[0].teamAbbreviation;t+=`
      ...
      `;for(const d of i){const l=d.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let p="";if(d.fitDate){const u=oe(d.fitDate);if(d.missedRaces&&d.missedRaces.length>0){let m="";for(const f of d.missedRaces)m+=`
          ...
          <tr>
            ...
            <td>${d.age}</td>
            <td><span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;">${yo(d.overallRating)}</span></td>
            <td>${l}</td>
    ...
    </div>`}function yg(e,t){const a=t.filter(r=>r.teamId!=null&&e.teamId!=null&&r.teamId===e.teamId).slice(0,30);return a.length===0?'<div class="season-standings-country-popover-empty">Noch keine Fahrer mit Saisonpunkten.</div>':`
    <div class="season-standings-country-popover-card">
      <div class="season-standings-country-popover-head">
    ...
    </div>`}async function Sg(e){const t=await V.getSeasonStandings();if(!t.success){c.seasonStandings=null,we("season-standings")&&Jr();return}c.seasonStandings=t.data??null,we("season-standings")&&Jr()}function Jr(){var g,b,y,v,T,R;const e=h("season-standings-meta"),t=h("season-standings-scope-tabs"),a=h("season-standings-empty"),r=h("season-standings-table"),s=h("season-standings-tbody"),n=h("season-standings-jersey-header"),i=h("season-standings-primary-header"),o=h("season-standings-flag-header"),d=h("season-standings-secondary-header"),l=((g=c.seasonStandings)==null?void 0:g.season)??((b=c.gameState)==null?void 0:b.season)??((y=c.currentSave)==null?void 0:y.currentSeason)??null;e.textContent=l!=null?`Saison ${l} · Ergebnis- und Trikotpunkte kumuliert`:"Noch keine Saisonwertung geladen.",t.innerHTML=`
    <button
      type="button"
  ...
  `;const p=c.selectedSeasonStandingScope==="countries",u=p?((v=c.seasonStandings)==null?void 0:v.countryStandings)??[]:c.selectedSeasonStandingScope==="teams"?((T=c.seasonStandings)==null?void 0:T.teamStandings)??[]:((R=c.seasonStandings)==null?void 0:R.riderStandings)??[],m=p?u:[],f=p?[]:u;if(n.textContent="Trikot",i.textContent=p?"Land":c.selectedSeasonStandingScope==="teams"?"Team":"Fahrer",o.textContent="Flagge",d.textContent=c.selectedSeasonStandingScope==="teams"?"Land":"Team",n.classList.toggle("hidden",p),d.classList.toggle("hidden",p),!c.seasonStandings||u.length===0){s.innerHTML="",r.classList.add("hidden"),a.classList.remove("hidden"),a.textContent="Noch keine Saisonpunkte vorhanden.";return}s.innerHTML=p?m.map(x=>`
      ...
      </tr>`).join(""):f.map(x=>{var L;const $=x.riderName??x.teamName,C=Xt(x.teamId,x.teamName),I=c.selectedSeasonStandingScope==="teams"?vg(x,((L=c.seasonStandings)==null?void 0:L.riderStandings)??[]):Qt($,!0,!1,x.riderId,x.teamId),P=ot(x.countryCode),F=c.selectedSeasonStandingScope==="teams"?S(x.countryName??x.countryCode??"–"):it(x.teamName??"–",x.teamId,!1);return`
        <tr>
          <td class="pos-${Math.min(x.rank,3)}">${x.rank}</td>
    ...
    `}).join(""),i=[...e.riders].sort((l,p)=>(p.overallRating??0)-(l.overallRating??0)).slice(0,10).map(l=>{const p=`${l.firstName.charAt(0)}. ${l.lastName}`,u=De(p,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),m=l.nationality?Ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,f=m?`<span class="fi fi-${m} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",g=l.overallRating.toFixed(0),b=c.riders.find(v=>v.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${_a((b==null?void 0:b.roleId)??null).color};">
          ${f}
          ${u}
        </span>
        <span style="font-weight: 700; color: var(--text-300); font-size: 0.8rem;">${g}</span>
      </li>
    `}).join(""),o=a.map(({rider:l,formValue:p})=>{const u=`${l.firstName.charAt(0)}. ${l.lastName}`,m=De(u,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=l.nationality?Ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",b=(p>=0?"+":"")+p.toFixed(1).replace(".",","),y=`S-Form: ${l.formBonus>=0?"+":""}${l.formBonus.toFixed(1)} / R-Form: ${l.raceFormBonus>=0?"+":""}${l.raceFormBonus.toFixed(1)}`,v=c.riders.find(R=>R.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${_a((v==null?void 0:v.roleId)??null).color};">
          ${g}
          ${m}
        </span>
        <span style="font-weight: 700; color: #fbbf24;" title="${y}">${b}</span>
      </li>
    `}).join(""),d=r.map(({rider:l,uciRank:p})=>{const u=`${l.firstName.charAt(0)}. ${l.lastName}`,m=De(u,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=l.nationality?Ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"";let b="rider-stats-rank-badge-gc";p===1?b="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":p===2?b="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":p===3&&(b="rider-stats-rank-badge-place rider-stats-rank-badge-top-3");const y=`<span class="rider-stats-rank-badge ${b}" style="margin: 0; font-size: 0.75rem; padding: 0; min-width: 2rem; height: 1.35rem; display: inline-flex; align-items: center; justify-content: center; text-align: center; box-sizing: border-box; line-height: 1;" title="UCI Weltrangliste: Platz ${p}">${p}</span>`,v=c.riders.find(R=>R.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${_a((v==null?void 0:v.roleId)??null).color};">
          ${g}
          ${m}
  ...
  `,p=o.length===0?'<tr><td colspan="11" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':o.map(m=>{const f=m.rowType!=="stage_result",g=f?`${m.raceName} · ${m.rowType==="gc_final"?"Gesamtwertung":m.rowType==="points_final"?"Punktewertung":m.rowType==="mountain_final"?"Bergwertung":"Nachwuchs"}`:m.stageNumber?`${m.raceName} · Etappe ${m.stageNumber}`:m.raceName;let b="–",y="–";m.finishStatus==="otl"?b=Pt("OTL","place"):m.finishStatus==="dnf"?b=Pt("DNF","place"):m.resultRank==null||(f?y=`<span class="rider-stats-final-type ${m.rowType==="gc_final"?"is-gc":m.rowType==="points_final"?"is-points":m.rowType==="mountain_final"?"is-mountain":"is-youth"}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${m.resultRank}</span>`:b=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${m.resultRank<=3?` rider-stats-rank-badge-top-${m.resultRank}`:""}">${S(String(m.resultRank))}</span>`);const v=m.profile?va(m.profile):"–",T=!f&&m.stageScore!=null&&m.stageScore>0?ur(m.stageScore,0,350):"–",R=tr(m.raceCategoryName),x=m.riderCountryCode?Ze[m.riderCountryCode]??m.riderCountryCode.slice(0,2).toLowerCase():null,$=x?`<span class="fi fi-${x} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px;" title="${S(m.riderCountryCode??"")}"></span>`:"–",C=De(m.riderName,{riderId:m.riderId,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return`
  ...
  `,qe("teamStats");const s=await V.getTeamStats(e);if(c.teamStatsSelectedTeamId===e){if(!s.success||!s.data){h("team-stats-body").innerHTML=`
    ...
    `;return}c.teamStatsPayload=s.data,h("team-stats-body").innerHTML=Tt(s.data)}}function Fg(){h("team-stats-body").addEventListener("click",e=>{const t=e.target,a=t.closest("button[data-team-stats-tab]");if(a){const s=a.dataset.teamStatsTab;(s==="topResults"||s==="career"||s==="contracts")&&(c.teamStatsTab=s,c.teamStatsPayload&&(h("team-stats-body").innerHTML=Tt(c.teamStatsPayload)));return}const r=t.closest("button[data-team-top-results-page]");if(r){const s=Number(r.dataset.teamTopResultsPage);!isNaN(s)&&s>=1&&(c.teamStatsTopResultsPage=s,c.teamStatsPayload&&(h("team-stats-body").innerHTML=Tt(c.teamStatsPayload)));return}}),h("team-stats-body").addEventListener("change",e=>{const t=e.target;if(t.id==="team-stats-filter-category"){const a=t;c.teamStatsTopResultsFilterCategory=a.value==="all"?null:a.value,c.teamStatsTopResultsPage=1,c.teamStatsPayload&&(h("team-stats-body").innerHTML=Tt(c.teamStatsPayload))}else if(t.id==="team-stats-filter-season"){const a=t;c.teamStatsTopResultsFilterSeason=a.value==="all"?null:Number(a.value),c.teamStatsTopResultsPage=1,c.teamStatsPayload&&(h("team-stats-body").innerHTML=Tt(c.teamStatsPayload))}else if(t.classList.contains("team-stats-filter-checkbox")){const a=t,r=a.dataset.filterType;c.teamStatsTopResultsFilters[r]=a.checked,c.teamStatsTopResultsPage=1,c.teamStatsPayload&&(h("team-stats-body").innerHTML=Tt(c.teamStatsPayload))}else if(t.id==="team-stats-success-season-select"){const a=t;c.teamStatsSelectedSeason=a.value==="all"?"all":Number(a.value),c.teamStatsPayload&&(h("team-stats-body").innerHTML=Tt(c.teamStatsPayload))}})}let Bt="riders",dt="season",Ps="season",Je="";const ir=["leaderboard-select-performance","leaderboard-select-load","leaderboard-select-physis","leaderboard-select-action","leaderboard-select-jersey","leaderboard-select-events"];function Pg(){const e=h("leaderboards-scope-tabs");if(e){const n=e.querySelectorAll("button");n.forEach(i=>{i.addEventListener("click",()=>{n.forEach(d=>d.classList.remove("active")),i.classList.add("active");const o=i.getAttribute("data-scope");Lg(o)})})}const t=h("leaderboards-period-tabs");if(t){const n=t.querySelectorAll("button");n.forEach(i=>{i.addEventListener("click",()=>{if(i.hasAttribute("disabled"))return;n.forEach(d=>d.classList.remove("active")),i.classList.add("active");const o=i.getAttribute("data-period");Dg(o)})})}ir.forEach(n=>{const i=h(n);i&&i.addEventListener("change",()=>{const o=i.value;o?_g(o,n):ir.some(l=>{const p=h(l);return p&&p.value!==""})||(Je="",Zt())})}),window.openRiderStatsFromLeaderboard=Yt;const a=h("leaderboard-filter-wt"),r=h("leaderboard-filter-pt"),s=h("leaderboard-filter-other");[a,r,s].forEach(n=>{n&&n.addEventListener("change",()=>{Zt()})})}function Ng(){Zt()}function Lg(e){Bt=e;const t=h("leaderboard-group-physis");t&&(t.style.display=e==="teams"?"none":"block"),e==="teams"&&((Ag(Je)||Je==="strongest_lieutenants")&&(Bg(),Je=""),dt==="live"&&(dt=Ps,za())),Zt()}function Dg(e){dt=e,Ps=e,Zt()}function _g(e,t){Je=e,ir.forEach(a=>{if(a!==t){const r=h(a);r&&(r.value="")}}),tl(e)?(dt="live",za()):Ns(e)?(dt="alltime",za()):(dt=Ps,za()),Zt()}function tl(e){return["fatigue_short","fatigue_long","fatigue_combined","form_r","form_s","form_combined"].includes(e)}function Ns(e){return["max_short_term_fatigue","max_long_term_fatigue","max_combined_fatigue","max_s_form","max_r_form","max_combined_form","mentors_ranking"].includes(e)||e.startsWith("youngest_winners")}function Ag(e){return tl(e)||Ns(e)||e==="mentors_ranking"}function Bg(){ir.forEach(e=>{const t=h(e);t&&(t.value="")})}function za(){const e=h("leaderboards-period-tabs");if(!e)return;const t=e.querySelector('button[data-period="season"]'),a=e.querySelector('button[data-period="alltime"]');dt==="live"?e.style.display="none":(e.style.display="flex",Ns(Je)?(t&&(t.disabled=!0,t.classList.remove("active"),t.style.opacity="0.5",t.style.cursor="not-allowed"),a&&(a.disabled=!1,a.classList.add("active"),a.style.opacity="1",a.style.cursor="pointer")):(t&&(t.disabled=!1,t.style.opacity="1",t.style.cursor="pointer"),a&&(a.disabled=!1,a.style.opacity="1",a.style.cursor="pointer"),dt==="season"?(t&&t.classList.add("active"),a&&a.classList.remove("active")):(t&&t.classList.remove("active"),a&&a.classList.add("active"))))}async function Zt(){var u,m,f;const e=h("leaderboard-empty"),t=h("leaderboard-table"),a=h("leaderboard-thead"),r=h("leaderboard-tbody");if(!e||!t||!a||!r)return;const s=h("leaderboard-filter-container");if(s&&(s.style.display=Bt==="teams"?"none":"flex"),!Je){e.textContent="Wähle eine Statistik aus den Dropdowns oben aus, um die Rangliste zu laden.",e.classList.remove("hidden"),t.classList.add("hidden");return}e.textContent="Lade Daten...",e.classList.remove("hidden"),t.classList.add("hidden");const n=await V.getLeaderboards(Bt,Je,dt);if(!we("leaderboards"))return;if(!n.success||!n.data||n.data.length===0){e.textContent=n.error||"Keine Einträge für diese Rangliste gefunden.",e.classList.remove("hidden"),t.classList.add("hidden");return}let i=n.data;if(Bt==="riders"){const g=((u=h("leaderboard-filter-wt"))==null?void 0:u.checked)??!0,b=((m=h("leaderboard-filter-pt"))==null?void 0:m.checked)??!0,y=((f=h("leaderboard-filter-other"))==null?void 0:f.checked)??!1;if(i=n.data.filter(v=>{const T=v.teamDivisionId===1&&!v.isRetired,R=v.teamDivisionId===2&&!v.isRetired,x=v.teamDivisionId===null||v.teamDivisionId===void 0||v.isRetired||v.teamDivisionId!==1&&v.teamDivisionId!==2;return!!(T&&g||R&&b||x&&y)}),i.length===0){e.textContent="Keine Einträge für die ausgewählten Filter gefunden.",e.classList.remove("hidden"),t.classList.add("hidden");return}}e.classList.add("hidden"),t.classList.remove("hidden");const o=Je==="highest_leadout_bonus",d=Je==="strongest_lieutenants";Bt==="riders"?a.innerHTML=`
      <tr>
    ...
    `;let l="",p=1;for(const g of i){const b=p++,v=`<span class="badge ${b===1?"badge-primary":b<=3?"badge-secondary":"badge-ghost"}" style="min-width: 28px; text-align: center; display: inline-block;">${b}</span>`,T=Ct(g.teamId,g.teamName);let R="";if(o){const $=g.stageNumber!=null?`Etappe ${g.stageNumber}`:"–";R=`<td style="vertical-align: middle;">${S(g.raceName??"–")} · ${S($)} · ${S(String(g.season??"–"))}</td>`}let x="";if(d)if(g.lieutenantDetails){const $=g.lieutenantDetails,C=$.leaderNationality?de($.leaderNationality):"",I=$.leaderRoleName?` (${$.leaderRoleName})`:"";x=`
        ...
        `}else x='<td style="vertical-align: middle;">–</td>';if(Bt==="riders"){const $=g.nationality?de(g.nationality):"—",C=`<a href="#" onclick="event.preventDefault(); openRiderStatsFromLeaderboard(${g.riderId})" style="color: #60a5fa; text-decoration: none; font-weight: bold; hover: text-decoration: underline;">${S(g.firstName)} ${S(g.lastName)}</a>`,I=g.teamAbbr?`<span class="text-muted" title="${S(g.teamName??"")}">${S(g.teamAbbr)}</span>`:"—";l+=`
        <tr>
      ...
      `}).join(""),p=o.map(u=>{var R;const m=u.race,f=a>=m.startDate&&a<=m.endDate,g=a>m.endDate,b=ct((R=m.category)==null?void 0:R.name),y=f?'<span class="calendar-live-dot"></span>':"",v=g?"opacity: 0.55;":"",T=u.endIdx-u.startIdx+1;return`
    ...
    `}t.innerHTML=r,al()}function al(){var n;const e=h("calendar-race-search"),t=e?e.value.toLowerCase().trim():"",a=h("calendar-races-tbody"),r=((n=c.gameState)==null?void 0:n.currentDate)??"",s=c.races.filter(i=>{var o;return t?i.name.toLowerCase().includes(t)||((o=i.category)==null?void 0:o.name)&&i.category.name.toLowerCase().includes(t):!0}).sort((i,o)=>i.startDate.localeCompare(o.startDate));if(s.length===0){a.innerHTML='<tr><td colspan="9" class="text-muted" style="text-align: center; padding: 20px;">Keine Rennen gefunden.</td></tr>';return}a.innerHTML=s.map(i=>{var y,v,T,R;const o=r>=i.startDate&&r<=i.endDate,l=r>i.endDate?'<span class="badge badge-done">Abgeschlossen</span>':o?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',p=((y=i.country)==null?void 0:y.name)??`Land ${i.countryId}`,u=(v=i.country)!=null&&v.code3?de(i.country.code3):"",m=i.isStageRace?(i.stages??[]).reduce((x,$)=>x+($.distanceKm??0),0):((T=i.upcomingStage)==null?void 0:T.distanceKm)??null,f=i.isStageRace?(i.stages??[]).reduce((x,$)=>x+($.elevationGainMeters??0),0):((R=i.upcomingStage)==null?void 0:R.elevationGainMeters)??null,g=m!=null?String(m.toFixed(1)).replace(".",","):"-",b=f!=null?String(Math.round(f)):"-";return`
...
${e.error??"Unbekannter Fehler"}`),Fe();return}c.raceProgramsDirty=!1,Ls(!0)}function Ds(e,t){let a=0,r=0,s=0;const n=new Set(t.raceProgramRaces.filter(o=>o.program_id===e.id).map(o=>o.race_id)),i=t.races.filter(o=>n.has(o.id));for(const o of i){const d=new Date(o.start_date),l=new Date(o.end_date);for(let p=new Date(d);p<=l;p.setDate(p.getDate()+1)){const u=p.getFullYear(),m=String(p.getMonth()+1).padStart(2,"0"),f=String(p.getDate()).padStart(2,"0"),g=hr(`${u}-${m}-${f}`),b=br(e,g);b==="peak"?a++:b==="prep"?r++:s++}}return{peak:a,prep:r,none:s}}function Fe(){const e=h("race-programs-root"),t=c.raceProgramsPayload;if(!t){e.innerHTML='<div class="results-empty">Keine Daten geladen.</div>';return}const a=c.raceProgramsDirty,r=c.raceProgramsSaving,s=c.raceProgramsActiveTab;let n=`
  ...
  `;s==="calendar-cols"?n+=Jg(t):s==="calendar-rows"?n+=qg(t):s==="peak-editor"?n+=Xg(t):s==="rider-role"?n+=ef(t):s==="program-roles"&&(n+=af(t)),n+="</div>",e.innerHTML=n}function Jg(e){var o,d,l;const t=e.programs,a=e.raceProgramRaces,r=e.races,s=t.map(p=>({id:p.id,stats:Ds(p,e)}));let n=`<tr>
  ...
  `;for(const p of t){const u=(o=s.find(m=>m.id===p.id))==null?void 0:o.stats;n+=`
    ...
    `}n+="</tr>";let i="";for(const p of qr){const u=r.filter(y=>y.start_date<=p.dateStr&&y.end_date>=p.dateStr),m=u.length>0,f=m?"row-has-races":"";let g="";if(m){g='<div style="display: flex; flex-direction: column; gap: 0.15rem; margin-top: 0.15rem;">';for(const y of u){const v=ct((d=y.category)==null?void 0:d.name);g+=`
    ...
    `;for(const y of t){const v=br(y,p.weekNum),T=rl(v),R=a.find(I=>I.program_id===y.id&&u.some(P=>P.id===I.race_id));let x="",$=`toggleable-race-cell ${T}`,C=`data-day="${p.dateStr}" data-program-id="${y.id}"`;if(R){const I=r.find(F=>F.id===R.race_id),P=ct((l=I==null?void 0:I.category)==null?void 0:l.name);x=`
  ...
  `}function qg(e){var f;const t=e.programs,a=e.raceProgramRaces,r=e.races;let s='<th class="sticky-col-header" style="z-index: 15;">Monat</th>',n='<th class="sticky-col-header" style="z-index: 15;">Tag / KW</th>',i='<th class="sticky-col-header" style="z-index: 15;">Rennen Anzahl</th>',o='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #1</th>',d='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #2</th>',l='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #3</th>';const p=[],u=["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"];for(const g of qr){const b=parseInt(g.dateStr.split("-")[1],10)-1,y=u[b];p.length===0||p[p.length-1].name!==y?p.push({name:y,span:1}):p[p.length-1].span++;const v=r.filter(C=>C.start_date<=g.dateStr&&C.end_date>=g.dateStr),T=v.length>0,R=T?`${v.length} R`:"",x=T?"race-count-active":"";n+=`<th style="text-align: center; min-width: 40px; font-variant-numeric: tabular-nums;">
    ...
    </th>`,i+=`<th class="${x}" style="text-align: center; font-size: 0.72rem; font-weight: bold;">${R}</th>`;const $=C=>{var L;const I=v[C];if(!I)return"";const P=ct((L=I.category)==null?void 0:L.name),F=a.filter(H=>H.race_id===I.id).length;return`
...
Zugelassene Programme: ${F}">
      ...
      `};o+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${$(0)}</th>`,d+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${$(1)}</th>`,l+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${$(2)}</th>`}for(const g of p)s+=`<th colspan="${g.span}" style="text-align: center; font-weight: bold; border-left: 1px solid var(--border);">${g.name}</th>`;let m="";for(const g of t){const b=Ds(g,e);let y=`
    ...
    `;for(const v of qr){const T=br(g,v.weekNum),R=rl(T),x=r.filter(L=>L.start_date<=v.dateStr&&L.end_date>=v.dateStr),$=x.length>0,C=a.find(L=>L.program_id===g.id&&x.some(H=>H.id===L.race_id));let I="",P=`toggleable-race-cell ${R}`,F=`data-day="${v.dateStr}" data-program-id="${g.id}"`;if(C){const L=r.find(G=>G.id===C.race_id),H=ct((f=L==null?void 0:L.category)==null?void 0:f.name);I=`
        ...
        `}else $?I='<span style="font-size: 0.72rem; color: var(--text-500); opacity: 0.5;">＋</span>':(P=R,F="");y+=`<td class="${P}" ${F} style="text-align: center; vertical-align: middle; padding: 0.35rem 0;">${I}</td>`}m+=`<tr>${y}</tr>`}return`
    <div class="team-detail-card" style="margin-top: 1rem;">
  ...
  `).join("");return{countHtml:n,stagesListHtml:i}}function ef(e){const t=[...e.races].sort((i,o)=>i.start_date.localeCompare(o.start_date)),a=e.raceProgramRaces,r=e.stages,s=e.programDistribution;return`
    <div class="team-detail-card" style="margin-top: 1rem; position: relative;">
      <div class="team-detail-table-scroll" style="max-height: 75vh;">
        <table class="data-table">
          ...
          <tbody>
            ${t.map(i=>{const o=new Set(a.filter(M=>M.race_id===i.id).map(M=>M.program_id)),d=s.filter(M=>o.has(M.program_id)),u=e.programs.map(M=>{const N=a.some(ee=>ee.program_id===M.id&&ee.race_id===i.id),B=s.find(ee=>ee.program_id===M.id),Z=B?parseInt(B.deterministic_rider_count||"0",10):0,ie=B?parseInt(B.deterministic_role_Kapitaen||"0",10):0,me=B?parseInt(B.deterministic_role_Co_Kapitaen||"0",10):0,fe=B?parseInt(B.deterministic_role_Edelhelfer||"0",10):0,be=B?parseInt(B.deterministic_role_Starke_Helfer||"0",10):0,ve=B?parseInt(B.deterministic_role_Wassertraeger||"0",10):0,ye=B?parseInt(B.deterministic_role_Sprinter||"0",10):0,Se=[];ie>0&&Se.push(`${ie} Kapitän`),me>0&&Se.push(`${me} Co-Kapitän`),fe>0&&Se.push(`${fe} Edelhelfer`),be>0&&Se.push(`${be} Starke Helfer`),ve>0&&Se.push(`${ve} Wasserträger`),ye>0&&Se.push(`${ye} Sprinter`);const at=Se.length>0?`(${Se.join(", ")})`:"";return{program:M,isAssigned:N,count:Z,rolesStr:at}}).sort((M,N)=>N.count-M.count).filter(M=>ei(M.program,i)||M.isAssigned).map(M=>{const N=M.program,B=ei(N,i);let Z="";B||(Z='<span style="color: #fb923c; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(251, 146, 60, 0.15); border: 1px solid #fb923c; border-radius: 50%; font-size: 0.65rem;" title="Dieses Rennen liegt außerhalb der Peak- und Aufbauphase dieses Programms!">!</span>');let ie="";if(!M.isAssigned){const at=a.filter(ee=>ee.program_id===N.id&&ee.race_id!==i.id).map(ee=>e.races.find(Lt=>Lt.id===ee.race_id)).filter(ee=>ee&&ee.start_date<=i.end_date&&ee.end_date>=i.start_date);if(at.length>0){const ee=at.map(Lt=>Lt.name).join(", ");ie=`<span style="color: #ef4444; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(239, 68, 68, 0.15); border: 1px solid #ef4444; border-radius: 50%; font-size: 0.65rem;" title="Kollision: Dieses Programm ist bereits einem zeitlich parallelen Rennen zugewiesen: ${S(ee)}!">!</span>`}}const me=M.isAssigned?"font-weight: bold; color: var(--text-100);":"color: var(--text-500);",fe=M.isAssigned?"☑":"☐",be=B||M.isAssigned,ve=be?"cursor: pointer;":"cursor: not-allowed; opacity: 0.4; pointer-events: none;";return`
        <div class="popover-program-toggle${be?"":" disabled"}" data-program-id="${N.id}" data-race-id="${i.id}" 
             style="${ve} padding: 0.45rem 0.6rem; display: flex; align-items: center; justify-content: space-between; gap: 1rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); transition: background-color 0.15s; white-space: nowrap;"
          ...
          <div style="display: flex; align-items: center; gap: 0.5rem; flex: 1; min-width: 0; overflow: hidden;">
            ...
            <span style="${me} font-size: 0.85rem; overflow: hidden; text-overflow: ellipsis;" title="${S(N.name)}">
              ${S(N.name)}
            </span>
            ${Z}
            ${ie}
    ...
    `;let U="—";if(i.is_stage_race===0){const M=r.find(N=>N.race_id===i.id);U=(M==null?void 0:M.profile)??"Flat"}let W="",ne=`<strong>${S(i.name)}</strong>`;if(i.is_stage_race===1){const M=ft===i.id,{countHtml:N,stagesListHtml:B}=Qg(i.id,r);W=`
      ...
      `}let q=["Berg","Hill","Sprint","Cobble","Timetrial","Attacker"];if(i.is_stage_race===0){const M=r.find(B=>B.race_id===i.id),N=((M==null?void 0:M.profile)??"").toLowerCase();N.includes("cobble")?q=["Cobble","Sprint","Hill","Attacker","Timetrial","Berg"]:(N.includes("flat")||N.includes("rolling"))&&(q=["Sprint","Timetrial","Attacker","Hill","Cobble","Berg"])}const te=[],Y=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],j={Kapitaen:"Kapitän",Co_Kapitaen:"Co-Kapitän",Sprinter:"Sprinter",Edelhelfer:"Edelhelfer",Starke_Helfer:"Starke Helfer",Wassertraeger:"Wasserträger"},D={Berg:"Berg",Hill:"Hügel",Sprint:"Sprint",Cobble:"Cobble",Timetrial:"Timetrial",Attacker:"Attacker"},_=(e.roleSpecCombinations||[]).filter(M=>o.has(M.program_id)),E=new Map;for(const M of _){const N=M.spec2||"—",B=`${M.role}|${M.spec1}|${N}`;E.set(B,(E.get(B)||0)+M.count)}const O=[...E.entries()].map(([M,N])=>{const[B,Z,ie]=M.split("|");return{role:B,spec1:Z,spec2:ie,count:N}}).sort((M,N)=>{const B=Y.indexOf(M.role)-Y.indexOf(N.role);if(B!==0)return B;const Z=q.indexOf(M.spec1)-q.indexOf(N.spec1);return Z!==0?Z:N.count-M.count}),z=(M,N)=>{const B=D[M]??M,Z=N!=="—"?D[N]??N:"—";return`${B} / ${Z}`};for(const M of O)if(M.count>0){const N=M.spec1==="Berg"&&M.spec2==="Cobble"||M.spec1==="Cobble"&&M.spec2==="Berg",B=N?"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem; background: rgba(249, 115, 22, 0.12); color: #f97316;":"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem;",Z=N?"color: #f97316; font-weight: bold;":"color: var(--text-100);",ie=N?"color: #f97316; font-weight: bold;":"color: var(--accent-h);",me=`${M.role}_${M.spec1}_${M.spec2.replace(/[^a-zA-Z0-9]/g,"_")}`,be=_.filter(ve=>ve.role===M.role&&ve.spec1===M.spec1&&(ve.spec2||"—")===M.spec2).map(ve=>{const ye=e.programs.find(Se=>Se.id===ve.program_id);return`<span style="white-space: nowrap; margin-right: 0.8rem;">${S((ye==null?void 0:ye.name)??"Unbekannt")}: <strong>${ve.count}</strong></span>`}).join(" ");te.push(`
        ...
        `)}const k=te.length>0?te.join(""):'<div class="text-muted" style="padding: 0.5rem; font-size: 0.8rem;">Keine Fahrer zugewiesen.</div>';return`
  ...
  `}function sl(e){return ze!==e?'<span style="opacity:0.35; margin-left:4px;">↕</span>':`<span style="color:var(--accent-h); margin-left:4px; font-weight:bold;">${da?"↑":"↓"}</span>`}function nt(e,t,a=""){return`
  ...
  `}function af(e){const t=e.programs,a=e.roleSpecCombinations||[],r={Kapitaen:"Kapitän",Co_Kapitaen:"Co-Kapitän",Sprinter:"Sprinter",Edelhelfer:"Edelhelfer",Starke_Helfer:"Starke Helfer",Wassertraeger:"Wasserträger"},s={Berg:"Berg",Hill:"Hügel",Sprint:"Sprint",Cobble:"Cobble",Timetrial:"Timetrial",Attacker:"Attacker"},n=t.map(o=>{const d=a.filter(f=>f.program_id===o.id);let l=0;const p={Kapitaen:0,Co_Kapitaen:0,Sprinter:0,Edelhelfer:0,Starke_Helfer:0,Wassertraeger:0};for(const f of d)l+=f.count,p[f.role]!==void 0&&(p[f.role]+=f.count);const u=Ds(o,e),m=u.peak+u.prep+u.none;return{program:o,totalRiders:l,roleCounts:p,progCombos:d,raceDays:m}});n.sort((o,d)=>{let l=0;return ze==="id"?l=o.program.id-d.program.id:ze==="name"?l=o.program.name.localeCompare(d.program.name):ze==="total"?l=o.totalRiders-d.totalRiders:ze==="raceDays"?l=o.raceDays-d.raceDays:l=(o.roleCounts[ze]||0)-(d.roleCounts[ze]||0),l===0&&(l=o.program.id-d.program.id),da?l:-l});const i=n.map(o=>{const d=o.program,l=o.progCombos,p=o.totalRiders,u=o.roleCounts,m=o.raceDays,f=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],g=["Berg","Hill","Sprint","Cobble","Timetrial","Attacker"],b=new Map;for(const x of l){const $=x.spec2||"—",C=`${x.role}|${x.spec1}|${$}`;b.set(C,(b.get(C)||0)+x.count)}const y=[...b.entries()].map(([x,$])=>{const[C,I,P]=x.split("|");return{role:C,spec1:I,spec2:P,count:$}}).sort((x,$)=>{const C=f.indexOf(x.role)-f.indexOf($.role);if(C!==0)return C;const I=g.indexOf(x.spec1)-g.indexOf($.spec1);return I!==0?I:$.count-x.count}),v=(x,$)=>{const C=s[x]??x,I=$!=="—"?s[$]??$:"—";return`${C} / ${I}`},T=[];for(const x of y)if(x.count>0){const $=x.spec1==="Berg"&&x.spec2==="Cobble"||x.spec1==="Cobble"&&x.spec2==="Berg",C=$?"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem; background: rgba(249, 115, 22, 0.12); color: #f97316;":"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem;",I=$?"color: #f97316; font-weight: bold;":"color: var(--text-100);",P=$?"color: #f97316; font-weight: bold;":"color: var(--accent-h);",F=`${x.role}_${x.spec1}_${x.spec2.replace(/[^a-zA-Z0-9]/g,"_")}`;T.push(`
          <div style="${C}">
            <span style="${I}">${r[x.role]||x.role} <span class="text-muted">(${v(x.spec1,x.spec2)})</span></span>
  ...
  `}window.openTeamStats=el;async function nl(){var e;for(let t=localStorage.length-1;t>=0;t--){const a=localStorage.key(t);a&&(a.startsWith("programAssignmentsLogged_")||a.startsWith("participantCountsLogged_"))&&localStorage.removeItem(a)}Qr("game"),h("meta-career").textContent=((e=c.currentSave)==null?void 0:e.careerName)??"",Nt("dashboard"),Me("Spiel wird geladen…");try{await Rs(),await Is(),gr()}catch(t){alert("Fehler beim Laden des Spiels: "+t.message)}finally{$e()}}function rf(){document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{var a;const t=e.dataset.view??"";Nt(t),t==="dashboard"&&gr(),t==="teams"&&rr(),t==="riders"&&rr(),t==="rider-team-editor"&&Xo(),t==="live-race"&&jt(),t==="results"&&Ie(),t==="draft"&&Qo(c.draftSelectedSeason||((a=c.currentSave)==null?void 0:a.currentSeason)||2026),t==="injuries"&&fg(),t==="season-standings"&&Sg(),t==="leaderboards"&&Ng(),t==="calendar"&&Wg(),t==="race-programs"&&Ls(),(t==="stage-editor-stages"||t==="stage-editor-climbs")&&ho()})}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-rider-link[data-rider-id]");if(!t)return;const a=Number(t.dataset.riderId);Number.isFinite(a)&&Yt(a)}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-team-link[data-team-id]");if(!t)return;const a=Number(t.dataset.teamId);Number.isFinite(a)&&el(a)}),h("btn-cancel-new").addEventListener("click",()=>Ue("newCareer")),h("btn-close-race-stages").addEventListener("click",()=>Ue("raceStages")),h("btn-close-stage-profile").addEventListener("click",()=>Ue("stageProfile")),h("btn-close-rider-program").addEventListener("click",()=>Ue("riderProgram")),h("btn-close-rider-stats").addEventListener("click",()=>Ue("riderStats")),h("btn-close-team-stats").addEventListener("click",()=>Ue("teamStats")),h("btn-close-race-participants").addEventListener("click",()=>Ue("raceParticipants")),h("btn-close-roster-editor").addEventListener("click",()=>Vr()),h("btn-cancel-roster-editor").addEventListener("click",()=>Vr()),h("btn-apply-roster-editor").addEventListener("click",()=>{Lp()}),h("btn-back-menu").addEventListener("click",()=>{aa==null||aa.pause(),Qr("menu"),pa()}),Tl(),Jp(),Kg(),No(),Jo(),gg(),Dp(),Ip(),qm(),pp(),Fg(),kg(),Pg(),Og()}(async()=>($m(),ge(),rf(),Qr("menu"),await pa()))();
