(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();function Pn(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function gs(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function qt(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function ja(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function Me(e,t={}){const a=t.strong===!1?"span":"strong",s=gs("app-rider-link-label",t.labelClassName),r=`<${a} class="${s}">${Pn(e)}</${a}>`;if(t.riderId==null)return r;const n=['type="button"','class="'+gs("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${r}</button>`}function lt(e,t,a=!0,s=""){const r=a===!1?"span":"strong",n=`<${r} class="app-team-link-label">${Pn(e)}</${r}>`;return t==null?n:`<button type="button" class="${gs("app-team-link",s)}" data-team-id="${t}">${n}</button>`}const d={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,draftHistory:null,injuries:null,draftSelectedSeason:null,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1};let Ht=null;function Po(e){Ht=e}let Ls=!1;function vr(e){Ls=e}let Ln=null;function Sr(e){Ln=e}let fs=null;function kr(e){fs=e}let qe=!1;function Ds(e){qe=e}function f(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Q(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function Ea(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),s=Math.floor(e%60),r=String(a).padStart(2,"0"),n=String(s).padStart(2,"0");return t>0?`${t}:${r}:${n}`:`${a}:${n}`}function ts(e){return e==null||e===0?"–":`+${Ea(e)}`}const Ta=2,hs=3,Dn=4;function An(e){return`/jersey/Jer_${e}.png`}function pt(e,t){var s;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((s=d.teams.find(r=>r.id===e))==null?void 0:s.name)??`Team ${e}`;return`
  ...
  `).join("")}async function Oo(e){he("Karriere wird geladen…");const t=await G.loadSave(e);if(me(),!t.success){alert("Fehler beim Laden: "+t.error);return}d.currentSave=t.data??null,await No()}async function jo(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;he("Löschen…");const a=await G.deleteSave(e);if(me(),!a.success){alert("Fehler: "+a.error);return}await Jt()}async function Vo(){const e=await G.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){f("btn-delete-all-careers").classList.add("hidden"),f("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){he("Alle Karrieren werden gelöscht…");try{for(const a of t){const s=await G.deleteSave(a.filename);if(!s.success){alert(`Fehler beim Löschen von "${a.careerName}": ${s.error??"Unbekannter Fehler"}`);break}}}finally{me()}await Jt()}}function Uo(){f("btn-new-career").addEventListener("click",async()=>{var r;Vt("new-career-error"),f("input-career-name").value="";const a=f("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',He("newCareer");const s=await G.getAvailableTeams();if(!s.success||!((r=s.data)!=null&&r.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=s.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),f("btn-cancel-new").addEventListener("click",()=>_e("newCareer")),f("btn-confirm-new").addEventListener("click",async()=>{const a=f("input-career-name").value.trim(),s=f("input-team-id").value;if(!a||!s){ct("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const r=Number(s),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;Vt("new-career-error"),he("Neue Karriere wird erstellt…");const o=await G.createSave(i,a,r);if(!o.success){me(),ct("new-career-error",o.error??"Unbekannter Fehler.");return}const c=await G.loadSave(i);if(me(),_e("newCareer"),!c.success){alert("Fehler: "+c.error);return}d.currentSave=c.data??null,await No()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>Jt());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{Vo()}),f("saves-list").addEventListener("click",async a=>{const s=a.target.closest("button[data-save-action]");if(!s)return;const{saveAction:r,filename:n,careerName:i}=s.dataset;if(n){if(r==="load"){await Oo(n);return}r==="delete"&&await jo(n,i??n)}})}const Yo="modulepreload",Zo=function(e){return"/"+e},xr={},Kn=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));r=Promise.allSettled(a.map(c=>{if(c=Zo(c),c in xr)return;xr[c]=!0;const l=c.endsWith(".css"),g=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${g}`))return;const m=document.createElement("link");if(m.rel=l?"stylesheet":Yo,l||(m.as="script"),m.crossOrigin="",m.href=c,o&&m.setAttribute("nonce",o),document.head.appendChild(m),l)return new Promise((u,p)=>{m.addEventListener("load",u),m.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})},qo={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function Jo(e){const t=qo[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const Xo=200;function _s(e){if(e.length===0)return[];const t=[];for(const a of e){const s=t[t.length-1];if(!s||Math.abs(s.distanceMeter-a.distanceMeter)>=Xo){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}s.riderIds.push(...a.riderIds),s.riderCount+=a.riderCount,s.distanceSum+=a.distanceMeter*a.riderCount,s.distanceMeter=s.distanceSum/s.riderCount}return t.map(({distanceSum:a,...s})=>s)}function Gs(e){if(e.length===0)return[];let t=0;for(let r=1;r<e.length;r+=1)e[r].riderCount>e[t].riderCount&&(t=r);let a=0,s=0;return e.map((r,n)=>{const i=n===t;let o;return i?o="P":n<t?(a+=1,o=`E${a}`):(s+=1,o=`A${s}`),{...r,label:o,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-r.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,r.distanceMeter-e[n+1].distanceMeter):null}})}function Qo(e,t=null){var a,s,r;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((s=e.find(n=>n.label==="P"))==null?void 0:s.label)??((r=e[0])==null?void 0:r.label)??null}function st(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function wr(e,t,a,s){return`${s.type}:${e}:${t}:${a}`}function el(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:st(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function Oe(e){const t=[];e.segments.forEach((r,n)=>{const i=n*2;(r.start_markers??[]).forEach((o,c)=>{t.push({key:wr(n,"start",c,o),label:"",marker:o,kmMark:r.start_km,elevation:r.start_elevation,boundary:"start",sequence:i+c/100})}),(r.end_markers??[]).forEach((o,c)=>{t.push({key:wr(n,"end",c,o),label:"",marker:o,kmMark:r.end_km,elevation:r.end_elevation,boundary:"end",sequence:i+1+c/100})})});const a=t.sort((r,n)=>r.kmMark-n.kmMark||r.sequence-n.sequence),s=new Map;return a.map(r=>{const n=(s.get(r.marker.type)??0)+1;return s.set(r.marker.type,n),{...r,label:r.marker.name??el(r.marker,n)}})}function tl(e){const t=Oe(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>st(a)).length}}function Ct(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function al(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function Ce(e,t,a,s){return t<=0?s:s+e/t*(a-s*2)}function Ca(e,t){const a=t/1e3,s=e.points;if(a<=s[0].kmMark)return s[0].elevation;for(let r=0;r<s.length-1;r+=1){const n=s[r],i=s[r+1];if(a>i.kmMark)continue;const o=Math.max(1e-4,i.kmMark-n.kmMark),c=(a-n.kmMark)/o;return n.elevation+(i.elevation-n.elevation)*c}return s[s.length-1].elevation}function Wn(e){const t=e.points.map(g=>g.elevation),a=Math.min(...t),s=Math.max(...t),r=Math.max(1,s-a),n=Math.max(40,r*.08),i=Math.max(0,a-n),o=s+n;let c=Math.floor(i/50)*50,l=Math.ceil(o/50)*50;return l<=c&&(l=c+100),{axisMinElevation:c,axisMaxElevation:l}}function ze(e,t,a,s,r,n){const i=Math.max(1,a-t);return s-n-(e-t)/i*(s-r-n)}function Kt(e){return`${Math.round(e)} m`}function Rr(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function Ir(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function On(e,t,a,s,r,n,i,o,c){var h;const l=[],g=[];let m=null,u="#b91c1c";for(const b of Oe(e)){const{marker:y,kmMark:v,elevation:k}=b;if(y.type==="climb_start"){g.push({kmMark:v,elevation:k,name:y.name});continue}if(st(y)){let w=-1;for(let E=g.length-1;E>=0;E-=1)if(y.name&&((h=g[E])==null?void 0:h.name)===y.name){w=E;break}const T=w>=0?g.splice(w,1)[0]:g.pop();T&&Math.max(0,v-T.kmMark),T&&Math.max(0,k-T.elevation);const M=Ir(y.cat,y.type),R=Rr(y.cat);if(y.type==="finish_hill"||y.type==="finish_mountain"){m=y.cat??null,u=M.accentColor;continue}l.push({x:Ce(v*1e3,t,a,s),anchorY:ze(k,o,c,r,n,i),primaryLabel:R??"Berg",secondaryLabel:Kt(k),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:M.accentColor});continue}if(y.type==="sprint_intermediate"){const w=Ir(y.cat,y.type);l.push({x:Ce(v*1e3,t,a,s),anchorY:ze(k,o,c,r,n,i),primaryLabel:"Sprint",secondaryLabel:Kt(k),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:w.accentColor})}}const p=e.points[e.points.length-1];return l.push({x:Ce(p.kmMark*1e3,t,a,s),anchorY:ze(p.elevation,o,c,r,n,i),primaryLabel:m?`${Rr(m)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:Kt(p.elevation),distanceLabel:`${p.kmMark.toFixed(1).replace(".",",")} km`,accentColor:u}),l.sort((b,y)=>b.x-y.x)}function jn(e,t,a){const s=t+4,r=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
      ...
      </g>`}).join("")}function sl(e,t,a,s,r,n,i,o,c,l,g){const m=Ce(e.distanceMeter,a,s,n),u=Ca(t,e.distanceMeter),p=ze(u,c,l,r,i,o),h=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),b=e.riderCount>1?`<text x="${m.toFixed(1)}" y="${(p+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${b}
    </g>`}function rl(e,t,a,s,r,n,i,o,c,l,g){const m=new Map(g.riders.map(p=>[p.id,p])),u=new Map((g.teams??[]).map(p=>[p.id,p.abbreviation]));return e.filter(p=>p.riderCount===1).map(p=>{const h=p.riderIds[0];if(h==null)return"";const b=m.get(h);if(!b)return"";const y=Ce(p.distanceMeter,a,s,n),v=Ca(t,p.distanceMeter),k=ze(v,c,l,r,i,o),w=b.activeTeamId!=null?u.get(b.activeTeamId)??"":"",T=`${b.lastName} (${w})`,M=k-34,R=k-40;return`
        <g class="race-sim-itt-rider-label-group">
          <line x1="${y.toFixed(1)}" y1="${(k-5).toFixed(1)}" x2="${y.toFixed(1)}" y2="${M.toFixed(1)}" stroke="rgba(31, 41, 55, .55)" stroke-width="1"></line>
          <text x="${y.toFixed(1)}" y="${R.toFixed(1)}" text-anchor="middle" class="race-sim-marker-detail">${Ct(T)}</text>
        </g>`}).join("")}function nl(e,t,a,s,r,n,i,o,c,l,g){const m=Math.max(0,Math.min(l,e.distanceKm)),u=Math.max(0,Math.min(g,e.distanceKm));if(u<=m)return null;const p=[{kmMark:m,elevation:Ca(e,m*1e3)},...e.points.filter(k=>k.kmMark>m&&k.kmMark<u),{kmMark:u,elevation:Ca(e,u*1e3)}];if(p.length<2)return null;const h=r-i,b=p.map((k,w)=>{const T=Ce(k.kmMark*1e3,t,a,s),M=ze(k.elevation,o,c,r,n,i);return`${w===0?"M":"L"} ${T.toFixed(1)} ${M.toFixed(1)}`}).join(" "),y=Ce(m*1e3,t,a,s),v=Ce(u*1e3,t,a,s);return`${b} L ${v.toFixed(1)} ${h.toFixed(1)} L ${y.toFixed(1)} ${h.toFixed(1)} Z`}function il(e,t,a,s,r={}){const g=e.distanceKm*1e3,{axisMinElevation:m,axisMaxElevation:u}=Wn(e),p=533,h=12,y=e.points.map(E=>{const D=Ce(E.kmMark*1e3,g,1584,28),C=ze(E.elevation,m,u,634,168,101);return{x:D,y:C}}).map((E,D)=>`${D===0?"M":"L"} ${E.x.toFixed(1)} ${E.y.toFixed(1)}`).join(" "),v=`${y} L ${1556 .toFixed(1)} ${p.toFixed(1)} L ${28 .toFixed(1)} ${p.toFixed(1)} Z`,k=r.selectedClimbRange!=null?nl(e,g,1584,28,634,168,101,m,u,r.selectedClimbRange.startKm,r.selectedClimbRange.endKm):null,w=On(e,g,1584,28,634,168,101,m,u).map(E=>jn(E,h,p)).join(""),M=Array.from({length:5},(E,D)=>m+(u-m)/4*D).map(E=>{const D=ze(E,m,u,634,168,101);return`
    ...
    <svg viewBox="0 0 1584 634" role="img" aria-label="${Ct(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
    ...
    </svg>`}function ol(e,t,a,s,r){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${il(t,a,s,!1,r)}</div>`}function ll(e,t,a,s,r,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const o=1584,c=634,l=28,g=168,m=101,{axisMinElevation:u,axisMaxElevation:p}=Wn(t),h=c-m,b=12,y=Array.from({length:5},(B,x)=>u+(p-u)/4*x),v=_s(a.clusters),k=Gs(v),w=Vn(t,a.stageDistanceMeters),M=t.points.map(B=>{const x=Ce(B.kmMark*1e3,a.stageDistanceMeters,o,l),N=ze(B.elevation,u,p,c,g,m);return{x,y:N}}).map((B,x)=>`${x===0?"M":"L"} ${B.x.toFixed(1)} ${B.y.toFixed(1)}`).join(" "),R=`${M} L ${(o-l).toFixed(1)} ${h.toFixed(1)} L ${l.toFixed(1)} ${h.toFixed(1)} Z`,E=On(t,a.stageDistanceMeters,o,l,c,g,m,u,p).map(B=>jn(B,b,h)).join(""),D=y.map(B=>{const x=ze(B,u,p,c,g,m);return`
      ...
      <text x="${(l-14).toFixed(1)}" y="${(x+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Kt(B)}</text>`}).join(""),C=Un(w,t,a.stageDistanceMeters,o,l,h),P=new Map(v.map((B,x)=>[B,k[x]??null])),A=v.map(B=>{var x;return sl(B,t,a.stageDistanceMeters,o,c,l,g,m,u,p,((x=P.get(B))==null?void 0:x.label)===i)}).join(""),_=r.stage.profile==="ITT"?rl(v,t,a.stageDistanceMeters,o,c,l,g,m,u,p,r):"";e.innerHTML=`
  ...
  `).join("")}</div>`}function Ut(e,t){const a=e.riders.find(s=>s.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function Ua(e,t){const a=e.riders.find(n=>n.id===t),s=(a==null?void 0:a.activeTeamId)??null,r=s!=null?e.teams.find(n=>n.id===s)??null:null;return{teamId:s,teamName:(r==null?void 0:r.name)??null}}function Tc(e,t,a,s={}){const r=(t??[]).slice(0,s.limit??8);return r.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${r.map(n=>{var m;const i=n.riderId??0,o=Ua(e,i),c=Ut(e,i),l=((m=s.distanceGapsByRiderId)==null?void 0:m.get(i))??null,g=[s.distanceGapClassName??"",bc(l)].filter(u=>u.length>0).join(" ");return`
    ...
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-grid">
        ${m.map((u,p)=>{const h=l.get(u.riderId)??null,b=Ua(e,u.riderId),y=g.get(u.riderId)??{points:0,mountain:0},v=Qr(r,u.riderId),k=Qr(n,u.riderId),w=Pc(u.riderId,e.classificationLeaders),T=w.length>0?w.map(M=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[M]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${Lc(w)}" title="${U(T)}">${p+1}.</strong>
              ${Xt(b.teamId,b.teamName)}
              <span class="race-sim-classification-main">
    ...
    </section>`}function Kc(e,t,a,s,r,n=new Set){var p,h;const i=Ws(a,s,r),o=Ks(i),c=Aa(a,a.pointsStandings,o,"points"),l=Aa(a,a.mountainStandings,o,"mountain"),g=Xr(r,((p=a.gcStandings[0])==null?void 0:p.riderId)??null),m=Xr(r,((h=a.youthStandings[0])==null?void 0:h.riderId)??null),u=b=>!n.has(b);e.innerHTML=`
    ...
    <section class="race-sim-classifications-section">
      ${kt("GC",ga("GC","gc",a,a.gcStandings,b=>U(`GC ${b.rank} · ${Da(b.gapSeconds)}`),{limit:20,distanceGapsByRiderId:g}),"race-sim-overview-classification race-sim-overview-gc","gc",u("gc"))}
      ...
      ${kt("Nachwuchsfahrerwertung",ga("Nachwuchsfahrerwertung","youth",a,a.youthStandings,b=>U(`${b.rank}. · ${Da(b.gapSeconds)}`),{distanceGapsByRiderId:m,distanceGapClassName:"is-compact"}),"race-sim-overview-classification race-sim-overview-youth","youth",u("youth"))}
    </section>
...
`)}function iu(e){return Wt(Math.max(-2.5,Math.min(2.5,e*2.5)))}function ou(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function Pi(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${V(e.riderName)}">${V(e.riderName)}</button>`}function lu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId)??"—",r=a.get(e.activeTeamId)??s;return`<span class="race-sim-team-code" title="${V(r)}">${V(s)}</span>`}function Li(e){return`/jersey/Jer_${e}.png`}function du(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId);if(!s)return"—";const r=a.get(e.activeTeamId)??s.name,n=Li(e.activeTeamId);return`
    ...
    </section>`}function mu(e,t,a,s,r,n,i){const o=document.createElement("article");o.dataset.raceSimRiderRow=String(e.riderId);const c=document.createElement("div");c.className="race-sim-row-grid",o.appendChild(c);const l=document.createElement("strong");l.className="race-sim-row-rank",l.textContent="0.",c.appendChild(l);const g=document.createElement("span");g.className="race-sim-row-flag",g.innerHTML=t?Jo(Uc(t)):"—",c.appendChild(g);const m=document.createElement("span");m.className="race-sim-row-name",m.innerHTML=Pi(e,a),c.appendChild(m);const u=m.querySelector(".race-sim-row-name-btn");if(!u)throw new Error("race-sim-row-name-btn not found");const p=document.createElement("span");p.className="race-sim-row-team-visual",p.innerHTML=du(t,r,i),c.appendChild(p);const h=document.createElement("strong");h.className="race-sim-row-team",h.innerHTML=lu(t,n,i),c.appendChild(h);const b=(P="")=>{const A=document.createElement("strong");return P&&(A.className=P),c.appendChild(A),A},y=b("race-sim-gap"),v=b("race-sim-cell-effective-skill"),k=b(),w=b(),T=b(),M=s.map(()=>b()),R=b(),E=b(),D=b("race-sim-form-state-cell"),C=document.createElement("div");return C.className="race-sim-row-detail-popover hidden",o.appendChild(C),{row:o,rankField:l,nameButton:u,gapField:y,clockField:T,splitFields:M,effectiveSkillField:v,gcRankField:k,gcGapField:w,gradientPercentField:R,speedField:E,formStateField:D,detailPanel:C,initialized:!1,lastValues:{}}}function pu(e,t,a,s,r,n,i,o,c,l,g){const m=(s==null?void 0:s.formBonus)??0,u=(s==null?void 0:s.raceFormBonus)??0,p=c&&l>1?g.get(a.riderId)??null:null,h=ke(a),b=i!=="ITT"&&i!=="TTT"?h?"DNF":"—":a.hasStarted?h?"DNF":a.riderClockSeconds!=null?ft(a.riderClockSeconds):"—":ki(a.startOffsetSeconds);ba(e.row,`race-sim-row${t===1&&!h?" race-sim-row-leader":""}${r?" race-sim-row-detail-open":""}${h?" race-sim-row-dnf":""}`),je(e.rankField,`${t}.`),je(e.gapField,h?"DNF":Si(a.gapToLeaderMeters)),je(e.clockField,b),e.nameButton.setAttribute("aria-expanded",r?"true":"false"),ba(e.nameButton,`race-sim-row-name-btn${a.isAttacking?" is-attacking":""}${a.isBreakaway?" is-breakaway":""}`),ha(e.nameButton,a.isBreakaway?`${a.riderName} (Ausreißer)`:a.isAttacking?`${a.riderName} (Attacke aktiv)`:a.riderName),n.forEach((w,T)=>{const M=e.splitFields[T];if(!M)return;const R=uu(a,w.key,i,o);je(M,R),ha(M,w.label)}),ya(e,"effectiveSkillValue",a.effectiveSkill)&&(je(e.effectiveSkillField,te(a.effectiveSkill)),va(e,"effectiveSkillValue",a.effectiveSkill));const y=`race-sim-cell-effective-skill ${wi(a)}`;ya(e,"effectiveSkillClass",y)&&(ba(e.effectiveSkillField,y),va(e,"effectiveSkillClass",y));const v=[a.baseSkill,a.effectiveSkill,a.teamGroupBonus,m,u,a.dailyForm,a.microForm,(s==null?void 0:s.fatigueMalus)??0,(s==null?void 0:s.longTermFatigueMalus)??0,(s==null?void 0:s.shortTermFatigueMalus)??0,a.staminaPenalty].join("|");ya(e,"effectiveSkillTitleKey",v)&&(ha(e.effectiveSkillField,nu(a,s)),va(e,"effectiveSkillTitleKey",v)),je(e.gcRankField,p?String(p.rank):"—"),je(e.gcGapField,p?$i(p.gapSeconds):"—"),je(e.gradientPercentField,Wc(a.gradientPercent)),ba(e.gradientPercentField,Vc(a.gradientPercent)),ha(e.gradientPercentField,`${xi(a.activeTerrain)} · ${Ti(a)}`),je(e.speedField,Os(a.currentSpeedMps)),e.formStateField.innerHTML=cu(a);const k=[r?"open":"closed",a.activeTerrain,a.segmentStartKm,a.segmentEndKm,a.segmentStartElevation,a.segmentEndElevation,a.skillName,a.baseSkill,a.teamGroupBonus,m,u,(s==null?void 0:s.fatigueMalus)??0,a.staminaPenalty,a.elevationPenalty,a.dailyForm,a.microForm,a.gradientModifier,a.windModifier,a.draftModifier,a.draftNearbyRiderCount,a.draftPackFactor,(p==null?void 0:p.rank)??"—",(p==null?void 0:p.gapSeconds)??"—",a.skillBreakdown].join("|");ya(e,"detailKey",k)&&(e.detailPanel.innerHTML=r?Di(a,s,p):"",e.detailPanel.classList.toggle("hidden",!r),va(e,"detailKey",k)),e.detailPanel.classList.toggle("hidden",!r),e.initialized=!0}function gu(e,t){return`<button type="button" class="race-sim-row-name-btn" data-race-sim-ttt-team-toggle="${e.id}" aria-expanded="${t?"true":"false"}" title="${V(e.name)}">${V(e.name)}</button>`}function fu(e){const t=Li(e.id);return`
    ...
    </section>`}function yu(e,t,a){var p,h;const s=performance.now(),r=Ei(a),n=r.splitMarkers,i=[{label:"Pos",width:"50px",className:"race-sim-col-rank"},{label:"Team",width:"220px",className:"race-sim-col-name"},{label:"Jer",width:"46px",className:"race-sim-col-team-visual"},{label:"Abr.",width:"58px",className:"race-sim-col-team"},{label:"Gap",width:"72px"},{label:"Uhr",width:"96px"},...n.map(b=>({label:b.key,displayLabel:b.label,width:"92px",className:"race-sim-col-split"})),{label:"Eff.",width:"74px"},{label:"Speed",width:"82px"}],o=(p=Ke.get(e))==null?void 0:p.layoutKey,c=Fi(e,i),l=Ke.get(e)??{openDetailRiderId:null,openTeamId:null};o!=null&&o!==c&&(e.innerHTML="");const g=hu(t,a,r.riderById),m=((h=g[0])==null?void 0:h.teamDistanceMeters)??0;return e.innerHTML=g.map((b,y)=>{const v=l.openTeamId===b.team.id;return`
    ...
    `).join(""))}function Qu(){const e=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked'),t=f("stage-editor-programs-selected-text");if(e.length===0)t.textContent="Keine Programme ausgewählt",t.classList.add("text-muted");else{const a=Array.from(e).map(s=>{var n;const r=(n=d.stageEditorPrograms)==null?void 0:n.find(i=>String(i.id)===s.value);return r?r.name:s.value});t.textContent=`${e.length} ausgewählt: ${a.join(", ")}`,t.classList.remove("text-muted")}}function Zs(e){return Math.round(e.startElevation+e.lengthKm*1e3*(e.gradientPercent/100))}function Hi(){const e=d.stageEditorExistingStages.map(t=>t.stageId);return e.length>0?Math.max(...e)+1:1}function em(){const e=[...d.stageEditorExistingStages.map(t=>t.raceId),...d.races.map(t=>t.id)];return e.length>0?Math.max(...e)+1:1}function tm(e,t){let a=e;const s=new Set(d.stageEditorExistingStages.map(r=>r.stageId));for(;a>0&&s.has(a);)a+=t;if(a<=0)for(a=1;s.has(a);)a+=1;return a}function am(e,t){let a=e;const s=new Set([...d.stageEditorExistingStages.map(r=>r.raceId),...d.races.map(r=>r.id)]);for(;a>0&&s.has(a);)a+=t;if(a<=0)for(a=1;s.has(a);)a+=1;return a}function sm(e){var o;const t=f("stage-editor-profile");t.innerHTML=Us(e.suggestedProfile),t.value=e.suggestedProfile;const a=Hi(),s=em();f("stage-editor-stage-id").value=String(a),f("stage-editor-race-id").value=String(s),Rt=a,It=s;const r=f("stage-editor-details-file");r.value.trim()||(r.value=`${Pu(e.routeName)}.csv`);const n=f("stage-editor-date");!n.value&&((o=d.gameState)!=null&&o.currentDate)&&(n.value=d.gameState.currentDate),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(c=>{c.checked=!0})}function rm(e){f("stage-editor-stage-id").value=String(e.stageId),f("stage-editor-race-id").value=String(e.raceId),Rt=e.stageId,It=e.raceId,f("stage-editor-stage-number").value=String(e.stageNumber),f("stage-editor-date").value=e.date,f("stage-editor-details-file").value=e.detailsCsvFile;const t=f("stage-editor-profile");t.innerHTML=Us(e.profile),t.value=e.profile,f("stage-editor-final-spread-start").value=String(e.finalSpreadStartPercent),f("stage-editor-final-push-start").value=String(e.finalPushStartPercent),f("stage-editor-final-spread-difficulty").value=String(e.finalSpreadDifficultyMultiplier),f("stage-editor-crash-multiplier").value=String(e.crashIncidentMultiplier),f("stage-editor-mechanical-multiplier").value=String(e.mechanicalIncidentMultiplier);const a=(e.allowedWeather||"1|2|3|4|5|6|7").split("|").map(r=>r.trim());document.querySelectorAll('input[name="stage-editor-weather"]').forEach(r=>{r.checked=a.includes(r.value)})}function zi(e){var s;if(!e)return["Noch keine Strecke importiert."];const t=[];return e.segments.length===0?(t.push("Mindestens ein Segment ist erforderlich."),t):((s=e.segments[0])!=null&&s.markers.some(r=>r.type==="start")||t.push("Das erste Segment muss als Start markiert sein."),(e.segments[e.segments.length-1].endMarkers??[]).some(r=>we(r.type))||t.push("Das letzte Segment muss per Endmarker als Ziel markiert sein."),e.segments.forEach((r,n)=>{Ys(e,n).forEach(i=>{t.push(`Segment ${n+1}: ${i}`)}),[...r.markers??[],...r.endMarkers??[]].forEach(i=>{i.cat!=null&&!Bi.includes(i.cat)&&t.push(`Segment ${n+1}: Ungültige Marker-Kategorie ${i.cat}.`)})}),t)}function Ki(){const e=[],t=Number(f("stage-editor-stage-id").value),a=Number(f("stage-editor-race-id").value),s=Number(f("stage-editor-stage-number").value),r=f("stage-editor-date").value.trim(),n=f("stage-editor-details-file").value.trim(),i=Number(f("stage-editor-final-spread-start").value),o=Number(f("stage-editor-final-push-start").value),c=Number(f("stage-editor-final-spread-difficulty").value),l=Number(f("stage-editor-crash-multiplier").value),g=Number(f("stage-editor-mechanical-multiplier").value);(!Number.isInteger(t)||t<=0)&&e.push("Stage-ID fehlt oder ist ungültig."),(!Number.isInteger(a)||a<=0)&&e.push("Race-ID fehlt oder ist ungültig."),(!Number.isInteger(s)||s<=0)&&e.push("Etappennummer fehlt oder ist ungültig."),/^\d{4}-\d{2}-\d{2}$/.test(r)||e.push("Datum muss im Format YYYY-MM-DD vorliegen."),(!/^[A-Za-z0-9_.-]+\.csv$/.test(n)||n.includes("/"))&&e.push("Details-Datei muss ein Dateiname mit .csv-Endung ohne Pfad sein."),(!Number.isFinite(i)||i<0||i>100)&&e.push("Final Spread Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(o)||o<0||o>100)&&e.push("Final Push Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(c)||c<=0)&&e.push("Final Spread Multiplikator muss groesser als 0 sein."),(!Number.isFinite(l)||l<=0)&&e.push("Sturz-Multiplikator muss groesser als 0 sein."),(!Number.isFinite(g)||g<=0)&&e.push("Defekt-Multiplikator muss groesser als 0 sein."),document.querySelectorAll('input[name="stage-editor-weather"]:checked').length===0&&e.push("Mindestens eine Wetterart muss ausgewählt sein."),d.stageEditorExistingStages.map(y=>y.stageId).includes(t)&&e.push(`Die Stage-ID ${t} existiert bereits in stages.csv.`);const p=f("stage-editor-new-race-checkbox").checked,h=[...d.stageEditorExistingStages.map(y=>y.raceId),...d.races.map(y=>y.id)];if(p){h.includes(a)&&e.push(`Die Race-ID ${a} existiert bereits.`);const y=f("stage-editor-race-name").value.trim(),v=Number(f("stage-editor-race-country").value),k=Number(f("stage-editor-race-category").value),w=Number(f("stage-editor-race-num-stages").value),T=f("stage-editor-race-start-date").value.trim(),M=f("stage-editor-race-end-date").value.trim(),R=Number(f("stage-editor-race-prestige").value);y||e.push("Rennname fehlt."),(!Number.isInteger(v)||v<=0)&&e.push("Land fehlt oder ist ungültig."),(!Number.isInteger(k)||k<=0)&&e.push("Kategorie fehlt oder ist ungültig."),(!Number.isInteger(w)||w<=0)&&e.push("Etappenanzahl muss eine positive Ganzzahl sein."),/^\d{4}-\d{2}-\d{2}$/.test(T)||e.push("Startdatum muss im Format YYYY-MM-DD vorliegen."),/^\d{4}-\d{2}-\d{2}$/.test(M)||e.push("Enddatum muss im Format YYYY-MM-DD vorliegen."),(!Number.isInteger(R)||R<1||R>100)&&e.push("Prestige muss zwischen 1 und 100 liegen.")}else h.includes(a)||e.push(`Die Race-ID ${a} existiert nicht. Wenn Sie ein neues Rennen erstellen möchten, aktivieren Sie bitte 'Neues Rennen anlegen'.`);return f("stage-editor-program-checkbox").checked&&document.querySelectorAll('input[name="stage-editor-program-selection"]:checked').length===0&&e.push("Mindestens ein Programm muss ausgewählt sein."),e}function nm(){var a,s;const e=document.querySelectorAll('input[name="stage-editor-weather"]:checked'),t=Array.from(e).map(r=>r.value).join("|");return{stageId:Number(f("stage-editor-stage-id").value),raceId:Number(f("stage-editor-race-id").value),stageNumber:Number(f("stage-editor-stage-number").value),date:f("stage-editor-date").value.trim(),profile:f("stage-editor-profile").value,detailsCsvFile:f("stage-editor-details-file").value.trim(),startElevation:((s=(a=d.stageEditorDraft)==null?void 0:a.segments[0])==null?void 0:s.startElevation)??0,finalSpreadStartPercent:Number(f("stage-editor-final-spread-start").value),finalPushStartPercent:Number(f("stage-editor-final-push-start").value),finalSpreadDifficultyMultiplier:Number(f("stage-editor-final-spread-difficulty").value),crashIncidentMultiplier:Number(f("stage-editor-crash-multiplier").value),mechanicalIncidentMultiplier:Number(f("stage-editor-mechanical-multiplier").value),allowedWeather:t}}function im(e){return["distanceKm","elevationGainMeters","sprintCount","climbCount","profileScore"].includes(e)?"desc":"asc"}function om(e){return["gainMeters","distanceKm","avgGradient","maxGradient","climbScore"].includes(e)?"desc":"asc"}function Za(e,t,a){const r=(Math.max(t,Math.min(a,e))-t)/Math.max(1,a-t),n=Math.round(124-r*118),i=54,o=.14+r*.12,c=.26+r*.18;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${n};--stage-editor-score-lightness:${i}%;--stage-editor-score-bg-alpha:${o};--stage-editor-score-border-alpha:${c};`}">${Math.round(e)}</span>`}function qs(e){let t;e<=100?t=e/100*.45:e<=250?t=.45+(e-100)/150*.35:t=.8+Math.min(e-250,100)/100*.2;const a=Math.round(122-t*122),s=Math.round(40-t*22),r=.18+t*.3,n=.3+t*.4;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${s}%;--stage-editor-score-bg-alpha:${r};--stage-editor-score-border-alpha:${n};`}">${Math.round(e)}</span>`}function lm(e){if(e==null)return'<span class="stage-editor-category-empty">—</span>';const t=e==="HC"?"is-hc":`is-cat-${e}`,a=e==="HC"?"HC":String(e);return`<span class="stage-editor-climb-category-badge ${t}">${a}</span>`}function dm(e,t,a,s){const r=s!=null?` data-stage-profile-open-climb-id="${S(s)}"`:"";return`<button class="dashboard-stage-profile-link" type="button" data-stage-profile-open-stage-id="${t}"${r}>${e}</button>`}function cm(e){const t=i=>i!=null?`${i.toFixed(1).replace(".",",")} km`:"—",a=i=>i!=null?`${Math.round(i).toLocaleString("de-DE")} m`:"—",s=e.profileScore??e.score,r=[...d.stageEditorClimbRows??[]].filter(i=>i.stageId===e.stageId).sort((i,o)=>i.climbIndex-o.climbIndex),n=r.length===0?'<div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-compact"><span class="text-muted" style="grid-column:1/-1">Keine Bergwertungen</span></div>':`
    ...
    </th>`}function _t(){const e=f("stage-editor-stages-table"),t=f("stage-editor-stages-empty"),a=f("stage-editor-stages-meta"),s=e.querySelector("thead"),r=e.querySelector("tbody");if(!r)return;const n=d.stageEditorStagesSort.key,i=d.stageEditorStagesSort.direction;s&&(s.innerHTML=`<tr>
    ...
    <tr>
      ...
      <td><strong>${S(aa({stageNumber:c.stageNumber}))}</strong></td>
    ...
    </tr>`).join(""),t.classList.toggle("hidden",o.length>0||d.stageEditorOverviewLoading),a.textContent=d.stageEditorOverviewLoading?"Etappenübersicht wird geladen...":`${d.stageEditorStageRows.length} vorhandene Etappen`}function Gt(){const e=f("stage-editor-climbs-table"),t=f("stage-editor-climbs-empty"),a=f("stage-editor-climbs-meta"),s=e.querySelector("thead"),r=e.querySelector("tbody");if(!r)return;const n=d.stageEditorClimbsSort.key,i=d.stageEditorClimbsSort.direction;s&&(s.innerHTML=`<tr>
        ...
        ${h.map(v=>`
          <div class="stage-editor-climb" style="padding: 0.5rem; background: rgba(255,255,255,0.03); border-radius: var(--radius-sm); border-left: 3px solid var(--accent);">
            ...
            <div style="font-size: 0.75rem; color: var(--text-300); display: flex; flex-wrap: wrap; gap: 0.5rem;">
              <span>${dt(v.startKm)} - ${dt(v.endKm)}</span>
              <span>·</span>
    ...
    `,s.innerHTML=y,n.innerHTML=fn(e),i.innerHTML=e.segments.map((v,k)=>`
    <tr data-segment-index="${k}" class="${Ys(e,k).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;">
      <td class="stage-editor-cell-nr text-muted" style="text-align:center; font-weight:700;">${k+1}</td>
      <td class="stage-editor-cell-length"><input type="number" step="0.01" min="0.2" value="${v.lengthKm.toFixed(2)}" data-field="segmentLengthKm" class="${Bu(v.lengthKm<_a)}"></td>
      ...
      <td class="stage-editor-cell-terrain"><select data-field="terrain">${Lu(v.terrain)}</select></td>
      <td class="stage-editor-cell-start-markers">
        ${gn(v.markers,k,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${gn(v.endMarkers,k,e.segments.length,"end")}
      </td>
      <td class="stage-editor-row-actions">
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          <div class="text-muted" style="min-width:3.5rem;">${Zs(v)} m</div>
          ${ym(e,k)}
          <button type="button" class="btn btn-secondary btn-xs" data-segment-action="insert" data-segment-index="${k}">+</button>
          ${k===e.segments.length-1?`<button type="button" class="btn btn-secondary btn-xs" data-segment-action="append" data-segment-index="${k}">+ Ende</button>`:""}
          ${e.segments.length>1?`<button type="button" class="btn btn-danger btn-xs" data-segment-action="delete" data-segment-index="${k}">✕</button>`:""}
        </div>
      </td>
    </tr>`).join(""),c.disabled=p.length>0,o.textContent=p.length>0?`${p.length} Validierungshinweise vor dem Export.`:`Exportiert ${f("stage-editor-details-file").value||"stage_details.csv"} und eine stages-Row als Download.`}function ym(e,t){const a=Ys(e,t);return a.length===0?'<div class="stage-editor-segment-status">OK</div>':`<div class="stage-editor-segment-issues">${a.map(s=>`<div>${S(s)}</div>`).join("")}</div>`}function fn(e){if(!e||e.waypoints.length<2)return'<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';const t=920,a=280,s=24,r=20,n=e.waypoints,i=n[n.length-1].kmMark,o=Math.min(...n.map(h=>h.elevation)),c=Math.max(...n.map(h=>h.elevation)),l=Math.max(1,c-o),g=n.map(h=>{const b=s+h.kmMark/Math.max(i,.1)*(t-s*2),y=a-r-(h.elevation-o)/l*(a-r*2);return{x:b,y,waypoint:h}}),m=g.map((h,b)=>`${b===0?"M":"L"} ${h.x.toFixed(1)} ${h.y.toFixed(1)}`).join(" "),u=`${m} L ${(t-s).toFixed(1)} ${(a-r).toFixed(1)} L ${s.toFixed(1)} ${(a-r).toFixed(1)} Z`,p=g.filter(h=>h.waypoint.markers.length>0).map(h=>`
      <line x1="${h.x.toFixed(1)}" y1="${r}" x2="${h.x.toFixed(1)}" y2="${(a-r).toFixed(1)}" class="stage-editor-chart-marker-line" />
      <text x="${h.x.toFixed(1)}" y="14" class="stage-editor-chart-marker-label">${S(fm(h.waypoint.markers))}</text>`).join("");return`
...
`)}`),ne();return}const t=f("stage-editor-new-race-checkbox").checked,a=f("stage-editor-program-checkbox").checked;let s;t&&(s={name:f("stage-editor-race-name").value.trim(),countryId:Number(f("stage-editor-race-country").value),categoryId:Number(f("stage-editor-race-category").value),isStageRace:Number(f("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(f("stage-editor-race-num-stages").value),startDate:f("stage-editor-race-start-date").value.trim(),endDate:f("stage-editor-race-end-date").value.trim(),prestige:Number(f("stage-editor-race-prestige").value)});let r;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');r=Array.from(n).map(i=>Number(i.value))}he("CSV-Dateien werden erstellt……");try{const n=await G.exportStageRoute({metadata:nm(),draft:d.stageEditorDraft,newRace:t,raceDetails:s,updatePrograms:a,programIds:r});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}Ss(n.data.stagesFileName,n.data.stagesCsv),Ss(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=f("stage-editor-stage-number"),o=Number(i.value)||1;i.value=String(o+1);const c=f("stage-editor-date"),l=c.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const y=new Date(l);y.setDate(y.getDate()+1);const v=y.getFullYear(),k=String(y.getMonth()+1).padStart(2,"0"),w=String(y.getDate()).padStart(2,"0");c.value=`${v}-${k}-${w}`}await Promise.all([Oi(!0),mm(!0)]);const g=Hi();f("stage-editor-stage-id").value=String(g),Rt=g;const m=f("stage-editor-new-race-checkbox");m&&(m.checked=!1);const u=f("stage-editor-new-race-details");u&&(u.classList.add("hidden"),u.style.display="none");const p=f("stage-editor-program-checkbox");p&&(p.checked=!1);const h=f("stage-editor-program-details");h&&(h.classList.add("hidden"),h.style.display="none"),It=Number(f("stage-editor-race-id").value),ne()}finally{me()}}function wm(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",T=>{const M=T.target.closest("button[data-stage-editor-stages-sort]");if(!M)return;const R=M.dataset.stageEditorStagesSort;d.stageEditorStagesSort.key===R?d.stageEditorStagesSort.direction=d.stageEditorStagesSort.direction==="asc"?"desc":"asc":d.stageEditorStagesSort={key:R,direction:im(R)},_t()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",T=>{const M=T.target.closest("button[data-stage-editor-climbs-sort]");if(!M)return;const R=M.dataset.stageEditorClimbsSort;d.stageEditorClimbsSort.key===R?d.stageEditorClimbsSort.direction=d.stageEditorClimbsSort.direction==="asc"?"desc":"asc":d.stageEditorClimbsSort={key:R,direction:om(R)},Gt()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{Tm()});const s=document.getElementById("btn-stage-editor-load-existing");s&&s.addEventListener("click",()=>{Mm()});const r=document.getElementById("btn-stage-editor-export");r&&r.addEventListener("click",()=>{xm()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",T=>{var R;const M=((R=T.target.files)==null?void 0:R[0])??null;f("stage-editor-file-hint").textContent=M?`${M.name} · ${(M.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",T=>{const M=T.target,R=M.closest("tr[data-segment-index]"),E=M.dataset.field;if(!R||!E)return;const D=Number(R.dataset.segmentIndex);if(Number.isInteger(D)){if(E==="markerType"||E==="markerName"||E==="markerCat"){const C=Number(M.dataset.markerIndex),P=M.dataset.markerScope;if(!Number.isInteger(C)||P!=="start"&&P!=="end")return;Yu(D,C,P,E,M.value);return}vm(D,E,M.value)}}),i.addEventListener("click",T=>{const M=T.target.closest("button[data-segment-action]");if(!M)return;const R=Number(M.dataset.segmentIndex);if(Number.isInteger(R)){if(M.dataset.segmentAction==="insert"){Sm(R);return}if(M.dataset.segmentAction==="append"){km();return}if(M.dataset.segmentAction==="add-marker"){const E=M.dataset.markerScope;if(E!=="start"&&E!=="end")return;Zu(R,E);return}if(M.dataset.segmentAction==="remove-marker"){const E=Number(M.dataset.markerIndex),D=M.dataset.markerScope;if(!Number.isInteger(E)||D!=="start"&&D!=="end")return;qu(R,E,D);return}M.dataset.segmentAction==="delete"&&$m(R)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(T=>{const M=document.getElementById(T);M&&M.addEventListener("change",()=>ne())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(T=>{T.addEventListener("change",()=>ne())});const c=f("stage-editor-new-race-checkbox"),l=f("stage-editor-new-race-details"),g=f("stage-editor-program-checkbox"),m=f("stage-editor-program-details");c&&c.addEventListener("change",()=>{c.checked?(l&&(l.classList.remove("hidden"),l.style.display="grid"),g&&(g.checked=!0,m&&(m.classList.remove("hidden"),m.style.display="block"))):l&&(l.classList.add("hidden"),l.style.display="none"),ne()}),g&&g.addEventListener("change",()=>{g.checked?m&&(m.classList.remove("hidden"),m.style.display="block"):m&&(m.classList.add("hidden"),m.style.display="none"),ne()});const u=f("stage-editor-programs-dropdown-trigger"),p=f("stage-editor-programs-dropdown-menu"),h=f("btn-stage-editor-programs-ok");u&&p&&(u.addEventListener("click",T=>{T.stopPropagation();const M=p.style.display==="none"||!p.style.display;p.style.display=M?"flex":"none"}),h&&h.addEventListener("click",T=>{T.stopPropagation(),p.style.display="none",ne()}),document.addEventListener("click",T=>{const M=T.target;p.style.display==="flex"&&!p.contains(M)&&M!==u&&!u.contains(M)&&(p.style.display="none",ne())}));const b=f("stage-editor-programs-list");b&&b.addEventListener("change",T=>{T.target.name==="stage-editor-program-selection"&&Qu()});let y=!1,v=null;const k=f("stage-editor-stage-id"),w=f("stage-editor-race-id");if(k&&w){[k,w].forEach(M=>{M.addEventListener("keydown",R=>{R.key!=="ArrowUp"&&R.key!=="ArrowDown"&&(y=!0,v&&clearTimeout(v))}),M.addEventListener("keyup",R=>{R.key!=="ArrowUp"&&R.key!=="ArrowDown"&&(v&&clearTimeout(v),v=setTimeout(()=>{y=!1},150))}),M.addEventListener("blur",()=>{y=!1})});const T=(M,R)=>{const E=Number(M.value);if(!Number.isInteger(E)||E<=0){R==="stage"?Rt=E:It=E;return}const C=E-(R==="stage"?Rt:It);if(!y&&(C===1||C===-1)){let P=E;R==="stage"?P=tm(E,C):f("stage-editor-new-race-checkbox").checked&&(P=am(E,C)),M.value=String(P)}R==="stage"?Rt=Number(M.value):It=Number(M.value)};k.addEventListener("input",()=>{T(k,"stage"),ne()}),w.addEventListener("input",()=>{T(w,"race"),ne()})}}let Ye=[],xt=null;const $t=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"];function Js(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill" title="Team">${l?pt(l,g):""} <span>${S(g)}</span></span>
      ...
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonrenntage">${q.raceDays} <span class="rider-stats-icon-pill-value">${b}</span></span>
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width ${w!=="none"?"text-error":""}" title="Kurzzeitfatigue">${q.shortFatigue} <span class="rider-stats-icon-pill-value">${k}</span></span>
      </div>
      <div class="rider-stats-header-col align-left">
      ...
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-summary-pill-heat" style="--rider-stats-pill-hue:6;--rider-stats-pill-border-alpha:0.26;--rider-stats-pill-bg-alpha:0.14; font-weight: 500;" title="Spezialisierung 3">${F} ${S(N)}</span>
  ...
  `}function bn(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",s=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(s)}</strong>`}function Ae(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
  ...
  `}function Dm(e,t){const a=t.shortTermFatigueMalus??0,s=t.longTermFatigueDecayable??0,r=t.longTermFatigueLocked??0,n=t.longTermFatigueMalus??0,i=t.totalFatigueLoadMalus??0,o=(a/.2).toFixed(1).replace(".",","),c=(s/.01).toFixed(0);let l="#fff";t.shortTermFatigueWarning==="critical"?l="#ef4444":t.shortTermFatigueWarning==="warning"&&(l="#fbbf24");const g=t.fatigueHistory??[];let m="";return g.length===0?m='<tr><td colspan="6" class="text-center text-muted" style="padding: 2rem; color: #888;">Keine Erschöpfungshistorie für diesen Fahrer vorhanden.</td></tr>':m=g.map(u=>{const p=Q(u.date);let h="";u.type==="race"?h=`${S(u.raceName)}${u.stageNumber!=null?` - Etappe ${u.stageNumber}`:""}`:h=u.raceName?S(u.raceName):"Regeneration";const b=u.type==="race"&&u.stageScore!=null?`<span class="badge" style="background: rgba(255,255,255,0.08); color: #fff; padding: 0.25rem 0.5rem; border-radius: 4px; font-weight: 600;">${u.stageScore.toFixed(0)}</span>`:'<span style="color: #666;">–</span>';let y="";u.shortChange>0?y=`<span style="color: #ef4444; font-weight: 600;">+${u.shortChange.toFixed(2).replace(".",",")}</span>`:u.shortChange<0?y=`<span style="color: #2ecc71; font-weight: 600;">${u.shortChange.toFixed(2).replace(".",",")}</span>`:y='<span style="color: #666;">0,00</span>';const v=[];if(u.longDecayableChange!==0){const T=u.longDecayableChange>0?"+":"",M=u.longDecayableChange>0?"#ef4444":"#2ecc71";v.push(`<span style="color: ${M}; font-weight: 500;">${T}${u.longDecayableChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Abbau.)</span></span>`)}if(u.longLockedChange!==0){const T=u.longLockedChange>0?"+":"",M=u.longLockedChange>0?"#a855f7":"#2ecc71";v.push(`<span style="color: ${M}; font-weight: 500;">${T}${u.longLockedChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Gesp.)</span></span>`)}const k=v.length>0?`<div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.1rem;">${v.join("")}</div>`:'<span style="color: #666;">0,00</span>',w=u.shortAfter+u.longAfter;return`
        <tr>
  ...
  `}function Am(e){var z;if(!e)return`
      ...
      </section>`;const a=(e.formHistory??[]).filter((I,F)=>F%2===0),s=((z=d.gameState)==null?void 0:z.currentDate)??new Date().toISOString(),r=a.length>0?new Date(a[a.length-1].date).getUTCFullYear():new Date(s).getUTCFullYear(),n=new Date(Date.UTC(r,0,1)).getTime(),i=864e5,o=1300,c=384,l=30,g=20,m=a.map(I=>{const L=(new Date(I.date).getTime()-n)/i,H=l+L/365*o,Y=g+c-Math.min(8,Math.max(0,I.totalForm))/8*c;return{x:H,y:Y,form:I.totalForm,date:I.date}});let u="",p="",h="";m.length>0&&(u=`M ${m.map(I=>`${I.x},${I.y}`).join(" L ")}`,p=m.map(I=>`<circle cx="${I.x}" cy="${I.y}" r="3" fill="#fff" stroke="var(--accent-primary)" stroke-width="2"><title>${e.riderName} (${I.date}): ${I.form}</title></circle>`).join(""),h=`${u} L ${m[m.length-1].x},${g+c} L ${m[0].x},${g+c} Z`);const b="rgba(251, 191, 36, 0.15)";let y="";for(let I=0;I<=8;I+=2){const F=g+c-I/8*c;y+=`<line x1="${l}" y1="${F}" x2="${l+o}" y2="${F}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,y+=`<text x="${l-5}" y="${F+4}" fill="#ffffff" font-size="10" text-anchor="end">${I}</text>`}let v="";for(let I=0;I<=52;I+=5){const F=l+I/52*o;y+=`<line x1="${F}" y1="${g}" x2="${F}" y2="${g+c}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,v+=`<text x="${F}" y="${g+c+15}" fill="#ffffff" font-size="10" text-anchor="middle">W${I}</text>`}let k="",w="";if(e.peakDates){const I=[...e.peakDates].sort((F,L)=>new Date(F).getTime()-new Date(L).getTime());for(let F=0;F<I.length;F++){const L=I[F],Y=(new Date(L).getTime()-n)/i,X=l+Y/365*o;k+=`<line x1="${X}" y1="${g}" x2="${X}" y2="${g+c}" stroke="#ffffff" stroke-width="2"><title>Peak: ${L}</title></line>`;const re=F>0?(new Date(I[F-1]).getTime()-n)/i:Number.NEGATIVE_INFINITY,$e=Y-56,le=re+14,$=Math.max(0,Math.max($e,le)),K=Y-$,W=l+$/365*o,O=K/365*o;w+=`<rect x="${W}" y="${g}" width="${O}" height="${c}" fill="rgba(16, 185, 129, 0.1)" />`;const ie=14/365*o;w+=`<rect x="${X}" y="${g}" width="${ie}" height="${c}" fill="rgba(239, 68, 68, 0.1)" />`}}const M=(new Date(s).getTime()-n)/i,R=l+M/365*o;k+=`<line x1="${R}" y1="${g}" x2="${R}" y2="${g+c}" stroke="#ef4444" stroke-width="3"><title>Heute: ${s}</title></line>`,Ye.forEach((I,F)=>{const L=$t[F%$t.length];I.peakDates&&I.peakDates.forEach(H=>{const X=(new Date(H).getTime()-n)/i,re=l+X/365*o;k+=`<line x1="${re}" y1="${g}" x2="${re}" y2="${g+c}" stroke="${L}" stroke-width="1.5" stroke-dasharray="3,3"><title>${I.riderName} Peak: ${H}</title></line>`})});let E="",D="";Ye.forEach((I,F)=>{const L=$t[F%$t.length],H=I.formHistory.filter((Y,X)=>X%2===0).map(Y=>{const re=(new Date(Y.date).getTime()-n)/i,$e=l+re/365*o,le=g+c-Math.min(8,Math.max(0,Y.totalForm))/8*c;return{x:$e,y:le,form:Y.totalForm,date:Y.date}});if(H.length>0){const Y=`M ${H.map(X=>`${X.x},${X.y}`).join(" L ")}`;E+=`<path d="${Y}" fill="none" stroke="${L}" stroke-width="2" />`,D+=H.map(X=>`<circle cx="${X.x}" cy="${X.y}" r="3" fill="#fff" stroke="${L}" stroke-width="2"><title>${I.riderName} (${X.date}): ${X.form}</title></circle>`).join("")}});const C=d.teams.filter(I=>I.division==="WorldTour"||I.divisionName==="WorldTour");let P='<option value="">-- Team auswählen --</option>';for(const I of C){const F=xt===I.id?" selected":"";P+=`<option value="${I.id}"${F}>${S(I.name)}</option>`}let A='<option value="">-- Fahrer auswählen --</option>';if(xt!=null){const I=d.riders.filter(F=>F.activeTeamId===xt&&F.id!==e.riderId&&!Ye.some(L=>L.riderId===F.id));for(const F of I)A+=`<option value="${F.id}">${S(F.firstName)} ${S(F.lastName)}</option>`}const _=`
  ...
  `}function Bm(e){const t=(e==null?void 0:e.programRaces)??[];return e!=null&&e.program?t.length===0?`
    ...
    ${i.map(l=>`
      ...
      <section class="rider-stats-placeholder">
        <h3>Keine Historie vorhanden</h3>
        <p>Für diesen Fahrer wurden in der aktuellen Karriere noch keine Ergebnisse gefunden.</p>
      </section>`}function xs(){const e=document.querySelector(".rider-stats-modal-card");e&&(d.riderStatsTab==="career"||d.riderStatsTab==="results"?(e.style.minWidth="min(1180px, 95vw)",e.style.maxWidth="1350px"):(e.style.minWidth="",e.style.maxWidth=""))}async function Zt(e){var c,l,g,m;const t=Te(e),a=(t==null?void 0:t.activeTeamId)!=null?((c=d.teams.find(u=>u.id===t.activeTeamId))==null?void 0:c.name)??null:null;Ye=[],xt=null,d.riderStatsSelectedRiderId=e,d.riderStatsTab="results",xs(),d.riderStatsTopResultsFilterCategory=null,d.riderStatsTopResultsFilterSeason=null,d.riderStatsTopResultsPage=1,f("rider-stats-title").innerHTML=bn(t,null),f("rider-stats-jersey").innerHTML="";const s=t!=null&&t.age?` · Alter ${t.age}`:"";f("rider-stats-meta").textContent=t?`${((l=t.role)==null?void 0:l.name)??"Fahrer"} · ${a??"Team unbekannt"}${s}`:"Historie wird geladen",f("rider-stats-body").innerHTML=Be(t,null,!0),He("riderStats");const r=await G.getRiderStats(e);if(d.riderStatsSelectedRiderId!==e)return;if(!r.success||!r.data){const u=t!=null&&t.age?` · Alter ${t.age}`:"";f("rider-stats-meta").textContent=t?`${((g=t.role)==null?void 0:g.name)??"Fahrer"} · ${a??"Team unbekannt"}${u}`:"Fehler beim Laden",f("rider-stats-body").innerHTML=`
      <section class="rider-stats-placeholder">
        <h3>Historie konnte nicht geladen werden</h3>
        <p>${S(r.error??"Unbekannter Fehler")}</p>
      </section>`;return}d.riderStatsPayload=r.data,xs(),f("rider-stats-title").innerHTML=bn(t,r.data),f("rider-stats-jersey").innerHTML="";const n=r.data.age?` · Alter ${r.data.age}`:t!=null&&t.age?` · Alter ${t.age}`:"",i=r.data.mentorName?` · Mentor: ${r.data.mentorName}`:"",o=r.data.mentoredRiderNames&&r.data.mentoredRiderNames.length>0?` · Mentor von: ${r.data.mentoredRiderNames.join(" - ")}`:"";f("rider-stats-meta").textContent=`${((m=t==null?void 0:t.role)==null?void 0:m.name)??"Fahrer"} · ${r.data.teamName??a??"Ohne aktives Team"}${n} · ${r.data.seasons.length} Saisons${i}${o}`,f("rider-stats-body").innerHTML=Be(t,r.data,!1)}function Km(){f("rider-stats-body").addEventListener("click",e=>{var r;const t=e.target.closest("button[data-rider-stats-tab]");if(!t){const n=e.target.closest("button[data-remove-compare-id]");if(n){const o=Number(n.dataset.removeCompareId);Ye=Ye.filter(l=>l.riderId!==o);const c=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(c,d.riderStatsPayload,!1);return}const i=e.target.closest("button[data-top-results-page]");if(i){const o=Number(i.dataset.topResultsPage);if(!isNaN(o)&&o>=1){d.riderStatsTopResultsPage=o;const c=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(c,d.riderStatsPayload,!1)}}return}const a=t.dataset.riderStatsTab;if(a!=="results"&&a!=="program"&&a!=="form"&&a!=="topResults"&&a!=="skills"&&a!=="career"&&a!=="fatigue"||a==="program"&&(((r=d.riderStatsPayload)==null?void 0:r.programRaces.length)??0)===0)return;d.riderStatsTab=a,xs();const s=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(s,d.riderStatsPayload,!1)}),f("rider-stats-body").addEventListener("change",async e=>{const t=e.target;if(t.id==="rider-stats-filter-category"){d.riderStatsTopResultsFilterCategory=t.value==="all"?null:t.value,d.riderStatsTopResultsPage=1;const a=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(a,d.riderStatsPayload,!1)}else if(t.id==="rider-stats-filter-season"){d.riderStatsTopResultsFilterSeason=t.value==="all"?null:Number(t.value),d.riderStatsTopResultsPage=1;const a=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(a,d.riderStatsPayload,!1)}else if(t.classList.contains("rider-stats-filter-checkbox")){const a=t.dataset.filterType;d.riderStatsTopResultsFilters[a]=t.checked,d.riderStatsTopResultsPage=1;const s=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(s,d.riderStatsPayload,!1)}else if(t.id==="rider-compare-team-select"){const a=t.value;xt=a?Number(a):null;const s=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(s,d.riderStatsPayload,!1)}else if(t.id==="rider-compare-rider-select"){const a=t.value;if(a){const s=Number(a);if(Ye.length>=10){alert("Sie können maximal 10 Fahrer vergleichen."),t.value="";return}const r=await G.getRiderStats(s);r.success&&r.data?Ye.push({riderId:r.data.riderId,riderName:r.data.riderName,teamId:r.data.teamId,teamName:r.data.teamName,formHistory:r.data.formHistory??[],peakDates:r.data.peakDates??[],currentSeasonPoints:r.data.currentSeasonPoints??0,currentSeasonRank:r.data.currentSeasonRank??null}):alert("Formverlauf konnte nicht geladen werden: "+(r.error??""));const n=Te(d.riderStatsSelectedRiderId);f("rider-stats-body").innerHTML=Be(n,d.riderStatsPayload,!1)}}})}function yn(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?0:t.includes("grand tour")?1:t.includes("monument")?2:t.includes("stage race high")?3:t.includes("one day high")?4:t.includes("stage race middle")?5:t.includes("one day middle")?6:t.includes("stage race low")?7:t.includes("one day low")?8:9}function Wm(e){const t=[];for(const p of e.seasons)for(const h of p.raceBlocks)for(const b of h.rows)t.push({...b,season:p.season,isStageRace:h.isStageRace});const a=Array.from(new Set(t.map(p=>p.raceCategoryName).filter(Boolean)));a.sort((p,h)=>p.localeCompare(h,"de"));const s=Array.from(new Set(t.map(p=>p.season))).sort((p,h)=>h-p);let r=t.filter(p=>p.rowType!=="stage_result"?p.rowType==="gc_final"?d.riderStatsTopResultsFilters.gc:p.rowType==="mountain_final"?d.riderStatsTopResultsFilters.mountain:p.rowType==="points_final"?d.riderStatsTopResultsFilters.points:p.rowType==="youth_final"?d.riderStatsTopResultsFilters.youth:!0:p.isStageRace?d.riderStatsTopResultsFilters.stage:d.riderStatsTopResultsFilters.oneDay);if(d.riderStatsTopResultsFilterCategory){const p=d.riderStatsTopResultsFilterCategory;if(p.endsWith("-etappen")){const h=p.substring(0,p.length-8);r=r.filter(b=>b.raceCategoryName===h&&b.rowType==="stage_result")}else if(p.endsWith("-gc")){const h=p.substring(0,p.length-3);r=r.filter(b=>b.raceCategoryName===h&&b.rowType!=="stage_result")}else r=r.filter(h=>h.raceCategoryName===p)}d.riderStatsTopResultsFilterSeason!=null&&(r=r.filter(p=>p.season===d.riderStatsTopResultsFilterSeason)),r.sort((p,h)=>{if(h.seasonPoints!==p.seasonPoints)return h.seasonPoints-p.seasonPoints;const b=p.rowType!=="stage_result",y=h.rowType!=="stage_result",v=p.resultRank??9999,k=h.resultRank??9999;if(d.riderStatsTopResultsFilterCategory)return v!==k?v-k:b!==y?b?-1:1:0;{const w=yn(p.raceCategoryName),T=yn(h.raceCategoryName);return w!==T?w-T:b!==y?b?-1:1:v-k}});const n=20,i=Math.max(1,Math.min(10,Math.ceil(r.length/n)));d.riderStatsTopResultsPage>i&&(d.riderStatsTopResultsPage=i);const o=(d.riderStatsTopResultsPage-1)*n,c=r.slice(o,o+n),g=`
    <div class="rider-stats-top-results-filters" style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; align-items: center; flex-wrap: wrap; background: rgba(255, 255, 255, 0.03); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.05);">
      <div class="form-group" style="margin: 0; display: flex; align-items: center;">
        ...
        <select id="rider-stats-filter-category" class="form-control" style="width: auto; display: inline-block; background: #222; color: #fff; border-color: #444;">
          ...
          ${a.map(p=>{if(p.toLowerCase().includes("stage race")||p.toLowerCase().includes("grand tour")||p.toLowerCase().includes("tour de france")){const b=`${p}-etappen`,y=`${p}-gc`;return`
        <option value="${S(b)}" ${d.riderStatsTopResultsFilterCategory===b?"selected":""}>${S(p)} - Etappen</option>
        <option value="${S(y)}" ${d.riderStatsTopResultsFilterCategory===y?"selected":""}>${S(p)} - GC</option>
  ...
  `,m=c.length===0?'<tr><td colspan="8" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':c.map(p=>{const h=p.rowType!=="stage_result",b=h?`${p.raceName} · ${Qs(p.rowType)}`:p.stageNumber&&p.isStageRace?`${p.raceName} · Etappe ${p.stageNumber}`:p.raceName;let y="–",v="–";p.finishStatus==="otl"?y=ht("OTL","place"):p.finishStatus==="dnf"?y=ht("DNF","place"):p.resultRank==null||(h?v=`<span class="rider-stats-final-type ${ji(p.rowType)}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${p.resultRank}</span>`:y=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${p.resultRank<=3?` rider-stats-rank-badge-top-${p.resultRank}`:""}">${S(String(p.resultRank))}</span>`);const k=h?"–":p.profile?sa(p.profile):"–",w=!h&&p.stageScore!=null&&p.stageScore>0?Za(p.stageScore,0,350):"–",T=za(p.raceCategoryName?p.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):p.raceCategoryName,p.isStageRace);return`
          <tr class="rider-stats-row${h?" rider-stats-row-final":""}">
            <td>${y}</td>
            <td>${v}</td>
            <td><strong>${S(b)}</strong>${h?"":Js(p.rolledWeatherId,p.rolledWetterName)}</td>
            <td>${k}</td>
            <td>${w}</td>
            <td>${T}</td>
      ...
      <div class="pagination-wrap" style="display: flex; justify-content: center; gap: 0.25rem; margin-top: 1rem; align-items: center;">
        ...
        ${Array.from({length:i}).map((p,h)=>{const b=h+1;return`<button type="button" class="btn btn-sm ${d.riderStatsTopResultsPage===b?"btn-primary":"btn-secondary"}" data-top-results-page="${b}">${b}</button>`}).join("")}
...
`+s.error);return}d.stageResults=s.data??null,d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId,d.selectedResultTypeId=((r=d.stageResults.classifications[0])==null?void 0:r.resultTypeId)??1,d.selectedResultsMarkerKey=Ge,d.selectedResultsSpecialView=null),d.selectedResultsRaceId!=null&&qi(d.selectedResultsRaceId),ye()}async function qi(e){if(!d.seasonStandings){const a=await G.getSeasonStandings();a.success&&a.data&&(d.seasonStandings=a.data)}const t=await G.getRaceResultsRoster(e);t.success&&t.data?d.resultsRoster=t.data:d.resultsRoster=null}function Qm(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function kn(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function ep(){const e=d.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=at(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=[...e.entries].sort((y,v)=>v.overallRating-y.overallRating),r=new Set(s.slice(0,5).map(y=>y.riderId)),n=y=>{var k;const v=d.riders.find(w=>w.id===y);return((k=v==null?void 0:v.skills)==null?void 0:k.sprint)??0},o=[...e.entries.filter(y=>!r.has(y.riderId))].sort((y,v)=>{const k=n(y.riderId),w=n(v.riderId);return w!==k?w-k:v.overallRating-y.overallRating}),c=new Set(o.slice(0,5).map(y=>y.riderId));function l(y){switch(y){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return y}}const g=new Map;for(const y of e.entries){const v=y.teamId;g.has(v)||g.set(v,{teamId:y.teamId,teamName:y.teamName,riders:[],avgRating:0}),g.get(v).riders.push(y)}for(const y of g.values())y.avgRating=y.riders.reduce((v,k)=>v+k.overallRating,0)/y.riders.length;const m=y=>{let v=Number.POSITIVE_INFINITY;for(const k of y)!k.hasDropped&&k.gcRank!=null&&k.gcRank<v&&(v=k.gcRank);return v},u=y=>{var k;if(!((k=d.seasonStandings)!=null&&k.riderStandings))return 0;let v=0;for(const w of y){const T=d.seasonStandings.riderStandings.find(M=>M.riderId===w.riderId);T&&T.points>v&&(v=T.points)}return v},p=y=>{if(y==null)return 0;const v=d.riders.filter(T=>T.activeTeamId===y);if(v.length===0)return 0;const k=v.map(T=>T.overallRating??0);k.sort((T,M)=>M-T);const w=k.slice(0,10);return w.length===0?0:w.reduce((T,M)=>T+M,0)/w.length},h=[...g.values()].sort((y,v)=>{const k=m(y.riders),w=m(v.riders);if((k!==Number.POSITIVE_INFINITY||w!==Number.POSITIVE_INFINITY)&&k!==w)return k-w;const T=u(y.riders),M=u(v.riders);if((T>0||M>0)&&T!==M)return M-T;const R=p(y.teamId),E=p(v.teamId);return Math.abs(R-E)>1e-4?E-R:(y.teamName??"").localeCompare(v.teamName??"","de")});for(const y of h)y.riders.sort((v,k)=>kn(v.roleId)-kn(k.roleId)||k.overallRating-v.overallRating||v.lastName.localeCompare(k.lastName,"de"));return`<div class="results-roster-grid">${h.map(y=>{const v=y.teamId!=null?pt(y.teamId,y.teamName):"",k=y.riders.map(T=>{var X;const M=Qm(T.roleId),R=T.countryCode?et[T.countryCode]??T.countryCode.slice(0,2).toLowerCase():null,E=R?`<span class="fi fi-${R} results-roster-flag" title="${S(T.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',D=`${T.firstName.charAt(0)}. ${T.lastName}`,C=T.roleName??"–",P=T.specialization1?l(T.specialization1):null,A=T.specialization2?l(T.specialization2):null;let _=C;P&&(_+=` · ${P}`),A&&(_+=` · ${A}`);const B=`<span class="results-roster-overall-badge" style="color:${tp(T.overallRating)}" title="Gesamtstärke: ${T.overallRating.toFixed(2)}">${T.overallRating.toFixed(2)}</span>`,x=T.hasDropped?" dropped":"";let N="";T.hasDropped?T.dropoutStatus==="dns"?N="DNS":T.dropoutStatus==="dnf"?N=((X=T.dropoutReason)==null?void 0:X.startsWith("OTL"))??!1?"OTL":"DNF":N="OUT":T.gcRank!=null&&(N=`${T.gcRank}`);let z="";if(T.hasDropped)z=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(T.dropoutReason||"")}">${N}</span>`;else if(T.gcRank!=null){let re="rider-stats-rank-badge-gc";T.gcRank===1?re="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":T.gcRank===2?re="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":T.gcRank===3&&(re="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),z=`<span class="rider-stats-rank-badge ${re}" title="GC Stand: Platz ${T.gcRank}">${T.gcRank}</span>`}const F=`style="color: ${T.hasDropped?"var(--text-500)":M.color}; font-weight: bold;"`,L=r.has(T.riderId),H=c.has(T.riderId);return`<div class="results-roster-rider${x}">
        <div class="results-roster-rider-info">
          ...
          <div class="results-roster-rider-meta">
            <span class="results-roster-role-spec" ${F}>${S(_)}</span>
          </div>
        </div>
  ...
  `}function $n(e){const t=e.title||"";return t.includes("guten Tag")?1:t.includes("schlechten Tag")?2:t.includes("Formhöhepunkt")||t.includes("Formhoehepunkt")?3:t.includes("nicht am Start")?4:5}function Rs(e){var g,m,u,p,h,b,y,v;if(e==null||!d.stageResults)return"";const t=at(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=d.stageResults.classifications,r=(m=(g=s.find(k=>k.resultTypeId===Ta))==null?void 0:g.rows.find(k=>k.rank===1))==null?void 0:m.riderId,n=(p=(u=s.find(k=>k.resultTypeId===hs))==null?void 0:u.rows.find(k=>k.rank===1))==null?void 0:p.riderId,i=(b=(h=s.find(k=>k.resultTypeId===Dn))==null?void 0:h.rows.find(k=>k.rank===1))==null?void 0:b.riderId,o=(v=(y=s.find(k=>k.resultTypeId===5))==null?void 0:y.rows.find(k=>k.rank===1))==null?void 0:v.riderId,c=[],l=d.selectedResultTypeId;return e===r&&(l===Ta||l===1&&a||l!==1&&l!==Ta)&&c.push('<span class="jersey-dot jersey-dot-yellow" title="Gelbes Trikot (Gesamtwertung)"></span>'),e===n&&c.push('<span class="jersey-dot jersey-dot-green" title="Grünes Trikot (Punktewertung)"></span>'),e===i&&c.push('<span class="jersey-dot jersey-dot-red" title="Rotes Trikot (Bergwertung)"></span>'),e===o&&c.push('<span class="jersey-dot jersey-dot-white" title="Weißes Trikot (Nachwuchswertung)"></span>'),c.length===0?"":`<span class="jersey-dots-wrapper">${c.join("")}</span>`}function Tn(e){if(!e)return"";let t=e;const a=[],s=[...d.riders].sort((n,i)=>{const o=`${n.firstName} ${n.lastName}`;return`${i.firstName} ${i.lastName}`.length-o.length});for(const n of s){const o=`${n.firstName} ${n.lastName}`.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"),c=new RegExp(`${o}(\\s+\\(\\d+\\.\\))?`,"g");c.test(t)&&(t=t.replace(c,l=>{const g=`__RIDER_LINK_${a.length}__`,m=Me(l,{riderId:n.id,teamId:n.activeTeamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return a.push(m),g}))}let r=S(t);for(let n=0;n<a.length;n++)r=r.replace(`__RIDER_LINK_${n}__`,a[n]);return r}function ye(){var X,re,$e,le;d.riders.length===0&&G.getRiders().then($=>{$.success&&$.data&&(d.riders=$.data,ye())});const e=f("results-race-select"),t=f("results-stage-select"),a=f("results-type-tabs"),s=f("results-marker-tabs"),r=f("results-stage-meta"),n=f("results-empty"),i=f("results-table"),o=i.querySelector("thead tr"),c=f("results-tbody"),l=f("results-marker-classifications"),g=f("results-roster"),m=i.querySelector("colgroup");m&&m.remove(),i.style.tableLayout="",d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId),e.innerHTML='<option value="">– Rennen auswählen –</option>'+d.races.filter($=>{var K;return(((K=$.stages)==null?void 0:K.length)??0)>0}).map($=>`<option value="${$.id}"${$.id===d.selectedResultsRaceId?" selected":""}>${S($.name)}</option>`).join("");const u=at(d.selectedResultsRaceId),p=u==null?"":(u.stages??[]).map($=>`<option value="${$.id}"${$.id===d.selectedResultsStageId?" selected":""}>${S(Xm(u,$))}</option>`).join("");t.innerHTML='<option value="">– Etappe auswählen –</option>'+p;const h=((X=d.stageResults)==null?void 0:X.classifications.filter($=>!(u&&!u.isStageRace&&$.resultTypeId!==1&&$.resultTypeId!==6)))??[],b=h.find($=>$.resultTypeId===d.selectedResultTypeId)??h[0]??null,y=d.selectedResultsSpecialView==="nonFinishers",v=d.selectedResultsSpecialView==="events",k=d.selectedResultsSpecialView==="roster";if(b&&!y&&!v&&!k&&(d.selectedResultTypeId=b.resultTypeId),v){i.style.tableLayout="fixed";const $=document.createElement("colgroup");$.innerHTML=`
      <col style="width: 100px;">
      <col style="width: 240px;">
      <col style="width: auto;">
    `,i.insertBefore($,i.firstChild)}if(!d.stageResults&&!k||!b&&!y&&!v&&!k){const $=Fa(d.selectedResultsStageId);r.textContent=$?`${$.race.name} · ${$.stage.profile} · ${Q($.stage.date)}`:"Noch keine Etappe ausgewählt.",a.innerHTML="",s.innerHTML="",s.classList.add("hidden"),c.innerHTML="",l.innerHTML="",l.classList.add("hidden"),i.classList.add("hidden"),g.innerHTML="",g.classList.add("hidden"),n.classList.remove("hidden"),n.textContent=d.selectedResultsStageId!=null?"Für diese Etappe liegen noch keine Ergebnisse vor.":"Noch keine Ergebnisse geladen.";return}k?d.resultsRoster&&(r.textContent=`${d.resultsRoster.raceName} · Starterfeld`):d.stageResults&&(r.textContent=`${d.stageResults.raceName} · Etappe ${d.stageResults.stageNumber} · ${d.stageResults.profile} · ${Q(d.stageResults.date)}`);const w=d.stageResults?Fa(d.stageResults.stageId):null,T=(w==null?void 0:w.stage.distanceKm)??null,M=new Map,R=new Map;if(d.stageResults){const $=d.stageResults.classifications.find(K=>K.resultTypeId===1);if($)for(const K of $.rows)K.riderId!=null&&K.points!=null&&K.points>0&&M.set(K.riderId,K.points);if(d.stageResults.markerClassifications){for(const K of d.stageResults.markerClassifications)if(er(K.markerType,K.markerCategory)){for(const W of K.entries)if(W.riderId!=null&&W.pointsAwarded!=null&&W.pointsAwarded>0){const O=R.get(W.riderId)??0;R.set(W.riderId,O+W.pointsAwarded)}}}}const E=(b==null?void 0:b.resultTypeId)===Ta,D=(b==null?void 0:b.resultTypeId)===hs||(b==null?void 0:b.resultTypeId)===Dn,C=(b==null?void 0:b.resultTypeId)===5,P=(b==null?void 0:b.resultTypeId)===6,A=E||D||C||P,_=h.map($=>`
    <button
      type="button"
      class="results-type-btn${!y&&!v&&!k&&$.resultTypeId===d.selectedResultTypeId?" active":""}"
      data-result-type-id="${$.resultTypeId}"
    >${S($.resultTypeName)}</button>
  `),B=`
    <button
      type="button"
  ...
  `,N=`
    ...
    >Teilnehmer</button>
  `,z=h.findIndex($=>$.resultTypeName.toLocaleLowerCase("de").includes("team"));z>=0?_.splice(z+1,0,B,x,N):_.push(B,x,N),a.innerHTML=_.join("");const I=Zm(((re=d.stageResults)==null?void 0:re.markerClassifications)??[]);if(k){g.innerHTML=ep(),g.classList.remove("hidden"),i.classList.add("hidden"),s.innerHTML="",s.classList.add("hidden"),l.innerHTML="",l.classList.add("hidden"),n.classList.add("hidden");return}else g.innerHTML="",g.classList.add("hidden");const F=!y&&!v&&!k&&(b==null?void 0:b.resultTypeId)===1&&I.length>0,L=F?d.selectedResultsMarkerKey??Ge:null,H=F&&L!==Ge?I.find($=>$.markerKey===L)??null:null;if(F&&(d.selectedResultsMarkerKey=(H==null?void 0:H.markerKey)??Ge),v){const $=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"}];s.innerHTML=$.map(K=>`
      <button
        type="button"
    ...
    `).join("")}else s.innerHTML=F?[`
        <button
          ...
          data-marker-key="${Ge}"
        >Tageswertung</button>`,...I.map($=>`
        <button
          type="button"
          class="results-type-btn${$.markerKey===d.selectedResultsMarkerKey?" active":""}"
          data-marker-key="${$.markerKey}"
        >${S(qm($))}</button>
      `)].join(""):"";s.classList.toggle("hidden",!v&&!F);const Y=y||v||!F||d.selectedResultsMarkerKey===Ge;if(o&&Y&&(o.innerHTML=y?`
        <th>Etappe</th>
        <th>Status</th>
      ...
      `:D?`
        ...
        <th class="results-points-cell">Punktewertung</th>
        <th>UCI Punkte</th>
      `),c.innerHTML=y?((($e=d.stageResults)==null?void 0:$e.nonFinishers)??[]).map($=>`
      <tr>
        <td>${$.stageNumber}</td>
        <td>${Lo($.isOtl)}</td>
        <td class="results-jersey-col-cell">${At($.teamId,$.teamName)}</td>
        <td>${Bt($.riderName,!0,!1,$.riderId,$.teamId)}</td>
        <td class="results-flag-col-cell">${Ue($.countryCode)}</td>
        <td>${lt($.teamName||"–",$.teamId)}</td>
        <td>${S(bs($.statusReason,$.isOtl))}</td>
      </tr>
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':v?[...((le=d.stageResults)==null?void 0:le.events)??[]].filter($=>Ee==="all"?!0:Ee==="form"?!!($.title&&($.title.includes("guten Tag")||$.title.includes("schlechten Tag")||$.title.includes("Formhöhepunkt")||$.title.includes("Formhoehepunkt"))):Ee==="attack"?($.type==="attack"||$.type==="counter_attack")&&!($.title&&($.title.toLowerCase().includes("ausreiß")||$.title.toLowerCase().includes("ausreiss"))):Ee==="breakaway"?!!($.title&&($.title.toLowerCase().includes("ausreiß")||$.title.toLowerCase().includes("ausreiss"))):Ee==="incident"?($.type==="incident"||!!($.title&&$.title.includes("Massensturz")))&&!($.title&&($.title.toLowerCase().includes("ausreiß")||$.title.toLowerCase().includes("ausreiss"))):Ee==="exit"?$.type==="dnf"||!!($.title&&$.title.includes("nicht am Start")):Ee==="home"?!!($.title&&($.title.includes("Heimvorteil")||$.title.includes("Heimdruck"))):Ee==="weather"?!!($.title&&$.title.startsWith("Wetterbericht:")):!0).sort(($,K)=>{const W=$.kmMark??0,O=K.kmMark??0;if(Math.abs(W-O)>1e-4)return W-O;if(W===0){const Le=$n($),Ie=$n(K);if(Le!==Ie)return Le-Ie}const ie=$.riderName??"",be=K.riderName??"";return ie.localeCompare(be,"de")}).map($=>{var Lt,br,yr;const K=$.kmMark!=null?`${$.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",W=$.riderId,O=W!=null?Te(W):null,ie=$.riderTeamId??(O==null?void 0:O.activeTeamId)??null,be=ie!=null?((Lt=d.teams.find(na=>na.id===ie))==null?void 0:Lt.name)??null:null;let Le=At(ie,be);const Ie=!!($.title&&$.title.startsWith("Wetterbericht:"));let vt=$.title||"";if(Ie){const na=(br=d.stageResults)==null?void 0:br.rolledWeatherId,es=(yr=d.stageResults)==null?void 0:yr.rolledWetterName;Le=`<span class="results-jersey-cell">${Js(na,es)}</span>`,es&&(vt=`Wetterbericht: ${es}`)}const ra=Ie?"":Ue(W!=null?Ma(W):null),St=Ie?"":W!=null?Bt($.riderName??"",!0,!1,W,ie):S($.riderName||"–");let ce="";return $.title&&$.title.includes("guten Tag")?ce='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':$.title&&$.title.includes("schlechten Tag")?ce='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':$.title&&($.title.includes("Formhöhepunkt")||$.title.includes("Formhoehepunkt"))?ce='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':$.title&&$.title.includes("nicht am Start")?ce='<span class="event-badge event-badge-dns">DNS</span>':$.title&&$.title.includes("Massensturz")?ce='<span class="event-badge event-badge-masscrash">Massensturz</span>':$.type==="dnf"?ce='<span class="event-badge event-badge-dnf">DNF</span>':$.title&&($.title.toLowerCase().includes("ausreiß")||$.title.toLowerCase().includes("ausreiss"))?ce='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':$.type==="attack"?ce='<span class="event-badge event-badge-attack">Attacke</span>':$.type==="counter_attack"?ce='<span class="event-badge event-badge-counter">Konterattacke</span>':$.type==="incident"?$.title&&($.title.toLowerCase().includes("defekt")||$.title.toLowerCase().includes("panne")||$.title.toLowerCase().includes("technisch"))?ce='<span class="event-badge event-badge-defect">Defekt</span>':ce='<span class="event-badge event-badge-crash">Sturz</span>':$.title&&$.title.includes("Super-Heimvorteil")?ce='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Super-Heim</span>':$.title&&$.title.includes("Heimdruck")?ce='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimdruck</span>':$.title&&$.title.includes("Heimvorteil")?ce='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':$.title&&$.title.startsWith("Wetterbericht:")&&(ce='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>'),`
          <tr>
            <td>${K}</td>
            <td>
            ...
            <td>
              <div class="event-content">
                ...
                ${$.detail?`<div class="event-detail">${Tn($.detail)}</div>`:""}
              </div>
            </td>
          </tr>`}).join("")||'<tr><td colspan="3" class="results-empty-cell">Keine Ereignisse für diese Etappe.</td></tr>':Y&&b?b.rows.map($=>{const K=$.riderName??$.teamName,W=$.riderName?$.teamName:"–",O=At($.teamId,$.teamName),ie=Bt(K,!0,$.isBreakaway===!0,$.riderId,$.teamId),be=Ue(Ma($.riderId)),Le=b.resultTypeId===1&&$.rank===1&&$.timeSeconds!=null&&T!=null,Ie=$.timeSeconds!=null?`${Ea($.timeSeconds)}${Le?` (${Jm(T,$.timeSeconds)})`:""}`:"–",vt=A?`<td class="results-gc-delta-cell">${Do($.previousRank,$.rankDelta)}</td>`:"";if(D){let St=$.points!=null?String($.points):"–";if($.points!=null&&$.riderId!=null&&b){const Lt=b.resultTypeId===hs?M.get($.riderId)??0:R.get($.riderId)??0;Lt>0&&(St+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${Lt}</span>`)}return`
          <tr>
          ...
          <tr>
            ...
            <td class="results-flag-col-cell">${be}</td>
            <td>${Ie}</td>
            <td>${S(ts($.gapSeconds))}</td>
            <td>${$.uciPoints!=null?$.uciPoints:"–"}</td>
          </tr>`;let ra=$.points!=null?String($.points):"–";if($.leadoutBonus!=null&&$.leadoutBonus>0&&$.leadoutRiderId!=null){const St=ap($);ra=`
        ...
        <tr>
          ...
          <td>${$.uciPoints!=null?$.uciPoints:"–"}</td>
        </tr>`}).join(""):"",n.classList.toggle("hidden",!!b||y||v||k),i.classList.toggle("hidden",!Y||k),H){const $=`
      <section class="results-marker-card">
        <div class="results-results-view-marker-card-head">
          <h4>${S(Ao(H.markerType,H.markerLabel))}</h4>
    ...
    <div class="team-detail-card">
      <div class="team-detail-header">
        ...
        <div class="team-detail-meta">
          ...
          <span>Kürzel: ${S(a.abbreviation)} · Top 12 ${S(Qi(a.id))} (${S(eo(a.id))})</span>
      ...
      <div class="team-detail-meta" style="margin-top:0.75rem">
        ...
        <span class="text-muted">Sortierung: ${S(ir(d.teamTableSort.key))} ${d.teamTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${so()}
...
`+(a.error??"Unbekannter Fehler")),!1;const s=a.data,r=await Zd(s,o=>Bn(o)),n=lo(r,s),i=co(r,s);return await bo(e,n,r.markerClassifications,r.incidents,r.allEvents,t,i),!0}catch(a){return alert("Unerwarteter Fehler bei der Instant-Simulation: "+a.message),!1}finally{Sr(null),me()}}function mo(e){var s;const t=(s=d.rosterEditor)==null?void 0:s.teams.find(r=>r.team.id===e);if(!t)return 0;const a=new Set(d.rosterEditorSelectedRiderIds);return t.riders.filter(r=>a.has(r.rider.id)).length}function po(){return d.rosterEditor?d.rosterEditor.teams.every(e=>mo(e.team.id)===e.riderLimit):!1}function us(){const e=f("roster-editor-title"),t=f("roster-editor-meta"),a=f("roster-editor-body"),s=f("btn-apply-roster-editor"),r=d.rosterEditor;if(!r){e.textContent="Starterfeld bearbeiten",t.textContent="",a.innerHTML='<div class="results-empty">Kein Starterfeld geladen.</div>',s.disabled=!0;return}e.textContent="Starterfeld bearbeiten",t.textContent=r.race.isStageRace?`${r.race.name} · Etappe ${r.stage.stageNumber} · ${r.stage.profile}`:`${r.race.name} · ${r.stage.profile}`;const n=new Set(d.rosterEditorSelectedRiderIds);a.innerHTML=r.teams.map(i=>{const o=mo(i.team.id),c=o===i.riderLimit?"roster-editor-team-count-ok":"roster-editor-team-count-bad";return`
      <section class="roster-editor-team">
        ...
        <div class="roster-editor-riders">
          ${i.riders.map(l=>{var b;const m=["roster-editor-rider",n.has(l.rider.id)?"roster-editor-rider-selected":"",l.isLocked?"roster-editor-rider-locked":""].filter(Boolean).join(" "),u=l.rider.country?se(l.rider.country.code3):"",p=[((b=l.rider.role)==null?void 0:b.name)??"Ohne Rolle",`OVR ${Math.round(l.rider.overallRating)}`].join(" · "),h=l.lockReason?`<span class="roster-editor-rider-lock">${S(l.lockReason)}</span>`:"";return`
              <button
                type="button"
                class="${m}"
...
`+(o.error??"Unbekannter Fehler"));return}const c=o.data;d.selectedResultsRaceId=(c==null?void 0:c.raceId)??d.selectedResultsRaceId,d.selectedResultsStageId=(c==null?void 0:c.stageId)??e,d.selectedResultTypeId=1,d.realtimeBootstrap=null,d.realtimeError=null,await ws(e,!1),await cr(),await ur(),await Wa(),Et(),n||yt("results")}catch(o){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+o.message)}finally{vr(!1),me()}}}function cp(){f("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);d.selectedRealtimeStageId=Number.isFinite(t)?t:null,d.realtimeBootstrap&&d.realtimeBootstrap.stage.id!==d.selectedRealtimeStageId&&(d.realtimeBootstrap=null),d.realtimeError=null,ho(t,!1)})}function dr(e){var s;const t=qt((s=e.category)==null?void 0:s.name),a=ja(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function qa(e){var r,n;const t=qt((r=e.category)==null?void 0:r.name),a=ja(t),s=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(s)}</span>`}function up(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(s=>s.date).sort((s,r)=>s.localeCompare(r));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function Ja(e){const{startDate:t,endDate:a}=up(e);return t===a?Q(t):`${Q(t)} - ${Q(a)}`}function mp(e){return e.stageId>0}async function cr(){const[e,t]=await Promise.all([G.getGameState(),G.getGameStatus()]);if(!e.success){console.error(e.error);return}d.gameState=e.data??null,d.gameStatus=t.success?t.data??null:null,pp(),fe("dashboard")&&Xa()}function pp(){var r;if(!d.gameState)return;f("meta-date").textContent=d.gameState.formattedDate,f("meta-season").textContent=`Saison ${d.gameState.season}`;const e=f("meta-race-hint"),t=f("btn-advance-day"),a=f("pending-stages-list"),s=((r=d.gameStatus)==null?void 0:r.pendingStages)??[];s.length>0?(e.textContent=`${s.length} offene Etappe${s.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=s.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${Q(n.date)}`:`${n.profile} · ${Q(n.date)}`,o=mp(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
    ...
    <tr>
      ...
      <td>${l}</td>
      <td>${s}</td>
    </tr>`}function bp(){const e=f("dashboard-races-tbody");if(!d.gameState){e.innerHTML='<tr><td colspan="9" class="text-muted">Kein Spiel geladen.</td></tr>';return}const t=d.gameState.currentDate,a=hp(t,7),s=d.races.filter(i=>i.startDate<=t&&i.endDate>=t),r=d.races.filter(i=>i.startDate>t&&i.startDate<=a);let n="";n+=`
  ...
  `,r.length===0?n+=`
    ...
    `:n+=r.map(i=>Mn(i)).join(""),e.innerHTML=n}function aa(e){return`Etappe ${e.stageNumber}`}function yp(e){if(e.length===0)return"Keine Etappen";const t=new Map;return e.forEach(a=>{t.set(a.profile,(t.get(a.profile)??0)+1)}),Array.from(t.entries()).sort((a,s)=>s[1]!==a[1]?s[1]-a[1]:a[0].localeCompare(s[0])).map(([a,s])=>`${s}x ${a}`).join(" · ")}function vp(e){return`stage-profile-badge-${e.toLowerCase().replace(/_/g,"-")}`}function sa(e){return`<span class="stage-profile-badge ${vp(e)}">${S(e)}</span>`}function Qa(e,t){return`${e.name} · ${aa(t)} · ${t.profile}`}async function Sp(e){var r;const t=d.stageSummariesByStageId[e];if(t)return t;const a=await G.getStageSummary(e);if(a.success&&a.data)return d.stageSummariesByStageId[e]=a.data,d.stageSummaryErrorsByStageId&&delete d.stageSummaryErrorsByStageId[e],a.data;const s=await G.getRealtimeSimulation(e);return s.success&&((r=s.data)!=null&&r.stageSummary)?(d.stageSummariesByStageId[e]=s.data.stageSummary,d.stageSummaryErrorsByStageId&&delete d.stageSummaryErrorsByStageId[e],s.data.stageSummary):(d.stageSummaryErrorsByStageId&&(d.stageSummaryErrorsByStageId[e]=a.error??s.error??"Etappenprofil konnte nicht geladen werden."),console.error("Stage-Summary-Laden fehlgeschlagen:",{stageId:e,stageSummaryError:a.error,realtimeFallbackError:s.error}),d.stageSummariesByStageId&&delete d.stageSummariesByStageId[e],!a.success||!a.data?null:a.data)}function kp(){var c;const e=f("race-stages-title"),t=f("race-stages-meta"),a=f("race-stages-body"),s=at(d.selectedDashboardRaceId);if(!s){e.textContent="Etappen",t.textContent="",a.innerHTML='<div class="results-empty">Rennen nicht gefunden.</div>';return}const r=s.stages??[],n=r.reduce((l,g)=>l+(g.distanceKm??0),0),i=r.reduce((l,g)=>l+(g.elevationGainMeters??0),0),o=yp(r);if(e.textContent=s.name,t.textContent=`${Ja(s)} · ${((c=s.country)==null?void 0:c.name)??`Land ${s.countryId}`} · ${s.isStageRace?`${s.numberOfStages} Etappen`:"Eintagesrennen"} · ${ys(n)} · ${vs(i)} · ${o}`,r.length===0){a.innerHTML='<div class="results-empty">Für dieses Rennen sind keine Etappen vorhanden.</div>';return}a.innerHTML=`
      ...
      <table class="data-table dashboard-race-stages-table">
        ...
        <tbody>
          ${e.races.map(t=>{var a,s;return`
            <tr>
              <td>${Ja(t)}</td>
              <td><span class="dashboard-race-country">${(a=t.country)!=null&&a.code3?se(t.country.code3):""}<span>${S(((s=t.country)==null?void 0:s.name)??`Land ${t.countryId}`)}</span></span></td>
    ...
    </div>`}async function mr(e){const t=d.riders.find(s=>s.id===e);f("rider-program-title").textContent=t?xe(t):"Programm",f("rider-program-meta").textContent="Lade Programmrennen ...",f("rider-program-body").innerHTML="",He("riderProgram");const a=await G.getRiderProgramRaces(e);if(!a.success||!a.data){f("rider-program-meta").textContent="",f("rider-program-body").innerHTML=`<div class="results-empty">${S(a.error??"Programm konnte nicht geladen werden.")}</div>`;return}f("rider-program-title").textContent=a.data.program.name,f("rider-program-meta").textContent=t?xe(t):"",f("rider-program-body").innerHTML=$p(a.data)}function Tp(e){if(e.length===0)return'<div class="results-empty">Keine Programmfahrer für dieses Rennen.</div>';const t=Mp(e);return`
    <div class="dashboard-race-stages-table-wrap">
        ...
        <tbody>
          ${t.map(a=>{var s,r;return`
            <tr class="race-participants-row">
              ...
              <td><span class="race-participant-rider-cell">${se(gt(a.rider))}<strong>${S(xe(a.rider))}</strong></span></td>
              <td>${S(Cs(a.rider))}</td>
              <td>${S(tt(a.rider))}</td>
    ...
    </th>`}function Mp(e){const t=d.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,s)=>{var n,i,o,c;let r=0;switch(d.raceParticipantsSort.key){case"team":r=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=s.team)==null?void 0:i.name)??"","de");break;case"rider":r=xe(a.rider).localeCompare(xe(s.rider),"de");break;case"spec1":r=Cs(a.rider).localeCompare(Cs(s.rider),"de");break;case"role":r=tt(a.rider).localeCompare(tt(s.rider),"de");break;case"overall":r=a.rider.overallRating-s.rider.overallRating;break;case"phase":r=(a.rider.seasonFormPhase??"neutral").localeCompare(s.rider.seasonFormPhase??"neutral","de");break;default:r=(((o=a.program)==null?void 0:o.name)??"").localeCompare(((c=s.program)==null?void 0:c.name)??"","de")}return r*t||xe(a.rider).localeCompare(xe(s.rider),"de")})}function Cs(e){return e.specialization1!=null?zt(e.specialization1):"–"}async function yo(e){const t=at(e);d.selectedRaceParticipantsRaceId=e,f("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",f("race-participants-meta").textContent="Lade Programmfahrer ...",f("race-participants-body").innerHTML="",d.raceParticipants=[],He("raceParticipants"),await vo()}async function vo(e=!1){const t=d.selectedRaceParticipantsRaceId;if(t==null)return;const a=at(t);e&&(f("race-participants-meta").textContent="Lade Programmfahrer ...");const s=await G.getRaceProgramParticipants(t);if(!s.success||!s.data){f("race-participants-meta").textContent="",f("race-participants-body").innerHTML=`<div class="results-empty">${S(s.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}d.raceParticipants=s.data,f("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",f("race-participants-meta").textContent=`${s.data.length} Programmfahrer · ${a?Ja(a):""}`,f("race-participants-body").innerHTML=Tp(d.raceParticipants)}async function xp(e,t=null){const a=Fa(e);if(!a)return;const s=await Sp(e);if(!s){alert(d.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}d.selectedDashboardProfileStageId=e,f("stage-profile-title").textContent=`${a.race.name} · ${aa(a.stage)}`;const r=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";f("stage-profile-meta").textContent=`${Q(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?ys(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?vs(a.stage.elevationGainMeters):"–"}${r}`,ol(f("stage-profile-view"),s,a.stage.profile,Qa(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),He("stageProfile")}function wp(){f("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const r=Number(t.dataset.editStageRoster);if(!Number.isFinite(r))return;lp(r);return}const a=e.target.closest("button[data-live-stage]");if(a){const r=Number(a.dataset.liveStage);if(!Number.isFinite(r))return;ho(r,!0);return}const s=e.target.closest("button[data-instant-stage]");if(s){const r=Number(s.dataset.instantStage);if(!Number.isFinite(r))return;uo(r)}}),f("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const r=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(r)&&yo(r);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const s=Number(a.dataset.dashboardRaceId);Number.isFinite(s)&&Fs(s)}),f("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&xp(a)}),f("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const r=Number(t.dataset.riderProgramId);Number.isFinite(r)&&mr(r);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const s=a.dataset.raceParticipantsSort;d.raceParticipantsSort.key===s?d.raceParticipantsSort.direction=d.raceParticipantsSort.direction==="asc"?"desc":"asc":d.raceParticipantsSort={key:s,direction:"asc"},vo()}),f("btn-advance-day").addEventListener("click",async()=>{await So()}),f("btn-auto-progress").addEventListener("click",()=>{Rp()})}async function So(){he("Tag wird fortgeschrieben...");try{const e=await G.advanceDay();if(!e.success)return alert(`Tageswechsel fehlgeschlagen:
`+(e.error??"Unbekannter Fehler")),!1;if(d.currentSave&&e.data&&(d.currentSave.currentSeason=e.data.season),await cr(),await ur(),fe("teams")){const{refreshTeamsViewData:t}=await Kn(async()=>{const{refreshTeamsViewData:a}=await Promise.resolve().then(()=>ip);return{refreshTeamsViewData:a}},void 0);await t()}return!0}catch(e){return alert("Unerwarteter Fehler beim Tageswechsel: "+e.message),!1}finally{me()}}function pr(){const e=document.getElementById("btn-auto-progress");e&&(qe?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function Rp(){qe?ko():Ip()}function Ip(){qe||(Ds(!0),pr(),Ep())}function ko(){qe&&(Ds(!1),pr())}async function Ep(){var e;for(;qe;){const t=((e=d.gameStatus)==null?void 0:e.pendingStages)??[];let a=!1;if(t.length>0){const s=t[0];a=await uo(s.stageId,!0)}else a=await So();if(!a){Ds(!1);break}await new Promise(s=>setTimeout(s,100))}pr()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&qe){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),ko()}});const jt=50;function gr(){return[...ar,...sr[d.riderMenuDetailPage]]}function $o(e){return d.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${d.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function To(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=d.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </div>`}function wa(){const e=f("riders-detail"),t=gr(),a=io(d.riders),s=a.length,r=Math.max(1,Math.ceil(s/jt));d.riderMenuPage=Math.min(r,Math.max(1,d.riderMenuPage));const n=(d.riderMenuPage-1)*jt,i=Math.min(s,n+jt),o=a.slice(n,i);e.innerHTML=`
    <div class="team-detail-card">
      <div class="team-detail-header">
        <h3>Alle Fahrer</h3>
      </div>
      <div class="team-detail-meta" style="margin-top:0.75rem">
        <span>${s} Fahrer</span>
        <span class="text-muted">Sortierung: ${S(ir(d.riderMenuTableSort.key))} ${d.riderMenuTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${Mo()}
      <div class="team-detail-table-scroll">
        <table class="data-table data-table-teams">
      ...
      <section class="rider-team-editor-main">
        <div class="team-detail-card">
          <div class="rider-team-editor-toolbar">
            ...
            <div class="team-detail-meta">
              <span>${i}</span>
              <span class="text-muted">Sortierung: ${S(d.riderTeamEditorSort.key==="teamName"?"Team":((o=ka.find(c=>c.key===d.riderTeamEditorSort.key))==null?void 0:o.title)??d.riderTeamEditorSort.key)} ${d.riderTeamEditorSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
...
`+t.error);return}d.injuries=t.data??[],fe("injuries")&&Rn()}function Rn(){const e=f("injuries-table-container");if(!d.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(f("injuries-meta").textContent=d.injuries.length+" Ausfälle",d.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=Zt;let t="";const a=d.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),s=new Map;for(const n of a){const i=n.teamId;s.has(i)||s.set(i,[]),s.get(i).push(n)}for(const n of s.keys())s.get(n).sort((i,o)=>o.overallRating-i.overallRating);const r=Array.from(s.keys()).sort((n,i)=>{const o=s.get(n)[0].teamAbbreviation||"",c=s.get(i)[0].teamAbbreviation||"";return o.localeCompare(c)});if(r.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of r){const i=s.get(n),o=i[0].teamAbbreviation;t+=`
    ...
    </div>`}async function Jp(e){const t=await G.getSeasonStandings();if(!t.success){d.seasonStandings=null,fe("season-standings")&&Ps();return}d.seasonStandings=t.data??null,fe("season-standings")&&Ps()}function Ps(){var h,b,y,v,k,w;const e=f("season-standings-meta"),t=f("season-standings-scope-tabs"),a=f("season-standings-empty"),s=f("season-standings-table"),r=f("season-standings-tbody"),n=f("season-standings-jersey-header"),i=f("season-standings-primary-header"),o=f("season-standings-flag-header"),c=f("season-standings-secondary-header"),l=((h=d.seasonStandings)==null?void 0:h.season)??((b=d.gameState)==null?void 0:b.season)??((y=d.currentSave)==null?void 0:y.currentSeason)??null;e.textContent=l!=null?`Saison ${l} · Ergebnis- und Trikotpunkte kumuliert`:"Noch keine Saisonwertung geladen.",t.innerHTML=`
    <button
      type="button"
  ...
  `;const g=d.selectedSeasonStandingScope==="countries",m=g?((v=d.seasonStandings)==null?void 0:v.countryStandings)??[]:d.selectedSeasonStandingScope==="teams"?((k=d.seasonStandings)==null?void 0:k.teamStandings)??[]:((w=d.seasonStandings)==null?void 0:w.riderStandings)??[],u=g?m:[],p=g?[]:m;if(n.textContent="Trikot",i.textContent=g?"Land":d.selectedSeasonStandingScope==="teams"?"Team":"Fahrer",o.textContent="Flagge",c.textContent=d.selectedSeasonStandingScope==="teams"?"Land":"Team",n.classList.toggle("hidden",g),c.classList.toggle("hidden",g),!d.seasonStandings||m.length===0){r.innerHTML="",s.classList.add("hidden"),a.classList.remove("hidden"),a.textContent="Noch keine Saisonpunkte vorhanden.";return}r.innerHTML=g?u.map(T=>`
    ...
    `}).join(""),i=[...e.riders].sort((l,g)=>(g.overallRating??0)-(l.overallRating??0)).slice(0,10).map(l=>{const g=`${l.firstName.charAt(0)}. ${l.lastName}`,m=Me(g,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),u=l.nationality?et[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,p=u?`<span class="fi fi-${u} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",h=l.overallRating.toFixed(0),b=d.riders.find(v=>v.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${$a((b==null?void 0:b.roleId)??null).color};">
          ${p}
          ${m}
        </span>
        <span style="font-weight: 700; color: var(--text-300); font-size: 0.8rem;">${h}</span>
      </li>
    `}).join(""),o=a.map(({rider:l,formValue:g})=>{const m=`${l.firstName.charAt(0)}. ${l.lastName}`,u=Me(m,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),p=l.nationality?et[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,h=p?`<span class="fi fi-${p} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",b=(g>=0?"+":"")+g.toFixed(1).replace(".",","),y=`S-Form: ${l.formBonus>=0?"+":""}${l.formBonus.toFixed(1)} / R-Form: ${l.raceFormBonus>=0?"+":""}${l.raceFormBonus.toFixed(1)}`,v=d.riders.find(w=>w.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${$a((v==null?void 0:v.roleId)??null).color};">
          ${h}
          ${u}
        </span>
        <span style="font-weight: 700; color: #fbbf24;" title="${y}">${b}</span>
      </li>
    `}).join(""),c=s.map(({rider:l,uciRank:g})=>{const m=`${l.firstName.charAt(0)}. ${l.lastName}`,u=Me(m,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),p=l.nationality?et[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,h=p?`<span class="fi fi-${p} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"";let b="rider-stats-rank-badge-gc";g===1?b="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":g===2?b="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":g===3&&(b="rider-stats-rank-badge-place rider-stats-rank-badge-top-3");const y=`<span class="rider-stats-rank-badge ${b}" style="margin: 0; font-size: 0.75rem; padding: 0; min-width: 2rem; height: 1.35rem; display: inline-flex; align-items: center; justify-content: center; text-align: center; box-sizing: border-box; line-height: 1;" title="UCI Weltrangliste: Platz ${g}">${g}</span>`,v=d.riders.find(w=>w.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${$a((v==null?void 0:v.roleId)??null).color};">
          ${h}
          ${u}
    ...
    <div class="rider-stats-top-results-filters" style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; align-items: center; flex-wrap: wrap; background: rgba(255, 255, 255, 0.03); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.05);">
      <div class="form-group" style="margin: 0; display: flex; align-items: center;">
        ...
        <select id="team-stats-filter-category" class="form-control" style="width: auto; display: inline-block; background: #222; color: #fff; border-color: #444;">
          <option value="all">Alle Rennklassen</option>
          ${t.map(u=>{if(u.toLowerCase().includes("stage race")||u.toLowerCase().includes("grand tour")||u.toLowerCase().includes("tour de france")){const h=`${u}-etappen`,b=`${u}-gc`;return`
  ...
  `,g=o.length===0?'<tr><td colspan="10" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':o.map(u=>{const p=u.rowType!=="stage_result",h=p?`${u.raceName} · ${u.rowType==="gc_final"?"Gesamtwertung":u.rowType==="points_final"?"Punktewertung":u.rowType==="mountain_final"?"Bergwertung":"Nachwuchs"}`:u.stageNumber?`${u.raceName} · Etappe ${u.stageNumber}`:u.raceName;let b="–",y="–";u.finishStatus==="otl"?b=ht("OTL","place"):u.finishStatus==="dnf"?b=ht("DNF","place"):u.resultRank==null||(p?y=`<span class="rider-stats-final-type ${u.rowType==="gc_final"?"is-gc":u.rowType==="points_final"?"is-points":u.rowType==="mountain_final"?"is-mountain":"is-youth"}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${u.resultRank}</span>`:b=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${u.resultRank<=3?` rider-stats-rank-badge-top-${u.resultRank}`:""}">${S(String(u.resultRank))}</span>`);const v=u.profile?sa(u.profile):"–",k=!p&&u.stageScore!=null&&u.stageScore>0?Za(u.stageScore,0,350):"–",w=za(u.raceCategoryName),T=u.riderCountryCode?et[u.riderCountryCode]??u.riderCountryCode.slice(0,2).toLowerCase():null,M=T?`<span class="fi fi-${T} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px;" title="${S(u.riderCountryCode??"")}"></span>`:"–",R=Me(u.riderName,{riderId:u.riderId,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return`
  ...
  `}function og(e,t){var s;if(e==null)return'<span class="results-team-jersey-placeholder" style="width: 54px; height: 54px; display: inline-block;" aria-hidden="true"></span>';const a=t??((s=d.teams.find(r=>r.id===e))==null?void 0:s.name)??`Team ${e}`;return`
    <span class="results-team-jersey large-jersey" title="${S(a)}" aria-label="${S(a)}" style="width: 54px; height: 54px; display: inline-block;">
      ...
      >
    </span>`}async function Eo(e){d.teamStatsSelectedTeamId=e,d.teamStatsTab="topResults",d.teamStatsTopResultsFilterCategory=null,d.teamStatsTopResultsFilterSeason=null,d.teamStatsSelectedSeason="all",d.teamStatsTopResultsPage=1;const t=d.teams.find(n=>n.id===e);f("team-stats-title").innerHTML=t?`Team <strong>${S(t.name)}</strong>`:"Teamstatistik",f("team-stats-jersey").innerHTML=og(e,(t==null?void 0:t.name)??"");const a=sg(e),s=a.average.toFixed(2).replace(".",",");f("team-stats-meta").innerHTML=t?`${S(t.abbreviation)} · ${S(t.divisionName||t.division||"–")} · <strong>Overall-Stärke (Top 10):</strong> Platz ${a.rank}/${a.total} (Ø ${s})`:"Daten werden geladen",f("team-stats-body").innerHTML=`
    <section class="rider-stats-placeholder">
      <h3>Statistiken werden geladen</h3>
      <p>Die Teamergebnisse und Fahrerdaten werden zusammengestellt.</p>
    </section>
  `,He("teamStats");const r=await G.getTeamStats(e);if(d.teamStatsSelectedTeamId===e){if(!r.success||!r.data){f("team-stats-body").innerHTML=`
      <section class="rider-stats-placeholder">
        <h3>Statistiken konnten nicht geladen werden</h3>
        <p>${S(r.error??"Unbekannter Fehler")}</p>
      </section>
    `;return}d.teamStatsPayload=r.data,f("team-stats-body").innerHTML=ot(r.data)}}function lg(){f("team-stats-body").addEventListener("click",e=>{const t=e.target,a=t.closest("button[data-team-stats-tab]");if(a){const r=a.dataset.teamStatsTab;(r==="topResults"||r==="career"||r==="contracts")&&(d.teamStatsTab=r,d.teamStatsPayload&&(f("team-stats-body").innerHTML=ot(d.teamStatsPayload)));return}const s=t.closest("button[data-team-top-results-page]");if(s){const r=Number(s.dataset.teamTopResultsPage);!isNaN(r)&&r>=1&&(d.teamStatsTopResultsPage=r,d.teamStatsPayload&&(f("team-stats-body").innerHTML=ot(d.teamStatsPayload)));return}}),f("team-stats-body").addEventListener("change",e=>{const t=e.target;if(t.id==="team-stats-filter-category"){const a=t;d.teamStatsTopResultsFilterCategory=a.value==="all"?null:a.value,d.teamStatsTopResultsPage=1,d.teamStatsPayload&&(f("team-stats-body").innerHTML=ot(d.teamStatsPayload))}else if(t.id==="team-stats-filter-season"){const a=t;d.teamStatsTopResultsFilterSeason=a.value==="all"?null:Number(a.value),d.teamStatsTopResultsPage=1,d.teamStatsPayload&&(f("team-stats-body").innerHTML=ot(d.teamStatsPayload))}else if(t.classList.contains("team-stats-filter-checkbox")){const a=t,s=a.dataset.filterType;d.teamStatsTopResultsFilters[s]=a.checked,d.teamStatsTopResultsPage=1,d.teamStatsPayload&&(f("team-stats-body").innerHTML=ot(d.teamStatsPayload))}else if(t.id==="team-stats-success-season-select"){const a=t;d.teamStatsSelectedSeason=a.value==="all"?"all":Number(a.value),d.teamStatsPayload&&(f("team-stats-body").innerHTML=ot(d.teamStatsPayload))}})}let Mt="riders",Ze="season",fr="season",bt="";const Oa=["leaderboard-select-performance","leaderboard-select-load","leaderboard-select-physis","leaderboard-select-action","leaderboard-select-jersey","leaderboard-select-events"];function dg(){const e=f("leaderboards-scope-tabs");if(e){const n=e.querySelectorAll("button");n.forEach(i=>{i.addEventListener("click",()=>{n.forEach(c=>c.classList.remove("active")),i.classList.add("active");const o=i.getAttribute("data-scope");ug(o)})})}const t=f("leaderboards-period-tabs");if(t){const n=t.querySelectorAll("button");n.forEach(i=>{i.addEventListener("click",()=>{if(i.hasAttribute("disabled"))return;n.forEach(c=>c.classList.remove("active")),i.classList.add("active");const o=i.getAttribute("data-period");mg(o)})})}Oa.forEach(n=>{const i=f(n);i&&i.addEventListener("change",()=>{const o=i.value;o?pg(o,n):Oa.some(l=>{const g=f(l);return g&&g.value!==""})||(bt="",Pt())})}),window.openRiderStatsFromLeaderboard=Zt;const a=f("leaderboard-filter-wt"),s=f("leaderboard-filter-pt"),r=f("leaderboard-filter-other");[a,s,r].forEach(n=>{n&&n.addEventListener("change",()=>{Pt()})})}function cg(){Pt()}function ug(e){Mt=e;const t=f("leaderboard-group-physis");t&&(t.style.display=e==="teams"?"none":"block"),e==="teams"&&(gg(bt)&&(fg(),bt=""),Ze==="live"&&(Ze=fr,Ra())),Pt()}function mg(e){Ze=e,fr=e,Pt()}function pg(e,t){bt=e,Oa.forEach(a=>{if(a!==t){const s=f(a);s&&(s.value="")}}),Fo(e)?(Ze="live",Ra()):hr(e)?(Ze="alltime",Ra()):(Ze=fr,Ra()),Pt()}function Fo(e){return["fatigue_short","fatigue_long","fatigue_combined","form_r","form_s","form_combined"].includes(e)}function hr(e){return["max_short_term_fatigue","max_long_term_fatigue","max_combined_fatigue","max_s_form","max_r_form","max_combined_form","mentors_ranking"].includes(e)||e.startsWith("youngest_winners")}function gg(e){return Fo(e)||hr(e)||e==="mentors_ranking"}function fg(){Oa.forEach(e=>{const t=f(e);t&&(t.value="")})}function Ra(){const e=f("leaderboards-period-tabs");if(!e)return;const t=e.querySelector('button[data-period="season"]'),a=e.querySelector('button[data-period="alltime"]');Ze==="live"?e.style.display="none":(e.style.display="flex",hr(bt)?(t&&(t.disabled=!0,t.classList.remove("active"),t.style.opacity="0.5",t.style.cursor="not-allowed"),a&&(a.disabled=!1,a.classList.add("active"),a.style.opacity="1",a.style.cursor="pointer")):(t&&(t.disabled=!1,t.style.opacity="1",t.style.cursor="pointer"),a&&(a.disabled=!1,a.style.opacity="1",a.style.cursor="pointer"),Ze==="season"?(t&&t.classList.add("active"),a&&a.classList.remove("active")):(t&&t.classList.remove("active"),a&&a.classList.add("active"))))}async function Pt(){var l,g,m;const e=f("leaderboard-empty"),t=f("leaderboard-table"),a=f("leaderboard-thead"),s=f("leaderboard-tbody");if(!e||!t||!a||!s)return;const r=f("leaderboard-filter-container");if(r&&(r.style.display=Mt==="teams"?"none":"flex"),!bt){e.textContent="Wähle eine Statistik aus den Dropdowns oben aus, um die Rangliste zu laden.",e.classList.remove("hidden"),t.classList.add("hidden");return}e.textContent="Lade Daten...",e.classList.remove("hidden"),t.classList.add("hidden");const n=await G.getLeaderboards(Mt,bt,Ze);if(!fe("leaderboards"))return;if(!n.success||!n.data||n.data.length===0){e.textContent=n.error||"Keine Einträge für diese Rangliste gefunden.",e.classList.remove("hidden"),t.classList.add("hidden");return}let i=n.data;if(Mt==="riders"){const u=((l=f("leaderboard-filter-wt"))==null?void 0:l.checked)??!0,p=((g=f("leaderboard-filter-pt"))==null?void 0:g.checked)??!0,h=((m=f("leaderboard-filter-other"))==null?void 0:m.checked)??!1;if(i=n.data.filter(b=>{const y=b.teamDivisionId===1&&!b.isRetired,v=b.teamDivisionId===2&&!b.isRetired,k=b.teamDivisionId===null||b.teamDivisionId===void 0||b.isRetired||b.teamDivisionId!==1&&b.teamDivisionId!==2;return!!(y&&u||v&&p||k&&h)}),i.length===0){e.textContent="Keine Einträge für die ausgewählten Filter gefunden.",e.classList.remove("hidden"),t.classList.add("hidden");return}}e.classList.add("hidden"),t.classList.remove("hidden"),Mt==="riders"?a.innerHTML=`
      <tr>
    ...
    `;let o="",c=1;for(const u of i){const p=c++,b=`<span class="badge ${p===1?"badge-primary":p<=3?"badge-secondary":"badge-ghost"}" style="min-width: 28px; text-align: center; display: inline-block;">${p}</span>`,y=pt(u.teamId,u.teamName);if(Mt==="riders"){const v=u.nationality?se(u.nationality):"—",k=`<a href="#" onclick="event.preventDefault(); openRiderStatsFromLeaderboard(${u.riderId})" style="color: #60a5fa; text-decoration: none; font-weight: bold; hover: text-decoration: underline;">${S(u.firstName)} ${S(u.lastName)}</a>`,w=u.teamAbbr?`<span class="text-muted" title="${S(u.teamName??"")}">${S(u.teamAbbr)}</span>`:"—";o+=`
        <tr>
          ...
          <td style="text-align: right; font-weight: bold; color: #34d399; vertical-align: middle;">${S(String(u.value))}</td>
        </tr>
      `}else{let v="";if(u.leadoutDetails){const k=u.leadoutDetails,w=k.sprinterNationality?se(k.sprinterNationality):"";v=`
          <div style="font-weight: bold; font-size: 0.95rem; color: #fff;">${S(u.teamName.split(" (Sprinter:")[0])}</div>
      ...
      `}).join(""),g=o.map(m=>{var w;const u=m.race,p=a>=u.startDate&&a<=u.endDate,h=a>u.endDate,b=qt((w=u.category)==null?void 0:w.name),y=p?'<span class="calendar-live-dot"></span>':"",v=h?"opacity: 0.55;":"",k=m.endIdx-m.startIdx+1;return`
    ...
    `}t.innerHTML=s,Co()}function Co(){var n;const e=f("calendar-race-search"),t=e?e.value.toLowerCase().trim():"",a=f("calendar-races-tbody"),s=((n=d.gameState)==null?void 0:n.currentDate)??"",r=d.races.filter(i=>{var o;return t?i.name.toLowerCase().includes(t)||((o=i.category)==null?void 0:o.name)&&i.category.name.toLowerCase().includes(t):!0}).sort((i,o)=>i.startDate.localeCompare(o.startDate));if(r.length===0){a.innerHTML='<tr><td colspan="9" class="text-muted" style="text-align: center; padding: 20px;">Keine Rennen gefunden.</td></tr>';return}a.innerHTML=r.map(i=>{var y,v,k,w;const o=s>=i.startDate&&s<=i.endDate,l=s>i.endDate?'<span class="badge badge-done">Abgeschlossen</span>':o?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',g=((y=i.country)==null?void 0:y.name)??`Land ${i.countryId}`,m=(v=i.country)!=null&&v.code3?se(i.country.code3):"",u=i.isStageRace?(i.stages??[]).reduce((T,M)=>T+(M.distanceKm??0),0):((k=i.upcomingStage)==null?void 0:k.distanceKm)??null,p=i.isStageRace?(i.stages??[]).reduce((T,M)=>T+(M.elevationGainMeters??0),0):((w=i.upcomingStage)==null?void 0:w.elevationGainMeters)??null,h=u!=null?String(u.toFixed(1)).replace(".",","):"-",b=p!=null?String(Math.round(p)):"-";return`
    ...
    `}).join("")}window.openTeamStats=Eo;async function No(){var e;for(let t=localStorage.length-1;t>=0;t--){const a=localStorage.key(t);a&&(a.startsWith("programAssignmentsLogged_")||a.startsWith("participantCountsLogged_"))&&localStorage.removeItem(a)}As("game"),f("meta-career").textContent=((e=d.currentSave)==null?void 0:e.careerName)??"",yt("dashboard"),he("Spiel wird geladen…");try{await cr(),await ur(),Xa()}catch(t){alert("Fehler beim Laden des Spiels: "+t.message)}finally{me()}}function Sg(){document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{var a;const t=e.dataset.view??"";yt(t),t==="dashboard"&&Xa(),t==="teams"&&Wa(),t==="riders"&&Wa(),t==="rider-team-editor"&&Ro(),t==="live-race"&&Et(),t==="results"&&ye(),t==="draft"&&Io(d.draftSelectedSeason||((a=d.currentSave)==null?void 0:a.currentSeason)||2026),t==="injuries"&&Vp(),t==="season-standings"&&Jp(),t==="leaderboards"&&cg(),t==="calendar"&&vg(),(t==="stage-editor-stages"||t==="stage-editor-climbs")&&Oi()})}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-rider-link[data-rider-id]");if(!t)return;const a=Number(t.dataset.riderId);Number.isFinite(a)&&Zt(a)}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-team-link[data-team-id]");if(!t)return;const a=Number(t.dataset.teamId);Number.isFinite(a)&&Eo(a)}),f("btn-cancel-new").addEventListener("click",()=>_e("newCareer")),f("btn-close-race-stages").addEventListener("click",()=>_e("raceStages")),f("btn-close-stage-profile").addEventListener("click",()=>_e("stageProfile")),f("btn-close-rider-program").addEventListener("click",()=>_e("riderProgram")),f("btn-close-rider-stats").addEventListener("click",()=>_e("riderStats")),f("btn-close-team-stats").addEventListener("click",()=>_e("teamStats")),f("btn-close-race-participants").addEventListener("click",()=>_e("raceParticipants")),f("btn-close-roster-editor").addEventListener("click",()=>Es()),f("btn-cancel-roster-editor").addEventListener("click",()=>Es()),f("btn-apply-roster-editor").addEventListener("click",()=>{dp()}),f("btn-back-menu").addEventListener("click",()=>{Ht==null||Ht.pause(),As("menu"),Jt()}),Uo(),wp(),yg(),oo(),xo(),jp(),cp(),sp(),wm(),Km(),lg(),Xp(),dg()}(async()=>(Ju(),ne(),Sg(),As("menu"),await Jt()))();
