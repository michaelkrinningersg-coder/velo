(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();function ti(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function _r(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function ct(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function lr(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function De(e,t={}){const a=t.strong===!1?"span":"strong",r=_r("app-rider-link-label",t.labelClassName),s=`<${a} class="${r}">${ti(e)}</${a}>`;if(t.riderId==null)return s;const n=['type="button"','class="'+_r("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${s}</button>`}function it(e,t,a=!0,r=""){const s=a===!1?"span":"strong",n=`<${s} class="app-team-link-label">${ti(e)}</${s}>`;return t==null?n:`<button type="button" class="${_r("app-team-link",r)}" data-team-id="${t}">${n}</button>`}function ai(e,t){return t?t instanceof Map?t.get(e)??0:t[e]??0:0}function ri(e){return Math.round(e*10)/10}function si(e,t){const a=e;return(t==null?void 0:t.distanceKm)??a.distanceKm??0}function ni(e,t){const a=e;return(t==null?void 0:t.elevationGainMeters)??a.elevationGainMeters??0}function ii(e,t){return t+(e.formBonus??0)+(e.raceFormBonus??0)}function il(e,t){return e.skills.stamina*(t/300)}function oi(e,t,a){return e.skills.timeTrial+ii(e,t)+e.skills.mountain*(a/500)}function ol(e,t,a,r){const s=il(e,a),n=ii(e,r);switch(t.profile){case"Flat":return .8*e.skills.sprint+.15*e.skills.acceleration+.05*e.skills.flat+n+s;case"Rolling":return .7*e.skills.sprint+.2*e.skills.acceleration+.1*e.skills.hill+n+s;case"Hilly":return .45*e.skills.sprint+.1*e.skills.flat+.45*e.skills.hill+n+s;case"Hilly_Difficult":return .2*e.skills.sprint+.1*e.skills.flat+.7*e.skills.hill+n+s;case"Medium_Mountain":return .05*e.skills.sprint+.1*e.skills.flat+.35*e.skills.hill+.45*e.skills.mediumMountain+.05*e.skills.mountain+n+s;case"Mountain":return .05*e.skills.hill+.2*e.skills.mediumMountain+.75*e.skills.mountain+n+s;case"High_Mountain":return e.skills.mountain+n+s;case"Cobble":return .3*e.skills.sprint+.2*e.skills.flat+.5*e.skills.cobble+n+s;case"Cobble_Hill":return .3*e.skills.sprint+.2*e.skills.flat+.2*e.skills.hill+.3*e.skills.cobble+n+s;default:return .8*e.skills.sprint+.2*e.skills.flat+n+s}}function ll(e,t,a,r,s){return t.profile==="ITT"||t.profile==="TTT"?oi(e,s,r):ol(e,t,a,s)}function dl(e,t){var a;return{rank:t,kind:"rider",effectiveSkill:ri(e.effectiveSkill),teamId:e.rider.activeTeamId??0,teamName:e.teamName,displayName:`${e.rider.firstName} ${e.rider.lastName}`,roleLabel:((a=e.rider.role)==null?void 0:a.name)??"–",riderId:e.rider.id}}function li(e,t,a,r){si(a,r);const s=ni(a,r),n=new Map(t.map(o=>[o.id,o]));if(a.profile==="TTT"){const o=new Map;for(const l of e){if(l.activeTeamId==null)continue;const p=o.get(l.activeTeamId)??[];p.push(l),o.set(l.activeTeamId,p)}return[...o.entries()].map(([l,p])=>{const u=n.get(l),f=p.map(y=>oi(y,ai(y.id,r==null?void 0:r.dailyFormByRiderId),s)).sort((y,T)=>T-y).slice(0,5),g=f.length,b=g>0?f.reduce((y,T)=>y+T,0)/g:0,v=Math.max(0,5-g)*2;return{team:u??{id:l,name:`Team ${l}`,abbreviation:"---",divisionId:0,u23TeamId:null,isPlayerTeam:!1,countryCode:"---",colorPrimary:"#000000",colorSecondary:"#ffffff",aiFocus1:0,aiFocus2:0,aiFocus3:0},score:b-v}}).sort((l,p)=>p.score-l.score||l.team.id-p.team.id).slice(0,20).map((l,p)=>({rank:p+1,kind:"team",effectiveSkill:ri(l.score),teamId:l.team.id,teamName:l.team.name,displayName:l.team.name,roleLabel:"TTT"}))}return(r!=null?ja(e,t,a,r):ja(e,t,a)).sort((o,d)=>d.effectiveSkill-o.effectiveSkill||o.rider.id-d.rider.id).slice(0,20).map((o,d)=>dl(o,d+1))}function ja(e,t,a,r){const s=si(a,r),n=ni(a,r),i=new Map(t.map(o=>[o.id,o]));return e.map(o=>{var d;return{rider:o,teamName:o.activeTeamId!=null?((d=i.get(o.activeTeamId))==null?void 0:d.name)??`Team ${o.activeTeamId}`:"—",effectiveSkill:ll(o,a,s,n,ai(o.id,r==null?void 0:r.dailyFormByRiderId))}}).sort((o,d)=>d.effectiveSkill-o.effectiveSkill||o.rider.id-d.rider.id)}const c={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,draftHistory:null,injuries:null,draftSelectedSeason:null,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorHideBoringSegments:!0,stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1,autoProgressTargetDate:null,raceProgramsPayload:null,raceProgramsActiveTab:"calendar-cols",raceProgramsDirty:!1,raceProgramsSaving:!1};let ra=null;function cl(e){ra=e}let ts=!1;function Bs(e){ts=e}let di=null;function Hs(e){di=e}let Ar=null;function Gs(e){Ar=e}let ut=!1;function ci(e){ut=e}function h(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function oe(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function Oa(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),r=Math.floor(e%60),s=String(a).padStart(2,"0"),n=String(r).padStart(2,"0");return t>0?`${t}:${s}:${n}`:`${a}:${n}`}function $r(e){return e==null||e===0?"–":`+${Oa(e)}`}const Ba=2,Br=3,ui=4;function mi(e){return`/jersey/Jer_${e}.png`}function Ft(e,t){var r;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((r=c.teams.find(s=>s.id===e))==null?void 0:r.name)??`Team ${e}`;return`
  ...
  `).join("")}async function kl(e){Me("Karriere wird geladen…");const t=await V.loadSave(e);if($e(),!t.success){alert("Fehler beim Laden: "+t.error);return}c.currentSave=t.data??null,await nl()}async function $l(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;Me("Löschen…");const a=await V.deleteSave(e);if($e(),!a.success){alert("Fehler: "+a.error);return}await ga()}async function xl(){const e=await V.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){h("btn-delete-all-careers").classList.add("hidden"),h("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){Me("Alle Karrieren werden gelöscht…");try{for(const a of t){const r=await V.deleteSave(a.filename);if(!r.success){alert(`Fehler beim Löschen von "${a.careerName}": ${r.error??"Unbekannter Fehler"}`);break}}}finally{$e()}await ga()}}function Tl(){h("btn-new-career").addEventListener("click",async()=>{var s;ua("new-career-error"),h("input-career-name").value="";const a=h("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',qe("newCareer");const r=await V.getAvailableTeams();if(!r.success||!((s=r.data)!=null&&s.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=r.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),h("btn-cancel-new").addEventListener("click",()=>Ue("newCareer")),h("btn-confirm-new").addEventListener("click",async()=>{const a=h("input-career-name").value.trim(),r=h("input-team-id").value;if(!a||!r){It("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const s=Number(r),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;ua("new-career-error"),Me("Neue Karriere wird erstellt…");const o=await V.createSave(i,a,s);if(!o.success){$e(),It("new-career-error",o.error??"Unbekannter Fehler.");return}const d=await V.loadSave(i);if($e(),Ue("newCareer"),!d.success){alert("Fehler: "+d.error);return}c.currentSave=d.data??null,await nl()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>ga());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{xl()}),h("saves-list").addEventListener("click",async a=>{const r=a.target.closest("button[data-save-action]");if(!r)return;const{saveAction:s,filename:n,careerName:i}=r.dataset;if(n){if(s==="load"){await kl(n);return}s==="delete"&&await $l(n,i??n)}})}const wl="modulepreload",Ml=function(e){return"/"+e},Os={},yi=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(a.map(d=>{if(d=Ml(d),d in Os)return;Os[d]=!0;const l=d.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":wl,l||(u.as="script"),u.crossOrigin="",u.href=d,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((m,f)=>{u.addEventListener("load",m),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return s.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})},Rl={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function Il(e){const t=Rl[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const Cl=200;function ss(e){if(e.length===0)return[];const t=[];for(const a of e){const r=t[t.length-1];if(!r||Math.abs(r.distanceMeter-a.distanceMeter)>=Cl){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}r.riderIds.push(...a.riderIds),r.riderCount+=a.riderCount,r.distanceSum+=a.distanceMeter*a.riderCount,r.distanceMeter=r.distanceSum/r.riderCount}return t.map(({distanceSum:a,...r})=>r)}function ns(e){if(e.length===0)return[];let t=0;for(let s=1;s<e.length;s+=1)e[s].riderCount>e[t].riderCount&&(t=s);let a=0,r=0;return e.map((s,n)=>{const i=n===t;let o;return i?o="P":n<t?(a+=1,o=`E${a}`):(r+=1,o=`A${r}`),{...s,label:o,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-s.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,s.distanceMeter-e[n+1].distanceMeter):null}})}function El(e,t=null){var a,r,s;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((r=e.find(n=>n.label==="P"))==null?void 0:r.label)??((s=e[0])==null?void 0:s.label)??null}function kt(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function Vs(e,t,a,r){return`${r.type}:${e}:${t}:${a}`}function Fl(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:kt(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function tt(e){const t=[];e.segments.forEach((s,n)=>{const i=n*2;(s.start_markers??[]).forEach((o,d)=>{t.push({key:Vs(n,"start",d,o),label:"",marker:o,kmMark:s.start_km,elevation:s.start_elevation,boundary:"start",sequence:i+d/100})}),(s.end_markers??[]).forEach((o,d)=>{t.push({key:Vs(n,"end",d,o),label:"",marker:o,kmMark:s.end_km,elevation:s.end_elevation,boundary:"end",sequence:i+1+d/100})})});const a=t.sort((s,n)=>s.kmMark-n.kmMark||s.sequence-n.sequence),r=new Map;return a.map(s=>{const n=(r.get(s.marker.type)??0)+1;return r.set(s.marker.type,n),{...s,label:s.marker.name??Fl(s.marker,n)}})}function Pl(e){const t=tt(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>kt(a)).length}}function Ut(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Nl(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function We(e,t,a,r){return t<=0?r:r+e/t*(a-r*2)}function Ua(e,t){const a=t/1e3,r=e.points;if(a<=r[0].kmMark)return r[0].elevation;for(let s=0;s<r.length-1;s+=1){const n=r[s],i=r[s+1];if(a>i.kmMark)continue;const o=Math.max(1e-4,i.kmMark-n.kmMark),d=(a-n.kmMark)/o;return n.elevation+(i.elevation-n.elevation)*d}return r[r.length-1].elevation}function Si(e){const t=e.points.map(p=>p.elevation),a=Math.min(...t),r=Math.max(...t),s=Math.max(1,r-a),n=Math.max(40,s*.08),i=Math.max(0,a-n),o=r+n;let d=Math.floor(i/50)*50,l=Math.ceil(o/50)*50;return l<=d&&(l=d+100),{axisMinElevation:d,axisMaxElevation:l}}function Xe(e,t,a,r,s,n){const i=Math.max(1,a-t);return r-n-(e-t)/i*(r-s-n)}function na(e){return`${Math.round(e)} m`}function Us(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function Ys(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function ki(e,t,a,r,s,n,i,o,d){var g;const l=[],p=[];let u=null,m="#b91c1c";for(const b of tt(e)){const{marker:v,kmMark:y,elevation:T}=b;if(v.type==="climb_start"){p.push({kmMark:y,elevation:T,name:v.name});continue}if(kt(v)){let M=-1;for(let C=p.length-1;C>=0;C-=1)if(v.name&&((g=p[C])==null?void 0:g.name)===v.name){M=C;break}const x=M>=0?p.splice(M,1)[0]:p.pop();x&&Math.max(0,y-x.kmMark),x&&Math.max(0,T-x.elevation);const $=Ys(v.cat,v.type),I=Us(v.cat);if(v.type==="finish_hill"||v.type==="finish_mountain"){u=v.cat??null,m=$.accentColor;continue}l.push({x:We(y*1e3,t,a,r),anchorY:Xe(T,o,d,s,n,i),primaryLabel:I??"Berg",secondaryLabel:na(T),distanceLabel:`${y.toFixed(1).replace(".",",")} km`,accentColor:$.accentColor});continue}if(v.type==="sprint_intermediate"){const M=Ys(v.cat,v.type);l.push({x:We(y*1e3,t,a,r),anchorY:Xe(T,o,d,s,n,i),primaryLabel:"Sprint",secondaryLabel:na(T),distanceLabel:`${y.toFixed(1).replace(".",",")} km`,accentColor:M.accentColor})}}const f=e.points[e.points.length-1];return l.push({x:We(f.kmMark*1e3,t,a,r),anchorY:Xe(f.elevation,o,d,s,n,i),primaryLabel:u?`${Us(u)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:na(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:m}),l.sort((b,v)=>b.x-v.x)}function $i(e,t,a){const r=t+4,s=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
    ...
    </g>`}function xi(e,t){const a=new Set,r=t/1e3;for(let s=0;s<=r;s+=25)a.add(Math.round(s*1e3));return a.add(Math.round(t)),[...a].filter(s=>s>=0&&s<=t).sort((s,n)=>s-n)}function Ti(e,t,a,r,s,n){const i=new Set(tt(t).map(o=>Math.round(o.kmMark*1e3)));return e.map(o=>{const d=We(o,a,r,s),p=i.has(o)?18:12,u=n+p+26;return`
      ...
      </g>`}).join("")}function Ll(e,t,a,r,s,n,i,o,d,l,p){const u=We(e.distanceMeter,a,r,n),m=Ua(t,e.distanceMeter),f=Xe(m,d,l,s,i,o),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),b=e.riderCount>1?`<text x="${u.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${b}
    </g>`}function Dl(e,t,a,r,s,n,i,o,d,l,p){const u=new Map(p.riders.map(f=>[f.id,f])),m=new Map((p.teams??[]).map(f=>[f.id,f.abbreviation]));return e.filter(f=>f.riderCount===1).map(f=>{const g=f.riderIds[0];if(g==null)return"";const b=u.get(g);if(!b)return"";const v=We(f.distanceMeter,a,r,n),y=Ua(t,f.distanceMeter),T=Xe(y,d,l,s,i,o),M=b.activeTeamId!=null?m.get(b.activeTeamId)??"":"",x=`${b.lastName} (${M})`,$=T-34,I=T-40;return`
        <g class="race-sim-itt-rider-label-group">
          ...
          <text x="${v.toFixed(1)}" y="${I.toFixed(1)}" text-anchor="middle" class="race-sim-marker-detail">${Ut(x)}</text>
        </g>`}).join("")}function _l(e,t,a,r,s,n,i,o,d,l,p){const u=Math.max(0,Math.min(l,e.distanceKm)),m=Math.max(0,Math.min(p,e.distanceKm));if(m<=u)return null;const f=[{kmMark:u,elevation:Ua(e,u*1e3)},...e.points.filter(T=>T.kmMark>u&&T.kmMark<m),{kmMark:m,elevation:Ua(e,m*1e3)}];if(f.length<2)return null;const g=s-i,b=f.map((T,M)=>{const x=We(T.kmMark*1e3,t,a,r),$=Xe(T.elevation,o,d,s,n,i);return`${M===0?"M":"L"} ${x.toFixed(1)} ${$.toFixed(1)}`}).join(" "),v=We(u*1e3,t,a,r),y=We(m*1e3,t,a,r);return`${b} L ${y.toFixed(1)} ${g.toFixed(1)} L ${v.toFixed(1)} ${g.toFixed(1)} Z`}function Al(e,t,a,r,s={}){const p=e.distanceKm*1e3,{axisMinElevation:u,axisMaxElevation:m}=Si(e),f=533,g=12,v=e.points.map(C=>{const E=We(C.kmMark*1e3,p,1584,28),P=Xe(C.elevation,u,m,634,168,101);return{x:E,y:P}}).map((C,E)=>`${E===0?"M":"L"} ${C.x.toFixed(1)} ${C.y.toFixed(1)}`).join(" "),y=`${v} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,T=s.selectedClimbRange!=null?_l(e,p,1584,28,634,168,101,u,m,s.selectedClimbRange.startKm,s.selectedClimbRange.endKm):null,M=ki(e,p,1584,28,634,168,101,u,m).map(C=>$i(C,g,f)).join(""),$=Array.from({length:5},(C,E)=>u+(m-u)/4*E).map(C=>{const E=Xe(C,u,m,634,168,101);return`
      ...
      <text x="${14 .toFixed(1)}" y="${(E+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${na(C)}</text>`}).join(""),I=Ti(xi(e,p),e,p,1584,28,f);return`
    <svg viewBox="0 0 1584 634" role="img" aria-label="${Ut(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
    ...
    </svg>`}function Bl(e,t,a,r,s){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${Al(t,a,r,!1,s)}</div>`}function Hl(e,t,a,r,s,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const o=1584,d=634,l=28,p=168,u=101,{axisMinElevation:m,axisMaxElevation:f}=Si(t),g=d-u,b=12,v=Array.from({length:5},(K,w)=>m+(f-m)/4*w),y=ss(a.clusters),T=ns(y),M=xi(t,a.stageDistanceMeters),$=t.points.map(K=>{const w=We(K.kmMark*1e3,a.stageDistanceMeters,o,l),B=Xe(K.elevation,m,f,d,p,u);return{x:w,y:B}}).map((K,w)=>`${w===0?"M":"L"} ${K.x.toFixed(1)} ${K.y.toFixed(1)}`).join(" "),I=`${$} L ${(o-l).toFixed(1)} ${g.toFixed(1)} L ${l.toFixed(1)} ${g.toFixed(1)} Z`,C=ki(t,a.stageDistanceMeters,o,l,d,p,u,m,f).map(K=>$i(K,b,g)).join(""),E=v.map(K=>{const w=Xe(K,m,f,d,p,u);return`
      ...
      <text x="${(l-14).toFixed(1)}" y="${(w+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${na(K)}</text>`}).join(""),P=Ti(M,t,a.stageDistanceMeters,o,l,g),L=new Map(y.map((K,w)=>[K,T[w]??null])),A=y.map(K=>{var w;return Ll(K,t,a.stageDistanceMeters,o,d,l,p,u,m,f,((w=L.get(K))==null?void 0:w.label)===i)}).join(""),G=s.stage.profile==="ITT"?Dl(y,t,a.stageDistanceMeters,o,d,l,p,u,m,f,s):"";e.innerHTML=`
  ...
  `).join("")}</div>`}function ma(e,t){const a=e.riders.find(r=>r.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function cr(e,t){const a=e.riders.find(n=>n.id===t),r=(a==null?void 0:a.activeTeamId)??null,s=r!=null?e.teams.find(n=>n.id===r)??null:null;return{teamId:r,teamName:(s==null?void 0:s.name)??null}}function Yc(e,t,a,r={}){const s=(t??[]).slice(0,r.limit??8);return s.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${s.map(n=>{var u;const i=n.riderId??0,o=cr(e,i),d=ma(e,i),l=((u=r.distanceGapsByRiderId)==null?void 0:u.get(i))??null,p=[r.distanceGapClassName??"",Kc(l)].filter(m=>m.length>0).join(" ");return`
    ...
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-grid">
        ${u.map((m,f)=>{const g=l.get(m.riderId)??null,b=cr(e,m.riderId),v=p.get(m.riderId)??{points:0,mountain:0},y=kn(s,m.riderId),T=kn(n,m.riderId),M=su(m.riderId,e.classificationLeaders),x=M.length>0?M.map($=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[$]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${nu(M)}" title="${Q(x)}">${f+1}.</strong>
    ...
    </section>`}function lu(e,t,a,r){const s=ls(t,a.markerClassifications,a),n=os(s),i=qa(t,t.pointsStandings,n,"points"),o=qa(t,t.mountainStandings,n,"mountain"),d=ns(ss(a.clusters));e.innerHTML=ou(t,a,d,r,i,o,s)}function du(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function cu(e){const t=tt(e.stageSummary),a=Wi(e)[0]??0,r=is(e)[0]??0,s=t.filter(({marker:n})=>kt(n)).reduce((n,{marker:i})=>n+(Ha(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+r,mountain:s}}function Tn(e){const t=cu(e);return`
    ...
    </span>`}function mu(e,t,a,r=null){const s=r??ls(e,t,a);return s.length===0?`
    ...
    </section>`}function pu(e,t,a,r,s,n=new Set){var f,g;const i=ls(a,r,s),o=os(i),d=qa(a,a.pointsStandings,o,"points"),l=qa(a,a.mountainStandings,o,"mountain"),p=Sn(s,((f=a.gcStandings[0])==null?void 0:f.riderId)??null),u=Sn(s,((g=a.youthStandings[0])==null?void 0:g.riderId)??null),m=b=>!n.has(b);e.innerHTML=`
  ...
  `}const wn=new WeakMap,Qe=new WeakMap,Mn=new WeakMap,ji=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function X(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Oi(e){return e<=0?"—":`+${Math.round(e)} m`}function oa(e){const t=ji.format(e);return e>0?`+${t}`:t}function Er(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function ce(e){return ji.format(e)}function Nt(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),r=Math.floor(t%3600/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Vi(e){return`+${Nt(e)}`}function Ui(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function ds(e){return`${(e*3.6).toFixed(1)} km/h`}function gu(e){return`${oa(e)}%`}function jr(e){return`${e.toFixed(1).replace(".",",")} km`}function Yi(e){return`${jr(e.segmentStartKm)} - ${jr(e.segmentEndKm)}`}function fu(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function Zi(e){return e.replace(/_/g," ")}function Ji(e){return Zi(e)}function hu(e){return Zi(e)}function qi(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function bu(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function vu(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function Xi(e){return tt(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||kt(t)).map(({key:t,label:a})=>({key:t,label:a}))}function yu(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function Su(e,t,a,r){var s;return a!=="ITT"&&a!=="TTT"?((s=r.get(t))==null?void 0:s.get(e.riderId))??null:e.splitTimes[t]??null}function Qi(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(s=>({label:s.key,displayLabel:s.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${s.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function ku(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function $u(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function eo(e){const t=wn.get(e);if(t)return t;const a=Xi(e),r={splitMarkers:a,columns:Qi(e,a,!1),riderById:new Map(e.riders.map(s=>[s.id,s])),teamById:new Map((e.teams??[]).map(s=>[s.id,s])),teamAbbreviationById:new Map((e.teams??[]).map(s=>[s.id,s.abbreviation])),teamNameById:new Map((e.teams??[]).map(s=>[s.id,s.name])),gcByRiderId:new Map((e.gcStandings??[]).map(s=>[s.riderId,s]))};return wn.set(e,r),r}function to(e,t){const a=e.parentElement,r=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!r)return"";const s=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const l=document.createElement("div");return l.className="race-sim-leaderboard-toolbar",r.insertAdjacentElement("beforebegin",l),l})(),n=cs(e),i=ku(t),o=$u(i,n),d=Qe.get(e);return(d==null?void 0:d.layoutKey)===o||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(l=>l.width).join(" ")),s.innerHTML=`
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,r.innerHTML=t.map(l=>xu(l,n)).join(""),Qe.set(e,{layoutKey:o,orderedRiderIds:(d==null?void 0:d.orderedRiderIds)??[],rowsByRiderId:(d==null?void 0:d.rowsByRiderId)??new Map,openDetailRiderId:(d==null?void 0:d.openDetailRiderId)??null,openTeamId:(d==null?void 0:d.openTeamId)??null})),o}function rt(e,t){e.textContent!==t&&(e.textContent=t)}function Fa(e,t){e.title!==t&&(e.title=t)}function Pa(e,t){e.className!==t&&(e.className=t)}function Na(e,t,a){return e.lastValues[t]!==a}function La(e,t,a){e.lastValues[t]=a}function cs(e){const t=Mn.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return Mn.set(e,a),a}function xu(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${X(e.label)}">${X(a)}</span>`;const r=!t.autoSort&&t.manualSortKey===e.sortKey,s=r?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
...
`)}function Fu(e){return oa(Math.max(-2.5,Math.min(2.5,e*2.5)))}function Pu(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function so(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${X(e.riderName)}">${X(e.riderName)}</button>`}function Nu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId)??"—",s=a.get(e.activeTeamId)??r;return`<span class="race-sim-team-code" title="${X(s)}">${X(r)}</span>`}function no(e){return`/jersey/Jer_${e}.png`}function Lu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId);if(!r)return"—";const s=a.get(e.activeTeamId)??r.name,n=no(e.activeTeamId);return`
    ...
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${X(e.team.name)}">
      ...
      <div class="race-sim-rider-detail-grid">
        ...
        <div class="race-sim-rider-detail-item"><span>Speed</span><strong>${X(ds(e.teamSpeedMps))}</strong></div>
        <div class="race-sim-rider-detail-item"><span>Teamuhr</span><strong>${X(e.teamClockSeconds!=null?Nt(e.teamClockSeconds):"—")}</strong></div>
        <div class="race-sim-rider-detail-item"><span>Distanz</span><strong>${X(jr(e.teamDistanceMeters/1e3))}</strong></div>
      </div>
    ...
    </div>`}function fo(e,t,a,r,s,n,i,o){const d=o??pr(e,t,a);return`
    ...
    <tr>
      ...
      <td>${fo(d.profileScore,0,100,d.stageId,Dm(d),br({name:d.raceName},{stageNumber:d.stageNumber,profile:d.profile}))}</td>
      <td>${Sa(d.profile)}</td>
    ...
    <tr>
      ...
      <td>${Nm(d.category)}</td>
      <td>${fo(d.climbScore,0,350,d.stageId,_m(d),br({name:d.raceName},{stageNumber:d.stageNumber,profile:"Mountain"}),d.id,gs(d.climbScore))}</td>
      <td>${de(d.countryCode||"")}</td>
      <td><strong>${S(d.raceName)}</strong></td>
      <td><strong>${S(ya({stageNumber:d.stageNumber}))}</strong></td>
        ...
        ${g.map(M=>`
          <div class="stage-editor-climb" style="padding: 0.5rem; background: rgba(255,255,255,0.03); border-radius: var(--radius-sm); border-left: 3px solid var(--accent);">
            ...
            <div style="font-size: 0.75rem; color: var(--text-300); display: flex; flex-wrap: wrap; gap: 0.5rem;">
              <span>${Rt(M.startKm)} - ${Rt(M.endKm)}</span>
              <span>·</span>
    ...
    `;const y=h("stage-editor-hide-boring-segments-checkbox");y&&(y.checked=c.stageEditorHideBoringSegments),r.innerHTML=v,n.innerHTML=_n(e);const T=Wm(e);i.innerHTML=e.segments.map((M,x)=>{const $=c.stageEditorHideBoringSegments&&jm(e,x,T);return`
    <tr data-segment-index="${x}" class="${ms(e,x).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;${$?" display: none;":""}">
      <td class="stage-editor-cell-nr text-muted" style="text-align:center; font-weight:700;">${x+1}</td>
      <td class="stage-editor-cell-length"><input type="number" step="0.01" min="0.2" value="${M.lengthKm.toFixed(2)}" data-field="segmentLengthKm" class="${lm(M.lengthKm<Qa)}"></td>
      ...
      <td class="stage-editor-cell-terrain"><select data-field="terrain">${nm(M.terrain)}</select></td>
      <td class="stage-editor-cell-start-markers">
        ${Dn(M.markers,x,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${Dn(M.endMarkers,x,e.segments.length,"end")}
      </td>
      <td class="stage-editor-row-actions">
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          <div class="text-muted" style="min-width:3.5rem;">${ps(M)} m</div>
          ${Om(e,x)}
    ...
    </svg>`}function Vm(e,t,a){const r=c.stageEditorDraft;if(!r)return;const s=r.segments[e];s&&(t==="startElevation"?s.startElevation=Math.max(-500,Math.min(9e3,Number.parseInt(a||"0",10))):t==="lengthKm"?s.lengthKm=Math.max(.01,Number.parseFloat(a||"0.1")):t==="gradientPercent"?s.gradientPercent=Number.parseFloat(a||"0"):t==="terrain"?(s.terrain=a,s.manualTerrain=!0):t==="techLevel"?s.techLevel=Math.max(1,Math.min(10,Number.parseInt(a||"5",10))):t==="windExp"&&(s.windExp=Math.max(1,Math.min(10,Number.parseInt(a||"5",10)))),$t(r),mt(r),me())}function Um(e){const t=c.stageEditorDraft;if(!t)return;const a=t.segments[e];if(!a)return;const r={startElevation:a.startElevation,lengthKm:1,gradientPercent:0,techLevel:5,windExp:5,terrain:"Flat",markers:[],endMarkers:[]};t.segments.splice(e,0,r),$t(t),mt(t),me()}function Ym(){const e=c.stageEditorDraft;if(!e)return;const t=e.segments[e.segments.length-1],r={startElevation:t?ps(t):100,lengthKm:1,gradientPercent:0,techLevel:5,windExp:5,terrain:"Flat",markers:[],endMarkers:[]};e.segments.push(r),$t(e),mt(e),me()}function Zm(e){const t=c.stageEditorDraft;t&&(t.segments.length<=1||(t.segments.splice(e,1),$t(t),mt(t),me()))}async function Jm(){var a;const t=(a=h("stage-editor-file").files)==null?void 0:a[0];if(!t){alert("Bitte zuerst eine GPX- oder TCX-Datei auswählen.");return}h("stage-editor-file-hint").textContent=`${t.name} · ${(t.size/1024).toFixed(1).replace(".",",")} KB`,Me("Route wird importiert……");try{const r=await t.text(),s=await V.importStageRoute({fileName:t.name,fileContent:r});if(!s.success||!s.data){alert(`Import fehlgeschlagen: ${s.error??"Unbekannter Fehler"}`);return}const n=uo(s.data);c.stageEditorDraft=n,mt(n),Im(n),me(),Dt("stage-editor")}finally{$e()}}async function qm(){const e=Number(h("stage-editor-existing-stage").value);if(!Number.isInteger(e)||e<=0){alert("Bitte zuerst eine vorhandene CSV-Stage auswählen.");return}Me("CSV-Stage wird geladen...");try{const t=await V.loadStageEditorStage(e);if(!t.success||!t.data){alert(`Stage konnte nicht geladen werden: ${t.error??"Unbekannter Fehler"}`);return}const a=uo(t.data.draft);c.stageEditorDraft=a,mt(a),Cm(t.data.metadata),me(),Dt("stage-editor")}finally{$e()}}async function Xm(){if(!c.stageEditorDraft){alert("Es gibt noch keine importierte oder geladene Strecke.");return}const e=[...po(c.stageEditorDraft),...go()];if(e.length>0){alert(`Export blockiert:

${e.join(`
`)}`),me();return}const t=h("stage-editor-new-race-checkbox").checked,a=h("stage-editor-program-checkbox").checked;let r;t&&(r={name:h("stage-editor-race-name").value.trim(),countryId:Number(h("stage-editor-race-country").value),categoryId:Number(h("stage-editor-race-category").value),isStageRace:Number(h("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(h("stage-editor-race-num-stages").value),startDate:h("stage-editor-race-start-date").value.trim(),endDate:h("stage-editor-race-end-date").value.trim(),prestige:Number(h("stage-editor-race-prestige").value)});let s;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');s=Array.from(n).map(i=>Number(i.value))}Me("CSV-Dateien werden erstellt……");try{const n=await V.exportStageRoute({metadata:Em(),draft:c.stageEditorDraft,newRace:t,raceDetails:r,updatePrograms:a,programIds:s});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}Kr(n.data.stagesFileName,n.data.stagesCsv),Kr(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=h("stage-editor-stage-number"),o=Number(i.value)||1;i.value=String(o+1);const d=h("stage-editor-date"),l=d.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const v=new Date(l);v.setDate(v.getDate()+1);const y=v.getFullYear(),T=String(v.getMonth()+1).padStart(2,"0"),M=String(v.getDate()).padStart(2,"0");d.value=`${y}-${T}-${M}`}await Promise.all([ho(!0),Am(!0)]);const p=mo();h("stage-editor-stage-id").value=String(p),Wt=p;const u=h("stage-editor-new-race-checkbox");u&&(u.checked=!1);const m=h("stage-editor-new-race-details");m&&(m.classList.add("hidden"),m.style.display="none");const f=h("stage-editor-program-checkbox");f&&(f.checked=!1);const g=h("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),jt=Number(h("stage-editor-race-id").value),me()}finally{$e()}}function Qm(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",$=>{const I=$.target.closest("button[data-stage-profile-open-stage-id]");if(I){const P=Number(I.dataset.stageProfileOpenStageId);Number.isFinite(P)&&nr(P);return}const C=$.target.closest("button[data-stage-editor-stages-sort]");if(!C)return;const E=C.dataset.stageEditorStagesSort;c.stageEditorStagesSort.key===E?c.stageEditorStagesSort.direction=c.stageEditorStagesSort.direction==="asc"?"desc":"asc":c.stageEditorStagesSort={key:E,direction:Fm(E)},ta()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",$=>{const I=$.target.closest("button[data-stage-profile-open-stage-id]");if(I){const P=Number(I.dataset.stageProfileOpenStageId),L=I.dataset.stageProfileOpenClimbId??null;if(Number.isFinite(P)){let A=null;L&&c.stageEditorClimbRows&&(A=c.stageEditorClimbRows.find(G=>G.id===L)??null),nr(P,A)}return}const C=$.target.closest("button[data-stage-editor-climbs-sort]");if(!C)return;const E=C.dataset.stageEditorClimbsSort;c.stageEditorClimbsSort.key===E?c.stageEditorClimbsSort.direction=c.stageEditorClimbsSort.direction==="asc"?"desc":"asc":c.stageEditorClimbsSort={key:E,direction:Pm(E)},aa()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{Jm()});const r=document.getElementById("btn-stage-editor-load-existing");r&&r.addEventListener("click",()=>{qm()});const s=document.getElementById("btn-stage-editor-export");s&&s.addEventListener("click",()=>{Xm()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",$=>{var C;const I=((C=$.target.files)==null?void 0:C[0])??null;h("stage-editor-file-hint").textContent=I?`${I.name} · ${(I.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",$=>{const I=$.target,C=I.closest("tr[data-segment-index]"),E=I.dataset.field;if(!C||!E)return;const P=Number(C.dataset.segmentIndex);if(Number.isInteger(P)){if(E==="markerType"||E==="markerName"||E==="markerCat"){const L=Number(I.dataset.markerIndex),A=I.dataset.markerScope;if(!Number.isInteger(L)||A!=="start"&&A!=="end")return;ym(P,L,A,E,I.value);return}Vm(P,E,I.value)}}),i.addEventListener("click",$=>{const I=$.target.closest("button[data-segment-action]");if(!I)return;const C=Number(I.dataset.segmentIndex);if(Number.isInteger(C)){if(I.dataset.segmentAction==="insert"){Um(C);return}if(I.dataset.segmentAction==="append"){Ym();return}if(I.dataset.segmentAction==="add-marker"){const E=I.dataset.markerScope;if(E!=="start"&&E!=="end")return;Sm(C,E);return}if(I.dataset.segmentAction==="remove-marker"){const E=Number(I.dataset.markerIndex),P=I.dataset.markerScope;if(!Number.isInteger(E)||P!=="start"&&P!=="end")return;km(C,E,P);return}I.dataset.segmentAction==="delete"&&Zm(C)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach($=>{const I=document.getElementById($);I&&I.addEventListener("change",()=>me())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach($=>{$.addEventListener("change",()=>me())});const d=h("stage-editor-new-race-checkbox"),l=h("stage-editor-new-race-details"),p=h("stage-editor-program-checkbox"),u=h("stage-editor-program-details");d&&d.addEventListener("change",()=>{d.checked?(l&&(l.classList.remove("hidden"),l.style.display="grid"),p&&(p.checked=!0,u&&(u.classList.remove("hidden"),u.style.display="block"))):l&&(l.classList.add("hidden"),l.style.display="none"),me()}),p&&p.addEventListener("change",()=>{p.checked?u&&(u.classList.remove("hidden"),u.style.display="block"):u&&(u.classList.add("hidden"),u.style.display="none"),me()});const m=h("stage-editor-programs-dropdown-trigger"),f=h("stage-editor-programs-dropdown-menu"),g=h("btn-stage-editor-programs-ok");m&&f&&(m.addEventListener("click",$=>{$.stopPropagation();const I=f.style.display==="none"||!f.style.display;f.style.display=I?"flex":"none"}),g&&g.addEventListener("click",$=>{$.stopPropagation(),f.style.display="none",me()}),document.addEventListener("click",$=>{const I=$.target;f.style.display==="flex"&&!f.contains(I)&&I!==m&&!m.contains(I)&&(f.style.display="none",me())}));const b=h("stage-editor-programs-list");b&&b.addEventListener("change",$=>{$.target.name==="stage-editor-program-selection"&&Tm()});let v=!1,y=null;const T=h("stage-editor-stage-id"),M=h("stage-editor-race-id");if(T&&M){[T,M].forEach(I=>{I.addEventListener("keydown",C=>{C.key!=="ArrowUp"&&C.key!=="ArrowDown"&&(v=!0,y&&clearTimeout(y))}),I.addEventListener("keyup",C=>{C.key!=="ArrowUp"&&C.key!=="ArrowDown"&&(y&&clearTimeout(y),y=setTimeout(()=>{v=!1},150))}),I.addEventListener("blur",()=>{v=!1})});const $=(I,C)=>{const E=Number(I.value);if(!Number.isInteger(E)||E<=0){C==="stage"?Wt=E:jt=E;return}const L=E-(C==="stage"?Wt:jt);if(!v&&(L===1||L===-1)){let A=E;C==="stage"?A=Mm(E,L):h("stage-editor-new-race-checkbox").checked&&(A=Rm(E,L)),I.value=String(A)}C==="stage"?Wt=Number(I.value):jt=Number(I.value)};T.addEventListener("input",()=>{$(T,"stage"),me()}),M.addEventListener("input",()=>{$(M,"race"),me()})}const x=h("stage-editor-hide-boring-segments-checkbox");x&&x.addEventListener("change",()=>{c.stageEditorHideBoringSegments=x.checked,me()})}let lt=[],Gt=null,Le={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const At=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"];function fs(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      ...
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonplatzierung">${re.rank} <span class="rider-stats-icon-pill-value">${tp($)}</span></span>
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Siege">${re.wins} <span class="rider-stats-icon-pill-value">${C}</span></span>
      </div>
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-summary-pill-heat" style="--rider-stats-pill-hue:6;--rider-stats-pill-border-alpha:0.26;--rider-stats-pill-bg-alpha:0.14; font-weight: 500;" title="Spezialisierung 3">${ne} ${S(B)}</span>
        <span class="rider-stats-icon-pill" style="visibility: hidden;">&nbsp;</span>
      </div>
      <div class="rider-stats-header-col align-left">
        ${gt(re.stageRace,"Rundfahrten Punkte",A.stageRace,G)}
        ${gt(re.oneDay,"Eintagesrennen Punkte",A.oneDay,G)}
      ...
      <div class="rider-stats-header-col align-left">
        ${gt(re.flat,"Flach-Punkte",P.flat,L)}
        ${gt(re.hilly,"Hügel-Punkte",P.hilly,L)}
        ${gt(re.mediumMountain,"Mittelgebirge-Punkte",P.mediumMountain,L)}
      </div>
      <div class="rider-stats-header-col align-left">
        ${gt(re.mountain,"Hochgebirge-Punkte",P.mountain,L)}
        ${gt(re.timetrial,"Zeitfahren-Punkte",P.timetrial,L)}
        ${gt(re.cobble,"Kopfsteinpflaster-Punkte",P.cobble,L)}
      </div>
    </div>
  `}function Bn(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",r=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(r)}</strong>`}function Ve(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </div>`}function ip(e){const t=[{score:55,hue:0,lightness:28},{score:60,hue:0,lightness:40},{score:68,hue:30,lightness:42},{score:74,hue:60,lightness:42},{score:80,hue:120,lightness:36}];let a=120,r=36;const s=Math.max(55,Math.min(80,e));for(let d=1;d<t.length;d++){const l=t[d-1],p=t[d];if(s<=p.score){const u=(s-l.score)/(p.score-l.score);a=Math.round(l.hue+(p.hue-l.hue)*u),r=Math.round(l.lightness+(p.lightness-l.lightness)*u);break}}return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${.44};--stage-editor-score-border-alpha:${.72};`}">${e.toFixed(0)}</span>`}function op(e,t){const a=(e==null?void 0:e.skills)??{mountain:60,hill:60,sprint:60,timeTrial:60,cobble:60,attack:60,mediumMountain:60,flat:60,prologue:60,acceleration:60},r=["mountain","hill","sprint","timeTrial","cobble","attack"],s=["Berg (MTN)","Hügel (HIL)","Sprint (SPR)","Zeitfahren (TT)","Pflaster (COB)","Angriff (ATT)"],n=540,i=440,o=n/2,d=i/2,l=160,p=60,u=85,m=u-p,f=A=>{const G=[];for(let K=0;K<6;K++){const w=K*Math.PI/3-Math.PI/2;G.push(`${o+A*Math.cos(w)},${d+A*Math.sin(w)}`)}return G},g=`
    <defs>
    ...
    </defs>`,b=`<circle cx="${o}" cy="${d}" r="${l+8}" fill="url(#radarBgGrad)" stroke="rgba(255,255,255,0.06)" stroke-width="1" />`;let v="";for(let A=p;A<=u;A+=2.5){const G=l*((A-p)/m);if(G<1){v+=`<circle cx="${o}" cy="${d}" r="2" fill="rgba(255,255,255,0.25)" />`;continue}const K=f(G),w=A%5===0,B=w?1:.6,U=w?"none":"4,4",W=w?.4:.18;v+=`<polygon points="${K.join(" ")}" fill="none" stroke="rgba(255,255,255,${W})" stroke-width="${B}" stroke-dasharray="${U}" />`,w&&A>p&&(v+=`<text x="${o+5}" y="${d-G+4}" fill="rgba(255,255,255,0.45)" font-size="9" font-family="Inter, sans-serif" text-anchor="start">${A}</text>`)}let y="",T="";for(let A=0;A<6;A++){const G=A*Math.PI/3-Math.PI/2,K=o+l*Math.cos(G),w=d+l*Math.sin(G);y+=`<line x1="${o}" y1="${d}" x2="${K}" y2="${w}" stroke="rgba(255,255,255,0.15)" stroke-width="1" />`;const B=l+28,U=o+B*Math.cos(G),W=d+B*Math.sin(G),ne=Math.cos(G);let q="middle";ne>.15?q="start":ne<-.15&&(q="end");const ee=a[r[A]]??p;T+=`<text x="${U}" y="${W}" fill="rgba(255,255,255,0.92)" font-size="11.5" font-weight="700" font-family="Inter, sans-serif" text-anchor="${q}" dominant-baseline="middle">${s[A]}</text>`,T+=`<text x="${U}" y="${W+14}" fill="rgba(255,255,255,0.50)" font-size="10" font-weight="500" font-family="Inter, sans-serif" text-anchor="${q}" dominant-baseline="middle">${ee}</text>`}const M=[],x=[];r.forEach((A,G)=>{const K=a[A]??p,w=l*((Math.max(p,Math.min(u,K))-p)/m),B=G*Math.PI/3-Math.PI/2,U=o+w*Math.cos(B),W=d+w*Math.sin(B);M.push(`${U},${W}`),x.push(`<circle cx="${U}" cy="${W}" r="5" fill="#818cf8" stroke="#fff" stroke-width="2" filter="url(#dotGlow)"><title>${s[G]}: ${K}</title></circle>`)});const $=`<polygon points="${M.join(" ")}" fill="url(#riderFillGrad)" stroke="#818cf8" stroke-width="2.5" stroke-linejoin="round" filter="url(#radarGlow)" />`,C=[...[{key:"mountain",label:"Berg (MTN)"},{key:"hill",label:"Hügel (HIL)"},{key:"sprint",label:"Sprint (SPR)"},{key:"timeTrial",label:"Zeitfahren (TT)"},{key:"cobble",label:"Pflaster (COB)"},{key:"attack",label:"Angriff (ATT)"},{key:"mediumMountain",label:"Mittelgebirge (MDM)"},{key:"flat",label:"Flach (FLA)"},{key:"prologue",label:"Prolog (PRO)"},{key:"acceleration",label:"Beschleunigung (ACC)"}]].sort((A,G)=>{const K=a[A.key]??60;return(a[G.key]??60)-K}),E=[],P=[];C.forEach((A,G)=>{const K=a[A.key]??60,w=`
    ...
    `;G%2===0?E.push(w):P.push(w)});const L=`
  ...
  `}function lp(e,t){const a=t.shortTermFatigueMalus??0,r=t.longTermFatigueDecayable??0,s=t.longTermFatigueLocked??0,n=t.longTermFatigueMalus??0,i=t.totalFatigueLoadMalus??0,o=(a/.2).toFixed(1).replace(".",","),d=(r/.01).toFixed(0);let l="#fff";t.shortTermFatigueWarning==="critical"?l="#ef4444":t.shortTermFatigueWarning==="warning"&&(l="#fbbf24");const p=t.fatigueHistory??[];let u="";return p.length===0?u='<tr><td colspan="6" class="text-center text-muted" style="padding: 2rem; color: #888;">Keine Erschöpfungshistorie für diesen Fahrer vorhanden.</td></tr>':u=p.map(m=>{const f=oe(m.date);let g="";m.type==="race"?g=`${S(m.raceName)}${m.stageNumber!=null?` - Etappe ${m.stageNumber}`:""}`:g=m.raceName?S(m.raceName):"Regeneration";const b=m.type==="race"&&m.stageScore!=null?`<span class="badge" style="background: rgba(255,255,255,0.08); color: #fff; padding: 0.25rem 0.5rem; border-radius: 4px; font-weight: 600;">${m.stageScore.toFixed(0)}</span>`:'<span style="color: #666;">–</span>';let v="";m.shortChange>0?v=`<span style="color: #ef4444; font-weight: 600;">+${m.shortChange.toFixed(2).replace(".",",")}</span>`:m.shortChange<0?v=`<span style="color: #2ecc71; font-weight: 600;">${m.shortChange.toFixed(2).replace(".",",")}</span>`:v='<span style="color: #666;">0,00</span>';const y=[];if(m.longDecayableChange!==0){const x=m.longDecayableChange>0?"+":"",$=m.longDecayableChange>0?"#ef4444":"#2ecc71";y.push(`<span style="color: ${$}; font-weight: 500;">${x}${m.longDecayableChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Abbau.)</span></span>`)}if(m.longLockedChange!==0){const x=m.longLockedChange>0?"+":"",$=m.longLockedChange>0?"#a855f7":"#2ecc71";y.push(`<span style="color: ${$}; font-weight: 500;">${x}${m.longLockedChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Gesp.)</span></span>`)}const T=y.length>0?`<div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.1rem;">${y.join("")}</div>`:'<span style="color: #666;">0,00</span>',M=m.shortAfter+m.longAfter;return`
        <tr>
  ...
  `}function dp(e){var j;if(!e)return`
      ...
      </section>`;const a=(e.formHistory??[]).filter((D,_)=>_%2===0),r=((j=c.gameState)==null?void 0:j.currentDate)??new Date().toISOString(),s=a.length>0?new Date(a[a.length-1].date).getUTCFullYear():new Date(r).getUTCFullYear(),n=new Date(Date.UTC(s,0,1)).getTime(),i=864e5,o=1260,d=384,l=40,p=20,u=a.map(D=>{const F=(new Date(D.date).getTime()-n)/i,O=l+F/365*o,z=p+d-Math.min(8,Math.max(0,D.totalForm))/8*d;return{x:O,y:z,form:D.totalForm,date:D.date}});let m="",f="",g="";Le.form&&u.length>0&&(m=`M ${u.map(D=>`${D.x},${D.y}`).join(" L ")}`,f=u.map(D=>`<circle cx="${D.x}" cy="${D.y}" r="3" fill="#fff" stroke="var(--accent-primary)" stroke-width="2"><title>${e.riderName} (${D.date}): ${D.form}</title></circle>`).join(""),g=`${m} L ${u[u.length-1].x},${p+d} L ${u[0].x},${p+d} Z`);let b="",v="";if(Le.combinedFatigue&&u.length>0){const D=a.map(F=>{const z=(new Date(F.date).getTime()-n)/i,k=l+z/365*o,R=F.combinedFatigue??0,N=p+d-Math.min(15,Math.max(0,R))/15*d;return{x:k,y:N,val:R,date:F.date}});b=`<path d="${`M ${D.map(F=>`${F.x},${F.y}`).join(" L ")}`}" fill="none" stroke="#ef4444" stroke-width="2" />`,v=D.map(F=>`<circle cx="${F.x}" cy="${F.y}" r="3" fill="#fff" stroke="#ef4444" stroke-width="2"><title>Gesamtfatigue (${F.date}): ${F.val.toFixed(2)}</title></circle>`).join("")}let y="",T="";if(Le.shortFatigue&&u.length>0){const D=a.map(F=>{const z=(new Date(F.date).getTime()-n)/i,k=l+z/365*o,R=F.shortFatigue??0,N=p+d-Math.min(15,Math.max(0,R))/15*d;return{x:k,y:N,val:R,date:F.date}});y=`<path d="${`M ${D.map(F=>`${F.x},${F.y}`).join(" L ")}`}" fill="none" stroke="#facc15" stroke-width="2" />`,T=D.map(F=>`<circle cx="${F.x}" cy="${F.y}" r="3" fill="#fff" stroke="#facc15" stroke-width="2"><title>Kurzzeitfatigue (${F.date}): ${F.val.toFixed(2)}</title></circle>`).join("")}let M="",x="";if(Le.longFatigue&&u.length>0){const D=a.map(F=>{const z=(new Date(F.date).getTime()-n)/i,k=l+z/365*o,R=F.longFatigue??0,N=p+d-Math.min(15,Math.max(0,R))/15*d;return{x:k,y:N,val:R,date:F.date}});M=`<path d="${`M ${D.map(F=>`${F.x},${F.y}`).join(" L ")}`}" fill="none" stroke="#a855f7" stroke-width="2" />`,x=D.map(F=>`<circle cx="${F.x}" cy="${F.y}" r="3" fill="#fff" stroke="#a855f7" stroke-width="2"><title>Langzeitfatigue (${F.date}): ${F.val.toFixed(2)}</title></circle>`).join("")}const $="rgba(251, 191, 36, 0.15)";let I="";for(let D=0;D<=8;D+=2){const _=p+d-D/8*d;I+=`<line x1="${l}" y1="${_}" x2="${l+o}" y2="${_}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,I+=`<text x="${l-5}" y="${_+4}" fill="#ffffff" font-size="10" text-anchor="end">${D}</text>`}for(let D=0;D<=15;D+=3){const _=p+d-D/15*d;I+=`<text x="${l+o+5}" y="${_+4}" fill="#ef4444" font-size="10" text-anchor="start">${D}</text>`}let C="";for(let D=0;D<=52;D+=5){const _=l+D/52*o;I+=`<line x1="${_}" y1="${p}" x2="${_}" y2="${p+d}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,C+=`<text x="${_}" y="${p+d+15}" fill="#ffffff" font-size="10" text-anchor="middle">W${D}</text>`}let E="",P="";if(e.peakDates){const D=[...e.peakDates].sort((_,F)=>new Date(_).getTime()-new Date(F).getTime());for(let _=0;_<D.length;_++){const F=D[_],z=(new Date(F).getTime()-n)/i,k=l+z/365*o;E+=`<line x1="${k}" y1="${p}" x2="${k}" y2="${p+d}" stroke="#ffffff" stroke-width="2"><title>Peak: ${F}</title></line>`;const R=_>0?(new Date(D[_-1]).getTime()-n)/i:Number.NEGATIVE_INFINITY,N=z-56,H=R+14,Z=Math.max(0,Math.max(N,H)),ie=z-Z,pe=l+Z/365*o,fe=ie/365*o;P+=`<rect x="${pe}" y="${p}" width="${fe}" height="${d}" fill="rgba(16, 185, 129, 0.1)" />`;const be=14/365*o;P+=`<rect x="${k}" y="${p}" width="${be}" height="${d}" fill="rgba(239, 68, 68, 0.1)" />`}}const A=(new Date(r).getTime()-n)/i,G=l+A/365*o;E+=`<line x1="${G}" y1="${p}" x2="${G}" y2="${p+d}" stroke="#ef4444" stroke-width="3"><title>Heute: ${r}</title></line>`,lt.forEach((D,_)=>{const F=At[_%At.length];D.peakDates&&D.peakDates.forEach(O=>{const k=(new Date(O).getTime()-n)/i,R=l+k/365*o;E+=`<line x1="${R}" y1="${p}" x2="${R}" y2="${p+d}" stroke="${F}" stroke-width="1.5" stroke-dasharray="3,3"><title>${D.riderName} Peak: ${O}</title></line>`})});let K="",w="";lt.forEach((D,_)=>{const F=At[_%At.length],O=D.formHistory.filter((z,k)=>k%2===0).map(z=>{const R=(new Date(z.date).getTime()-n)/i,N=l+R/365*o,H=p+d-Math.min(8,Math.max(0,z.totalForm))/8*d;return{x:N,y:H,form:z.totalForm,date:z.date}});if(O.length>0){const z=`M ${O.map(k=>`${k.x},${k.y}`).join(" L ")}`;K+=`<path d="${z}" fill="none" stroke="${F}" stroke-width="2" />`,w+=O.map(k=>`<circle cx="${k.x}" cy="${k.y}" r="3" fill="#fff" stroke="${F}" stroke-width="2"><title>${D.riderName} (${k.date}): ${k.form}</title></circle>`).join("")}});const B=c.teams.filter(D=>D.division==="WorldTour"||D.divisionName==="WorldTour");let U='<option value="">-- Team auswählen --</option>';for(const D of B){const _=Gt===D.id?" selected":"";U+=`<option value="${D.id}"${_}>${S(D.name)}</option>`}let W='<option value="">-- Fahrer auswählen --</option>';if(Gt!=null){const D=c.riders.filter(_=>_.activeTeamId===Gt&&_.id!==e.riderId&&!lt.some(F=>F.riderId===_.id));for(const _ of D)W+=`<option value="${_.id}">${S(_.firstName)} ${S(_.lastName)}</option>`}const ne=`
  ...
  `,q=e.currentSeasonRank??rr(e.riderId)??"–",ee=[`
    ...
    `];lt.forEach((D,_)=>{const F=At[_%At.length],O=D.currentSeasonRank??rr(D.riderId)??"–";ee.push(`
  ...
  `}function Lt(e,t){return`<span class="rider-stats-rank-badge rider-stats-rank-badge-${t}">${S(e)}</span>`}function up(e){return!e.isBreakaway||e.rowType!=="stage_result"||e.finishStatus!=="classified"?"–":'<span class="rider-stats-breakaway-icon" aria-label="Ausreißer" title="Ausreißer"><svg class="rider-stats-icon" viewBox="0 0 24 24" style="fill:#ef4444; width:1em; height:1em; vertical-align:middle;"><path d="M12 21L2 3h20L12 21z"/></svg></span>'}function mp(e){return e.finishStatus==="otl"?Lt("OTL","place"):e.finishStatus==="dnf"?Lt("DNF","place"):e.resultRank==null?"–":`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${e.resultRank<=3?` rider-stats-rank-badge-top-${e.resultRank}`:""}">${S(String(e.resultRank))}</span>`}function pp(e){return e.finishStatus!=="classified"||e.gcRank==null?"–":Lt(String(e.gcRank),"gc")}function gp(e){return e.finishStatus==="otl"?Hr(e.statusReason,!0):e.finishStatus==="dnf"?Hr(e.statusReason,!1):e.stageTimeSeconds!=null?`${e.resultLabel} · ${Oa(e.stageTimeSeconds)}`:e.resultLabel}function Ge(e,t,a=!1){var o,d;const r=(e==null?void 0:e.activeTeamId)!=null?((o=c.teams.find(l=>l.id===e.activeTeamId))==null?void 0:o.name)??null:null,s=((d=e==null?void 0:e.country)==null?void 0:d.code3)??(e==null?void 0:e.nationality)??null,n=s?de(s):"",i=t==null?[]:[...t.seasons].map(l=>({...l,raceBlocks:np(l.raceBlocks)})).sort((l,p)=>p.season-l.season);return a?`
      ...
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      ${op(e)}`:c.riderStatsTab==="fatigue"?`
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      ${lp(e,t)}`:c.riderStatsTab==="program"?`
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      ${cp(t)}`:c.riderStatsTab==="form"?`
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      ${dp(t)}`:c.riderStatsTab==="topResults"?`
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      ${hp(t)}`:c.riderStatsTab==="career"?`
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      ${bp(t)}`:t.seasons.length===0?`
      ${Oe(e,t,r,s,n)}
      ${Ve(t)}
      <section class="rider-stats-placeholder">
    ...
    ${i.map(l=>`
                  ...
                  <tbody>
                    ${p.rows.map(u=>{const m=u.rowType!=="stage_result",f=m?`${u.raceName} · ${bs(u.rowType)}`:u.stageName?`${u.raceName} · ${u.stageName}`:u.raceName;return`
                        <tr class="rider-stats-row${m?" rider-stats-row-final":""}">
                          ...
                          <td>${mp(u)}</td>
                          <td>${pp(u)}</td>
                          <td class="rider-stats-breakaway-col">${up(u)}</td>
                          <td>${m?"":fs(u.rolledWeatherId,u.rolledWetterName)}</td>
                          <td>${m?ap(u.rowType):ar(u.raceCategoryName?u.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):u.raceCategoryName,u.isStageRace)}</td>
                          <td>${S(f)}</td>
      ...
      <section class="rider-stats-placeholder">
        <h3>Keine Historie vorhanden</h3>
        <p>Für diesen Fahrer wurden in der aktuellen Karriere noch keine Ergebnisse gefunden.</p>
      </section>`}function Vr(){const e=document.querySelector(".rider-stats-modal-card");if(!e)return;["results","topResults","career","form","fatigue"].includes(c.riderStatsTab)?(e.style.minWidth="min(1475px, 95vw)",e.style.maxWidth="1687px"):(e.style.minWidth="",e.style.maxWidth="")}async function Zt(e){var d,l,p,u;const t=Re(e),a=(t==null?void 0:t.activeTeamId)!=null?((d=c.teams.find(m=>m.id===t.activeTeamId))==null?void 0:d.name)??null:null;lt=[],Gt=null,c.riderStatsSelectedRiderId=e,c.riderStatsTab="results",Vr(),c.riderStatsTopResultsFilterCategory=null,c.riderStatsTopResultsFilterSeason=null,c.riderStatsTopResultsPage=1,h("rider-stats-title").innerHTML=Bn(t,null),h("rider-stats-jersey").innerHTML="";const r=t!=null&&t.age?` · Alter ${t.age}`:"";h("rider-stats-meta").textContent=t?`${((l=t.role)==null?void 0:l.name)??"Fahrer"} · ${a??"Team unbekannt"}${r}`:"Historie wird geladen",h("rider-stats-body").innerHTML=Ge(t,null,!0),qe("riderStats");const s=await V.getRiderStats(e);if(c.riderStatsSelectedRiderId!==e)return;if(!s.success||!s.data){const m=t!=null&&t.age?` · Alter ${t.age}`:"";h("rider-stats-meta").textContent=t?`${((p=t.role)==null?void 0:p.name)??"Fahrer"} · ${a??"Team unbekannt"}${m}`:"Fehler beim Laden",h("rider-stats-body").innerHTML=`
      <section class="rider-stats-placeholder">
        <h3>Historie konnte nicht geladen werden</h3>
        <p>${S(s.error??"Unbekannter Fehler")}</p>
      </section>`;return}c.riderStatsPayload=s.data,Vr(),h("rider-stats-title").innerHTML=Bn(t,s.data),h("rider-stats-jersey").innerHTML="";const n=s.data.age?` · Alter ${s.data.age}`:t!=null&&t.age?` · Alter ${t.age}`:"",i=s.data.mentorName?` · Mentor: ${s.data.mentorName}`:"",o=s.data.mentoredRiderNames&&s.data.mentoredRiderNames.length>0?` · Mentor von: ${s.data.mentoredRiderNames.join(" - ")}`:"";h("rider-stats-meta").textContent=`${((u=t==null?void 0:t.role)==null?void 0:u.name)??"Fahrer"} · ${s.data.teamName??a??"Ohne aktives Team"}${n} · ${s.data.seasons.length} Saisons${i}${o}`,h("rider-stats-body").innerHTML=Ge(t,s.data,!1)}function fp(){h("rider-stats-body").addEventListener("click",e=>{var s;if(e.target&&e.target.id&&e.target.id.startsWith("toggle-chart-")){const n=e.target.id,i=e.target.checked;n==="toggle-chart-form"?Le.form=i:n==="toggle-chart-combined-fatigue"?Le.combinedFatigue=i:n==="toggle-chart-short-fatigue"?Le.shortFatigue=i:n==="toggle-chart-long-fatigue"&&(Le.longFatigue=i);const o=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(o,c.riderStatsPayload,!1);return}const t=e.target.closest("button[data-rider-stats-tab]");if(!t){const n=e.target.closest("button[data-remove-compare-id]");if(n){const d=Number(n.dataset.removeCompareId);lt=lt.filter(p=>p.riderId!==d);const l=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(l,c.riderStatsPayload,!1);return}const i=e.target.closest("button[data-top-results-page]");if(i){const d=Number(i.dataset.topResultsPage);if(!isNaN(d)&&d>=1){c.riderStatsTopResultsPage=d;const l=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(l,c.riderStatsPayload,!1)}return}const o=e.target.closest("button[data-stage-profile-id]");if(o){const d=Number(o.dataset.stageProfileId);Number.isFinite(d)&&nr(d);return}return}const a=t.dataset.riderStatsTab;if(a!=="results"&&a!=="program"&&a!=="form"&&a!=="topResults"&&a!=="skills"&&a!=="career"&&a!=="fatigue"||a==="program"&&(((s=c.riderStatsPayload)==null?void 0:s.programRaces.length)??0)===0)return;c.riderStatsTab=a,Vr();const r=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(r,c.riderStatsPayload,!1)}),h("rider-stats-body").addEventListener("change",async e=>{const t=e.target;if(t.id==="rider-stats-filter-category"){c.riderStatsTopResultsFilterCategory=t.value==="all"?null:t.value,c.riderStatsTopResultsPage=1;const a=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(a,c.riderStatsPayload,!1)}else if(t.id==="rider-stats-filter-season"){c.riderStatsTopResultsFilterSeason=t.value==="all"?null:Number(t.value),c.riderStatsTopResultsPage=1;const a=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(a,c.riderStatsPayload,!1)}else if(t.classList.contains("rider-stats-filter-checkbox")){const a=t.dataset.filterType;c.riderStatsTopResultsFilters[a]=t.checked,c.riderStatsTopResultsPage=1;const r=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(r,c.riderStatsPayload,!1)}else if(t.id==="rider-compare-team-select"){const a=t.value;Gt=a?Number(a):null;const r=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(r,c.riderStatsPayload,!1)}else if(t.id==="rider-compare-rider-select"){const a=t.value;if(a){const r=Number(a);if(lt.length>=10){alert("Sie können maximal 10 Fahrer vergleichen."),t.value="";return}const s=await V.getRiderStats(r,!0);s.success&&s.data?lt.push({riderId:s.data.riderId,riderName:s.data.riderName,teamId:s.data.teamId,teamName:s.data.teamName,formHistory:s.data.formHistory??[],peakDates:s.data.peakDates??[],currentSeasonPoints:s.data.currentSeasonPoints??0,currentSeasonRank:s.data.currentSeasonRank??null}):alert("Formverlauf konnte nicht geladen werden: "+(s.error??""));const n=Re(c.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Ge(n,c.riderStatsPayload,!1)}}})}function Hn(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?0:t.includes("grand tour")?1:t.includes("monument")?2:t.includes("stage race high")?3:t.includes("one day high")?4:t.includes("stage race middle")?5:t.includes("one day middle")?6:t.includes("stage race low")?7:t.includes("one day low")?8:9}function hp(e){const t=[];for(const g of e.seasons)for(const b of g.raceBlocks)for(const v of b.rows)t.push({...v,season:g.season,isStageRace:b.isStageRace});const a=Array.from(new Set(t.map(g=>g.raceCategoryName).filter(Boolean)));a.sort((g,b)=>g.localeCompare(b,"de"));const r=Array.from(new Set(t.map(g=>g.season))).sort((g,b)=>b-g);let s=t.filter(g=>g.rowType!=="stage_result"?g.rowType==="gc_final"?c.riderStatsTopResultsFilters.gc:g.rowType==="mountain_final"?c.riderStatsTopResultsFilters.mountain:g.rowType==="points_final"?c.riderStatsTopResultsFilters.points:g.rowType==="youth_final"?c.riderStatsTopResultsFilters.youth:!0:g.isStageRace?c.riderStatsTopResultsFilters.stage:c.riderStatsTopResultsFilters.oneDay);if(c.riderStatsTopResultsFilterCategory){const g=c.riderStatsTopResultsFilterCategory;if(g.endsWith("-etappen")){const b=g.substring(0,g.length-8);s=s.filter(v=>v.raceCategoryName===b&&v.rowType==="stage_result")}else if(g.endsWith("-gc")){const b=g.substring(0,g.length-3);s=s.filter(v=>v.raceCategoryName===b&&v.rowType!=="stage_result")}else s=s.filter(b=>b.raceCategoryName===g)}c.riderStatsTopResultsFilterSeason!=null&&(s=s.filter(g=>g.season===c.riderStatsTopResultsFilterSeason)),s.sort((g,b)=>{if(b.seasonPoints!==g.seasonPoints)return b.seasonPoints-g.seasonPoints;const v=g.rowType!=="stage_result",y=b.rowType!=="stage_result",T=g.resultRank??9999,M=b.resultRank??9999;if(c.riderStatsTopResultsFilterCategory)return T!==M?T-M:v!==y?v?-1:1:0;{const x=Hn(g.raceCategoryName),$=Hn(b.raceCategoryName);return x!==$?x-$:v!==y?v?-1:1:T-M}});const n=200,i=s.slice(0,1e3),o=Math.max(1,Math.ceil(i.length/n));c.riderStatsTopResultsPage>o&&(c.riderStatsTopResultsPage=o);const d=(c.riderStatsTopResultsPage-1)*n,l=i.slice(d,d+n),u=`
...
`+r.error);return}c.stageResults=r.data??null,c.stageResults&&(c.selectedResultsRaceId=c.stageResults.raceId,c.selectedResultsStageId=c.stageResults.stageId,c.selectedResultTypeId=((s=c.stageResults.classifications[0])==null?void 0:s.resultTypeId)??1,c.selectedResultsMarkerKey=Ye,c.selectedResultsSpecialView=null),c.selectedResultsRaceId!=null&&$o(c.selectedResultsRaceId),Ie()}async function $o(e){if(!c.seasonStandings){const a=await V.getSeasonStandings();a.success&&a.data&&(c.seasonStandings=a.data)}const t=await V.getRaceResultsRoster(e);t.success&&t.data?c.resultsRoster=t.data:c.resultsRoster=null}function Mp(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function Kn(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function Rp(){const e=c.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=St(c.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,r=[...e.entries].sort((v,y)=>y.overallRating-v.overallRating),s=new Set(r.slice(0,5).map(v=>v.riderId)),n=v=>{var T;const y=c.riders.find(M=>M.id===v);return((T=y==null?void 0:y.skills)==null?void 0:T.sprint)??0},o=[...e.entries.filter(v=>!s.has(v.riderId))].sort((v,y)=>{const T=n(v.riderId),M=n(y.riderId);return M!==T?M-T:y.overallRating-v.overallRating}),d=new Set(o.slice(0,5).map(v=>v.riderId));function l(v){switch(v){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return v}}const p=new Map;for(const v of e.entries){const y=v.teamId;p.has(y)||p.set(y,{teamId:v.teamId,teamName:v.teamName,riders:[],avgRating:0}),p.get(y).riders.push(v)}for(const v of p.values())v.avgRating=v.riders.reduce((y,T)=>y+T.overallRating,0)/v.riders.length;const u=v=>{let y=Number.POSITIVE_INFINITY;for(const T of v)!T.hasDropped&&T.gcRank!=null&&T.gcRank<y&&(y=T.gcRank);return y},m=v=>{var T;if(!((T=c.seasonStandings)!=null&&T.riderStandings))return 0;let y=0;for(const M of v){const x=c.seasonStandings.riderStandings.find($=>$.riderId===M.riderId);x&&x.points>y&&(y=x.points)}return y},f=v=>{if(v==null)return 0;const y=c.riders.filter(x=>x.activeTeamId===v);if(y.length===0)return 0;const T=y.map(x=>x.overallRating??0);T.sort((x,$)=>$-x);const M=T.slice(0,10);return M.length===0?0:M.reduce((x,$)=>x+$,0)/M.length},g=[...p.values()].sort((v,y)=>{const T=u(v.riders),M=u(y.riders);if((T!==Number.POSITIVE_INFINITY||M!==Number.POSITIVE_INFINITY)&&T!==M)return T-M;const x=m(v.riders),$=m(y.riders);if((x>0||$>0)&&x!==$)return $-x;const I=f(v.teamId),C=f(y.teamId);return Math.abs(I-C)>1e-4?C-I:(v.teamName??"").localeCompare(y.teamName??"","de")});for(const v of g)v.riders.sort((y,T)=>Kn(y.roleId)-Kn(T.roleId)||T.overallRating-y.overallRating||y.lastName.localeCompare(T.lastName,"de"));return`<div class="results-roster-grid">${g.map(v=>{const y=v.teamId!=null?Ft(v.teamId,v.teamName):"",T=v.riders.map(x=>{var j;const $=Mp(x.roleId),I=x.countryCode?Ze[x.countryCode]??x.countryCode.slice(0,2).toLowerCase():null,C=I?`<span class="fi fi-${I} results-roster-flag" title="${S(x.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',E=`${x.firstName.charAt(0)}. ${x.lastName}`,P=x.roleName??"–",L=x.specialization1?l(x.specialization1):null,A=x.specialization2?l(x.specialization2):null;let G=P;L&&(G+=` · ${L}`),A&&(G+=` · ${A}`);const K=`<span class="results-roster-overall-badge" style="color:${Ip(x.overallRating)}" title="Gesamtstärke: ${x.overallRating.toFixed(2)}">${x.overallRating.toFixed(2)}</span>`,w=x.hasDropped?" dropped":"";let B="";x.hasDropped?x.dropoutStatus==="dns"?B="DNS":x.dropoutStatus==="dnf"?B=((j=x.dropoutReason)==null?void 0:j.startsWith("OTL"))??!1?"OTL":"DNF":B="OUT":x.gcRank!=null&&(B=`${x.gcRank}`);let U="";if(x.hasDropped)U=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(x.dropoutReason||"")}">${B}</span>`;else if(x.gcRank!=null){let D="rider-stats-rank-badge-gc";x.gcRank===1?D="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":x.gcRank===2?D="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":x.gcRank===3&&(D="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),U=`<span class="rider-stats-rank-badge ${D}" title="GC Stand: Platz ${x.gcRank}">${x.gcRank}</span>`}const ne=`style="color: ${x.hasDropped?"var(--text-500)":$.color}; font-weight: bold;"`,q=s.has(x.riderId),ee=d.has(x.riderId);return`<div class="results-roster-rider${w}">
        <div class="results-roster-rider-info">
          <div class="results-roster-rider-top">
            ...
            <span class="results-roster-name${q?" strongest-rider":ee?" best-sprinter":""}">
              ${De(E,{riderId:x.riderId,teamId:x.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"})}
              ${Ga(x.riderId)}
            </span>
          </div>
  ...
  `,ne=g.findIndex(k=>k.resultTypeName.toLocaleLowerCase("de").includes("team"));ne>=0?w.splice(ne+1,0,B,U,W):w.push(B,U,W),a.innerHTML=w.join("");const q=$p(((F=c.stageResults)==null?void 0:F.markerClassifications)??[]);if(T){p.innerHTML=Rp(),p.classList.remove("hidden"),i.classList.add("hidden"),r.innerHTML="",r.classList.add("hidden"),l.innerHTML="",l.classList.add("hidden"),n.classList.add("hidden");return}else p.innerHTML="",p.classList.add("hidden");const ee=!v&&!y&&!T&&(b==null?void 0:b.resultTypeId)===1&&q.length>0,Y=ee?c.selectedResultsMarkerKey??Ye:null,j=ee&&Y!==Ye?q.find(k=>k.markerKey===Y)??null:null;if(ee&&(c.selectedResultsMarkerKey=(j==null?void 0:j.markerKey)??Ye),y){const k=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"},{key:"superteam",label:"Superteam"}];r.innerHTML=k.map(R=>`
    ...
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':y?[...((z=c.stageResults)==null?void 0:z.events)??[]].filter(k=>Ne==="all"?!0:Ne==="form"?!!(k.title&&(k.title.includes("guten Tag")||k.title.includes("schlechten Tag")||k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))):Ne==="attack"?(k.type==="attack"||k.type==="counter_attack")&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Ne==="breakaway"?!!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Ne==="incident"?(k.type==="incident"||!!(k.title&&k.title.includes("Massensturz")))&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Ne==="exit"?k.type==="dnf"||!!(k.title&&k.title.includes("nicht am Start")):Ne==="home"?!!(k.title&&(k.title.includes("Heimvorteil")||k.title.includes("Heimdruck"))):Ne==="weather"?!!(k.title&&k.title.startsWith("Wetterbericht:")):Ne==="superteam"?k.type==="superteam":!0).sort((k,R)=>{const N=k.kmMark??0,H=R.kmMark??0;if(Math.abs(N-H)>1e-4)return N-H;if(N===0){const pe=Wn(k),fe=Wn(R);if(pe!==fe)return pe-fe}const Z=k.riderName??"",ie=R.riderName??"";return Z.localeCompare(ie,"de")}).map(k=>{var pt,xt,As;const R=k.kmMark!=null?`${k.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",N=k.riderId,H=N!=null?Re(N):null,Z=k.riderTeamId??(H==null?void 0:H.activeTeamId)??null,ie=Z!=null?((pt=c.teams.find(ka=>ka.id===Z))==null?void 0:pt.name)??null:null;let pe=Qt(Z,ie);const fe=!!(k.title&&k.title.startsWith("Wetterbericht:"));let be=k.title||"";if(fe){const ka=(xt=c.stageResults)==null?void 0:xt.rolledWeatherId,kr=(As=c.stageResults)==null?void 0:As.rolledWetterName;pe=`<span class="results-jersey-cell">${fs(ka,kr)}</span>`,kr&&(be=`Wetterbericht: ${kr}`)}const ye=k.type==="superteam",ve=ye&&N==null,Se=fe||ve?"":ot(N!=null?zt(N):null),at=fe?"":ve?it(ie||"–",Z):N!=null?ea(k.riderName??"",!0,!1,N,Z):S(k.riderName||"–");let te="";return k.title&&k.title.includes("guten Tag")?te='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':k.title&&k.title.includes("schlechten Tag")?te='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':k.title&&(k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))?te='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':k.title&&k.title.includes("nicht am Start")?te='<span class="event-badge event-badge-dns">DNS</span>':k.title&&k.title.includes("Massensturz")?te='<span class="event-badge event-badge-masscrash">Massensturz</span>':k.type==="dnf"?te='<span class="event-badge event-badge-dnf">DNF</span>':k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))?te='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':k.type==="attack"?te='<span class="event-badge event-badge-attack">Attacke</span>':k.type==="counter_attack"?te='<span class="event-badge event-badge-counter">Konterattacke</span>':k.type==="incident"?k.title&&(k.title.toLowerCase().includes("defekt")||k.title.toLowerCase().includes("panne")||k.title.toLowerCase().includes("technisch"))?te='<span class="event-badge event-badge-defect">Defekt</span>':te='<span class="event-badge event-badge-crash">Sturz</span>':k.title&&k.title.includes("Super-Heimvorteil")?te='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Heimbonus</span>':k.title&&k.title.includes("Heimdruck")?te='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimmalus</span>':k.title&&k.title.includes("Heimvorteil")?te='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':k.title&&k.title.startsWith("Wetterbericht:")?te='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>':ye&&(te='<span class="event-badge event-badge-superteam"><span class="event-icon">⚡</span> Superteam</span>'),`
          ...
          </tr>`}).join("")||'<tr><td colspan="3" class="results-empty-cell">Keine Ereignisse für diese Etappe.</td></tr>':D&&b?b.rows.map(k=>{const R=k.riderName??k.teamName,N=k.riderName?k.teamName:"–",H=Qt(k.teamId,k.teamName),Z=ea(R,!0,k.isBreakaway===!0,k.riderId,k.teamId),ie=ot(zt(k.riderId)),pe=b.resultTypeId===1&&k.rank===1&&k.timeSeconds!=null&&x!=null,fe=k.timeSeconds!=null?`${Oa(k.timeSeconds)}${pe?` (${Tp(x,k.timeSeconds)})`:""}`:"–",be=K?`<td class="results-gc-delta-cell">${ml(k.previousRank,k.rankDelta)}</td>`:"";if(P){let ve=k.points!=null?String(k.points):"–";if(k.points!=null&&k.riderId!=null&&b){const at=b.resultTypeId===Br?$.get(k.riderId)??0:I.get(k.riderId)??0;at>0&&(ve+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${at}</span>`)}return`
          <tr>
          ...
          </tr>`}if(G){let ve=k.breakawayKms!=null?`${k.breakawayKms.toFixed(1).replace(".",",")} km`:"–";if(k.breakawayKms!=null&&k.riderId!=null){const Se=C.get(k.riderId)??0;Se>0&&(ve+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${Se.toFixed(1).replace(".",",")} km</span>`)}return`
          <tr>
            <td class="pos-${Math.min(k.rank,3)}">${k.rank}</td>
            ${be}
            <td class="results-jersey-col-cell">${H}</td>
          ...
          <tr>
            ...
            <td class="results-flag-col-cell">${ie}</td>
            <td>${fe}</td>
            <td>${S($r(k.gapSeconds))}</td>
            <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
          </tr>`;let ye=k.points!=null?String(k.points):"–";if(k.leadoutBonus!=null&&k.leadoutBonus>0&&k.leadoutRiderId!=null){const ve=Cp(k);ye=`
...
`+(d.error??"Unbekannter Fehler"));return}const l=d.data;c.selectedResultsRaceId=(l==null?void 0:l.raceId)??c.selectedResultsRaceId,c.selectedResultsStageId=(l==null?void 0:l.stageId)??e,c.selectedResultTypeId=1,c.realtimeBootstrap=null,c.realtimeError=null,await Ur(e,!1),await Cs(),await Es(),await sr(),Ot(),n||Dt("results")}catch(d){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+d.message)}finally{Bs(!1),$e()}}}function Ap(){h("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);c.selectedRealtimeStageId=Number.isFinite(t)?t:null,c.realtimeBootstrap&&c.realtimeBootstrap.stage.id!==c.selectedRealtimeStageId&&(c.realtimeBootstrap=null),c.realtimeError=null,zo(t,!1)})}function Is(e){var r;const t=ct((r=e.category)==null?void 0:r.name),a=lr(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function gr(e){var s,n;const t=ct((s=e.category)==null?void 0:s.name),a=lr(t),r=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(r)}</span>`}function Bp(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(r=>r.date).sort((r,s)=>r.localeCompare(s));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function fr(e){const{startDate:t,endDate:a}=Bp(e);return t===a?oe(t):`${oe(t)} - ${oe(a)}`}function Hp(e){return e.stageId>0}async function Cs(){const[e,t]=await Promise.all([V.getGameState(),V.getGameStatus()]);if(!e.success){console.error(e.error);return}c.gameState=e.data??null,c.gameStatus=t.success?t.data??null:null,Gp(),we("dashboard")&&hr()}function Gp(){var s;if(!c.gameState)return;h("meta-date").textContent=c.gameState.formattedDate,h("meta-season").textContent=`Saison ${c.gameState.season}`;const e=h("meta-race-hint"),t=h("btn-advance-day"),a=h("pending-stages-list"),r=((s=c.gameStatus)==null?void 0:s.pendingStages)??[];r.length>0?(e.textContent=`${r.length} offene Etappe${r.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=r.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${oe(n.date)}`:`${n.profile} · ${oe(n.date)}`,o=Hp(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
    ...
    <tr>
      ...
      <td>${l}</td>
      <td>${r}</td>
    </tr>`}function jp(){const e=h("dashboard-races-tbody");if(!c.gameState){e.innerHTML='<tr><td colspan="9" class="text-muted">Kein Spiel geladen.</td></tr>';return}const t=c.gameState.currentDate,a=Wp(t,7),r=c.races.filter(i=>i.startDate<=t&&i.endDate>=t),s=c.races.filter(i=>i.startDate>t&&i.startDate<=a);let n="";n+=`
  ...
  `,s.length===0?n+=`
    ...
    `:n+=s.map(i=>On(i)).join(""),e.innerHTML=n}function ya(e){return`Etappe ${e.stageNumber}`}function Op(e){if(e.length===0)return"Keine Etappen";const t=new Map;return e.forEach(a=>{t.set(a.profile,(t.get(a.profile)??0)+1)}),Array.from(t.entries()).sort((a,r)=>r[1]!==a[1]?r[1]-a[1]:a[0].localeCompare(r[0])).map(([a,r])=>`${r}x ${a}`).join(" · ")}function Vp(e){return`stage-profile-badge-${e.toLowerCase().replace(/_/g,"-")}`}function Sa(e){return`<span class="stage-profile-badge ${Vp(e)}">${S(e)}</span>`}function br(e,t){return`${e.name} · ${ya(t)} · ${t.profile}`}async function Up(e){var s;const t=c.stageSummariesByStageId[e];if(t)return t;const a=await V.getStageSummary(e);if(a.success&&a.data)return c.stageSummariesByStageId[e]=a.data,c.stageSummaryErrorsByStageId&&delete c.stageSummaryErrorsByStageId[e],a.data;const r=await V.getRealtimeSimulation(e);return r.success&&((s=r.data)!=null&&s.stageSummary)?(c.stageSummariesByStageId[e]=r.data.stageSummary,c.stageSummaryErrorsByStageId&&delete c.stageSummaryErrorsByStageId[e],r.data.stageSummary):(c.stageSummaryErrorsByStageId&&(c.stageSummaryErrorsByStageId[e]=a.error??r.error??"Etappenprofil konnte nicht geladen werden."),console.error("Stage-Summary-Laden fehlgeschlagen:",{stageId:e,stageSummaryError:a.error,realtimeFallbackError:r.error}),c.stageSummariesByStageId&&delete c.stageSummariesByStageId[e],!a.success||!a.data?null:a.data)}function Yp(){var d;const e=h("race-stages-title"),t=h("race-stages-meta"),a=h("race-stages-body"),r=St(c.selectedDashboardRaceId);if(!r){e.textContent="Etappen",t.textContent="",a.innerHTML='<div class="results-empty">Rennen nicht gefunden.</div>';return}const s=r.stages??[],n=s.reduce((l,p)=>l+(p.distanceKm??0),0),i=s.reduce((l,p)=>l+(p.elevationGainMeters??0),0),o=Op(s);if(e.textContent=r.name,t.textContent=`${fr(r)} · ${((d=r.country)==null?void 0:d.name)??`Land ${r.countryId}`} · ${r.isStageRace?`${r.numberOfStages} Etappen`:"Eintagesrennen"} · ${Gr(n)} · ${zr(i)} · ${o}`,s.length===0){a.innerHTML='<div class="results-empty">Für dieses Rennen sind keine Etappen vorhanden.</div>';return}a.innerHTML=`
        ...
        <tbody>
          ${s.map(l=>`
              <tr class="dashboard-race-stage-row">
                ...
                <td>${Sa(l.profile)}</td>
                <td>${l.distanceKm!=null?Gr(l.distanceKm):"–"}</td>
                <td>${l.elevationGainMeters!=null?zr(l.elevationGainMeters):"–"}</td>
                <td>
                  <button
                    type="button"
                    class="dashboard-stage-profile-link"
                    data-dashboard-stage-profile-id="${l.id}"
                    aria-label="Profil von ${S(br(r,l))} öffnen"
                  >
                    Profil anzeigen
                  </button>
                </td>
    ...
    </div>`}async function Jr(e){St(e)&&(c.selectedDashboardRaceId=e,Yp(),qe("raceStages"))}function Zp(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
    ...
    </th>`}function qp(e){const t=c.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,r)=>{var n,i,o,d;let s=0;switch(c.raceParticipantsSort.key){case"team":s=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=r.team)==null?void 0:i.name)??"","de");break;case"rider":s=_e(a.rider).localeCompare(_e(r.rider),"de");break;case"spec1":s=qr(a.rider).localeCompare(qr(r.rider),"de");break;case"role":s=yt(a.rider).localeCompare(yt(r.rider),"de");break;case"overall":s=a.rider.overallRating-r.rider.overallRating;break;case"phase":s=(a.rider.seasonFormPhase??"neutral").localeCompare(r.rider.seasonFormPhase??"neutral","de");break;default:s=(((o=a.program)==null?void 0:o.name)??"").localeCompare(((d=r.program)==null?void 0:d.name)??"","de")}return s*t||_e(a.rider).localeCompare(_e(r.rider),"de")})}function qr(e){return e.specialization1!=null?sa(e.specialization1):"–"}async function Wo(e){const t=St(e);c.selectedRaceParticipantsRaceId=e,h("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",h("race-participants-meta").textContent="Lade Programmfahrer ...",h("race-participants-body").innerHTML="",c.raceParticipants=[],qe("raceParticipants"),await jo()}async function jo(e=!1){const t=c.selectedRaceParticipantsRaceId;if(t==null)return;const a=St(t);e&&(h("race-participants-meta").textContent="Lade Programmfahrer ...");const r=await V.getRaceProgramParticipants(t);if(!r.success||!r.data){h("race-participants-meta").textContent="",h("race-participants-body").innerHTML=`<div class="results-empty">${S(r.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}c.raceParticipants=r.data,h("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",h("race-participants-meta").textContent=`${r.data.length} Programmfahrer · ${a?fr(a):""}`,h("race-participants-body").innerHTML=Jp(c.raceParticipants)}async function nr(e,t=null){let a=Va(e);if(!a&&c.stageEditorStageRows){const n=c.stageEditorStageRows.find(i=>i.stageId===e);n&&(a={race:{id:n.raceId,name:n.raceName,countryId:0,categoryId:0,isStageRace:!0,numberOfStages:1,startDate:"",endDate:"",prestige:0},stage:{id:n.stageId,raceId:n.raceId,stageNumber:n.stageNumber,date:"2026-01-01",profile:n.profile,startElevation:0,detailsCsvFile:"",distanceKm:n.distanceKm,elevationGainMeters:n.elevationGainMeters}})}if(!a)return;const r=await Up(e);if(!r){alert(c.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}c.selectedDashboardProfileStageId=e,h("stage-profile-title").textContent=`${a.race.name} · ${ya(a.stage)}`;const s=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";h("stage-profile-meta").textContent=`${oe(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?Gr(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?zr(a.stage.elevationGainMeters):"–"}${s}`,Bl(h("stage-profile-view"),r,a.stage.profile,br(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),qe("stageProfile")}function Xp(){h("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const s=Number(t.dataset.editStageRoster);if(!Number.isFinite(s))return;Dp(s);return}const a=e.target.closest("button[data-live-stage]");if(a){const s=Number(a.dataset.liveStage);if(!Number.isFinite(s))return;zo(s,!0);return}const r=e.target.closest("button[data-instant-stage]");if(r){const s=Number(r.dataset.instantStage);if(!Number.isFinite(s))return;_o(s)}}),h("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const s=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(s)&&Wo(s);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const r=Number(a.dataset.dashboardRaceId);Number.isFinite(r)&&Jr(r)}),h("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&nr(a)}),h("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const s=Number(t.dataset.riderProgramId);Number.isFinite(s)&&Fs(s);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const r=a.dataset.raceParticipantsSort;c.raceParticipantsSort.key===r?c.raceParticipantsSort.direction=c.raceParticipantsSort.direction==="asc"?"desc":"asc":c.raceParticipantsSort={key:r,direction:"asc"},jo()}),h("btn-advance-day").addEventListener("click",async()=>{await Oo()}),h("btn-auto-progress").addEventListener("click",()=>{Qp()})}async function Oo(){Me("Tag wird fortgeschrieben...");try{const e=await V.advanceDay();if(!e.success)return alert(`Tageswechsel fehlgeschlagen:
`+(e.error??"Unbekannter Fehler")),!1;if(c.currentSave&&e.data&&(c.currentSave.currentSeason=e.data.season),await Cs(),await Es(),we("teams")){const{refreshTeamsViewData:t}=await yi(async()=>{const{refreshTeamsViewData:a}=await Promise.resolve().then(()=>Np);return{refreshTeamsViewData:a}},void 0);await t()}return!0}catch(e){return alert("Unerwarteter Fehler beim Tageswechsel: "+e.message),!1}finally{$e()}}function Ps(){const e=document.getElementById("btn-auto-progress");e&&(ut?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function Qp(){ut?ir():Vo()}function Vo(){ut||(ci(!0),Ps(),eg())}function ir(){ut&&(ci(!1),c.autoProgressTargetDate=null,Ps())}async function eg(){var e,t;for(;ut;){const a=(e=c.gameState)==null?void 0:e.currentDate;if(c.autoProgressTargetDate&&a&&a>=c.autoProgressTargetDate){ir();break}const r=((t=c.gameStatus)==null?void 0:t.pendingStages)??[];let s=!1;if(r.length>0){const n=r[0];s=await _o(n.stageId,!0)}else s=await Oo();if(!s){ir();break}await new Promise(n=>setTimeout(n,100))}Ps()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&ut){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),ir()}});const da=50;function Ns(){return[...ks,...$s[c.riderMenuDetailPage]]}function Uo(e){return c.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${c.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function Yo(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=c.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </th>`}function ig(e,t){switch(c.riderTeamEditorSort.key){case"riderId":return e.riderId-t.riderId;case"firstName":return se(e.firstName,t.firstName);case"lastName":return se(e.lastName,t.lastName);case"countryId":return e.countryId-t.countryId;case"birthYear":return e.birthYear-t.birthYear;case"teamName":return se(Vn(e.teamId),Vn(t.teamId));case"overallRating":return e.overallRating-t.overallRating;case"skillFlat":return e.skillFlat-t.skillFlat;case"skillMountain":return e.skillMountain-t.skillMountain;case"skillMediumMountain":return e.skillMediumMountain-t.skillMediumMountain;case"skillHill":return e.skillHill-t.skillHill;case"skillTimeTrial":return e.skillTimeTrial-t.skillTimeTrial;case"skillPrologue":return e.skillPrologue-t.skillPrologue;case"skillCobble":return e.skillCobble-t.skillCobble;case"skillSprint":return e.skillSprint-t.skillSprint;case"skillAcceleration":return e.skillAcceleration-t.skillAcceleration;case"skillDownhill":return e.skillDownhill-t.skillDownhill;case"skillAttack":return e.skillAttack-t.skillAttack;case"skillStamina":return e.skillStamina-t.skillStamina;case"skillResistance":return e.skillResistance-t.skillResistance;case"skillRecuperation":return e.skillRecuperation-t.skillRecuperation;case"favoriteRaces":return se(e.favoriteRaces,t.favoriteRaces);case"nonFavoriteRaces":return se(e.nonFavoriteRaces,t.nonFavoriteRaces);default:return 0}}function og(e){const t=c.riderTeamEditorSort.direction==="asc"?1:-1;return[...e].sort((a,r)=>(ig(a,r)||se(a.lastName,r.lastName)||se(a.firstName,r.firstName)||a.riderId-r.riderId)*t)}function lg(e){const t=c.riderTeamEditorSelectedTeamKey;if(!t)return[];const a=e.riders.filter(r=>et(r.teamId)===t);return og(a)}function dg(e){const t=c.riderTeamEditorPayload;return t?t.teams.map(a=>`<option value="${et(a.teamId)}"${a.teamId===e?" selected":""}>${S(a.name)}</option>`).join(""):'<option value="free-agents">Free Agents</option>'}function qo(e){return c.riderTeamEditorDirtyRiderIds.includes(e)}function cg(e,t){const a=qo(e.riderId)?" rider-team-editor-input-dirty":"";switch(t.inputType){case"readonly":return`<td><span class="skill-value" style="color:${rs(e.overallRating)}">${Math.round(e.overallRating)}</span></td>`;case"team":return`<td><select class="rider-team-editor-input${a}" data-rider-team-editor-field="teamId" data-rider-team-editor-rider-id="${e.riderId}">${dg(e.teamId)}</select></td>`;case"number":{const r=e[t.key];return`<td><input type="number" class="rider-team-editor-input${a}" data-rider-team-editor-field="${t.key}" data-rider-team-editor-rider-id="${e.riderId}" value="${r}"></td>`}case"text":{const r=String(e[t.key]??"");return`<td><input type="text" class="rider-team-editor-input${a}" data-rider-team-editor-field="${t.key}" data-rider-team-editor-rider-id="${e.riderId}" value="${S(r)}"></td>`}default:return"<td>–</td>"}}function ug(e){const t=[...e.teams].sort((a,r)=>a.rank-r.rank||se(a.name,r.name));return`
    ...
    </aside>`}function He(){var o;const e=h("rider-team-editor-root"),t=h("rider-team-editor-meta"),a=c.riderTeamEditorPayload;if(!a){e.innerHTML='<div class="results-empty">Editor wird geladen.</div>',t.textContent="Masterdaten aus riders.csv bearbeiten.";return}const r=c.riderTeamEditorSelectedTeamKey?a.teams.find(d=>et(d.teamId)===c.riderTeamEditorSelectedTeamKey)??null:null,s=lg(a),n=c.riderTeamEditorDirtyRiderIds.length,i=r==null?"Kein Team gewählt":`${r.riderCount} Fahrer · Ø ${r.averageOverall!=null?r.averageOverall.toFixed(1).replace(".",","):"–"} · Rang #${r.rank}`;t.textContent=r==null?"Masterdaten aus riders.csv bearbeiten. Fahrer werden erst nach Teamauswahl geladen.":`${r.name} · ${i}`,e.innerHTML=`
    <div class="rider-team-editor-layout">
      ...
      ${ug(a)}
    </div>`}function mg(e){const a=e.teams.filter(i=>!i.isFreeAgents).map(i=>({teamId:i.teamId,name:i.name,abbreviation:i.abbreviation,divisionName:i.divisionName,isFreeAgents:!1})).map(i=>{const o=e.riders.filter(l=>l.teamId===i.teamId),d=o.length===0?null:Math.round(o.reduce((l,p)=>l+p.overallRating,0)/o.length*100)/100;return{...i,riderCount:o.length,averageOverall:d,rank:0}}),r=e.riders.filter(i=>i.teamId==null);a.push({teamId:null,name:"Free Agents",abbreviation:"FA",divisionName:"Free Agents",riderCount:r.length,averageOverall:r.length===0?null:Math.round(r.reduce((i,o)=>i+o.overallRating,0)/r.length*100)/100,rank:0,isFreeAgents:!0});const s=[...a].sort((i,o)=>{const d=i.averageOverall??-1;return(o.averageOverall??-1)-d||o.riderCount-i.riderCount||se(i.name,o.name)}),n=new Map(s.map((i,o)=>[et(i.teamId),o+1]));return a.map(i=>({...i,rank:n.get(et(i.teamId))??a.length}))}async function Xo(e=!1){if(c.riderTeamEditorPayload&&!e){He();return}h("rider-team-editor-root").innerHTML='<div class="results-empty">Editor wird geladen.</div>';const t=await V.getRiderTeamEditor();if(!t.success||!t.data){h("rider-team-editor-root").innerHTML=`<div class="results-empty">${S(t.error??"Editor konnte nicht geladen werden.")}</div>`;return}c.riderTeamEditorPayload=t.data,c.riderTeamEditorDirtyRiderIds=[],c.riderTeamEditorSaving=!1,c.riderTeamEditorExporting=!1,c.riderTeamEditorSelectedTeamKey&&(t.data.teams.some(r=>et(r.teamId)===c.riderTeamEditorSelectedTeamKey)||(c.riderTeamEditorSelectedTeamKey="")),He()}function pg(e,t,a){const r=c.riderTeamEditorPayload;if(!r)return;const s=r.riders.find(n=>n.riderId===e);s&&(t==="teamId"?s.teamId=a==="free-agents"?null:Number.parseInt(a,10):typeof s[t]=="number"?s[t]=Number.parseInt(a||"0",10):s[t]=a,s.overallRating=ag(s),r.teams=mg(r),c.riderTeamEditorDirtyRiderIds.includes(e)||(c.riderTeamEditorDirtyRiderIds=[...c.riderTeamEditorDirtyRiderIds,e]),He())}async function gg(){if(!c.riderTeamEditorPayload||c.riderTeamEditorSaving)return;c.riderTeamEditorSaving=!0,He();const e=await V.saveRiderTeamEditor({riders:c.riderTeamEditorPayload.riders});if(c.riderTeamEditorSaving=!1,!e.success||!e.data){alert(`Editor konnte nicht gespeichert werden:
${e.error??"Unbekannter Fehler"}`),He();return}c.riderTeamEditorPayload=e.data,c.riderTeamEditorDirtyRiderIds=[],He()}async function fg(){if(!c.riderTeamEditorPayload||c.riderTeamEditorExporting)return;c.riderTeamEditorExporting=!0,He();const e=await V.exportRiderTeamEditor({riders:c.riderTeamEditorPayload.riders});if(c.riderTeamEditorExporting=!1,!e.success||!e.data){alert(`riders.csv konnte nicht exportiert werden:
${e.error??"Unbekannter Fehler"}`),He();return}Kr(e.data.fileName,e.data.content),He()}function hg(){h("view-rider-team-editor").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-team-editor-sort]");if(t){const s=t.dataset.riderTeamEditorSort;c.riderTeamEditorSort.key===s?c.riderTeamEditorSort.direction=c.riderTeamEditorSort.direction==="asc"?"desc":"asc":c.riderTeamEditorSort={key:s,direction:rg(s)},He();return}const a=e.target.closest("button[data-rider-team-editor-team-filter]");if(a){c.riderTeamEditorSelectedTeamKey=a.dataset.riderTeamEditorTeamFilter??"",He();return}const r=e.target.closest("button[data-rider-team-editor-action]");if(r){const s=r.dataset.riderTeamEditorAction;if(s==="reload"){Xo(!0);return}if(s==="export"){fg();return}s==="save"&&gg()}}),h("view-rider-team-editor").addEventListener("change",e=>{const t=e.target.closest("#rider-team-editor-team-select");if(t){c.riderTeamEditorSelectedTeamKey=t.value,He();return}const a=e.target.closest(".rider-team-editor-input");if(a){const r=Number(a.dataset.riderTeamEditorRiderId),s=a.dataset.riderTeamEditorField;Number.isFinite(r)&&s&&pg(r,s,a.value)}})}let st={key:"pickNumber",asc:!0};function Un(e){const t=Math.max(0,Math.min(1,(e-50)/35)),a=Math.round(6+t*118),r=.26+t*.18,s=.14+t*.12;return`--rider-stats-pill-hue:${a};--rider-stats-pill-border-alpha:${r};--rider-stats-pill-bg-alpha:${s};`}async function Qo(e,t=!1){const a=await V.getDraftHistory(e);if(!a.success){c.draftHistory=null,we("draft")&&Xr(),!t&&a.error&&alert(`Draft Historie konnte nicht geladen werden:
`+a.error);return}c.draftHistory=a.data??null,we("draft")&&Xr()}function Xr(){const e=h("draft-table-container"),t=h("draft-season-select");if(!c.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(t.options.length===0){const i=c.currentSave.startSeason??2026;for(let o=c.currentSave.currentSeason;o>=i;o--){const d=document.createElement("option");d.value=o.toString(),d.textContent=`Saison ${o}`,t.appendChild(d)}c.draftSelectedSeason||(c.draftSelectedSeason=c.currentSave.currentSeason),t.value=c.draftSelectedSeason.toString(),t.onchange=o=>{const d=o.target;c.draftSelectedSeason=parseInt(d.value,10),Qo(c.draftSelectedSeason)}}if(!c.draftHistory){e.innerHTML='<div class="alert alert-info">Lade Draft Historie...</div>';return}if(c.draftHistory.rows.length===0){e.innerHTML='<div class="alert alert-info">Keine Draft-Einträge für diese Saison vorhanden.</div>';return}const a=[...c.draftHistory.rows].sort((i,o)=>{let d=0;const l=st.key;return l==="riderLastName"?d=i.riderLastName.localeCompare(o.riderLastName):l==="teamName"?d=i.teamName.localeCompare(o.teamName):l==="oldTeamName"?d=(i.oldTeamName||"").localeCompare(o.oldTeamName||""):l==="countryCode"?d=i.countryCode.localeCompare(o.countryCode):d=(i[l]??0)-(o[l]??0),st.asc?d:-d}),r=i=>st.key!==i?'<span class="sort-icon-placeholder"></span>':st.asc?" ▲":" ▼",s=i=>{st.key===i?st.asc=!st.asc:(st.key=i,st.asc=!0),Xr()};window.setDraftSort=s;let n=`
  ...
  `;for(const i of a){const o=c.draftHistory.season-i.riderBirthYear;let d="-";i.oldTeamName&&(d=`<div style="display:flex; align-items:center; gap:0.5rem;">${Ft(i.oldTeamId,i.oldTeamName)} ${S(i.oldTeamName)}</div>`);const l=`<div style="display:flex; align-items:center; gap:0.5rem;">${Ft(i.teamId,i.teamName)} ${S(i.teamName)}</div>`;n+=`
    ...
    `}n+="</tbody></table>",e.innerHTML=n}async function bg(e=!1){const t=await V.getInjuries();if(!t.success){c.injuries=null,we("injuries")&&Yn(),!e&&t.error&&alert(`Verletzungen konnten nicht geladen werden:
`+t.error);return}c.injuries=t.data??[],we("injuries")&&Yn()}function Yn(){const e=h("injuries-table-container");if(!c.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(h("injuries-meta").textContent=c.injuries.length+" Ausfälle",c.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=Zt;let t="";const a=c.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),r=new Map;for(const n of a){const i=n.teamId;r.has(i)||r.set(i,[]),r.get(i).push(n)}for(const n of r.keys())r.get(n).sort((i,o)=>o.overallRating-i.overallRating);const s=Array.from(r.keys()).sort((n,i)=>{const o=r.get(n)[0].teamAbbreviation||"",d=r.get(i)[0].teamAbbreviation||"";return o.localeCompare(d)});if(s.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of s){const i=r.get(n),o=i[0].teamAbbreviation;t+=`
      ...
      `;for(const d of i){const l=d.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let p="";if(d.fitDate){const u=oe(d.fitDate);if(d.missedRaces&&d.missedRaces.length>0){let m="";for(const f of d.missedRaces)m+=`
        ...
        `}t+="</tbody></table></div>"}e.innerHTML=t}function Zn(e){return e===0?"–":`-${e}`}function vg(e){return e.length===0?'<div class="season-standings-country-popover-empty">Noch keine Fahrer mit Saisonpunkten.</div>':`
    ...
    </div>`}function Sg(e,t){const a=t.filter(r=>r.teamId!=null&&e.teamId!=null&&r.teamId===e.teamId).slice(0,30);return a.length===0?'<div class="season-standings-country-popover-empty">Noch keine Fahrer mit Saisonpunkten.</div>':`
    <div class="season-standings-country-popover-card">
      <div class="season-standings-country-popover-head">
      ...
      `).join("")}
    </div>`}function kg(e,t){return`
    <div class="season-standings-country-anchor" tabindex="0">
      <span class="season-standings-country-name">${it(e.teamName,e.teamId,!1)}</span>
      <div class="season-standings-country-popover">
        ${Sg(e,t)}
      </div>
    </div>`}async function $g(e){const t=await V.getSeasonStandings();if(!t.success){c.seasonStandings=null,we("season-standings")&&Qr();return}c.seasonStandings=t.data??null,we("season-standings")&&Qr()}function Qr(){var g,b,v,y,T,M;const e=h("season-standings-meta"),t=h("season-standings-scope-tabs"),a=h("season-standings-empty"),r=h("season-standings-table"),s=h("season-standings-tbody"),n=h("season-standings-jersey-header"),i=h("season-standings-primary-header"),o=h("season-standings-flag-header"),d=h("season-standings-secondary-header"),l=((g=c.seasonStandings)==null?void 0:g.season)??((b=c.gameState)==null?void 0:b.season)??((v=c.currentSave)==null?void 0:v.currentSeason)??null;e.textContent=l!=null?`Saison ${l} · Ergebnis- und Trikotpunkte kumuliert`:"Noch keine Saisonwertung geladen.",t.innerHTML=`
    <button
      type="button"
  ...
  `;const p=c.selectedSeasonStandingScope==="countries",u=p?((y=c.seasonStandings)==null?void 0:y.countryStandings)??[]:c.selectedSeasonStandingScope==="teams"?((T=c.seasonStandings)==null?void 0:T.teamStandings)??[]:((M=c.seasonStandings)==null?void 0:M.riderStandings)??[],m=p?u:[],f=p?[]:u;if(n.textContent="Trikot",i.textContent=p?"Land":c.selectedSeasonStandingScope==="teams"?"Team":"Fahrer",o.textContent="Flagge",d.textContent=c.selectedSeasonStandingScope==="teams"?"Land":"Team",n.classList.toggle("hidden",p),d.classList.toggle("hidden",p),!c.seasonStandings||u.length===0){s.innerHTML="",r.classList.add("hidden"),a.classList.remove("hidden"),a.textContent="Noch keine Saisonpunkte vorhanden.";return}s.innerHTML=p?m.map(x=>`
      <tr>
        ...
        <tr>
          ...
          <td>${x.points}</td>
          <td>${S(Zn(x.gapPoints))}</td>
        </tr>`}).join(""),a.classList.add("hidden"),r.classList.remove("hidden")}function xg(){h("season-standings-scope-tabs").addEventListener("click",e=>{const t=e.target.closest("button[data-season-scope]");if(!t)return;const a=t.dataset.seasonScope;a!=="riders"&&a!=="teams"&&a!=="countries"||(c.selectedSeasonStandingScope=a,Qr())})}function Jn(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?0:t.includes("grand tour")?1:t.includes("monument")?2:t.includes("stage race high")?3:t.includes("one day high")?4:t.includes("stage race middle")?5:t.includes("one day middle")?6:t.includes("stage race low")?7:t.includes("one day low")?8:9}function Tg(e){const t=l=>l.skills.mountain*.7+l.skills.timeTrial*.3,a=l=>l.skills.sprint*.7+l.skills.acceleration*.3,r=[...e].map(l=>({rider:l,score:t(l)})).sort((l,p)=>p.score-l.score).slice(0,10),s=[...e].map(l=>({rider:l,score:a(l)})).sort((l,p)=>p.score-l.score).slice(0,10),n=[...e].map(l=>({rider:l,score:l.skills.mountain})).sort((l,p)=>p.score-l.score).slice(0,10),i=[...e].map(l=>({rider:l,score:l.skills.hill})).sort((l,p)=>p.score-l.score).slice(0,10),o=[...e].map(l=>({rider:l,score:l.skills.cobble})).sort((l,p)=>p.score-l.score).slice(0,10),d=[...e].map(l=>({rider:l,score:l.skills.attack})).sort((l,p)=>p.score-l.score).slice(0,10);return{Gesamtklassement:r,Sprinter:s,Bergfahrer:n,Hügelspezialist:i,Pflasterspezialist:o,Angreifer:d}}function wg(e,t){const a=c.riders.filter(o=>o.activeTeamId===e);if(a.length===0)return 0;const r=o=>o.skills.mountain*.7+o.skills.timeTrial*.3,s=o=>o.skills.sprint*.7+o.skills.acceleration*.3;let n=[];t==="Gesamtklassement"?n=a.map(o=>r(o)):t==="Sprinter"?n=a.map(o=>s(o)):t==="Bergfahrer"?n=a.map(o=>o.skills.mountain):t==="Hügelspezialist"?n=a.map(o=>o.skills.hill):t==="Pflasterspezialist"?n=a.map(o=>o.skills.cobble):t==="Angreifer"&&(n=a.map(o=>o.skills.attack)),n.sort((o,d)=>d-o);const i=n.slice(0,8);return i.length===0?0:i.reduce((o,d)=>o+d,0)/i.length}function Mg(e,t){var i;const r=c.teams.filter(o=>o.division==="WorldTour"||o.divisionName==="WorldTour").map(o=>({teamId:o.id,avgScore:wg(o.id,t)}));r.sort((o,d)=>d.avgScore-o.avgScore);const s=r.findIndex(o=>o.teamId===e)+1,n=((i=r.find(o=>o.teamId===e))==null?void 0:i.avgScore)??0;return{rank:s,total:r.length,average:n}}function Rg(e){const t=c.riders.filter(s=>s.activeTeamId===e);if(t.length===0)return 0;const a=t.map(s=>s.overallRating??0);a.sort((s,n)=>n-s);const r=a.slice(0,10);return r.length===0?0:r.reduce((s,n)=>s+n,0)/r.length}function Ig(e){var n;const a=c.teams.filter(i=>i.division==="WorldTour"||i.divisionName==="WorldTour").map(i=>({teamId:i.id,avgScore:Rg(i.id)}));a.sort((i,o)=>o.avgScore-i.avgScore);const r=a.findIndex(i=>i.teamId===e)+1,s=((n=a.find(i=>i.teamId===e))==null?void 0:n.avgScore)??0;return{rank:r,total:a.length,average:s}}function Aa(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-200)",bg:"rgba(255, 255, 255, 0.05)"}}function Lr(e){e.countryCode&&de(e.countryCode);const t=Tg(e.riders),a=[...e.riders].map(l=>({rider:l,formValue:l.formBonus+l.raceFormBonus})).sort((l,p)=>p.formValue-l.formValue).slice(0,10),r=[...e.riders].map(l=>({rider:l,uciRank:rr(l.id)})).filter(l=>l.uciRank!==null).sort((l,p)=>l.uciRank-p.uciRank).slice(0,10),s=Object.entries(t).map(([l,p])=>{const u=Mg(e.teamId,l),m=u.average.toFixed(1).replace(".",","),f=p.map(({rider:g,score:b})=>{const v=`${g.firstName.charAt(0)}. ${g.lastName}`,y=De(v,{riderId:g.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),T=g.nationality?Ze[g.nationality]??g.nationality.slice(0,2).toLowerCase():null,M=T?`<span class="fi fi-${T} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(g.nationality)}"></span>`:"",x=c.riders.find(I=>I.id===g.id);return`
    ...
    `}).join(""),o=a.map(({rider:l,formValue:p})=>{const u=`${l.firstName.charAt(0)}. ${l.lastName}`,m=De(u,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=l.nationality?Ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",b=(p>=0?"+":"")+p.toFixed(1).replace(".",","),v=`S-Form: ${l.formBonus>=0?"+":""}${l.formBonus.toFixed(1)} / R-Form: ${l.raceFormBonus>=0?"+":""}${l.raceFormBonus.toFixed(1)}`,y=c.riders.find(M=>M.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
  ...
  `}function Dr(){return`
    ...
    </div>`}function Cg(e){const t=Array.from(new Set(e.topResults.map(m=>m.raceCategoryName).filter(Boolean)));t.sort((m,f)=>m.localeCompare(f,"de"));const a=Array.from(new Set(e.topResults.map(m=>m.season))).sort((m,f)=>f-m);let r=e.topResults.filter(m=>m.rowType!=="stage_result"?m.rowType==="gc_final"?c.teamStatsTopResultsFilters.gc:m.rowType==="mountain_final"?c.teamStatsTopResultsFilters.mountain:m.rowType==="points_final"?c.teamStatsTopResultsFilters.points:m.rowType==="youth_final"?c.teamStatsTopResultsFilters.youth:!0:m.profile==="TTT"||m.isStageRace||m.stageNumber!=null?c.teamStatsTopResultsFilters.stage:c.teamStatsTopResultsFilters.oneDay);if(c.teamStatsTopResultsFilterCategory){const m=c.teamStatsTopResultsFilterCategory;if(m.endsWith("-etappen")){const f=m.substring(0,m.length-8);r=r.filter(g=>g.raceCategoryName===f&&g.rowType==="stage_result")}else if(m.endsWith("-gc")){const f=m.substring(0,m.length-3);r=r.filter(g=>g.raceCategoryName===f&&g.rowType!=="stage_result")}else r=r.filter(f=>f.raceCategoryName===m)}c.teamStatsTopResultsFilterSeason!=null&&(r=r.filter(m=>m.season===c.teamStatsTopResultsFilterSeason)),r.sort((m,f)=>{if(f.seasonPoints!==m.seasonPoints)return f.seasonPoints-m.seasonPoints;const g=m.rowType!=="stage_result",b=f.rowType!=="stage_result",v=m.resultRank??9999,y=f.resultRank??9999;if(c.teamStatsTopResultsFilterCategory)return v!==y?v-y:g!==b?g?-1:1:0;{const T=Jn(m.raceCategoryName),M=Jn(f.raceCategoryName);return T!==M?T-M:g!==b?g?-1:1:v-y}});const s=20,n=Math.max(1,Math.min(10,Math.ceil(r.length/s)));c.teamStatsTopResultsPage>n&&(c.teamStatsTopResultsPage=n);const i=(c.teamStatsTopResultsPage-1)*s,o=r.slice(i,i+s),l=`
    <div class="rider-stats-top-results-filters" style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; align-items: center; flex-wrap: wrap; background: rgba(255, 255, 255, 0.03); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.05);">
      <div class="form-group" style="margin: 0; display: flex; align-items: center;">
        <label style="margin-right: 0.5rem; font-weight: 600; white-space: nowrap; color: #ccc;">Rennklasse:</label>
  ...
  `}function Fg(e){var s;const t=((s=c.gameState)==null?void 0:s.season)??new Date().getFullYear(),a=[...e.riders].sort((n,i)=>{const o=n.contractEndSeason??9999,d=i.contractEndSeason??9999;return o!==d?o-d:i.overallRating-n.overallRating});return`
  ...
  `}function qn(e){return e>=85?"#22c55e":e>=78?"#86efac":e>=72?"#fbbf24":e>=66?"#fb923c":e>=60?"#f87171":"#94a3b8"}function Mt(e){return c.teamStatsTab==="career"?`
    ...
    ${Dr()}
    ${Cg(e)}
  `}function Pg(e,t){var r;if(e==null)return'<span class="results-team-jersey-placeholder" style="width: 54px; height: 54px; display: inline-block;" aria-hidden="true"></span>';const a=t??((r=c.teams.find(s=>s.id===e))==null?void 0:r.name)??`Team ${e}`;return`
    <span class="results-team-jersey large-jersey" title="${S(a)}" aria-label="${S(a)}" style="width: 54px; height: 54px; display: inline-block;">
      ...
      >
    </span>`}async function el(e){c.teamStatsSelectedTeamId=e,c.teamStatsTab="topResults",c.teamStatsTopResultsFilterCategory=null,c.teamStatsTopResultsFilterSeason=null,c.teamStatsSelectedSeason="all",c.teamStatsTopResultsPage=1;const t=c.teams.find(n=>n.id===e);h("team-stats-title").innerHTML=t?`Team <strong>${S(t.name)}</strong>`:"Teamstatistik",h("team-stats-jersey").innerHTML=Pg(e,(t==null?void 0:t.name)??"");const a=Ig(e),r=a.average.toFixed(2).replace(".",",");h("team-stats-meta").innerHTML=t?`${S(t.abbreviation)} · ${S(t.divisionName||t.division||"–")} · <strong>Overall-Stärke (Top 10):</strong> Platz ${a.rank}/${a.total} (Ø ${r})`:"Daten werden geladen",h("team-stats-body").innerHTML=`
    <section class="rider-stats-placeholder">
  ...
  `,qe("teamStats");const s=await V.getTeamStats(e);if(c.teamStatsSelectedTeamId===e){if(!s.success||!s.data){h("team-stats-body").innerHTML=`
    ...
    `;let l="",p=1;for(const g of i){const b=p++,y=`<span class="badge ${b===1?"badge-primary":b<=3?"badge-secondary":"badge-ghost"}" style="min-width: 28px; text-align: center; display: inline-block;">${b}</span>`,T=Ft(g.teamId,g.teamName);let M="";if(o){const $=g.stageNumber!=null?`Etappe ${g.stageNumber}`:"–";M=`<td style="vertical-align: middle;">${S(g.raceName??"–")} · ${S($)} · ${S(String(g.season??"–"))}</td>`}let x="";if(d)if(g.lieutenantDetails){const $=g.lieutenantDetails,I=$.leaderNationality?de($.leaderNationality):"",C=$.leaderRoleName?` (${$.leaderRoleName})`:"";x=`
        ...
        `}else x='<td style="vertical-align: middle;">–</td>';if(Ht==="riders"){const $=g.nationality?de(g.nationality):"—",I=`<a href="#" onclick="event.preventDefault(); openRiderStatsFromLeaderboard(${g.riderId})" style="color: #60a5fa; text-decoration: none; font-weight: bold; hover: text-decoration: underline;">${S(g.firstName)} ${S(g.lastName)}</a>`,C=g.teamAbbr?`<span class="text-muted" title="${S(g.teamName??"")}">${S(g.teamAbbr)}</span>`:"—";l+=`
        <tr>
      ...
      `}else{let $="";if(g.leadoutDetails){const I=g.leadoutDetails,C=I.sprinterNationality?de(I.sprinterNationality):"";$=`
      ...
      `}}r.innerHTML=l}let Vt=2026,ze=5,Xn=!1;const zg=["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"];function Qn(e){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`}function Kg(e){var s;const t=(s=c.gameState)==null?void 0:s.currentDate;if(!t||e<=t)return;const a=oe(e);confirm(`Möchtest du automatisch bis zum ${a} simulieren?`)&&(c.autoProgressTargetDate=e,Vo())}function Wg(e,t){const a=[],r=new Date(e,t,1),s=new Date(e,t+1,0);let i=(r.getDay()+6)%7;const o=new Date(r);o.setDate(o.getDate()-i);const d=new Date(o);for(;d<=s||d.getDay()!==1;){const l=[];for(let p=0;p<7;p++)l.push(new Date(d)),d.setDate(d.getDate()+1);a.push(l)}return a}function jg(){if(Xn)return;Xn=!0,h("calendar-prev-month").addEventListener("click",()=>{ze--,ze<0&&(ze=11,Vt--),Wa()}),h("calendar-next-month").addEventListener("click",()=>{ze++,ze>11&&(ze=0,Vt++),Wa()}),h("calendar-today-btn").addEventListener("click",()=>{var t;if((t=c.gameState)!=null&&t.currentDate){const[a,r]=c.gameState.currentDate.split("-").map(Number);Vt=a,ze=r-1}Wa()}),h("calendar-race-search").addEventListener("input",()=>{al()}),h("calendar-weeks").addEventListener("click",t=>{const a=t.target.closest(".calendar-event-bar");if(a){const s=Number(a.dataset.raceId);Number.isFinite(s)&&Jr(s);return}const r=t.target.closest("[data-calendar-date]");if(r){const s=r.dataset.calendarDate;s&&Kg(s)}}),h("calendar-races-tbody").addEventListener("click",t=>{const a=t.target.closest(".dashboard-race-link");if(a){const s=Number(a.dataset.dashboardRaceId);Number.isFinite(s)&&Jr(s);return}const r=t.target.closest("button[data-dashboard-race-participants-id]");if(r){const s=Number(r.dataset.dashboardRaceParticipantsId);Number.isFinite(s)&&Wo(s)}});const e=document.querySelector(".calendar-layout-container");e&&(e.addEventListener("mouseenter",t=>{const a=t.target.closest("[data-race-id]");if(a){const r=a.dataset.raceId;r&&document.querySelectorAll(`[data-race-id="${r}"]`).forEach(s=>{s.classList.add("calendar-highlight")})}},!0),e.addEventListener("mouseleave",t=>{const a=t.target.closest("[data-race-id]");if(a){const r=a.dataset.raceId;r&&document.querySelectorAll(`[data-race-id="${r}"]`).forEach(s=>{s.classList.remove("calendar-highlight")})}},!0))}function Og(){var e;if((e=c.gameState)!=null&&e.currentDate){const[t,a]=c.gameState.currentDate.split("-").map(Number);Vt=t,ze=a-1}Wa()}function Wa(){var s;if(!we("calendar"))return;h("calendar-month-label").textContent=`${zg[ze]} ${Vt}`;const e=Wg(Vt,ze),t=h("calendar-weeks"),a=((s=c.gameState)==null?void 0:s.currentDate)??"";let r="";for(const n of e){const i=n.map(Qn),o=[];for(const u of c.races)if(u.startDate<=i[6]&&u.endDate>=i[0]){const m=u.startDate<i[0]?0:i.indexOf(u.startDate),f=u.endDate>i[6]?6:i.indexOf(u.endDate);o.push({race:u,startIdx:m,endIdx:f})}o.sort((u,m)=>{const f=u.endIdx-u.startIdx+1,g=m.endIdx-m.startIdx+1;return g!==f?g-f:u.startIdx-m.startIdx});const d=Array.from({length:3},()=>Array(7).fill(!1));for(const u of o){let m=2;for(let f=0;f<3;f++){let g=!0;for(let b=u.startIdx;b<=u.endIdx;b++)if(d[f][b]){g=!1;break}if(g){m=f;break}}for(let f=u.startIdx;f<=u.endIdx;f++)d[m][f]=!0;u.slot=m}const l=n.map(u=>{const m=Qn(u),f=u.getMonth()!==ze,g=m===a,b=m>a;return`
      ...
      `}).join(""),p=o.map(u=>{var M;const m=u.race,f=a>=m.startDate&&a<=m.endDate,g=a>m.endDate,b=ct((M=m.category)==null?void 0:M.name),v=f?'<span class="calendar-live-dot"></span>':"",y=g?"opacity: 0.55;":"",T=u.endIdx-u.startIdx+1;return`
    ...
    `}t.innerHTML=r,al()}function al(){var n;const e=h("calendar-race-search"),t=e?e.value.toLowerCase().trim():"",a=h("calendar-races-tbody"),r=((n=c.gameState)==null?void 0:n.currentDate)??"",s=c.races.filter(i=>{var o;return t?i.name.toLowerCase().includes(t)||((o=i.category)==null?void 0:o.name)&&i.category.name.toLowerCase().includes(t):!0}).sort((i,o)=>i.startDate.localeCompare(o.startDate));if(s.length===0){a.innerHTML='<tr><td colspan="9" class="text-muted" style="text-align: center; padding: 20px;">Keine Rennen gefunden.</td></tr>';return}a.innerHTML=s.map(i=>{var v,y,T,M;const o=r>=i.startDate&&r<=i.endDate,l=r>i.endDate?'<span class="badge badge-done">Abgeschlossen</span>':o?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',p=((v=i.country)==null?void 0:v.name)??`Land ${i.countryId}`,u=(y=i.country)!=null&&y.code3?de(i.country.code3):"",m=i.isStageRace?(i.stages??[]).reduce((x,$)=>x+($.distanceKm??0),0):((T=i.upcomingStage)==null?void 0:T.distanceKm)??null,f=i.isStageRace?(i.stages??[]).reduce((x,$)=>x+($.elevationGainMeters??0),0):((M=i.upcomingStage)==null?void 0:M.elevationGainMeters)??null,g=m!=null?String(m.toFixed(1)).replace(".",","):"-",b=f!=null?String(Math.round(f)):"-";return`
    ...
    `}).join("")}let ht=null,bt=null,Ke="id",ca=!0;function vr(e){const t=new Date(e);t.setUTCDate(t.getUTCDate()+4-(t.getUTCDay()||7));const a=new Date(Date.UTC(t.getUTCFullYear(),0,1));return Math.ceil(((t.getTime()-a.getTime())/864e5+1)/7)}function yr(e,t){if(t>=e.peak1_min&&t<=e.peak1_max||t>=e.peak2_min&&t<=e.peak2_max||t>=e.peak3_min&&t<=e.peak3_max)return"peak";const r=n=>{const i=n-8,o=n-1;if(i>=1)return t>=i&&t<=o;{const d=i+53;return t>=d||t<=o}};return r(e.peak1_min)||r(e.peak2_min)||r(e.peak3_min)?"prep":"none"}function rl(e){return e==="peak"?"cell-peak":e==="prep"?"cell-prep":""}function ei(e,t){const a=new Date(t.start_date),r=new Date(t.end_date);for(let s=new Date(a);s<=r;s.setDate(s.getDate()+1)){const n=s.getFullYear(),i=String(s.getMonth()+1).padStart(2,"0"),o=String(s.getDate()).padStart(2,"0"),d=`${n}-${i}-${o}`,l=vr(d),p=yr(e,l);if(p==="peak"||p==="prep")return!0}return!1}function Vg(e,t){const a=c.raceProgramsPayload;if(!a)return;const r=a.raceProgramRaces.findIndex(s=>s.program_id===e&&s.race_id===t);if(r===-1){const s=a.races.find(n=>n.id===t);if(s){const n=s.start_date,i=s.end_date,o=[];a.raceProgramRaces.forEach((d,l)=>{if(d.program_id===e&&d.race_id!==t){const p=a.races.find(u=>u.id===d.race_id);p&&p.start_date<=i&&p.end_date>=n&&o.push(l)}}),o.sort((d,l)=>l-d).forEach(d=>{a.raceProgramRaces.splice(d,1)})}a.raceProgramRaces.push({program_id:e,race_id:t})}else a.raceProgramRaces.splice(r,1);c.raceProgramsDirty=!0,Fe()}const es=(()=>{const e=[],t=new Date(2026,0,1),a=new Date(2026,11,31),r=["So","Mo","Di","Mi","Do","Fr","Sa"];for(let s=new Date(t);s<=a;s.setDate(s.getDate()+1)){const n=s.getFullYear(),i=String(s.getMonth()+1).padStart(2,"0"),o=String(s.getDate()).padStart(2,"0"),d=`${n}-${i}-${o}`,l=`${r[s.getDay()]}, ${o}.${String(s.getMonth()+1).padStart(2,"0")}`;e.push({dateStr:d,label:l,weekNum:vr(d)})}return e})();async function _s(e=!1){if(c.raceProgramsPayload&&!e){Fe();return}h("race-programs-root").innerHTML='<div class="results-empty">Programmdaten werden geladen...</div>';const t=await V.getRaceProgramsEditor();if(!t.success||!t.data){h("race-programs-root").innerHTML=`<div class="results-empty text-danger">${S(t.error??"Fehler beim Laden.")}</div>`;return}c.raceProgramsPayload=t.data,c.raceProgramsDirty=!1,c.raceProgramsSaving=!1,ht=null,bt=null,Fe()}function Ug(){h("view-race-programs").addEventListener("click",e=>{const t=e.target,a=t.closest(".results-type-btn[data-tab]");if(a){const u=a.dataset.tab??"calendar-cols";c.raceProgramsActiveTab=u,Fe();return}const r=t.closest(".race-programs-action-btn");if(r){const u=r.dataset.action;u==="reload"?_s(!0):u==="save"&&qg();return}const s=t.closest(".race-row-expand-btn");if(s){const u=s.dataset.raceId,m=h(`race-details-row-${u}`);m&&(m.classList.toggle("hidden"),s.textContent=m.classList.contains("hidden")?"▶":"▼");return}const n=t.closest(".program-row-expand-btn");if(n){const u=n.dataset.programId,m=h(`program-details-row-${u}`);m&&(m.classList.toggle("hidden"),n.textContent=m.classList.contains("hidden")?"▶":"▼");return}const i=t.closest(".program-roles-sort-header");if(i){const u=i.dataset.sortKey;Ke===u?ca=!ca:(Ke=u,ca=u==="name"||u==="id"),Fe();return}const o=t.closest(".combo-origin-trigger");if(o){const u=o.dataset.raceId,m=o.dataset.comboKey,f=h(`combo-origin-${u}-${m}`);f&&f.classList.toggle("hidden");return}const d=t.closest(".race-popover-trigger");if(d){e.stopPropagation();const u=parseInt(d.dataset.raceId??"0",10);bt=null,ht===u?ht=null:ht=u,Fe();return}const l=t.closest(".race-rider-count-trigger");if(l){e.stopPropagation();const u=parseInt(l.dataset.raceId??"0",10);ht=null,bt===u?bt=null:bt=u,Fe();return}const p=t.closest(".popover-program-toggle");if(p){if(e.stopPropagation(),p.classList.contains("disabled"))return;const u=parseInt(p.dataset.programId??"0",10),m=parseInt(p.dataset.raceId??"0",10);Vg(u,m);return}!t.closest(".race-stages-popover-card")&&!t.closest(".race-rider-programs-popover-card")&&(ht!==null||bt!==null)&&(ht=null,bt=null,Fe())}),h("view-race-programs").addEventListener("click",e=>{const t=e.target.closest(".toggleable-race-cell[data-day]");if(!t)return;const a=t.dataset.day,r=parseInt(t.dataset.programId,10);Jg(r,a)}),h("view-race-programs").addEventListener("change",e=>{const t=e.target;if(t.classList.contains("peak-date-picker")){const a=parseInt(t.dataset.programId,10),r=parseInt(t.dataset.peak,10),s=t.value;if(s){const n=vr(s);Zg(a,r,n)}return}if(t.classList.contains("peak-number-input")){const a=parseInt(t.dataset.programId,10),r=t.dataset.field,s=parseInt(t.value||"1",10);Yg(a,r,s)}})}function Yg(e,t,a){const r=c.raceProgramsPayload;if(!r)return;const s=r.programs.find(i=>i.id===e);if(!s)return;const n=Math.max(1,Math.min(53,a));if(s[t]=n,t.endsWith("_min")){const i=t.replace("_min","_max");s[i]<n&&(s[i]=n)}else if(t.endsWith("_max")){const i=t.replace("_max","_min");s[i]>n&&(s[i]=n)}c.raceProgramsDirty=!0,Fe()}function Zg(e,t,a){const r=c.raceProgramsPayload;if(!r)return;const s=r.programs.find(o=>o.id===e);if(!s)return;const n=`peak${t}_min`,i=`peak${t}_max`;s[n]=Math.max(1,a-2),s[i]=Math.min(53,a+2),c.raceProgramsDirty=!0,Fe()}function Jg(e,t){const a=c.raceProgramsPayload;if(!a)return;const r=a.races.filter(n=>n.start_date<=t&&n.end_date>=t);if(r.length===0)return;const s=a.raceProgramRaces.findIndex(n=>n.program_id===e&&r.some(i=>i.id===n.race_id));if(s===-1)a.raceProgramRaces.push({program_id:e,race_id:r[0].id});else{const n=a.raceProgramRaces[s],i=r.findIndex(o=>o.id===n.race_id);i<r.length-1?n.race_id=r[i+1].id:a.raceProgramRaces.splice(s,1)}c.raceProgramsDirty=!0,Fe()}async function qg(){if(!c.raceProgramsPayload||c.raceProgramsSaving)return;c.raceProgramsSaving=!0,Fe();const e=await V.saveRaceProgramsEditor({programs:c.raceProgramsPayload.programs,raceProgramRaces:c.raceProgramsPayload.raceProgramRaces});if(c.raceProgramsSaving=!1,!e.success){alert(`Fehler beim Speichern:
${e.error??"Unbekannter Fehler"}`),Fe();return}c.raceProgramsDirty=!1,_s(!0)}function Sr(e,t){let a=0,r=0,s=0;const n=new Set(t.raceProgramRaces.filter(o=>o.program_id===e.id).map(o=>o.race_id)),i=t.races.filter(o=>n.has(o.id));for(const o of i){const d=new Date(o.start_date),l=new Date(o.end_date);for(let p=new Date(d);p<=l;p.setDate(p.getDate()+1)){const u=p.getFullYear(),m=String(p.getMonth()+1).padStart(2,"0"),f=String(p.getDate()).padStart(2,"0"),g=vr(`${u}-${m}-${f}`),b=yr(e,g);b==="peak"?a++:b==="prep"?r++:s++}}return{peak:a,prep:r,none:s}}function Fe(){const e=h("race-programs-root"),t=c.raceProgramsPayload;if(!t){e.innerHTML='<div class="results-empty">Keine Daten geladen.</div>';return}const a=window.scrollX,r=window.scrollY,s={},n=document.querySelector(".team-detail-table-scroll");n&&(s.table={scrollTop:n.scrollTop,scrollLeft:n.scrollLeft}),document.querySelectorAll(".popover-program-list-scroll").forEach(f=>{const g=f.getAttribute("data-race-id");g&&(s[`popover-${g}`]={scrollTop:f.scrollTop,scrollLeft:f.scrollLeft})});const o=c.raceProgramsDirty,d=c.raceProgramsSaving,l=c.raceProgramsActiveTab;let p=`
  ...
  `;l==="calendar-cols"?p+=Xg(t):l==="calendar-rows"?p+=Qg(t):l==="peak-editor"?p+=ef(t):l==="rider-role"?p+=af(t):l==="program-roles"&&(p+=sf(t)),p+="</div>",e.innerHTML=p;const u=document.querySelector(".team-detail-table-scroll");u&&s.table&&(u.scrollTop=s.table.scrollTop,u.scrollLeft=s.table.scrollLeft),document.querySelectorAll(".popover-program-list-scroll").forEach(f=>{const g=f.getAttribute("data-race-id");g&&s[`popover-${g}`]&&(f.scrollTop=s[`popover-${g}`].scrollTop,f.scrollLeft=s[`popover-${g}`].scrollLeft)}),window.scrollTo(a,r)}function Xg(e){var o,d,l;const t=e.programs,a=e.raceProgramRaces,r=e.races,s=t.map(p=>({id:p.id,stats:Sr(p,e)}));let n=`<tr>
  ...
  `;for(const p of t){const u=(o=s.find(m=>m.id===p.id))==null?void 0:o.stats;n+=`
    ...
    `}n+="</tr>";let i="";for(const p of es){const u=r.filter(v=>v.start_date<=p.dateStr&&v.end_date>=p.dateStr),m=u.length>0,f=m?"row-has-races":"";let g="";if(m){g='<div style="display: flex; flex-direction: column; gap: 0.15rem; margin-top: 0.15rem;">';for(const v of u){const y=ct((d=v.category)==null?void 0:d.name);g+=`
    ...
    `;for(const v of t){const y=yr(v,p.weekNum),T=rl(y),M=a.find(C=>C.program_id===v.id&&u.some(E=>E.id===C.race_id));let x="",$=`toggleable-race-cell ${T}`,I=`data-day="${p.dateStr}" data-program-id="${v.id}"`;if(M){const C=r.find(P=>P.id===M.race_id),E=ct((l=C==null?void 0:C.category)==null?void 0:l.name);x=`
        ...
        `}else m?x='<span class="race-cell-placeholder" title="Klicken zum Zuweisen">＋</span>':($=T,I="");b+=`<td class="${$}" ${I} style="text-align: center; vertical-align: middle;">${x}</td>`}i+=`<tr>${b}</tr>`}return`
  ...
  `}function Qg(e){var f;const t=e.programs,a=e.raceProgramRaces,r=e.races;let s='<th class="sticky-col-header" style="z-index: 15;">Monat</th>',n='<th class="sticky-col-header" style="z-index: 15;">Tag / KW</th>',i='<th class="sticky-col-header" style="z-index: 15;">Rennen Anzahl</th>',o='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #1</th>',d='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #2</th>',l='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #3</th>';const p=[],u=["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"];for(const g of es){const b=parseInt(g.dateStr.split("-")[1],10)-1,v=u[b];p.length===0||p[p.length-1].name!==v?p.push({name:v,span:1}):p[p.length-1].span++;const y=r.filter(I=>I.start_date<=g.dateStr&&I.end_date>=g.dateStr),T=y.length>0,M=T?`${y.length} R`:"",x=T?"race-count-active":"";n+=`<th style="text-align: center; min-width: 40px; font-variant-numeric: tabular-nums;">
    ...
    </th>`,i+=`<th class="${x}" style="text-align: center; font-size: 0.72rem; font-weight: bold;">${M}</th>`;const $=I=>{var L;const C=y[I];if(!C)return"";const E=ct((L=C.category)==null?void 0:L.name),P=a.filter(A=>A.race_id===C.id).length;return`
...
Zugelassene Programme: ${P}">
      ...
      `};o+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${$(0)}</th>`,d+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${$(1)}</th>`,l+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${$(2)}</th>`}for(const g of p)s+=`<th colspan="${g.span}" style="text-align: center; font-weight: bold; border-left: 1px solid var(--border);">${g.name}</th>`;let m="";for(const g of t){const b=Sr(g,e);let v=`
    ...
    `;for(const y of es){const T=yr(g,y.weekNum),M=rl(T),x=r.filter(L=>L.start_date<=y.dateStr&&L.end_date>=y.dateStr),$=x.length>0,I=a.find(L=>L.program_id===g.id&&x.some(A=>A.id===L.race_id));let C="",E=`toggleable-race-cell ${M}`,P=`data-day="${y.dateStr}" data-program-id="${g.id}"`;if(I){const L=r.find(G=>G.id===I.race_id),A=ct((f=L==null?void 0:L.category)==null?void 0:f.name);C=`
          <span class="race-id-badge" style="background-color: ${A.background}; border: 1px solid ${A.border}; color: ${A.color};" title="${S(L==null?void 0:L.name)}">
            R${L==null?void 0:L.id}
          </span>
        `}else $?C='<span style="font-size: 0.72rem; color: var(--text-500); opacity: 0.5;">＋</span>':(E=M,P="");v+=`<td class="${E}" ${P} style="text-align: center; vertical-align: middle; padding: 0.35rem 0;">${C}</td>`}m+=`<tr>${v}</tr>`}return`
    <div class="team-detail-card" style="margin-top: 1rem;">
  ...
  `).join("");return{countHtml:n,stagesListHtml:i}}function af(e){const t=[...e.races].sort((i,o)=>i.start_date.localeCompare(o.start_date)),a=e.raceProgramRaces,r=e.stages,s=e.programDistribution;return`
    <div class="team-detail-card" style="margin-top: 1rem; position: relative;">
      <div class="team-detail-table-scroll" style="max-height: 75vh;">
        <table class="data-table">
          ...
          <tbody>
            ${t.map(i=>{const o=new Set(a.filter(R=>R.race_id===i.id).map(R=>R.program_id)),d=s.filter(R=>o.has(R.program_id)),u=e.programs.map(R=>{const N=a.some(xt=>xt.program_id===R.id&&xt.race_id===i.id),H=s.find(xt=>xt.program_id===R.id),Z=H?parseInt(H.deterministic_rider_count||"0",10):0,ie=H?parseInt(H.deterministic_role_Kapitaen||"0",10):0,pe=H?parseInt(H.deterministic_role_Co_Kapitaen||"0",10):0,fe=H?parseInt(H.deterministic_role_Edelhelfer||"0",10):0,be=H?parseInt(H.deterministic_role_Starke_Helfer||"0",10):0,ye=H?parseInt(H.deterministic_role_Wassertraeger||"0",10):0,ve=H?parseInt(H.deterministic_role_Sprinter||"0",10):0,Se=[];ie>0&&Se.push(`${ie} Kapitän`),pe>0&&Se.push(`${pe} Co-Kapitän`),fe>0&&Se.push(`${fe} Edelhelfer`),be>0&&Se.push(`${be} Starke Helfer`),ye>0&&Se.push(`${ye} Wasserträger`),ve>0&&Se.push(`${ve} Sprinter`);const at=Se.length>0?`(${Se.join(", ")})`:"",te=Sr(R,e),pt=te.peak+te.prep+te.none;return{program:R,isAssigned:N,count:Z,rolesStr:at,totalDays:pt}}).sort((R,N)=>N.count-R.count).filter(R=>ei(R.program,i)||R.isAssigned).map(R=>{const N=R.program,H=ei(N,i);let Z="";H||(Z='<span style="color: #fb923c; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(251, 146, 60, 0.15); border: 1px solid #fb923c; border-radius: 50%; font-size: 0.65rem;" title="Dieses Rennen liegt außerhalb der Peak- und Aufbauphase dieses Programms!">!</span>');let ie="";if(!R.isAssigned){const at=a.filter(te=>te.program_id===N.id&&te.race_id!==i.id).map(te=>e.races.find(pt=>pt.id===te.race_id)).filter(te=>te&&te.start_date<=i.end_date&&te.end_date>=i.start_date);if(at.length>0){const te=at.map(pt=>pt.name).join(", ");ie=`<span style="color: #ef4444; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(239, 68, 68, 0.15); border: 1px solid #ef4444; border-radius: 50%; font-size: 0.65rem;" title="Kollision: Dieses Programm ist bereits einem zeitlich parallelen Rennen zugewiesen: ${S(te)}!">!</span>`}}const pe=R.isAssigned?"font-weight: bold; color: var(--text-100);":"color: var(--text-500);",fe=R.isAssigned?"☑":"☐",be=H||R.isAssigned,ye=be?"cursor: pointer;":"cursor: not-allowed; opacity: 0.4; pointer-events: none;";return`
        <div class="popover-program-toggle${be?"":" disabled"}" data-program-id="${N.id}" data-race-id="${i.id}" 
          ...
          <div style="display: flex; align-items: center; gap: 0.5rem; flex: 1; min-width: 0; overflow: hidden;">
            <span style="font-size: 1.15rem; line-height: 1; user-select: none; color: ${R.isAssigned?"var(--accent-h)":"var(--text-500)"};">${fe}</span>
            <span style="${pe} font-size: 0.85rem; overflow: hidden; text-overflow: ellipsis;" title="${S(N.name)} (${R.totalDays} Renntage)">
              ${S(N.name)} (${R.totalDays} RT)
            </span>
            ${Z}
            ${ie}
          </div>
      ...
      `}).join(""),m=bt===i.id;let f=0,g=0,b=0,v=0,y=0,T=0,M=0;const x={Kapitaen:{},Co_Kapitaen:{},Sprinter:{},Edelhelfer:{},Starke_Helfer:{},Wassertraeger:{}},$=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],I=["Berg","Hill","Sprint","Timetrial","Cobble","Attacker"];for(const R of d){f+=parseInt(R.deterministic_rider_count||"0",10),g+=parseInt(R.deterministic_role_Kapitaen||"0",10),b+=parseInt(R.deterministic_role_Co_Kapitaen||"0",10),v+=parseInt(R.deterministic_role_Sprinter||"0",10),y+=parseInt(R.deterministic_role_Edelhelfer||"0",10),T+=parseInt(R.deterministic_role_Starke_Helfer||"0",10),M+=parseInt(R.deterministic_role_Wassertraeger||"0",10);for(const N of $)for(const H of I){const Z=`deterministic_${N}_spec1_${H}`,ie=parseInt(R[Z]||"0",10);x[N][H]=(x[N][H]||0)+ie}}let C=0;i.is_stage_race===1&&(C=r.filter(N=>N.race_id===i.id).filter(N=>{const H=(N.profile||"").toLowerCase();return H==="flat"||H==="rolling"}).length);let E=!1,P=0;if(i.is_stage_race===0){const R=r.find(H=>H.race_id===i.id),N=((R==null?void 0:R.profile)||"").toLowerCase();E=N==="cobble"||N==="cobble_hill",E&&(P=(e.roleSpecCombinations||[]).filter(Z=>o.has(Z.program_id)).filter(Z=>Z.spec1==="Cobble"||Z.spec2==="Cobble"||Z.spec3==="Cobble").reduce((Z,ie)=>Z+ie.count,0))}let L="<strong>Rennprogramme verwalten</strong>";i.is_stage_race===0&&E?L=`
        <strong>Rennprogramme verwalten 
          (<span style="color: ${P<20?"#ef4444":"var(--accent-h)"}; font-weight: bold;" title="Kopfsteinpflaster-Spezialisten: ${P} / min. 20">Gesamtfahrer: ${f}</span>)
        </strong>
      `:L=`<strong>Rennprogramme verwalten (Gesamtfahrer: ${f})</strong>`;const A=`
    ...
    `;let G="text-align: center; font-variant-numeric: tabular-nums;";i.is_stage_race===1&&C>=2&&(v<=7?G+=" background-color: rgba(239, 68, 68, 0.2); color: #ef4444; font-weight: bold;":v>7&&v<10&&(G+=" background-color: rgba(234, 179, 8, 0.2); color: #eab308; font-weight: bold;"));let K="position: relative; text-align: center; font-variant-numeric: tabular-nums; vertical-align: middle;",w="font-weight: bold; border: none; background: transparent; padding: 0.15rem 0.4rem; cursor: pointer; color: var(--accent-h); text-decoration: underline;";i.is_stage_race===0&&E&&P<20&&(K+=" background-color: rgba(239, 68, 68, 0.2);",w+=" color: #ef4444; font-weight: bold;");const B=`
      <button type="button" class="race-rider-count-trigger btn-link" data-race-id="${i.id}" 
              style="${w}">
        ${f}
      </button>
    `;let U="—";if(i.is_stage_race===0){const R=r.find(N=>N.race_id===i.id);U=(R==null?void 0:R.profile)??"Flat"}let W="",ne=`<strong>${S(i.name)}</strong>`;if(i.is_stage_race===1){const R=ht===i.id,{countHtml:N,stagesListHtml:H}=tf(i.id,r);W=`
      ...
      `}let q=["Berg","Hill","Sprint","Cobble","Timetrial","Attacker"];if(i.is_stage_race===0){const R=r.find(H=>H.race_id===i.id),N=((R==null?void 0:R.profile)??"").toLowerCase();N.includes("cobble")?q=["Cobble","Sprint","Hill","Attacker","Timetrial","Berg"]:(N.includes("flat")||N.includes("rolling"))&&(q=["Sprint","Timetrial","Attacker","Hill","Cobble","Berg"])}const ee=[],Y=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],j={Kapitaen:"Kapitän",Co_Kapitaen:"Co-Kapitän",Sprinter:"Sprinter",Edelhelfer:"Edelhelfer",Starke_Helfer:"Starke Helfer",Wassertraeger:"Wasserträger"},D={Berg:"Berg",Hill:"Hügel",Sprint:"Sprint",Cobble:"Cobble",Timetrial:"Timetrial",Attacker:"Attacker"},_=(e.roleSpecCombinations||[]).filter(R=>o.has(R.program_id)),F=new Map;for(const R of _){const N=R.spec2||"—",H=`${R.role}|${R.spec1}|${N}`;F.set(H,(F.get(H)||0)+R.count)}const O=[...F.entries()].map(([R,N])=>{const[H,Z,ie]=R.split("|");return{role:H,spec1:Z,spec2:ie,count:N}}).sort((R,N)=>{const H=Y.indexOf(R.role)-Y.indexOf(N.role);if(H!==0)return H;const Z=q.indexOf(R.spec1)-q.indexOf(N.spec1);return Z!==0?Z:N.count-R.count}),z=(R,N)=>{const H=D[R]??R,Z=N!=="—"?D[N]??N:"—";return`${H} / ${Z}`};for(const R of O)if(R.count>0){const N=R.spec1==="Berg"&&R.spec2==="Cobble"||R.spec1==="Cobble"&&R.spec2==="Berg",H=N?"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem; background: rgba(249, 115, 22, 0.12); color: #f97316;":"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem;",Z=N?"color: #f97316; font-weight: bold;":"color: var(--text-100);",ie=N?"color: #f97316; font-weight: bold;":"color: var(--accent-h);",pe=`${R.role}_${R.spec1}_${R.spec2.replace(/[^a-zA-Z0-9]/g,"_")}`,be=_.filter(ye=>ye.role===R.role&&ye.spec1===R.spec1&&(ye.spec2||"—")===R.spec2).map(ye=>{const ve=e.programs.find(Se=>Se.id===ye.program_id);return`<span style="white-space: nowrap; margin-right: 0.8rem;">${S((ve==null?void 0:ve.name)??"Unbekannt")}: <strong>${ye.count}</strong></span>`}).join(" ");ee.push(`
          <div style="${H}">
            <span style="${Z}">${j[R.role]||R.role} <span class="text-muted">(${z(R.spec1,R.spec2)})</span></span>
            <strong style="${ie} cursor: pointer; text-decoration: underline;" class="combo-origin-trigger" data-race-id="${i.id}" data-combo-key="${pe}">
              ${R.count} Fahrer
            </strong>
          </div>
  ...
  `}function sl(e){return Ke!==e?'<span style="opacity:0.35; margin-left:4px;">↕</span>':`<span style="color:var(--accent-h); margin-left:4px; font-weight:bold;">${ca?"↑":"↓"}</span>`}function nt(e,t,a=""){return`
    <th style="cursor: pointer; user-select: none; ${a}" class="program-roles-sort-header ${Ke===e?"sort-active":""}" data-sort-key="${e}">
      <div style="display: flex; align-items: center; justify-content: center; gap: 2px;">
        <span>${S(t)}</span>
        ${sl(e)}
      </div>
    </th>
  `}function rf(e,t,a=""){return`
    <th style="cursor: pointer; user-select: none; ${a}" class="program-roles-sort-header ${Ke===e?"sort-active":""}" data-sort-key="${e}">
  ...
  `}function sf(e){const t=e.programs,a=e.roleSpecCombinations||[],r={Kapitaen:"Kapitän",Co_Kapitaen:"Co-Kapitän",Sprinter:"Sprinter",Edelhelfer:"Edelhelfer",Starke_Helfer:"Starke Helfer",Wassertraeger:"Wasserträger"},s={Berg:"Berg",Hill:"Hügel",Sprint:"Sprint",Cobble:"Cobble",Timetrial:"Timetrial",Attacker:"Attacker"},n=t.map(o=>{const d=a.filter(f=>f.program_id===o.id);let l=0;const p={Kapitaen:0,Co_Kapitaen:0,Sprinter:0,Edelhelfer:0,Starke_Helfer:0,Wassertraeger:0};for(const f of d)l+=f.count,p[f.role]!==void 0&&(p[f.role]+=f.count);const u=Sr(o,e),m=u.peak+u.prep+u.none;return{program:o,totalRiders:l,roleCounts:p,progCombos:d,raceDays:m}});n.sort((o,d)=>{let l=0;return Ke==="id"?l=o.program.id-d.program.id:Ke==="name"?l=o.program.name.localeCompare(d.program.name):Ke==="total"?l=o.totalRiders-d.totalRiders:Ke==="raceDays"?l=o.raceDays-d.raceDays:l=(o.roleCounts[Ke]||0)-(d.roleCounts[Ke]||0),l===0&&(l=o.program.id-d.program.id),ca?l:-l});const i=n.map(o=>{const d=o.program,l=o.progCombos,p=o.totalRiders,u=o.roleCounts,m=o.raceDays,f=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],g=["Berg","Hill","Sprint","Cobble","Timetrial","Attacker"],b=new Map;for(const x of l){const $=x.spec2||"—",I=`${x.role}|${x.spec1}|${$}`;b.set(I,(b.get(I)||0)+x.count)}const v=[...b.entries()].map(([x,$])=>{const[I,C,E]=x.split("|");return{role:I,spec1:C,spec2:E,count:$}}).sort((x,$)=>{const I=f.indexOf(x.role)-f.indexOf($.role);if(I!==0)return I;const C=g.indexOf(x.spec1)-g.indexOf($.spec1);return C!==0?C:$.count-x.count}),y=(x,$)=>{const I=s[x]??x,C=$!=="—"?s[$]??$:"—";return`${I} / ${C}`},T=[];for(const x of v)if(x.count>0){const $=x.spec1==="Berg"&&x.spec2==="Cobble"||x.spec1==="Cobble"&&x.spec2==="Berg",I=$?"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem; background: rgba(249, 115, 22, 0.12); color: #f97316;":"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem;",C=$?"color: #f97316; font-weight: bold;":"color: var(--text-100);",E=$?"color: #f97316; font-weight: bold;":"color: var(--accent-h);",P=`${x.role}_${x.spec1}_${x.spec2.replace(/[^a-zA-Z0-9]/g,"_")}`;T.push(`
          <div style="${I}">
            <span style="${C}">${r[x.role]||x.role} <span class="text-muted">(${y(x.spec1,x.spec2)})</span></span>
            <strong style="${E} cursor: pointer; text-decoration: underline;" class="combo-origin-trigger" data-race-id="prog-${d.id}" data-combo-key="${P}">
              ${x.count} Fahrer
            </strong>
          </div>
          <div id="combo-origin-prog-${d.id}-${P}" class="hidden" style="padding: 0.25rem 0.75rem; font-size: 0.75rem; color: var(--text-400); background: rgba(0, 0, 0, 0.18); border-left: 2px solid var(--accent-h); text-align: left; line-height: 1.4;">
  ...
  `}window.openTeamStats=el;async function nl(){var e;for(let t=localStorage.length-1;t>=0;t--){const a=localStorage.key(t);a&&(a.startsWith("programAssignmentsLogged_")||a.startsWith("participantCountsLogged_"))&&localStorage.removeItem(a)}as("game"),h("meta-career").textContent=((e=c.currentSave)==null?void 0:e.careerName)??"",Dt("dashboard"),Me("Spiel wird geladen…");try{await Cs(),await Es(),hr()}catch(t){alert("Fehler beim Laden des Spiels: "+t.message)}finally{$e()}}function nf(){document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{var a;const t=e.dataset.view??"";Dt(t),t==="dashboard"&&hr(),t==="teams"&&sr(),t==="riders"&&sr(),t==="rider-team-editor"&&Xo(),t==="live-race"&&Ot(),t==="results"&&Ie(),t==="draft"&&Qo(c.draftSelectedSeason||((a=c.currentSave)==null?void 0:a.currentSeason)||2026),t==="injuries"&&bg(),t==="season-standings"&&$g(),t==="leaderboards"&&Dg(),t==="calendar"&&Og(),t==="race-programs"&&_s(),(t==="stage-editor-stages"||t==="stage-editor-climbs")&&ho()})}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-rider-link[data-rider-id]");if(!t)return;const a=Number(t.dataset.riderId);Number.isFinite(a)&&Zt(a)}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-team-link[data-team-id]");if(!t)return;const a=Number(t.dataset.teamId);Number.isFinite(a)&&el(a)}),h("btn-cancel-new").addEventListener("click",()=>Ue("newCareer")),h("btn-close-race-stages").addEventListener("click",()=>Ue("raceStages")),h("btn-close-stage-profile").addEventListener("click",()=>Ue("stageProfile")),h("btn-close-rider-program").addEventListener("click",()=>Ue("riderProgram")),h("btn-close-rider-stats").addEventListener("click",()=>Ue("riderStats")),h("btn-close-team-stats").addEventListener("click",()=>Ue("teamStats")),h("btn-close-race-participants").addEventListener("click",()=>Ue("raceParticipants")),h("btn-close-roster-editor").addEventListener("click",()=>Zr()),h("btn-cancel-roster-editor").addEventListener("click",()=>Zr()),h("btn-apply-roster-editor").addEventListener("click",()=>{_p()}),h("btn-back-menu").addEventListener("click",()=>{ra==null||ra.pause(),as("menu"),ga()}),Tl(),Xp(),jg(),No(),Jo(),hg(),Ap(),Ep(),Qm(),fp(),Ng(),xg(),Lg(),Ug()}(async()=>($m(),me(),nf(),as("menu"),await ga()))();
