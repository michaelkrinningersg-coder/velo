(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();function Bn(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ys(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function Qt(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function Za(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function Ee(e,t={}){const a=t.strong===!1?"span":"strong",s=ys("app-rider-link-label",t.labelClassName),r=`<${a} class="${s}">${Bn(e)}</${a}>`;if(t.riderId==null)return r;const n=['type="button"','class="'+ys("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${r}</button>`}function nt(e,t,a=!0,s=""){const r=a===!1?"span":"strong",n=`<${r} class="app-team-link-label">${Bn(e)}</${r}>`;return t==null?n:`<button type="button" class="${ys("app-team-link",s)}" data-team-id="${t}">${n}</button>`}const d={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,draftHistory:null,injuries:null,draftSelectedSeason:null,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1};let jt=null;function _o(e){jt=e}let Bs=!1;function Tr(e){Bs=e}let _n=null;function xr(e){_n=e}let vs=null;function Mr(e){vs=e}let at=!1;function _s(e){at=e}function h(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function se(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function Pa(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),s=Math.floor(e%60),r=String(a).padStart(2,"0"),n=String(s).padStart(2,"0");return t>0?`${t}:${r}:${n}`:`${a}:${n}`}function ns(e){return e==null||e===0?"–":`+${Pa(e)}`}const wa=2,Ss=3,Gn=4;function Hn(e){return`/jersey/Jer_${e}.png`}function vt(e,t){var s;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((s=d.teams.find(r=>r.id===e))==null?void 0:s.name)??`Team ${e}`;return`
  ...
  `).join("")}async function Zo(e){ve("Karriere wird geladen…");const t=await H.loadSave(e);if(ge(),!t.success){alert("Fehler beim Laden: "+t.error);return}d.currentSave=t.data??null,await Bo()}async function Jo(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;ve("Löschen…");const a=await H.deleteSave(e);if(ge(),!a.success){alert("Fehler: "+a.error);return}await ea()}async function qo(){const e=await H.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){h("btn-delete-all-careers").classList.add("hidden"),h("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){ve("Alle Karrieren werden gelöscht…");try{for(const a of t){const s=await H.deleteSave(a.filename);if(!s.success){alert(`Fehler beim Löschen von "${a.careerName}": ${s.error??"Unbekannter Fehler"}`);break}}}finally{ge()}await ea()}}function Xo(){h("btn-new-career").addEventListener("click",async()=>{var r;Jt("new-career-error"),h("input-career-name").value="";const a=h("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',je("newCareer");const s=await H.getAvailableTeams();if(!s.success||!((r=s.data)!=null&&r.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=s.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),h("btn-cancel-new").addEventListener("click",()=>ze("newCareer")),h("btn-confirm-new").addEventListener("click",async()=>{const a=h("input-career-name").value.trim(),s=h("input-team-id").value;if(!a||!s){ht("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const r=Number(s),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;Jt("new-career-error"),ve("Neue Karriere wird erstellt…");const o=await H.createSave(i,a,r);if(!o.success){ge(),ht("new-career-error",o.error??"Unbekannter Fehler.");return}const c=await H.loadSave(i);if(ge(),ze("newCareer"),!c.success){alert("Fehler: "+c.error);return}d.currentSave=c.data??null,await Bo()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>ea());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{qo()}),h("saves-list").addEventListener("click",async a=>{const s=a.target.closest("button[data-save-action]");if(!s)return;const{saveAction:r,filename:n,careerName:i}=s.dataset;if(n){if(r==="load"){await Zo(n);return}r==="delete"&&await Jo(n,i??n)}})}const Qo="modulepreload",el=function(e){return"/"+e},Er={},Vn=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));r=Promise.allSettled(a.map(c=>{if(c=el(c),c in Er)return;Er[c]=!0;const l=c.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":Qo,l||(u.as="script"),u.crossOrigin="",u.href=c,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((m,f)=>{u.addEventListener("load",m),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})},tl={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function al(e){const t=tl[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const sl=200;function zs(e){if(e.length===0)return[];const t=[];for(const a of e){const s=t[t.length-1];if(!s||Math.abs(s.distanceMeter-a.distanceMeter)>=sl){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}s.riderIds.push(...a.riderIds),s.riderCount+=a.riderCount,s.distanceSum+=a.distanceMeter*a.riderCount,s.distanceMeter=s.distanceSum/s.riderCount}return t.map(({distanceSum:a,...s})=>s)}function Ks(e){if(e.length===0)return[];let t=0;for(let r=1;r<e.length;r+=1)e[r].riderCount>e[t].riderCount&&(t=r);let a=0,s=0;return e.map((r,n)=>{const i=n===t;let o;return i?o="P":n<t?(a+=1,o=`E${a}`):(s+=1,o=`A${s}`),{...r,label:o,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-r.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,r.distanceMeter-e[n+1].distanceMeter):null}})}function rl(e,t=null){var a,s,r;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((s=e.find(n=>n.label==="P"))==null?void 0:s.label)??((r=e[0])==null?void 0:r.label)??null}function ct(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function Fr(e,t,a,s){return`${s.type}:${e}:${t}:${a}`}function nl(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:ct(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function Ye(e){const t=[];e.segments.forEach((r,n)=>{const i=n*2;(r.start_markers??[]).forEach((o,c)=>{t.push({key:Fr(n,"start",c,o),label:"",marker:o,kmMark:r.start_km,elevation:r.start_elevation,boundary:"start",sequence:i+c/100})}),(r.end_markers??[]).forEach((o,c)=>{t.push({key:Fr(n,"end",c,o),label:"",marker:o,kmMark:r.end_km,elevation:r.end_elevation,boundary:"end",sequence:i+1+c/100})})});const a=t.sort((r,n)=>r.kmMark-n.kmMark||r.sequence-n.sequence),s=new Map;return a.map(r=>{const n=(s.get(r.marker.type)??0)+1;return s.set(r.marker.type,n),{...r,label:r.marker.name??nl(r.marker,n)}})}function il(e){const t=Ye(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>ct(a)).length}}function Lt(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ol(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function Ae(e,t,a,s){return t<=0?s:s+e/t*(a-s*2)}function Da(e,t){const a=t/1e3,s=e.points;if(a<=s[0].kmMark)return s[0].elevation;for(let r=0;r<s.length-1;r+=1){const n=s[r],i=s[r+1];if(a>i.kmMark)continue;const o=Math.max(1e-4,i.kmMark-n.kmMark),c=(a-n.kmMark)/o;return n.elevation+(i.elevation-n.elevation)*c}return s[s.length-1].elevation}function Un(e){const t=e.points.map(p=>p.elevation),a=Math.min(...t),s=Math.max(...t),r=Math.max(1,s-a),n=Math.max(40,r*.08),i=Math.max(0,a-n),o=s+n;let c=Math.floor(i/50)*50,l=Math.ceil(o/50)*50;return l<=c&&(l=c+100),{axisMinElevation:c,axisMaxElevation:l}}function Oe(e,t,a,s,r,n){const i=Math.max(1,a-t);return s-n-(e-t)/i*(s-r-n)}function Vt(e){return`${Math.round(e)} m`}function Cr(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function Nr(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function Yn(e,t,a,s,r,n,i,o,c){var g;const l=[],p=[];let u=null,m="#b91c1c";for(const b of Ye(e)){const{marker:y,kmMark:v,elevation:x}=b;if(y.type==="climb_start"){p.push({kmMark:v,elevation:x,name:y.name});continue}if(ct(y)){let w=-1;for(let I=p.length-1;I>=0;I-=1)if(y.name&&((g=p[I])==null?void 0:g.name)===y.name){w=I;break}const T=w>=0?p.splice(w,1)[0]:p.pop();T&&Math.max(0,v-T.kmMark),T&&Math.max(0,x-T.elevation);const $=Nr(y.cat,y.type),R=Cr(y.cat);if(y.type==="finish_hill"||y.type==="finish_mountain"){u=y.cat??null,m=$.accentColor;continue}l.push({x:Ae(v*1e3,t,a,s),anchorY:Oe(x,o,c,r,n,i),primaryLabel:R??"Berg",secondaryLabel:Vt(x),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:$.accentColor});continue}if(y.type==="sprint_intermediate"){const w=Nr(y.cat,y.type);l.push({x:Ae(v*1e3,t,a,s),anchorY:Oe(x,o,c,r,n,i),primaryLabel:"Sprint",secondaryLabel:Vt(x),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:w.accentColor})}}const f=e.points[e.points.length-1];return l.push({x:Ae(f.kmMark*1e3,t,a,s),anchorY:Oe(f.elevation,o,c,r,n,i),primaryLabel:u?`${Cr(u)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:Vt(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:m}),l.sort((b,y)=>b.x-y.x)}function Zn(e,t,a){const s=t+4,r=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
    ...
    </g>`}function Jn(e,t){const a=new Set,s=t/1e3;for(let r=0;r<=s;r+=25)a.add(Math.round(r*1e3));return a.add(Math.round(t)),[...a].filter(r=>r>=0&&r<=t).sort((r,n)=>r-n)}function qn(e,t,a,s,r,n){const i=new Set(Ye(t).map(o=>Math.round(o.kmMark*1e3)));return e.map(o=>{const c=Ae(o,a,s,r),p=i.has(o)?18:12,u=n+p+26;return`
      <g class="race-sim-distance-tick">
        ...
        <text x="${c.toFixed(1)}" y="${u.toFixed(1)}" text-anchor="middle" class="race-sim-grid-label">${Lt(ol(o))}</text>
      </g>`}).join("")}function ll(e,t,a,s,r,n,i,o,c,l,p){const u=Ae(e.distanceMeter,a,s,n),m=Da(t,e.distanceMeter),f=Oe(m,c,l,r,i,o),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),b=e.riderCount>1?`<text x="${u.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${b}
    </g>`}function dl(e,t,a,s,r,n,i,o,c,l,p){const u=new Map(p.riders.map(f=>[f.id,f])),m=new Map((p.teams??[]).map(f=>[f.id,f.abbreviation]));return e.filter(f=>f.riderCount===1).map(f=>{const g=f.riderIds[0];if(g==null)return"";const b=u.get(g);if(!b)return"";const y=Ae(f.distanceMeter,a,s,n),v=Da(t,f.distanceMeter),x=Oe(v,c,l,r,i,o),w=b.activeTeamId!=null?m.get(b.activeTeamId)??"":"",T=`${b.lastName} (${w})`,$=x-34,R=x-40;return`
        <g class="race-sim-itt-rider-label-group">
          ...
          <text x="${y.toFixed(1)}" y="${R.toFixed(1)}" text-anchor="middle" class="race-sim-marker-detail">${Lt(T)}</text>
        </g>`}).join("")}function cl(e,t,a,s,r,n,i,o,c,l,p){const u=Math.max(0,Math.min(l,e.distanceKm)),m=Math.max(0,Math.min(p,e.distanceKm));if(m<=u)return null;const f=[{kmMark:u,elevation:Da(e,u*1e3)},...e.points.filter(x=>x.kmMark>u&&x.kmMark<m),{kmMark:m,elevation:Da(e,m*1e3)}];if(f.length<2)return null;const g=r-i,b=f.map((x,w)=>{const T=Ae(x.kmMark*1e3,t,a,s),$=Oe(x.elevation,o,c,r,n,i);return`${w===0?"M":"L"} ${T.toFixed(1)} ${$.toFixed(1)}`}).join(" "),y=Ae(u*1e3,t,a,s),v=Ae(m*1e3,t,a,s);return`${b} L ${v.toFixed(1)} ${g.toFixed(1)} L ${y.toFixed(1)} ${g.toFixed(1)} Z`}function ul(e,t,a,s,r={}){const p=e.distanceKm*1e3,{axisMinElevation:u,axisMaxElevation:m}=Un(e),f=533,g=12,y=e.points.map(I=>{const C=Ae(I.kmMark*1e3,p,1584,28),E=Oe(I.elevation,u,m,634,168,101);return{x:C,y:E}}).map((I,C)=>`${C===0?"M":"L"} ${I.x.toFixed(1)} ${I.y.toFixed(1)}`).join(" "),v=`${y} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,x=r.selectedClimbRange!=null?cl(e,p,1584,28,634,168,101,u,m,r.selectedClimbRange.startKm,r.selectedClimbRange.endKm):null,w=Yn(e,p,1584,28,634,168,101,u,m).map(I=>Zn(I,g,f)).join(""),$=Array.from({length:5},(I,C)=>u+(m-u)/4*C).map(I=>{const C=Oe(I,u,m,634,168,101);return`
    ...
    <svg viewBox="0 0 1584 634" role="img" aria-label="${Lt(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
    ...
    </svg>`}function ml(e,t,a,s,r){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${ul(t,a,s,!1,r)}</div>`}function pl(e,t,a,s,r,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const o=1584,c=634,l=28,p=168,u=101,{axisMinElevation:m,axisMaxElevation:f}=Un(t),g=c-u,b=12,y=Array.from({length:5},(B,M)=>m+(f-m)/4*M),v=zs(a.clusters),x=Ks(v),w=Jn(t,a.stageDistanceMeters),$=t.points.map(B=>{const M=Ae(B.kmMark*1e3,a.stageDistanceMeters,o,l),N=Oe(B.elevation,m,f,c,p,u);return{x:M,y:N}}).map((B,M)=>`${M===0?"M":"L"} ${B.x.toFixed(1)} ${B.y.toFixed(1)}`).join(" "),R=`${$} L ${(o-l).toFixed(1)} ${g.toFixed(1)} L ${l.toFixed(1)} ${g.toFixed(1)} Z`,I=Yn(t,a.stageDistanceMeters,o,l,c,p,u,m,f).map(B=>Zn(B,b,g)).join(""),C=y.map(B=>{const M=Oe(B,m,f,c,p,u);return`
      ...
      <text x="${(l-14).toFixed(1)}" y="${(M+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Vt(B)}</text>`}).join(""),E=qn(w,t,a.stageDistanceMeters,o,l,g),P=new Map(v.map((B,M)=>[B,x[M]??null])),D=v.map(B=>{var M;return ll(B,t,a.stageDistanceMeters,o,c,l,p,u,m,f,((M=P.get(B))==null?void 0:M.label)===i)}).join(""),_=r.stage.profile==="ITT"?dl(v,t,a.stageDistanceMeters,o,c,l,p,u,m,f,r):"";e.innerHTML=`
    ...
    <div class="race-sim-favorites-column">
      ${n.map(i=>`
        <article class="race-sim-favorite-item${(()=>{const o=Mc(i,a);return o?` is-${o}-leader`:""})()}">
          ...
          ${ta(i.teamId,i.teamName)}
          <div class="race-sim-favorite-main">
                    ${aa(i.riderId,i.displayName,"race-sim-favorite-name")}
  ...
  `).join("")}</div>`}function qt(e,t){const a=e.riders.find(s=>s.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function qa(e,t){const a=e.riders.find(n=>n.id===t),s=(a==null?void 0:a.activeTeamId)??null,r=s!=null?e.teams.find(n=>n.id===s)??null:null;return{teamId:s,teamName:(r==null?void 0:r.name)??null}}function Ic(e,t,a,s={}){const r=(t??[]).slice(0,s.limit??8);return r.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${r.map(n=>{var u;const i=n.riderId??0,o=qa(e,i),c=qt(e,i),l=((u=s.distanceGapsByRiderId)==null?void 0:u.get(i))??null,p=[s.distanceGapClassName??"",$c(l)].filter(m=>m.length>0).join(" ");return`
      <article class="race-sim-classification-row">
        <strong class="race-sim-favorite-rank">${n.rank}.</strong>
        ${ta(o.teamId,o.teamName)}
        <span class="race-sim-classification-main">
          ${aa(n.riderId,c,"race-sim-classification-name")}
      ...
      </article>`}).join("")}</div>`}function ba(e,t,a,s,r,n={}){return`
    ...
    <div class="race-sim-stage-points-popover-list">
      ${r.map(n=>{const i=qa(e,n.riderId),o=a.get(n.riderId)??null;return`
          <div class="race-sim-stage-points-popover-row">
            ...
            ${ta(i.teamId,i.teamName)}
            ${aa(n.riderId,qt(e,n.riderId),"race-sim-stage-scoring-name")}
    ...
    </div>`}function sn(e,t){var a;return((a=e==null?void 0:e.find(s=>s.riderId===t))==null?void 0:a.points)??0}function rn(e,t){var a;return((a=e.filter(s=>s.riderId!=null&&t.has(s.riderId)).sort((s,r)=>s.rank-r.rank||s.riderId-r.riderId)[0])==null?void 0:a.riderId)??null}function ya(e,t,a){if(!(!t||e.some(s=>s.riderId===t.riderId))){if(e.length<25){e.push(t);return}e[a]=t}}function Bc(e,t,a,s,r){const n=new Set(e.riderIds),i=new Map(t.riders.map(f=>[f.riderId,f])),c=e.riderIds.map(f=>i.get(f)??null).filter(f=>f!=null).sort((f,g)=>{var b,y;return(((b=a.get(f.riderId))==null?void 0:b.rank)??Number.MAX_SAFE_INTEGER)-(((y=a.get(g.riderId))==null?void 0:y.rank)??Number.MAX_SAFE_INTEGER)||f.riderName.localeCompare(g.riderName,"de")||f.riderId-g.riderId}).slice(0,25),l=i.get(rn(s,n)??-1)??null,p=i.get(rn(r,n)??-1)??null,u=l!=null&&!c.some(f=>f.riderId===l.riderId),m=p!=null&&!c.some(f=>f.riderId===p.riderId);return c.length>=25&&u&&m&&l.riderId!==p.riderId?(ya(c,l,23),ya(c,p,24),c):(ya(c,l,24),ya(c,p,24),c)}function _c(e,t){const a=[];return t.gcLeaderRiderId===e&&a.push("gc"),t.mountainLeaderRiderId===e&&a.push("mountain"),t.pointsLeaderRiderId===e&&a.push("points"),t.youthLeaderRiderId===e&&a.push("youth"),a}function Gc(e){return e.includes("gc")?" is-gc-leader":e.includes("mountain")?" is-mountain-leader":e.includes("points")?" is-points-leader":e.includes("youth")?" is-youth-leader":""}function nn(e,t){return e==null?"—":`${t}${Math.round(e)} m`}function Hc(e,t){const a=t.riders.filter(r=>e.riderIds.includes(r.riderId)).reduce((r,n)=>Math.max(r,n.distanceCoveredMeters),0),s=Math.max(0,t.leaderDistanceMeters-a);return s>0?`-${Math.round(s)} m`:"—"}function zc(e,t,a,s,r,n,i){if(a.length===0||e.stage.profile==="ITT"||e.stage.profile==="TTT")return"";const o=rl(a,s),c=a.find(m=>m.label===o)??a[0],l=new Map(e.gcStandings.map(m=>[m.riderId,m])),p=Os(i),u=Bc(c,t,l,r,n);return`
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-gap-row">
        ...
        <span>Leader ${Z(Hc(c,t))}</span>
        <span>Hinten ${Z(nn(c.nextGapMeters,"+"))}</span>
      </div>
      <div class="race-sim-group-grid">
        ${u.map((m,f)=>{const g=l.get(m.riderId)??null,b=qa(e,m.riderId),y=p.get(m.riderId)??{points:0,mountain:0},v=sn(r,m.riderId),x=sn(n,m.riderId),w=_c(m.riderId,e.classificationLeaders),T=w.length>0?w.map($=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[$]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${Gc(w)}" title="${Z(T)}">${f+1}.</strong>
              ${ta(b.teamId,b.teamName)}
              <span class="race-sim-classification-main">
                ${aa(m.riderId,m.riderName,`race-sim-group-rider-name${m.isBreakaway?" is-breakaway":""}`)}
    ...
    </section>`}function Kc(e,t,a,s){const r=Vs(t,a.markerClassifications,a),n=Os(r),i=Ha(t,t.pointsStandings,n,"points"),o=Ha(t,t.mountainStandings,n,"mountain"),c=Ks(zs(a.clusters));e.innerHTML=zc(t,a,c,s,i,o,r)}function Wc(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function jc(e){const t=Ye(e.stageSummary),a=$i(e)[0]??0,s=js(e)[0]??0,r=t.filter(({marker:n})=>ct(n)).reduce((n,{marker:i})=>n+(Ia(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+s,mountain:r}}function on(e){const t=jc(e);return`
    ...
    </span>`}function Oc(e){const t=xc(e),a=[`<span class="race-sim-stage-points-meta-pill">${Z(fa(e.kmMark))}</span>`,`<span class="race-sim-stage-points-meta-pill">${Z(`${fa(e.kmToFinish)} bis Ziel`)}</span>`,e.climbLengthKm!=null?`<span class="race-sim-stage-points-meta-pill">${Z(`Länge ${fa(e.climbLengthKm)}`)}</span>`:"",e.averageGradient!=null?`<span class="race-sim-stage-points-meta-pill">${Z(`Ø ${Qr(e.averageGradient)}`)}</span>`:"",e.steepestSegmentLengthKm!=null&&e.steepestSegmentGradient!=null?`<span class="race-sim-stage-points-meta-pill is-steepest">${Z(`Steilstes ${fa(e.steepestSegmentLengthKm)}`)}</span>`:"",e.steepestSegmentLengthKm!=null&&e.steepestSegmentGradient!=null?`<span class="race-sim-stage-points-meta-pill is-steepest">${Z(Qr(e.steepestSegmentGradient))}</span>`:""].filter(s=>s.length>0);return`
    ...
    <section class="race-sim-mountain-primes-box">
      ...
      <div class="race-sim-mountain-primes-list">
        ${r.map(n=>{const i=n.leaderRiderId!=null?qa(e,n.leaderRiderId):{teamId:null,teamName:null},o=n.leaderRiderId!=null?qt(e,n.leaderRiderId):"Noch offen";return`
          <details class="race-sim-mountain-prime-row race-sim-stage-points-event race-sim-stage-points-event-${n.accent}">
            ...
            <span class="race-sim-stage-points-leader">
              ${ta(i.teamId,i.teamName)}
              ${n.leaderRiderId!=null?aa(n.leaderRiderId,o,"race-sim-stage-scoring-leader-name"):`<strong>${Z(o)}</strong>`}
            </span>
            </summary>
    ...
    </section>`}function Uc(e,t,a,s,r,n=new Set){var f,g;const i=Vs(a,s,r),o=Os(i),c=Ha(a,a.pointsStandings,o,"points"),l=Ha(a,a.mountainStandings,o,"mountain"),p=an(r,((f=a.gcStandings[0])==null?void 0:f.riderId)??null),u=an(r,((g=a.youthStandings[0])==null?void 0:g.riderId)??null),m=b=>!n.has(b);e.innerHTML=`
  ...
  `}const ln=new WeakMap,Ve=new WeakMap,dn=new WeakMap,Ti=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function Y(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function xi(e){return e<=0?"—":`+${Math.round(e)} m`}function Ut(e){const t=Ti.format(e);return e>0?`+${t}`:t}function ms(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function ie(e){return Ti.format(e)}function kt(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),s=Math.floor(t%3600/60),r=t%60;return`${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function Mi(e){return`+${kt(e)}`}function wi(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Us(e){return`${(e*3.6).toFixed(1)} km/h`}function Yc(e){return`${Ut(e)}%`}function Rs(e){return`${e.toFixed(1).replace(".",",")} km`}function Ri(e){return`${Rs(e.segmentStartKm)} - ${Rs(e.segmentEndKm)}`}function Zc(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function Ii(e){return e.replace(/_/g," ")}function Ei(e){return Ii(e)}function Jc(e){return Ii(e)}function Fi(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function qc(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function Xc(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function Ci(e){return Ye(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||ct(t)).map(({key:t,label:a})=>({key:t,label:a}))}function Qc(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function eu(e,t,a,s){var r;return a!=="ITT"&&a!=="TTT"?((r=s.get(t))==null?void 0:r.get(e.riderId))??null:e.splitTimes[t]??null}function Ni(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(r=>({label:r.key,displayLabel:r.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${r.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function tu(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function au(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function Pi(e){const t=ln.get(e);if(t)return t;const a=Ci(e),s={splitMarkers:a,columns:Ni(e,a,!1),riderById:new Map(e.riders.map(r=>[r.id,r])),teamById:new Map((e.teams??[]).map(r=>[r.id,r])),teamAbbreviationById:new Map((e.teams??[]).map(r=>[r.id,r.abbreviation])),teamNameById:new Map((e.teams??[]).map(r=>[r.id,r.name])),gcByRiderId:new Map((e.gcStandings??[]).map(r=>[r.riderId,r]))};return ln.set(e,s),s}function Li(e,t){const a=e.parentElement,s=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!s)return"";const r=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const l=document.createElement("div");return l.className="race-sim-leaderboard-toolbar",s.insertAdjacentElement("beforebegin",l),l})(),n=Ys(e),i=tu(t),o=au(i,n),c=Ve.get(e);return(c==null?void 0:c.layoutKey)===o||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(l=>l.width).join(" ")),r.innerHTML=`
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,s.innerHTML=t.map(l=>su(l,n)).join(""),Ve.set(e,{layoutKey:o,orderedRiderIds:(c==null?void 0:c.orderedRiderIds)??[],rowsByRiderId:(c==null?void 0:c.rowsByRiderId)??new Map,openDetailRiderId:(c==null?void 0:c.openDetailRiderId)??null,openTeamId:(c==null?void 0:c.openTeamId)??null})),o}function qe(e,t){e.textContent!==t&&(e.textContent=t)}function va(e,t){e.title!==t&&(e.title=t)}function Sa(e,t){e.className!==t&&(e.className=t)}function ka(e,t,a){return e.lastValues[t]!==a}function $a(e,t,a){e.lastValues[t]=a}function Ys(e){const t=dn.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return dn.set(e,a),a}function su(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${Y(e.label)}">${Y(a)}</span>`;const s=!t.autoSort&&t.manualSortKey===e.sortKey,r=s?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
...
`)}function uu(e){return Ut(Math.max(-2.5,Math.min(2.5,e*2.5)))}function mu(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function Bi(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${Y(e.riderName)}">${Y(e.riderName)}</button>`}function pu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId)??"—",r=a.get(e.activeTeamId)??s;return`<span class="race-sim-team-code" title="${Y(r)}">${Y(s)}</span>`}function _i(e){return`/jersey/Jer_${e}.png`}function gu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId);if(!s)return"—";const r=a.get(e.activeTeamId)??s.name,n=_i(e.activeTeamId);return`
    <span class="race-sim-team-visual" title="${Y(r)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function fu(e){return e.hasSuperform?'<span class="race-sim-special-form-dot race-sim-special-form-dot-good" title="Superform"></span>':e.hasSupermalus?'<span class="race-sim-special-form-dot race-sim-special-form-dot-bad" title="Supermalus"></span>':""}function hu(e,t,a,s){var n;if(a!=="ITT"&&a!=="TTT"){const i=(n=s.get(t))==null?void 0:n.get(e.riderId);return i!=null?`${i}.`:"—"}const r=e.splitTimes[t];return r!=null?kt(r):"—"}function Gi(e,t,a){const s=Ai(e,t),r=[{label:"Terrain / Skill",value:`${Ei(e.activeTerrain)} / ${Jc(e.skillName)}`},{label:"Aktiver Abschnitt",value:Ri(e)},{label:"Segmenthöhe",value:Zc(e)},{label:"Basis",value:ie(e.baseSkill)},{label:"Team+",value:e.teamGroupBonus>0?`+${ie(e.teamGroupBonus)}`:"—"},{label:"S-Form",value:Ut((t==null?void 0:t.formBonus)??0)},{label:"R-Form",value:Ut((t==null?void 0:t.raceFormBonus)??0)},{label:"Fatigue",value:ms((t==null?void 0:t.fatigueMalus)??0)},{label:"Langzeit",value:ms((t==null?void 0:t.longTermFatigueMalus)??0)},{label:"Akut",value:ms((t==null?void 0:t.shortTermFatigueMalus)??0)},{label:"Stamina",value:ie(e.staminaPenalty)},{label:"HM",value:ie(e.elevationPenalty)},{label:"T-Form",value:Ut(e.dailyForm)},{label:"Zufall",value:uu(e.microForm)},{label:"M_grad",value:`x${e.gradientModifier.toFixed(2).replace(".",",")}`},{label:"M_wind",value:`x${e.windModifier.toFixed(2).replace(".",",")}`},{label:"Draft",value:`x${e.draftModifier.toFixed(2).replace(".",",")}`},{label:"Draft Pack",value:mu(e)},{label:"GC",value:a?String(a.rank):"—"},{label:"GC Gap",value:a?wi(a.gapSeconds):"—"}];return`
    ...
    </section>`}function bu(e,t,a,s,r,n,i){const o=document.createElement("article");o.dataset.raceSimRiderRow=String(e.riderId);const c=document.createElement("div");c.className="race-sim-row-grid",o.appendChild(c);const l=document.createElement("strong");l.className="race-sim-row-rank",l.textContent="0.",c.appendChild(l);const p=document.createElement("span");p.className="race-sim-row-flag",p.innerHTML=t?al(Xc(t)):"—",c.appendChild(p);const u=document.createElement("span");u.className="race-sim-row-name",u.innerHTML=Bi(e,a),c.appendChild(u);const m=u.querySelector(".race-sim-row-name-btn");if(!m)throw new Error("race-sim-row-name-btn not found");const f=document.createElement("span");f.className="race-sim-row-team-visual",f.innerHTML=gu(t,r,i),c.appendChild(f);const g=document.createElement("strong");g.className="race-sim-row-team",g.innerHTML=pu(t,n,i),c.appendChild(g);const b=(P="")=>{const D=document.createElement("strong");return P&&(D.className=P),c.appendChild(D),D},y=b("race-sim-gap"),v=b("race-sim-cell-effective-skill"),x=b(),w=b(),T=b(),$=s.map(()=>b()),R=b(),I=b(),C=b("race-sim-form-state-cell"),E=document.createElement("div");return E.className="race-sim-row-detail-popover hidden",o.appendChild(E),{row:o,rankField:l,nameButton:m,gapField:y,clockField:T,splitFields:$,effectiveSkillField:v,gcRankField:x,gcGapField:w,gradientPercentField:R,speedField:I,formStateField:C,detailPanel:E,initialized:!1,lastValues:{}}}function yu(e,t,a,s,r,n,i,o,c,l,p){const u=(s==null?void 0:s.formBonus)??0,m=(s==null?void 0:s.raceFormBonus)??0,f=c&&l>1?p.get(a.riderId)??null:null,g=Me(a),b=i!=="ITT"&&i!=="TTT"?g?"DNF":"—":a.hasStarted?g?"DNF":a.riderClockSeconds!=null?kt(a.riderClockSeconds):"—":Mi(a.startOffsetSeconds);Sa(e.row,`race-sim-row${t===1&&!g?" race-sim-row-leader":""}${r?" race-sim-row-detail-open":""}${g?" race-sim-row-dnf":""}`),qe(e.rankField,`${t}.`),qe(e.gapField,g?"DNF":xi(a.gapToLeaderMeters)),qe(e.clockField,b),e.nameButton.setAttribute("aria-expanded",r?"true":"false"),Sa(e.nameButton,`race-sim-row-name-btn${a.isAttacking?" is-attacking":""}${a.isBreakaway?" is-breakaway":""}`),va(e.nameButton,a.isBreakaway?`${a.riderName} (Ausreißer)`:a.isAttacking?`${a.riderName} (Attacke aktiv)`:a.riderName),n.forEach((w,T)=>{const $=e.splitFields[T];if(!$)return;const R=hu(a,w.key,i,o);qe($,R),va($,w.label)}),ka(e,"effectiveSkillValue",a.effectiveSkill)&&(qe(e.effectiveSkillField,ie(a.effectiveSkill)),$a(e,"effectiveSkillValue",a.effectiveSkill));const y=`race-sim-cell-effective-skill ${Fi(a)}`;ka(e,"effectiveSkillClass",y)&&(Sa(e.effectiveSkillField,y),$a(e,"effectiveSkillClass",y));const v=[a.baseSkill,a.effectiveSkill,a.teamGroupBonus,u,m,a.dailyForm,a.microForm,(s==null?void 0:s.fatigueMalus)??0,(s==null?void 0:s.longTermFatigueMalus)??0,(s==null?void 0:s.shortTermFatigueMalus)??0,a.staminaPenalty].join("|");ka(e,"effectiveSkillTitleKey",v)&&(va(e.effectiveSkillField,cu(a,s)),$a(e,"effectiveSkillTitleKey",v)),qe(e.gcRankField,f?String(f.rank):"—"),qe(e.gcGapField,f?wi(f.gapSeconds):"—"),qe(e.gradientPercentField,Yc(a.gradientPercent)),Sa(e.gradientPercentField,qc(a.gradientPercent)),va(e.gradientPercentField,`${Ei(a.activeTerrain)} · ${Ri(a)}`),qe(e.speedField,Us(a.currentSpeedMps)),e.formStateField.innerHTML=fu(a);const x=[r?"open":"closed",a.activeTerrain,a.segmentStartKm,a.segmentEndKm,a.segmentStartElevation,a.segmentEndElevation,a.skillName,a.baseSkill,a.teamGroupBonus,u,m,(s==null?void 0:s.fatigueMalus)??0,a.staminaPenalty,a.elevationPenalty,a.dailyForm,a.microForm,a.gradientModifier,a.windModifier,a.draftModifier,a.draftNearbyRiderCount,a.draftPackFactor,(f==null?void 0:f.rank)??"—",(f==null?void 0:f.gapSeconds)??"—",a.skillBreakdown].join("|");ka(e,"detailKey",x)&&(e.detailPanel.innerHTML=r?Gi(a,s,f):"",e.detailPanel.classList.toggle("hidden",!r),$a(e,"detailKey",x)),e.detailPanel.classList.toggle("hidden",!r),e.initialized=!0}function vu(e,t){return`<button type="button" class="race-sim-row-name-btn" data-race-sim-ttt-team-toggle="${e.id}" aria-expanded="${t?"true":"false"}" title="${Y(e.name)}">${Y(e.name)}</button>`}function Su(e){const t=_i(e.id);return`
    <span class="race-sim-team-visual" title="${Y(e.name)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function ku(e,t,a){const s=new Map;for(const r of e.riders){const n=a.get(r.riderId),i=n==null?void 0:n.activeTeamId;if(i==null)continue;const o=s.get(i)??[];o.push(r),s.set(i,o)}return t.teams.filter(r=>s.has(r.id)).map(r=>{const n=(s.get(r.id)??[]).slice().sort((p,u)=>u.effectiveSkill-p.effectiveSkill||p.riderId-u.riderId),i=n[0]??e.riders[0],o=Math.min(5,n.length),c=n.slice(0,o).reduce((p,u)=>p+u.effectiveSkill,0)/Math.max(o,1),l=Math.max(0,8-n.length);return{team:r,riders:n,representative:i,teamClockSeconds:(i==null?void 0:i.riderClockSeconds)??null,teamDistanceMeters:(i==null?void 0:i.distanceCoveredMeters)??0,teamEffectiveSkill:Math.max(1,c-l),teamSpeedMps:(i==null?void 0:i.currentSpeedMps)??0,splitTimes:(i==null?void 0:i.splitTimes)??{},finishedRiders:n.filter(p=>p.isFinished).length}}).sort((r,n)=>Di(r.representative,n.representative,Ci(t))||r.team.id-n.team.id)}function $u(e,t,a,s,r){return`
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${Y(e.team.name)}">
      ...
      <article class="race-sim-row${y===0?" race-sim-row-leader":""}${v?" race-sim-row-detail-open":""}">
        <div class="race-sim-row-grid">
          ...
          ${n.map(x=>`<strong>${Y(b.splitTimes[x.key]!=null?kt(b.splitTimes[x.key]):"—")}</strong>`).join("")}
          <strong class="race-sim-cell-effective-skill ${Fi(b.representative)}">${Y(ie(b.teamEffectiveSkill))}</strong>
    ...
    </div>`}function Ui(e,t,a,s,r,n,i,o){const c=o??Qa(e,t,a);return`
    ...
    </tr>`);const o=ym(d.stageEditorStageRows);r.innerHTML=o.map(c=>`
    <tr>
      <td>${c.stageId}</td>
      <td>${ne(c.countryCode||"")}</td>
      <td><strong>${S(c.raceName)}</strong></td>
      <td><strong>${S(na({stageNumber:c.stageNumber}))}</strong></td>
      <td>${Ui(c.profileScore,0,100,c.stageId,fm(c),ss({name:c.raceName},{stageNumber:c.stageNumber,profile:c.profile}))}</td>
      <td>${ia(c.profile)}</td>
      <td>${ft(c.distanceKm)}</td>
      <td>${Ki(c.elevationGainMeters)}</td>
    ...
    `,s.innerHTML=y,n.innerHTML=vn(e),i.innerHTML=e.segments.map((v,x)=>`
    <tr data-segment-index="${x}" class="${qs(e,x).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;">
      ...
      <td class="stage-editor-cell-start-markers">
        ${yn(v.markers,x,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${yn(v.endMarkers,x,e.segments.length,"end")}
      </td>
    ...
    </svg>`}function xm(e,t,a){const s=d.stageEditorDraft;if(!s)return;const r=s.segments[e];r&&(t==="startElevation"?r.startElevation=Math.max(-500,Math.min(9e3,Number.parseInt(a||"0",10))):t==="lengthKm"?r.lengthKm=Math.max(.01,Number.parseFloat(a||"0.1")):t==="gradientPercent"?r.gradientPercent=Number.parseFloat(a||"0"):t==="terrain"?(r.terrain=a,r.manualTerrain=!0):t==="techLevel"?r.techLevel=Math.max(1,Math.min(10,Number.parseInt(a||"5",10))):t==="windExp"&&(r.windExp=Math.max(1,Math.min(10,Number.parseInt(a||"5",10)))),ut(s),st(s),de())}function Mm(e){const t=d.stageEditorDraft;if(!t)return;const a=t.segments[e];if(!a)return;const s={startElevation:a.startElevation,lengthKm:1,gradientPercent:0,techLevel:5,windExp:5,terrain:"Flat",markers:[],endMarkers:[]};t.segments.splice(e,0,s),ut(t),st(t),de()}function wm(){const e=d.stageEditorDraft;if(!e)return;const t=e.segments[e.segments.length-1],s={startElevation:t?Xs(t):100,lengthKm:1,gradientPercent:0,techLevel:5,windExp:5,terrain:"Flat",markers:[],endMarkers:[]};e.segments.push(s),ut(e),st(e),de()}function Rm(e){const t=d.stageEditorDraft;t&&(t.segments.length<=1||(t.segments.splice(e,1),ut(t),st(t),de()))}async function Im(){var a;const t=(a=h("stage-editor-file").files)==null?void 0:a[0];if(!t){alert("Bitte zuerst eine GPX- oder TCX-Datei auswählen.");return}h("stage-editor-file-hint").textContent=`${t.name} · ${(t.size/1024).toFixed(1).replace(".",",")} KB`,ve("Route wird importiert……");try{const s=await t.text(),r=await H.importStageRoute({fileName:t.name,fileContent:s});if(!r.success||!r.data){alert(`Import fehlgeschlagen: ${r.error??"Unbekannter Fehler"}`);return}const n=Wi(r.data);d.stageEditorDraft=n,st(n),lm(n),de(),Tt("stage-editor")}finally{ge()}}async function Em(){const e=Number(h("stage-editor-existing-stage").value);if(!Number.isInteger(e)||e<=0){alert("Bitte zuerst eine vorhandene CSV-Stage auswählen.");return}ve("CSV-Stage wird geladen...");try{const t=await H.loadStageEditorStage(e);if(!t.success||!t.data){alert(`Stage konnte nicht geladen werden: ${t.error??"Unbekannter Fehler"}`);return}const a=Wi(t.data.draft);d.stageEditorDraft=a,st(a),dm(t.data.metadata),de(),Tt("stage-editor")}finally{ge()}}async function Fm(){if(!d.stageEditorDraft){alert("Es gibt noch keine importierte oder geladene Strecke.");return}const e=[...Oi(d.stageEditorDraft),...Vi()];if(e.length>0){alert(`Export blockiert:

${e.join(`
`)}`),de();return}const t=h("stage-editor-new-race-checkbox").checked,a=h("stage-editor-program-checkbox").checked;let s;t&&(s={name:h("stage-editor-race-name").value.trim(),countryId:Number(h("stage-editor-race-country").value),categoryId:Number(h("stage-editor-race-category").value),isStageRace:Number(h("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(h("stage-editor-race-num-stages").value),startDate:h("stage-editor-race-start-date").value.trim(),endDate:h("stage-editor-race-end-date").value.trim(),prestige:Number(h("stage-editor-race-prestige").value)});let r;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');r=Array.from(n).map(i=>Number(i.value))}ve("CSV-Dateien werden erstellt……");try{const n=await H.exportStageRoute({metadata:cm(),draft:d.stageEditorDraft,newRace:t,raceDetails:s,updatePrograms:a,programIds:r});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}xs(n.data.stagesFileName,n.data.stagesCsv),xs(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=h("stage-editor-stage-number"),o=Number(i.value)||1;i.value=String(o+1);const c=h("stage-editor-date"),l=c.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const y=new Date(l);y.setDate(y.getDate()+1);const v=y.getFullYear(),x=String(y.getMonth()+1).padStart(2,"0"),w=String(y.getDate()).padStart(2,"0");c.value=`${v}-${x}-${w}`}await Promise.all([Yi(!0),bm(!0)]);const p=ji();h("stage-editor-stage-id").value=String(p),Ft=p;const u=h("stage-editor-new-race-checkbox");u&&(u.checked=!1);const m=h("stage-editor-new-race-details");m&&(m.classList.add("hidden"),m.style.display="none");const f=h("stage-editor-program-checkbox");f&&(f.checked=!1);const g=h("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),Ct=Number(h("stage-editor-race-id").value),de()}finally{ge()}}function Cm(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",T=>{const $=T.target.closest("button[data-stage-editor-stages-sort]");if(!$)return;const R=$.dataset.stageEditorStagesSort;d.stageEditorStagesSort.key===R?d.stageEditorStagesSort.direction=d.stageEditorStagesSort.direction==="asc"?"desc":"asc":d.stageEditorStagesSort={key:R,direction:um(R)},Kt()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",T=>{const $=T.target.closest("button[data-stage-editor-climbs-sort]");if(!$)return;const R=$.dataset.stageEditorClimbsSort;d.stageEditorClimbsSort.key===R?d.stageEditorClimbsSort.direction=d.stageEditorClimbsSort.direction==="asc"?"desc":"asc":d.stageEditorClimbsSort={key:R,direction:mm(R)},Wt()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{Im()});const s=document.getElementById("btn-stage-editor-load-existing");s&&s.addEventListener("click",()=>{Em()});const r=document.getElementById("btn-stage-editor-export");r&&r.addEventListener("click",()=>{Fm()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",T=>{var R;const $=((R=T.target.files)==null?void 0:R[0])??null;h("stage-editor-file-hint").textContent=$?`${$.name} · ${($.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",T=>{const $=T.target,R=$.closest("tr[data-segment-index]"),I=$.dataset.field;if(!R||!I)return;const C=Number(R.dataset.segmentIndex);if(Number.isInteger(C)){if(I==="markerType"||I==="markerName"||I==="markerCat"){const E=Number($.dataset.markerIndex),P=$.dataset.markerScope;if(!Number.isInteger(E)||P!=="start"&&P!=="end")return;Qu(C,E,P,I,$.value);return}xm(C,I,$.value)}}),i.addEventListener("click",T=>{const $=T.target.closest("button[data-segment-action]");if(!$)return;const R=Number($.dataset.segmentIndex);if(Number.isInteger(R)){if($.dataset.segmentAction==="insert"){Mm(R);return}if($.dataset.segmentAction==="append"){wm();return}if($.dataset.segmentAction==="add-marker"){const I=$.dataset.markerScope;if(I!=="start"&&I!=="end")return;em(R,I);return}if($.dataset.segmentAction==="remove-marker"){const I=Number($.dataset.markerIndex),C=$.dataset.markerScope;if(!Number.isInteger(I)||C!=="start"&&C!=="end")return;tm(R,I,C);return}$.dataset.segmentAction==="delete"&&Rm(R)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(T=>{const $=document.getElementById(T);$&&$.addEventListener("change",()=>de())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(T=>{T.addEventListener("change",()=>de())});const c=h("stage-editor-new-race-checkbox"),l=h("stage-editor-new-race-details"),p=h("stage-editor-program-checkbox"),u=h("stage-editor-program-details");c&&c.addEventListener("change",()=>{c.checked?(l&&(l.classList.remove("hidden"),l.style.display="grid"),p&&(p.checked=!0,u&&(u.classList.remove("hidden"),u.style.display="block"))):l&&(l.classList.add("hidden"),l.style.display="none"),de()}),p&&p.addEventListener("change",()=>{p.checked?u&&(u.classList.remove("hidden"),u.style.display="block"):u&&(u.classList.add("hidden"),u.style.display="none"),de()});const m=h("stage-editor-programs-dropdown-trigger"),f=h("stage-editor-programs-dropdown-menu"),g=h("btn-stage-editor-programs-ok");m&&f&&(m.addEventListener("click",T=>{T.stopPropagation();const $=f.style.display==="none"||!f.style.display;f.style.display=$?"flex":"none"}),g&&g.addEventListener("click",T=>{T.stopPropagation(),f.style.display="none",de()}),document.addEventListener("click",T=>{const $=T.target;f.style.display==="flex"&&!f.contains($)&&$!==m&&!m.contains($)&&(f.style.display="none",de())}));const b=h("stage-editor-programs-list");b&&b.addEventListener("change",T=>{T.target.name==="stage-editor-program-selection"&&rm()});let y=!1,v=null;const x=h("stage-editor-stage-id"),w=h("stage-editor-race-id");if(x&&w){[x,w].forEach($=>{$.addEventListener("keydown",R=>{R.key!=="ArrowUp"&&R.key!=="ArrowDown"&&(y=!0,v&&clearTimeout(v))}),$.addEventListener("keyup",R=>{R.key!=="ArrowUp"&&R.key!=="ArrowDown"&&(v&&clearTimeout(v),v=setTimeout(()=>{y=!1},150))}),$.addEventListener("blur",()=>{y=!1})});const T=($,R)=>{const I=Number($.value);if(!Number.isInteger(I)||I<=0){R==="stage"?Ft=I:Ct=I;return}const E=I-(R==="stage"?Ft:Ct);if(!y&&(E===1||E===-1)){let P=I;R==="stage"?P=im(I,E):h("stage-editor-new-race-checkbox").checked&&(P=om(I,E)),$.value=String(P)}R==="stage"?Ft=Number($.value):Ct=Number($.value)};x.addEventListener("input",()=>{T(x,"stage"),de()}),w.addEventListener("input",()=>{T(w,"race"),de()})}}let et=[],It=null,Ie={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const Mt=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"];function er(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      ...
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;" title="Overall-Stärke">${Ji(c)}</span>
      ...
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width ${w!=="none"?"text-error":""}" title="Kurzzeitfatigue">${ee.shortFatigue} <span class="rider-stats-icon-pill-value">${x}</span></span>
      </div>
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonpunkte">${ee.seasonPoints} <span class="rider-stats-icon-pill-value">${T}</span></span>
      ...
      <div class="rider-stats-header-col align-left">
        ${rt(ee.flat,"Flach-Punkte",E.flat,P)}
        ${rt(ee.hilly,"Hügel-Punkte",E.hilly,P)}
        ${rt(ee.mediumMountain,"Mittelgebirge-Punkte",E.mediumMountain,P)}
      </div>
      <div class="rider-stats-header-col align-left">
        ${rt(ee.mountain,"Hochgebirge-Punkte",E.mountain,P)}
        ${rt(ee.timetrial,"Zeitfahren-Punkte",E.timetrial,P)}
        ${rt(ee.cobble,"Kopfsteinpflaster-Punkte",E.cobble,P)}
      </div>
    </div>
  `}function kn(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",s=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(s)}</strong>`}function He(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </div>`}function _m(e){const t=[{score:55,hue:0,lightness:28},{score:60,hue:0,lightness:40},{score:68,hue:30,lightness:42},{score:74,hue:60,lightness:42},{score:80,hue:120,lightness:36}];let a=120,s=36;const r=Math.max(55,Math.min(80,e));for(let c=1;c<t.length;c++){const l=t[c-1],p=t[c];if(r<=p.score){const u=(r-l.score)/(p.score-l.score);a=Math.round(l.hue+(p.hue-l.hue)*u),s=Math.round(l.lightness+(p.lightness-l.lightness)*u);break}}return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${s}%;--stage-editor-score-bg-alpha:${.44};--stage-editor-score-border-alpha:${.72};`}">${e.toFixed(0)}</span>`}function Gm(e,t){const a=(e==null?void 0:e.skills)??{mountain:60,hill:60,sprint:60,timeTrial:60,cobble:60,attack:60,mediumMountain:60,flat:60,prologue:60,acceleration:60},s=["mountain","hill","sprint","timeTrial","cobble","attack"],r=["Berg (MTN)","Hügel (HIL)","Sprint (SPR)","Zeitfahren (TT)","Pflaster (COB)","Angriff (ATT)"],n=540,i=440,o=n/2,c=i/2,l=160,p=60,u=85,m=u-p,f=D=>{const _=[];for(let B=0;B<6;B++){const M=B*Math.PI/3-Math.PI/2;_.push(`${o+D*Math.cos(M)},${c+D*Math.sin(M)}`)}return _},g=`
    <defs>
    ...
    </defs>`,b=`<circle cx="${o}" cy="${c}" r="${l+8}" fill="url(#radarBgGrad)" stroke="rgba(255,255,255,0.06)" stroke-width="1" />`;let y="";for(let D=p;D<=u;D+=2.5){const _=l*((D-p)/m);if(_<1){y+=`<circle cx="${o}" cy="${c}" r="2" fill="rgba(255,255,255,0.25)" />`;continue}const B=f(_),M=D%5===0,N=M?1:.6,O=M?"none":"4,4",K=M?.4:.18;y+=`<polygon points="${B.join(" ")}" fill="none" stroke="rgba(255,255,255,${K})" stroke-width="${N}" stroke-dasharray="${O}" />`,M&&D>p&&(y+=`<text x="${o+5}" y="${c-_+4}" fill="rgba(255,255,255,0.45)" font-size="9" font-family="Inter, sans-serif" text-anchor="start">${D}</text>`)}let v="",x="";for(let D=0;D<6;D++){const _=D*Math.PI/3-Math.PI/2,B=o+l*Math.cos(_),M=c+l*Math.sin(_);v+=`<line x1="${o}" y1="${c}" x2="${B}" y2="${M}" stroke="rgba(255,255,255,0.15)" stroke-width="1" />`;const N=l+28,O=o+N*Math.cos(_),K=c+N*Math.sin(_),j=Math.cos(_);let A="middle";j>.15?A="start":j<-.15&&(A="end");const X=a[s[D]]??p;x+=`<text x="${O}" y="${K}" fill="rgba(255,255,255,0.92)" font-size="11.5" font-weight="700" font-family="Inter, sans-serif" text-anchor="${A}" dominant-baseline="middle">${r[D]}</text>`,x+=`<text x="${O}" y="${K+14}" fill="rgba(255,255,255,0.50)" font-size="10" font-weight="500" font-family="Inter, sans-serif" text-anchor="${A}" dominant-baseline="middle">${X}</text>`}const w=[],T=[];s.forEach((D,_)=>{const B=a[D]??p,M=l*((Math.max(p,Math.min(u,B))-p)/m),N=_*Math.PI/3-Math.PI/2,O=o+M*Math.cos(N),K=c+M*Math.sin(N);w.push(`${O},${K}`),T.push(`<circle cx="${O}" cy="${K}" r="5" fill="#818cf8" stroke="#fff" stroke-width="2" filter="url(#dotGlow)"><title>${r[_]}: ${B}</title></circle>`)});const $=`<polygon points="${w.join(" ")}" fill="url(#riderFillGrad)" stroke="#818cf8" stroke-width="2.5" stroke-linejoin="round" filter="url(#radarGlow)" />`,I=[...[{key:"mountain",label:"Berg (MTN)"},{key:"hill",label:"Hügel (HIL)"},{key:"sprint",label:"Sprint (SPR)"},{key:"timeTrial",label:"Zeitfahren (TT)"},{key:"cobble",label:"Pflaster (COB)"},{key:"attack",label:"Angriff (ATT)"},{key:"mediumMountain",label:"Mittelgebirge (MDM)"},{key:"flat",label:"Flach (FLA)"},{key:"prologue",label:"Prolog (PRO)"},{key:"acceleration",label:"Beschleunigung (ACC)"}]].sort((D,_)=>{const B=a[D.key]??60;return(a[_.key]??60)-B}),C=[],E=[];I.forEach((D,_)=>{const B=a[D.key]??60,M=`
    ...
    `;_%2===0?C.push(M):E.push(M)});const P=`
  ...
  `}function zm(e){var ae;if(!e)return`
      ...
      </section>`;const a=(e.formHistory??[]).filter((F,z)=>z%2===0),s=((ae=d.gameState)==null?void 0:ae.currentDate)??new Date().toISOString(),r=a.length>0?new Date(a[a.length-1].date).getUTCFullYear():new Date(s).getUTCFullYear(),n=new Date(Date.UTC(r,0,1)).getTime(),i=864e5,o=1260,c=384,l=40,p=20,u=a.map(F=>{const L=(new Date(F.date).getTime()-n)/i,q=l+L/365*o,J=p+c-Math.min(8,Math.max(0,F.totalForm))/8*c;return{x:q,y:J,form:F.totalForm,date:F.date}});let m="",f="",g="";Ie.form&&u.length>0&&(m=`M ${u.map(F=>`${F.x},${F.y}`).join(" L ")}`,f=u.map(F=>`<circle cx="${F.x}" cy="${F.y}" r="3" fill="#fff" stroke="var(--accent-primary)" stroke-width="2"><title>${e.riderName} (${F.date}): ${F.form}</title></circle>`).join(""),g=`${m} L ${u[u.length-1].x},${p+c} L ${u[0].x},${p+c} Z`);let b="",y="";if(Ie.combinedFatigue&&u.length>0){const F=a.map(L=>{const J=(new Date(L.date).getTime()-n)/i,k=l+J/365*o,G=L.combinedFatigue??0,W=p+c-Math.min(15,Math.max(0,G))/15*c;return{x:k,y:W,val:G,date:L.date}});b=`<path d="${`M ${F.map(L=>`${L.x},${L.y}`).join(" L ")}`}" fill="none" stroke="#ef4444" stroke-width="2" />`,y=F.map(L=>`<circle cx="${L.x}" cy="${L.y}" r="3" fill="#fff" stroke="#ef4444" stroke-width="2"><title>Gesamtfatigue (${L.date}): ${L.val.toFixed(2)}</title></circle>`).join("")}let v="",x="";if(Ie.shortFatigue&&u.length>0){const F=a.map(L=>{const J=(new Date(L.date).getTime()-n)/i,k=l+J/365*o,G=L.shortFatigue??0,W=p+c-Math.min(15,Math.max(0,G))/15*c;return{x:k,y:W,val:G,date:L.date}});v=`<path d="${`M ${F.map(L=>`${L.x},${L.y}`).join(" L ")}`}" fill="none" stroke="#facc15" stroke-width="2" />`,x=F.map(L=>`<circle cx="${L.x}" cy="${L.y}" r="3" fill="#fff" stroke="#facc15" stroke-width="2"><title>Kurzzeitfatigue (${L.date}): ${L.val.toFixed(2)}</title></circle>`).join("")}let w="",T="";if(Ie.longFatigue&&u.length>0){const F=a.map(L=>{const J=(new Date(L.date).getTime()-n)/i,k=l+J/365*o,G=L.longFatigue??0,W=p+c-Math.min(15,Math.max(0,G))/15*c;return{x:k,y:W,val:G,date:L.date}});w=`<path d="${`M ${F.map(L=>`${L.x},${L.y}`).join(" L ")}`}" fill="none" stroke="#a855f7" stroke-width="2" />`,T=F.map(L=>`<circle cx="${L.x}" cy="${L.y}" r="3" fill="#fff" stroke="#a855f7" stroke-width="2"><title>Langzeitfatigue (${L.date}): ${L.val.toFixed(2)}</title></circle>`).join("")}const $="rgba(251, 191, 36, 0.15)";let R="";for(let F=0;F<=8;F+=2){const z=p+c-F/8*c;R+=`<line x1="${l}" y1="${z}" x2="${l+o}" y2="${z}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,R+=`<text x="${l-5}" y="${z+4}" fill="#ffffff" font-size="10" text-anchor="end">${F}</text>`}for(let F=0;F<=15;F+=3){const z=p+c-F/15*c;R+=`<text x="${l+o+5}" y="${z+4}" fill="#ef4444" font-size="10" text-anchor="start">${F}</text>`}let I="";for(let F=0;F<=52;F+=5){const z=l+F/52*o;R+=`<line x1="${z}" y1="${p}" x2="${z}" y2="${p+c}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,I+=`<text x="${z}" y="${p+c+15}" fill="#ffffff" font-size="10" text-anchor="middle">W${F}</text>`}let C="",E="";if(e.peakDates){const F=[...e.peakDates].sort((z,L)=>new Date(z).getTime()-new Date(L).getTime());for(let z=0;z<F.length;z++){const L=F[z],J=(new Date(L).getTime()-n)/i,k=l+J/365*o;C+=`<line x1="${k}" y1="${p}" x2="${k}" y2="${p+c}" stroke="#ffffff" stroke-width="2"><title>Peak: ${L}</title></line>`;const G=z>0?(new Date(F[z-1]).getTime()-n)/i:Number.NEGATIVE_INFINITY,W=J-56,V=G+14,fe=Math.max(0,Math.max(W,V)),we=J-fe,Re=l+fe/365*o,Se=we/365*o;E+=`<rect x="${Re}" y="${p}" width="${Se}" height="${c}" fill="rgba(16, 185, 129, 0.1)" />`;const Ze=14/365*o;E+=`<rect x="${k}" y="${p}" width="${Ze}" height="${c}" fill="rgba(239, 68, 68, 0.1)" />`}}const D=(new Date(s).getTime()-n)/i,_=l+D/365*o;C+=`<line x1="${_}" y1="${p}" x2="${_}" y2="${p+c}" stroke="#ef4444" stroke-width="3"><title>Heute: ${s}</title></line>`,et.forEach((F,z)=>{const L=Mt[z%Mt.length];F.peakDates&&F.peakDates.forEach(q=>{const k=(new Date(q).getTime()-n)/i,G=l+k/365*o;C+=`<line x1="${G}" y1="${p}" x2="${G}" y2="${p+c}" stroke="${L}" stroke-width="1.5" stroke-dasharray="3,3"><title>${F.riderName} Peak: ${q}</title></line>`})});let B="",M="";et.forEach((F,z)=>{const L=Mt[z%Mt.length],q=F.formHistory.filter((J,k)=>k%2===0).map(J=>{const G=(new Date(J.date).getTime()-n)/i,W=l+G/365*o,V=p+c-Math.min(8,Math.max(0,J.totalForm))/8*c;return{x:W,y:V,form:J.totalForm,date:J.date}});if(q.length>0){const J=`M ${q.map(k=>`${k.x},${k.y}`).join(" L ")}`;B+=`<path d="${J}" fill="none" stroke="${L}" stroke-width="2" />`,M+=q.map(k=>`<circle cx="${k.x}" cy="${k.y}" r="3" fill="#fff" stroke="${L}" stroke-width="2"><title>${F.riderName} (${k.date}): ${k.form}</title></circle>`).join("")}});const N=d.teams.filter(F=>F.division==="WorldTour"||F.divisionName==="WorldTour");let O='<option value="">-- Team auswählen --</option>';for(const F of N){const z=It===F.id?" selected":"";O+=`<option value="${F.id}"${z}>${S(F.name)}</option>`}let K='<option value="">-- Fahrer auswählen --</option>';if(It!=null){const F=d.riders.filter(z=>z.activeTeamId===It&&z.id!==e.riderId&&!et.some(L=>L.riderId===z.id));for(const z of F)K+=`<option value="${z.id}">${S(z.firstName)} ${S(z.lastName)}</option>`}const j=`
  ...
  `,A=e.currentSeasonRank??Va(e.riderId)??"–",X=[`
    ...
    `];et.forEach((F,z)=>{const L=Mt[z%Mt.length],q=F.currentSeasonRank??Va(F.riderId)??"–";X.push(`
      <div style="display: flex; align-items: center; justify-content: space-between; gap: 0.5rem; margin-bottom: 0.50rem; padding: 0.25rem 0; border-top: 1px solid rgba(255,255,255,0.05);">
        <div style="display: flex; align-items: center; gap: 0.5rem; min-width: 0;">
          ...
          <span style="font-size: 0.9rem; color: var(--text-300); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="${S(F.riderName)} (${F.currentSeasonPoints}/${q})">${S(F.riderName)} <span style="color: var(--text-500);">(${F.currentSeasonPoints}/${q})</span></span>
        </div>
  ...
  `}function $t(e,t){return`<span class="rider-stats-rank-badge rider-stats-rank-badge-${t}">${S(e)}</span>`}function Wm(e){return!e.isBreakaway||e.rowType!=="stage_result"||e.finishStatus!=="classified"?"–":'<span class="rider-stats-breakaway-icon" aria-label="Ausreißer" title="Ausreißer"><svg class="rider-stats-icon" viewBox="0 0 24 24" style="fill:#ef4444; width:1em; height:1em; vertical-align:middle;"><path d="M12 21L2 3h20L12 21z"/></svg></span>'}function jm(e){return e.finishStatus==="otl"?$t("OTL","place"):e.finishStatus==="dnf"?$t("DNF","place"):e.resultRank==null?"–":`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${e.resultRank<=3?` rider-stats-rank-badge-top-${e.resultRank}`:""}">${S(String(e.resultRank))}</span>`}function Om(e){return e.finishStatus!=="classified"||e.gcRank==null?"–":$t(String(e.gcRank),"gc")}function Vm(e){return e.finishStatus==="otl"?ks(e.statusReason,!0):e.finishStatus==="dnf"?ks(e.statusReason,!1):e.stageTimeSeconds!=null?`${e.resultLabel} · ${Pa(e.stageTimeSeconds)}`:e.resultLabel}function Pe(e,t,a=!1){var o,c;const s=(e==null?void 0:e.activeTeamId)!=null?((o=d.teams.find(l=>l.id===e.activeTeamId))==null?void 0:o.name)??null:null,r=((c=e==null?void 0:e.country)==null?void 0:c.code3)??(e==null?void 0:e.nationality)??null,n=r?ne(r):"",i=t==null?[]:[...t.seasons].map(l=>({...l,raceBlocks:Bm(l.raceBlocks)})).sort((l,p)=>p.season-l.season);return a?`
      ...
      ${Ge(e,t,s,r,n)}
      ${He(t)}
      ${Gm(e)}`:d.riderStatsTab==="fatigue"?`
      ${Ge(e,t,s,r,n)}
      ${He(t)}
      ${Hm(e,t)}`:d.riderStatsTab==="program"?`
      ${Ge(e,t,s,r,n)}
      ${He(t)}
      ${Km(t)}`:d.riderStatsTab==="form"?`
      ${Ge(e,t,s,r,n)}
      ${He(t)}
      ${zm(t)}`:d.riderStatsTab==="topResults"?`
      ${Ge(e,t,s,r,n)}
      ${He(t)}
                  ...
                  <tbody>
                    ${p.rows.map(u=>{const m=u.rowType!=="stage_result",f=m?`${u.raceName} · ${ar(u.rowType)}`:u.stageName?`${u.raceName} · ${u.stageName}`:u.raceName;return`
                        <tr class="rider-stats-row${m?" rider-stats-row-final":""}">
                          ...
                          <td>${m?"–":u.profile?`<button type="button" class="rider-stats-profile-badge-link" data-stage-profile-id="${u.stageId}" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex;">${ia(u.profile)}</button>`:"–"}</td>
  ...
  `,m=l.length===0?'<tr><td colspan="9" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':l.map(g=>{const b=g.rowType!=="stage_result",y=b?`${g.raceName} · ${ar(g.rowType)}`:g.stageNumber&&g.isStageRace?`${g.raceName} · Etappe ${g.stageNumber}`:g.raceName;let v="–",x="–";g.finishStatus==="otl"?v=$t("OTL","place"):g.finishStatus==="dnf"?v=$t("DNF","place"):g.resultRank==null||(b?x=`<span class="rider-stats-final-type ${Zi(g.rowType)}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${g.resultRank}</span>`:v=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${g.resultRank<=3?` rider-stats-rank-badge-top-${g.resultRank}`:""}">${S(String(g.resultRank))}</span>`);const w=b?"–":g.profile?`<button type="button" class="rider-stats-profile-badge-link" data-stage-profile-id="${g.stageId}" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex;">${ia(g.profile)}</button>`:"–",T=!b&&g.stageScore!=null&&g.stageScore>0?Qa(g.stageScore,0,350):"–",$=Oa(g.raceCategoryName?g.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):g.raceCategoryName,g.isStageRace);return`
...
`+s.error);return}d.stageResults=s.data??null,d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId,d.selectedResultTypeId=((r=d.stageResults.classifications[0])==null?void 0:r.resultTypeId)??1,d.selectedResultsMarkerKey=Ke,d.selectedResultsSpecialView=null),d.selectedResultsRaceId!=null&&eo(d.selectedResultsRaceId),$e()}async function eo(e){if(!d.seasonStandings){const a=await H.getSeasonStandings();a.success&&a.data&&(d.seasonStandings=a.data)}const t=await H.getRaceResultsRoster(e);t.success&&t.data?d.resultsRoster=t.data:d.resultsRoster=null}function rp(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function Mn(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function np(){const e=d.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=dt(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=[...e.entries].sort((y,v)=>v.overallRating-y.overallRating),r=new Set(s.slice(0,5).map(y=>y.riderId)),n=y=>{var x;const v=d.riders.find(w=>w.id===y);return((x=v==null?void 0:v.skills)==null?void 0:x.sprint)??0},o=[...e.entries.filter(y=>!r.has(y.riderId))].sort((y,v)=>{const x=n(y.riderId),w=n(v.riderId);return w!==x?w-x:v.overallRating-y.overallRating}),c=new Set(o.slice(0,5).map(y=>y.riderId));function l(y){switch(y){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return y}}const p=new Map;for(const y of e.entries){const v=y.teamId;p.has(v)||p.set(v,{teamId:y.teamId,teamName:y.teamName,riders:[],avgRating:0}),p.get(v).riders.push(y)}for(const y of p.values())y.avgRating=y.riders.reduce((v,x)=>v+x.overallRating,0)/y.riders.length;const u=y=>{let v=Number.POSITIVE_INFINITY;for(const x of y)!x.hasDropped&&x.gcRank!=null&&x.gcRank<v&&(v=x.gcRank);return v},m=y=>{var x;if(!((x=d.seasonStandings)!=null&&x.riderStandings))return 0;let v=0;for(const w of y){const T=d.seasonStandings.riderStandings.find($=>$.riderId===w.riderId);T&&T.points>v&&(v=T.points)}return v},f=y=>{if(y==null)return 0;const v=d.riders.filter(T=>T.activeTeamId===y);if(v.length===0)return 0;const x=v.map(T=>T.overallRating??0);x.sort((T,$)=>$-T);const w=x.slice(0,10);return w.length===0?0:w.reduce((T,$)=>T+$,0)/w.length},g=[...p.values()].sort((y,v)=>{const x=u(y.riders),w=u(v.riders);if((x!==Number.POSITIVE_INFINITY||w!==Number.POSITIVE_INFINITY)&&x!==w)return x-w;const T=m(y.riders),$=m(v.riders);if((T>0||$>0)&&T!==$)return $-T;const R=f(y.teamId),I=f(v.teamId);return Math.abs(R-I)>1e-4?I-R:(y.teamName??"").localeCompare(v.teamName??"","de")});for(const y of g)y.riders.sort((v,x)=>Mn(v.roleId)-Mn(x.roleId)||x.overallRating-v.overallRating||v.lastName.localeCompare(x.lastName,"de"));return`<div class="results-roster-grid">${g.map(y=>{const v=y.teamId!=null?vt(y.teamId,y.teamName):"",x=y.riders.map(T=>{var ae;const $=rp(T.roleId),R=T.countryCode?ot[T.countryCode]??T.countryCode.slice(0,2).toLowerCase():null,I=R?`<span class="fi fi-${R} results-roster-flag" title="${S(T.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',C=`${T.firstName.charAt(0)}. ${T.lastName}`,E=T.roleName??"–",P=T.specialization1?l(T.specialization1):null,D=T.specialization2?l(T.specialization2):null;let _=E;P&&(_+=` · ${P}`),D&&(_+=` · ${D}`);const B=`<span class="results-roster-overall-badge" style="color:${ip(T.overallRating)}" title="Gesamtstärke: ${T.overallRating.toFixed(2)}">${T.overallRating.toFixed(2)}</span>`,M=T.hasDropped?" dropped":"";let N="";T.hasDropped?T.dropoutStatus==="dns"?N="DNS":T.dropoutStatus==="dnf"?N=((ae=T.dropoutReason)==null?void 0:ae.startsWith("OTL"))??!1?"OTL":"DNF":N="OUT":T.gcRank!=null&&(N=`${T.gcRank}`);let O="";if(T.hasDropped)O=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(T.dropoutReason||"")}">${N}</span>`;else if(T.gcRank!=null){let F="rider-stats-rank-badge-gc";T.gcRank===1?F="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":T.gcRank===2?F="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":T.gcRank===3&&(F="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),O=`<span class="rider-stats-rank-badge ${F}" title="GC Stand: Platz ${T.gcRank}">${T.gcRank}</span>`}const j=`style="color: ${T.hasDropped?"var(--text-500)":$.color}; font-weight: bold;"`,A=r.has(T.riderId),X=c.has(T.riderId);return`<div class="results-roster-rider${M}">
        <div class="results-roster-rider-info">
          <div class="results-roster-rider-top">
            ...
            <span class="results-roster-name${A?" strongest-rider":X?" best-sprinter":""}">
              ${Ee(C,{riderId:T.riderId,teamId:T.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"})}
              ${Ea(T.riderId)}
            </span>
          </div>
  ...
  `}function wn(e){const t=e.title||"";return t.includes("guten Tag")?1:t.includes("schlechten Tag")?2:t.includes("Formhöhepunkt")||t.includes("Formhoehepunkt")?3:t.includes("nicht am Start")?4:5}function Ea(e){var u,m,f,g,b,y,v,x,w,T;if(e==null||!d.stageResults)return"";const t=dt(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=d.stageResults.classifications,r=(m=(u=s.find($=>$.resultTypeId===wa))==null?void 0:u.rows.find($=>$.rank===1))==null?void 0:m.riderId,n=(g=(f=s.find($=>$.resultTypeId===Ss))==null?void 0:f.rows.find($=>$.rank===1))==null?void 0:g.riderId,i=(y=(b=s.find($=>$.resultTypeId===Gn))==null?void 0:b.rows.find($=>$.rank===1))==null?void 0:y.riderId,o=(x=(v=s.find($=>$.resultTypeId===5))==null?void 0:v.rows.find($=>$.rank===1))==null?void 0:x.riderId,c=(T=(w=s.find($=>$.resultTypeId===7))==null?void 0:w.rows.find($=>$.rank===1))==null?void 0:T.riderId,l=[],p=d.selectedResultTypeId;return e===r&&(p===wa||p===1&&a||p!==1&&p!==wa)&&l.push('<span class="jersey-dot jersey-dot-yellow" title="Gelbes Trikot (Gesamtwertung)"></span>'),e===n&&l.push('<span class="jersey-dot jersey-dot-green" title="Grünes Trikot (Punktewertung)"></span>'),e===i&&l.push('<span class="jersey-dot jersey-dot-red" title="Rotes Trikot (Bergwertung)"></span>'),e===o&&l.push('<span class="jersey-dot jersey-dot-white" title="Weißes Trikot (Nachwuchswertung)"></span>'),e===c&&l.push('<span class="jersey-dot jersey-dot-purple" title="Ausreißertrikot (Aktivste Fahrer)"></span>'),l.length===0?"":`<span class="jersey-dots-wrapper">${l.join("")}</span>`}function Rn(e){if(!e)return"";let t=e;const a=[],s=[...d.riders].sort((n,i)=>{const o=`${n.firstName} ${n.lastName}`;return`${i.firstName} ${i.lastName}`.length-o.length});for(const n of s){const o=`${n.firstName} ${n.lastName}`.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"),c=new RegExp(`${o}(\\s+\\(\\d+\\.\\))?`,"g");c.test(t)&&(t=t.replace(c,l=>{const p=`__RIDER_LINK_${a.length}__`,u=Ee(l,{riderId:n.id,teamId:n.activeTeamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return a.push(u),p}))}let r=S(t);for(let n=0;n<a.length;n++)r=r.replace(`__RIDER_LINK_${n}__`,a[n]);return r}function $e(){var z,L,q,J;d.riders.length===0&&H.getRiders().then(k=>{k.success&&k.data&&(d.riders=k.data,$e())});const e=h("results-race-select"),t=h("results-stage-select"),a=h("results-type-tabs"),s=h("results-marker-tabs"),r=h("results-stage-meta"),n=h("results-empty"),i=h("results-table"),o=i.querySelector("thead tr"),c=h("results-tbody"),l=h("results-marker-classifications"),p=h("results-roster"),u=i.querySelector("colgroup");u&&u.remove(),i.style.tableLayout="",d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId),e.innerHTML='<option value="">– Rennen auswählen –</option>'+d.races.filter(k=>{var G;return(((G=k.stages)==null?void 0:G.length)??0)>0}).map(k=>`<option value="${k.id}"${k.id===d.selectedResultsRaceId?" selected":""}>${S(k.name)}</option>`).join("");const m=dt(d.selectedResultsRaceId),f=m==null?"":(m.stages??[]).map(k=>`<option value="${k.id}"${k.id===d.selectedResultsStageId?" selected":""}>${S(sp(m,k))}</option>`).join("");t.innerHTML='<option value="">– Etappe auswählen –</option>'+f;const g=((z=d.stageResults)==null?void 0:z.classifications.filter(k=>!(m&&!m.isStageRace&&k.resultTypeId!==1&&k.resultTypeId!==6)))??[],b=g.find(k=>k.resultTypeId===d.selectedResultTypeId)??g[0]??null,y=d.selectedResultsSpecialView==="nonFinishers",v=d.selectedResultsSpecialView==="events",x=d.selectedResultsSpecialView==="roster";if(b&&!y&&!v&&!x&&(d.selectedResultTypeId=b.resultTypeId),v){i.style.tableLayout="fixed";const k=document.createElement("colgroup");k.innerHTML=`
      <col style="width: 100px;">
      <col style="width: 240px;">
      <col style="width: auto;">
    `,i.insertBefore(k,i.firstChild)}if(!d.stageResults&&!x||!b&&!y&&!v&&!x){const k=La(d.selectedResultsStageId);r.textContent=k?`${k.race.name} · ${k.stage.profile} · ${se(k.stage.date)}`:"Noch keine Etappe ausgewählt.",a.innerHTML="",s.innerHTML="",s.classList.add("hidden"),c.innerHTML="",l.innerHTML="",l.classList.add("hidden"),i.classList.add("hidden"),p.innerHTML="",p.classList.add("hidden"),n.classList.remove("hidden"),n.textContent=d.selectedResultsStageId!=null?"Für diese Etappe liegen noch keine Ergebnisse vor.":"Noch keine Ergebnisse geladen.";return}x?d.resultsRoster&&(r.textContent=`${d.resultsRoster.raceName} · Starterfeld`):d.stageResults&&(r.textContent=`${d.stageResults.raceName} · Etappe ${d.stageResults.stageNumber} · ${d.stageResults.profile} · ${se(d.stageResults.date)}`);const w=d.stageResults?La(d.stageResults.stageId):null,T=(w==null?void 0:w.stage.distanceKm)??null,$=new Map,R=new Map,I=new Map;if(d.stageResults){const k=d.stageResults.classifications.find(G=>G.resultTypeId===1);if(k)for(const G of k.rows)G.riderId!=null&&G.points!=null&&G.points>0&&$.set(G.riderId,G.points),G.riderId!=null&&G.breakawayKms!=null&&G.breakawayKms>0&&I.set(G.riderId,G.breakawayKms);if(d.stageResults.markerClassifications){for(const G of d.stageResults.markerClassifications)if(rr(G.markerType,G.markerCategory)){for(const W of G.entries)if(W.riderId!=null&&W.pointsAwarded!=null&&W.pointsAwarded>0){const V=R.get(W.riderId)??0;R.set(W.riderId,V+W.pointsAwarded)}}}}const C=(b==null?void 0:b.resultTypeId)===wa,E=(b==null?void 0:b.resultTypeId)===Ss||(b==null?void 0:b.resultTypeId)===Gn,P=(b==null?void 0:b.resultTypeId)===5,D=(b==null?void 0:b.resultTypeId)===6,_=(b==null?void 0:b.resultTypeId)===7,B=C||E||P||D||_,M=g.map(k=>`
    <button
      type="button"
      class="results-type-btn${!y&&!v&&!x&&k.resultTypeId===d.selectedResultTypeId?" active":""}"
  ...
  `,K=`
    <button
      ...
      data-results-special-view="${Qi}"
    >Teilnehmer</button>
  `,j=g.findIndex(k=>k.resultTypeName.toLocaleLowerCase("de").includes("team"));j>=0?M.splice(j+1,0,N,O,K):M.push(N,O,K),a.innerHTML=M.join("");const A=ep(((L=d.stageResults)==null?void 0:L.markerClassifications)??[]);if(x){p.innerHTML=np(),p.classList.remove("hidden"),i.classList.add("hidden"),s.innerHTML="",s.classList.add("hidden"),l.innerHTML="",l.classList.add("hidden"),n.classList.add("hidden");return}else p.innerHTML="",p.classList.add("hidden");const X=!y&&!v&&!x&&(b==null?void 0:b.resultTypeId)===1&&A.length>0,me=X?d.selectedResultsMarkerKey??Ke:null,ae=X&&me!==Ke?A.find(k=>k.markerKey===me)??null:null;if(X&&(d.selectedResultsMarkerKey=(ae==null?void 0:ae.markerKey)??Ke),v){const k=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"}];s.innerHTML=k.map(G=>`
      <button
        type="button"
    ...
    `).join("")}else s.innerHTML=X?[`
        ...
        >${S(tp(k))}</button>
      `)].join(""):"";s.classList.toggle("hidden",!v&&!X);const F=y||v||!X||d.selectedResultsMarkerKey===Ke;if(o&&F&&(o.innerHTML=y?`
        <th>Etappe</th>
        <th>Status</th>
    ...
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':v?[...((J=d.stageResults)==null?void 0:J.events)??[]].filter(k=>Le==="all"?!0:Le==="form"?!!(k.title&&(k.title.includes("guten Tag")||k.title.includes("schlechten Tag")||k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))):Le==="attack"?(k.type==="attack"||k.type==="counter_attack")&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Le==="breakaway"?!!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Le==="incident"?(k.type==="incident"||!!(k.title&&k.title.includes("Massensturz")))&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Le==="exit"?k.type==="dnf"||!!(k.title&&k.title.includes("nicht am Start")):Le==="home"?!!(k.title&&(k.title.includes("Heimvorteil")||k.title.includes("Heimdruck"))):Le==="weather"?!!(k.title&&k.title.startsWith("Wetterbericht:")):!0).sort((k,G)=>{const W=k.kmMark??0,V=G.kmMark??0;if(Math.abs(W-V)>1e-4)return W-V;if(W===0){const Re=wn(k),Se=wn(G);if(Re!==Se)return Re-Se}const fe=k.riderName??"",we=G.riderName??"";return fe.localeCompare(we,"de")}).map(k=>{var _t,kr,$r;const G=k.kmMark!=null?`${k.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",W=k.riderId,V=W!=null?ke(W):null,fe=k.riderTeamId??(V==null?void 0:V.activeTeamId)??null,we=fe!=null?((_t=d.teams.find(la=>la.id===fe))==null?void 0:_t.name)??null:null;let Re=Ht(fe,we);const Se=!!(k.title&&k.title.startsWith("Wetterbericht:"));let Ze=k.title||"";if(Se){const la=(kr=d.stageResults)==null?void 0:kr.rolledWeatherId,rs=($r=d.stageResults)==null?void 0:$r.rolledWetterName;Re=`<span class="results-jersey-cell">${er(la,rs)}</span>`,rs&&(Ze=`Wetterbericht: ${rs}`)}const oa=Se?"":Qe(W!=null?Ra(W):null),Je=Se?"":W!=null?zt(k.riderName??"",!0,!1,W,fe):S(k.riderName||"–");let le="";return k.title&&k.title.includes("guten Tag")?le='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':k.title&&k.title.includes("schlechten Tag")?le='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':k.title&&(k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))?le='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':k.title&&k.title.includes("nicht am Start")?le='<span class="event-badge event-badge-dns">DNS</span>':k.title&&k.title.includes("Massensturz")?le='<span class="event-badge event-badge-masscrash">Massensturz</span>':k.type==="dnf"?le='<span class="event-badge event-badge-dnf">DNF</span>':k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))?le='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':k.type==="attack"?le='<span class="event-badge event-badge-attack">Attacke</span>':k.type==="counter_attack"?le='<span class="event-badge event-badge-counter">Konterattacke</span>':k.type==="incident"?k.title&&(k.title.toLowerCase().includes("defekt")||k.title.toLowerCase().includes("panne")||k.title.toLowerCase().includes("technisch"))?le='<span class="event-badge event-badge-defect">Defekt</span>':le='<span class="event-badge event-badge-crash">Sturz</span>':k.title&&k.title.includes("Super-Heimvorteil")?le='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Heimbonus</span>':k.title&&k.title.includes("Heimdruck")?le='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimmalus</span>':k.title&&k.title.includes("Heimvorteil")?le='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':k.title&&k.title.startsWith("Wetterbericht:")&&(le='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>'),`
          ...
          </tr>`}).join("")||'<tr><td colspan="3" class="results-empty-cell">Keine Ereignisse für diese Etappe.</td></tr>':F&&b?b.rows.map(k=>{const G=k.riderName??k.teamName,W=k.riderName?k.teamName:"–",V=Ht(k.teamId,k.teamName),fe=zt(G,!0,k.isBreakaway===!0,k.riderId,k.teamId),we=Qe(Ra(k.riderId)),Re=b.resultTypeId===1&&k.rank===1&&k.timeSeconds!=null&&T!=null,Se=k.timeSeconds!=null?`${Pa(k.timeSeconds)}${Re?` (${ap(T,k.timeSeconds)})`:""}`:"–",Ze=B?`<td class="results-gc-delta-cell">${Ho(k.previousRank,k.rankDelta)}</td>`:"";if(E){let Je=k.points!=null?String(k.points):"–";if(k.points!=null&&k.riderId!=null&&b){const _t=b.resultTypeId===Ss?$.get(k.riderId)??0:R.get(k.riderId)??0;_t>0&&(Je+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${_t}</span>`)}return`
          <tr>
          ...
          <tr>
            ...
            <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
          </tr>`;let oa=k.points!=null?String(k.points):"–";if(k.leadoutBonus!=null&&k.leadoutBonus>0&&k.leadoutRiderId!=null){const Je=op(k);oa=`
        ...
        <tr>
          ...
          <td>${Se}</td>
          <td>${S(ns(k.gapSeconds))}</td>
          <td class="results-points-cell">${oa}</td>
          <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
        </tr>`}).join(""):"",n.classList.toggle("hidden",!!b||y||v||x),i.classList.toggle("hidden",!F||x),ae){const k=`
      <section class="results-marker-card">
        ...
        <div class="results-marker-row">
          ...
          <div class="results-marker-flag">${Qe(Ra(V==null?void 0:V.id))}</div>
          <div class="results-marker-time">${S(Pa(W.crossingTimeSeconds))}</div>
    ...
    <div class="team-detail-page-tabs" role="tablist" aria-label="Fahrer-Detailseite">
      ${ra.map(e=>{const t={skills:"Werte",form:"Saisonform",profile:"Fahrertyp & Peaks",preferences:"Programm & Mentoren"};return`
          <button
            type="button"
...
`+(o.error??"Unbekannter Fehler"));return}const c=o.data;d.selectedResultsRaceId=(c==null?void 0:c.raceId)??d.selectedResultsRaceId,d.selectedResultsStageId=(c==null?void 0:c.stageId)??e,d.selectedResultTypeId=1,d.realtimeBootstrap=null,d.realtimeError=null,await Fs(e,!1),await gr(),await fr(),await Ua(),Nt(),n||Tt("results")}catch(o){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+o.message)}finally{Tr(!1),ge()}}}function fp(){h("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);d.selectedRealtimeStageId=Number.isFinite(t)?t:null,d.realtimeBootstrap&&d.realtimeBootstrap.stage.id!==d.selectedRealtimeStageId&&(d.realtimeBootstrap=null),d.realtimeError=null,So(t,!1)})}function pr(e){var s;const t=Qt((s=e.category)==null?void 0:s.name),a=Za(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function es(e){var r,n;const t=Qt((r=e.category)==null?void 0:r.name),a=Za(t),s=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(s)}</span>`}function hp(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(s=>s.date).sort((s,r)=>s.localeCompare(r));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function ts(e){const{startDate:t,endDate:a}=hp(e);return t===a?se(t):`${se(t)} - ${se(a)}`}function bp(e){return e.stageId>0}async function gr(){const[e,t]=await Promise.all([H.getGameState(),H.getGameStatus()]);if(!e.success){console.error(e.error);return}d.gameState=e.data??null,d.gameStatus=t.success?t.data??null:null,yp(),ye("dashboard")&&as()}function yp(){var r;if(!d.gameState)return;h("meta-date").textContent=d.gameState.formattedDate,h("meta-season").textContent=`Saison ${d.gameState.season}`;const e=h("meta-race-hint"),t=h("btn-advance-day"),a=h("pending-stages-list"),s=((r=d.gameStatus)==null?void 0:r.pendingStages)??[];s.length>0?(e.textContent=`${s.length} offene Etappe${s.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=s.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${se(n.date)}`:`${n.profile} · ${se(n.date)}`,o=bp(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
  ...
  `,r.length===0?n+=`
    ...
    </div>`}async function Ps(e){dt(e)&&(d.selectedDashboardRaceId=e,wp(),je("raceStages"))}function Rp(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
    ...
    </div>`}async function hr(e){const t=d.riders.find(s=>s.id===e);h("rider-program-title").textContent=t?Fe(t):"Programm",h("rider-program-meta").textContent="Lade Programmrennen ...",h("rider-program-body").innerHTML="",je("riderProgram");const a=await H.getRiderProgramRaces(e);if(!a.success||!a.data){h("rider-program-meta").textContent="",h("rider-program-body").innerHTML=`<div class="results-empty">${S(a.error??"Programm konnte nicht geladen werden.")}</div>`;return}h("rider-program-title").textContent=a.data.program.name,h("rider-program-meta").textContent=t?Fe(t):"",h("rider-program-body").innerHTML=Rp(a.data)}function Ip(e){if(e.length===0)return'<div class="results-empty">Keine Programmfahrer für dieses Rennen.</div>';const t=Ep(e);return`
    <div class="dashboard-race-stages-table-wrap">
        ...
        <tbody>
          ${t.map(a=>{var s,r;return`
            <tr class="race-participants-row">
              ...
              <td><span class="race-participant-rider-cell">${ne(St(a.rider))}<strong>${S(Fe(a.rider))}</strong></span></td>
              <td>${S(Ls(a.rider))}</td>
              <td>${S(lt(a.rider))}</td>
    ...
    </th>`}function Ep(e){const t=d.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,s)=>{var n,i,o,c;let r=0;switch(d.raceParticipantsSort.key){case"team":r=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=s.team)==null?void 0:i.name)??"","de");break;case"rider":r=Fe(a.rider).localeCompare(Fe(s.rider),"de");break;case"spec1":r=Ls(a.rider).localeCompare(Ls(s.rider),"de");break;case"role":r=lt(a.rider).localeCompare(lt(s.rider),"de");break;case"overall":r=a.rider.overallRating-s.rider.overallRating;break;case"phase":r=(a.rider.seasonFormPhase??"neutral").localeCompare(s.rider.seasonFormPhase??"neutral","de");break;default:r=(((o=a.program)==null?void 0:o.name)??"").localeCompare(((c=s.program)==null?void 0:c.name)??"","de")}return r*t||Fe(a.rider).localeCompare(Fe(s.rider),"de")})}function Ls(e){return e.specialization1!=null?Ot(e.specialization1):"–"}async function $o(e){const t=dt(e);d.selectedRaceParticipantsRaceId=e,h("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",h("race-participants-meta").textContent="Lade Programmfahrer ...",h("race-participants-body").innerHTML="",d.raceParticipants=[],je("raceParticipants"),await To()}async function To(e=!1){const t=d.selectedRaceParticipantsRaceId;if(t==null)return;const a=dt(t);e&&(h("race-participants-meta").textContent="Lade Programmfahrer ...");const s=await H.getRaceProgramParticipants(t);if(!s.success||!s.data){h("race-participants-meta").textContent="",h("race-participants-body").innerHTML=`<div class="results-empty">${S(s.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}d.raceParticipants=s.data,h("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",h("race-participants-meta").textContent=`${s.data.length} Programmfahrer · ${a?ts(a):""}`,h("race-participants-body").innerHTML=Ip(d.raceParticipants)}async function xo(e,t=null){const a=La(e);if(!a)return;const s=await Mp(e);if(!s){alert(d.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}d.selectedDashboardProfileStageId=e,h("stage-profile-title").textContent=`${a.race.name} · ${na(a.stage)}`;const r=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";h("stage-profile-meta").textContent=`${se(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?$s(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?Ts(a.stage.elevationGainMeters):"–"}${r}`,ml(h("stage-profile-view"),s,a.stage.profile,ss(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),je("stageProfile")}function Fp(){h("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const r=Number(t.dataset.editStageRoster);if(!Number.isFinite(r))return;pp(r);return}const a=e.target.closest("button[data-live-stage]");if(a){const r=Number(a.dataset.liveStage);if(!Number.isFinite(r))return;So(r,!0);return}const s=e.target.closest("button[data-instant-stage]");if(s){const r=Number(s.dataset.instantStage);if(!Number.isFinite(r))return;fo(r)}}),h("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const r=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(r)&&$o(r);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const s=Number(a.dataset.dashboardRaceId);Number.isFinite(s)&&Ps(s)}),h("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&xo(a)}),h("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const r=Number(t.dataset.riderProgramId);Number.isFinite(r)&&hr(r);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const s=a.dataset.raceParticipantsSort;d.raceParticipantsSort.key===s?d.raceParticipantsSort.direction=d.raceParticipantsSort.direction==="asc"?"desc":"asc":d.raceParticipantsSort={key:s,direction:"asc"},To()}),h("btn-advance-day").addEventListener("click",async()=>{await Mo()}),h("btn-auto-progress").addEventListener("click",()=>{Cp()})}async function Mo(){ve("Tag wird fortgeschrieben...");try{const e=await H.advanceDay();if(!e.success)return alert(`Tageswechsel fehlgeschlagen:
`+(e.error??"Unbekannter Fehler")),!1;if(d.currentSave&&e.data&&(d.currentSave.currentSeason=e.data.season),await gr(),await fr(),ye("teams")){const{refreshTeamsViewData:t}=await Vn(async()=>{const{refreshTeamsViewData:a}=await Promise.resolve().then(()=>up);return{refreshTeamsViewData:a}},void 0);await t()}return!0}catch(e){return alert("Unerwarteter Fehler beim Tageswechsel: "+e.message),!1}finally{ge()}}function br(){const e=document.getElementById("btn-auto-progress");e&&(at?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function Cp(){at?wo():Np()}function Np(){at||(_s(!0),br(),Pp())}function wo(){at&&(_s(!1),br())}async function Pp(){var e;for(;at;){const t=((e=d.gameStatus)==null?void 0:e.pendingStages)??[];let a=!1;if(t.length>0){const s=t[0];a=await fo(s.stageId,!0)}else a=await Mo();if(!a){_s(!1);break}await new Promise(s=>setTimeout(s,100))}br()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&at){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),wo()}});const Zt=50;function yr(){return[...ir,...or[d.riderMenuDetailPage]]}function Ro(e){return d.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${d.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function Io(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=d.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </div>`}function Fa(){const e=h("riders-detail"),t=yr(),a=uo(d.riders),s=a.length,r=Math.max(1,Math.ceil(s/Zt));d.riderMenuPage=Math.min(r,Math.max(1,d.riderMenuPage));const n=(d.riderMenuPage-1)*Zt,i=Math.min(s,n+Zt),o=a.slice(n,i);e.innerHTML=`
    <div class="team-detail-card">
      <div class="team-detail-header">
        <h3>Alle Fahrer</h3>
      </div>
      ...
      <section class="rider-team-editor-main">
        <div class="team-detail-card">
          <div class="rider-team-editor-toolbar">
            ...
            <div class="team-detail-meta">
              <span>${i}</span>
              <span class="text-muted">Sortierung: ${S(d.riderTeamEditorSort.key==="teamName"?"Team":((o=xa.find(c=>c.key===d.riderTeamEditorSort.key))==null?void 0:o.title)??d.riderTeamEditorSort.key)} ${d.riderTeamEditorSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
          ...
          <div class="team-detail-table-scroll rider-team-editor-table-scroll">
            <table class="data-table data-table-teams rider-team-editor-table">
              ...
              <tbody>
                ${r.length===0?`<tr><td colspan="${xa.length}" class="text-muted">${d.riderTeamEditorSelectedTeamKey?"Keine Fahrer im aktuellen Team.":"Bitte zuerst ein Team im Dropdown auswählen."}</td></tr>`:r.map(c=>`
                    <tr class="team-detail-row${Co(c.riderId)?" rider-team-editor-row-dirty":""}">
                      ${xa.map(l=>Wp(c,l)).join("")}
                    </tr>
                  `).join("")}
              </tbody>
            </table>
...
${e.error??"Unbekannter Fehler"}`),Ne();return}xs(e.data.fileName,e.data.content),Ne()}function Zp(){h("view-rider-team-editor").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-team-editor-sort]");if(t){const r=t.dataset.riderTeamEditorSort;d.riderTeamEditorSort.key===r?d.riderTeamEditorSort.direction=d.riderTeamEditorSort.direction==="asc"?"desc":"asc":d.riderTeamEditorSort={key:r,direction:Ap(r)},Ne();return}const a=e.target.closest("button[data-rider-team-editor-team-filter]");if(a){d.riderTeamEditorSelectedTeamKey=a.dataset.riderTeamEditorTeamFilter??"",Ne();return}const s=e.target.closest("button[data-rider-team-editor-action]");if(s){const r=s.dataset.riderTeamEditorAction;if(r==="reload"){No(!0);return}if(r==="export"){Yp();return}r==="save"&&Up()}}),h("view-rider-team-editor").addEventListener("change",e=>{const t=e.target.closest("#rider-team-editor-team-select");if(t){d.riderTeamEditorSelectedTeamKey=t.value,Ne();return}const a=e.target.closest(".rider-team-editor-input");if(a){const s=Number(a.dataset.riderTeamEditorRiderId),r=a.dataset.riderTeamEditorField;Number.isFinite(s)&&r&&Vp(s,r,a.value)}})}let Xe={key:"pickNumber",asc:!0};function Fn(e){const t=Math.max(0,Math.min(1,(e-50)/35)),a=Math.round(6+t*118),s=.26+t*.18,r=.14+t*.12;return`--rider-stats-pill-hue:${a};--rider-stats-pill-border-alpha:${s};--rider-stats-pill-bg-alpha:${r};`}async function Po(e,t=!1){const a=await H.getDraftHistory(e);if(!a.success){d.draftHistory=null,ye("draft")&&Ds(),!t&&a.error&&alert(`Draft Historie konnte nicht geladen werden:
`+a.error);return}d.draftHistory=a.data??null,ye("draft")&&Ds()}function Ds(){const e=h("draft-table-container"),t=h("draft-season-select");if(!d.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(t.options.length===0){const i=d.currentSave.startSeason??2026;for(let o=d.currentSave.currentSeason;o>=i;o--){const c=document.createElement("option");c.value=o.toString(),c.textContent=`Saison ${o}`,t.appendChild(c)}d.draftSelectedSeason||(d.draftSelectedSeason=d.currentSave.currentSeason),t.value=d.draftSelectedSeason.toString(),t.onchange=o=>{const c=o.target;d.draftSelectedSeason=parseInt(c.value,10),Po(d.draftSelectedSeason)}}if(!d.draftHistory){e.innerHTML='<div class="alert alert-info">Lade Draft Historie...</div>';return}if(d.draftHistory.rows.length===0){e.innerHTML='<div class="alert alert-info">Keine Draft-Einträge für diese Saison vorhanden.</div>';return}const a=[...d.draftHistory.rows].sort((i,o)=>{let c=0;const l=Xe.key;return l==="riderLastName"?c=i.riderLastName.localeCompare(o.riderLastName):l==="teamName"?c=i.teamName.localeCompare(o.teamName):l==="oldTeamName"?c=(i.oldTeamName||"").localeCompare(o.oldTeamName||""):l==="countryCode"?c=i.countryCode.localeCompare(o.countryCode):c=(i[l]??0)-(o[l]??0),Xe.asc?c:-c}),s=i=>Xe.key!==i?'<span class="sort-icon-placeholder"></span>':Xe.asc?" ▲":" ▼",r=i=>{Xe.key===i?Xe.asc=!Xe.asc:(Xe.key=i,Xe.asc=!0),Ds()};window.setDraftSort=r;let n=`
  ...
  `;for(const i of a){const o=d.draftHistory.season-i.riderBirthYear;let c="-";i.oldTeamName&&(c=`<div style="display:flex; align-items:center; gap:0.5rem;">${vt(i.oldTeamId,i.oldTeamName)} ${S(i.oldTeamName)}</div>`);const l=`<div style="display:flex; align-items:center; gap:0.5rem;">${vt(i.teamId,i.teamName)} ${S(i.teamName)}</div>`;n+=`
      <tr>
        ...
        <td class="text-center"><span class="rider-stats-summary-pill rider-stats-summary-pill-heat" style="${Fn(i.overallAtDraft)}">${i.overallAtDraft.toFixed(1)}</span></td>
        <td class="text-center"><span class="rider-stats-summary-pill rider-stats-summary-pill-heat" style="${Fn(i.potOverallAtDraft)}">${i.potOverallAtDraft.toFixed(1)}</span></td>
      </tr>
...
`+t.error);return}d.injuries=t.data??[],ye("injuries")&&Cn()}function Cn(){const e=h("injuries-table-container");if(!d.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(h("injuries-meta").textContent=d.injuries.length+" Ausfälle",d.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=At;let t="";const a=d.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),s=new Map;for(const n of a){const i=n.teamId;s.has(i)||s.set(i,[]),s.get(i).push(n)}for(const n of s.keys())s.get(n).sort((i,o)=>o.overallRating-i.overallRating);const r=Array.from(s.keys()).sort((n,i)=>{const o=s.get(n)[0].teamAbbreviation||"",c=s.get(i)[0].teamAbbreviation||"";return o.localeCompare(c)});if(r.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of r){const i=s.get(n),o=i[0].teamAbbreviation;t+=`
      ...
      `;for(const c of i){const l=c.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let p="";if(c.fitDate){const u=se(c.fitDate);if(c.missedRaces&&c.missedRaces.length>0){let m="";for(const f of c.missedRaces)m+=`
          ...
          <tr>
            ...
            <td>${c.age}</td>
            <td><span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;">${Ji(c.overallRating)}</span></td>
            <td>${l}</td>
    ...
    <div class="season-standings-country-popover-card">
      ...
      ${a.map(s=>`
        <div class="season-standings-country-popover-grid">
          ...
          <span class="season-standings-country-rider-name">${Ee(s.riderName??"–",{riderId:s.riderId,teamId:s.teamId,strong:!1})}</span>
  ...
  `,je("teamStats");const r=await H.getTeamStats(e);if(d.teamStatsSelectedTeamId===e){if(!r.success||!r.data){h("team-stats-body").innerHTML=`
    ...
    `;let l="",p=1;for(const g of i){const b=p++,v=`<span class="badge ${b===1?"badge-primary":b<=3?"badge-secondary":"badge-ghost"}" style="min-width: 28px; text-align: center; display: inline-block;">${b}</span>`,x=vt(g.teamId,g.teamName);let w="";if(o){const $=g.stageNumber!=null?`Etappe ${g.stageNumber}`:"–";w=`<td style="vertical-align: middle;">${S(g.raceName??"–")} · ${S($)} · ${S(String(g.season??"–"))}</td>`}let T="";if(c)if(g.lieutenantDetails){const $=g.lieutenantDetails,R=$.leaderNationality?ne($.leaderNationality):"",I=$.leaderRoleName?` (${$.leaderRoleName})`:"";T=`
      ...
      `}).join(""),p=o.map(u=>{var w;const m=u.race,f=a>=m.startDate&&a<=m.endDate,g=a>m.endDate,b=Qt((w=m.category)==null?void 0:w.name),y=f?'<span class="calendar-live-dot"></span>':"",v=g?"opacity: 0.55;":"",x=u.endIdx-u.startIdx+1;return`
    ...
    `}t.innerHTML=s,Ao()}function Ao(){var n;const e=h("calendar-race-search"),t=e?e.value.toLowerCase().trim():"",a=h("calendar-races-tbody"),s=((n=d.gameState)==null?void 0:n.currentDate)??"",r=d.races.filter(i=>{var o;return t?i.name.toLowerCase().includes(t)||((o=i.category)==null?void 0:o.name)&&i.category.name.toLowerCase().includes(t):!0}).sort((i,o)=>i.startDate.localeCompare(o.startDate));if(r.length===0){a.innerHTML='<tr><td colspan="9" class="text-muted" style="text-align: center; padding: 20px;">Keine Rennen gefunden.</td></tr>';return}a.innerHTML=r.map(i=>{var y,v,x,w;const o=s>=i.startDate&&s<=i.endDate,l=s>i.endDate?'<span class="badge badge-done">Abgeschlossen</span>':o?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',p=((y=i.country)==null?void 0:y.name)??`Land ${i.countryId}`,u=(v=i.country)!=null&&v.code3?ne(i.country.code3):"",m=i.isStageRace?(i.stages??[]).reduce((T,$)=>T+($.distanceKm??0),0):((x=i.upcomingStage)==null?void 0:x.distanceKm)??null,f=i.isStageRace?(i.stages??[]).reduce((T,$)=>T+($.elevationGainMeters??0),0):((w=i.upcomingStage)==null?void 0:w.elevationGainMeters)??null,g=m!=null?String(m.toFixed(1)).replace(".",","):"-",b=f!=null?String(Math.round(f)):"-";return`
