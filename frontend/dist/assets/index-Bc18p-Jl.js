(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();function Bn(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function vs(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function ea(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function Ja(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function Fe(e,t={}){const a=t.strong===!1?"span":"strong",s=vs("app-rider-link-label",t.labelClassName),r=`<${a} class="${s}">${Bn(e)}</${a}>`;if(t.riderId==null)return r;const n=['type="button"','class="'+vs("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${r}</button>`}function nt(e,t,a=!0,s=""){const r=a===!1?"span":"strong",n=`<${r} class="app-team-link-label">${Bn(e)}</${r}>`;return t==null?n:`<button type="button" class="${vs("app-team-link",s)}" data-team-id="${t}">${n}</button>`}const d={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,draftHistory:null,injuries:null,draftSelectedSeason:null,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1,autoProgressTargetDate:null};let jt=null;function Go(e){jt=e}let _s=!1;function Tr(e){_s=e}let _n=null;function xr(e){_n=e}let Ss=null;function Mr(e){Ss=e}let at=!1;function Gn(e){at=e}function h(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function se(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function La(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),s=Math.floor(e%60),r=String(a).padStart(2,"0"),n=String(s).padStart(2,"0");return t>0?`${t}:${r}:${n}`:`${a}:${n}`}function is(e){return e==null||e===0?"–":`+${La(e)}`}const Ra=2,ks=3,Hn=4;function zn(e){return`/jersey/Jer_${e}.png`}function vt(e,t){var s;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((s=d.teams.find(r=>r.id===e))==null?void 0:s.name)??`Team ${e}`;return`
  ...
  `).join("")}async function Jo(e){ve("Karriere wird geladen…");const t=await H.loadSave(e);if(ge(),!t.success){alert("Fehler beim Laden: "+t.error);return}d.currentSave=t.data??null,await _o()}async function qo(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;ve("Löschen…");const a=await H.deleteSave(e);if(ge(),!a.success){alert("Fehler: "+a.error);return}await ta()}async function Xo(){const e=await H.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){h("btn-delete-all-careers").classList.add("hidden"),h("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){ve("Alle Karrieren werden gelöscht…");try{for(const a of t){const s=await H.deleteSave(a.filename);if(!s.success){alert(`Fehler beim Löschen von "${a.careerName}": ${s.error??"Unbekannter Fehler"}`);break}}}finally{ge()}await ta()}}function Qo(){h("btn-new-career").addEventListener("click",async()=>{var r;qt("new-career-error"),h("input-career-name").value="";const a=h("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',je("newCareer");const s=await H.getAvailableTeams();if(!s.success||!((r=s.data)!=null&&r.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=s.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),h("btn-cancel-new").addEventListener("click",()=>ze("newCareer")),h("btn-confirm-new").addEventListener("click",async()=>{const a=h("input-career-name").value.trim(),s=h("input-team-id").value;if(!a||!s){ht("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const r=Number(s),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;qt("new-career-error"),ve("Neue Karriere wird erstellt…");const o=await H.createSave(i,a,r);if(!o.success){ge(),ht("new-career-error",o.error??"Unbekannter Fehler.");return}const c=await H.loadSave(i);if(ge(),ze("newCareer"),!c.success){alert("Fehler: "+c.error);return}d.currentSave=c.data??null,await _o()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>ta());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{Xo()}),h("saves-list").addEventListener("click",async a=>{const s=a.target.closest("button[data-save-action]");if(!s)return;const{saveAction:r,filename:n,careerName:i}=s.dataset;if(n){if(r==="load"){await Jo(n);return}r==="delete"&&await qo(n,i??n)}})}const el="modulepreload",tl=function(e){return"/"+e},Fr={},Un=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));r=Promise.allSettled(a.map(c=>{if(c=tl(c),c in Fr)return;Fr[c]=!0;const l=c.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":el,l||(u.as="script"),u.crossOrigin="",u.href=c,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((m,f)=>{u.addEventListener("load",m),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})},al={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function sl(e){const t=al[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const rl=200;function zs(e){if(e.length===0)return[];const t=[];for(const a of e){const s=t[t.length-1];if(!s||Math.abs(s.distanceMeter-a.distanceMeter)>=rl){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}s.riderIds.push(...a.riderIds),s.riderCount+=a.riderCount,s.distanceSum+=a.distanceMeter*a.riderCount,s.distanceMeter=s.distanceSum/s.riderCount}return t.map(({distanceSum:a,...s})=>s)}function Ks(e){if(e.length===0)return[];let t=0;for(let r=1;r<e.length;r+=1)e[r].riderCount>e[t].riderCount&&(t=r);let a=0,s=0;return e.map((r,n)=>{const i=n===t;let o;return i?o="P":n<t?(a+=1,o=`E${a}`):(s+=1,o=`A${s}`),{...r,label:o,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-r.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,r.distanceMeter-e[n+1].distanceMeter):null}})}function nl(e,t=null){var a,s,r;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((s=e.find(n=>n.label==="P"))==null?void 0:s.label)??((r=e[0])==null?void 0:r.label)??null}function ct(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function Er(e,t,a,s){return`${s.type}:${e}:${t}:${a}`}function il(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:ct(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function Ye(e){const t=[];e.segments.forEach((r,n)=>{const i=n*2;(r.start_markers??[]).forEach((o,c)=>{t.push({key:Er(n,"start",c,o),label:"",marker:o,kmMark:r.start_km,elevation:r.start_elevation,boundary:"start",sequence:i+c/100})}),(r.end_markers??[]).forEach((o,c)=>{t.push({key:Er(n,"end",c,o),label:"",marker:o,kmMark:r.end_km,elevation:r.end_elevation,boundary:"end",sequence:i+1+c/100})})});const a=t.sort((r,n)=>r.kmMark-n.kmMark||r.sequence-n.sequence),s=new Map;return a.map(r=>{const n=(s.get(r.marker.type)??0)+1;return s.set(r.marker.type,n),{...r,label:r.marker.name??il(r.marker,n)}})}function ol(e){const t=Ye(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>ct(a)).length}}function Lt(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ll(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function Ae(e,t,a,s){return t<=0?s:s+e/t*(a-s*2)}function Aa(e,t){const a=t/1e3,s=e.points;if(a<=s[0].kmMark)return s[0].elevation;for(let r=0;r<s.length-1;r+=1){const n=s[r],i=s[r+1];if(a>i.kmMark)continue;const o=Math.max(1e-4,i.kmMark-n.kmMark),c=(a-n.kmMark)/o;return n.elevation+(i.elevation-n.elevation)*c}return s[s.length-1].elevation}function Yn(e){const t=e.points.map(p=>p.elevation),a=Math.min(...t),s=Math.max(...t),r=Math.max(1,s-a),n=Math.max(40,r*.08),i=Math.max(0,a-n),o=s+n;let c=Math.floor(i/50)*50,l=Math.ceil(o/50)*50;return l<=c&&(l=c+100),{axisMinElevation:c,axisMaxElevation:l}}function Oe(e,t,a,s,r,n){const i=Math.max(1,a-t);return s-n-(e-t)/i*(s-r-n)}function Vt(e){return`${Math.round(e)} m`}function Cr(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function Nr(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function Zn(e,t,a,s,r,n,i,o,c){var g;const l=[],p=[];let u=null,m="#b91c1c";for(const b of Ye(e)){const{marker:y,kmMark:v,elevation:T}=b;if(y.type==="climb_start"){p.push({kmMark:v,elevation:T,name:y.name});continue}if(ct(y)){let w=-1;for(let I=p.length-1;I>=0;I-=1)if(y.name&&((g=p[I])==null?void 0:g.name)===y.name){w=I;break}const x=w>=0?p.splice(w,1)[0]:p.pop();x&&Math.max(0,v-x.kmMark),x&&Math.max(0,T-x.elevation);const $=Nr(y.cat,y.type),R=Cr(y.cat);if(y.type==="finish_hill"||y.type==="finish_mountain"){u=y.cat??null,m=$.accentColor;continue}l.push({x:Ae(v*1e3,t,a,s),anchorY:Oe(T,o,c,r,n,i),primaryLabel:R??"Berg",secondaryLabel:Vt(T),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:$.accentColor});continue}if(y.type==="sprint_intermediate"){const w=Nr(y.cat,y.type);l.push({x:Ae(v*1e3,t,a,s),anchorY:Oe(T,o,c,r,n,i),primaryLabel:"Sprint",secondaryLabel:Vt(T),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:w.accentColor})}}const f=e.points[e.points.length-1];return l.push({x:Ae(f.kmMark*1e3,t,a,s),anchorY:Oe(f.elevation,o,c,r,n,i),primaryLabel:u?`${Cr(u)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:Vt(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:m}),l.sort((b,y)=>b.x-y.x)}function Jn(e,t,a){const s=t+4,r=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
    ...
    </g>`}function qn(e,t){const a=new Set,s=t/1e3;for(let r=0;r<=s;r+=25)a.add(Math.round(r*1e3));return a.add(Math.round(t)),[...a].filter(r=>r>=0&&r<=t).sort((r,n)=>r-n)}function Xn(e,t,a,s,r,n){const i=new Set(Ye(t).map(o=>Math.round(o.kmMark*1e3)));return e.map(o=>{const c=Ae(o,a,s,r),p=i.has(o)?18:12,u=n+p+26;return`
      ...
      </g>`}).join("")}function dl(e,t,a,s,r,n,i,o,c,l,p){const u=Ae(e.distanceMeter,a,s,n),m=Aa(t,e.distanceMeter),f=Oe(m,c,l,r,i,o),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),b=e.riderCount>1?`<text x="${u.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${b}
    </g>`}function cl(e,t,a,s,r,n,i,o,c,l,p){const u=new Map(p.riders.map(f=>[f.id,f])),m=new Map((p.teams??[]).map(f=>[f.id,f.abbreviation]));return e.filter(f=>f.riderCount===1).map(f=>{const g=f.riderIds[0];if(g==null)return"";const b=u.get(g);if(!b)return"";const y=Ae(f.distanceMeter,a,s,n),v=Aa(t,f.distanceMeter),T=Oe(v,c,l,r,i,o),w=b.activeTeamId!=null?m.get(b.activeTeamId)??"":"",x=`${b.lastName} (${w})`,$=T-34,R=T-40;return`
        ...
        </g>`}).join("")}function ul(e,t,a,s,r,n,i,o,c,l,p){const u=Math.max(0,Math.min(l,e.distanceKm)),m=Math.max(0,Math.min(p,e.distanceKm));if(m<=u)return null;const f=[{kmMark:u,elevation:Aa(e,u*1e3)},...e.points.filter(T=>T.kmMark>u&&T.kmMark<m),{kmMark:m,elevation:Aa(e,m*1e3)}];if(f.length<2)return null;const g=r-i,b=f.map((T,w)=>{const x=Ae(T.kmMark*1e3,t,a,s),$=Oe(T.elevation,o,c,r,n,i);return`${w===0?"M":"L"} ${x.toFixed(1)} ${$.toFixed(1)}`}).join(" "),y=Ae(u*1e3,t,a,s),v=Ae(m*1e3,t,a,s);return`${b} L ${v.toFixed(1)} ${g.toFixed(1)} L ${y.toFixed(1)} ${g.toFixed(1)} Z`}function ml(e,t,a,s,r={}){const p=e.distanceKm*1e3,{axisMinElevation:u,axisMaxElevation:m}=Yn(e),f=533,g=12,y=e.points.map(I=>{const C=Ae(I.kmMark*1e3,p,1584,28),F=Oe(I.elevation,u,m,634,168,101);return{x:C,y:F}}).map((I,C)=>`${C===0?"M":"L"} ${I.x.toFixed(1)} ${I.y.toFixed(1)}`).join(" "),v=`${y} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,T=r.selectedClimbRange!=null?ul(e,p,1584,28,634,168,101,u,m,r.selectedClimbRange.startKm,r.selectedClimbRange.endKm):null,w=Zn(e,p,1584,28,634,168,101,u,m).map(I=>Jn(I,g,f)).join(""),$=Array.from({length:5},(I,C)=>u+(m-u)/4*C).map(I=>{const C=Oe(I,u,m,634,168,101);return`
      ...
      <text x="${14 .toFixed(1)}" y="${(C+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Vt(I)}</text>`}).join(""),R=Xn(qn(e,p),e,p,1584,28,f);return`
    <svg viewBox="0 0 1584 634" role="img" aria-label="${Lt(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
    ...
    </svg>`}function pl(e,t,a,s,r){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${ml(t,a,s,!1,r)}</div>`}function gl(e,t,a,s,r,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const o=1584,c=634,l=28,p=168,u=101,{axisMinElevation:m,axisMaxElevation:f}=Yn(t),g=c-u,b=12,y=Array.from({length:5},(B,M)=>m+(f-m)/4*M),v=zs(a.clusters),T=Ks(v),w=qn(t,a.stageDistanceMeters),$=t.points.map(B=>{const M=Ae(B.kmMark*1e3,a.stageDistanceMeters,o,l),N=Oe(B.elevation,m,f,c,p,u);return{x:M,y:N}}).map((B,M)=>`${M===0?"M":"L"} ${B.x.toFixed(1)} ${B.y.toFixed(1)}`).join(" "),R=`${$} L ${(o-l).toFixed(1)} ${g.toFixed(1)} L ${l.toFixed(1)} ${g.toFixed(1)} Z`,I=Zn(t,a.stageDistanceMeters,o,l,c,p,u,m,f).map(B=>Jn(B,b,g)).join(""),C=y.map(B=>{const M=Oe(B,m,f,c,p,u);return`
      ...
      <text x="${(l-14).toFixed(1)}" y="${(M+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Vt(B)}</text>`}).join(""),F=Xn(w,t,a.stageDistanceMeters,o,l,g),P=new Map(v.map((B,M)=>[B,T[M]??null])),D=v.map(B=>{var M;return dl(B,t,a.stageDistanceMeters,o,c,l,p,u,m,f,((M=P.get(B))==null?void 0:M.label)===i)}).join(""),_=r.stage.profile==="ITT"?cl(v,t,a.stageDistanceMeters,o,c,l,p,u,m,f,r):"";e.innerHTML=`
    ...
    <span class="${t}" aria-hidden="true">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function lc(e){return e.riderId==null||e.riderTeamId==null?"":vi(e.riderTeamId)}function dc(e){const t=Dt(e.title);return e.riderId==null?`<strong class="race-sim-message-title">${t}</strong>`:`<button type="button" class="race-sim-message-title race-sim-message-rider-link" data-race-sim-group-rider-id="${e.riderId}">${t}</button>`}function cc(e,t){return`<button type="button" class="race-sim-message-inline-name race-sim-message-rider-link" data-race-sim-group-rider-name="${Dt(e)}"${t!=null?` data-race-sim-group-rider-team-id="${t}"`:""}>${Dt(e)}</button>`}function uc(e,t){if(t==="all")return!0;const a=Si(e);return t==="attack"?a==="attack"||a==="counter_attack":a===t}function mc(e){const t=e.detail?Dt(e.detail):"",a=(e.secondaryRiders??[]).map(r=>`${r.riderTeamId!=null?vi(r.riderTeamId,"race-sim-message-inline-jersey"):""}${cc(r.riderName,r.riderTeamId)}`).join(", ");if(!t&&a.length===0)return"";const s=a.length>0?`${t.length>0?" ":""}Reaktion: ${a}.`:"";return`<span class="race-sim-message-detail"> · ${t}${s}</span>`}function Si(e){return e.title.includes("stürzt")||e.title.includes("Sturz")?"crash":e.title.includes("Defekt")?"mechanical":e.title.includes("Ausreißer")?"breakaway":e.type}function qr(e,t,a="all"){const s=t.filter(n=>uc(n,a)),r=t.length===0?"Noch keine Events in dieser Etappe.":"Keine Meldungen in dieser Kategorie.";e.innerHTML=`
    ...
    <div class="race-sim-message-list">
      ${s.length===0?`<div class="race-sim-message-empty">${r}</div>`:s.map(n=>`
        <article class="race-sim-message-item" data-tone="${n.tone}" data-message-kind="${Dt(Si(n))}">
      ...
      `).join("")}
    </div>`}const pc=1,gc={Flat:12,Rolling:14,Hilly:16,Hilly_Difficult:17,Medium_Mountain:18,Mountain:23,High_Mountain:25,ITT:30,TTT:40,Cobble:18,Cobble_Hill:20};function fc(e){return Math.max(0,Math.round(e))}function ki(e){return e==="ITT"||e==="TTT"}function hc(e){return gc[e]??20}function bc(e,t){if(t.length===0)return null;const a=Math.min(...t);return!Number.isFinite(a)||a<=0?null:Math.floor(a*(1+hc(e)/100))}function yc(e,t){return e.stageTimeSeconds-t.stageTimeSeconds||t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function Xr(e,t){return t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function us(e,t){if(ki(t))return[...e].sort(yc);const a=[...e].sort((o,c)=>o.stageTimeSeconds-c.stageTimeSeconds||Xr(o,c)),s=[];let r=[],n=null;const i=()=>{s.push(...r.sort(Xr))};for(const o of a){if(r.length===0){r=[o],n=o.stageTimeSeconds;continue}if(n!=null&&o.stageTimeSeconds-n<=pc){r.push(o),n=o.stageTimeSeconds;continue}i(),r=[o],n=o.stageTimeSeconds}return r.length>0&&i(),s}function Z(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function vc(e){return`/jersey/Jer_${e}.png`}function aa(e,t){return e==null||e<=0?"—":`
  ...
  `).join("")}</div>`}function Xt(e,t){const a=e.riders.find(s=>s.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function Xa(e,t){const a=e.riders.find(n=>n.id===t),s=(a==null?void 0:a.activeTeamId)??null,r=s!=null?e.teams.find(n=>n.id===s)??null:null;return{teamId:s,teamName:(r==null?void 0:r.name)??null}}function Fc(e,t,a,s={}){const r=(t??[]).slice(0,s.limit??8);return r.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${r.map(n=>{var u;const i=n.riderId??0,o=Xa(e,i),c=Xt(e,i),l=((u=s.distanceGapsByRiderId)==null?void 0:u.get(i))??null,p=[s.distanceGapClassName??"",Tc(l)].filter(m=>m.length>0).join(" ");return`
    ...
    <details class="race-sim-overview-details ${a}" data-race-sim-overview-section="${s}" ${r?"open":""}>
      ...
      ${t}
    </details>`}function Ha(e,t,a,s){const r=new Map(t.map(n=>[n.riderId,n]));return e.riders.map(n=>{var c;const i=r.get(n.id)??null,o=((c=a.get(n.id))==null?void 0:c[s])??0;return{riderId:n.id,rank:(i==null?void 0:i.rank)??Number.MAX_SAFE_INTEGER,points:((i==null?void 0:i.points)??0)+o,timeSeconds:(i==null?void 0:i.timeSeconds)??null,gapSeconds:(i==null?void 0:i.gapSeconds)??null,stagePoints:o}}).sort((n,i)=>(i.points??0)-(n.points??0)||n.rank-i.rank||Xt(e,n.riderId).localeCompare(Xt(e,i.riderId),"de")).map((n,i)=>({...n,rank:i+1}))}function tn(e){const t=Ec(e)?e.stagePoints:0;return`${Z(kc("points"in e?e.points:null))}${t>0?`<span class="race-sim-classification-stage-gain"><span class="race-sim-classification-stage-gain-arrow">▲</span><span class="race-sim-classification-stage-gain-amount">+${Z(t)}</span></span>`:""}`}function Ec(e){return"stagePoints"in e&&typeof e.stagePoints=="number"}function an(e,t){if(t==null)return new Map;const a=e.riders.find(s=>s.riderId===t)??null;return a?new Map(e.riders.map(s=>[s.riderId,a.distanceCoveredMeters-s.distanceCoveredMeters])):new Map}function Cc(e,t){return e.stageSummary.segments.find(a=>t>=a.start_km&&t<=a.end_km)??e.stageSummary.segments.find(a=>a.end_km>=t)??e.stageSummary.segments[e.stageSummary.segments.length-1]??null}function Fa(e,t){var s;const a=(s=e.race.category)==null?void 0:s.bonusSystem;return!a||t==null||t==="Sprint"?[]:it(t==="HC"?a.pointsMountainHc:t==="1"?a.pointsMountainCat1:t==="2"?a.pointsMountainCat2:t==="3"?a.pointsMountainCat3:a.pointsMountainCat4)}function js(e){var s;const t=(s=e.race.category)==null?void 0:s.bonusSystem;if(!t||e.stage.profile==="TTT")return[];if(!e.race.isStageRace)return it(t.pointsOneDay);const a=!["ITT","TTT","Flat","Rolling","Hilly"].includes(e.stage.profile);return it(a?t.pointsMountainStage:t.pointsSprintFinish)}function Ti(e){var t,a;return e.stage.profile==="ITT"||e.stage.profile==="TTT"?[]:it((a=(t=e.race.category)==null?void 0:t.bonusSystem)==null?void 0:a.pointsSprintIntermediate)}function Nc(e,t,a){let s=null;for(const r of e.stageSummary.segments){const n=Math.max(t,r.start_km),i=Math.min(a,r.end_km),o=Math.max(0,i-n);if(o<=0)continue;const c={lengthKm:o,gradient:r.gradient_percent};(s==null||c.gradient>s.gradient||c.gradient===s.gradient&&c.lengthKm>s.lengthKm)&&(s=c)}return s}function ms(e,t,a,s=null){return e.entries.filter(r=>s==null||s.has(r.riderId)).map((r,n)=>({riderId:r.riderId,rank:r.rank,points:t[n]??0,pointsKind:a,crossingTimeSeconds:r.crossingTimeSeconds,gapSeconds:r.gapSeconds})).filter(r=>r.points>0)}function Os(e){const t=new Map;for(const a of e)for(const s of a.entries){const r=t.get(s.riderId)??{points:0,mountain:0};s.pointsKind==="mountain"?r.mountain+=s.points:r.points+=s.points,t.set(s.riderId,r)}return t}function Pc(e){return Ye(e.stageSummary).filter(({marker:t})=>t.type==="finish_flat"||t.type==="finish_TT"||t.type==="finish_hill"||t.type==="finish_mountain").sort((t,a)=>a.kmMark-t.kmMark)[0]??null}function za(e,t){const a=ki(e.stage.profile)?t.riderClockSeconds:t.finishTimeSeconds;return a!=null&&Number.isFinite(a)?fc(a):null}function Qa(e,t){const a=t.riders.filter(n=>n.finishStatus!=="dnf").map(n=>{const i=za(e,n);return i==null?null:{rider:n,stageTimeSeconds:i,photoFinishScore:n.photoFinishScore,riderId:n.riderId}}).filter(n=>n!=null);if(a.length===0)return[];const s=Math.min(...a.map(n=>n.stageTimeSeconds));if(!Number.isFinite(s)||s<=0)return us(a,e.stage.profile).map(n=>n.rider);const r=bc(e.stage.profile,a.map(n=>n.stageTimeSeconds));return r==null?us(a,e.stage.profile).map(n=>n.rider):us(a.filter(n=>n.stageTimeSeconds<=r),e.stage.profile).map(n=>n.rider)}function Lc(e,t){const a=js(e);return a.length===0?[]:Qa(e,t).map((s,r)=>({riderId:s.riderId,rank:r+1,points:a[r]??0,pointsKind:"points",crossingTimeSeconds:za(e,s),gapSeconds:null})).filter(s=>s.points>0)}function Dc(e,t){const a=Qa(e,t).slice(0,20),s=a[0]!=null?za(e,a[0])??0:0;return a.map((r,n)=>{const i=za(e,r)??0;return{riderId:r.riderId,rank:n+1,crossingTimeSeconds:i,gapSeconds:Math.max(0,i-s),photoFinishScore:r.photoFinishScore}})}function Ac(e,t){var a;return((a=Qa(e,t)[0])==null?void 0:a.riderId)??null}function Vs(e,t,a){var w,x;const s=Ye(e.stageSummary),r=e.stageSummary.distanceKm*.75,n=a.isFinished?new Set(Qa(e,a).map($=>$.riderId)):null,i=s.filter(({marker:$})=>$.type==="climb_start"),o=s.filter(({marker:$})=>ct($)).sort(($,R)=>$.kmMark-R.kmMark).map(($,R)=>{var j,A;const I=[...i].reverse().find(X=>X.kmMark<=$.kmMark)??null,C=Cc(e,$.kmMark),F=(I==null?void 0:I.kmMark)??(C==null?void 0:C.start_km)??$.kmMark,P=(I==null?void 0:I.elevation)??(C==null?void 0:C.start_elevation)??$.elevation,D=Math.max(0,$.kmMark-F),_=D>0?($.elevation-P)/(D*1e3)*100:(C==null?void 0:C.gradient_percent)??0,B=Nc(e,F,$.kmMark),M=t.find(X=>X.markerKey===$.key)??null,N=Fa(e,(M==null?void 0:M.markerCategory)??$.marker.cat??null),O=M?ms(M,N,"mountain",n):[],K=(M==null?void 0:M.markerCategory)??$.marker.cat??null;return{key:$.key,title:`${R+1}. Bergwertung`,label:$.label,categoryLabel:K?`Kat. ${K}`:null,categoryClassName:en(K),kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:D,averageGradient:_,steepestSegmentLengthKm:(B==null?void 0:B.lengthKm)??null,steepestSegmentGradient:(B==null?void 0:B.gradient)??null,highlightMeta:$.kmMark>=r,leaderRiderId:((j=O[0])==null?void 0:j.riderId)??((A=M==null?void 0:M.entries[0])==null?void 0:A.riderId)??null,displayBadges:ba(N,"mountain"),entries:O,timingEntries:(M==null?void 0:M.entries)??[],accent:"mountain"}}),c=s.filter(({marker:$})=>$.type==="sprint_intermediate").sort(($,R)=>$.kmMark-R.kmMark).map(($,R)=>{var P,D;const I=t.find(_=>_.markerKey===$.key)??null,C=Ti(e),F=I?ms(I,C,"points",n):[];return{key:$.key,title:`${R+1}. Zwischensprint`,label:$.label,categoryLabel:null,categoryClassName:null,kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!1,leaderRiderId:((P=F[0])==null?void 0:P.riderId)??((D=I==null?void 0:I.entries[0])==null?void 0:D.riderId)??null,displayBadges:ba(C,"points"),entries:F,timingEntries:(I==null?void 0:I.entries)??[],accent:"sprint"}}),l=Pc(e),p=Lc(e,a),u=l?t.find($=>$.markerKey===l.key)??null:null,m=u?ms(u,Fa(e,u.markerCategory),"mountain",n):[],f=js(e),g=u?Fa(e,u.markerCategory):[],b=e.stage.profile==="ITT"||e.stage.profile==="TTT"?Dc(e,a):(u==null?void 0:u.entries)??[],y=((w=p[0])==null?void 0:w.riderId)??((x=m[0])==null?void 0:x.riderId)??Ac(e,a),v={key:"finish",title:"Zielsprint",label:(l==null?void 0:l.label)??"Ziel",categoryLabel:u!=null&&u.markerCategory?`Kat. ${u.markerCategory}`:null,categoryClassName:en((u==null?void 0:u.markerCategory)??null),kmMark:(l==null?void 0:l.kmMark)??e.stageSummary.distanceKm,kmToFinish:0,climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!!(u!=null&&u.markerCategory),leaderRiderId:y,displayBadges:[...ba(f,"points"),...ba(g,"mountain")],entries:[...p,...m],timingEntries:b,accent:"finish"};return[...[...c,...o].sort(($,R)=>$.kmMark-R.kmMark||$.title.localeCompare(R.title,"de")),v].filter($=>$.entries.length>0||$.timingEntries.length>0||$.accent!=="finish"||l!=null||a.isFinished)}function Bc(e,t){const a=new Map(t.entries.map(n=>[n.riderId,n])),s=(e.stage.profile==="ITT"||e.stage.profile==="TTT")&&t.key==="finish"?20:15,r=t.timingEntries.length>0?[...t.timingEntries].sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId).slice(0,s):t.entries.slice(0,s).map(n=>({riderId:n.riderId,rank:n.rank,crossingTimeSeconds:n.crossingTimeSeconds??0,gapSeconds:n.gapSeconds??0,photoFinishScore:0,pointsAwarded:n.points})).sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId);return r.length===0?'<div class="race-sim-stage-points-popover-empty">Noch keine Punkte vergeben.</div>':`
    <div class="race-sim-stage-points-popover-list">
      ${r.map(n=>{const i=Xa(e,n.riderId),o=a.get(n.riderId)??null;return`
          <div class="race-sim-stage-points-popover-row">
            <strong>${n.rank}.</strong>
            ${aa(i.teamId,i.teamName)}
            ${sa(n.riderId,Xt(e,n.riderId),"race-sim-stage-scoring-name")}
            <strong>${n.rank===1?Z($i(n.crossingTimeSeconds)):Z(xc(n.gapSeconds))}</strong>
            ${o?`<strong class="race-sim-stage-points-value-${o.pointsKind}">${o.points}</strong>`:"<strong>—</strong>"}
          </div>`}).join("")}
    </div>`}function sn(e,t){var a;return((a=e==null?void 0:e.find(s=>s.riderId===t))==null?void 0:a.points)??0}function rn(e,t){var a;return((a=e.filter(s=>s.riderId!=null&&t.has(s.riderId)).sort((s,r)=>s.rank-r.rank||s.riderId-r.riderId)[0])==null?void 0:a.riderId)??null}function va(e,t,a){if(!(!t||e.some(s=>s.riderId===t.riderId))){if(e.length<25){e.push(t);return}e[a]=t}}function _c(e,t,a,s,r){const n=new Set(e.riderIds),i=new Map(t.riders.map(f=>[f.riderId,f])),c=e.riderIds.map(f=>i.get(f)??null).filter(f=>f!=null).sort((f,g)=>{var b,y;return(((b=a.get(f.riderId))==null?void 0:b.rank)??Number.MAX_SAFE_INTEGER)-(((y=a.get(g.riderId))==null?void 0:y.rank)??Number.MAX_SAFE_INTEGER)||f.riderName.localeCompare(g.riderName,"de")||f.riderId-g.riderId}).slice(0,25),l=i.get(rn(s,n)??-1)??null,p=i.get(rn(r,n)??-1)??null,u=l!=null&&!c.some(f=>f.riderId===l.riderId),m=p!=null&&!c.some(f=>f.riderId===p.riderId);return c.length>=25&&u&&m&&l.riderId!==p.riderId?(va(c,l,23),va(c,p,24),c):(va(c,l,24),va(c,p,24),c)}function Gc(e,t){const a=[];return t.gcLeaderRiderId===e&&a.push("gc"),t.mountainLeaderRiderId===e&&a.push("mountain"),t.pointsLeaderRiderId===e&&a.push("points"),t.youthLeaderRiderId===e&&a.push("youth"),a}function Hc(e){return e.includes("gc")?" is-gc-leader":e.includes("mountain")?" is-mountain-leader":e.includes("points")?" is-points-leader":e.includes("youth")?" is-youth-leader":""}function nn(e,t){return e==null?"—":`${t}${Math.round(e)} m`}function zc(e,t){const a=t.riders.filter(r=>e.riderIds.includes(r.riderId)).reduce((r,n)=>Math.max(r,n.distanceCoveredMeters),0),s=Math.max(0,t.leaderDistanceMeters-a);return s>0?`-${Math.round(s)} m`:"—"}function Kc(e,t,a,s,r,n,i){if(a.length===0||e.stage.profile==="ITT"||e.stage.profile==="TTT")return"";const o=nl(a,s),c=a.find(m=>m.label===o)??a[0],l=new Map(e.gcStandings.map(m=>[m.riderId,m])),p=Os(i),u=_c(c,t,l,r,n);return`
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-gap-row">
        <span>Vorne ${Z(nn(c.previousGapMeters,"-"))}</span>
        <span>Leader ${Z(zc(c,t))}</span>
        <span>Hinten ${Z(nn(c.nextGapMeters,"+"))}</span>
      </div>
      <div class="race-sim-group-grid">
        ${u.map((m,f)=>{const g=l.get(m.riderId)??null,b=Xa(e,m.riderId),y=p.get(m.riderId)??{points:0,mountain:0},v=sn(r,m.riderId),T=sn(n,m.riderId),w=Gc(m.riderId,e.classificationLeaders),x=w.length>0?w.map($=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[$]).join(", "):"";return`
    ...
    </section>`}function Wc(e,t,a,s){const r=Vs(t,a.markerClassifications,a),n=Os(r),i=Ha(t,t.pointsStandings,n,"points"),o=Ha(t,t.mountainStandings,n,"mountain"),c=Ks(zs(a.clusters));e.innerHTML=Kc(t,a,c,s,i,o,r)}function jc(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function Oc(e){const t=Ye(e.stageSummary),a=Ti(e)[0]??0,s=js(e)[0]??0,r=t.filter(({marker:n})=>ct(n)).reduce((n,{marker:i})=>n+(Fa(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+s,mountain:r}}function on(e){const t=Oc(e);return`
    ...
    </span>`}function Uc(e,t,a,s=null){const r=s??Vs(e,t,a);return r.length===0?`
    ...
    <section class="race-sim-mountain-primes-box">
      ...
      <div class="race-sim-mountain-primes-list">
        ${r.map(n=>{const i=n.leaderRiderId!=null?Xa(e,n.leaderRiderId):{teamId:null,teamName:null},o=n.leaderRiderId!=null?Xt(e,n.leaderRiderId):"Noch offen";return`
    ...
    </section>`}function Yc(e,t,a,s,r,n=new Set){var f,g;const i=Vs(a,s,r),o=Os(i),c=Ha(a,a.pointsStandings,o,"points"),l=Ha(a,a.mountainStandings,o,"mountain"),p=an(r,((f=a.gcStandings[0])==null?void 0:f.riderId)??null),u=an(r,((g=a.youthStandings[0])==null?void 0:g.riderId)??null),m=b=>!n.has(b);e.innerHTML=`
    ...
    <section class="race-sim-classifications-section">
      ...
      ${xt("Punktewertung",ya("Punktewertung","points",a,c,tn),"race-sim-overview-classification race-sim-overview-points","points",m("points"))}
  ...
  `}const ln=new WeakMap,Ve=new WeakMap,dn=new WeakMap,xi=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function Y(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Mi(e){return e<=0?"—":`+${Math.round(e)} m`}function Yt(e){const t=xi.format(e);return e>0?`+${t}`:t}function ps(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function ie(e){return xi.format(e)}function kt(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),s=Math.floor(t%3600/60),r=t%60;return`${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function wi(e){return`+${kt(e)}`}function Ri(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Us(e){return`${(e*3.6).toFixed(1)} km/h`}function Zc(e){return`${Yt(e)}%`}function Is(e){return`${e.toFixed(1).replace(".",",")} km`}function Ii(e){return`${Is(e.segmentStartKm)} - ${Is(e.segmentEndKm)}`}function Jc(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function Fi(e){return e.replace(/_/g," ")}function Ei(e){return Fi(e)}function qc(e){return Fi(e)}function Ci(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function Xc(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function Qc(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function Ni(e){return Ye(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||ct(t)).map(({key:t,label:a})=>({key:t,label:a}))}function eu(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function tu(e,t,a,s){var r;return a!=="ITT"&&a!=="TTT"?((r=s.get(t))==null?void 0:r.get(e.riderId))??null:e.splitTimes[t]??null}function Pi(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(r=>({label:r.key,displayLabel:r.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${r.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function au(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function su(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function Li(e){const t=ln.get(e);if(t)return t;const a=Ni(e),s={splitMarkers:a,columns:Pi(e,a,!1),riderById:new Map(e.riders.map(r=>[r.id,r])),teamById:new Map((e.teams??[]).map(r=>[r.id,r])),teamAbbreviationById:new Map((e.teams??[]).map(r=>[r.id,r.abbreviation])),teamNameById:new Map((e.teams??[]).map(r=>[r.id,r.name])),gcByRiderId:new Map((e.gcStandings??[]).map(r=>[r.riderId,r]))};return ln.set(e,s),s}function Di(e,t){const a=e.parentElement,s=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!s)return"";const r=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const l=document.createElement("div");return l.className="race-sim-leaderboard-toolbar",s.insertAdjacentElement("beforebegin",l),l})(),n=Ys(e),i=au(t),o=su(i,n),c=Ve.get(e);return(c==null?void 0:c.layoutKey)===o||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(l=>l.width).join(" ")),r.innerHTML=`
    <button
      type="button"
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,s.innerHTML=t.map(l=>ru(l,n)).join(""),Ve.set(e,{layoutKey:o,orderedRiderIds:(c==null?void 0:c.orderedRiderIds)??[],rowsByRiderId:(c==null?void 0:c.rowsByRiderId)??new Map,openDetailRiderId:(c==null?void 0:c.openDetailRiderId)??null,openTeamId:(c==null?void 0:c.openTeamId)??null})),o}function qe(e,t){e.textContent!==t&&(e.textContent=t)}function Sa(e,t){e.title!==t&&(e.title=t)}function ka(e,t){e.className!==t&&(e.className=t)}function $a(e,t,a){return e.lastValues[t]!==a}function Ta(e,t,a){e.lastValues[t]=a}function Ys(e){const t=dn.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return dn.set(e,a),a}function ru(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${Y(e.label)}">${Y(a)}</span>`;const s=!t.autoSort&&t.manualSortKey===e.sortKey,r=s?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
...
`)}function mu(e){return Yt(Math.max(-2.5,Math.min(2.5,e*2.5)))}function pu(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function _i(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${Y(e.riderName)}">${Y(e.riderName)}</button>`}function gu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId)??"—",r=a.get(e.activeTeamId)??s;return`<span class="race-sim-team-code" title="${Y(r)}">${Y(s)}</span>`}function Gi(e){return`/jersey/Jer_${e}.png`}function fu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId);if(!s)return"—";const r=a.get(e.activeTeamId)??s.name,n=Gi(e.activeTeamId);return`
    <span class="race-sim-team-visual" title="${Y(r)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function hu(e){return e.hasSuperform?'<span class="race-sim-special-form-dot race-sim-special-form-dot-good" title="Superform"></span>':e.hasSupermalus?'<span class="race-sim-special-form-dot race-sim-special-form-dot-bad" title="Supermalus"></span>':""}function bu(e,t,a,s){var n;if(a!=="ITT"&&a!=="TTT"){const i=(n=s.get(t))==null?void 0:n.get(e.riderId);return i!=null?`${i}.`:"—"}const r=e.splitTimes[t];return r!=null?kt(r):"—"}function Hi(e,t,a){const s=Bi(e,t),r=[{label:"Terrain / Skill",value:`${Ei(e.activeTerrain)} / ${qc(e.skillName)}`},{label:"Aktiver Abschnitt",value:Ii(e)},{label:"Segmenthöhe",value:Jc(e)},{label:"Basis",value:ie(e.baseSkill)},{label:"Team+",value:e.teamGroupBonus>0?`+${ie(e.teamGroupBonus)}`:"—"},{label:"S-Form",value:Yt((t==null?void 0:t.formBonus)??0)},{label:"R-Form",value:Yt((t==null?void 0:t.raceFormBonus)??0)},{label:"Fatigue",value:ps((t==null?void 0:t.fatigueMalus)??0)},{label:"Langzeit",value:ps((t==null?void 0:t.longTermFatigueMalus)??0)},{label:"Akut",value:ps((t==null?void 0:t.shortTermFatigueMalus)??0)},{label:"Stamina",value:ie(e.staminaPenalty)},{label:"HM",value:ie(e.elevationPenalty)},{label:"T-Form",value:Yt(e.dailyForm)},{label:"Zufall",value:mu(e.microForm)},{label:"M_grad",value:`x${e.gradientModifier.toFixed(2).replace(".",",")}`},{label:"M_wind",value:`x${e.windModifier.toFixed(2).replace(".",",")}`},{label:"Draft",value:`x${e.draftModifier.toFixed(2).replace(".",",")}`},{label:"Draft Pack",value:pu(e)},{label:"GC",value:a?String(a.rank):"—"},{label:"GC Gap",value:a?Ri(a.gapSeconds):"—"}];return`
    ...
    <span class="race-sim-team-visual" title="${Y(e.name)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function $u(e,t,a){const s=new Map;for(const r of e.riders){const n=a.get(r.riderId),i=n==null?void 0:n.activeTeamId;if(i==null)continue;const o=s.get(i)??[];o.push(r),s.set(i,o)}return t.teams.filter(r=>s.has(r.id)).map(r=>{const n=(s.get(r.id)??[]).slice().sort((p,u)=>u.effectiveSkill-p.effectiveSkill||p.riderId-u.riderId),i=n[0]??e.riders[0],o=Math.min(5,n.length),c=n.slice(0,o).reduce((p,u)=>p+u.effectiveSkill,0)/Math.max(o,1),l=Math.max(0,8-n.length);return{team:r,riders:n,representative:i,teamClockSeconds:(i==null?void 0:i.riderClockSeconds)??null,teamDistanceMeters:(i==null?void 0:i.distanceCoveredMeters)??0,teamEffectiveSkill:Math.max(1,c-l),teamSpeedMps:(i==null?void 0:i.currentSpeedMps)??0,splitTimes:(i==null?void 0:i.splitTimes)??{},finishedRiders:n.filter(p=>p.isFinished).length}}).sort((r,n)=>Ai(r.representative,n.representative,Ni(t))||r.team.id-n.team.id)}function Tu(e,t,a,s,r){return`
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${Y(e.team.name)}">
      ...
      <div class="race-sim-rider-detail-grid">
        ...
        <div class="race-sim-rider-detail-item"><span>Distanz</span><strong>${Y(Is(e.teamDistanceMeters/1e3))}</strong></div>
      </div>
      ...
      <article class="race-sim-row${y===0?" race-sim-row-leader":""}${v?" race-sim-row-detail-open":""}">
        <div class="race-sim-row-grid">
          ...
          <strong class="race-sim-gap">${Y(Mi(Math.max(0,u-b.teamDistanceMeters)))}</strong>
          <strong>${Y(b.teamClockSeconds!=null?kt(b.teamClockSeconds):wi(b.representative.startOffsetSeconds))}</strong>
          ${n.map(T=>`<strong>${Y(b.splitTimes[T.key]!=null?kt(b.splitTimes[T.key]):"—")}</strong>`).join("")}
          <strong class="race-sim-cell-effective-skill ${Ci(b.representative)}">${Y(ie(b.teamEffectiveSkill))}</strong>
    ...
    </div>`}function Yi(e,t,a,s,r,n,i,o){const c=o??es(e,t,a);return`
    ...
    <tr>
      ...
      <td>${Yi(c.profileScore,0,100,c.stageId,hm(c),rs({name:c.raceName},{stageNumber:c.stageNumber,profile:c.profile}))}</td>
      <td>${oa(c.profile)}</td>
      <td>${ft(c.distanceKm)}</td>
      <td>${Wi(c.elevationGainMeters)}</td>
...
`)}`),de();return}const t=h("stage-editor-new-race-checkbox").checked,a=h("stage-editor-program-checkbox").checked;let s;t&&(s={name:h("stage-editor-race-name").value.trim(),countryId:Number(h("stage-editor-race-country").value),categoryId:Number(h("stage-editor-race-category").value),isStageRace:Number(h("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(h("stage-editor-race-num-stages").value),startDate:h("stage-editor-race-start-date").value.trim(),endDate:h("stage-editor-race-end-date").value.trim(),prestige:Number(h("stage-editor-race-prestige").value)});let r;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');r=Array.from(n).map(i=>Number(i.value))}ve("CSV-Dateien werden erstellt……");try{const n=await H.exportStageRoute({metadata:um(),draft:d.stageEditorDraft,newRace:t,raceDetails:s,updatePrograms:a,programIds:r});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}Ms(n.data.stagesFileName,n.data.stagesCsv),Ms(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=h("stage-editor-stage-number"),o=Number(i.value)||1;i.value=String(o+1);const c=h("stage-editor-date"),l=c.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const y=new Date(l);y.setDate(y.getDate()+1);const v=y.getFullYear(),T=String(y.getMonth()+1).padStart(2,"0"),w=String(y.getDate()).padStart(2,"0");c.value=`${v}-${T}-${w}`}await Promise.all([Zi(!0),ym(!0)]);const p=Oi();h("stage-editor-stage-id").value=String(p),Et=p;const u=h("stage-editor-new-race-checkbox");u&&(u.checked=!1);const m=h("stage-editor-new-race-details");m&&(m.classList.add("hidden"),m.style.display="none");const f=h("stage-editor-program-checkbox");f&&(f.checked=!1);const g=h("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),Ct=Number(h("stage-editor-race-id").value),de()}finally{ge()}}function Nm(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",x=>{const $=x.target.closest("button[data-stage-editor-stages-sort]");if(!$)return;const R=$.dataset.stageEditorStagesSort;d.stageEditorStagesSort.key===R?d.stageEditorStagesSort.direction=d.stageEditorStagesSort.direction==="asc"?"desc":"asc":d.stageEditorStagesSort={key:R,direction:mm(R)},Kt()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",x=>{const $=x.target.closest("button[data-stage-editor-climbs-sort]");if(!$)return;const R=$.dataset.stageEditorClimbsSort;d.stageEditorClimbsSort.key===R?d.stageEditorClimbsSort.direction=d.stageEditorClimbsSort.direction==="asc"?"desc":"asc":d.stageEditorClimbsSort={key:R,direction:pm(R)},Wt()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{Fm()});const s=document.getElementById("btn-stage-editor-load-existing");s&&s.addEventListener("click",()=>{Em()});const r=document.getElementById("btn-stage-editor-export");r&&r.addEventListener("click",()=>{Cm()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",x=>{var R;const $=((R=x.target.files)==null?void 0:R[0])??null;h("stage-editor-file-hint").textContent=$?`${$.name} · ${($.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",x=>{const $=x.target,R=$.closest("tr[data-segment-index]"),I=$.dataset.field;if(!R||!I)return;const C=Number(R.dataset.segmentIndex);if(Number.isInteger(C)){if(I==="markerType"||I==="markerName"||I==="markerCat"){const F=Number($.dataset.markerIndex),P=$.dataset.markerScope;if(!Number.isInteger(F)||P!=="start"&&P!=="end")return;em(C,F,P,I,$.value);return}Mm(C,I,$.value)}}),i.addEventListener("click",x=>{const $=x.target.closest("button[data-segment-action]");if(!$)return;const R=Number($.dataset.segmentIndex);if(Number.isInteger(R)){if($.dataset.segmentAction==="insert"){wm(R);return}if($.dataset.segmentAction==="append"){Rm();return}if($.dataset.segmentAction==="add-marker"){const I=$.dataset.markerScope;if(I!=="start"&&I!=="end")return;tm(R,I);return}if($.dataset.segmentAction==="remove-marker"){const I=Number($.dataset.markerIndex),C=$.dataset.markerScope;if(!Number.isInteger(I)||C!=="start"&&C!=="end")return;am(R,I,C);return}$.dataset.segmentAction==="delete"&&Im(R)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(x=>{const $=document.getElementById(x);$&&$.addEventListener("change",()=>de())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(x=>{x.addEventListener("change",()=>de())});const c=h("stage-editor-new-race-checkbox"),l=h("stage-editor-new-race-details"),p=h("stage-editor-program-checkbox"),u=h("stage-editor-program-details");c&&c.addEventListener("change",()=>{c.checked?(l&&(l.classList.remove("hidden"),l.style.display="grid"),p&&(p.checked=!0,u&&(u.classList.remove("hidden"),u.style.display="block"))):l&&(l.classList.add("hidden"),l.style.display="none"),de()}),p&&p.addEventListener("change",()=>{p.checked?u&&(u.classList.remove("hidden"),u.style.display="block"):u&&(u.classList.add("hidden"),u.style.display="none"),de()});const m=h("stage-editor-programs-dropdown-trigger"),f=h("stage-editor-programs-dropdown-menu"),g=h("btn-stage-editor-programs-ok");m&&f&&(m.addEventListener("click",x=>{x.stopPropagation();const $=f.style.display==="none"||!f.style.display;f.style.display=$?"flex":"none"}),g&&g.addEventListener("click",x=>{x.stopPropagation(),f.style.display="none",de()}),document.addEventListener("click",x=>{const $=x.target;f.style.display==="flex"&&!f.contains($)&&$!==m&&!m.contains($)&&(f.style.display="none",de())}));const b=h("stage-editor-programs-list");b&&b.addEventListener("change",x=>{x.target.name==="stage-editor-program-selection"&&nm()});let y=!1,v=null;const T=h("stage-editor-stage-id"),w=h("stage-editor-race-id");if(T&&w){[T,w].forEach($=>{$.addEventListener("keydown",R=>{R.key!=="ArrowUp"&&R.key!=="ArrowDown"&&(y=!0,v&&clearTimeout(v))}),$.addEventListener("keyup",R=>{R.key!=="ArrowUp"&&R.key!=="ArrowDown"&&(v&&clearTimeout(v),v=setTimeout(()=>{y=!1},150))}),$.addEventListener("blur",()=>{y=!1})});const x=($,R)=>{const I=Number($.value);if(!Number.isInteger(I)||I<=0){R==="stage"?Et=I:Ct=I;return}const F=I-(R==="stage"?Et:Ct);if(!y&&(F===1||F===-1)){let P=I;R==="stage"?P=om(I,F):h("stage-editor-new-race-checkbox").checked&&(P=lm(I,F)),$.value=String(P)}R==="stage"?Et=Number($.value):Ct=Number($.value)};T.addEventListener("input",()=>{x(T,"stage"),de()}),w.addEventListener("input",()=>{x(w,"race"),de()})}}let et=[],It=null,Ie={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const Mt=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"];function er(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill" title="Formphase">${Vn(u)} <span>Form</span></span>
        ${A}
      </div>
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;" title="Overall-Stärke">${qi(c)}</span>
  ...
  `}function kn(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",s=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(s)}</strong>`}function He(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </defs>`,b=`<circle cx="${o}" cy="${c}" r="${l+8}" fill="url(#radarBgGrad)" stroke="rgba(255,255,255,0.06)" stroke-width="1" />`;let y="";for(let D=p;D<=u;D+=2.5){const _=l*((D-p)/m);if(_<1){y+=`<circle cx="${o}" cy="${c}" r="2" fill="rgba(255,255,255,0.25)" />`;continue}const B=f(_),M=D%5===0,N=M?1:.6,O=M?"none":"4,4",K=M?.4:.18;y+=`<polygon points="${B.join(" ")}" fill="none" stroke="rgba(255,255,255,${K})" stroke-width="${N}" stroke-dasharray="${O}" />`,M&&D>p&&(y+=`<text x="${o+5}" y="${c-_+4}" fill="rgba(255,255,255,0.45)" font-size="9" font-family="Inter, sans-serif" text-anchor="start">${D}</text>`)}let v="",T="";for(let D=0;D<6;D++){const _=D*Math.PI/3-Math.PI/2,B=o+l*Math.cos(_),M=c+l*Math.sin(_);v+=`<line x1="${o}" y1="${c}" x2="${B}" y2="${M}" stroke="rgba(255,255,255,0.15)" stroke-width="1" />`;const N=l+28,O=o+N*Math.cos(_),K=c+N*Math.sin(_),j=Math.cos(_);let A="middle";j>.15?A="start":j<-.15&&(A="end");const X=a[s[D]]??p;T+=`<text x="${O}" y="${K}" fill="rgba(255,255,255,0.92)" font-size="11.5" font-weight="700" font-family="Inter, sans-serif" text-anchor="${A}" dominant-baseline="middle">${r[D]}</text>`,T+=`<text x="${O}" y="${K+14}" fill="rgba(255,255,255,0.50)" font-size="10" font-weight="500" font-family="Inter, sans-serif" text-anchor="${A}" dominant-baseline="middle">${X}</text>`}const w=[],x=[];s.forEach((D,_)=>{const B=a[D]??p,M=l*((Math.max(p,Math.min(u,B))-p)/m),N=_*Math.PI/3-Math.PI/2,O=o+M*Math.cos(N),K=c+M*Math.sin(N);w.push(`${O},${K}`),x.push(`<circle cx="${O}" cy="${K}" r="5" fill="#818cf8" stroke="#fff" stroke-width="2" filter="url(#dotGlow)"><title>${r[_]}: ${B}</title></circle>`)});const $=`<polygon points="${w.join(" ")}" fill="url(#riderFillGrad)" stroke="#818cf8" stroke-width="2.5" stroke-linejoin="round" filter="url(#radarGlow)" />`,I=[...[{key:"mountain",label:"Berg (MTN)"},{key:"hill",label:"Hügel (HIL)"},{key:"sprint",label:"Sprint (SPR)"},{key:"timeTrial",label:"Zeitfahren (TT)"},{key:"cobble",label:"Pflaster (COB)"},{key:"attack",label:"Angriff (ATT)"},{key:"mediumMountain",label:"Mittelgebirge (MDM)"},{key:"flat",label:"Flach (FLA)"},{key:"prologue",label:"Prolog (PRO)"},{key:"acceleration",label:"Beschleunigung (ACC)"}]].sort((D,_)=>{const B=a[D.key]??60;return(a[_.key]??60)-B}),C=[],F=[];I.forEach((D,_)=>{const B=a[D.key]??60,M=`
  ...
  `}function Km(e){var ae;if(!e)return`
      ...
      </section>`;const a=(e.formHistory??[]).filter((E,z)=>z%2===0),s=((ae=d.gameState)==null?void 0:ae.currentDate)??new Date().toISOString(),r=a.length>0?new Date(a[a.length-1].date).getUTCFullYear():new Date(s).getUTCFullYear(),n=new Date(Date.UTC(r,0,1)).getTime(),i=864e5,o=1260,c=384,l=40,p=20,u=a.map(E=>{const L=(new Date(E.date).getTime()-n)/i,q=l+L/365*o,J=p+c-Math.min(8,Math.max(0,E.totalForm))/8*c;return{x:q,y:J,form:E.totalForm,date:E.date}});let m="",f="",g="";Ie.form&&u.length>0&&(m=`M ${u.map(E=>`${E.x},${E.y}`).join(" L ")}`,f=u.map(E=>`<circle cx="${E.x}" cy="${E.y}" r="3" fill="#fff" stroke="var(--accent-primary)" stroke-width="2"><title>${e.riderName} (${E.date}): ${E.form}</title></circle>`).join(""),g=`${m} L ${u[u.length-1].x},${p+c} L ${u[0].x},${p+c} Z`);let b="",y="";if(Ie.combinedFatigue&&u.length>0){const E=a.map(L=>{const J=(new Date(L.date).getTime()-n)/i,k=l+J/365*o,G=L.combinedFatigue??0,W=p+c-Math.min(15,Math.max(0,G))/15*c;return{x:k,y:W,val:G,date:L.date}});b=`<path d="${`M ${E.map(L=>`${L.x},${L.y}`).join(" L ")}`}" fill="none" stroke="#ef4444" stroke-width="2" />`,y=E.map(L=>`<circle cx="${L.x}" cy="${L.y}" r="3" fill="#fff" stroke="#ef4444" stroke-width="2"><title>Gesamtfatigue (${L.date}): ${L.val.toFixed(2)}</title></circle>`).join("")}let v="",T="";if(Ie.shortFatigue&&u.length>0){const E=a.map(L=>{const J=(new Date(L.date).getTime()-n)/i,k=l+J/365*o,G=L.shortFatigue??0,W=p+c-Math.min(15,Math.max(0,G))/15*c;return{x:k,y:W,val:G,date:L.date}});v=`<path d="${`M ${E.map(L=>`${L.x},${L.y}`).join(" L ")}`}" fill="none" stroke="#facc15" stroke-width="2" />`,T=E.map(L=>`<circle cx="${L.x}" cy="${L.y}" r="3" fill="#fff" stroke="#facc15" stroke-width="2"><title>Kurzzeitfatigue (${L.date}): ${L.val.toFixed(2)}</title></circle>`).join("")}let w="",x="";if(Ie.longFatigue&&u.length>0){const E=a.map(L=>{const J=(new Date(L.date).getTime()-n)/i,k=l+J/365*o,G=L.longFatigue??0,W=p+c-Math.min(15,Math.max(0,G))/15*c;return{x:k,y:W,val:G,date:L.date}});w=`<path d="${`M ${E.map(L=>`${L.x},${L.y}`).join(" L ")}`}" fill="none" stroke="#a855f7" stroke-width="2" />`,x=E.map(L=>`<circle cx="${L.x}" cy="${L.y}" r="3" fill="#fff" stroke="#a855f7" stroke-width="2"><title>Langzeitfatigue (${L.date}): ${L.val.toFixed(2)}</title></circle>`).join("")}const $="rgba(251, 191, 36, 0.15)";let R="";for(let E=0;E<=8;E+=2){const z=p+c-E/8*c;R+=`<line x1="${l}" y1="${z}" x2="${l+o}" y2="${z}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,R+=`<text x="${l-5}" y="${z+4}" fill="#ffffff" font-size="10" text-anchor="end">${E}</text>`}for(let E=0;E<=15;E+=3){const z=p+c-E/15*c;R+=`<text x="${l+o+5}" y="${z+4}" fill="#ef4444" font-size="10" text-anchor="start">${E}</text>`}let I="";for(let E=0;E<=52;E+=5){const z=l+E/52*o;R+=`<line x1="${z}" y1="${p}" x2="${z}" y2="${p+c}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,I+=`<text x="${z}" y="${p+c+15}" fill="#ffffff" font-size="10" text-anchor="middle">W${E}</text>`}let C="",F="";if(e.peakDates){const E=[...e.peakDates].sort((z,L)=>new Date(z).getTime()-new Date(L).getTime());for(let z=0;z<E.length;z++){const L=E[z],J=(new Date(L).getTime()-n)/i,k=l+J/365*o;C+=`<line x1="${k}" y1="${p}" x2="${k}" y2="${p+c}" stroke="#ffffff" stroke-width="2"><title>Peak: ${L}</title></line>`;const G=z>0?(new Date(E[z-1]).getTime()-n)/i:Number.NEGATIVE_INFINITY,W=J-56,V=G+14,fe=Math.max(0,Math.max(W,V)),we=J-fe,Re=l+fe/365*o,Se=we/365*o;F+=`<rect x="${Re}" y="${p}" width="${Se}" height="${c}" fill="rgba(16, 185, 129, 0.1)" />`;const Ze=14/365*o;F+=`<rect x="${k}" y="${p}" width="${Ze}" height="${c}" fill="rgba(239, 68, 68, 0.1)" />`}}const D=(new Date(s).getTime()-n)/i,_=l+D/365*o;C+=`<line x1="${_}" y1="${p}" x2="${_}" y2="${p+c}" stroke="#ef4444" stroke-width="3"><title>Heute: ${s}</title></line>`,et.forEach((E,z)=>{const L=Mt[z%Mt.length];E.peakDates&&E.peakDates.forEach(q=>{const k=(new Date(q).getTime()-n)/i,G=l+k/365*o;C+=`<line x1="${G}" y1="${p}" x2="${G}" y2="${p+c}" stroke="${L}" stroke-width="1.5" stroke-dasharray="3,3"><title>${E.riderName} Peak: ${q}</title></line>`})});let B="",M="";et.forEach((E,z)=>{const L=Mt[z%Mt.length],q=E.formHistory.filter((J,k)=>k%2===0).map(J=>{const G=(new Date(J.date).getTime()-n)/i,W=l+G/365*o,V=p+c-Math.min(8,Math.max(0,J.totalForm))/8*c;return{x:W,y:V,form:J.totalForm,date:J.date}});if(q.length>0){const J=`M ${q.map(k=>`${k.x},${k.y}`).join(" L ")}`;B+=`<path d="${J}" fill="none" stroke="${L}" stroke-width="2" />`,M+=q.map(k=>`<circle cx="${k.x}" cy="${k.y}" r="3" fill="#fff" stroke="${L}" stroke-width="2"><title>${E.riderName} (${k.date}): ${k.form}</title></circle>`).join("")}});const N=d.teams.filter(E=>E.division==="WorldTour"||E.divisionName==="WorldTour");let O='<option value="">-- Team auswählen --</option>';for(const E of N){const z=It===E.id?" selected":"";O+=`<option value="${E.id}"${z}>${S(E.name)}</option>`}let K='<option value="">-- Fahrer auswählen --</option>';if(It!=null){const E=d.riders.filter(z=>z.activeTeamId===It&&z.id!==e.riderId&&!et.some(L=>L.riderId===z.id));for(const z of E)K+=`<option value="${z.id}">${S(z.firstName)} ${S(z.lastName)}</option>`}const j=`
                  ...
                  <tbody>
                    ${p.rows.map(u=>{const m=u.rowType!=="stage_result",f=m?`${u.raceName} · ${ar(u.rowType)}`:u.stageName?`${u.raceName} · ${u.stageName}`:u.raceName;return`
                        <tr class="rider-stats-row${m?" rider-stats-row-final":""}">
                          ...
                          <td>${Om(u)}</td>
                          <td>${Vm(u)}</td>
                          <td class="rider-stats-breakaway-col">${jm(u)}</td>
                          <td>${m?"":er(u.rolledWeatherId,u.rolledWetterName)}</td>
                          <td>${m?Dm(u.rowType):Oa(u.raceCategoryName?u.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):u.raceCategoryName,u.isStageRace)}</td>
                          <td>${S(f)}</td>
...
`+s.error);return}d.stageResults=s.data??null,d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId,d.selectedResultTypeId=((r=d.stageResults.classifications[0])==null?void 0:r.resultTypeId)??1,d.selectedResultsMarkerKey=Ke,d.selectedResultsSpecialView=null),d.selectedResultsRaceId!=null&&to(d.selectedResultsRaceId),$e()}async function to(e){if(!d.seasonStandings){const a=await H.getSeasonStandings();a.success&&a.data&&(d.seasonStandings=a.data)}const t=await H.getRaceResultsRoster(e);t.success&&t.data?d.resultsRoster=t.data:d.resultsRoster=null}function np(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function Mn(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function ip(){const e=d.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=dt(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=[...e.entries].sort((y,v)=>v.overallRating-y.overallRating),r=new Set(s.slice(0,5).map(y=>y.riderId)),n=y=>{var T;const v=d.riders.find(w=>w.id===y);return((T=v==null?void 0:v.skills)==null?void 0:T.sprint)??0},o=[...e.entries.filter(y=>!r.has(y.riderId))].sort((y,v)=>{const T=n(y.riderId),w=n(v.riderId);return w!==T?w-T:v.overallRating-y.overallRating}),c=new Set(o.slice(0,5).map(y=>y.riderId));function l(y){switch(y){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return y}}const p=new Map;for(const y of e.entries){const v=y.teamId;p.has(v)||p.set(v,{teamId:y.teamId,teamName:y.teamName,riders:[],avgRating:0}),p.get(v).riders.push(y)}for(const y of p.values())y.avgRating=y.riders.reduce((v,T)=>v+T.overallRating,0)/y.riders.length;const u=y=>{let v=Number.POSITIVE_INFINITY;for(const T of y)!T.hasDropped&&T.gcRank!=null&&T.gcRank<v&&(v=T.gcRank);return v},m=y=>{var T;if(!((T=d.seasonStandings)!=null&&T.riderStandings))return 0;let v=0;for(const w of y){const x=d.seasonStandings.riderStandings.find($=>$.riderId===w.riderId);x&&x.points>v&&(v=x.points)}return v},f=y=>{if(y==null)return 0;const v=d.riders.filter(x=>x.activeTeamId===y);if(v.length===0)return 0;const T=v.map(x=>x.overallRating??0);T.sort((x,$)=>$-x);const w=T.slice(0,10);return w.length===0?0:w.reduce((x,$)=>x+$,0)/w.length},g=[...p.values()].sort((y,v)=>{const T=u(y.riders),w=u(v.riders);if((T!==Number.POSITIVE_INFINITY||w!==Number.POSITIVE_INFINITY)&&T!==w)return T-w;const x=m(y.riders),$=m(v.riders);if((x>0||$>0)&&x!==$)return $-x;const R=f(y.teamId),I=f(v.teamId);return Math.abs(R-I)>1e-4?I-R:(y.teamName??"").localeCompare(v.teamName??"","de")});for(const y of g)y.riders.sort((v,T)=>Mn(v.roleId)-Mn(T.roleId)||T.overallRating-v.overallRating||v.lastName.localeCompare(T.lastName,"de"));return`<div class="results-roster-grid">${g.map(y=>{const v=y.teamId!=null?vt(y.teamId,y.teamName):"",T=y.riders.map(x=>{var ae;const $=np(x.roleId),R=x.countryCode?ot[x.countryCode]??x.countryCode.slice(0,2).toLowerCase():null,I=R?`<span class="fi fi-${R} results-roster-flag" title="${S(x.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',C=`${x.firstName.charAt(0)}. ${x.lastName}`,F=x.roleName??"–",P=x.specialization1?l(x.specialization1):null,D=x.specialization2?l(x.specialization2):null;let _=F;P&&(_+=` · ${P}`),D&&(_+=` · ${D}`);const B=`<span class="results-roster-overall-badge" style="color:${op(x.overallRating)}" title="Gesamtstärke: ${x.overallRating.toFixed(2)}">${x.overallRating.toFixed(2)}</span>`,M=x.hasDropped?" dropped":"";let N="";x.hasDropped?x.dropoutStatus==="dns"?N="DNS":x.dropoutStatus==="dnf"?N=((ae=x.dropoutReason)==null?void 0:ae.startsWith("OTL"))??!1?"OTL":"DNF":N="OUT":x.gcRank!=null&&(N=`${x.gcRank}`);let O="";if(x.hasDropped)O=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(x.dropoutReason||"")}">${N}</span>`;else if(x.gcRank!=null){let E="rider-stats-rank-badge-gc";x.gcRank===1?E="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":x.gcRank===2?E="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":x.gcRank===3&&(E="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),O=`<span class="rider-stats-rank-badge ${E}" title="GC Stand: Platz ${x.gcRank}">${x.gcRank}</span>`}const j=`style="color: ${x.hasDropped?"var(--text-500)":$.color}; font-weight: bold;"`,A=r.has(x.riderId),X=c.has(x.riderId);return`<div class="results-roster-rider${M}">
  ...
  `,j=g.findIndex(k=>k.resultTypeName.toLocaleLowerCase("de").includes("team"));j>=0?M.splice(j+1,0,N,O,K):M.push(N,O,K),a.innerHTML=M.join("");const A=tp(((L=d.stageResults)==null?void 0:L.markerClassifications)??[]);if(T){p.innerHTML=ip(),p.classList.remove("hidden"),i.classList.add("hidden"),s.innerHTML="",s.classList.add("hidden"),l.innerHTML="",l.classList.add("hidden"),n.classList.add("hidden");return}else p.innerHTML="",p.classList.add("hidden");const X=!y&&!v&&!T&&(b==null?void 0:b.resultTypeId)===1&&A.length>0,me=X?d.selectedResultsMarkerKey??Ke:null,ae=X&&me!==Ke?A.find(k=>k.markerKey===me)??null:null;if(X&&(d.selectedResultsMarkerKey=(ae==null?void 0:ae.markerKey)??Ke),v){const k=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"}];s.innerHTML=k.map(G=>`
    ...
    `).join("")}else s.innerHTML=X?[`
        ...
        >${S(ap(k))}</button>
      `)].join(""):"";s.classList.toggle("hidden",!v&&!X);const E=y||v||!X||d.selectedResultsMarkerKey===Ke;if(o&&E&&(o.innerHTML=y?`
        <th>Etappe</th>
        <th>Status</th>
    ...
    <div class="team-detail-card">
      <div class="team-detail-header">
        ...
        <div class="team-detail-meta">
          ...
          <span>Kürzel: ${S(a.abbreviation)} · Top 12 ${S(ro(a.id))} (${S(no(a.id))})</span>
      ...
      <div class="team-detail-meta" style="margin-top:0.75rem">
        ...
        <span class="text-muted">Sortierung: ${S(cr(d.teamTableSort.key))} ${d.teamTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${lo()}
    ...
    </div>`}function po(){h("teams-dropdown").addEventListener("change",e=>{const t=e.target.value;d.teamDetailPage="skills",Zt(t?Number(t):null)}),h("teams-detail").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const r=Number(t.dataset.riderProgramId);Number.isFinite(r)&&hr(r);return}const a=e.target.closest("button[data-team-detail-page]");if(a){const r=a.dataset.teamDetailPage;if(na.includes(r)){d.teamDetailPage=r,new Set(lr().map(o=>o.sortKey).filter(o=>o!=null)).has(d.teamTableSort.key)||(d.teamTableSort={key:"name",direction:"asc"});const i=Number(h("teams-dropdown").value);Zt(Number.isFinite(i)?i:null)}return}const s=e.target.closest("button[data-team-sort]");if(s){const r=s.dataset.teamSort;d.teamTableSort.key===r?d.teamTableSort.direction=d.teamTableSort.direction==="asc"?"desc":"asc":d.teamTableSort={key:r,direction:dr(r)};const n=Number(h("teams-dropdown").value);Zt(Number.isFinite(n)?n:null);return}})}const mp=Object.freeze(Object.defineProperty({__proto__:null,TEAM_DETAIL_PAGE_COLUMNS:or,TEAM_DETAIL_PAGE_ORDER:na,TEAM_SKILL_COLUMNS:nr,TEAM_SKILL_TITLES:co,TEAM_TABLE_COLUMNS:ir,compareOptionalStrings:Te,compareStrings:te,formatTeamAverage:no,formatTeamTopAverage:ro,getActiveTeamTableColumns:lr,getDefaultTeamSortDirection:dr,getPeakDate:pe,getSortIndicator:io,getSpecializationSortLabel:xe,getTeamAverage:so,getTeamSortLabel:cr,getTeamTopAverage:ao,initTeamsListeners:po,loadTeams:up,refreshTeamsViewData:Ua,renderPeakDatesSummary:cp,renderRacePrefs:Ns,renderTeamDetail:Zt,renderTeamDetailPageTabs:lo,renderTeamTableCell:ur,renderTeamTableHeader:oo,renderTeams:mr,sortRiderMenuRiders:mo,sortTeamRiders:uo},Symbol.toStringTag,{value:"Module"}));function pp(e,t,a){return`${e} · Etappe ${t} · ${a}`}function go(e,t){return e.riders.map(a=>({riderId:a.riderId,finishTimeSeconds:t.stage.profile==="ITT"||t.stage.profile==="TTT"?a.riderClockSeconds:a.finishTimeSeconds,finishStatus:a.finishStatus??"finished",isBreakaway:a.isBreakaway,statusReason:a.statusReason??null,photoFinishScore:a.photoFinishScore,leadoutRiderId:a.leadoutRiderId,leadoutBonus:a.leadoutBonus})).filter(a=>a.finishStatus==="dnf"||a.finishTimeSeconds!=null)}function fo(e,t){const a=[];for(const s of e.riders)if(s.leadoutBonus!=null&&s.leadoutBonus>0&&s.leadoutContributions&&s.leadoutContributions.length>0){const r=t.riders.find(i=>i.id===s.riderId),n=(r==null?void 0:r.activeTeamId)??null;n!=null&&a.push({teamId:n,sprinterId:s.riderId,leadoutBonus:s.leadoutBonus,contributorsJson:JSON.stringify(s.leadoutContributions)})}return a}async function ho(e,t=!1){if(_n!=null||_s)return!1;xr(e),Oo(0);try{const a=await H.getRealtimeSimulation(e);if(!a.success||!a.data)return alert(`Instant-Simulation fehlgeschlagen:
`+(a.error??"Unbekannter Fehler")),!1;const s=a.data,r=await tc(s,o=>Kn(o)),n=go(r,s),i=fo(r,s);return await $o(e,n,r.markerClassifications,r.incidents,r.allEvents,t,i),!0}catch(a){return alert("Unerwarteter Fehler bei der Instant-Simulation: "+a.message),!1}finally{xr(null),ge()}}function bo(e){var s;const t=(s=d.rosterEditor)==null?void 0:s.teams.find(r=>r.team.id===e);if(!t)return 0;const a=new Set(d.rosterEditorSelectedRiderIds);return t.riders.filter(r=>a.has(r.rider.id)).length}function yo(){return d.rosterEditor?d.rosterEditor.teams.every(e=>bo(e.team.id)===e.riderLimit):!1}function hs(){const e=h("roster-editor-title"),t=h("roster-editor-meta"),a=h("roster-editor-body"),s=h("btn-apply-roster-editor"),r=d.rosterEditor;if(!r){e.textContent="Starterfeld bearbeiten",t.textContent="",a.innerHTML='<div class="results-empty">Kein Starterfeld geladen.</div>',s.disabled=!0;return}e.textContent="Starterfeld bearbeiten",t.textContent=r.race.isStageRace?`${r.race.name} · Etappe ${r.stage.stageNumber} · ${r.stage.profile}`:`${r.race.name} · ${r.stage.profile}`;const n=new Set(d.rosterEditorSelectedRiderIds);a.innerHTML=r.teams.map(i=>{const o=bo(i.team.id),c=o===i.riderLimit?"roster-editor-team-count-ok":"roster-editor-team-count-bad";return`
...
`+(o.error??"Unbekannter Fehler"));return}const c=o.data;d.selectedResultsRaceId=(c==null?void 0:c.raceId)??d.selectedResultsRaceId,d.selectedResultsStageId=(c==null?void 0:c.stageId)??e,d.selectedResultTypeId=1,d.realtimeBootstrap=null,d.realtimeError=null,await Cs(e,!1),await gr(),await fr(),await Ua(),Nt(),n||Tt("results")}catch(o){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+o.message)}finally{Tr(!1),ge()}}}function hp(){h("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);d.selectedRealtimeStageId=Number.isFinite(t)?t:null,d.realtimeBootstrap&&d.realtimeBootstrap.stage.id!==d.selectedRealtimeStageId&&(d.realtimeBootstrap=null),d.realtimeError=null,ko(t,!1)})}function pr(e){var s;const t=ea((s=e.category)==null?void 0:s.name),a=Ja(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function ts(e){var r,n;const t=ea((r=e.category)==null?void 0:r.name),a=Ja(t),s=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(s)}</span>`}function bp(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(s=>s.date).sort((s,r)=>s.localeCompare(r));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function as(e){const{startDate:t,endDate:a}=bp(e);return t===a?se(t):`${se(t)} - ${se(a)}`}function yp(e){return e.stageId>0}async function gr(){const[e,t]=await Promise.all([H.getGameState(),H.getGameStatus()]);if(!e.success){console.error(e.error);return}d.gameState=e.data??null,d.gameStatus=t.success?t.data??null:null,vp(),ye("dashboard")&&ss()}function vp(){var r;if(!d.gameState)return;h("meta-date").textContent=d.gameState.formattedDate,h("meta-season").textContent=`Saison ${d.gameState.season}`;const e=h("meta-race-hint"),t=h("btn-advance-day"),a=h("pending-stages-list"),s=((r=d.gameStatus)==null?void 0:r.pendingStages)??[];s.length>0?(e.textContent=`${s.length} offene Etappe${s.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=s.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${se(n.date)}`:`${n.profile} · ${se(n.date)}`,o=yp(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
  ...
  `,r.length===0?n+=`
        ...
        <tbody>
          ${r.map(l=>`
              <tr class="dashboard-race-stage-row">
                ...
                <td>${oa(l.profile)}</td>
                <td>${l.distanceKm!=null?Ts(l.distanceKm):"–"}</td>
                <td>${l.elevationGainMeters!=null?xs(l.elevationGainMeters):"–"}</td>
                <td>
                  <button
                    type="button"
                    class="dashboard-stage-profile-link"
                    data-dashboard-stage-profile-id="${l.id}"
                    aria-label="Profil von ${S(rs(s,l))} öffnen"
                  >
                    Profil anzeigen
                  </button>
                </td>
    ...
    </div>`}async function Ls(e){dt(e)&&(d.selectedDashboardRaceId=e,Rp(),je("raceStages"))}function Ip(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
    ...
    </th>`}function Ep(e){const t=d.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,s)=>{var n,i,o,c;let r=0;switch(d.raceParticipantsSort.key){case"team":r=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=s.team)==null?void 0:i.name)??"","de");break;case"rider":r=Ee(a.rider).localeCompare(Ee(s.rider),"de");break;case"spec1":r=Ds(a.rider).localeCompare(Ds(s.rider),"de");break;case"role":r=lt(a.rider).localeCompare(lt(s.rider),"de");break;case"overall":r=a.rider.overallRating-s.rider.overallRating;break;case"phase":r=(a.rider.seasonFormPhase??"neutral").localeCompare(s.rider.seasonFormPhase??"neutral","de");break;default:r=(((o=a.program)==null?void 0:o.name)??"").localeCompare(((c=s.program)==null?void 0:c.name)??"","de")}return r*t||Ee(a.rider).localeCompare(Ee(s.rider),"de")})}function Ds(e){return e.specialization1!=null?Ot(e.specialization1):"–"}async function To(e){const t=dt(e);d.selectedRaceParticipantsRaceId=e,h("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",h("race-participants-meta").textContent="Lade Programmfahrer ...",h("race-participants-body").innerHTML="",d.raceParticipants=[],je("raceParticipants"),await xo()}async function xo(e=!1){const t=d.selectedRaceParticipantsRaceId;if(t==null)return;const a=dt(t);e&&(h("race-participants-meta").textContent="Lade Programmfahrer ...");const s=await H.getRaceProgramParticipants(t);if(!s.success||!s.data){h("race-participants-meta").textContent="",h("race-participants-body").innerHTML=`<div class="results-empty">${S(s.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}d.raceParticipants=s.data,h("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",h("race-participants-meta").textContent=`${s.data.length} Programmfahrer · ${a?as(a):""}`,h("race-participants-body").innerHTML=Fp(d.raceParticipants)}async function Mo(e,t=null){const a=Da(e);if(!a)return;const s=await wp(e);if(!s){alert(d.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}d.selectedDashboardProfileStageId=e,h("stage-profile-title").textContent=`${a.race.name} · ${ia(a.stage)}`;const r=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";h("stage-profile-meta").textContent=`${se(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?Ts(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?xs(a.stage.elevationGainMeters):"–"}${r}`,pl(h("stage-profile-view"),s,a.stage.profile,rs(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),je("stageProfile")}function Cp(){h("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const r=Number(t.dataset.editStageRoster);if(!Number.isFinite(r))return;gp(r);return}const a=e.target.closest("button[data-live-stage]");if(a){const r=Number(a.dataset.liveStage);if(!Number.isFinite(r))return;ko(r,!0);return}const s=e.target.closest("button[data-instant-stage]");if(s){const r=Number(s.dataset.instantStage);if(!Number.isFinite(r))return;ho(r)}}),h("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const r=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(r)&&To(r);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const s=Number(a.dataset.dashboardRaceId);Number.isFinite(s)&&Ls(s)}),h("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&Mo(a)}),h("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const r=Number(t.dataset.riderProgramId);Number.isFinite(r)&&hr(r);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const s=a.dataset.raceParticipantsSort;d.raceParticipantsSort.key===s?d.raceParticipantsSort.direction=d.raceParticipantsSort.direction==="asc"?"desc":"asc":d.raceParticipantsSort={key:s,direction:"asc"},xo()}),h("btn-advance-day").addEventListener("click",async()=>{await wo()}),h("btn-auto-progress").addEventListener("click",()=>{Np()})}async function wo(){ve("Tag wird fortgeschrieben...");try{const e=await H.advanceDay();if(!e.success)return alert(`Tageswechsel fehlgeschlagen:
`+(e.error??"Unbekannter Fehler")),!1;if(d.currentSave&&e.data&&(d.currentSave.currentSeason=e.data.season),await gr(),await fr(),ye("teams")){const{refreshTeamsViewData:t}=await Un(async()=>{const{refreshTeamsViewData:a}=await Promise.resolve().then(()=>mp);return{refreshTeamsViewData:a}},void 0);await t()}return!0}catch(e){return alert("Unerwarteter Fehler beim Tageswechsel: "+e.message),!1}finally{ge()}}function br(){const e=document.getElementById("btn-auto-progress");e&&(at?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function Np(){at?Ya():Ro()}function Ro(){at||(Gn(!0),br(),Pp())}function Ya(){at&&(Gn(!1),d.autoProgressTargetDate=null,br())}async function Pp(){var e,t;for(;at;){const a=(e=d.gameState)==null?void 0:e.currentDate;if(d.autoProgressTargetDate&&a&&a>=d.autoProgressTargetDate){Ya();break}const s=((t=d.gameStatus)==null?void 0:t.pendingStages)??[];let r=!1;if(s.length>0){const n=s[0];r=await ho(n.stageId,!0)}else r=await wo();if(!r){Ya();break}await new Promise(n=>setTimeout(n,100))}br()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&at){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),Ya()}});const Jt=50;function yr(){return[...ir,...or[d.riderMenuDetailPage]]}function Io(e){return d.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${d.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function Fo(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=d.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </div>`}function Ca(){const e=h("riders-detail"),t=yr(),a=mo(d.riders),s=a.length,r=Math.max(1,Math.ceil(s/Jt));d.riderMenuPage=Math.min(r,Math.max(1,d.riderMenuPage));const n=(d.riderMenuPage-1)*Jt,i=Math.min(s,n+Jt),o=a.slice(n,i);e.innerHTML=`
    <div class="team-detail-card">
      <div class="team-detail-header">
        <h3>Alle Fahrer</h3>
      </div>
      <div class="team-detail-meta" style="margin-top:0.75rem">
        <span>${s} Fahrer</span>
        <span class="text-muted">Sortierung: ${S(cr(d.riderMenuTableSort.key))} ${d.riderMenuTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${Eo()}
      <div class="team-detail-table-scroll">
        <table class="data-table data-table-teams">
...
${e.error??"Unbekannter Fehler"}`),Ne();return}Ms(e.data.fileName,e.data.content),Ne()}function Zp(){h("view-rider-team-editor").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-team-editor-sort]");if(t){const r=t.dataset.riderTeamEditorSort;d.riderTeamEditorSort.key===r?d.riderTeamEditorSort.direction=d.riderTeamEditorSort.direction==="asc"?"desc":"asc":d.riderTeamEditorSort={key:r,direction:Ap(r)},Ne();return}const a=e.target.closest("button[data-rider-team-editor-team-filter]");if(a){d.riderTeamEditorSelectedTeamKey=a.dataset.riderTeamEditorTeamFilter??"",Ne();return}const s=e.target.closest("button[data-rider-team-editor-action]");if(s){const r=s.dataset.riderTeamEditorAction;if(r==="reload"){Po(!0);return}if(r==="export"){Yp();return}r==="save"&&Up()}}),h("view-rider-team-editor").addEventListener("change",e=>{const t=e.target.closest("#rider-team-editor-team-select");if(t){d.riderTeamEditorSelectedTeamKey=t.value,Ne();return}const a=e.target.closest(".rider-team-editor-input");if(a){const s=Number(a.dataset.riderTeamEditorRiderId),r=a.dataset.riderTeamEditorField;Number.isFinite(s)&&r&&Vp(s,r,a.value)}})}let Xe={key:"pickNumber",asc:!0};function En(e){const t=Math.max(0,Math.min(1,(e-50)/35)),a=Math.round(6+t*118),s=.26+t*.18,r=.14+t*.12;return`--rider-stats-pill-hue:${a};--rider-stats-pill-border-alpha:${s};--rider-stats-pill-bg-alpha:${r};`}async function Lo(e,t=!1){const a=await H.getDraftHistory(e);if(!a.success){d.draftHistory=null,ye("draft")&&As(),!t&&a.error&&alert(`Draft Historie konnte nicht geladen werden:
`+a.error);return}d.draftHistory=a.data??null,ye("draft")&&As()}function As(){const e=h("draft-table-container"),t=h("draft-season-select");if(!d.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(t.options.length===0){const i=d.currentSave.startSeason??2026;for(let o=d.currentSave.currentSeason;o>=i;o--){const c=document.createElement("option");c.value=o.toString(),c.textContent=`Saison ${o}`,t.appendChild(c)}d.draftSelectedSeason||(d.draftSelectedSeason=d.currentSave.currentSeason),t.value=d.draftSelectedSeason.toString(),t.onchange=o=>{const c=o.target;d.draftSelectedSeason=parseInt(c.value,10),Lo(d.draftSelectedSeason)}}if(!d.draftHistory){e.innerHTML='<div class="alert alert-info">Lade Draft Historie...</div>';return}if(d.draftHistory.rows.length===0){e.innerHTML='<div class="alert alert-info">Keine Draft-Einträge für diese Saison vorhanden.</div>';return}const a=[...d.draftHistory.rows].sort((i,o)=>{let c=0;const l=Xe.key;return l==="riderLastName"?c=i.riderLastName.localeCompare(o.riderLastName):l==="teamName"?c=i.teamName.localeCompare(o.teamName):l==="oldTeamName"?c=(i.oldTeamName||"").localeCompare(o.oldTeamName||""):l==="countryCode"?c=i.countryCode.localeCompare(o.countryCode):c=(i[l]??0)-(o[l]??0),Xe.asc?c:-c}),s=i=>Xe.key!==i?'<span class="sort-icon-placeholder"></span>':Xe.asc?" ▲":" ▼",r=i=>{Xe.key===i?Xe.asc=!Xe.asc:(Xe.key=i,Xe.asc=!0),As()};window.setDraftSort=r;let n=`
...
`+t.error);return}d.injuries=t.data??[],ye("injuries")&&Cn()}function Cn(){const e=h("injuries-table-container");if(!d.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(h("injuries-meta").textContent=d.injuries.length+" Ausfälle",d.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=At;let t="";const a=d.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),s=new Map;for(const n of a){const i=n.teamId;s.has(i)||s.set(i,[]),s.get(i).push(n)}for(const n of s.keys())s.get(n).sort((i,o)=>o.overallRating-i.overallRating);const r=Array.from(s.keys()).sort((n,i)=>{const o=s.get(n)[0].teamAbbreviation||"",c=s.get(i)[0].teamAbbreviation||"";return o.localeCompare(c)});if(r.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of r){const i=s.get(n),o=i[0].teamAbbreviation;t+=`
      ...
      `;for(const c of i){const l=c.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let p="";if(c.fitDate){const u=se(c.fitDate);if(c.missedRaces&&c.missedRaces.length>0){let m="";for(const f of c.missedRaces)m+=`
          ...
          <tr>
            ...
            <td>${c.age}</td>
            <td><span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;">${qi(c.overallRating)}</span></td>
            <td>${l}</td>
  ...
  `;const p=d.selectedSeasonStandingScope==="countries",u=p?((v=d.seasonStandings)==null?void 0:v.countryStandings)??[]:d.selectedSeasonStandingScope==="teams"?((T=d.seasonStandings)==null?void 0:T.teamStandings)??[]:((w=d.seasonStandings)==null?void 0:w.riderStandings)??[],m=p?u:[],f=p?[]:u;if(n.textContent="Trikot",i.textContent=p?"Land":d.selectedSeasonStandingScope==="teams"?"Team":"Fahrer",o.textContent="Flagge",c.textContent=d.selectedSeasonStandingScope==="teams"?"Land":"Team",n.classList.toggle("hidden",p),c.classList.toggle("hidden",p),!d.seasonStandings||u.length===0){r.innerHTML="",s.classList.add("hidden"),a.classList.remove("hidden"),a.textContent="Noch keine Saisonpunkte vorhanden.";return}r.innerHTML=p?m.map(x=>`
      ...
      </tr>`).join(""):f.map(x=>{var P;const $=x.riderName??x.teamName,R=Ht(x.teamId,x.teamName),I=d.selectedSeasonStandingScope==="teams"?eg(x,((P=d.seasonStandings)==null?void 0:P.riderStandings)??[]):zt($,!0,!1,x.riderId,x.teamId),C=Qe(x.countryCode),F=d.selectedSeasonStandingScope==="teams"?S(x.countryName??x.countryCode??"–"):nt(x.teamName??"–",x.teamId,!1);return`
        <tr>
          <td class="pos-${Math.min(x.rank,3)}">${x.rank}</td>
  ...
  `}function Ln(e){return e>=85?"#22c55e":e>=78?"#86efac":e>=72?"#fbbf24":e>=66?"#fb923c":e>=60?"#f87171":"#94a3b8"}function gt(e){return d.teamStatsTab==="career"?`
      ${bs(e)}
      ${ys()}
      ${dg(e)}
  ...
  `,je("teamStats");const r=await H.getTeamStats(e);if(d.teamStatsSelectedTeamId===e){if(!r.success||!r.data){h("team-stats-body").innerHTML=`
    ...
    `}).join("")}window.openTeamStats=Do;async function _o(){var e;for(let t=localStorage.length-1;t>=0;t--){const a=localStorage.key(t);a&&(a.startsWith("programAssignmentsLogged_")||a.startsWith("participantCountsLogged_"))&&localStorage.removeItem(a)}Gs("game"),h("meta-career").textContent=((e=d.currentSave)==null?void 0:e.careerName)??"",Tt("dashboard"),ve("Spiel wird geladen…");try{await gr(),await fr(),ss()}catch(t){alert("Fehler beim Laden des Spiels: "+t.message)}finally{ge()}}function Mg(){document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{var a;const t=e.dataset.view??"";Tt(t),t==="dashboard"&&ss(),t==="teams"&&Ua(),t==="riders"&&Ua(),t==="rider-team-editor"&&Po(),t==="live-race"&&Nt(),t==="results"&&$e(),t==="draft"&&Lo(d.draftSelectedSeason||((a=d.currentSave)==null?void 0:a.currentSeason)||2026),t==="injuries"&&Jp(),t==="season-standings"&&tg(),t==="leaderboards"&&gg(),t==="calendar"&&xg(),(t==="stage-editor-stages"||t==="stage-editor-climbs")&&Zi()})}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-rider-link[data-rider-id]");if(!t)return;const a=Number(t.dataset.riderId);Number.isFinite(a)&&At(a)}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-team-link[data-team-id]");if(!t)return;const a=Number(t.dataset.teamId);Number.isFinite(a)&&Do(a)}),h("btn-cancel-new").addEventListener("click",()=>ze("newCareer")),h("btn-close-race-stages").addEventListener("click",()=>ze("raceStages")),h("btn-close-stage-profile").addEventListener("click",()=>ze("stageProfile")),h("btn-close-rider-program").addEventListener("click",()=>ze("riderProgram")),h("btn-close-rider-stats").addEventListener("click",()=>ze("riderStats")),h("btn-close-team-stats").addEventListener("click",()=>ze("teamStats")),h("btn-close-race-participants").addEventListener("click",()=>ze("raceParticipants")),h("btn-close-roster-editor").addEventListener("click",()=>Ps()),h("btn-cancel-roster-editor").addEventListener("click",()=>Ps()),h("btn-apply-roster-editor").addEventListener("click",()=>{fp()}),h("btn-back-menu").addEventListener("click",()=>{jt==null||jt.pause(),Gs("menu"),ta()}),Qo(),Cp(),Tg(),po(),Co(),Zp(),hp(),dp(),Nm(),Ym(),mg(),ag(),pg()}(async()=>(sm(),de(),Mg(),Gs("menu"),await ta()))();
