(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();function Wn(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Ms(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function ra(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function es(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function Fe(e,t={}){const a=t.strong===!1?"span":"strong",s=Ms("app-rider-link-label",t.labelClassName),r=`<${a} class="${s}">${Wn(e)}</${a}>`;if(t.riderId==null)return r;const n=['type="button"','class="'+Ms("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${r}</button>`}function et(e,t,a=!0,s=""){const r=a===!1?"span":"strong",n=`<${r} class="app-team-link-label">${Wn(e)}</${r}>`;return t==null?n:`<button type="button" class="${Ms("app-team-link",s)}" data-team-id="${t}">${n}</button>`}function jn(e,t){return t?t instanceof Map?t.get(e)??0:t[e]??0:0}function On(e){return Math.round(e*10)/10}function Vn(e,t){const a=e;return(t==null?void 0:t.distanceKm)??a.distanceKm??0}function Un(e,t){const a=e;return(t==null?void 0:t.elevationGainMeters)??a.elevationGainMeters??0}function Yn(e,t){return t+(e.formBonus??0)+(e.raceFormBonus??0)}function Vo(e,t){return e.skills.stamina*(t/300)}function Zn(e,t,a){return e.skills.timeTrial+Yn(e,t)+e.skills.mountain*(a/500)}function Uo(e,t,a,s){const r=Vo(e,a),n=Yn(e,s);switch(t.profile){case"Flat":return .8*e.skills.sprint+.15*e.skills.acceleration+.05*e.skills.flat+n+r;case"Rolling":return .7*e.skills.sprint+.2*e.skills.acceleration+.1*e.skills.hill+n+r;case"Hilly":return .45*e.skills.sprint+.1*e.skills.flat+.45*e.skills.hill+n+r;case"Hilly_Difficult":return .2*e.skills.sprint+.1*e.skills.flat+.7*e.skills.hill+n+r;case"Medium_Mountain":return .05*e.skills.sprint+.1*e.skills.flat+.35*e.skills.hill+.45*e.skills.mediumMountain+.05*e.skills.mountain+n+r;case"Mountain":return .05*e.skills.hill+.2*e.skills.mediumMountain+.75*e.skills.mountain+n+r;case"High_Mountain":return e.skills.mountain+n+r;case"Cobble":return .3*e.skills.sprint+.2*e.skills.flat+.5*e.skills.cobble+n+r;case"Cobble_Hill":return .3*e.skills.sprint+.2*e.skills.flat+.2*e.skills.hill+.3*e.skills.cobble+n+r;default:return .8*e.skills.sprint+.2*e.skills.flat+n+r}}function Yo(e,t,a,s,r){return t.profile==="ITT"||t.profile==="TTT"?Zn(e,r,s):Uo(e,t,a,r)}function Zo(e,t){var a;return{rank:t,kind:"rider",effectiveSkill:On(e.effectiveSkill),teamId:e.rider.activeTeamId??0,teamName:e.teamName,displayName:`${e.rider.firstName} ${e.rider.lastName}`,roleLabel:((a=e.rider.role)==null?void 0:a.name)??"–",riderId:e.rider.id}}function Jn(e,t,a,s){Vn(a,s);const r=Un(a,s),n=new Map(t.map(l=>[l.id,l]));if(a.profile==="TTT"){const l=new Map;for(const o of e){if(o.activeTeamId==null)continue;const p=l.get(o.activeTeamId)??[];p.push(o),l.set(o.activeTeamId,p)}return[...l.entries()].map(([o,p])=>{const m=n.get(o),f=p.map(v=>Zn(v,jn(v.id,s==null?void 0:s.dailyFormByRiderId),r)).sort((v,T)=>T-v).slice(0,5),g=f.length,b=g>0?f.reduce((v,T)=>v+T,0)/g:0,y=Math.max(0,5-g)*2;return{team:m??{id:o,name:`Team ${o}`,abbreviation:"---",divisionId:0,u23TeamId:null,isPlayerTeam:!1,countryCode:"---",colorPrimary:"#000000",colorSecondary:"#ffffff",aiFocus1:0,aiFocus2:0,aiFocus3:0},score:b-y}}).sort((o,p)=>p.score-o.score||o.team.id-p.team.id).slice(0,20).map((o,p)=>({rank:p+1,kind:"team",effectiveSkill:On(o.score),teamId:o.team.id,teamName:o.team.name,displayName:o.team.name,roleLabel:"TTT"}))}return(s!=null?Aa(e,t,a,s):Aa(e,t,a)).sort((l,c)=>c.effectiveSkill-l.effectiveSkill||l.rider.id-c.rider.id).slice(0,20).map((l,c)=>Zo(l,c+1))}function Aa(e,t,a,s){const r=Vn(a,s),n=Un(a,s),i=new Map(t.map(l=>[l.id,l]));return e.map(l=>{var c;return{rider:l,teamName:l.activeTeamId!=null?((c=i.get(l.activeTeamId))==null?void 0:c.name)??`Team ${l.activeTeamId}`:"—",effectiveSkill:Yo(l,a,r,n,jn(l.id,s==null?void 0:s.dailyFormByRiderId))}}).sort((l,c)=>c.effectiveSkill-l.effectiveSkill||l.rider.id-c.rider.id)}const d={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,draftHistory:null,injuries:null,draftSelectedSeason:null,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1,autoProgressTargetDate:null};let Yt=null;function Jo(e){Yt=e}let Ks=!1;function Ir(e){Ks=e}let qn=null;function Rr(e){qn=e}let xs=null;function Er(e){xs=e}let rt=!1;function Xn(e){rt=e}function h(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function re(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function Ba(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),s=Math.floor(e%60),r=String(a).padStart(2,"0"),n=String(s).padStart(2,"0");return t>0?`${t}:${r}:${n}`:`${a}:${n}`}function cs(e){return e==null||e===0?"–":`+${Ba(e)}`}const Fa=2,ws=3,Qn=4;function ei(e){return`/jersey/Jer_${e}.png`}function St(e,t){var s;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((s=d.teams.find(r=>r.id===e))==null?void 0:s.name)??`Team ${e}`;return`
  ...
  `;for(const m of r){const u=e.riders.find(w=>w.id===m.riderId);if(!u)continue;const f=Ft(u.id)??"un",g=je[f]??"un",b=e.teams.find(w=>w.id===u.activeTeamId),y=(b==null?void 0:b.abbreviation)??"—",v=n.get(u.id),T=v?`GC ${v.rank} (${v.rank===1?"Gelb":Fr(v.gapSeconds)})`:"GC –";i+=`
    ...
    `}i+="</div>",t.innerHTML=i;const l=e.gcStandings.slice(0,10);let c=`
    <h3>
      <span>Gesamtwertung (GC)</span>
      <span style="font-size: 0.75rem; color: #94a3b8; font-weight: normal;">Top 10</span>
    </h3>
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const m of l){const u=e.riders.find(T=>T.id===m.riderId);if(!u)continue;const f=Ft(u.id)??"un",g=je[f]??"un",b=e.teams.find(T=>T.id===u.activeTeamId),y=(b==null?void 0:b.abbreviation)??"—",v=m.rank===1?"Gelb":Fr(m.gapSeconds);c+=`
      <div class="instant-sim-rider-card">
        <div class="instant-sim-jersey-column">
          <img src="/jersey/Jer_${u.activeTeamId}.png" class="instant-sim-large-jersey" onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';">
        </div>
  ...
  `).join("")}async function ol(e){ve("Karriere wird geladen…");const t=await O.loadSave(e);if(fe(),!t.success){alert("Fehler beim Laden: "+t.error);return}d.currentSave=t.data??null,await Oo()}async function ll(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;ve("Löschen…");const a=await O.deleteSave(e);if(fe(),!a.success){alert("Fehler: "+a.error);return}await na()}async function dl(){const e=await O.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){h("btn-delete-all-careers").classList.add("hidden"),h("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){ve("Alle Karrieren werden gelöscht…");try{for(const a of t){const s=await O.deleteSave(a.filename);if(!s.success){alert(`Fehler beim Löschen von "${a.careerName}": ${s.error??"Unbekannter Fehler"}`);break}}}finally{fe()}await na()}}function cl(){h("btn-new-career").addEventListener("click",async()=>{var r;ta("new-career-error"),h("input-career-name").value="";const a=h("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',Ve("newCareer");const s=await O.getAvailableTeams();if(!s.success||!((r=s.data)!=null&&r.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=s.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),h("btn-cancel-new").addEventListener("click",()=>Ke("newCareer")),h("btn-confirm-new").addEventListener("click",async()=>{const a=h("input-career-name").value.trim(),s=h("input-team-id").value;if(!a||!s){bt("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const r=Number(s),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;ta("new-career-error"),ve("Neue Karriere wird erstellt…");const l=await O.createSave(i,a,r);if(!l.success){fe(),bt("new-career-error",l.error??"Unbekannter Fehler.");return}const c=await O.loadSave(i);if(fe(),Ke("newCareer"),!c.success){alert("Fehler: "+c.error);return}d.currentSave=c.data??null,await Oo()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>na());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{dl()}),h("saves-list").addEventListener("click",async a=>{const s=a.target.closest("button[data-save-action]");if(!s)return;const{saveAction:r,filename:n,careerName:i}=s.dataset;if(n){if(r==="load"){await ol(n);return}r==="delete"&&await ll(n,i??n)}})}const ul="modulepreload",ml=function(e){return"/"+e},Lr={},oi=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));r=Promise.allSettled(a.map(c=>{if(c=ml(c),c in Lr)return;Lr[c]=!0;const o=c.endsWith(".css"),p=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const m=document.createElement("link");if(m.rel=o?"stylesheet":ul,o||(m.as="script"),m.crossOrigin="",m.href=c,l&&m.setAttribute("nonce",l),document.head.appendChild(m),o)return new Promise((u,f)=>{m.addEventListener("load",u),m.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return r.then(i=>{for(const l of i||[])l.status==="rejected"&&n(l.reason);return t().catch(n)})},pl={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function gl(e){const t=pl[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const fl=200;function Os(e){if(e.length===0)return[];const t=[];for(const a of e){const s=t[t.length-1];if(!s||Math.abs(s.distanceMeter-a.distanceMeter)>=fl){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}s.riderIds.push(...a.riderIds),s.riderCount+=a.riderCount,s.distanceSum+=a.distanceMeter*a.riderCount,s.distanceMeter=s.distanceSum/s.riderCount}return t.map(({distanceSum:a,...s})=>s)}function Vs(e){if(e.length===0)return[];let t=0;for(let r=1;r<e.length;r+=1)e[r].riderCount>e[t].riderCount&&(t=r);let a=0,s=0;return e.map((r,n)=>{const i=n===t;let l;return i?l="P":n<t?(a+=1,l=`E${a}`):(s+=1,l=`A${s}`),{...r,label:l,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-r.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,r.distanceMeter-e[n+1].distanceMeter):null}})}function hl(e,t=null){var a,s,r;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((s=e.find(n=>n.label==="P"))==null?void 0:s.label)??((r=e[0])==null?void 0:r.label)??null}function ut(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function Dr(e,t,a,s){return`${s.type}:${e}:${t}:${a}`}function bl(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:ut(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function Je(e){const t=[];e.segments.forEach((r,n)=>{const i=n*2;(r.start_markers??[]).forEach((l,c)=>{t.push({key:Dr(n,"start",c,l),label:"",marker:l,kmMark:r.start_km,elevation:r.start_elevation,boundary:"start",sequence:i+c/100})}),(r.end_markers??[]).forEach((l,c)=>{t.push({key:Dr(n,"end",c,l),label:"",marker:l,kmMark:r.end_km,elevation:r.end_elevation,boundary:"end",sequence:i+1+c/100})})});const a=t.sort((r,n)=>r.kmMark-n.kmMark||r.sequence-n.sequence),s=new Map;return a.map(r=>{const n=(s.get(r.marker.type)??0)+1;return s.set(r.marker.type,n),{...r,label:r.marker.name??bl(r.marker,n)}})}function yl(e){const t=Je(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>ut(a)).length}}function At(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function vl(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function Ae(e,t,a,s){return t<=0?s:s+e/t*(a-s*2)}function Ga(e,t){const a=t/1e3,s=e.points;if(a<=s[0].kmMark)return s[0].elevation;for(let r=0;r<s.length-1;r+=1){const n=s[r],i=s[r+1];if(a>i.kmMark)continue;const l=Math.max(1e-4,i.kmMark-n.kmMark),c=(a-n.kmMark)/l;return n.elevation+(i.elevation-n.elevation)*c}return s[s.length-1].elevation}function li(e){const t=e.points.map(p=>p.elevation),a=Math.min(...t),s=Math.max(...t),r=Math.max(1,s-a),n=Math.max(40,r*.08),i=Math.max(0,a-n),l=s+n;let c=Math.floor(i/50)*50,o=Math.ceil(l/50)*50;return o<=c&&(o=c+100),{axisMinElevation:c,axisMaxElevation:o}}function Ue(e,t,a,s,r,n){const i=Math.max(1,a-t);return s-n-(e-t)/i*(s-r-n)}function Jt(e){return`${Math.round(e)} m`}function Ar(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function Br(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function di(e,t,a,s,r,n,i,l,c){var g;const o=[],p=[];let m=null,u="#b91c1c";for(const b of Je(e)){const{marker:y,kmMark:v,elevation:T}=b;if(y.type==="climb_start"){p.push({kmMark:v,elevation:T,name:y.name});continue}if(ut(y)){let w=-1;for(let R=p.length-1;R>=0;R-=1)if(y.name&&((g=p[R])==null?void 0:g.name)===y.name){w=R;break}const M=w>=0?p.splice(w,1)[0]:p.pop();M&&Math.max(0,v-M.kmMark),M&&Math.max(0,T-M.elevation);const $=Br(y.cat,y.type),E=Ar(y.cat);if(y.type==="finish_hill"||y.type==="finish_mountain"){m=y.cat??null,u=$.accentColor;continue}o.push({x:Ae(v*1e3,t,a,s),anchorY:Ue(T,l,c,r,n,i),primaryLabel:E??"Berg",secondaryLabel:Jt(T),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:$.accentColor});continue}if(y.type==="sprint_intermediate"){const w=Br(y.cat,y.type);o.push({x:Ae(v*1e3,t,a,s),anchorY:Ue(T,l,c,r,n,i),primaryLabel:"Sprint",secondaryLabel:Jt(T),distanceLabel:`${v.toFixed(1).replace(".",",")} km`,accentColor:w.accentColor})}}const f=e.points[e.points.length-1];return o.push({x:Ae(f.kmMark*1e3,t,a,s),anchorY:Ue(f.elevation,l,c,r,n,i),primaryLabel:m?`${Ar(m)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:Jt(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:u}),o.sort((b,y)=>b.x-y.x)}function ci(e,t,a){const s=t+4,r=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
    ...
    </g>`}function ui(e,t){const a=new Set,s=t/1e3;for(let r=0;r<=s;r+=25)a.add(Math.round(r*1e3));return a.add(Math.round(t)),[...a].filter(r=>r>=0&&r<=t).sort((r,n)=>r-n)}function mi(e,t,a,s,r,n){const i=new Set(Je(t).map(l=>Math.round(l.kmMark*1e3)));return e.map(l=>{const c=Ae(l,a,s,r),p=i.has(l)?18:12,m=n+p+26;return`
      <g class="race-sim-distance-tick">
        ...
        <text x="${c.toFixed(1)}" y="${m.toFixed(1)}" text-anchor="middle" class="race-sim-grid-label">${At(vl(l))}</text>
      </g>`}).join("")}function Sl(e,t,a,s,r,n,i,l,c,o,p){const m=Ae(e.distanceMeter,a,s,n),u=Ga(t,e.distanceMeter),f=Ue(u,c,o,r,i,l),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),b=e.riderCount>1?`<text x="${m.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${b}
    </g>`}function kl(e,t,a,s,r,n,i,l,c,o,p){const m=new Map(p.riders.map(f=>[f.id,f])),u=new Map((p.teams??[]).map(f=>[f.id,f.abbreviation]));return e.filter(f=>f.riderCount===1).map(f=>{const g=f.riderIds[0];if(g==null)return"";const b=m.get(g);if(!b)return"";const y=Ae(f.distanceMeter,a,s,n),v=Ga(t,f.distanceMeter),T=Ue(v,c,o,r,i,l),w=b.activeTeamId!=null?u.get(b.activeTeamId)??"":"",M=`${b.lastName} (${w})`,$=T-34,E=T-40;return`
        ...
        </g>`}).join("")}function $l(e,t,a,s,r,n,i,l,c,o,p){const m=Math.max(0,Math.min(o,e.distanceKm)),u=Math.max(0,Math.min(p,e.distanceKm));if(u<=m)return null;const f=[{kmMark:m,elevation:Ga(e,m*1e3)},...e.points.filter(T=>T.kmMark>m&&T.kmMark<u),{kmMark:u,elevation:Ga(e,u*1e3)}];if(f.length<2)return null;const g=r-i,b=f.map((T,w)=>{const M=Ae(T.kmMark*1e3,t,a,s),$=Ue(T.elevation,l,c,r,n,i);return`${w===0?"M":"L"} ${M.toFixed(1)} ${$.toFixed(1)}`}).join(" "),y=Ae(m*1e3,t,a,s),v=Ae(u*1e3,t,a,s);return`${b} L ${v.toFixed(1)} ${g.toFixed(1)} L ${y.toFixed(1)} ${g.toFixed(1)} Z`}function Tl(e,t,a,s,r={}){const p=e.distanceKm*1e3,{axisMinElevation:m,axisMaxElevation:u}=li(e),f=533,g=12,y=e.points.map(R=>{const L=Ae(R.kmMark*1e3,p,1584,28),C=Ue(R.elevation,m,u,634,168,101);return{x:L,y:C}}).map((R,L)=>`${L===0?"M":"L"} ${R.x.toFixed(1)} ${R.y.toFixed(1)}`).join(" "),v=`${y} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,T=r.selectedClimbRange!=null?$l(e,p,1584,28,634,168,101,m,u,r.selectedClimbRange.startKm,r.selectedClimbRange.endKm):null,w=di(e,p,1584,28,634,168,101,m,u).map(R=>ci(R,g,f)).join(""),$=Array.from({length:5},(R,L)=>m+(u-m)/4*L).map(R=>{const L=Ue(R,m,u,634,168,101);return`
    ...
    </svg>`}function Ml(e,t,a,s,r){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${Tl(t,a,s,!1,r)}</div>`}function xl(e,t,a,s,r,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const l=1584,c=634,o=28,p=168,m=101,{axisMinElevation:u,axisMaxElevation:f}=li(t),g=c-m,b=12,y=Array.from({length:5},(H,x)=>u+(f-u)/4*x),v=Os(a.clusters),T=Vs(v),w=ui(t,a.stageDistanceMeters),$=t.points.map(H=>{const x=Ae(H.kmMark*1e3,a.stageDistanceMeters,l,o),P=Ue(H.elevation,u,f,c,p,m);return{x,y:P}}).map((H,x)=>`${x===0?"M":"L"} ${H.x.toFixed(1)} ${H.y.toFixed(1)}`).join(" "),E=`${$} L ${(l-o).toFixed(1)} ${g.toFixed(1)} L ${o.toFixed(1)} ${g.toFixed(1)} Z`,R=di(t,a.stageDistanceMeters,l,o,c,p,m,u,f).map(H=>ci(H,b,g)).join(""),L=y.map(H=>{const x=Ue(H,u,f,c,p,m);return`
      <line x1="${o}" y1="${x.toFixed(1)}" x2="${l-o}" y2="${x.toFixed(1)}" class="race-sim-grid-line"></line>
      <line x1="${o}" y1="${x.toFixed(1)}" x2="${(o-8).toFixed(1)}" y2="${x.toFixed(1)}" class="race-sim-axis"></line>
      <text x="${(o-14).toFixed(1)}" y="${(x+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Jt(H)}</text>`}).join(""),C=mi(w,t,a.stageDistanceMeters,l,o,g),D=new Map(v.map((H,x)=>[H,T[x]??null])),B=v.map(H=>{var x;return Sl(H,t,a.stageDistanceMeters,l,c,o,p,m,u,f,((x=D.get(H))==null?void 0:x.label)===i)}).join(""),G=r.stage.profile==="ITT"?kl(v,t,a.stageDistanceMeters,l,c,o,p,m,u,f,r):"";e.innerHTML=`
    <div class="race-sim-profile-layout${r.stage.profile==="ITT"?" race-sim-profile-layout-itt":""}">
      <div class="race-sim-profile-canvas-wrap">
        <svg viewBox="0 0 ${l} ${c}" role="img" aria-label="${At(s)}">
          <defs>
          ...
          <line x1="${o}" y1="${p}" x2="${o}" y2="${g}" class="race-sim-axis"></line>
          ...
          ${G}
          ${C}
          <text x="${o.toFixed(1)}" y="${(p-20).toFixed(1)}" class="race-sim-scale race-sim-scale-title" text-anchor="start">Höhe</text>
        </svg>
      </div>
    </div>`}const wl={Flat:1.25,Hill:1.1,Medium_Mountain:1.05,Mountain:1.05,High_Mountain:1.05,Cobble:1.05,Cobble_Hill:1.05,Abfahrt:1.2,Sprint:1.05},_r={Flat:{lateMultiplier:1,peakMultiplier:1},Hill:{lateMultiplier:1.1,peakMultiplier:1.6},Medium_Mountain:{lateMultiplier:1.6,peakMultiplier:2.5},Mountain:{lateMultiplier:1.6,peakMultiplier:2.5},High_Mountain:{lateMultiplier:1.6,peakMultiplier:2.5},Cobble:{lateMultiplier:1.5,peakMultiplier:1.5},Cobble_Hill:{lateMultiplier:1.5,peakMultiplier:1.5},Abfahrt:{lateMultiplier:1,peakMultiplier:1},Sprint:{lateMultiplier:1,peakMultiplier:1}};function Cs(e){switch(e){case"Flat":return"flat";case"Hill":return"hill";case"Medium_Mountain":return"mediumMountain";case"Mountain":case"High_Mountain":return"mountain";case"Cobble":case"Cobble_Hill":return"cobble";case"Sprint":return"sprint";case"Abfahrt":return"downhill";default:return"flat"}}function ts(e,t){return`${e}:${t}`}function Il(e){return new Map(e.map(t=>[ts(t.simulationMode,t.terrain),t.weights]))}function Rl(e){return new Map(e.map(t=>[ts(t.simulationMode,t.terrain),t]))}function El(e){return e==="ITT"?"itt":e==="TTT"?"ttt":"road"}function pi(e,t,a){const s=a.get(ts(e,t));if(!s)return[{key:Cs(t),weight:1}];const r=Object.entries(s).map(([n,i])=>({key:n,weight:i??0})).filter(n=>n.weight>0);return r.length>0?r:[{key:Cs(t),weight:1}]}function Fl(e,t,a,s){const r=pi(t,a,s),n=r.reduce((l,c)=>l+c.weight,0);return n<=0?e[Cs(a)]:r.reduce((l,c)=>l+e[c.key]*c.weight,0)/n}function Cl(e,t){const a=t.find(s=>s.simulationMode==="ttt"&&s.terrain===e);return(a==null?void 0:a.tttSpeedMultiplier)??wl[e]??1.05}function Nl(e,t,a){const s=a==null?void 0:a.get(ts(e,t));return{lateMultiplier:(s==null?void 0:s.finalSpreadLateMultiplier)??_r[t].lateMultiplier,peakMultiplier:(s==null?void 0:s.finalSpreadPeakMultiplier)??_r[t].peakMultiplier}}const Pl=.005,Ll=.005,gi=70,fi=1e3,hi=15,bi=360,yi=8,vi=-.75,Si=10;function yt(e,t){return e+Math.random()*(t-e)}function ki(e,t,a){return Math.max(t,Math.min(a,e))}function Dl(e){return e==="ITT"||e==="TTT"}function $i(e,t){var a;return((a=e.role)==null?void 0:a.name)!=="Kapitaen"||e.activeTeamId==null?[]:t.filter(s=>{var r,n,i;return s.id!==e.id&&s.activeTeamId===e.activeTeamId&&(((r=s.role)==null?void 0:r.name)==="Edelhelfer"||((n=s.role)==null?void 0:n.name)==="Starke Helfer"||((i=s.role)==null?void 0:i.name)==="Wassertraeger")}).map(s=>s.id)}function Ti(){const e=Math.random();return e<.1?"severe":e<.35?"medium":"light"}function Al(e,t,a,s){const r=s==="crash"?Ti():null,n=Number(yt(.5,Math.max(.6,a-.25)).toFixed(2)),i=Math.round(n*1e3),l=ki(n/Math.max(.1,a)*100,0,100),c=l<=gi;return{riderId:e.id,type:s,severity:r,triggerDistanceKm:n,triggerDistanceMeters:i,triggerDistancePercent:l,waitDurationSeconds:Math.round(s==="crash"?yt(10,60):yt(10,45)),recoverySeconds:c?fi:bi,recoveryFormBonus:c?hi:yi,dayFormPenalty:vi,staminaPenalty:Si,recoveryPenaltyStages:s==="crash"?r==="light"?[10,5,2]:[]:[],raceRecuperationPenalty:s==="crash"&&r==="medium"?15:0,supportRiderIds:$i(e,t)}}function Bl(e,t,a){if(Dl(t.profile)||a<=0)return[];const s=[];for(const r of e){const n=Math.random(),i=Math.random(),l=Pl*Math.max(0,t.crashIncidentMultiplier??1),c=Ll*Math.max(0,t.mechanicalIncidentMultiplier??1),o=l+(t.rolledEffektSturz??0)/100,p=c+(t.rolledEffektDefekt??0)/100,m=n<o,u=i<p;if(!m&&!u)continue;const f=m&&u?n<=i?"crash":"mechanical":m?"crash":"mechanical",g=Al(r,e,a,f);if(f==="crash"&&Math.random()<.01){g.isMassCrashTrigger=!0;const b=Math.floor(yt(2,26)),v=[...e.filter(T=>T.id!==r.id)].sort(()=>.5-Math.random());g.massCrashPotentialRiderIds=v.slice(0,b).map(T=>T.id),Math.random()<.2&&(g.hasAdditionalMechanical=!0,g.waitDurationSeconds+=Math.round(yt(10,45)))}s.push(g)}return s}function _l(e,t,a,s){const r=Ti(),n=Math.round(a*1e3),i=ki(a/Math.max(.1,s)*100,0,100),l=i<=gi;let c=Math.round(yt(10,60)),o=!1;return Math.random()<.2&&(o=!0,c+=Math.round(yt(10,45))),{riderId:e.id,type:"crash",severity:r,triggerDistanceKm:a,triggerDistanceMeters:n,triggerDistancePercent:i,waitDurationSeconds:c,recoverySeconds:l?fi:bi,recoveryFormBonus:l?hi:yi,dayFormPenalty:vi,staminaPenalty:Si,recoveryPenaltyStages:r==="light"?[10,5,2]:[],raceRecuperationPenalty:r==="medium"?15:0,supportRiderIds:$i(e,t),hasAdditionalMechanical:o}}function Gl(e,t){return e+Math.random()*(t-e)}function Gr(e){const t=[...e];for(let a=t.length-1;a>0;a-=1){const s=Math.floor(Gl(0,a+1)),r=t[a];t[a]=t[s]??r,t[s]=r}return t}function Hl(e){const t=new Map;for(const a of e)a.activeTeamId==null||t.has(a.activeTeamId)||t.set(a.activeTeamId,{id:a.activeTeamId,name:`Team ${a.activeTeamId}`,abbreviation:"---",divisionId:0,u23TeamId:null,isPlayerTeam:!1,countryCode:"---",colorPrimary:"#000000",colorSecondary:"#ffffff",aiFocus1:0,aiFocus2:0,aiFocus3:0});return[...t.values()]}function zl(e,t,a={}){if(e.length===0)return[];const s=e.map(f=>({...f,hasSuperform:!1,hasSupermalus:!1,specialFormDelta:0})),r=a.teams??Hl(s),n=Aa(s,r,t,a),i=new Set(n.slice(0,20).map(f=>f.rider.id)),l=Math.min(Math.ceil(s.length*.02),Math.max(0,s.length-i.size)),c=Math.min(Math.ceil(s.length*.01),s.length),o=Gr(s.filter(f=>!i.has(f.id))),p=new Set(o.slice(0,l).map(f=>f.id)),m=Gr(s.filter(f=>!p.has(f.id))),u=new Set(m.slice(0,c).map(f=>f.id));return s.map(f=>p.has(f.id)?{...f,hasSuperform:!0,hasSupermalus:!1,specialFormDelta:4}:u.has(f.id)?{...f,hasSuperform:!1,hasSupermalus:!0,specialFormDelta:-6}:f)}function Kt(e,t){const a=Math.ceil(Math.min(e,t)),s=Math.floor(Math.max(e,t));return Math.floor(Math.random()*(s-a+1))+a}function Hr(e,t){return e+Math.random()*(t-e)}function Kl(e,t,a){const s=[...e],r=[];for(;r.length<t&&s.length>0;){const n=s.reduce((o,p)=>o+Math.max(1e-4,a(p)),0);let i=Math.random()*n,l=0;for(let o=0;o<s.length;o+=1)if(i-=Math.max(1e-4,a(s[o])),i<=0){l=o;break}const[c]=s.splice(l,1);c&&r.push(c)}return r}function Wl(e,t){return new Set(e.filter(a=>a.kind==="rider"&&a.riderId!=null).slice(0,t).map(a=>a.riderId))}function zr(e,t){return new Set(e.slice(0,t).map(a=>a.riderId))}function jl(e,t,a){return new Set(e.map(s=>s.riderId).filter(s=>s!=null&&!t.has(s)).slice(0,a))}function Ol(e){return(e??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()}function ot(e){var t;return Ol((t=e.role)==null?void 0:t.name)}function Vl(e){return Je(e).some(({marker:t})=>ut(t))}function Ul(e){return Math.max(1,Math.pow(10,(e.skills.attack-65)/10))}function Yl(e,t){const a=Ul(e),s=e.hasSuperform===!0?40:1,r=!t.isEarlyStageRace&&t.race.isStageRace&&t.gcLeaderTeamId!=null&&e.activeTeamId===t.gcLeaderTeamId?.25:1,n=t.stageHasMountainClassifications&&t.topMountainIds.has(e.id)?50:1,i=t.isHardStage&&ot(e)==="sprinter"&&e.skills.hill>67?20:1,l=a*s*r*n*i;return{attackFactor:a,superformFactor:s,gcLeaderTeamFactor:r,mountainFactor:n,sprinterFactor:i,finalWeight:l}}function Zl(e){return e.profile==="Hilly_Difficult"||e.profile==="Medium_Mountain"||e.profile==="Mountain"||e.profile==="High_Mountain"||e.profile==="Cobble_Hill"}function Jl(e,t){var s,r;const a=((s=t[0])==null?void 0:s.riderId)??null;return a==null?null:((r=e.find(n=>n.id===a))==null?void 0:r.activeTeamId)??null}function ql(e,t,a){const s=new Map(t.map(n=>[n.id,n])),r=new Set;for(const n of e){if(n.kind!=="rider"||n.riderId==null)continue;const i=s.get(n.riderId)??null;if(!(!i||i.activeTeamId==null||r.has(i.activeTeamId))&&(r.add(i.activeTeamId),r.size>=a))break}return r}function Xl(e){const t=new Map;for(const a of e)a.activeTeamId!=null&&(t.has(a.activeTeamId)||t.set(a.activeTeamId,!1),ot(a)==="kapitaen"&&t.set(a.activeTeamId,!0));return t}function Ql(e,t,a){if(e.isStageRace&&t.stageNumber<=8){const i=Math.max(1,Math.ceil(a*.01)),l=Math.max(i,Math.ceil(a*.06));return{min:i,max:l}}const s=t.stageNumber<=10,r=Math.max(1,Math.floor(a*(s?.01:.05))),n=Math.max(r,Math.floor(a*(s?.08:.2)));return{min:r,max:n}}function ed(e,t){return!e.isStageRace||t.stageNumber<=8?{min:.45,max:.6}:t.stageNumber<=15?{min:.45,max:.75}:{min:.5,max:.85}}function td(e,t,a,s,r,n,i,l){if(a.profile==="ITT"||a.profile==="TTT"||e.length===0||s.distanceKm<=0)return null;const c=e.length,{min:o,max:p}=Ql(t,a,c),m=Kt(o,p),u=t.isStageRace&&a.stageNumber<=10,f=!t.isStageRace,g=Jl(e,n),b=u?ql(r,e,5):new Set,y=u?Xl(e):new Map,v=Vl(s),T=Wl(r,5),w=zr(n,10),M=new Set([...T,...w]),$=v?jl(i,M,5):new Set,E=Zl(a),R=["Hilly_Difficult","Medium_Mountain","Mountain","High_Mountain"].includes(a.profile),L=t.isStageRace&&R&&a.stageNumber>=4;let C;const D=new Set;if(L){const N=zr(n,10),j=Aa(e,l??[],a,{distanceKm:s.distanceKm,elevationGainMeters:s.elevationGainMeters});let _=[];for(const k of j){if(_.length>=5)break;const A=k.rider;if(A.activeTeamId==null||!N.has(A.id))continue;const z=ot(A);(z==="kapitaen"||z==="co-kapitaen")&&(_.includes(A.activeTeamId)||_.push(A.activeTeamId))}if(_.length===0)for(const k of j){if(_.length>=5)break;const A=k.rider;if(A.activeTeamId==null||!N.has(A.id))continue;ot(A)==="edelhelfer"&&(_.includes(A.activeTeamId)||_.push(A.activeTeamId))}if(_.length>0&&Math.random()<.5){const k=Kt(0,_.length-1);C=_[k]}}if(C!=null){const N=e.filter(_=>_.activeTeamId===C),I=N.filter(_=>ot(_)==="kapitaen"),j=N.filter(_=>ot(_)==="co-kapitaen");if(I.length>0){if(I.forEach(_=>D.add(_.id)),I.length===1&&j.length>0){const _=[...j].sort((k,A)=>A.overallRating-k.overallRating||A.id-k.id);D.add(_[0].id)}}else if(j.length>0)[...j].sort((k,A)=>A.overallRating-k.overallRating||A.id-k.id).slice(0,2).forEach(k=>D.add(k.id));else{const _=N.filter(k=>ot(k)==="edelhelfer");if(_.length>0){const k=[..._].sort((A,z)=>z.overallRating-A.overallRating||z.id-A.id);D.add(k[0].id)}}}let B;if(C!=null){const I=e.filter(j=>j.activeTeamId===C).filter(j=>!D.has(j.id));I.length>0&&(B=[...I].sort((_,k)=>k.skills.attack-_.skills.attack||k.overallRating-_.overallRating||k.id-_.id)[0])}const G=e.filter(N=>{if(N.activeTeamId==null||T.has(N.id)||w.has(N.id)||C!=null&&N.activeTeamId===C&&(D.has(N.id)||B!=null&&N.id===B.id)||u&&g!=null&&N.activeTeamId===g||u&&b.has(N.activeTeamId))return!1;const I=ot(N);return!(f&&(I==="kapitaen"||I==="co-kapitaen")||u&&I==="kapitaen"||u&&I==="co-kapitaen"&&y.get(N.activeTeamId)!==!0||I==="sprinter"&&(t.isStageRace&&a.stageNumber<=5||!t.isStageRace&&["Flat","Rolling","Hilly"].includes(a.profile)))});if(G.length===0)return null;const H=new Map(G.map(N=>[N.id,Yl(N,{isEarlyStageRace:u,race:t,gcLeaderTeamId:g,stageHasMountainClassifications:v,topMountainIds:$,isHardStage:E})])),x=G.reduce((N,I)=>{var j;return N+(((j=H.get(I.id))==null?void 0:j.finalWeight)??0)},0),P=Kl(G,Math.max(0,Math.min(m-(B?1:0),G.length)),N=>{var I;return((I=H.get(N.id))==null?void 0:I.finalWeight)??1});if(B&&P.push(B),P.length===0)return null;console.groupCollapsed(`[BreakawaySelection] ${a.profile} Etappe ${a.stageNumber}: ${P.length}/${m} ausgewählt aus ${G.length}`),console.log(`Gesamtgewicht im Pool: ${x.toFixed(2)}`),console.table(P.map(N=>{var j;const I=H.get(N.id);return{Fahrer:`${N.firstName} ${N.lastName}`,Team:N.activeTeamId,Rolle:((j=N.role)==null?void 0:j.name)??null,Atk:N.skills.attack,Hill:N.skills.hill,Chance:`${((x>0&&I!=null?I.finalWeight/x:0)*100).toFixed(2)}%`,Gewicht:((I==null?void 0:I.finalWeight)??1).toFixed(2),Attacke:`x${((I==null?void 0:I.attackFactor)??1).toFixed(2)}`,Superform:`x${(I==null?void 0:I.superformFactor)??1}`,GC_Team:`x${((I==null?void 0:I.gcLeaderTeamFactor)??1).toFixed(2)}`,Berg:`x${(I==null?void 0:I.mountainFactor)??1}`,Sprinter:`x${(I==null?void 0:I.sprinterFactor)??1}`}})),console.groupEnd();const V=s.distanceKm*1e3,K=Kt(0,Math.min(1e4,Math.max(0,Math.floor(V*.1)))),se=ed(t,a),X=Math.round(V*Hr(se.min,se.max)),ae=Math.round(V*Hr(.1,.25)),Y=Math.max(K+1e3,Math.min(X-1e3,X-ae)),W=a.rolledBreakawayBonus??0,F=Kt(3+W,8+W);return{riderIds:P.map(N=>N.id),triggerDistanceMeters:K,groupPhaseEndDistanceMeters:Y,phaseEndDistanceMeters:X,skillBonus:F,malusValue:Kt(5,8),superTeamId:C}}const ad=new Set(["Hilly_Difficult","Medium_Mountain","Mountain","High_Mountain","Cobble","Cobble_Hill"]),sd=3,rd=7,Kr=120,Wr=200,jr=180,nd=10,ga=8e3;function vt(e,t,a=Math.random()){const s=Math.ceil(Math.min(e,t)),r=Math.floor(Math.max(e,t));return Math.floor(a*(r-s+1))+s}function id(e){for(let t=e.length-1;t>0;t-=1){const a=vt(0,t);[e[t],e[a]]=[e[a],e[t]]}return e}function Ha(e,t){return t<=0||e.length===0?[]:id([...e]).slice(0,Math.min(t,e.length))}function od(e,t,a){if(t<=0||e.length===0)return[];const s=[...e],r=[];for(;s.length>0&&r.length<t;){const n=s.reduce((c,o)=>c+Math.max(0,a(o)),0);if(n<=0){r.push(...Ha(s,t-r.length));break}let i=Math.random()*n,l=s.length-1;for(let c=0;c<s.length;c+=1)if(i-=Math.max(0,a(s[c])),i<=0){l=c;break}r.push(s[l]),s.splice(l,1)}return r}function ld(e){return ad.has(e.profile)}function dd(e){return e.gradient_percent>5||e.terrain==="Cobble"||e.terrain==="Cobble_Hill"}function cd(e,t){if(!ld(e)||t.distanceKm<=0)return[];const a=t.distanceKm*1e3*Math.max(0,Math.min(1,e.finalPushStartPercent/100));return t.segments.flatMap(s=>{if(!dd(s))return[];const r=s.start_km*1e3,n=s.end_km*1e3,i=Math.max(r,a);return i>=n?[]:[{startMeters:i,endMeters:n,sourceSegmentStartMeters:r,sourceSegmentEndMeters:n}]})}function Or(e,t){const a=t==null?e:e.filter(c=>{const o=Math.min(Math.abs(c.startMeters-t),Math.abs(c.endMeters-t)),p=Math.max(Math.abs(c.startMeters-t),Math.abs(c.endMeters-t));return o>=ga||p>=ga});if(a.length===0)return null;const s=a[vt(0,a.length-1)];if(!s)return null;const r=Math.ceil(s.startMeters),n=Math.floor(s.endMeters);if(n<=r)return null;let i=0;for(;i<12;){const c=vt(r,n);if(t==null||Math.abs(c-t)>=ga)return{triggerDistanceMeters:c,sourceSegmentStartMeters:s.sourceSegmentStartMeters,sourceSegmentEndMeters:s.sourceSegmentEndMeters};i+=1}const l=t!=null&&t<s.startMeters?n:r;return t==null||Math.abs(l-t)>=ga?{triggerDistanceMeters:l,sourceSegmentStartMeters:s.sourceSegmentStartMeters,sourceSegmentEndMeters:s.sourceSegmentEndMeters}:null}function ud(e,t,a,s=()=>1){const r=e.slice(0,15),n=cd(t,a);if(r.length===0||n.length===0)return[];const i=vt(sd,Math.min(rd,r.length)),l=od(r,i,s),c=[];for(const u of l){const f=Or(n);f&&c.push({riderId:u.id,attackNumber:1,triggerDistanceMeters:f.triggerDistanceMeters,durationSeconds:vt(Kr,Wr),sourceSegmentStartMeters:f.sourceSegmentStartMeters,sourceSegmentEndMeters:f.sourceSegmentEndMeters,isCounterAttack:!1})}if(c.length===0)return[];const o=c.map(u=>u.riderId),p=Math.floor(o.length*.5),m=new Set(Ha(o,p));for(const u of[...c]){if(!m.has(u.riderId))continue;const f=Or(n,u.triggerDistanceMeters);f&&c.push({riderId:u.riderId,attackNumber:2,triggerDistanceMeters:f.triggerDistanceMeters,durationSeconds:vt(Kr,Wr),sourceSegmentStartMeters:f.sourceSegmentStartMeters,sourceSegmentEndMeters:f.sourceSegmentEndMeters,isCounterAttack:!1})}return c.sort((u,f)=>u.triggerDistanceMeters-f.triggerDistanceMeters||u.riderId-f.riderId||u.attackNumber-f.attackNumber)}function md(e,t,a){var c;if(e.length===0)return[];const s=((c=e.find(o=>o.kind==="rider"&&o.riderId===t))==null?void 0:c.teamId)??null,r=e.filter(o=>!(o.kind!=="rider"||o.riderId==null||o.riderId===t||a.has(o.riderId)||s!=null&&o.teamId===s));if(r.length===0)return[];const n=new Map;for(const o of r){const p=n.get(o.teamId)??[];p.push(o),n.set(o.teamId,p)}const i=[...n.values()].map(o=>Ha(o,1)[0]??null).filter(o=>o!=null&&o.riderId!=null);if(i.length===0)return[];const l=Math.min(vt(0,3),i.length);return Ha(i,l).map(o=>o.riderId)}function pd(e,t){const a=[],s=[];for(const[r,n]of e.entries()){const i=Math.max(0,n.remainingSeconds-t);if(i<=0){s.push(r);continue}a.push({...n,remainingSeconds:i})}return{newActiveAttacks:a,expiredRiderIds:s}}function ms(e,t){const a=Math.ceil(Math.min(e,t)),s=Math.floor(Math.max(e,t));return Math.floor(Math.random()*(s-a+1))+a}const gd={sprint:.46,acceleration:.24,hill:.06,attack:.08,resistance:.08,stamina:.04,flat:.04},fd={sprint:.45,acceleration:.2,hill:.04,attack:.06,resistance:.06,stamina:.04,flat:.15},hd={mountain:.05,mediumMountain:.05,hill:.28,sprint:.18,acceleration:.12,attack:.12,resistance:.1,stamina:.06,flat:.04},bd={mountain:.38,mediumMountain:.2,hill:.1,sprint:.03,acceleration:.03,attack:.12,resistance:.08,stamina:.06},yd={HC:{mountain:.4,mediumMountain:.2,hill:.07,sprint:.01,acceleration:.02,attack:.16,resistance:.08,stamina:.06},1:{mountain:.31,mediumMountain:.18,hill:.12,sprint:.03,acceleration:.04,attack:.16,resistance:.09,stamina:.07},2:{mountain:.2,mediumMountain:.14,hill:.22,sprint:.08,acceleration:.08,attack:.15,resistance:.08,stamina:.05},3:{mountain:.05,mediumMountain:.09,hill:.27,sprint:.14,acceleration:.12,attack:.16,resistance:.1,stamina:.07},4:{hill:.3,sprint:.18,acceleration:.16,attack:.16,resistance:.12,stamina:.08}};function vd(e){const t=new Map;for(const a of e){const s=a.weights;if(a.appliesTo==="sprint_intermediate")t.set("sprint_intermediate",s);else if(a.appliesTo==="climb_top"){const r=!a.markerCategory||a.markerCategory==="Sprint"?"HC":a.markerCategory;t.set(`climb_top|${r}`,s)}else a.appliesTo==="finish"&&t.set(a.markerType,s)}return t}const fa=20,Sd=120,kd=300,ps=.025,$d=.1,Td=.4,Md=.6,xd=.8,qt=1,Vr=2/3,wd=.1,ha=10,Ur=50,Id=25,Rd=7,Ed=500,Fd=100,Cd=.02,Nd=.04,Pd=.009,Ld=120,Dd=150,Ad=100,Bd=300,Yr=50,gs=85,pt=[{kmMark:100,value:.5},{kmMark:150,value:1},{kmMark:175,value:2},{kmMark:200,value:3},{kmMark:250,value:8},{kmMark:300,value:15}],Zr=5*60,_d=60,Gd=.5,Hd=.3,ba=5e3,zd=2e3,Kd=1,Wd=2,jd=.05,Mi={flat:"Fl",mountain:"Berg",mediumMountain:"MB",hill:"Hgl",timeTrial:"ZF",prologue:"Pro",cobble:"Pf",sprint:"Spr",acceleration:"Acc",downhill:"Abf",attack:"Atk",stamina:"Sta",resistance:"Res",recuperation:"Rec",bikeHandling:"Ftg"},Od={flat:"Flach",mountain:"Berg",mediumMountain:"Mittlere Berge",hill:"Hügel",timeTrial:"Zeitfahren",prologue:"Prolog",cobble:"Pflaster",sprint:"Sprint",acceleration:"Antritt",downhill:"Abfahrt",attack:"Attacke",stamina:"Stamina",resistance:"Widerstand",recuperation:"Regeneration",bikeHandling:"Fahrtechnik"},ya=[{gradientPercent:2,draftPenaltyShare:.1},{gradientPercent:3,draftPenaltyShare:.15},{gradientPercent:4,draftPenaltyShare:.2},{gradientPercent:5,draftPenaltyShare:.3},{gradientPercent:6,draftPenaltyShare:.45},{gradientPercent:7,draftPenaltyShare:.8},{gradientPercent:8,draftPenaltyShare:.9},{gradientPercent:9,draftPenaltyShare:.92},{gradientPercent:10,draftPenaltyShare:.94},{gradientPercent:12,draftPenaltyShare:.96},{gradientPercent:15,draftPenaltyShare:.98},{gradientPercent:20,draftPenaltyShare:1}];function ue(e,t,a){return Math.max(t,Math.min(a,e))}function de(e,t){return e+Math.random()*(t-e)}function Jr(e){return e[Math.floor(Math.random()*e.length)]}function Ct(e){return Math.round(e*100)/100}function Vd(e){let t=2166136261;for(let a=0;a<e.length;a+=1)t^=e.charCodeAt(a),t=Math.imul(t,16777619);return(t>>>0)/4294967295}function qr(e){if(e<2)return 1;const t=ue(e,2,20),a=ya[0];if(t<=a.gradientPercent)return 1-a.draftPenaltyShare;for(let s=1;s<ya.length;s+=1){const r=ya[s-1],n=ya[s];if(t>n.gradientPercent)continue;const i=(t-r.gradientPercent)/Math.max(1e-4,n.gradientPercent-r.gradientPercent),l=r.draftPenaltyShare+(n.draftPenaltyShare-r.draftPenaltyShare)*i;return Math.max(0,1-l)}return 0}function Ud(e){return e==="Flat"?Ld:e==="Abfahrt"?Dd:Number.POSITIVE_INFINITY}function Yd(e){switch(e){case"Flat":return"Flat";case"Hill":return"Hill";case"Medium_Mountain":return"Medium_Mountain";case"Mountain":case"High_Mountain":return"Mountain";case"Cobble":case"Cobble_Hill":return"Cobble";case"Sprint":return"Sprint";case"Abfahrt":return"Downhill";default:return"Flat"}}function za(e){return(e.formBonus??0)+(e.raceFormBonus??0)-((e.fatigueMalus??0)+(e.longTermFatigueMalus??0)+(e.shortTermFatigueMalus??0))*.5}function Zd(e,t){if(t.length===0)return"";const a=t.reduce((p,m)=>p+m.weight,0),s=t.map(p=>{const m=e.skills[p.key],u=Math.round(p.weight/a*100);return`${Mi[p.key]} ${Math.round(m)} (${u}%)`}),r=e.formBonus??0,n=e.raceFormBonus??0,i=(e.fatigueMalus??0)*.5,l=(e.longTermFatigueMalus??0)*.5,c=(e.shortTermFatigueMalus??0)*.5;s.push(`S-Form ${r>=0?"+":""}${r.toFixed(1).replace(".",",")}`),s.push(`R-Form ${n>=0?"+":""}${n.toFixed(1).replace(".",",")}`),i>0&&s.push(`Fatigue -${i.toFixed(1).replace(".",",")}`),l>0&&s.push(`Langzeit -${l.toFixed(1).replace(".",",")}`),c>0&&s.push(`Akut -${c.toFixed(1).replace(".",",")}`);let o=0;if(e.mentorBoosts)for(const p of t)o+=(e.mentorBoosts[p.key]||0)*(p.weight/a);return o>0&&s.push(`Mentor +${o.toFixed(1).replace(".",",")}`),s.join(" • ")}function Jd(){const e=Math.random();return e<.9?de(5,20):e<.98?de(20,40):de(40,70)}function Xr(){const e=Math.random();return e<.9?Ct(de(-1,1)):e<.995?Ct(Jr([-1,1])*de(1,2)):Ct(Jr([-1,1])*de(3,4))}function qd(){return Ct(de(-3,3))}function Xd(e){const t=[];let a=0,s=Jd(),r=de(-1,1);for(;a<e;){const n=Math.min(e-a,de(3e3,4e4));if(t.push({startMeter:a,endMeter:a+n,windSpeedKph:s,vector:r}),a+=n,a>=e)break;s=ue(s+(Math.random()<.5?-1:1)*de(2,10),5,70),r=ue(r+(Math.random()<.5?-1:1)*de(0,.5),-1,1)}return t}function xi(e,t){const a=Q(e),s=Q(t);if(a!==s)return a?1:-1;const r=he(e),n=he(t);return r&&n?(e.finishTimeSeconds??0)-(t.finishTimeSeconds??0)||t.photoFinishScore-e.photoFinishScore||e.rider.id-t.rider.id:r?-1:n?1:e.distanceCoveredMeters!==t.distanceCoveredMeters?t.distanceCoveredMeters-e.distanceCoveredMeters:e.rider.id-t.rider.id}function Q(e){return e.finishStatus==="dnf"||e.finishTimeSeconds!=null}function he(e){return e.finishStatus!=="dnf"&&e.finishTimeSeconds!=null}function Wt(e,t,a=!1,s=null){var c;const r="rider"in e?e.rider:null,n=(r==null?void 0:r.specialization1)??null,i=(r==null?void 0:r.specialization2)??null;let l=0;if(t==="sprint_intermediate")n==="Berg"?l-=3:i==="Berg"&&(l-=2),n==="Sprint"?l+=1:i==="Sprint"&&(l+=.5);else if(t==="finish_flat")n==="Sprint"?l+=2:i==="Sprint"&&(l+=1),a&&((n==="Sprint"||i==="Sprint")&&(l+=1),n==="Berg"?l-=3:i==="Berg"&&(l-=2));else if(t==="climb_top"){const o=(c=r==null?void 0:r.role)==null?void 0:c.name;s==="4"?(n==="Sprint"?l-=3:i==="Sprint"&&(l-=1.5),(o==="Edelhelfer"||o==="Starke Helfer")&&(l+=2),o==="Wassertraeger"&&(l+=1),o==="Co-Kapitaen"&&(l-=1),o==="Kapitaen"&&(l-=3)):(n==="Sprint"?l-=3:i==="Sprint"&&(l-=1.5),o==="Edelhelfer"&&(l+=3),o==="Starke Helfer"&&(l+=1.5),o==="Wassertraeger"&&(l+=.5),o==="Co-Kapitaen"&&(l-=1),o==="Kapitaen"&&(l-=2)),(n==="Attacker"||i==="Attacker")&&(l+=3)}return l}function Qd(e,t,a=null,s=null,r=!1){var f,g;const n=b=>b.photoFinishScore;if(!t){const b=[...e].sort((v,T)=>v.crossingTimeSeconds-T.crossingTimeSeconds||T.photoFinishScore-v.photoFinishScore||v.riderId-T.riderId),y=((f=b[0])==null?void 0:f.crossingTimeSeconds)??0;return b.map((v,T)=>({riderId:v.riderId,rank:T+1,crossingTimeSeconds:v.crossingTimeSeconds,gapSeconds:Math.max(0,v.crossingTimeSeconds-y),photoFinishScore:v.photoFinishScore}))}const i=[...e].sort((b,y)=>b.crossingTimeSeconds-y.crossingTimeSeconds||y.photoFinishScore-b.photoFinishScore||b.riderId-y.riderId),l=((g=i[0])==null?void 0:g.crossingTimeSeconds)??0,c=[];let o=[],p=0,m=null;const u=()=>{const b=Math.max(0,p-l),y=o.sort((v,T)=>n(T)-n(v)||v.riderId-T.riderId);for(const v of y)c.push({riderId:v.riderId,rank:c.length+1,crossingTimeSeconds:v.crossingTimeSeconds,gapSeconds:b,photoFinishScore:v.photoFinishScore})};for(const b of i){if(o.length===0){o=[b],p=b.crossingTimeSeconds,m=b.crossingTimeSeconds;continue}if(m!=null&&b.crossingTimeSeconds-m<=qt){o.push(b),m=b.crossingTimeSeconds;continue}u(),o=[b],p=b.crossingTimeSeconds,m=b.crossingTimeSeconds}return o.length>0&&u(),c}function ec(e,t,a){const s=e.filter(he).sort((m,u)=>(m.finishTimeSeconds??0)-(u.finishTimeSeconds??0)||u.photoFinishScore-m.photoFinishScore||m.rider.id-u.rider.id),r=e.filter(m=>!Q(m)).sort(xi),n=e.filter(m=>m.finishStatus==="dnf").sort((m,u)=>u.distanceCoveredMeters-m.distanceCoveredMeters||m.rider.id-u.rider.id),i=[];let l=[],c=null;const o=m=>m.photoFinishScore,p=()=>{i.push(...l.sort((m,u)=>o(u)-o(m)||m.rider.id-u.rider.id))};for(const m of s){const u=m.finishTimeSeconds??0;if(l.length===0){l=[m],c=u;continue}if(c!=null&&u-c<=qt){l.push(m),c=u;continue}p(),l=[m],c=u}return l.length>0&&p(),[...i,...r,...n]}function tc(e,t){const a=Q(e),s=Q(t);if(a!==s)return a?1:-1;const r=t.distanceCoveredMeters-e.distanceCoveredMeters;return Math.abs(r)>=.1?r:e.tempSpeedMps!==t.tempSpeedMps?t.tempSpeedMps-e.tempSpeedMps:he(e)&&he(t)?(e.finishTimeSeconds??0)-(t.finishTimeSeconds??0)||e.rider.id-t.rider.id:he(e)?-1:he(t)?1:e.rider.id-t.rider.id}function Qr(e){const t=ue(e,1,Ur);return t<=2?.12*t:t<=ha?.24+(t-2)/Math.max(1,ha-2)*.58:.82+(t-ha)/Math.max(1,Ur-ha)*.18}function fs(e,t){const a=za(e.rider);return Object.entries(t).reduce((s,[r,n])=>{if(!n)return s;const i=r==="stamina"?e.staminaSkillPenalty+e.incidentStaminaPenalty:0,l=Math.max(0,e.rider.skills[r]+a+e.dailyForm+e.microForm+e.teamGroupBonus-i);return s+l*n},0)}function ac(e,t){const a=za(e.rider);return Object.entries(t).filter(s=>!!s[1]).map(([s,r])=>{const n=s,i=n==="stamina"?e.staminaSkillPenalty+e.incidentStaminaPenalty:0,l=Math.max(0,e.rider.skills[n]+a+e.dailyForm+e.microForm+e.teamGroupBonus-i);return{skillKey:n,weight:r,effectiveSkill:l,contribution:l*r}})}function sc(e,t,a){let s=t;for(;s>0;){const n=e[s-1].distanceCoveredMeters-e[s].distanceCoveredMeters;if(n<=0||n>=a)break;s-=1}let r=t;for(;r<e.length-1;){const n=e[r].distanceCoveredMeters-e[r+1].distanceCoveredMeters;if(n<=0||n>=a)break;r+=1}return{startIndex:s,endIndex:r,size:r-s+1,positionInGroup:t-s}}function rc(e,t){if(e<Id)return!1;const a=Math.max(1,Math.floor(e*.1));return t<a}class wi{constructor(t,a){var G,H;this.bootstrap=t,this.weightedSkillComponentsByTerrain=new Map,this.skillBreakdownCache=new Map,this.teamSprintRandomValues=new Map,this.teamSprintSpecialRandomValues=new Map,this.teamBestSprinterRiderId=new Map,this.lastTeamGroupBonusByRiderId=null,this.draftOrderScratch=[],this.elapsedSeconds=0,this.activeStageAttacksByRiderId=new Map,this.nextBreakawayGapPenaltyMarkerIndex=0,this.nextBreakawayGapPenaltyFallbackIndex=0,this.breakawayGapStatus=null,this.breakawayPhaseActive=!1,this.breakawayGroupPhaseEnded=!1,this.breakawayPhaseEnded=!1,this.breakawayCaughtLogged=!1,this.messages=[],this.allEvents=[],this.nextMessageId=1,this.superTeamProtectedLeaderIds=new Set,this.superTeamBonusAmount=0,this.superTeamMalusAmount=0,this.superTeamStartPercent=0,this.superTeamEndPercent=0,this.superTeamBreakawayRiderCaught=!1,this.hasLoggedFinishSprintTieBreak=!1,this.hasAppliedSprintLeadoutBonuses=!1,this.maxSubstepSeconds=(a==null?void 0:a.maxSubstepSeconds)??1;const s=(G=t.race.country)==null?void 0:G.code3;s&&(t.riders=t.riders.map(x=>{var V;const P=x.nationality||((V=x.country)==null?void 0:V.code3);if(P&&P.trim().toUpperCase()===s.trim().toUpperCase()){const K={...x,skills:{...x.skills}},se=Math.random(),X=t.stage.profile,ae=X==="ITT"||X==="TTT",Y=["flat","hill","sprint","acceleration","stamina","resistance","recuperation","bikeHandling"];(X==="Cobble"||X==="Cobble_Hill")&&Y.push("cobble"),["Flat","Rolling","Cobble","Cobble_Hill","ITT","TTT"].includes(X)||Y.push("mountain","mediumMountain");const I=[...(j=>{const _=[...Y],k=[];if(ae){k.push("timeTrial");const A=Math.min(j-1,_.length);for(let z=0;z<A;z++){const U=Math.floor(Math.random()*_.length);k.push(_.splice(U,1)[0])}}else{const A=Math.min(j,_.length);for(let z=0;z<A;z++){const U=Math.floor(Math.random()*_.length);k.push(_.splice(U,1)[0])}}return k})(5)].sort(()=>Math.random()-.5);if(K.homeEffectSkills=I,se<.05){K.homeEffect="home_pressure";for(const j of I)K.skills[j]=Math.max(0,K.skills[j]-.5)}else if(se<.1){K.homeEffect="super_home";const j=I[0];K.skills[j]=Math.min(100,K.skills[j]+3);for(let _=1;_<5;_++){const k=I[_];K.skills[k]=Math.min(100,K.skills[k]+1)}}else{K.homeEffect="normal_home";for(const j of I)K.skills[j]=Math.min(100,K.skills[j]+1)}return K}return x})),this.stageDistanceMeters=t.stageSummary.distanceKm*1e3,this.isIndividualTimeTrial=t.stage.profile==="ITT",this.isTeamTimeTrial=t.stage.profile==="TTT",this.isTimeTrialMode=this.isIndividualTimeTrial||this.isTeamTimeTrial,this.simulationMode=El(t.stage.profile),this.skillWeightRuleMap=Il(t.skillWeightRules??[]),this.skillWeightConfigMap=Rl(t.skillWeightRules??[]),this.stageScoringWeightMap=vd(t.stageScoringRules??[]),this.finishWeightProfile=this.resolveFinishWeightProfile(),this.windZones=Xd(this.stageDistanceMeters),this.intermediateMarkers=this.buildIntermediateMarkers();const r=t.stage.finalSpreadStartPercent;this.lateStageStartRatio=r!=null?ue(r/100,0,1):de(Md,xd);const n=t.stage.finalPushStartPercent;this.finalPushStartRatio=n!=null?ue(n/100,this.lateStageStartRatio,1):ue(.9,this.lateStageStartRatio,1),this.finalSpreadDifficultyMultiplier=t.stage.finalSpreadDifficultyMultiplier??1,this.spreadCurve=this.buildSpreadCurve(this.lateStageStartRatio);const i=Bl(t.riders,t.stage,t.stageSummary.distanceKm);if(this.incidentsByRiderId=new Map(i.map(x=>[x.riderId,x])),i.length>0){console.log("[RaceIncidents] Vor der Etappe ausgewuerfelt:",i.map(P=>({riderId:P.riderId,type:P.type,severity:P.severity,kmMark:P.triggerDistanceKm,waitDurationSeconds:P.waitDurationSeconds,supportRiderIds:P.supportRiderIds})));const x=i.filter(P=>P.isMassCrashTrigger);x.length>0&&x.forEach(P=>{var V;console.log(`[RaceIncidents] Massensturz vor der Etappe ausgewuerfelt! Auslöser: Fahrer ${P.riderId} bei Km ${P.triggerDistanceKm}. Potenziell betroffene Fahrer (${(V=P.massCrashPotentialRiderIds)==null?void 0:V.length}):`,P.massCrashPotentialRiderIds)})}const l=t.riders.map(x=>{const P={rider:x,riderName:`${x.firstName} ${x.lastName}`,startOffsetSeconds:0,hasStarted:!this.isTimeTrialMode,distanceCoveredMeters:0,nextDistanceCoveredMeters:null,segmentStartKm:0,segmentEndKm:0,segmentStartElevation:0,segmentEndElevation:0,dailyForm:qd(),microForm:Xr(),nextFormUpdateMeter:de(5e3,4e4),finishTimeSeconds:null,segmentIndex:0,windZoneIndex:0,activeTerrain:"Flat",skillName:"Flat",skillBreakdown:"",baseSkill:0,teamGroupBonus:0,effectiveSkill:0,staminaPenalty:0,staminaSkillPenalty:0,elevationPenalty:0,staminaPenaltyKmBucket:0,elevationPenaltyHmBucket:0,gradientPercent:0,gradientModifier:1,windModifier:1,draftModifier:1,draftNearbyRiderCount:0,draftPackFactor:0,tempSpeedMps:0,currentSpeedMps:0,photoFinishScore:0,nextIntermediateIndex:0,lastSplitLabel:null,lastSplitTimeSeconds:null,splitTimes:{},markerCrossings:{},finishStatus:null,statusReason:null,pendingIncident:this.incidentsByRiderId.get(x.id)??null,appliedIncident:null,incidentDelaySecondsRemaining:0,incidentRecoverySecondsRemaining:0,incidentRecoveryFormBonus:0,incidentStaminaPenalty:0,dailyFormCap:null,waitingForCaptainId:null,waitForCaptainRecovery:!1,waitLogged:!1,breakawayMalus:0,breakawayInitialMalus:0,breakawayRecoveryStartDistanceMeters:null,breakawayGapPenalty:0,breakawayFallbackCheckpointTimes:[],nextBreakawayFallbackCheckpointIndex:0,isAttacking:!1,isBreakaway:!1,isLeadingGroup:!this.isTimeTrialMode};return this.applyPersistentStageRaceState(P),P}),c=new Map(l.map(x=>[x.rider.id,x.dailyForm]));this.stageFavorites=Jn(t.riders,t.teams,t.stage,{distanceKm:t.stageSummary.distanceKm,elevationGainMeters:t.stageSummary.elevationGainMeters,dailyFormByRiderId:c});const o=this.stageFavorites.filter(x=>x.kind==="rider"&&x.riderId!=null).slice(0,15).map(x=>t.riders.find(P=>P.id===x.riderId)??null).filter(x=>x!=null),p=((H=t.gcStandings.find(x=>x.rank===1))==null?void 0:H.riderId)??null,m=ud(o,t.stage,t.stageSummary,x=>Math.max(1,Math.pow(10,(x.skills.attack-65)/10))*(x.id===p?.25:1));this.precalculatedStageAttacksByRiderId=new Map;for(const x of m){const P=this.precalculatedStageAttacksByRiderId.get(x.riderId)??[];P.push(x),this.precalculatedStageAttacksByRiderId.set(x.riderId,P)}this.breakawayPlan=td(t.riders,t.race,t.stage,t.stageSummary,this.stageFavorites,t.gcStandings,t.mountainStandings,t.teams);const u=this.buildBreakawayGapPenaltyConfig();this.breakawayGapPenaltyMarkers=u.markers,this.breakawayGapPenaltyFallbackCheckpointsMeters=u.fallbackCheckpointsMeters;for(const x of l)x.breakawayFallbackCheckpointTimes=new Array(this.breakawayGapPenaltyFallbackCheckpointsMeters.length).fill(null);const f=zl(t.riders,t.stage,{teams:t.teams,distanceKm:t.stageSummary.distanceKm,elevationGainMeters:t.stageSummary.elevationGainMeters,dailyFormByRiderId:c}),g=new Map(f.map(x=>[x.id,x])),b=l.map(x=>{const P=g.get(x.rider.id)??x.rider;return{...x,rider:P,riderName:`${P.firstName} ${P.lastName}`,dailyForm:x.dailyForm+(P.specialFormDelta??0)}}),y=f.filter(x=>x.hasSuperform),v=f.filter(x=>x.hasSupermalus);(y.length>0||v.length>0)&&console.log("[RaceSpecialForm] Vor der Etappe ausgewuerfelt:",{superform:y.map(x=>`${x.firstName} ${x.lastName}`),supermalus:v.map(x=>`${x.firstName} ${x.lastName}`)});const T=this.resolveStartOrder(b),w=new Map((this.bootstrap.teamStartOrder??[]).map((x,P)=>[x,P]));if(this.riders=T.map((x,P)=>({...x,startOffsetSeconds:this.resolveStartOffsetSeconds(x,P,w)})),this.riders.forEach(x=>this.syncRiderTelemetry(x)),this.breakawayPlan&&this.breakawayPlan.superTeamId!=null){this.superTeamId=this.breakawayPlan.superTeamId,this.superTeamBonusAmount=ms(2,6),this.superTeamMalusAmount=ms(4,8),this.superTeamStartPercent=de(.4,.6),this.superTeamEndPercent=de(.86,.96);const x=Y=>(Y??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),P=t.riders.filter(Y=>Y.activeTeamId===this.superTeamId),V=P.filter(Y=>{var W;return x((W=Y.role)==null?void 0:W.name)==="kapitaen"}),K=P.filter(Y=>{var W;return x((W=Y.role)==null?void 0:W.name)==="co-kapitaen"});if(V.length>0){if(V.forEach(Y=>this.superTeamProtectedLeaderIds.add(Y.id)),V.length===1&&K.length>0){const Y=[...K].sort((W,F)=>F.overallRating-W.overallRating||F.id-W.id);this.superTeamProtectedLeaderIds.add(Y[0].id)}}else if(K.length>0)[...K].sort((W,F)=>F.overallRating-W.overallRating||F.id-W.id).slice(0,2).forEach(W=>this.superTeamProtectedLeaderIds.add(W.id));else{const Y=P.filter(W=>{var F;return x((F=W.role)==null?void 0:F.name)==="edelhelfer"});if(Y.length>0){const W=[...Y].sort((F,N)=>N.overallRating-F.overallRating||N.id-F.id);this.superTeamProtectedLeaderIds.add(W[0].id)}}const se=t.teams.find(Y=>Y.id===this.superTeamId),X=se?se.name:`Team ${this.superTeamId}`;this.pushMessage({elapsedSeconds:0,riderId:null,riderName:null,riderTeamId:this.superTeamId,type:"superteam",tone:"neutral",title:`Superteam des Tages: ${X}`,detail:`Dieses Team hat sich heute zusammengeschlossen, um seinen Leader zu unterstützen! Die Helfer erhalten zwischen ${(this.superTeamStartPercent*100).toFixed(0)}% und ${(this.superTeamEndPercent*100).toFixed(0)}% der Etappe einen Bonus von +${this.superTeamBonusAmount} auf Berg, Hill, Medium Mountain und Flat. Danach folgt ein individueller Malus von -4 bis -8 wegen Erschöpfung.`});const ae=this.riders.find(Y=>{var W;return Y.rider.activeTeamId===this.superTeamId&&((W=this.breakawayPlan)==null?void 0:W.riderIds.includes(Y.rider.id))});ae&&(this.superTeamBreakawayRiderId=ae.rider.id)}for(const x of this.riders){const P=x.rider.homeEffectSkills,V=K=>Od[K]||K;if(x.rider.homeEffect==="super_home"){const K=P&&P.length===5?`${V(P[0])} (+3), ${V(P[1])} (+1), ${V(P[2])} (+1), ${V(P[3])} (+1), ${V(P[4])} (+1)`:"";this.pushMessage({elapsedSeconds:0,riderId:x.rider.id,riderName:x.riderName,type:"support_resume",tone:"neutral",title:`${this.formatRiderWithPreStageGc(x.rider.id,x.riderName)} hat heute Super-Heimvorteil!`,detail:`Beflügelt durch die Fans im eigenen Land! (+1 auf 4 Skills, +3 auf einen Skill) (${K})`})}if(x.rider.homeEffect==="home_pressure"){const K=P?P.map(V).join(", "):"";this.pushMessage({elapsedSeconds:0,riderId:x.rider.id,riderName:x.riderName,type:"support_wait",tone:"danger",title:`${this.formatRiderWithPreStageGc(x.rider.id,x.riderName)} leidet unter Heimdruck!`,detail:`Der Druck im eigenen Land belastet die Nerven. (-0,5 auf 5 Skills) (${K})`})}if(x.rider.homeEffect==="normal_home"){const K=P?P.map(V).join(", "):"";this.pushMessage({elapsedSeconds:0,riderId:x.rider.id,riderName:x.riderName,type:"support_resume",tone:"neutral",title:`${this.formatRiderWithPreStageGc(x.rider.id,x.riderName)} hat heute Heimvorteil!`,detail:`Beflügelt durch die Fans im eigenen Land! (+1 auf 5 Skills) (${K})`})}x.rider.hasSuperform&&this.pushMessage({elapsedSeconds:0,riderId:x.rider.id,riderName:x.riderName,type:"support_resume",tone:"neutral",title:`${this.formatRiderWithPreStageGc(x.rider.id,x.riderName)} hat heute einen guten Tag`,detail:"Superform aktiv."}),x.rider.hasSupermalus&&this.pushMessage({elapsedSeconds:0,riderId:x.rider.id,riderName:x.riderName,type:"support_wait",tone:"danger",title:`${this.formatRiderWithPreStageGc(x.rider.id,x.riderName)} hat heute einen schlechten Tag`,detail:"Supermalus aktiv."}),x.rider.activePeakDate===this.bootstrap.stage.date&&this.pushMessage({elapsedSeconds:0,riderId:x.rider.id,riderName:x.riderName,type:"support_resume",tone:"neutral",title:`${this.formatRiderWithPreStageGc(x.rider.id,x.riderName)} hat heute seinen Formhöhepunkt`,detail:"Formhöhepunkt erreicht."})}const M=this.bootstrap.stage.rolledWetterName??"Sonnig",$=this.bootstrap.stage.rolledEffektSturz??0,E=this.bootstrap.stage.rolledEffektDefekt??0,R=this.bootstrap.stage.rolledWindkantenGefahr??0,L=this.bootstrap.stage.rolledEffektFatigue??0,C=this.bootstrap.stage.rolledBreakawayBonus??0,D=[];$>0&&D.push(`Sturzwahrscheinlichkeit +${$.toFixed(1)}%`),E>0&&D.push(`Defektwahrscheinlichkeit +${E.toFixed(1)}%`),R>0&&D.push(`Windkanten-Gefahr +${(R*100).toFixed(1)}%`),L>0&&D.push(`Fatigue +${L.toFixed(1)}%`),C>0&&D.push(`Ausreißer-Bonus +${C.toFixed(1)}`);const B=D.length>0?`Wettereinflüsse: ${D.join(", ")}`:"Keine nennenswerten Wettereinflüsse auf das Rennen.";this.pushMessage({elapsedSeconds:0,riderId:null,riderName:null,type:"support_resume",tone:"neutral",title:`Wetterbericht: ${M}`,detail:B})}step(t){if(t<=0||this.isFinished())return this.getFrameSnapshot();let a=t;for(;a>0&&!this.isFinished();){const s=Math.min(a,this.maxSubstepSeconds);this.advanceSubstep(s),a-=s}return this.getFrameSnapshot()}getFrameSnapshot(){const t=this.getOrderedRiders();return this.buildFrameSnapshot(t)}getSnapshot(){const t=this.getOrderedRiders(),a=this.buildFrameSnapshot(t);return{...a,riders:t.map(s=>({riderId:s.rider.id,riderName:s.riderName,startOffsetSeconds:s.startOffsetSeconds,riderClockSeconds:this.resolveRiderClockSeconds(s),hasStarted:s.hasStarted||Q(s),distanceCoveredMeters:s.distanceCoveredMeters,gapToLeaderMeters:Math.max(0,a.leaderDistanceMeters-s.distanceCoveredMeters),segmentStartKm:s.segmentStartKm,segmentEndKm:s.segmentEndKm,segmentStartElevation:s.segmentStartElevation,segmentEndElevation:s.segmentEndElevation,activeTerrain:he(s)?"Finish":s.activeTerrain,skillName:he(s)?"Finish":s.skillName,skillBreakdown:he(s)?"":s.skillBreakdown,baseSkill:s.baseSkill,teamGroupBonus:s.teamGroupBonus,effectiveSkill:s.effectiveSkill,staminaPenalty:s.staminaPenalty,elevationPenalty:s.elevationPenalty,dailyForm:s.dailyForm,microForm:s.microForm,gradientPercent:s.gradientPercent,gradientModifier:s.gradientModifier,windModifier:s.windModifier,draftModifier:s.draftModifier,draftNearbyRiderCount:s.draftNearbyRiderCount,draftPackFactor:s.draftPackFactor,currentSpeedMps:s.currentSpeedMps,photoFinishScore:s.photoFinishScore,leadoutBonus:s.leadoutBonus,leadoutRiderId:s.leadoutRiderId,leadoutContributions:s.leadoutContributions,lastSplitLabel:s.lastSplitLabel,lastSplitTimeSeconds:s.lastSplitTimeSeconds,splitTimes:{...s.splitTimes},finishTimeSeconds:Number.isFinite(s.finishTimeSeconds??Number.NaN)?s.finishTimeSeconds:null,finishStatus:s.finishStatus,statusReason:s.statusReason,isAttacking:s.isAttacking,isBreakaway:s.isBreakaway,isLeadingGroup:s.isLeadingGroup,hasSuperform:s.rider.hasSuperform===!0,hasSupermalus:s.rider.hasSupermalus===!0,isFinished:he(s)})),markerClassifications:this.buildMarkerClassifications(t),incidents:this.riders.flatMap(s=>s.appliedIncident?[s.appliedIncident]:[]),messages:[...this.messages],allEvents:[...this.allEvents],stageFavorites:this.stageFavorites,breakawayPhaseActive:this.isBreakawayGroupPhaseActive(),breakawayGapStatus:this.breakawayGapStatus==null?null:{...this.breakawayGapStatus},superTeamId:this.superTeamId}}applyPersistentStageRaceState(t){t.dailyForm+=t.rider.stageRaceDayFormPenalty??0,t.microForm+=t.rider.stageRaceMicroFormPenalty??0,t.incidentStaminaPenalty+=t.rider.stageRaceStaminaPenalty??0,t.dailyFormCap=t.rider.stageRaceDayFormCap??null,t.dailyFormCap!=null&&(t.dailyForm=Math.min(t.dailyForm,t.dailyFormCap))}pushMessage(t){var n;const a=t.riderTeamId??(t.riderId!=null?((n=this.riders.find(i=>i.rider.id===t.riderId))==null?void 0:n.rider.activeTeamId)??null:null);let s=null;if(t.riderId!=null){const i=this.riders.find(l=>l.rider.id===t.riderId);i&&(s=Number((i.distanceCoveredMeters/1e3).toFixed(2)))}if(s==null){const i=this.riders.filter(l=>l.finishStatus!=="dnf").reduce((l,c)=>Math.max(l,c.distanceCoveredMeters),0);s=Number((i/1e3).toFixed(2))}const r={id:this.nextMessageId,...t,riderTeamId:a,kmMark:s};this.messages.unshift(r),this.allEvents.push(r),this.nextMessageId+=1,this.messages.length>60&&(this.messages.length=60)}buildMarkerClassifications(t){const a=new Map(t.map(s=>[s.rider.id,s]));return this.intermediateMarkers.map(s=>{const r=t.map(i=>i.markerCrossings[s.key]??null).filter(i=>i!=null),n=Qd(r,!this.isTimeTrialMode,s.markerType,a,this.isClimberMalusStage());return{markerKey:s.key,markerLabel:s.label,markerType:s.markerType,markerCategory:s.markerCategory,kmMark:s.distanceMeters/1e3,entries:n}})}getOrderedRiders(){return this.isFinished()&&!this.hasAppliedSprintLeadoutBonuses&&(this.applySprintLeadoutBonuses(),this.hasAppliedSprintLeadoutBonuses=!0),this.isTimeTrialMode?[...this.riders].sort(xi):ec(this.riders,this.resolveFinishMarkerType(),this.isClimberMalusStage())}isClimberMalusStage(){if(this.isTimeTrialMode)return!1;const t=this.bootstrap.stage.profile;return t==="Flat"||t==="Rolling"}buildFrameSnapshot(t){const a=t.filter(r=>r.finishStatus!=="dnf").reduce((r,n)=>Math.max(r,n.distanceCoveredMeters),0);let s=0;for(const r of t)he(r)&&(s+=1);return{elapsedSeconds:this.elapsedSeconds,stageDistanceMeters:this.stageDistanceMeters,leaderDistanceMeters:a,finishedRiders:s,isFinished:this.isFinished(),clusters:this.buildClusters(t),windZones:this.windZones}}isFinished(){return this.riders.every(Q)}advanceSubstep(t){const a=this.elapsedSeconds,s=a+t,r=this.isTimeTrialMode?null:this.lastTeamGroupBonusByRiderId??this.buildTeamGroupBonusByRiderId();if(this.updateBreakawayPhaseState(),this.superTeamId!=null&&this.superTeamBreakawayRiderId!=null&&!this.superTeamBreakawayRiderCaught){const o=this.riders.find(p=>p.rider.id===this.superTeamBreakawayRiderId);o&&!Q(o)&&this.riders.filter(u=>this.superTeamProtectedLeaderIds.has(u.rider.id)&&!Q(u)).some(u=>u.distanceCoveredMeters>=o.distanceCoveredMeters)&&(this.superTeamBreakawayRiderCaught=!0,o.breakawayMalus=0,this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:o.rider.id,riderName:o.riderName,type:"superteam",tone:"neutral",title:`${this.formatRiderWithPreStageGc(o.rider.id,o.riderName)} von Leader eingeholt!`,detail:"Der Ausreißer wurde von seinem Kapitän eingeholt und unterstützt das Team ab jetzt mit frischen Kräften!"}))}if(this.superTeamBreakawayRiderCaught&&this.superTeamBreakawayRiderId!=null){const o=this.riders.find(p=>p.rider.id===this.superTeamBreakawayRiderId);o&&(o.breakawayMalus=0)}for(const o of this.riders){if(Q(o)){o.nextDistanceCoveredMeters=null,o.tempSpeedMps=0,o.draftModifier=1,o.draftNearbyRiderCount=0,o.draftPackFactor=0,o.currentSpeedMps=0,o.isAttacking=!1,o.isLeadingGroup=!1;continue}if(this.isTimeTrialMode&&s<=o.startOffsetSeconds){o.nextDistanceCoveredMeters=null,o.tempSpeedMps=0,o.draftModifier=1,o.draftNearbyRiderCount=0,o.draftPackFactor=0,o.currentSpeedMps=0,o.teamGroupBonus=0,o.isAttacking=!1,o.isLeadingGroup=!1;continue}const p=this.isTimeTrialMode?Math.max(a,o.startOffsetSeconds):a,m=Math.max(0,s-p);if(m<=0)continue;if(o.incidentDelaySecondsRemaining>0){o.incidentDelaySecondsRemaining=Math.max(0,o.incidentDelaySecondsRemaining-m),o.tempSpeedMps=0,o.currentSpeedMps=0,o.nextDistanceCoveredMeters=o.distanceCoveredMeters,o.isAttacking=this.activeStageAttacksByRiderId.has(o.rider.id);continue}o.hasStarted=!0,this.advanceIndexForDistance(o);const u=this.currentSegment(o),f=this.currentWindZone(o);if(!u||!f){o.distanceCoveredMeters=this.stageDistanceMeters,o.nextDistanceCoveredMeters=this.stageDistanceMeters,o.finishTimeSeconds=p,o.tempSpeedMps=0,o.draftModifier=1,o.draftNearbyRiderCount=0,o.draftPackFactor=0,o.currentSpeedMps=0,o.isAttacking=!1,o.isLeadingGroup=!1,o.activeTerrain="Finish",o.skillName="Finish",o.skillBreakdown="",o.photoFinishScore=this.calculatePhotoFinishScore(o);const b=Wt(o,this.resolveFinishMarkerType(),this.isClimberMalusStage());o.photoFinishScore+=b,o.leadoutBonus=0,o.leadoutRiderId=null,o.leadoutContributions=[];continue}o.teamGroupBonus=this.resolveTeamGroupBonusValue(o,r);const g=this.calculateBasePhysics(o,u,f);o.activeTerrain=u.terrain,o.skillName=g.skillName,o.skillBreakdown=g.skillBreakdown,o.baseSkill=g.baseSkill,o.teamGroupBonus=g.teamGroupBonus,o.effectiveSkill=g.effectiveSkill,o.staminaPenalty=g.staminaPenalty,o.elevationPenalty=g.elevationPenalty,o.gradientPercent=g.gradientPercent,o.gradientModifier=g.gradientModifier,o.windModifier=g.windModifier,o.tempSpeedMps=g.tempSpeedMps,o.draftModifier=1,o.draftNearbyRiderCount=0,o.draftPackFactor=0,o.currentSpeedMps=g.tempSpeedMps,o.photoFinishScore=this.calculatePhotoFinishScore(o),o.isAttacking=this.activeStageAttacksByRiderId.has(o.rider.id),o.isLeadingGroup=!this.isTimeTrialMode,o.nextDistanceCoveredMeters=null,o.nextDistanceCoveredMeters=o.distanceCoveredMeters+o.currentSpeedMps*m}if(this.applyBreakawaySkillTempo(t),this.isTeamTimeTrial)this.applyTeamTimeTrialTempo(a,s);else if(!this.isTimeTrialMode){const o=this.draftOrderScratch;o.length=0;for(const p of this.riders)o.push(p);o.sort(tc);for(let p=0;p<o.length;p+=1){const m=o[p];if(Q(m))continue;const u=this.isActiveBreakawayRider(m),f=m.tempSpeedMps/14,g=Math.max(5,50*f),b=this.currentSegment(m),y=Math.max(15,150*f),v=Math.max(g,Math.min(y,Ud(b==null?void 0:b.terrain))),T=sc(o,p,v),w=T.size,M=Qr(w),$=rc(w,T.positionInGroup);let E=0,R=Number.POSITIVE_INFINITY,L=null;for(let F=p-1;F>=0;F-=1){const N=o[F],I=N.distanceCoveredMeters-m.distanceCoveredMeters;if(I>=v+wd)break;!this.canReceiveDraftFromCandidate(m,N)||this.isActiveBreakawayRider(N)||I<=0||I>=v||(E+=1,I<=R&&(R=I,L=N))}if(E===0||!L){if(u)continue;m.draftModifier=1,m.draftNearbyRiderCount=0,m.draftPackFactor=0,m.currentSpeedMps=m.tempSpeedMps,m.nextDistanceCoveredMeters=m.distanceCoveredMeters+m.currentSpeedMps*t,m.isLeadingGroup=!0,this.applyCaptainWaitLogic(m);continue}const C=Q(L)?L.tempSpeedMps:L.currentSpeedMps,D=R,B=D<=g?1:1-(D-g)/Math.max(1e-4,v-g),G=this.currentWindZone(m),H=(G==null?void 0:G.vector)??0,x=(G==null?void 0:G.windSpeedKph)??0,P=-H*(x/70),K=Math.max(.3,.35+.35*P)*Math.min(1,f)*Vr,se=ue((b==null?void 0:b.gradient_percent)??0,-20,20),X=qr(se),Y=1+($?0:K*B*M*X),W=m.tempSpeedMps*Y;if(!(u&&Y<=m.draftModifier)){if(m.draftModifier=Y,m.draftNearbyRiderCount=w,m.draftPackFactor=M,m.isLeadingGroup=$,W>C){if(m.tempSpeedMps>L.tempSpeedMps){m.currentSpeedMps=W,m.nextDistanceCoveredMeters=m.distanceCoveredMeters+m.currentSpeedMps*t;continue}if(D<1){m.currentSpeedMps=C,m.nextDistanceCoveredMeters=L.distanceCoveredMeters+C*t,u||this.applyCaptainWaitLogic(m);continue}m.currentSpeedMps=Math.min(W,C+2),m.nextDistanceCoveredMeters=m.distanceCoveredMeters+m.currentSpeedMps*t,u||this.applyCaptainWaitLogic(m);continue}m.currentSpeedMps=W,m.nextDistanceCoveredMeters=m.distanceCoveredMeters+m.currentSpeedMps*t,u||this.applyCaptainWaitLogic(m)}}}this.applyBreakawayGroupTempo(t);for(const o of this.riders)o.incidentRecoverySecondsRemaining>0&&o.draftModifier>=1.2&&(o.incidentRecoverySecondsRemaining=0,o.incidentRecoveryFormBonus=0);const n=this.isTimeTrialMode?null:this.buildTeamGroupBonusByRiderId();this.lastTeamGroupBonusByRiderId=n;for(const o of this.riders){if(Q(o))continue;if(this.superTeamId!=null&&o.rider.activeTeamId===this.superTeamId&&!this.superTeamProtectedLeaderIds.has(o.rider.id)){const v=o.rider.id===this.superTeamBreakawayRiderId;if(!v||this.superTeamBreakawayRiderCaught){const T=o.distanceCoveredMeters/this.stageDistanceMeters;let w=0,M=!1,$=!1;v?T<this.superTeamEndPercent?M=!0:o.superTeamActiveLogged&&($=!0):T>=this.superTeamStartPercent&&T<this.superTeamEndPercent?M=!0:T>=this.superTeamEndPercent&&o.superTeamActiveLogged&&($=!0),M?(w=this.superTeamBonusAmount,o.superTeamActiveLogged||(o.superTeamActiveLogged=!0,this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:o.rider.id,riderName:o.riderName,type:"superteam",tone:"neutral",title:`${this.formatRiderWithPreStageGc(o.rider.id,o.riderName)} leistet Führungsarbeit!`,detail:v?`Der eingeholte Ausreißer investiert all seine Kraft für das Team und erhält vorübergehend +${this.superTeamBonusAmount} auf Berg-, Hügel- und Flachpassagen!`:`Der Edelhelfer investiert all seine Kraft für das Team und erhält vorübergehend +${this.superTeamBonusAmount} auf Berg-, Hügel- und Flachpassagen!`}))):$&&(o.superTeamMalusAmount==null&&(o.superTeamMalusAmount=ms(4,8)),w=-o.superTeamMalusAmount,o.superTeamExhaustedLogged||(o.superTeamExhaustedLogged=!0,this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:o.rider.id,riderName:o.riderName,type:"superteam",tone:"warning",title:`${this.formatRiderWithPreStageGc(o.rider.id,o.riderName)} ist erschöpft!`,detail:`Die Führungsarbeit hat ihren Tribut gefordert. Der Fahrer erhält für den Rest der Etappe einen Malus von -${o.superTeamMalusAmount} auf Berg-, Hügel- und Flachpassagen.`}))),o.originalSkills||(o.originalSkills={flat:o.rider.skills.flat,mountain:o.rider.skills.mountain,mediumMountain:o.rider.skills.mediumMountain,hill:o.rider.skills.hill}),o.rider.skills.flat=o.originalSkills.flat+w,o.rider.skills.mountain=o.originalSkills.mountain+w,o.rider.skills.mediumMountain=o.originalSkills.mediumMountain+w,o.rider.skills.hill=o.originalSkills.hill+w}}if(this.isTimeTrialMode&&s<=o.startOffsetSeconds)continue;const p=this.isTimeTrialMode?Math.max(a,o.startOffsetSeconds):a,m=Math.max(0,s-p);if(m<=0)continue;const u=o.distanceCoveredMeters,f=o.nextDistanceCoveredMeters??o.distanceCoveredMeters+o.currentSpeedMps*m,g=o.pendingIncident;if(g&&u<g.triggerDistanceMeters&&f>=g.triggerDistanceMeters){const v=Math.max(.1,o.currentSpeedMps),T=Math.max(0,(g.triggerDistanceMeters-u)/v);o.distanceCoveredMeters=g.triggerDistanceMeters,this.recordIntermediateSplits(o,u,o.distanceCoveredMeters,p,o.currentSpeedMps),this.recordBreakawayFallbackCheckpointCrossings(o,u,o.distanceCoveredMeters,p,o.currentSpeedMps),this.applyIncident(o,g,p+T),o.nextDistanceCoveredMeters=null,this.advanceIndexForDistance(o),this.syncRiderTelemetry(o,n);continue}const b=this.stageDistanceMeters-o.distanceCoveredMeters;if(Math.max(0,f-o.distanceCoveredMeters)>=b){const v=b/o.currentSpeedMps;o.distanceCoveredMeters=this.stageDistanceMeters,this.recordIntermediateSplits(o,u,o.distanceCoveredMeters,p,o.currentSpeedMps),this.recordBreakawayFallbackCheckpointCrossings(o,u,o.distanceCoveredMeters,p,o.currentSpeedMps),o.finishTimeSeconds=p+v,o.currentSpeedMps=0;const T=Wt(o,this.resolveFinishMarkerType(),this.isClimberMalusStage());o.photoFinishScore+=T,o.leadoutBonus=0,o.leadoutRiderId=null,o.leadoutContributions=[]}else o.distanceCoveredMeters=f,this.recordIntermediateSplits(o,u,o.distanceCoveredMeters,p,o.currentSpeedMps),this.recordBreakawayFallbackCheckpointCrossings(o,u,o.distanceCoveredMeters,p,o.currentSpeedMps);for(this.triggerStageAttacksForRider(o,u,o.distanceCoveredMeters,p),o.nextDistanceCoveredMeters=null,o.incidentRecoverySecondsRemaining>0&&(o.incidentRecoverySecondsRemaining=Math.max(0,o.incidentRecoverySecondsRemaining-m),o.incidentRecoverySecondsRemaining<=0&&(o.incidentRecoveryFormBonus=0));!Q(o)&&o.distanceCoveredMeters>=o.nextFormUpdateMeter;)o.microForm=Xr(),o.nextFormUpdateMeter+=de(5e3,4e4);this.advanceIndexForDistance(o),this.syncRiderTelemetry(o,n)}const i=this.updateBreakawayPhaseState(),l=this.updateBreakawayMalusRecovery();if((i||l)&&this.syncBreakawayPlanRidersTelemetry(n),this.updateBreakawayGapStatus(),this.breakawayPlan&&this.breakawayPhaseActive&&!this.breakawayCaughtLogged){const o=new Set(this.breakawayPlan.riderIds),p=this.riders.filter(u=>o.has(u.rider.id)&&!Q(u)),m=this.riders.filter(u=>!o.has(u.rider.id)&&!Q(u));if(p.length>0&&m.length>0){const u=p.reduce((g,b)=>b.distanceCoveredMeters>g.distanceCoveredMeters?b:g,p[0]);m.reduce((g,b)=>b.distanceCoveredMeters>g.distanceCoveredMeters?b:g,m[0]).distanceCoveredMeters>=u.distanceCoveredMeters&&(u.distanceCoveredMeters>=.4*this.stageDistanceMeters&&this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:u.rider.id,riderName:u.riderName,type:"attack",tone:"warning",title:`Ausreißer eingeholt: ${u.riderName}`,detail:"Der letzte Fahrer des Ausreißversuchs wurde eingeholt."}),this.breakawayCaughtLogged=!0)}}const c=pd(this.activeStageAttacksByRiderId,t);this.activeStageAttacksByRiderId.clear();for(const o of c.newActiveAttacks)this.activeStageAttacksByRiderId.set(o.riderId,o);for(const o of this.riders)o.isAttacking=!Q(o)&&this.activeStageAttacksByRiderId.has(o.rider.id);this.elapsedSeconds+=t,this.isFinished()&&!this.hasAppliedSprintLeadoutBonuses&&(this.applySprintLeadoutBonuses(),this.hasAppliedSprintLeadoutBonuses=!0),this.logFinishSprintTieBreakIfNeeded()}applyTeamTimeTrialTempo(t,a){const s=new Map;for(const r of this.riders){if(Q(r)||r.rider.activeTeamId==null||a<=r.startOffsetSeconds)continue;const n=s.get(r.rider.activeTeamId)??[];n.push(r),s.set(r.rider.activeTeamId,n)}for(const r of s.values()){const n=r[0],i=n?this.currentSegment(n):null;if(!n||!i)continue;const l=Math.min(5,r.length),c=[...r].sort((u,f)=>f.effectiveSkill-u.effectiveSkill||u.rider.id-f.rider.id).slice(0,l).reduce((u,f)=>u+f.effectiveSkill,0)/Math.max(l,1),o=Math.max(0,8-r.length),p=Math.max(1,c-o),m=this.resolveTimeTrialSpeedMps(p,n.distanceCoveredMeters,i,n.gradientModifier,n.windModifier)*Cl(i.terrain,this.bootstrap.skillWeightRules??[]);for(const u of r){const f=Math.max(t,u.startOffsetSeconds),g=Math.max(0,a-f);u.currentSpeedMps=m,u.tempSpeedMps=m,u.nextDistanceCoveredMeters=u.distanceCoveredMeters+m*g}}}advanceIndexForDistance(t){for(;t.segmentIndex<this.bootstrap.stageSummary.segments.length-1;){const a=this.bootstrap.stageSummary.segments[t.segmentIndex];if(t.distanceCoveredMeters<a.end_km*1e3)break;t.segmentIndex+=1}for(;t.windZoneIndex<this.windZones.length-1;){const a=this.windZones[t.windZoneIndex];if(t.distanceCoveredMeters<a.endMeter)break;t.windZoneIndex+=1}}currentSegment(t){return this.bootstrap.stageSummary.segments[t.segmentIndex]??null}currentWindZone(t){return this.windZones[t.windZoneIndex]??null}resolveStartOrder(t){if(this.isTeamTimeTrial){const r=new Map((this.bootstrap.teamStartOrder??[]).map((n,i)=>[n,i]));return[...t].sort((n,i)=>{const l=n.rider.activeTeamId!=null?r.get(n.rider.activeTeamId)??Number.MAX_SAFE_INTEGER:Number.MAX_SAFE_INTEGER,c=i.rider.activeTeamId!=null?r.get(i.rider.activeTeamId)??Number.MAX_SAFE_INTEGER:Number.MAX_SAFE_INTEGER;return l!==c?l-c:this.resolveProjectedIttStartScore(i)-this.resolveProjectedIttStartScore(n)||n.rider.id-i.rider.id})}if(!this.isIndividualTimeTrial)return[...t];const a=new Map((this.bootstrap.gcStandings??[]).map(r=>[r.riderId,r.rank]));return this.bootstrap.race.isStageRace&&this.bootstrap.stage.stageNumber>1&&a.size>0?[...t].sort((r,n)=>{const i=a.get(r.rider.id),l=a.get(n.rider.id);return i!=null&&l!=null?l-i:i!=null?-1:l!=null?1:this.resolveProjectedIttStartScore(r)-this.resolveProjectedIttStartScore(n)||r.rider.id-n.rider.id}):[...t].sort((r,n)=>r.rider.skills.timeTrial-n.rider.skills.timeTrial||r.rider.id-n.rider.id)}resolveProjectedIttStartScore(t){let a=0,s=0;for(const r of this.bootstrap.stageSummary.segments){const n=(r.start_km+r.end_km)/2*1e3,i=this.resolveStaminaPenalty(t.rider.skills.stamina,n)+t.incidentStaminaPenalty,l=this.resolveWeightedSkill(t.rider,r.terrain),c=i>0?this.resolveWeightedSkill(t.rider,r.terrain,i):l,o=Math.max(0,l.value-c.value),{effectiveSkill:p}=this.resolveEffectiveSkill({rider:t,baseSkill:c.value,staminaPenalty:o,teamGroupBonus:0,distanceMeters:n}),m=ue(r.gradient_percent,-20,20),u=m>0?Math.exp(-.11*m):1-m*.06,f=this.windZones.find(b=>n>=b.startMeter&&n<=b.endMeter)??this.windZones[this.windZones.length-1],g=f?1+f.vector*(f.windSpeedKph/100)*.52:1;a+=p*u*g*r.length_km,s+=r.length_km}return s>0?a/s:0}resolveStartOffsetSeconds(t,a,s){if(this.isIndividualTimeTrial)return a*Sd;if(this.isTeamTimeTrial){const r=t.rider.activeTeamId;return(r!=null?s.get(r)??0:0)*kd}return 0}buildIntermediateMarkers(){return Je(this.bootstrap.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||ut(t)).map(({key:t,label:a,marker:s,kmMark:r})=>({key:t,distanceMeters:r*1e3,label:a,markerType:s.type,markerCategory:s.cat})).sort((t,a)=>t.distanceMeters-a.distanceMeters)}buildBreakawayGapPenaltyConfig(){const t=this.breakawayPlan;if(!t||this.isTimeTrialMode)return{markers:[],fallbackCheckpointsMeters:[]};const a=this.intermediateMarkers.filter(c=>c.distanceMeters<t.groupPhaseEndDistanceMeters),s=this.stageDistanceMeters*Hd,r=a.some(c=>c.distanceMeters<=s);if(!(a.length<=1||!r))return{markers:a,fallbackCheckpointsMeters:[]};const i=[],l=Math.max(ba,Math.ceil(s/ba)*ba);for(let c=l;c<t.groupPhaseEndDistanceMeters;c+=ba)i.push(c);return{markers:a,fallbackCheckpointsMeters:i}}calculateBasePhysics(t,a,s){const r=Yd(a.terrain),n=this.resolveRiderStaminaPenalty(t)+t.incidentStaminaPenalty,i=this.resolveWeightedSkill(t.rider,a.terrain),l=n>0?this.resolveWeightedSkill(t.rider,a.terrain,n):i,c=Math.max(0,i.value-l.value),o=this.resolveAttackSkillBonus(t),p=Math.min(85,l.value)+o,m=this.isTimeTrialMode?0:t.teamGroupBonus,u=this.resolveSegmentElevation(a,t.distanceCoveredMeters),{effectiveSkill:f,staminaPenalty:g,elevationPenalty:b}=this.resolveEffectiveSkill({rider:t,baseSkill:p,staminaPenalty:c,teamGroupBonus:m,distanceMeters:t.distanceCoveredMeters,currentElevationMeters:u}),y=ue(a.gradient_percent,-20,20),v=y>0?Math.exp(-.11*y):1-y*.06,T=1+s.vector*(s.windSpeedKph/100)*.52,w=this.isTimeTrialMode?.5:this.resolveRoadSpeedSkillFactor(a.terrain);return{skillName:r,skillBreakdown:l.breakdown,baseSkill:p,teamGroupBonus:m,effectiveSkill:f,staminaPenalty:g,elevationPenalty:b,gradientPercent:y,gradientModifier:v,windModifier:T,attackSkillBonus:o,tempSpeedMps:this.isTimeTrialMode?this.resolveTimeTrialSpeedMps(f,t.distanceCoveredMeters,a,v,T):this.resolveRoadStageSpeedMps(f,t.distanceCoveredMeters,a,v,T,w)}}resolveRoadStageSpeedMps(t,a,s,r,n,i){const l=this.resolveSkillSpreadFactor(a,s),c=this.resolveSegmentElevation(s,a),o=this.resolveElevationSkillSpreadFactor(s,c),u=(40+(t-50)*i*l*o)/3.6;return Math.max(.5,u*r*n)}resolveElevationSkillSpreadFactor(t,a){if(t.terrain!=="Mountain"&&t.terrain!=="Medium_Mountain")return 1;const s=Math.max(0,a-Ed),r=Math.floor(s/Fd);return t.terrain==="Mountain"?1+(r*Nd+r*Math.max(0,r-1)*Pd/2):1+r*Cd}resolveRoadSpeedSkillFactor(t){return t==="Flat"?.12+(this.bootstrap.stage.rolledWindkantenGefahr??0):t==="Abfahrt"||t==="Downhill"?.15:t==="Cobble"?20/35:t==="Cobble_Hill"?25/35:10/35}resolveBreakawayReferenceSkill(t,a){const s=a.filter(n=>n.activeTerrain===t.activeTerrain);return(s.length>0?s:a).reduce((n,i)=>Math.max(n,i.effectiveSkill),t.effectiveSkill)}resolveBreakawaySkillBonus(t){var a;return this.isBreakawayBonusWindow(t)?((a=this.breakawayPlan)==null?void 0:a.skillBonus)??0:0}resolveMaxBreakawayDraftModifier(t,a,s){if(s<=1)return{draftModifier:1,draftPackFactor:0};const r=t.tempSpeedMps/14,n=this.currentWindZone(t),i=(n==null?void 0:n.vector)??0,l=(n==null?void 0:n.windSpeedKph)??0,c=-i*(l/70),p=Math.max(.3,.35+.35*c)*Math.min(1,r)*Vr,m=ue(a.gradient_percent,-20,20),u=qr(m),f=Qr(s);return{draftModifier:1+p*f*u,draftPackFactor:f}}resolveBreakawayTimeGapPenalty(t){if(t<Zr)return 0;const a=Math.floor((t-Zr)/_d);return Gd+a}recordBreakawayFallbackCheckpointCrossings(t,a,s,r,n){if(!(this.breakawayGapPenaltyFallbackCheckpointsMeters.length===0||n<=0))for(;t.nextBreakawayFallbackCheckpointIndex<this.breakawayGapPenaltyFallbackCheckpointsMeters.length;){const i=t.nextBreakawayFallbackCheckpointIndex,l=this.breakawayGapPenaltyFallbackCheckpointsMeters[i];if(l==null||l>s)break;if(l<a){t.nextBreakawayFallbackCheckpointIndex+=1;continue}const c=(l-a)/n,o=Math.max(0,this.isTimeTrialMode?r+c-t.startOffsetSeconds:r+c);t.breakawayFallbackCheckpointTimes[i]=o,t.nextBreakawayFallbackCheckpointIndex+=1}}updateBreakawayGapPenaltyFromCheckpoints(t,a){var i,l;if(!this.breakawayPlan||t.length===0||a.length===0)return this.breakawayGapStatus=null,((i=t[0])==null?void 0:i.breakawayGapPenalty)??0;let r=((l=t[0])==null?void 0:l.breakawayGapPenalty)??0;const n=[...a].sort((c,o)=>o.distanceCoveredMeters-c.distanceCoveredMeters||o.currentSpeedMps-c.currentSpeedMps||c.rider.id-o.rider.id)[0]??null;if(!n)return this.breakawayGapStatus=null,r;for(;this.nextBreakawayGapPenaltyMarkerIndex<this.breakawayGapPenaltyMarkers.length;){const c=this.breakawayGapPenaltyMarkers[this.nextBreakawayGapPenaltyMarkerIndex];if(!c)break;const o=n.markerCrossings[c.key]??null;if(!o)break;const p=t.map(m=>m.markerCrossings[c.key]??null).filter(m=>m!=null).sort((m,u)=>m.crossingTimeSeconds-u.crossingTimeSeconds||m.riderId-u.riderId)[0]??null;if(p){const m=o.crossingTimeSeconds-p.crossingTimeSeconds;r=this.resolveBreakawayTimeGapPenalty(m),this.breakawayGapStatus={gapSeconds:m,penalty:r,kmMark:c.distanceMeters/1e3}}this.nextBreakawayGapPenaltyMarkerIndex+=1}for(;this.nextBreakawayGapPenaltyFallbackIndex<this.breakawayGapPenaltyFallbackCheckpointsMeters.length;){const c=this.nextBreakawayGapPenaltyFallbackIndex,o=n.breakawayFallbackCheckpointTimes[c]??null;if(o==null)break;const p=t.map(m=>m.breakawayFallbackCheckpointTimes[c]??null).filter(m=>m!=null).sort((m,u)=>m-u)[0]??null;if(p!=null){const m=o-p;r=this.resolveBreakawayTimeGapPenalty(m),this.breakawayGapStatus={gapSeconds:m,penalty:r,kmMark:c<this.breakawayGapPenaltyFallbackCheckpointsMeters.length?this.breakawayGapPenaltyFallbackCheckpointsMeters[c]/1e3:null}}this.nextBreakawayGapPenaltyFallbackIndex+=1}return r}updateBreakawayGapStatus(){const t=this.breakawayPlan;if(!t||this.isTimeTrialMode||!this.isBreakawayGroupPhaseActive()){this.breakawayGapStatus=null;return}const a=new Set(t.riderIds),s=this.riders.filter(l=>!Q(l)&&a.has(l.rider.id)&&l.activeTerrain!=="Finish"),r=this.riders.filter(l=>!Q(l)&&!a.has(l.rider.id)&&l.activeTerrain!=="Finish");if(s.length===0||r.length===0){this.breakawayGapStatus=null;return}const n=[...s].sort((l,c)=>c.distanceCoveredMeters-l.distanceCoveredMeters||c.currentSpeedMps-l.currentSpeedMps||l.rider.id-c.rider.id)[0]??null,i=[...r].sort((l,c)=>c.distanceCoveredMeters-l.distanceCoveredMeters||c.currentSpeedMps-l.currentSpeedMps||l.rider.id-c.rider.id)[0]??null;if(!n||!i||n.distanceCoveredMeters<=i.distanceCoveredMeters){this.breakawayGapStatus=null;return}for(let l=this.intermediateMarkers.length-1;l>=0;l-=1){const c=this.intermediateMarkers[l];if(!c)continue;const o=n.markerCrossings[c.key]??null,p=i.markerCrossings[c.key]??null;if(!o||!p)continue;const m=p.crossingTimeSeconds-o.crossingTimeSeconds;this.breakawayGapStatus={gapSeconds:m,penalty:this.resolveBreakawayTimeGapPenalty(m),kmMark:c.distanceMeters/1e3};return}for(let l=this.breakawayGapPenaltyFallbackCheckpointsMeters.length-1;l>=0;l-=1){const c=this.breakawayGapPenaltyFallbackCheckpointsMeters[l];if(c==null)continue;const o=n.breakawayFallbackCheckpointTimes[l]??null,p=i.breakawayFallbackCheckpointTimes[l]??null;if(o==null||p==null)continue;const m=p-o;this.breakawayGapStatus={gapSeconds:m,penalty:this.resolveBreakawayTimeGapPenalty(m),kmMark:c/1e3};return}this.breakawayGapStatus=null}applyBreakawaySkillTempo(t){const a=this.breakawayPlan;if(!a||!this.isBreakawayGroupPhaseActive()||this.isTimeTrialMode)return;const s=new Set(a.riderIds),r=this.riders.filter(l=>!Q(l)&&s.has(l.rider.id));if(r.length===0)return;const n=this.riders.filter(l=>!Q(l)&&!s.has(l.rider.id)&&l.activeTerrain!=="Finish"),i=this.updateBreakawayGapPenaltyFromCheckpoints(r,n);for(const l of r)l.breakawayGapPenalty=i;for(const l of r){const c=this.currentSegment(l);if(!c)continue;const p=this.resolveBreakawayReferenceSkill(l,n)+Math.max(0,a.skillBonus-l.breakawayGapPenalty);l.effectiveSkill=p,l.tempSpeedMps=this.resolveRoadStageSpeedMps(p,l.distanceCoveredMeters,c,l.gradientModifier,l.windModifier,this.resolveRoadSpeedSkillFactor(c.terrain));const m=this.resolveMaxBreakawayDraftModifier(l,c,r.length);l.draftModifier=m.draftModifier,l.draftNearbyRiderCount=Math.max(0,r.length-1),l.draftPackFactor=m.draftPackFactor,l.currentSpeedMps=l.tempSpeedMps*m.draftModifier,l.nextDistanceCoveredMeters=l.distanceCoveredMeters+l.currentSpeedMps*t}}resolveTimeTrialSpeedMps(t,a,s,r,n){return this.resolveRoadStageSpeedMps(t,a,s,r,n,.5)}syncRiderTelemetry(t,a=null){var i;const s=this.currentSegment(t),r=this.currentWindZone(t);if(Q(t)||!s||!r){t.segmentStartKm=this.bootstrap.stageSummary.distanceKm,t.segmentEndKm=this.bootstrap.stageSummary.distanceKm,t.segmentStartElevation=0,t.segmentEndElevation=0,t.activeTerrain="Finish",t.skillName="Finish",t.skillBreakdown="",t.baseSkill=0,t.teamGroupBonus=0,t.effectiveSkill=0,t.staminaPenalty=0,t.staminaSkillPenalty=0,t.elevationPenalty=0,t.gradientPercent=0,t.gradientModifier=1,t.windModifier=1,t.draftModifier=1,t.draftNearbyRiderCount=0,t.draftPackFactor=0,t.currentSpeedMps=0,t.isAttacking=!1;return}t.teamGroupBonus=this.resolveTeamGroupBonusValue(t,a);const n=this.calculateBasePhysics(t,s,r);t.segmentStartKm=s.start_km,t.segmentEndKm=s.end_km,t.segmentStartElevation=s.start_elevation,t.segmentEndElevation=s.end_elevation,t.activeTerrain=s.terrain,t.skillName=n.skillName,t.skillBreakdown=n.attackSkillBonus>0?`${n.skillBreakdown} · Attack +${n.attackSkillBonus}`:n.skillBreakdown,t.baseSkill=n.baseSkill,t.teamGroupBonus=n.teamGroupBonus,t.effectiveSkill=n.effectiveSkill,t.staminaPenalty=n.staminaPenalty,t.elevationPenalty=n.elevationPenalty,t.gradientPercent=n.gradientPercent,t.gradientModifier=n.gradientModifier,t.windModifier=n.windModifier,t.currentSpeedMps=n.tempSpeedMps*t.draftModifier,t.photoFinishScore=this.calculatePhotoFinishScore(t),t.isAttacking=this.activeStageAttacksByRiderId.has(t.rider.id),t.isBreakaway=((i=this.breakawayPlan)==null?void 0:i.riderIds.includes(t.rider.id))??!1}updateBreakawayMalusRecovery(){const t=this.breakawayPlan;if(!t||!this.breakawayPhaseEnded||this.isTimeTrialMode)return!1;const a=new Set(t.riderIds),s=this.riders.reduce((n,i)=>Q(i)||a.has(i.rider.id)?n:Math.max(n,i.distanceCoveredMeters),0);if(s<=t.phaseEndDistanceMeters)return!1;let r=!1;for(const n of this.riders){if(!a.has(n.rider.id)||n.breakawayMalus<=0||n.rider.hasSupermalus===!0||n.distanceCoveredMeters<t.phaseEndDistanceMeters)continue;if(n.breakawayRecoveryStartDistanceMeters==null){if(s<=n.distanceCoveredMeters)continue;if(n.breakawayRecoveryStartDistanceMeters=n.distanceCoveredMeters,n.rider.hasSuperform===!0||Math.random()<jd){n.breakawayMalus=0,r=!0;continue}}const i=n.breakawayRecoveryStartDistanceMeters;if(i==null||n.breakawayInitialMalus<=0)continue;const l=Math.max(0,n.distanceCoveredMeters-i),c=Math.floor(l/zd),o=Math.min(Wd,n.breakawayInitialMalus),p=Math.max(o,n.breakawayInitialMalus-c*Kd),m=Ct(p);m!==n.breakawayMalus&&(n.breakawayMalus=m,r=!0)}return r}syncBreakawayPlanRidersTelemetry(t){const a=this.breakawayPlan;if(!a)return;const s=new Set(a.riderIds);for(const r of this.riders)Q(r)||!s.has(r.rider.id)||this.syncRiderTelemetry(r,t)}updateBreakawayPhaseState(){const t=this.breakawayPlan;if(!t||this.breakawayPhaseEnded)return!1;const a=this.riders.filter(r=>t.riderIds.includes(r.rider.id));if(a.length===0)return!1;if(!this.breakawayPhaseActive&&a.some(r=>r.distanceCoveredMeters>=t.triggerDistanceMeters)){this.breakawayPhaseActive=!0;for(const r of a)this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:r.rider.id,riderName:r.riderName,type:"attack",tone:"warning",title:`Ausreißversuch: ${this.formatRiderWithPreStageGc(r.rider.id,r.riderName)}`,detail:`Fahrer ist Teil der Ausreißergruppe. Die gemeinsame Bewegung endet ab ${(t.groupPhaseEndDistanceMeters/1e3).toFixed(1).replace(".",",")} km.`})}let s=!1;if(!this.breakawayGroupPhaseEnded&&this.breakawayPhaseActive&&a.some(r=>r.distanceCoveredMeters>=t.groupPhaseEndDistanceMeters)){this.breakawayGroupPhaseEnded=!0,this.breakawayGapStatus=null;for(const r of a)r.breakawayGapPenalty=0;this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:null,riderName:null,type:"attack",tone:"warning",title:"Ausreißerverbund endet",detail:`Ab jetzt gilt wieder normales Drafting. Der Ausreißermalus greift erst ab ${(t.phaseEndDistanceMeters/1e3).toFixed(1).replace(".",",")} km.`}),s=!0}if(this.breakawayPhaseActive&&a.some(r=>r.distanceCoveredMeters>=t.phaseEndDistanceMeters)){this.breakawayPhaseEnded=!0,this.breakawayGapStatus=null;for(const r of a)r.breakawayMalus=t.malusValue,r.breakawayInitialMalus=t.malusValue,r.breakawayRecoveryStartDistanceMeters=null,r.breakawayGapPenalty=0;return this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:null,riderName:null,type:"incident",tone:"danger",title:"Ausreißerphase endet",detail:`Die Fahrer erhalten -${t.malusValue} Form für den Rest der Etappe.`}),!0}return s}applyBreakawayGroupTempo(t){const a=this.breakawayPlan;if(!a||!this.isBreakawayGroupPhaseActive()||this.isTimeTrialMode)return;const s=this.riders.filter(l=>!Q(l)&&a.riderIds.includes(l.rider.id));if(s.length===0)return;const r=[...s].sort((l,c)=>c.distanceCoveredMeters-l.distanceCoveredMeters||c.currentSpeedMps-l.currentSpeedMps||l.rider.id-c.rider.id)[0];if(!r)return;const n=Math.max(.1,r.currentSpeedMps),i=r.distanceCoveredMeters+n*t;for(const l of s){if(Math.max(0,r.distanceCoveredMeters-l.distanceCoveredMeters)>0){const o=n+.1;l.currentSpeedMps=o,l.nextDistanceCoveredMeters=Math.min(i,l.distanceCoveredMeters+o*t);continue}l.currentSpeedMps=n,l.nextDistanceCoveredMeters=l.distanceCoveredMeters+n*t}}resolveAttackSkillBonus(t){return this.activeStageAttacksByRiderId.has(t.rider.id)?nd:0}isActiveBreakawayRider(t){var a;return(((a=this.breakawayPlan)==null?void 0:a.riderIds.includes(t.rider.id))??!1)&&this.isBreakawayGroupPhaseActive()}isBreakawayGroupPhaseActive(){return this.breakawayPhaseActive&&!this.breakawayGroupPhaseEnded&&!this.breakawayPhaseEnded}isBreakawayBonusWindow(t){var a;return(((a=this.breakawayPlan)==null?void 0:a.riderIds.includes(t.rider.id))??!1)&&this.breakawayPhaseActive&&this.breakawayGroupPhaseEnded&&!this.breakawayPhaseEnded}resolveAttackStagePositionExcludingBreakaways(t){return this.getOrderedRiders().filter(a=>!this.isActiveBreakawayRider(a)).findIndex(a=>a.rider.id===t)+1}isDraftBlockedByAttack(t){const a=this.activeStageAttacksByRiderId.get(t.rider.id)??null;return a!=null&&!a.isCounterAttack}canReceiveDraftFromCandidate(t,a){const s=this.activeStageAttacksByRiderId.get(a.rider.id)??null;if(s==null||s.isCounterAttack)return!0;const r=this.activeStageAttacksByRiderId.get(t.rider.id)??null;return(r==null?void 0:r.isCounterAttack)===!0&&r.triggeredByRiderId===a.rider.id}resolvePreStageGcRank(t){var a;return((a=this.bootstrap.gcStandings.find(s=>s.riderId===t))==null?void 0:a.rank)??null}formatRiderWithPreStageGc(t,a){const s=this.resolvePreStageGcRank(t);return s!=null?`${a} (${s}.)`:a}triggerStageAttacksForRider(t,a,s,r){if(Q(t)||this.activeStageAttacksByRiderId.has(t.rider.id))return;const n=this.precalculatedStageAttacksByRiderId.get(t.rider.id);if(!n||n.length===0)return;const i=n[0];if(!i||a>=i.triggerDistanceMeters||s<i.triggerDistanceMeters)return;const l=this.resolveAttackStagePositionExcludingBreakaways(t.rider.id);if(l<=0||l>10){console.log(`[RaceAttack] verworfen: ${t.riderName} Attacke ${i.attackNumber} bei ${(i.triggerDistanceMeters/1e3).toFixed(1).replace(".",",")} km, Position ohne Ausreißer ${l}, aktuelle km ${(s/1e3).toFixed(1).replace(".",",")}`),n.shift();return}n.shift();const c=Math.max(.1,t.currentSpeedMps),o=Math.max(0,(i.triggerDistanceMeters-a)/c),p=r+o;this.activeStageAttacksByRiderId.set(t.rider.id,{riderId:t.rider.id,remainingSeconds:i.durationSeconds,startedAtElapsedSeconds:p,triggerDistanceMeters:i.triggerDistanceMeters,durationSeconds:i.durationSeconds,attackNumber:i.attackNumber,isCounterAttack:!1,triggeredByRiderId:null}),t.isAttacking=!0;const m=new Set(this.activeStageAttacksByRiderId.keys()),u=this.stageFavorites.slice(0,20).filter(b=>{if(b.kind!=="rider"||b.riderId==null)return!1;const y=this.riders.find(T=>T.rider.id===b.riderId);if(!y||Q(y))return!1;const v=t.distanceCoveredMeters-y.distanceCoveredMeters;return v>=0&&v<=150}),f=md(u,t.rider.id,m),g=[];for(const b of f){const y=this.riders.find(v=>v.rider.id===b);!y||Q(y)||this.activeStageAttacksByRiderId.has(b)||(this.activeStageAttacksByRiderId.set(b,{riderId:b,remainingSeconds:jr,startedAtElapsedSeconds:p,triggerDistanceMeters:y.distanceCoveredMeters,durationSeconds:jr,attackNumber:1,isCounterAttack:!0,triggeredByRiderId:t.rider.id}),y.isAttacking=!0,g.push({riderId:b,riderName:this.formatRiderWithPreStageGc(b,y.riderName),riderTeamId:y.rider.activeTeamId??null}))}this.pushMessage({elapsedSeconds:p,riderId:t.rider.id,riderName:t.riderName,type:"attack",tone:"warning",title:`${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} attackiert`,detail:`Attacke ${i.attackNumber} bei ${(i.triggerDistanceMeters/1e3).toFixed(1).replace(".",",")} km.`});for(const b of g)this.pushMessage({elapsedSeconds:p,riderId:b.riderId,riderName:b.riderName,type:"counter_attack",tone:"warning",title:`${b.riderName} kontert (Reaktion auf ${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)})`,detail:`Konterattacke bei ${(i.triggerDistanceMeters/1e3).toFixed(1).replace(".",",")} km.`})}buildClusters(t){const a=[];for(const s of t){if(s.finishStatus==="dnf")continue;const r=a[a.length-1];if(!r||Math.abs(r.distanceMeter-s.distanceCoveredMeters)>=fa){a.push({riderIds:[s.rider.id],riderCount:1,distanceMeter:s.distanceCoveredMeters,distanceSum:s.distanceCoveredMeters});continue}r.riderIds.push(s.rider.id),r.riderCount+=1,r.distanceSum+=s.distanceCoveredMeters,r.distanceMeter=r.distanceSum/r.riderCount}return a.map(({distanceSum:s,...r})=>r)}buildTeamGroupBonusByRiderId(){const t=new Map,a=this.riders.filter(i=>!Q(i)&&i.rider.activeTeamId!=null).sort((i,l)=>i.distanceCoveredMeters-l.distanceCoveredMeters||i.rider.id-l.rider.id),s=new Map;let r=0,n=0;for(let i=0;i<a.length;i+=1){const l=a[i],c=l.distanceCoveredMeters;for(;n<a.length&&a[n].distanceCoveredMeters-c<fa;){const m=a[n].rider.activeTeamId;m!=null&&s.set(m,(s.get(m)??0)+1),n+=1}for(;r<a.length&&c-a[r].distanceCoveredMeters>=fa;){const m=a[r].rider.activeTeamId;if(m!=null){const u=(s.get(m)??0)-1;u<=0?s.delete(m):s.set(m,u)}r+=1}const o=l.rider.activeTeamId,p=o==null?0:Math.max(0,(s.get(o)??0)-1);t.set(l.rider.id,p===0?0:Ct(p*.3*this.resolveTeamBonusRoleMultiplier(l)))}return t}resolveTeamBonusRoleMultiplier(t){var a;switch((a=t.rider.role)==null?void 0:a.name){case"Kapitaen":case"Co-Kapitaen":case"Sprinter":return 1;case"Wassertraeger":return .1;default:return .5}}resolveTeamGroupBonusValue(t,a){return this.isTimeTrialMode||t.rider.activeTeamId==null?0:(a==null?void 0:a.get(t.rider.id))??0}resolveEffectiveSkill(t){const a=t.rider.incidentRecoverySecondsRemaining>0?Rd:0,s=this.resolveBreakawaySkillBonus(t.rider),r=t.baseSkill+za(t.rider.rider)+t.rider.dailyForm+t.rider.incidentRecoveryFormBonus+a+t.rider.microForm+s+t.teamGroupBonus-t.rider.breakawayMalus,n=Math.max(0,r),i=t.distanceMeters===t.rider.distanceCoveredMeters?this.resolveRiderElevationPenalty(t.rider,t.currentElevationMeters):this.resolveElevationPenalty(t.rider,t.distanceMeters);return{effectiveSkill:Math.max(0,n-i),staminaPenalty:t.staminaPenalty,elevationPenalty:i}}resolveStaminaPenalty(t,a){const s=ue(this.stageDistanceMeters/1e3,Ad,Bd),r=this.interpolateStaminaDistanceValue(s),n=ue(t,Yr,gs),i=(gs-n)/(gs-Yr),l=r/3+i*r,c=this.stageDistanceMeters<=0?0:ue(a/this.stageDistanceMeters,0,1);return l*c**2}resolveRiderStaminaPenalty(t){const a=Math.max(0,Math.floor(t.distanceCoveredMeters/1e3));return a===t.staminaPenaltyKmBucket||(t.staminaPenaltyKmBucket=a,t.staminaSkillPenalty=this.resolveStaminaPenalty(t.rider.skills.stamina,t.distanceCoveredMeters)),t.staminaSkillPenalty}interpolateStaminaDistanceValue(t){if(t<=pt[0].kmMark)return pt[0].value;for(let a=0;a<pt.length-1;a+=1){const s=pt[a],r=pt[a+1];if(t<=r.kmMark){const n=Math.max(1e-4,r.kmMark-s.kmMark),i=(t-s.kmMark)/n;return s.value+(r.value-s.value)*i}}return pt[pt.length-1].value}buildSpreadCurve(t){const a=Math.ceil(1/ps),s=Math.max(1,Math.ceil(t/ps)),r=de($d,Td),n=Array.from({length:s},()=>de(.2,1.2)),i=n.reduce((o,p)=>o+p,0),l=Array.from({length:a+1},()=>1);l[0]=r;let c=0;for(let o=1;o<=s;o+=1)c+=n[o-1]??0,l[o]=r+(1-r)*(c/i);return l}resolveSkillSpreadFactor(t,a){const s=this.stageDistanceMeters<=0?1:ue(t/this.stageDistanceMeters,0,1),r=Math.min(this.spreadCurve.length-1,Math.floor(s/ps)),n=this.spreadCurve[r]??1;if(s<=this.lateStageStartRatio)return n;const i=Nl(this.simulationMode,a.terrain,this.skillWeightConfigMap),l=this.scaleFinalSpreadMultiplier(i.lateMultiplier),c=Math.max(l,this.scaleFinalSpreadMultiplier(i.peakMultiplier)),o=ue((s-this.lateStageStartRatio)/Math.max(1e-4,this.finalPushStartRatio-this.lateStageStartRatio),0,1),p=this.interpolateFinalSpread(l,o);if(l<=1&&c<=1)return n;if(s<this.finalPushStartRatio||c<=l)return Math.max(n,p);const m=ue((s-this.finalPushStartRatio)/Math.max(1e-4,1-this.finalPushStartRatio),0,1),u=l+(c-l)*m;return Math.max(n,u)}scaleFinalSpreadMultiplier(t){return 1+(Math.max(0,t)-1)*this.finalSpreadDifficultyMultiplier}interpolateFinalSpread(t,a){return 1+(t-1)*a}resolveWeightedSkillComponents(t){const a=this.weightedSkillComponentsByTerrain.get(t);if(a)return a;const s=pi(this.simulationMode,t,this.skillWeightRuleMap).map(r=>({key:r.key,weight:r.weight}));return this.weightedSkillComponentsByTerrain.set(t,s),s}resolveWeightedSkill(t,a,s=0){const r=this.resolveWeightedSkillComponents(a),n=s>0||t.mentorBoosts?{...t.skills}:t.skills;if(s>0&&(n.stamina=Math.max(0,n.stamina-s)),t.mentorBoosts)for(const[o,p]of Object.entries(t.mentorBoosts))typeof p=="number"&&(n[o]+=p);let i=0,l=0;for(const o of r)i+=o.weight,l+=n[o.key]*o.weight;return{value:i>0?l/i:Fl(n,this.simulationMode,a,this.skillWeightRuleMap),breakdown:this.resolveSkillBreakdown(t,a,r)}}resolveSkillBreakdown(t,a,s){const r=`${t.id}:${a}:${t.formBonus??0}:${t.raceFormBonus??0}:${t.fatigueMalus??0}:${t.longTermFatigueMalus??0}:${t.shortTermFatigueMalus??0}`,n=this.skillBreakdownCache.get(r);if(n!==void 0)return n;const i=Zd(t,s);return this.skillBreakdownCache.set(r,i),i}resolvePrimarySkillKey(t){switch(t){case"Flat":return"flat";case"Hill":return"hill";case"Medium_Mountain":return"mediumMountain";case"Mountain":return"mountain";case"Cobble":return"cobble";case"Sprint":return"sprint";case"Downhill":return"downhill";default:return"flat"}}resolveElevationPenaltyFromElevation(t,a){const s=(4*t.rider.skills.mountain+t.rider.skills.resistance+2*t.rider.skills.stamina)/7,r=Math.max(0,100-s)/1e3,n=this.resolveElevationBucket(a);return r*(n**3/1500/1e5)}resolveElevationPenalty(t,a){return this.resolveElevationPenaltyFromElevation(t,this.interpolateElevation(a))}resolveRiderElevationPenalty(t,a){const s=a??this.interpolateElevation(t.distanceCoveredMeters),r=this.resolveElevationBucket(s);return r===t.elevationPenaltyHmBucket||(t.elevationPenaltyHmBucket=r,t.elevationPenalty=this.resolveElevationPenaltyFromElevation(t,s)),t.elevationPenalty}resolveSegmentElevation(t,a){const s=t.start_km*1e3,r=t.end_km*1e3,n=Math.max(1e-4,r-s),i=ue((a-s)/n,0,1);return t.start_elevation+(t.end_elevation-t.start_elevation)*i}resolveElevationBucket(t){return Math.max(0,Math.floor(t/10)*10)}interpolateElevation(t){const a=this.bootstrap.stageSummary.points;if(a.length===0)return 0;const r=ue(t,0,this.stageDistanceMeters)/1e3;if(r<=a[0].kmMark)return a[0].elevation;for(let n=0;n<a.length-1;n+=1){const i=a[n],l=a[n+1];if(r<=l.kmMark){const c=Math.max(1e-4,l.kmMark-i.kmMark),o=(r-i.kmMark)/c;return i.elevation+(l.elevation-i.elevation)*o}}return a[a.length-1].elevation}calculatePhotoFinishScore(t){return this.resolveRiderStaminaPenalty(t),fs(t,this.finishWeightProfile)}logFinishSprintTieBreakIfNeeded(){var m;if(this.hasLoggedFinishSprintTieBreak||this.isTimeTrialMode||!this.isFinished())return;this.hasLoggedFinishSprintTieBreak=!0;const t=this.riders.filter(he).sort((u,f)=>(u.finishTimeSeconds??0)-(f.finishTimeSeconds??0)||f.photoFinishScore-u.photoFinishScore||u.rider.id-f.rider.id);if(t.length===0)return;const a=[];let s=null;for(const u of t){const f=u.finishTimeSeconds??0;if(a.length===0){a.push(u),s=f;continue}if(s!=null&&f-s<=qt){a.push(u),s=f;continue}break}const r=this.resolveFinishMarkerType(),n=this.isClimberMalusStage(),i=u=>u.photoFinishScore,l=[...a].sort((u,f)=>i(f)-i(u)||u.rider.id-f.rider.id),c=((m=l[0])==null?void 0:m.finishTimeSeconds)??0,o=this.finishWeightProfile,p=`Etappe ${this.bootstrap.stage.stageNumber} · ${this.bootstrap.stage.profile}`;console.groupCollapsed(`[FinishSprintTieBreak] ${p} | erste Zielgruppe (${l.length} Fahrer) | Zeitfenster <= ${qt.toFixed(2)} s`),console.log("[FinishSprintTieBreak] Sortierung: erst Zielzeit, dann Score (photoFinish + SpecAdjustment) absteigend, dann Fahrer-ID."),console.log(`[FinishSprintTieBreak] Kontext: ${r}${n?" | Bergfahrer-Malus aktiv":""}`),l.forEach((u,f)=>{const g=ac(u,o).map($=>`${Mi[$.skillKey]} ${$.contribution.toFixed(2)} = ${$.effectiveSkill.toFixed(2)} x ${($.weight*100).toFixed(0)}%`).join(" | "),b=u.finishTimeSeconds??0,y=b-c,v=y<=1e-4?`${b.toFixed(2)} s`:`${b.toFixed(2)} s (+${y.toFixed(2)} s)`,T=this.calculatePhotoFinishScore(u),w=u.leadoutBonus??0,M=Wt(u,r,n);console.log(`#${f+1} Zielsprint | ${u.riderName} | Zeit ${v} | Score (ohne Boni): ${T.toFixed(2)} -> Score (mit Boni): ${u.photoFinishScore.toFixed(2)} [SpecAdj: ${M>0?"+":""}${M.toFixed(2)}, Leadout: +${w.toFixed(2)}] | ID-Tiebreak ${u.rider.id} | (${g})`)}),console.groupEnd()}recordIntermediateSplits(t,a,s,r,n){if(!(n<=0))for(;t.nextIntermediateIndex<this.intermediateMarkers.length;){const i=this.intermediateMarkers[t.nextIntermediateIndex];if(i.distanceMeters>s)break;if(i.distanceMeters<a){t.nextIntermediateIndex+=1;continue}const l=(i.distanceMeters-a)/n,c=Math.max(0,this.isTimeTrialMode?r+l-t.startOffsetSeconds:r+l);let o=this.resolveMarkerCrossingScore(t,i);const p=i.markerType==="sprint_intermediate"?"sprint_intermediate":i.markerType==="climb_top"?"climb_top":null;p&&(o+=Wt(t,p,this.isClimberMalusStage(),i.markerCategory)),t.lastSplitLabel=i.label,t.lastSplitTimeSeconds=c,t.splitTimes[i.key]=c,t.splitTimes[i.label]=c,t.markerCrossings[i.key]={riderId:t.rider.id,markerKey:i.key,markerLabel:i.label,markerType:i.markerType,markerCategory:i.markerCategory,kmMark:i.distanceMeters/1e3,crossingTimeSeconds:c,photoFinishScore:o},t.nextIntermediateIndex+=1}}resolveMarkerCrossingScore(t,a){if(a.markerType==="sprint_intermediate")return fs(t,this.resolveSprintWeightProfile());const s=fs(t,this.resolveClimbWeightProfile(a.markerCategory)),r=Vd(`${this.bootstrap.stage.id}:${a.key}:${t.rider.id}`)*25;return s+r}resolveSprintWeightProfile(){return this.stageScoringWeightMap.get("sprint_intermediate")??gd}resolveClimbWeightProfile(t){const a=!t||t==="Sprint"?"HC":t;return this.stageScoringWeightMap.get(`climb_top|${a}`)??yd[a]}calculatePreLeadoutFinishScore(t){const s=this.resolveStaminaPenalty(t.rider.skills.stamina,this.stageDistanceMeters)+t.incidentStaminaPenalty,r=za(t.rider),n=Object.entries(this.finishWeightProfile).reduce((l,[c,o])=>{if(!o)return l;const p=c==="stamina"?s:0,m=Math.max(0,t.rider.skills[c]+r+t.dailyForm+t.microForm+t.teamGroupBonus-p);return l+m*o},0),i=Wt(t,this.resolveFinishMarkerType(),this.isClimberMalusStage());return n+i}applySprintLeadoutBonuses(){const t=this.resolveFinishMarkerType();if(t!=="finish_flat"&&t!=="finish_hill"||this.isTimeTrialMode)return;const a=this.riders.filter(he).sort((l,c)=>(l.finishTimeSeconds??0)-(c.finishTimeSeconds??0));if(a.length===0)return;const s=[];let r=null;for(const l of a){const c=l.finishTimeSeconds??0;if(s.length===0){s.push(l),r=c;continue}if(r!=null&&c-r<=qt){s.push(l),r=c;continue}break}const n=new Set(s.map(l=>l.rider.id)),i=new Map;for(const l of this.riders)if(l.finishStatus!=="dnf"&&l.finishStatus!=="otl"&&l.finishStatus!=="dns"&&l.finishTimeSeconds!=null&&l.rider.skills.sprint>=73&&l.rider.activeTeamId!=null&&n.has(l.rider.id)){const c=l.rider.activeTeamId,o=i.get(c)??[];o.push(l),i.set(c,o)}for(const[l,c]of i.entries()){if(c.length===0)continue;let o=null,p=Number.NEGATIVE_INFINITY;for(const m of c){const u=this.calculatePreLeadoutFinishScore(m);u>p?(p=u,o=m):u===p&&o!==null&&(m.rider.skills.sprint>o.rider.skills.sprint||m.rider.skills.sprint===o.rider.skills.sprint&&m.rider.id<o.rider.id)&&(o=m)}if(o){const m=this.calculateSprintLeadoutBonusForRider(o);m>0&&(o.leadoutBonus=m,o.photoFinishScore+=m)}}}calculateSprintLeadoutBonusForRider(t){const a=t.rider.activeTeamId;if(a==null)return 0;const s=this.riders.filter(p=>p.rider.activeTeamId===a);if(s.length===0)return 0;let r=this.teamSprintRandomValues.get(a);r===void 0&&(r=de(.25,.6),this.teamSprintRandomValues.set(a,r));let n=this.teamSprintSpecialRandomValues.get(a);n===void 0&&(n=de(.1,.3),this.teamSprintSpecialRandomValues.set(a,n)),t.leadoutRiderId=null;let i=0,l=0,c=null;const o=[];for(const p of s){if(p.rider.id===t.rider.id||p.finishStatus==="dnf"||p.finishStatus==="otl"||p.finishStatus==="dns")continue;let m=0;const u=p.rider.skills.sprint>=72,f=p.rider.skills.flat>=78,g=p.rider.skills.timeTrial>=76,b=p.rider.skills.acceleration>=80;if(u&&m++,f&&m++,g&&m++,b&&m++,m>0){const y=u?r:n;let v=1;m===2?v=1.25:m===3?v=1.5:m===4&&(v=2);const T=y*v*1.5;if(i+=y*v,o.push({riderId:p.rider.id,name:p.riderName,contribution:Number(T.toFixed(2))}),y*v>l)l=y*v,c=p.rider.id;else if(y*v===l&&c!==null){const w=this.riders.find(M=>M.rider.id===c);w&&p.rider.skills.sprint>w.rider.skills.sprint&&(c=p.rider.id)}}}return i>0&&(t.leadoutRiderId=c,t.leadoutContributions=o),i*1.5}resolveFinishMarkerType(){const t=Je(this.bootstrap.stageSummary);for(let a=t.length-1;a>=0;a-=1){const s=t[a].marker.type;if(s==="finish_flat"||s==="finish_hill"||s==="finish_mountain")return s}switch(this.bootstrap.stage.profile){case"Hilly":case"Hilly_Difficult":case"Rolling":case"Cobble_Hill":return"finish_hill";case"Medium_Mountain":case"Mountain":case"High_Mountain":return"finish_mountain";default:return"finish_flat"}}resolveFinishWeightProfile(){const t=this.resolveFinishMarkerType(),a=this.stageScoringWeightMap.get(t);if(a)return a;switch(t){case"finish_hill":return hd;case"finish_mountain":return bd;default:return fd}}resolveRiderClockSeconds(t){if(he(t)){const a=t.finishTimeSeconds;return a==null||!Number.isFinite(a)?null:Math.max(0,a-t.startOffsetSeconds)}return t.finishStatus==="dnf"?null:this.isTimeTrialMode?t.hasStarted?Math.max(0,this.elapsedSeconds-t.startOffsetSeconds):null:this.elapsedSeconds}applyIncident(t,a,s,r=!1){var n;if(t.pendingIncident=null,t.appliedIncident=a,t.incidentDelaySecondsRemaining=a.waitDurationSeconds,t.incidentRecoverySecondsRemaining=a.recoverySeconds,t.incidentRecoveryFormBonus=a.recoveryFormBonus,t.dailyForm+=a.dayFormPenalty,t.incidentStaminaPenalty+=a.staminaPenalty,t.statusReason=a.type==="crash"?`crash:${a.severity??"unknown"}${a.hasAdditionalMechanical?"+mechanical":""}`:"mechanical",t.dailyFormCap!=null&&(t.dailyForm=Math.min(t.dailyForm,t.dailyFormCap)),a.type==="crash"&&(a.severity==="medium"&&(t.dailyForm=Math.min(0,t.dailyForm-3),t.microForm-=3,t.dailyFormCap=0),a.severity==="light"&&(t.dailyForm+=0),a.severity==="severe"&&(t.finishStatus="dnf",t.finishTimeSeconds=null,t.currentSpeedMps=0,t.tempSpeedMps=0,t.nextDistanceCoveredMeters=null,t.isAttacking=!1,t.isLeadingGroup=!1,this.activeStageAttacksByRiderId.delete(t.rider.id),t.incidentDelaySecondsRemaining=0,t.incidentRecoverySecondsRemaining=0,t.incidentRecoveryFormBonus=0)),((n=t.rider.role)==null?void 0:n.name)==="Kapitaen"&&a.supportRiderIds.length>0&&a.severity!=="severe")for(const i of a.supportRiderIds){const l=this.riders.find(c=>c.rider.id===i);l&&(l.waitingForCaptainId=t.rider.id,l.waitForCaptainRecovery=!0,l.waitLogged=!1)}if(a.isMassCrashTrigger&&a.massCrashPotentialRiderIds){r=!0;const i=[];for(const l of a.massCrashPotentialRiderIds){const c=this.riders.find(p=>p.rider.id===l);if(!c||Q(c))continue;if(Math.abs(c.distanceCoveredMeters-t.distanceCoveredMeters)<=50){i.push(l);const p=_l(c.rider,this.bootstrap.riders,a.triggerDistanceKm,this.bootstrap.stageSummary.distanceKm);this.applyIncident(c,p,s,!0)}}console.log(`[RaceIncidents] Massensturz ausgelöst durch Fahrer ${t.rider.id} bei Km ${a.triggerDistanceKm}. Tatsächlich verwickelte Fahrer (${i.length}):`,i)}this.pushMessage({elapsedSeconds:s,riderId:t.rider.id,riderName:t.riderName,type:"incident",tone:a.type==="crash"?"danger":"warning",title:r?a.isMassCrashTrigger?`Massensturz (Auslöser): ${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} stürzt`:`Massensturz (involviert): ${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} stürzt`:a.type==="crash"?`${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} stürzt`:`${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} hat einen Defekt`,detail:a.type==="crash"?(()=>{let i="Low",l="Regenerationsmalus auf den nächsten Etappen (-10, -5, -2 Form)";return a.severity==="medium"?(i="Middle",l="Frischeverlust (-15 Frische) und verringerte Tagesform für den Rest der Etappe"):a.severity==="severe"&&(i="High",l="Fahrer musste die Etappe beenden (DNF)"),`Auswirkung: ${i} · Folge: ${l} · Wartezeit: ${a.waitDurationSeconds}s`})():`Wartezeit: ${a.waitDurationSeconds}s`}),a.type==="crash"&&a.severity==="severe"&&this.pushMessage({elapsedSeconds:s,riderId:t.rider.id,riderName:t.riderName,type:"dnf",tone:"danger",title:r?`Massensturz (Folge): ${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} ist ausgeschieden`:`${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} ist ausgeschieden`,detail:`Schwerer Sturz bei km ${a.triggerDistanceKm.toFixed(2)}.`}),console.log("[RaceIncidents] Trigger",{rider:t.riderName,type:a.type,severity:a.severity,kmMark:a.triggerDistanceKm,waitDurationSeconds:a.waitDurationSeconds,eventTimeSeconds:s,supportRiderIds:a.supportRiderIds})}applyCaptainWaitLogic(t){if(t.waitingForCaptainId==null)return;const a=this.riders.find(s=>s.rider.id===t.waitingForCaptainId)??null;if(!a||a.finishStatus==="dnf"){t.waitingForCaptainId=null,t.waitForCaptainRecovery=!1,t.waitLogged=!1;return}if(!(t.waitForCaptainRecovery&&(a.incidentDelaySecondsRemaining>0||a.incidentRecoverySecondsRemaining>0))){if(t.waitForCaptainRecovery=!1,t.distanceCoveredMeters>a.distanceCoveredMeters+fa){t.currentSpeedMps=0,t.nextDistanceCoveredMeters=t.distanceCoveredMeters,t.waitLogged||(this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:t.rider.id,riderName:t.riderName,type:"support_wait",tone:"neutral",title:`${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} wartet auf ${this.formatRiderWithPreStageGc(a.rider.id,a.riderName)}`,detail:"Helfer nimmt Tempo raus, bis der Kapitän wieder anschließt."}),console.log("[RaceIncidents] Helfer wartet",{helper:t.riderName,captain:a.riderName}),t.waitLogged=!0);return}t.waitLogged&&this.pushMessage({elapsedSeconds:this.elapsedSeconds,riderId:t.rider.id,riderName:t.riderName,type:"support_resume",tone:"neutral",title:`${this.formatRiderWithPreStageGc(t.rider.id,t.riderName)} ist wieder beim Kapitän`,detail:`${this.formatRiderWithPreStageGc(a.rider.id,a.riderName)} hat den Helfer wieder erreicht.`}),t.waitingForCaptainId=null,t.waitForCaptainRecovery=!1,t.waitLogged=!1}}}const nc=300;async function ic(e,t){const a=new wi(e,{maxSubstepSeconds:5});let s=!1;for(;!s;){const r=a.step(nc);if(s=r.isFinished,t){const n=r.stageDistanceMeters>0?r.leaderDistanceMeters/r.stageDistanceMeters:0,i=e.riders.length>0?r.finishedRiders/e.riders.length:0,l=Math.min(1,Math.max(0,Math.max(n,i)));t(l)}await new Promise(n=>setTimeout(n,0))}return t==null||t(1),a.getSnapshot()}const oc=[1,2,5,10,25,50,100,250,500],en=new WeakMap;function lc(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),s=Math.floor(t%3600/60),r=t%60;return`${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function tn(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function dc(e){const t=en.get(e);if(t)return t;e.dataset.raceSimMounted="true",e.innerHTML=`
    ...
    <div class="race-sim-message-list">
      ...
      `).join("")}
    </div>`}const yc=1,vc={Flat:12,Rolling:14,Hilly:16,Hilly_Difficult:17,Medium_Mountain:18,Mountain:23,High_Mountain:25,ITT:30,TTT:40,Cobble:18,Cobble_Hill:20};function Sc(e){return Math.max(0,Math.round(e))}function Ei(e){return e==="ITT"||e==="TTT"}function kc(e){return vc[e]??20}function $c(e,t){if(t.length===0)return null;const a=Math.min(...t);return!Number.isFinite(a)||a<=0?null:Math.floor(a*(1+kc(e)/100))}function Tc(e,t){return e.stageTimeSeconds-t.stageTimeSeconds||t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function rn(e,t){return t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function hs(e,t){if(Ei(t))return[...e].sort(Tc);const a=[...e].sort((l,c)=>l.stageTimeSeconds-c.stageTimeSeconds||rn(l,c)),s=[];let r=[],n=null;const i=()=>{s.push(...r.sort(rn))};for(const l of a){if(r.length===0){r=[l],n=l.stageTimeSeconds;continue}if(n!=null&&l.stageTimeSeconds-n<=yc){r.push(l),n=l.stageTimeSeconds;continue}i(),r=[l],n=l.stageTimeSeconds}return r.length>0&&i(),s}function q(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Mc(e){return`/jersey/Jer_${e}.png`}function ia(e,t){return e==null||e<=0?"—":`
    <span class="race-sim-team-visual" title="${q(t??`Team ${e}`)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function oa(e,t,a){return e==null?`<span class="${a}" title="${q(t)}">${q(t)}</span>`:`<button type="button" class="${a} race-sim-stage-overview-rider-link" data-race-sim-group-rider-id="${e}" title="${q(t)}">${q(t)}</button>`}function xc(e){return e.toFixed(1).replace(".",",")}function Ka(e){if(e==null||e<=0)return"—";const t=Math.floor(e/60),a=Math.floor(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function wc(e){return`${e??0} Pkt.`}function Ic(e){if(e==null||!Number.isFinite(e))return"—";const t=Math.round(e);return t===0?"—":t>0?`+${t} m`:`-${Math.abs(t)} m`}function Rc(e){return e==null||!Number.isFinite(e)?"":e<-100?"is-ahead":e>100?"is-behind":""}function Fi(e){const t=Math.max(0,Math.round(e)),a=Math.floor(t/3600),s=Math.floor(t%3600/60),r=t%60;return`${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function Ec(e){if(e==null||e<=0)return Fi(0);const t=Math.floor(e/60),a=Math.round(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function lt(e){return e?e.split("|").map(t=>Number.parseInt(t.trim(),10)).filter(Number.isFinite):[]}function va(e){return`${e.toFixed(1).replace(".",",")} km`}function nn(e){return`${e.toFixed(1).replace(".",",")}%`}function Sa(e,t){return e.filter(a=>Number.isFinite(a)&&a>0).map(a=>({points:a,pointsKind:t}))}function on(e){return e==null?null:e==="HC"?"is-hc":`is-cat-${e}`}function Fc(e){return e.accent==="sprint"?{label:"Sprint",className:"is-sprint"}:e.categoryLabel&&e.categoryClassName?{label:e.categoryLabel,className:e.categoryClassName}:null}function Cc(e,t){return e.riderId==null?null:t.gcLeaderRiderId===e.riderId?"gc":t.pointsLeaderRiderId===e.riderId?"points":t.mountainLeaderRiderId===e.riderId?"mountain":t.youthLeaderRiderId===e.riderId?"youth":null}function Nc(e,t,a){return Array.from({length:t},(s,r)=>e.slice(r*a,(r+1)*a))}function Pc(e,t,a){if(e.length===0)return'<div class="race-sim-favorites-empty">Noch keine Favoriten für diese Etappe.</div>';const s=Nc(e,4,5),r=new Map(t.map(n=>[n.riderId,n]));return`<div class="race-sim-stage-favorites-grid">${s.map(n=>`
    <div class="race-sim-favorites-column">
      ${n.map(i=>`
        <article class="race-sim-favorite-item${(()=>{const l=Cc(i,a);return l?` is-${l}-leader`:""})()}">
  ...
  `).join("")}</div>`}function aa(e,t){const a=e.riders.find(s=>s.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function as(e,t){const a=e.riders.find(n=>n.id===t),s=(a==null?void 0:a.activeTeamId)??null,r=s!=null?e.teams.find(n=>n.id===s)??null:null;return{teamId:s,teamName:(r==null?void 0:r.name)??null}}function Lc(e,t,a,s={}){const r=(t??[]).slice(0,s.limit??8);return r.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${r.map(n=>{var m;const i=n.riderId??0,l=as(e,i),c=aa(e,i),o=((m=s.distanceGapsByRiderId)==null?void 0:m.get(i))??null,p=[s.distanceGapClassName??"",Rc(o)].filter(u=>u.length>0).join(" ");return`
      <article class="race-sim-classification-row">
        ...
        ${s.distanceGapsByRiderId?`<span class="race-sim-classification-distance-gap ${p}">${q(Ic(o))}</span>`:""}
    ...
    <details class="race-sim-overview-details ${a}" data-race-sim-overview-section="${s}" ${r?"open":""}>
      ...
      ${t}
    </details>`}function Wa(e,t,a,s){const r=new Map(t.map(n=>[n.riderId,n]));return e.riders.map(n=>{var c;const i=r.get(n.id)??null,l=((c=a.get(n.id))==null?void 0:c[s])??0;return{riderId:n.id,rank:(i==null?void 0:i.rank)??Number.MAX_SAFE_INTEGER,points:((i==null?void 0:i.points)??0)+l,timeSeconds:(i==null?void 0:i.timeSeconds)??null,gapSeconds:(i==null?void 0:i.gapSeconds)??null,stagePoints:l}}).sort((n,i)=>(i.points??0)-(n.points??0)||n.rank-i.rank||aa(e,n.riderId).localeCompare(aa(e,i.riderId),"de")).map((n,i)=>({...n,rank:i+1}))}function ln(e){const t=Dc(e)?e.stagePoints:0;return`${q(wc("points"in e?e.points:null))}${t>0?`<span class="race-sim-classification-stage-gain"><span class="race-sim-classification-stage-gain-arrow">▲</span><span class="race-sim-classification-stage-gain-amount">+${q(t)}</span></span>`:""}`}function Dc(e){return"stagePoints"in e&&typeof e.stagePoints=="number"}function dn(e,t){if(t==null)return new Map;const a=e.riders.find(s=>s.riderId===t)??null;return a?new Map(e.riders.map(s=>[s.riderId,a.distanceCoveredMeters-s.distanceCoveredMeters])):new Map}function Ac(e,t){return e.stageSummary.segments.find(a=>t>=a.start_km&&t<=a.end_km)??e.stageSummary.segments.find(a=>a.end_km>=t)??e.stageSummary.segments[e.stageSummary.segments.length-1]??null}function Ca(e,t){var s;const a=(s=e.race.category)==null?void 0:s.bonusSystem;return!a||t==null||t==="Sprint"?[]:lt(t==="HC"?a.pointsMountainHc:t==="1"?a.pointsMountainCat1:t==="2"?a.pointsMountainCat2:t==="3"?a.pointsMountainCat3:a.pointsMountainCat4)}function Us(e){var s;const t=(s=e.race.category)==null?void 0:s.bonusSystem;if(!t||e.stage.profile==="TTT")return[];if(!e.race.isStageRace)return lt(t.pointsOneDay);const a=!["ITT","TTT","Flat","Rolling","Hilly"].includes(e.stage.profile);return lt(a?t.pointsMountainStage:t.pointsSprintFinish)}function Ci(e){var t,a;return e.stage.profile==="ITT"||e.stage.profile==="TTT"?[]:lt((a=(t=e.race.category)==null?void 0:t.bonusSystem)==null?void 0:a.pointsSprintIntermediate)}function Bc(e,t,a){let s=null;for(const r of e.stageSummary.segments){const n=Math.max(t,r.start_km),i=Math.min(a,r.end_km),l=Math.max(0,i-n);if(l<=0)continue;const c={lengthKm:l,gradient:r.gradient_percent};(s==null||c.gradient>s.gradient||c.gradient===s.gradient&&c.lengthKm>s.lengthKm)&&(s=c)}return s}function bs(e,t,a,s=null){return e.entries.filter(r=>s==null||s.has(r.riderId)).map((r,n)=>({riderId:r.riderId,rank:r.rank,points:t[n]??0,pointsKind:a,crossingTimeSeconds:r.crossingTimeSeconds,gapSeconds:r.gapSeconds})).filter(r=>r.points>0)}function Ys(e){const t=new Map;for(const a of e)for(const s of a.entries){const r=t.get(s.riderId)??{points:0,mountain:0};s.pointsKind==="mountain"?r.mountain+=s.points:r.points+=s.points,t.set(s.riderId,r)}return t}function _c(e){return Je(e.stageSummary).filter(({marker:t})=>t.type==="finish_flat"||t.type==="finish_TT"||t.type==="finish_hill"||t.type==="finish_mountain").sort((t,a)=>a.kmMark-t.kmMark)[0]??null}function ja(e,t){const a=Ei(e.stage.profile)?t.riderClockSeconds:t.finishTimeSeconds;return a!=null&&Number.isFinite(a)?Sc(a):null}function ss(e,t){const a=t.riders.filter(n=>n.finishStatus!=="dnf").map(n=>{const i=ja(e,n);return i==null?null:{rider:n,stageTimeSeconds:i,photoFinishScore:n.photoFinishScore,riderId:n.riderId}}).filter(n=>n!=null);if(a.length===0)return[];const s=Math.min(...a.map(n=>n.stageTimeSeconds));if(!Number.isFinite(s)||s<=0)return hs(a,e.stage.profile).map(n=>n.rider);const r=$c(e.stage.profile,a.map(n=>n.stageTimeSeconds));return r==null?hs(a,e.stage.profile).map(n=>n.rider):hs(a.filter(n=>n.stageTimeSeconds<=r),e.stage.profile).map(n=>n.rider)}function Gc(e,t){const a=Us(e);return a.length===0?[]:ss(e,t).map((s,r)=>({riderId:s.riderId,rank:r+1,points:a[r]??0,pointsKind:"points",crossingTimeSeconds:ja(e,s),gapSeconds:null})).filter(s=>s.points>0)}function Hc(e,t){const a=ss(e,t).slice(0,20),s=a[0]!=null?ja(e,a[0])??0:0;return a.map((r,n)=>{const i=ja(e,r)??0;return{riderId:r.riderId,rank:n+1,crossingTimeSeconds:i,gapSeconds:Math.max(0,i-s),photoFinishScore:r.photoFinishScore}})}function zc(e,t){var a;return((a=ss(e,t)[0])==null?void 0:a.riderId)??null}function Zs(e,t,a){var w,M;const s=Je(e.stageSummary),r=e.stageSummary.distanceKm*.75,n=a.isFinished?new Set(ss(e,a).map($=>$.riderId)):null,i=s.filter(({marker:$})=>$.type==="climb_start"),l=s.filter(({marker:$})=>ut($)).sort(($,E)=>$.kmMark-E.kmMark).map(($,E)=>{var se,X;const R=[...i].reverse().find(ae=>ae.kmMark<=$.kmMark)??null,L=Ac(e,$.kmMark),C=(R==null?void 0:R.kmMark)??(L==null?void 0:L.start_km)??$.kmMark,D=(R==null?void 0:R.elevation)??(L==null?void 0:L.start_elevation)??$.elevation,B=Math.max(0,$.kmMark-C),G=B>0?($.elevation-D)/(B*1e3)*100:(L==null?void 0:L.gradient_percent)??0,H=Bc(e,C,$.kmMark),x=t.find(ae=>ae.markerKey===$.key)??null,P=Ca(e,(x==null?void 0:x.markerCategory)??$.marker.cat??null),V=x?bs(x,P,"mountain",n):[],K=(x==null?void 0:x.markerCategory)??$.marker.cat??null;return{key:$.key,title:`${E+1}. Bergwertung`,label:$.label,categoryLabel:K?`Kat. ${K}`:null,categoryClassName:on(K),kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:B,averageGradient:G,steepestSegmentLengthKm:(H==null?void 0:H.lengthKm)??null,steepestSegmentGradient:(H==null?void 0:H.gradient)??null,highlightMeta:$.kmMark>=r,leaderRiderId:((se=V[0])==null?void 0:se.riderId)??((X=x==null?void 0:x.entries[0])==null?void 0:X.riderId)??null,displayBadges:Sa(P,"mountain"),entries:V,timingEntries:(x==null?void 0:x.entries)??[],accent:"mountain"}}),c=s.filter(({marker:$})=>$.type==="sprint_intermediate").sort(($,E)=>$.kmMark-E.kmMark).map(($,E)=>{var D,B;const R=t.find(G=>G.markerKey===$.key)??null,L=Ci(e),C=R?bs(R,L,"points",n):[];return{key:$.key,title:`${E+1}. Zwischensprint`,label:$.label,categoryLabel:null,categoryClassName:null,kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!1,leaderRiderId:((D=C[0])==null?void 0:D.riderId)??((B=R==null?void 0:R.entries[0])==null?void 0:B.riderId)??null,displayBadges:Sa(L,"points"),entries:C,timingEntries:(R==null?void 0:R.entries)??[],accent:"sprint"}}),o=_c(e),p=Gc(e,a),m=o?t.find($=>$.markerKey===o.key)??null:null,u=m?bs(m,Ca(e,m.markerCategory),"mountain",n):[],f=Us(e),g=m?Ca(e,m.markerCategory):[],b=e.stage.profile==="ITT"||e.stage.profile==="TTT"?Hc(e,a):(m==null?void 0:m.entries)??[],y=((w=p[0])==null?void 0:w.riderId)??((M=u[0])==null?void 0:M.riderId)??zc(e,a),v={key:"finish",title:"Zielsprint",label:(o==null?void 0:o.label)??"Ziel",categoryLabel:m!=null&&m.markerCategory?`Kat. ${m.markerCategory}`:null,categoryClassName:on((m==null?void 0:m.markerCategory)??null),kmMark:(o==null?void 0:o.kmMark)??e.stageSummary.distanceKm,kmToFinish:0,climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!!(m!=null&&m.markerCategory),leaderRiderId:y,displayBadges:[...Sa(f,"points"),...Sa(g,"mountain")],entries:[...p,...u],timingEntries:b,accent:"finish"};return[...[...c,...l].sort(($,E)=>$.kmMark-E.kmMark||$.title.localeCompare(E.title,"de")),v].filter($=>$.entries.length>0||$.timingEntries.length>0||$.accent!=="finish"||o!=null||a.isFinished)}function Kc(e,t){const a=new Map(t.entries.map(n=>[n.riderId,n])),s=(e.stage.profile==="ITT"||e.stage.profile==="TTT")&&t.key==="finish"?20:15,r=t.timingEntries.length>0?[...t.timingEntries].sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId).slice(0,s):t.entries.slice(0,s).map(n=>({riderId:n.riderId,rank:n.rank,crossingTimeSeconds:n.crossingTimeSeconds??0,gapSeconds:n.gapSeconds??0,photoFinishScore:0,pointsAwarded:n.points})).sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId);return r.length===0?'<div class="race-sim-stage-points-popover-empty">Noch keine Punkte vergeben.</div>':`
    <div class="race-sim-stage-points-popover-list">
      ${r.map(n=>{const i=as(e,n.riderId),l=a.get(n.riderId)??null;return`
          <div class="race-sim-stage-points-popover-row">
            <strong>${n.rank}.</strong>
            ${ia(i.teamId,i.teamName)}
            ${oa(n.riderId,aa(e,n.riderId),"race-sim-stage-scoring-name")}
            <strong>${n.rank===1?q(Fi(n.crossingTimeSeconds)):q(Ec(n.gapSeconds))}</strong>
            ${l?`<strong class="race-sim-stage-points-value-${l.pointsKind}">${l.points}</strong>`:"<strong>—</strong>"}
          </div>`}).join("")}
    </div>`}function cn(e,t){var a;return((a=e==null?void 0:e.find(s=>s.riderId===t))==null?void 0:a.points)??0}function un(e,t){var a;return((a=e.filter(s=>s.riderId!=null&&t.has(s.riderId)).sort((s,r)=>s.rank-r.rank||s.riderId-r.riderId)[0])==null?void 0:a.riderId)??null}function $a(e,t,a){if(!(!t||e.some(s=>s.riderId===t.riderId))){if(e.length<25){e.push(t);return}e[a]=t}}function Wc(e,t,a,s,r){const n=new Set(e.riderIds),i=new Map(t.riders.map(f=>[f.riderId,f])),c=e.riderIds.map(f=>i.get(f)??null).filter(f=>f!=null).sort((f,g)=>{var b,y;return(((b=a.get(f.riderId))==null?void 0:b.rank)??Number.MAX_SAFE_INTEGER)-(((y=a.get(g.riderId))==null?void 0:y.rank)??Number.MAX_SAFE_INTEGER)||f.riderName.localeCompare(g.riderName,"de")||f.riderId-g.riderId}).slice(0,25),o=i.get(un(s,n)??-1)??null,p=i.get(un(r,n)??-1)??null,m=o!=null&&!c.some(f=>f.riderId===o.riderId),u=p!=null&&!c.some(f=>f.riderId===p.riderId);return c.length>=25&&m&&u&&o.riderId!==p.riderId?($a(c,o,23),$a(c,p,24),c):($a(c,o,24),$a(c,p,24),c)}function jc(e,t){const a=[];return t.gcLeaderRiderId===e&&a.push("gc"),t.mountainLeaderRiderId===e&&a.push("mountain"),t.pointsLeaderRiderId===e&&a.push("points"),t.youthLeaderRiderId===e&&a.push("youth"),a}function Oc(e){return e.includes("gc")?" is-gc-leader":e.includes("mountain")?" is-mountain-leader":e.includes("points")?" is-points-leader":e.includes("youth")?" is-youth-leader":""}function mn(e,t){return e==null?"—":`${t}${Math.round(e)} m`}function Vc(e,t){const a=t.riders.filter(r=>e.riderIds.includes(r.riderId)).reduce((r,n)=>Math.max(r,n.distanceCoveredMeters),0),s=Math.max(0,t.leaderDistanceMeters-a);return s>0?`-${Math.round(s)} m`:"—"}function Uc(e,t,a,s,r,n,i){if(a.length===0||e.stage.profile==="ITT"||e.stage.profile==="TTT")return"";const l=hl(a,s),c=a.find(u=>u.label===l)??a[0],o=new Map(e.gcStandings.map(u=>[u.riderId,u])),p=Ys(i),m=Wc(c,t,o,r,n);return`
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-gap-row">
        <span>Vorne ${q(mn(c.previousGapMeters,"-"))}</span>
        <span>Leader ${q(Vc(c,t))}</span>
        <span>Hinten ${q(mn(c.nextGapMeters,"+"))}</span>
      </div>
      <div class="race-sim-group-grid">
        ${m.map((u,f)=>{const g=o.get(u.riderId)??null,b=as(e,u.riderId),y=p.get(u.riderId)??{points:0,mountain:0},v=cn(r,u.riderId),T=cn(n,u.riderId),w=jc(u.riderId,e.classificationLeaders),M=w.length>0?w.map($=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[$]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${Oc(w)}" title="${q(M)}">${f+1}.</strong>
              ${ia(b.teamId,b.teamName)}
              <span class="race-sim-classification-main">
                ${oa(u.riderId,u.riderName,`race-sim-group-rider-name${u.isBreakaway?" is-breakaway":""}`)}
                <strong class="race-sim-group-detail">GC ${g?g.rank:"—"} · ${q(g?Ka(g.gapSeconds):"—")} · ${q(u.gapToLeaderMeters>0?`+${Math.round(u.gapToLeaderMeters)} m`:"—")}</strong>
              </span>
    ...
    </section>`}function Yc(e,t,a,s){const r=Zs(t,a.markerClassifications,a),n=Ys(r),i=Wa(t,t.pointsStandings,n,"points"),l=Wa(t,t.mountainStandings,n,"mountain"),c=Vs(Os(a.clusters));e.innerHTML=Uc(t,a,c,s,i,l,r)}function Zc(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function Jc(e){const t=Je(e.stageSummary),a=Ci(e)[0]??0,s=Us(e)[0]??0,r=t.filter(({marker:n})=>ut(n)).reduce((n,{marker:i})=>n+(Ca(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+s,mountain:r}}function pn(e){const t=Jc(e);return`
    ...
    </span>`}function qc(e){const t=Fc(e),a=[`<span class="race-sim-stage-points-meta-pill">${q(va(e.kmMark))}</span>`,`<span class="race-sim-stage-points-meta-pill">${q(`${va(e.kmToFinish)} bis Ziel`)}</span>`,e.climbLengthKm!=null?`<span class="race-sim-stage-points-meta-pill">${q(`Länge ${va(e.climbLengthKm)}`)}</span>`:"",e.averageGradient!=null?`<span class="race-sim-stage-points-meta-pill">${q(`Ø ${nn(e.averageGradient)}`)}</span>`:"",e.steepestSegmentLengthKm!=null&&e.steepestSegmentGradient!=null?`<span class="race-sim-stage-points-meta-pill is-steepest">${q(`Steilstes ${va(e.steepestSegmentLengthKm)}`)}</span>`:"",e.steepestSegmentLengthKm!=null&&e.steepestSegmentGradient!=null?`<span class="race-sim-stage-points-meta-pill is-steepest">${q(nn(e.steepestSegmentGradient))}</span>`:""].filter(s=>s.length>0);return`
    ...
    </span>`}function Xc(e,t,a,s=null){const r=s??Zs(e,t,a);return r.length===0?`
    ...
    <section class="race-sim-mountain-primes-box">
      ...
      <div class="race-sim-mountain-primes-list">
        ${r.map(n=>{const i=n.leaderRiderId!=null?as(e,n.leaderRiderId):{teamId:null,teamName:null},l=n.leaderRiderId!=null?aa(e,n.leaderRiderId):"Noch offen";return`
          <details class="race-sim-mountain-prime-row race-sim-stage-points-event race-sim-stage-points-event-${n.accent}">
            ...
            <span class="race-sim-stage-points-leader">
              ${ia(i.teamId,i.teamName)}
              ${n.leaderRiderId!=null?oa(n.leaderRiderId,l,"race-sim-stage-scoring-leader-name"):`<strong>${q(l)}</strong>`}
            </span>
            </summary>
    ...
    </section>`}function Qc(e,t,a,s,r,n=new Set){var f,g;const i=Zs(a,s,r),l=Ys(i),c=Wa(a,a.pointsStandings,l,"points"),o=Wa(a,a.mountainStandings,l,"mountain"),p=dn(r,((f=a.gcStandings[0])==null?void 0:f.riderId)??null),m=dn(r,((g=a.youthStandings[0])==null?void 0:g.riderId)??null),u=b=>!n.has(b);e.innerHTML=`
    ...
    <section class="race-sim-classifications-section">
      ${xt("GC",ka("GC","gc",a,a.gcStandings,b=>q(`GC ${b.rank} · ${Ka(b.gapSeconds)}`),{limit:20,distanceGapsByRiderId:p}),"race-sim-overview-classification race-sim-overview-gc","gc",u("gc"))}
  ...
  `}const gn=new WeakMap,Ye=new WeakMap,fn=new WeakMap,Ni=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function J(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Pi(e){return e<=0?"—":`+${Math.round(e)} m`}function Xt(e){const t=Ni.format(e);return e>0?`+${t}`:t}function ys(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function oe(e){return Ni.format(e)}function $t(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),s=Math.floor(t%3600/60),r=t%60;return`${String(a).padStart(2,"0")}:${String(s).padStart(2,"0")}:${String(r).padStart(2,"0")}`}function Li(e){return`+${$t(e)}`}function Di(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Js(e){return`${(e*3.6).toFixed(1)} km/h`}function eu(e){return`${Xt(e)}%`}function Ns(e){return`${e.toFixed(1).replace(".",",")} km`}function Ai(e){return`${Ns(e.segmentStartKm)} - ${Ns(e.segmentEndKm)}`}function tu(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function Bi(e){return e.replace(/_/g," ")}function _i(e){return Bi(e)}function au(e){return Bi(e)}function Gi(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function su(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function ru(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function Hi(e){return Je(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||ut(t)).map(({key:t,label:a})=>({key:t,label:a}))}function nu(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function iu(e,t,a,s){var r;return a!=="ITT"&&a!=="TTT"?((r=s.get(t))==null?void 0:r.get(e.riderId))??null:e.splitTimes[t]??null}function zi(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(r=>({label:r.key,displayLabel:r.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${r.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function ou(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function lu(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function Ki(e){const t=gn.get(e);if(t)return t;const a=Hi(e),s={splitMarkers:a,columns:zi(e,a,!1),riderById:new Map(e.riders.map(r=>[r.id,r])),teamById:new Map((e.teams??[]).map(r=>[r.id,r])),teamAbbreviationById:new Map((e.teams??[]).map(r=>[r.id,r.abbreviation])),teamNameById:new Map((e.teams??[]).map(r=>[r.id,r.name])),gcByRiderId:new Map((e.gcStandings??[]).map(r=>[r.riderId,r]))};return gn.set(e,s),s}function Wi(e,t){const a=e.parentElement,s=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!s)return"";const r=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const o=document.createElement("div");return o.className="race-sim-leaderboard-toolbar",s.insertAdjacentElement("beforebegin",o),o})(),n=qs(e),i=ou(t),l=lu(i,n),c=Ye.get(e);return(c==null?void 0:c.layoutKey)===l||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(o=>o.width).join(" ")),r.innerHTML=`
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,s.innerHTML=t.map(o=>du(o,n)).join(""),Ye.set(e,{layoutKey:l,orderedRiderIds:(c==null?void 0:c.orderedRiderIds)??[],rowsByRiderId:(c==null?void 0:c.rowsByRiderId)??new Map,openDetailRiderId:(c==null?void 0:c.openDetailRiderId)??null,openTeamId:(c==null?void 0:c.openTeamId)??null})),l}function Xe(e,t){e.textContent!==t&&(e.textContent=t)}function Ta(e,t){e.title!==t&&(e.title=t)}function Ma(e,t){e.className!==t&&(e.className=t)}function xa(e,t,a){return e.lastValues[t]!==a}function wa(e,t,a){e.lastValues[t]=a}function qs(e){const t=fn.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return fn.set(e,a),a}function du(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${J(e.label)}">${J(a)}</span>`;const s=!t.autoSort&&t.manualSortKey===e.sortKey,r=s?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
      ...
      ${t.autoSort?"disabled":""}
    >${J(a)}<span class="race-sim-leaderboard-sort-indicator">${J(r)}</span></button>`}function cu(e){return e==="name"||e==="team"||e==="terrainSkill"||e==="clock"||e==="gap"||e==="gcRank"||e==="gcGap"||e.startsWith("split:")?"asc":"desc"}function uu(e,t){return e==null&&t==null?0:e==null?1:t==null?-1:typeof e=="number"&&typeof t=="number"?e-t:String(e).localeCompare(String(t),"de")}function hn(e,t,a,s,r,n,i){if(s.autoSort)return(c,o)=>e.stage.profile==="ITT"?ji(c,o,t):fu(c,o);if(!s.manualSortKey)return null;const l=s.manualSortDirection==="asc"?1:-1;return(c,o)=>{if(we(c)!==we(o))return we(c)?1:-1;const p=r.get(c.riderId)??null,m=r.get(o.riderId)??null,u=bn(c,p,s.manualSortKey??"",e,a,n,i),f=bn(o,m,s.manualSortKey??"",e,a,n,i);return uu(u,f)*l||c.riderId-o.riderId}}function mu(e,t,a){if(e.length!==t.size)return!1;let s=null;for(const r of e){const n=t.get(r);if(!n||s&&a(s,n)>0)return!1;s=n}return!0}function bn(e,t,a,s,r,n,i){const l=s.race.isStageRace&&s.stage.stageNumber>1?n.get(e.riderId)??null:null;switch(a){case"name":return e.riderName;case"team":return(t==null?void 0:t.activeTeamId)!=null?i.get(t.activeTeamId)??"":null;case"gap":return e.gapToLeaderMeters;case"clock":return s.stage.profile==="ITT"?e.riderClockSeconds??(e.hasStarted?null:e.startOffsetSeconds):e.finishTimeSeconds;case"terrainSkill":return`${e.activeTerrain}-${e.skillName}`;case"baseSkill":return e.baseSkill;case"effectiveSkill":return e.effectiveSkill;case"teamBonus":return e.teamGroupBonus;case"seasonForm":return(t==null?void 0:t.formBonus)??0;case"raceForm":return(t==null?void 0:t.raceFormBonus)??0;case"fatigue":return(t==null?void 0:t.fatigueMalus)??0;case"staminaPenalty":return e.staminaPenalty;case"elevationPenalty":return e.elevationPenalty;case"dailyForm":return e.dailyForm;case"microForm":return e.microForm;case"gcRank":return(l==null?void 0:l.rank)??null;case"gcGap":return(l==null?void 0:l.gapSeconds)??null;case"gradientPercent":return e.gradientPercent;case"gradientModifier":return e.gradientModifier;case"windModifier":return e.windModifier;case"draftModifier":return e.draftModifier;case"speed":return e.currentSpeedMps;case"specialForm":return e.hasSuperform?1:e.hasSupermalus?-1:0;default:return a.startsWith("split:")?iu(e,a.slice(6),s.stage.profile,r):null}}function pu(e,t,a,s,r,n,i,l,c){if(!r.manualSortKey){if(r.autoSort){const u=hn(t,a,s,r,n,i,l);return u?[...e].sort(u):[...e]}const m=new Map(r.frozenOrder.map((u,f)=>[u,f]));return[...e].sort((u,f)=>(we(u)===we(f)?0:we(u)?1:-1)||(m.get(u.riderId)??Number.MAX_SAFE_INTEGER)-(m.get(f.riderId)??Number.MAX_SAFE_INTEGER)||u.riderId-f.riderId)}const o=hn(t,a,s,r,n,i,l);if(!o)return[...e];const p=new Map(e.map(m=>[m.riderId,m]));return mu(c,p,o)?c.map(m=>p.get(m)).filter(m=>m!=null):[...e].sort(o)}function gu(e,t){var o;const a=t.closest("button[data-race-sim-ttt-team-toggle]");if(a){const p=Number(a.dataset.raceSimTttTeamToggle);if(!Number.isFinite(p))return!1;const m=Ye.get(e);return m?(m.openTeamId=m.openTeamId===p?null:p,m.openTeamId==null&&(m.openDetailRiderId=null),!0):!1}const s=t.closest("button[data-race-sim-rider-toggle]");if(s){const p=Number(s.dataset.raceSimRiderToggle);if(!Number.isFinite(p))return!1;const m=Ye.get(e);return m?(m.openDetailRiderId=m.openDetailRiderId===p?null:p,!0):!1}const r=qs(e);if(t.closest("button[data-race-sim-splits-toggle]"))return r.showSplitColumns=!r.showSplitColumns,!r.showSplitColumns&&((o=r.manualSortKey)!=null&&o.startsWith("split:"))&&(r.manualSortKey=null,r.manualSortDirection="asc"),!0;if(t.closest("button[data-race-sim-auto-sort]"))return r.autoSort=!r.autoSort,r.autoSort?(r.manualSortKey=null,r.frozenOrder=[]):(r.manualSortKey=null,r.manualSortDirection="asc",r.frozenOrder=Array.from(e.querySelectorAll("[data-race-sim-rider-row]")).map(p=>Number(p.dataset.raceSimRiderRow)).filter(p=>Number.isFinite(p))),!0;const l=t.closest("button[data-race-sim-sort-key]");if(!l||r.autoSort)return!1;const c=l.dataset.raceSimSortKey;return c?(r.manualSortKey===c?r.manualSortDirection=r.manualSortDirection==="asc"?"desc":"asc":(r.manualSortKey=c,r.manualSortDirection=cu(c)),r.frozenOrder=[],!0):!1}function yn(e,t){return t.some(a=>e.splitTimes[a.key]!=null)}function we(e){return e.finishStatus==="dnf"}function ji(e,t,a){if(we(e)!==we(t))return we(e)?1:-1;if(e.finishTimeSeconds!=null&&t.finishTimeSeconds!=null)return(e.riderClockSeconds??e.finishTimeSeconds??Number.POSITIVE_INFINITY)-(t.riderClockSeconds??t.finishTimeSeconds??Number.POSITIVE_INFINITY)||e.riderId-t.riderId;if(e.finishTimeSeconds!=null)return-1;if(t.finishTimeSeconds!=null)return 1;for(let l=a.length-1;l>=0;l-=1){const c=a[l];if(!c)continue;const o=e.splitTimes[c.key],p=t.splitTimes[c.key];if(o!=null&&p!=null&&o!==p)return o-p;if(o!=null&&p==null)return-1;if(o==null&&p!=null)return 1}const s=yn(e,a),r=yn(t,a);if(s!==r)return s?-1:1;const n=e.riderClockSeconds,i=t.riderClockSeconds;return n!=null&&i!=null&&n!==i?n-i:n!=null&&i==null?-1:n==null&&i!=null?1:e.startOffsetSeconds-t.startOffsetSeconds||e.riderId-t.riderId}function fu(e,t){return we(e)!==we(t)?we(e)?1:-1:e.isFinished!==t.isFinished?e.isFinished?-1:1:e.isFinished&&t.isFinished?(e.finishTimeSeconds??Number.POSITIVE_INFINITY)-(t.finishTimeSeconds??Number.POSITIVE_INFINITY)||e.riderId-t.riderId:e.gapToLeaderMeters-t.gapToLeaderMeters||e.riderId-t.riderId}function Oi(e,t){const a=(t==null?void 0:t.formBonus)??0,s=(t==null?void 0:t.raceFormBonus)??0,r=((t==null?void 0:t.fatigueMalus)??0)*.5,n=((t==null?void 0:t.longTermFatigueMalus)??0)*.5,i=((t==null?void 0:t.shortTermFatigueMalus)??0)*.5,l=e.teamGroupBonus,c=Math.max(-2.5,Math.min(2.5,e.microForm*2.5)),o=e.isAttacking?10:0,p=e.baseSkill+o+a+s+e.dailyForm+e.microForm+l-r-n-i,m=Math.max(0,p-e.staminaPenalty),u=p-m,f=m-e.effectiveSkill;return[`Basis ${oe(e.baseSkill)}`,e.isAttacking?`+ Attacke ${oe(o)}`:null,`+ S-Form ${oe(a)}`,`+ R-Form ${oe(s)}`,`+ T-Form ${oe(e.dailyForm)}`,`+ Zufällige Form ${oe(c)} (skaliert)`,`+ Teambonus ${oe(l)}`,`- Fatigue ${oe(r)}`,`- Langzeit ${oe(n)}`,`- Akut ${oe(i)}`,`- Stamina ${oe(u)}`,`- HM ${oe(f)}`,`= Effektiv ${oe(e.effectiveSkill)}`].filter(g=>g!=null)}function hu(e,t){return Oi(e,t).join(`
`)}function bu(e){return Xt(Math.max(-2.5,Math.min(2.5,e*2.5)))}function yu(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function Vi(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${J(e.riderName)}">${J(e.riderName)}</button>`}function vu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId)??"—",r=a.get(e.activeTeamId)??s;return`<span class="race-sim-team-code" title="${J(r)}">${J(s)}</span>`}function Ui(e){return`/jersey/Jer_${e}.png`}function Su(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const s=t.get(e.activeTeamId);if(!s)return"—";const r=a.get(e.activeTeamId)??s.name,n=Ui(e.activeTeamId);return`
    ...
    <span class="race-sim-team-visual" title="${J(e.name)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function Iu(e,t,a){const s=new Map;for(const r of e.riders){const n=a.get(r.riderId),i=n==null?void 0:n.activeTeamId;if(i==null)continue;const l=s.get(i)??[];l.push(r),s.set(i,l)}return t.teams.filter(r=>s.has(r.id)).map(r=>{const n=(s.get(r.id)??[]).slice().sort((p,m)=>m.effectiveSkill-p.effectiveSkill||p.riderId-m.riderId),i=n[0]??e.riders[0],l=Math.min(5,n.length),c=n.slice(0,l).reduce((p,m)=>p+m.effectiveSkill,0)/Math.max(l,1),o=Math.max(0,8-n.length);return{team:r,riders:n,representative:i,teamClockSeconds:(i==null?void 0:i.riderClockSeconds)??null,teamDistanceMeters:(i==null?void 0:i.distanceCoveredMeters)??0,teamEffectiveSkill:Math.max(1,c-o),teamSpeedMps:(i==null?void 0:i.currentSpeedMps)??0,splitTimes:(i==null?void 0:i.splitTimes)??{},finishedRiders:n.filter(p=>p.isFinished).length}}).sort((r,n)=>ji(r.representative,n.representative,Hi(t))||r.team.id-n.team.id)}function Ru(e,t,a,s,r){return`
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${J(e.team.name)}">
      ...
      <div class="race-sim-rider-detail-grid">
        ...
        <div class="race-sim-rider-detail-item"><span>Speed</span><strong>${J(Js(e.teamSpeedMps))}</strong></div>
        <div class="race-sim-rider-detail-item"><span>Teamuhr</span><strong>${J(e.teamClockSeconds!=null?$t(e.teamClockSeconds):"—")}</strong></div>
        <div class="race-sim-rider-detail-item"><span>Distanz</span><strong>${J(Ns(e.teamDistanceMeters/1e3))}</strong></div>
      </div>
      ...
      <div class="race-sim-ttt-team-detail-list">
        ${e.riders.map(n=>{const i=t.riderById.get(n.riderId)??null,l=a&&s>1?t.gcByRiderId.get(n.riderId)??null:null,c=r===n.riderId;return`
      ...
      <div class="stage-editor-marker-row">
        ...
        <button type="button" class="btn btn-danger btn-xs" data-segment-action="remove-marker" data-marker-scope="${s}" data-marker-index="${n}" data-segment-index="${t}" ${o?"":"disabled"}>✕</button>
    ...
    </div>`}function nm(e,t,a,s,r){if(!d.stageEditorDraft)return;const n=d.stageEditorDraft.segments[e];if(!n)return;const i=a==="start"?n.markers:n.endMarkers,l=i[t];if(l){if(s==="markerType"){l.type=r;const c=Ju(l);if(l.name=c.name,l.cat=c.cat,Ne(l.type)){const o=i.filter((p,m)=>m===t||!Ne(p.type));a==="start"?n.markers=o:n.endMarkers=o}}else s==="markerName"?l.name=r.trim()||null:s==="markerCat"&&(l.cat=r||null);a==="start"?n.markers=_e(n.markers):n.endMarkers=_e(n.endMarkers),mt(d.stageEditorDraft),nt(d.stageEditorDraft),ce()}}function im(e,t){if(!d.stageEditorDraft)return;const a=d.stageEditorDraft.segments[e];if(!a)return;const s=t==="start"?e===0&&!a.markers.some(r=>r.type==="start")?{type:"start",name:"Start",cat:null}:{type:"climb_start",name:null,cat:null}:e===d.stageEditorDraft.segments.length-1&&!a.endMarkers.some(r=>Ne(r.type))?{type:"finish_flat",name:"Ziel",cat:null}:{type:"sprint_intermediate",name:null,cat:"Sprint"};t==="start"?(a.markers.push(s),a.markers=_e(a.markers)):(a.endMarkers.push(s),a.endMarkers=_e(a.endMarkers)),mt(d.stageEditorDraft),nt(d.stageEditorDraft),ce()}function om(e,t,a){if(!d.stageEditorDraft)return;const s=d.stageEditorDraft.segments[e];s&&(a==="start"?s.markers.splice(t,1):s.endMarkers.splice(t,1),mt(d.stageEditorDraft),nt(d.stageEditorDraft),ce())}let Nt=0,Pt=0;async function lm(){h("stage-editor-profile").innerHTML=Qs("Flat"),h("stage-editor-chart").innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>',h("stage-editor-climbs").innerHTML='<p class="text-muted">Climb-Vorschläge erscheinen nach dem Import.</p>';const[e,t,a]=await Promise.all([O.listStageEditorCountries(),O.listStageEditorRaceCategories(),O.listStageEditorRacePrograms()]);if(e.success&&e.data){const s=h("stage-editor-race-country");s.innerHTML=e.data.map(r=>`<option value="${r.id}">${S(r.name)} (${S(r.code3)})</option>`).join("")}if(t.success&&t.data){const s=h("stage-editor-race-category");s.innerHTML=t.data.map(r=>`<option value="${r.id}">${S(r.name)}</option>`).join("")}a.success&&a.data&&(d.stageEditorPrograms=a.data,dm())}function dm(){const e=h("stage-editor-programs-list");d.stageEditorPrograms&&(e.innerHTML=d.stageEditorPrograms.map(t=>`
    ...
    `).join(""))}function cm(){const e=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked'),t=h("stage-editor-programs-selected-text");if(e.length===0)t.textContent="Keine Programme ausgewählt",t.classList.add("text-muted");else{const a=Array.from(e).map(s=>{var n;const r=(n=d.stageEditorPrograms)==null?void 0:n.find(i=>String(i.id)===s.value);return r?r.name:s.value});t.textContent=`${e.length} ausgewählt: ${a.join(", ")}`,t.classList.remove("text-muted")}}function tr(e){return Math.round(e.startElevation+e.lengthKm*1e3*(e.gradientPercent/100))}function Qi(){const e=d.stageEditorExistingStages.map(t=>t.stageId);return e.length>0?Math.max(...e)+1:1}function um(){const e=[...d.stageEditorExistingStages.map(t=>t.raceId),...d.races.map(t=>t.id)];return e.length>0?Math.max(...e)+1:1}function mm(e,t){let a=e;const s=new Set(d.stageEditorExistingStages.map(r=>r.stageId));for(;a>0&&s.has(a);)a+=t;if(a<=0)for(a=1;s.has(a);)a+=1;return a}function pm(e,t){let a=e;const s=new Set([...d.stageEditorExistingStages.map(r=>r.raceId),...d.races.map(r=>r.id)]);for(;a>0&&s.has(a);)a+=t;if(a<=0)for(a=1;s.has(a);)a+=1;return a}function gm(e){var l;const t=h("stage-editor-profile");t.innerHTML=Qs(e.suggestedProfile),t.value=e.suggestedProfile;const a=Qi(),s=um();h("stage-editor-stage-id").value=String(a),h("stage-editor-race-id").value=String(s),Nt=a,Pt=s;const r=h("stage-editor-details-file");r.value.trim()||(r.value=`${ju(e.routeName)}.csv`);const n=h("stage-editor-date");!n.value&&((l=d.gameState)!=null&&l.currentDate)&&(n.value=d.gameState.currentDate),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(c=>{c.checked=!0})}function fm(e){h("stage-editor-stage-id").value=String(e.stageId),h("stage-editor-race-id").value=String(e.raceId),Nt=e.stageId,Pt=e.raceId,h("stage-editor-stage-number").value=String(e.stageNumber),h("stage-editor-date").value=e.date,h("stage-editor-details-file").value=e.detailsCsvFile;const t=h("stage-editor-profile");t.innerHTML=Qs(e.profile),t.value=e.profile,h("stage-editor-final-spread-start").value=String(e.finalSpreadStartPercent),h("stage-editor-final-push-start").value=String(e.finalPushStartPercent),h("stage-editor-final-spread-difficulty").value=String(e.finalSpreadDifficultyMultiplier),h("stage-editor-crash-multiplier").value=String(e.crashIncidentMultiplier),h("stage-editor-mechanical-multiplier").value=String(e.mechanicalIncidentMultiplier);const a=(e.allowedWeather||"1|2|3|4|5|6|7").split("|").map(r=>r.trim());document.querySelectorAll('input[name="stage-editor-weather"]').forEach(r=>{r.checked=a.includes(r.value)})}function eo(e){var s;if(!e)return["Noch keine Strecke importiert."];const t=[];return e.segments.length===0?(t.push("Mindestens ein Segment ist erforderlich."),t):((s=e.segments[0])!=null&&s.markers.some(r=>r.type==="start")||t.push("Das erste Segment muss als Start markiert sein."),(e.segments[e.segments.length-1].endMarkers??[]).some(r=>Ne(r.type))||t.push("Das letzte Segment muss per Endmarker als Ziel markiert sein."),e.segments.forEach((r,n)=>{er(e,n).forEach(i=>{t.push(`Segment ${n+1}: ${i}`)}),[...r.markers??[],...r.endMarkers??[]].forEach(i=>{i.cat!=null&&!Ji.includes(i.cat)&&t.push(`Segment ${n+1}: Ungültige Marker-Kategorie ${i.cat}.`)})}),t)}function to(){const e=[],t=Number(h("stage-editor-stage-id").value),a=Number(h("stage-editor-race-id").value),s=Number(h("stage-editor-stage-number").value),r=h("stage-editor-date").value.trim(),n=h("stage-editor-details-file").value.trim(),i=Number(h("stage-editor-final-spread-start").value),l=Number(h("stage-editor-final-push-start").value),c=Number(h("stage-editor-final-spread-difficulty").value),o=Number(h("stage-editor-crash-multiplier").value),p=Number(h("stage-editor-mechanical-multiplier").value);(!Number.isInteger(t)||t<=0)&&e.push("Stage-ID fehlt oder ist ungültig."),(!Number.isInteger(a)||a<=0)&&e.push("Race-ID fehlt oder ist ungültig."),(!Number.isInteger(s)||s<=0)&&e.push("Etappennummer fehlt oder ist ungültig."),/^\d{4}-\d{2}-\d{2}$/.test(r)||e.push("Datum muss im Format YYYY-MM-DD vorliegen."),(!/^[A-Za-z0-9_.-]+\.csv$/.test(n)||n.includes("/"))&&e.push("Details-Datei muss ein Dateiname mit .csv-Endung ohne Pfad sein."),(!Number.isFinite(i)||i<0||i>100)&&e.push("Final Spread Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(l)||l<0||l>100)&&e.push("Final Push Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(c)||c<=0)&&e.push("Final Spread Multiplikator muss groesser als 0 sein."),(!Number.isFinite(o)||o<=0)&&e.push("Sturz-Multiplikator muss groesser als 0 sein."),(!Number.isFinite(p)||p<=0)&&e.push("Defekt-Multiplikator muss groesser als 0 sein."),document.querySelectorAll('input[name="stage-editor-weather"]:checked').length===0&&e.push("Mindestens eine Wetterart muss ausgewählt sein."),d.stageEditorExistingStages.map(y=>y.stageId).includes(t)&&e.push(`Die Stage-ID ${t} existiert bereits in stages.csv.`);const f=h("stage-editor-new-race-checkbox").checked,g=[...d.stageEditorExistingStages.map(y=>y.raceId),...d.races.map(y=>y.id)];if(f){g.includes(a)&&e.push(`Die Race-ID ${a} existiert bereits.`);const y=h("stage-editor-race-name").value.trim(),v=Number(h("stage-editor-race-country").value),T=Number(h("stage-editor-race-category").value),w=Number(h("stage-editor-race-num-stages").value),M=h("stage-editor-race-start-date").value.trim(),$=h("stage-editor-race-end-date").value.trim(),E=Number(h("stage-editor-race-prestige").value);y||e.push("Rennname fehlt."),(!Number.isInteger(v)||v<=0)&&e.push("Land fehlt oder ist ungültig."),(!Number.isInteger(T)||T<=0)&&e.push("Kategorie fehlt oder ist ungültig."),(!Number.isInteger(w)||w<=0)&&e.push("Etappenanzahl muss eine positive Ganzzahl sein."),/^\d{4}-\d{2}-\d{2}$/.test(M)||e.push("Startdatum muss im Format YYYY-MM-DD vorliegen."),/^\d{4}-\d{2}-\d{2}$/.test($)||e.push("Enddatum muss im Format YYYY-MM-DD vorliegen."),(!Number.isInteger(E)||E<1||E>100)&&e.push("Prestige muss zwischen 1 und 100 liegen.")}else g.includes(a)||e.push(`Die Race-ID ${a} existiert nicht. Wenn Sie ein neues Rennen erstellen möchten, aktivieren Sie bitte 'Neues Rennen anlegen'.`);return h("stage-editor-program-checkbox").checked&&document.querySelectorAll('input[name="stage-editor-program-selection"]:checked').length===0&&e.push("Mindestens ein Programm muss ausgewählt sein."),e}function hm(){var a,s;const e=document.querySelectorAll('input[name="stage-editor-weather"]:checked'),t=Array.from(e).map(r=>r.value).join("|");return{stageId:Number(h("stage-editor-stage-id").value),raceId:Number(h("stage-editor-race-id").value),stageNumber:Number(h("stage-editor-stage-number").value),date:h("stage-editor-date").value.trim(),profile:h("stage-editor-profile").value,detailsCsvFile:h("stage-editor-details-file").value.trim(),startElevation:((s=(a=d.stageEditorDraft)==null?void 0:a.segments[0])==null?void 0:s.startElevation)??0,finalSpreadStartPercent:Number(h("stage-editor-final-spread-start").value),finalPushStartPercent:Number(h("stage-editor-final-push-start").value),finalSpreadDifficultyMultiplier:Number(h("stage-editor-final-spread-difficulty").value),crashIncidentMultiplier:Number(h("stage-editor-crash-multiplier").value),mechanicalIncidentMultiplier:Number(h("stage-editor-mechanical-multiplier").value),allowedWeather:t}}function bm(e){return["distanceKm","elevationGainMeters","sprintCount","climbCount","profileScore"].includes(e)?"desc":"asc"}function ym(e){return["gainMeters","distanceKm","avgGradient","maxGradient","climbScore"].includes(e)?"desc":"asc"}function rs(e,t,a){const r=(Math.max(t,Math.min(a,e))-t)/Math.max(1,a-t),n=Math.round(124-r*118),i=54,l=.14+r*.12,c=.26+r*.18;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${n};--stage-editor-score-lightness:${i}%;--stage-editor-score-bg-alpha:${l};--stage-editor-score-border-alpha:${c};`}">${Math.round(e)}</span>`}function ar(e){let t;e<=100?t=e/100*.45:e<=250?t=.45+(e-100)/150*.35:t=.8+Math.min(e-250,100)/100*.2;const a=Math.round(122-t*122),s=Math.round(40-t*22),r=.18+t*.3,n=.3+t*.4;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${s}%;--stage-editor-score-bg-alpha:${r};--stage-editor-score-border-alpha:${n};`}">${Math.round(e)}</span>`}function vm(e){if(e==null)return'<span class="stage-editor-category-empty">—</span>';const t=e==="HC"?"is-hc":`is-cat-${e}`,a=e==="HC"?"HC":String(e);return`<span class="stage-editor-climb-category-badge ${t}">${a}</span>`}function Sm(e,t,a,s){const r=s!=null?` data-stage-profile-open-climb-id="${S(s)}"`:"";return`<button class="dashboard-stage-profile-link" type="button" data-stage-profile-open-stage-id="${t}"${r}>${e}</button>`}function km(e){const t=i=>i!=null?`${i.toFixed(1).replace(".",",")} km`:"—",a=i=>i!=null?`${Math.round(i).toLocaleString("de-DE")} m`:"—",s=e.profileScore??e.score,r=[...d.stageEditorClimbRows??[]].filter(i=>i.stageId===e.stageId).sort((i,l)=>i.climbIndex-l.climbIndex),n=r.length===0?'<div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-compact"><span class="text-muted" style="grid-column:1/-1">Keine Bergwertungen</span></div>':`
      ...
      ${r.map(i=>`
        <div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-climbs">
          ...
          <span>${S(i.name)}</span>
          <span class="text-right">${ar(i.climbScore)}</span>
    ...
    </div>`}function ao(e,t,a,s,r,n,i,l){const c=l??rs(e,t,a);return`
    ...
    </tr>`);const l=Mm(d.stageEditorStageRows);r.innerHTML=l.map(c=>`
    <tr>
      <td>${c.stageId}</td>
    ...
    </tr>`);const l=xm(d.stageEditorClimbRows);r.innerHTML=l.map(c=>`
    <tr>
      <td>${c.placementKm.toFixed(1).replace(".",",")} km</td>
      <td><strong>${S(c.name)}</strong></td>
      <td>${vm(c.category)}</td>
      <td>${ao(c.climbScore,0,350,c.stageId,$m(c),ls({name:c.raceName},{stageNumber:c.stageNumber,profile:"Mountain"}),c.id,ar(c.climbScore))}</td>
      <td>${ie(c.countryCode||"")}</td>
      <td><strong>${S(c.raceName)}</strong></td>
      <td><strong>${S(ca({stageNumber:c.stageNumber}))}</strong></td>
    ...
    `,s.innerHTML=y,n.innerHTML=xn(e),i.innerHTML=e.segments.map((v,T)=>`
    <tr data-segment-index="${T}" class="${er(e,T).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;">
      <td class="stage-editor-cell-nr text-muted" style="text-align:center; font-weight:700;">${T+1}</td>
      <td class="stage-editor-cell-length"><input type="number" step="0.01" min="0.2" value="${v.lengthKm.toFixed(2)}" data-field="segmentLengthKm" class="${Yu(v.lengthKm<Oa)}"></td>
      ...
      <td class="stage-editor-cell-start-markers">
        ${Mn(v.markers,T,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${Mn(v.endMarkers,T,e.segments.length,"end")}
      </td>
      <td class="stage-editor-row-actions">
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          <div class="text-muted" style="min-width:3.5rem;">${tr(v)} m</div>
          ${Em(e,T)}
    ...
    </tr>`).join(""),c.disabled=f.length>0,l.textContent=f.length>0?`${f.length} Validierungshinweise vor dem Export.`:`Exportiert ${h("stage-editor-details-file").value||"stage_details.csv"} und eine stages-Row als Download.`}function Em(e,t){const a=er(e,t);return a.length===0?'<div class="stage-editor-segment-status">OK</div>':`<div class="stage-editor-segment-issues">${a.map(s=>`<div>${S(s)}</div>`).join("")}</div>`}function xn(e){if(!e||e.waypoints.length<2)return'<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';const t=920,a=280,s=24,r=20,n=e.waypoints,i=n[n.length-1].kmMark,l=Math.min(...n.map(g=>g.elevation)),c=Math.max(...n.map(g=>g.elevation)),o=Math.max(1,c-l),p=n.map(g=>{const b=s+g.kmMark/Math.max(i,.1)*(t-s*2),y=a-r-(g.elevation-l)/o*(a-r*2);return{x:b,y,waypoint:g}}),m=p.map((g,b)=>`${b===0?"M":"L"} ${g.x.toFixed(1)} ${g.y.toFixed(1)}`).join(" "),u=`${m} L ${(t-s).toFixed(1)} ${(a-r).toFixed(1)} L ${s.toFixed(1)} ${(a-r).toFixed(1)} Z`,f=p.filter(g=>g.waypoint.markers.length>0).map(g=>`
...
`)}`),ce();return}const t=h("stage-editor-new-race-checkbox").checked,a=h("stage-editor-program-checkbox").checked;let s;t&&(s={name:h("stage-editor-race-name").value.trim(),countryId:Number(h("stage-editor-race-country").value),categoryId:Number(h("stage-editor-race-category").value),isStageRace:Number(h("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(h("stage-editor-race-num-stages").value),startDate:h("stage-editor-race-start-date").value.trim(),endDate:h("stage-editor-race-end-date").value.trim(),prestige:Number(h("stage-editor-race-prestige").value)});let r;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');r=Array.from(n).map(i=>Number(i.value))}ve("CSV-Dateien werden erstellt……");try{const n=await O.exportStageRoute({metadata:hm(),draft:d.stageEditorDraft,newRace:t,raceDetails:s,updatePrograms:a,programIds:r});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}Fs(n.data.stagesFileName,n.data.stagesCsv),Fs(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=h("stage-editor-stage-number"),l=Number(i.value)||1;i.value=String(l+1);const c=h("stage-editor-date"),o=c.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(o)){const y=new Date(o);y.setDate(y.getDate()+1);const v=y.getFullYear(),T=String(y.getMonth()+1).padStart(2,"0"),w=String(y.getDate()).padStart(2,"0");c.value=`${v}-${T}-${w}`}await Promise.all([so(!0),Tm(!0)]);const p=Qi();h("stage-editor-stage-id").value=String(p),Nt=p;const m=h("stage-editor-new-race-checkbox");m&&(m.checked=!1);const u=h("stage-editor-new-race-details");u&&(u.classList.add("hidden"),u.style.display="none");const f=h("stage-editor-program-checkbox");f&&(f.checked=!1);const g=h("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),Pt=Number(h("stage-editor-race-id").value),ce()}finally{fe()}}function Bm(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",M=>{const $=M.target.closest("button[data-stage-profile-open-stage-id]");if($){const L=Number($.dataset.stageProfileOpenStageId);Number.isFinite(L)&&qa(L);return}const E=M.target.closest("button[data-stage-editor-stages-sort]");if(!E)return;const R=E.dataset.stageEditorStagesSort;d.stageEditorStagesSort.key===R?d.stageEditorStagesSort.direction=d.stageEditorStagesSort.direction==="asc"?"desc":"asc":d.stageEditorStagesSort={key:R,direction:bm(R)},Vt()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",M=>{const $=M.target.closest("button[data-stage-profile-open-stage-id]");if($){const L=Number($.dataset.stageProfileOpenStageId),C=$.dataset.stageProfileOpenClimbId??null;if(Number.isFinite(L)){let D=null;C&&d.stageEditorClimbRows&&(D=d.stageEditorClimbRows.find(B=>B.id===C)??null),qa(L,D)}return}const E=M.target.closest("button[data-stage-editor-climbs-sort]");if(!E)return;const R=E.dataset.stageEditorClimbsSort;d.stageEditorClimbsSort.key===R?d.stageEditorClimbsSort.direction=d.stageEditorClimbsSort.direction==="asc"?"desc":"asc":d.stageEditorClimbsSort={key:R,direction:ym(R)},Ut()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{Lm()});const s=document.getElementById("btn-stage-editor-load-existing");s&&s.addEventListener("click",()=>{Dm()});const r=document.getElementById("btn-stage-editor-export");r&&r.addEventListener("click",()=>{Am()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",M=>{var E;const $=((E=M.target.files)==null?void 0:E[0])??null;h("stage-editor-file-hint").textContent=$?`${$.name} · ${($.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",M=>{const $=M.target,E=$.closest("tr[data-segment-index]"),R=$.dataset.field;if(!E||!R)return;const L=Number(E.dataset.segmentIndex);if(Number.isInteger(L)){if(R==="markerType"||R==="markerName"||R==="markerCat"){const C=Number($.dataset.markerIndex),D=$.dataset.markerScope;if(!Number.isInteger(C)||D!=="start"&&D!=="end")return;nm(L,C,D,R,$.value);return}Fm(L,R,$.value)}}),i.addEventListener("click",M=>{const $=M.target.closest("button[data-segment-action]");if(!$)return;const E=Number($.dataset.segmentIndex);if(Number.isInteger(E)){if($.dataset.segmentAction==="insert"){Cm(E);return}if($.dataset.segmentAction==="append"){Nm();return}if($.dataset.segmentAction==="add-marker"){const R=$.dataset.markerScope;if(R!=="start"&&R!=="end")return;im(E,R);return}if($.dataset.segmentAction==="remove-marker"){const R=Number($.dataset.markerIndex),L=$.dataset.markerScope;if(!Number.isInteger(R)||L!=="start"&&L!=="end")return;om(E,R,L);return}$.dataset.segmentAction==="delete"&&Pm(E)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(M=>{const $=document.getElementById(M);$&&$.addEventListener("change",()=>ce())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(M=>{M.addEventListener("change",()=>ce())});const c=h("stage-editor-new-race-checkbox"),o=h("stage-editor-new-race-details"),p=h("stage-editor-program-checkbox"),m=h("stage-editor-program-details");c&&c.addEventListener("change",()=>{c.checked?(o&&(o.classList.remove("hidden"),o.style.display="grid"),p&&(p.checked=!0,m&&(m.classList.remove("hidden"),m.style.display="block"))):o&&(o.classList.add("hidden"),o.style.display="none"),ce()}),p&&p.addEventListener("change",()=>{p.checked?m&&(m.classList.remove("hidden"),m.style.display="block"):m&&(m.classList.add("hidden"),m.style.display="none"),ce()});const u=h("stage-editor-programs-dropdown-trigger"),f=h("stage-editor-programs-dropdown-menu"),g=h("btn-stage-editor-programs-ok");u&&f&&(u.addEventListener("click",M=>{M.stopPropagation();const $=f.style.display==="none"||!f.style.display;f.style.display=$?"flex":"none"}),g&&g.addEventListener("click",M=>{M.stopPropagation(),f.style.display="none",ce()}),document.addEventListener("click",M=>{const $=M.target;f.style.display==="flex"&&!f.contains($)&&$!==u&&!u.contains($)&&(f.style.display="none",ce())}));const b=h("stage-editor-programs-list");b&&b.addEventListener("change",M=>{M.target.name==="stage-editor-program-selection"&&cm()});let y=!1,v=null;const T=h("stage-editor-stage-id"),w=h("stage-editor-race-id");if(T&&w){[T,w].forEach($=>{$.addEventListener("keydown",E=>{E.key!=="ArrowUp"&&E.key!=="ArrowDown"&&(y=!0,v&&clearTimeout(v))}),$.addEventListener("keyup",E=>{E.key!=="ArrowUp"&&E.key!=="ArrowDown"&&(v&&clearTimeout(v),v=setTimeout(()=>{y=!1},150))}),$.addEventListener("blur",()=>{y=!1})});const M=($,E)=>{const R=Number($.value);if(!Number.isInteger(R)||R<=0){E==="stage"?Nt=R:Pt=R;return}const C=R-(E==="stage"?Nt:Pt);if(!y&&(C===1||C===-1)){let D=R;E==="stage"?D=mm(R,C):h("stage-editor-new-race-checkbox").checked&&(D=pm(R,C)),$.value=String(D)}E==="stage"?Nt=Number($.value):Pt=Number($.value)};T.addEventListener("input",()=>{M(T,"stage"),ce()}),w.addEventListener("input",()=>{M(w,"race"),ce()})}}let at=[],Et=null,Ee={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const wt=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"];function sr(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill" title="Team">${o?St(o,p):""} <span>${S(p)}</span></span>
      ...
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonpunkte">${ee.seasonPoints} <span class="rider-stats-icon-pill-value">${M}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonplatzierung">${ee.rank} <span class="rider-stats-icon-pill-value">${Gm($)}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Renntage">${ee.raceDays} <span class="rider-stats-icon-pill-value">${E}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Siege">${ee.wins} <span class="rider-stats-icon-pill-value">${R}</span></span>
      </div>
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill rider-stats-summary-pill-heat" style="--rider-stats-pill-hue:124;--rider-stats-pill-border-alpha:0.44;--rider-stats-pill-bg-alpha:0.26; font-weight: 500;" title="Spezialisierung 1">${V} ${S(H)}</span>
        ...
        <span class="rider-stats-icon-pill rider-stats-summary-pill-heat" style="--rider-stats-pill-hue:6;--rider-stats-pill-border-alpha:0.26;--rider-stats-pill-bg-alpha:0.14; font-weight: 500;" title="Spezialisierung 3">${se} ${S(P)}</span>
        <span class="rider-stats-icon-pill" style="visibility: hidden;">&nbsp;</span>
      </div>
      <div class="rider-stats-header-col align-left">
        ${it(ee.stageRace,"Rundfahrten Punkte",B.stageRace,G)}
        ${it(ee.oneDay,"Eintagesrennen Punkte",B.oneDay,G)}
      ...
      <div class="rider-stats-header-col align-left">
        ${it(ee.flat,"Flach-Punkte",C.flat,D)}
        ${it(ee.hilly,"Hügel-Punkte",C.hilly,D)}
        ${it(ee.mediumMountain,"Mittelgebirge-Punkte",C.mediumMountain,D)}
      </div>
      <div class="rider-stats-header-col align-left">
        ${it(ee.mountain,"Hochgebirge-Punkte",C.mountain,D)}
        ${it(ee.timetrial,"Zeitfahren-Punkte",C.timetrial,D)}
        ${it(ee.cobble,"Kopfsteinpflaster-Punkte",C.cobble,D)}
      </div>
    </div>
  `}function In(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",s=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(s)}</strong>`}function ze(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </div>`}function jm(e){const t=[{score:55,hue:0,lightness:28},{score:60,hue:0,lightness:40},{score:68,hue:30,lightness:42},{score:74,hue:60,lightness:42},{score:80,hue:120,lightness:36}];let a=120,s=36;const r=Math.max(55,Math.min(80,e));for(let c=1;c<t.length;c++){const o=t[c-1],p=t[c];if(r<=p.score){const m=(r-o.score)/(p.score-o.score);a=Math.round(o.hue+(p.hue-o.hue)*m),s=Math.round(o.lightness+(p.lightness-o.lightness)*m);break}}return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${s}%;--stage-editor-score-bg-alpha:${.44};--stage-editor-score-border-alpha:${.72};`}">${e.toFixed(0)}</span>`}function Om(e,t){const a=(e==null?void 0:e.skills)??{mountain:60,hill:60,sprint:60,timeTrial:60,cobble:60,attack:60,mediumMountain:60,flat:60,prologue:60,acceleration:60},s=["mountain","hill","sprint","timeTrial","cobble","attack"],r=["Berg (MTN)","Hügel (HIL)","Sprint (SPR)","Zeitfahren (TT)","Pflaster (COB)","Angriff (ATT)"],n=540,i=440,l=n/2,c=i/2,o=160,p=60,m=85,u=m-p,f=B=>{const G=[];for(let H=0;H<6;H++){const x=H*Math.PI/3-Math.PI/2;G.push(`${l+B*Math.cos(x)},${c+B*Math.sin(x)}`)}return G},g=`
    <defs>
    ...
    </defs>`,b=`<circle cx="${l}" cy="${c}" r="${o+8}" fill="url(#radarBgGrad)" stroke="rgba(255,255,255,0.06)" stroke-width="1" />`;let y="";for(let B=p;B<=m;B+=2.5){const G=o*((B-p)/u);if(G<1){y+=`<circle cx="${l}" cy="${c}" r="2" fill="rgba(255,255,255,0.25)" />`;continue}const H=f(G),x=B%5===0,P=x?1:.6,V=x?"none":"4,4",K=x?.4:.18;y+=`<polygon points="${H.join(" ")}" fill="none" stroke="rgba(255,255,255,${K})" stroke-width="${P}" stroke-dasharray="${V}" />`,x&&B>p&&(y+=`<text x="${l+5}" y="${c-G+4}" fill="rgba(255,255,255,0.45)" font-size="9" font-family="Inter, sans-serif" text-anchor="start">${B}</text>`)}let v="",T="";for(let B=0;B<6;B++){const G=B*Math.PI/3-Math.PI/2,H=l+o*Math.cos(G),x=c+o*Math.sin(G);v+=`<line x1="${l}" y1="${c}" x2="${H}" y2="${x}" stroke="rgba(255,255,255,0.15)" stroke-width="1" />`;const P=o+28,V=l+P*Math.cos(G),K=c+P*Math.sin(G),se=Math.cos(G);let X="middle";se>.15?X="start":se<-.15&&(X="end");const ae=a[s[B]]??p;T+=`<text x="${V}" y="${K}" fill="rgba(255,255,255,0.92)" font-size="11.5" font-weight="700" font-family="Inter, sans-serif" text-anchor="${X}" dominant-baseline="middle">${r[B]}</text>`,T+=`<text x="${V}" y="${K+14}" fill="rgba(255,255,255,0.50)" font-size="10" font-weight="500" font-family="Inter, sans-serif" text-anchor="${X}" dominant-baseline="middle">${ae}</text>`}const w=[],M=[];s.forEach((B,G)=>{const H=a[B]??p,x=o*((Math.max(p,Math.min(m,H))-p)/u),P=G*Math.PI/3-Math.PI/2,V=l+x*Math.cos(P),K=c+x*Math.sin(P);w.push(`${V},${K}`),M.push(`<circle cx="${V}" cy="${K}" r="5" fill="#818cf8" stroke="#fff" stroke-width="2" filter="url(#dotGlow)"><title>${r[G]}: ${H}</title></circle>`)});const $=`<polygon points="${w.join(" ")}" fill="url(#riderFillGrad)" stroke="#818cf8" stroke-width="2.5" stroke-linejoin="round" filter="url(#radarGlow)" />`,R=[...[{key:"mountain",label:"Berg (MTN)"},{key:"hill",label:"Hügel (HIL)"},{key:"sprint",label:"Sprint (SPR)"},{key:"timeTrial",label:"Zeitfahren (TT)"},{key:"cobble",label:"Pflaster (COB)"},{key:"attack",label:"Angriff (ATT)"},{key:"mediumMountain",label:"Mittelgebirge (MDM)"},{key:"flat",label:"Flach (FLA)"},{key:"prologue",label:"Prolog (PRO)"},{key:"acceleration",label:"Beschleunigung (ACC)"}]].sort((B,G)=>{const H=a[B.key]??60;return(a[G.key]??60)-H}),L=[],C=[];R.forEach((B,G)=>{const H=a[B.key]??60,x=`
    ...
    `;G%2===0?L.push(x):C.push(x)});const D=`
  ...
  `}function Vm(e,t){const a=t.shortTermFatigueMalus??0,s=t.longTermFatigueDecayable??0,r=t.longTermFatigueLocked??0,n=t.longTermFatigueMalus??0,i=t.totalFatigueLoadMalus??0,l=(a/.2).toFixed(1).replace(".",","),c=(s/.01).toFixed(0);let o="#fff";t.shortTermFatigueWarning==="critical"?o="#ef4444":t.shortTermFatigueWarning==="warning"&&(o="#fbbf24");const p=t.fatigueHistory??[];let m="";return p.length===0?m='<tr><td colspan="6" class="text-center text-muted" style="padding: 2rem; color: #888;">Keine Erschöpfungshistorie für diesen Fahrer vorhanden.</td></tr>':m=p.map(u=>{const f=re(u.date);let g="";u.type==="race"?g=`${S(u.raceName)}${u.stageNumber!=null?` - Etappe ${u.stageNumber}`:""}`:g=u.raceName?S(u.raceName):"Regeneration";const b=u.type==="race"&&u.stageScore!=null?`<span class="badge" style="background: rgba(255,255,255,0.08); color: #fff; padding: 0.25rem 0.5rem; border-radius: 4px; font-weight: 600;">${u.stageScore.toFixed(0)}</span>`:'<span style="color: #666;">–</span>';let y="";u.shortChange>0?y=`<span style="color: #ef4444; font-weight: 600;">+${u.shortChange.toFixed(2).replace(".",",")}</span>`:u.shortChange<0?y=`<span style="color: #2ecc71; font-weight: 600;">${u.shortChange.toFixed(2).replace(".",",")}</span>`:y='<span style="color: #666;">0,00</span>';const v=[];if(u.longDecayableChange!==0){const M=u.longDecayableChange>0?"+":"",$=u.longDecayableChange>0?"#ef4444":"#2ecc71";v.push(`<span style="color: ${$}; font-weight: 500;">${M}${u.longDecayableChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Abbau.)</span></span>`)}if(u.longLockedChange!==0){const M=u.longLockedChange>0?"+":"",$=u.longLockedChange>0?"#a855f7":"#2ecc71";v.push(`<span style="color: ${$}; font-weight: 500;">${M}${u.longLockedChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Gesp.)</span></span>`)}const T=v.length>0?`<div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.1rem;">${v.join("")}</div>`:'<span style="color: #666;">0,00</span>',w=u.shortAfter+u.longAfter;return`
        <tr>
  ...
  `}function Um(e){var W;if(!e)return`
      ...
      </section>`;const a=(e.formHistory??[]).filter((F,N)=>N%2===0),s=((W=d.gameState)==null?void 0:W.currentDate)??new Date().toISOString(),r=a.length>0?new Date(a[a.length-1].date).getUTCFullYear():new Date(s).getUTCFullYear(),n=new Date(Date.UTC(r,0,1)).getTime(),i=864e5,l=1260,c=384,o=40,p=20,m=a.map(F=>{const I=(new Date(F.date).getTime()-n)/i,j=o+I/365*l,_=p+c-Math.min(8,Math.max(0,F.totalForm))/8*c;return{x:j,y:_,form:F.totalForm,date:F.date}});let u="",f="",g="";Ee.form&&m.length>0&&(u=`M ${m.map(F=>`${F.x},${F.y}`).join(" L ")}`,f=m.map(F=>`<circle cx="${F.x}" cy="${F.y}" r="3" fill="#fff" stroke="var(--accent-primary)" stroke-width="2"><title>${e.riderName} (${F.date}): ${F.form}</title></circle>`).join(""),g=`${u} L ${m[m.length-1].x},${p+c} L ${m[0].x},${p+c} Z`);let b="",y="";if(Ee.combinedFatigue&&m.length>0){const F=a.map(I=>{const _=(new Date(I.date).getTime()-n)/i,k=o+_/365*l,A=I.combinedFatigue??0,z=p+c-Math.min(15,Math.max(0,A))/15*c;return{x:k,y:z,val:A,date:I.date}});b=`<path d="${`M ${F.map(I=>`${I.x},${I.y}`).join(" L ")}`}" fill="none" stroke="#ef4444" stroke-width="2" />`,y=F.map(I=>`<circle cx="${I.x}" cy="${I.y}" r="3" fill="#fff" stroke="#ef4444" stroke-width="2"><title>Gesamtfatigue (${I.date}): ${I.val.toFixed(2)}</title></circle>`).join("")}let v="",T="";if(Ee.shortFatigue&&m.length>0){const F=a.map(I=>{const _=(new Date(I.date).getTime()-n)/i,k=o+_/365*l,A=I.shortFatigue??0,z=p+c-Math.min(15,Math.max(0,A))/15*c;return{x:k,y:z,val:A,date:I.date}});v=`<path d="${`M ${F.map(I=>`${I.x},${I.y}`).join(" L ")}`}" fill="none" stroke="#facc15" stroke-width="2" />`,T=F.map(I=>`<circle cx="${I.x}" cy="${I.y}" r="3" fill="#fff" stroke="#facc15" stroke-width="2"><title>Kurzzeitfatigue (${I.date}): ${I.val.toFixed(2)}</title></circle>`).join("")}let w="",M="";if(Ee.longFatigue&&m.length>0){const F=a.map(I=>{const _=(new Date(I.date).getTime()-n)/i,k=o+_/365*l,A=I.longFatigue??0,z=p+c-Math.min(15,Math.max(0,A))/15*c;return{x:k,y:z,val:A,date:I.date}});w=`<path d="${`M ${F.map(I=>`${I.x},${I.y}`).join(" L ")}`}" fill="none" stroke="#a855f7" stroke-width="2" />`,M=F.map(I=>`<circle cx="${I.x}" cy="${I.y}" r="3" fill="#fff" stroke="#a855f7" stroke-width="2"><title>Langzeitfatigue (${I.date}): ${I.val.toFixed(2)}</title></circle>`).join("")}const $="rgba(251, 191, 36, 0.15)";let E="";for(let F=0;F<=8;F+=2){const N=p+c-F/8*c;E+=`<line x1="${o}" y1="${N}" x2="${o+l}" y2="${N}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,E+=`<text x="${o-5}" y="${N+4}" fill="#ffffff" font-size="10" text-anchor="end">${F}</text>`}for(let F=0;F<=15;F+=3){const N=p+c-F/15*c;E+=`<text x="${o+l+5}" y="${N+4}" fill="#ef4444" font-size="10" text-anchor="start">${F}</text>`}let R="";for(let F=0;F<=52;F+=5){const N=o+F/52*l;E+=`<line x1="${N}" y1="${p}" x2="${N}" y2="${p+c}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,R+=`<text x="${N}" y="${p+c+15}" fill="#ffffff" font-size="10" text-anchor="middle">W${F}</text>`}let L="",C="";if(e.peakDates){const F=[...e.peakDates].sort((N,I)=>new Date(N).getTime()-new Date(I).getTime());for(let N=0;N<F.length;N++){const I=F[N],_=(new Date(I).getTime()-n)/i,k=o+_/365*l;L+=`<line x1="${k}" y1="${p}" x2="${k}" y2="${p+c}" stroke="#ffffff" stroke-width="2"><title>Peak: ${I}</title></line>`;const A=N>0?(new Date(F[N-1]).getTime()-n)/i:Number.NEGATIVE_INFINITY,z=_-56,U=A+14,pe=Math.max(0,Math.max(z,U)),Se=_-pe,Ie=o+pe/365*l,ke=Se/365*l;C+=`<rect x="${Ie}" y="${p}" width="${ke}" height="${c}" fill="rgba(16, 185, 129, 0.1)" />`;const qe=14/365*l;C+=`<rect x="${k}" y="${p}" width="${qe}" height="${c}" fill="rgba(239, 68, 68, 0.1)" />`}}const B=(new Date(s).getTime()-n)/i,G=o+B/365*l;L+=`<line x1="${G}" y1="${p}" x2="${G}" y2="${p+c}" stroke="#ef4444" stroke-width="3"><title>Heute: ${s}</title></line>`,at.forEach((F,N)=>{const I=wt[N%wt.length];F.peakDates&&F.peakDates.forEach(j=>{const k=(new Date(j).getTime()-n)/i,A=o+k/365*l;L+=`<line x1="${A}" y1="${p}" x2="${A}" y2="${p+c}" stroke="${I}" stroke-width="1.5" stroke-dasharray="3,3"><title>${F.riderName} Peak: ${j}</title></line>`})});let H="",x="";at.forEach((F,N)=>{const I=wt[N%wt.length],j=F.formHistory.filter((_,k)=>k%2===0).map(_=>{const A=(new Date(_.date).getTime()-n)/i,z=o+A/365*l,U=p+c-Math.min(8,Math.max(0,_.totalForm))/8*c;return{x:z,y:U,form:_.totalForm,date:_.date}});if(j.length>0){const _=`M ${j.map(k=>`${k.x},${k.y}`).join(" L ")}`;H+=`<path d="${_}" fill="none" stroke="${I}" stroke-width="2" />`,x+=j.map(k=>`<circle cx="${k.x}" cy="${k.y}" r="3" fill="#fff" stroke="${I}" stroke-width="2"><title>${F.riderName} (${k.date}): ${k.form}</title></circle>`).join("")}});const P=d.teams.filter(F=>F.division==="WorldTour"||F.divisionName==="WorldTour");let V='<option value="">-- Team auswählen --</option>';for(const F of P){const N=Et===F.id?" selected":"";V+=`<option value="${F.id}"${N}>${S(F.name)}</option>`}let K='<option value="">-- Fahrer auswählen --</option>';if(Et!=null){const F=d.riders.filter(N=>N.activeTeamId===Et&&N.id!==e.riderId&&!at.some(I=>I.riderId===N.id));for(const N of F)K+=`<option value="${N.id}">${S(N.firstName)} ${S(N.lastName)}</option>`}const se=`
  ...
  `,X=e.currentSeasonRank??Za(e.riderId)??"–",ae=[`
    ...
    `];at.forEach((F,N)=>{const I=wt[N%wt.length],j=F.currentSeasonRank??Za(F.riderId)??"–";ae.push(`
      <div style="display: flex; align-items: center; justify-content: space-between; gap: 0.5rem; margin-bottom: 0.50rem; padding: 0.25rem 0; border-top: 1px solid rgba(255,255,255,0.05);">
        <div style="display: flex; align-items: center; gap: 0.5rem; min-width: 0;">
          ...
          <span style="font-size: 0.9rem; color: var(--text-300); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="${S(F.riderName)} (${F.currentSeasonPoints}/${j})">${S(F.riderName)} <span style="color: var(--text-500);">(${F.currentSeasonPoints}/${j})</span></span>
        </div>
        <button type="button" class="compare-remove-btn" data-remove-compare-id="${F.riderId}" style="background: none; border: none; color: #ef4444; cursor: pointer; font-size: 1.1rem; line-height: 1; padding: 0 0.25rem; font-weight: bold; display: flex; align-items: center;" title="Vergleich entfernen">×</button>
      </div>
    `)});const Y=`
  ...
  `}function Tt(e,t){return`<span class="rider-stats-rank-badge rider-stats-rank-badge-${t}">${S(e)}</span>`}function Zm(e){return!e.isBreakaway||e.rowType!=="stage_result"||e.finishStatus!=="classified"?"–":'<span class="rider-stats-breakaway-icon" aria-label="Ausreißer" title="Ausreißer"><svg class="rider-stats-icon" viewBox="0 0 24 24" style="fill:#ef4444; width:1em; height:1em; vertical-align:middle;"><path d="M12 21L2 3h20L12 21z"/></svg></span>'}function Jm(e){return e.finishStatus==="otl"?Tt("OTL","place"):e.finishStatus==="dnf"?Tt("DNF","place"):e.resultRank==null?"–":`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${e.resultRank<=3?` rider-stats-rank-badge-top-${e.resultRank}`:""}">${S(String(e.resultRank))}</span>`}function qm(e){return e.finishStatus!=="classified"||e.gcRank==null?"–":Tt(String(e.gcRank),"gc")}function Xm(e){return e.finishStatus==="otl"?Is(e.statusReason,!0):e.finishStatus==="dnf"?Is(e.statusReason,!1):e.stageTimeSeconds!=null?`${e.resultLabel} · ${Ba(e.stageTimeSeconds)}`:e.resultLabel}function Le(e,t,a=!1){var l,c;const s=(e==null?void 0:e.activeTeamId)!=null?((l=d.teams.find(o=>o.id===e.activeTeamId))==null?void 0:l.name)??null:null,r=((c=e==null?void 0:e.country)==null?void 0:c.code3)??(e==null?void 0:e.nationality)??null,n=r?ie(r):"",i=t==null?[]:[...t.seasons].map(o=>({...o,raceBlocks:Wm(o.raceBlocks)})).sort((o,p)=>p.season-o.season);return a?`
    ...
    ${i.map(o=>`
      <section class="rider-stats-season">
        <div class="rider-stats-season-head">
          <h3>Saison ${o.season}</h3>
          <span>${o.raceBlocks.length} Rennen</span>
        </div>
            ...
            <section class="rider-stats-race-block">
              ...
              <div class="dashboard-race-stages-table-wrap rider-stats-table-wrap">
                <table class="data-table rider-stats-table">
                  ...
                  <tbody>
                    ${p.rows.map(m=>{const u=m.rowType!=="stage_result",f=u?`${m.raceName} · ${nr(m.rowType)}`:m.stageName?`${m.raceName} · ${m.stageName}`:m.raceName;return`
                        <tr class="rider-stats-row${u?" rider-stats-row-final":""}">
                          <td>${S(re(m.date))}</td>
                          <td>${Jm(m)}</td>
                          <td>${qm(m)}</td>
                          <td class="rider-stats-breakaway-col">${Zm(m)}</td>
                          <td>${u?"":sr(m.rolledWeatherId,m.rolledWetterName)}</td>
      ...
      <section class="rider-stats-placeholder">
        <h3>Keine Historie vorhanden</h3>
        <p>Für diesen Fahrer wurden in der aktuellen Karriere noch keine Ergebnisse gefunden.</p>
      </section>`}function Ls(){const e=document.querySelector(".rider-stats-modal-card");if(!e)return;["results","topResults","career","form","fatigue"].includes(d.riderStatsTab)?(e.style.minWidth="min(1475px, 95vw)",e.style.maxWidth="1687px"):(e.style.minWidth="",e.style.maxWidth="")}async function _t(e){var c,o,p,m;const t=$e(e),a=(t==null?void 0:t.activeTeamId)!=null?((c=d.teams.find(u=>u.id===t.activeTeamId))==null?void 0:c.name)??null:null;at=[],Et=null,d.riderStatsSelectedRiderId=e,d.riderStatsTab="results",Ls(),d.riderStatsTopResultsFilterCategory=null,d.riderStatsTopResultsFilterSeason=null,d.riderStatsTopResultsPage=1,h("rider-stats-title").innerHTML=In(t,null),h("rider-stats-jersey").innerHTML="";const s=t!=null&&t.age?` · Alter ${t.age}`:"";h("rider-stats-meta").textContent=t?`${((o=t.role)==null?void 0:o.name)??"Fahrer"} · ${a??"Team unbekannt"}${s}`:"Historie wird geladen",h("rider-stats-body").innerHTML=Le(t,null,!0),Ve("riderStats");const r=await O.getRiderStats(e);if(d.riderStatsSelectedRiderId!==e)return;if(!r.success||!r.data){const u=t!=null&&t.age?` · Alter ${t.age}`:"";h("rider-stats-meta").textContent=t?`${((p=t.role)==null?void 0:p.name)??"Fahrer"} · ${a??"Team unbekannt"}${u}`:"Fehler beim Laden",h("rider-stats-body").innerHTML=`
      <section class="rider-stats-placeholder">
        <h3>Historie konnte nicht geladen werden</h3>
        <p>${S(r.error??"Unbekannter Fehler")}</p>
      </section>`;return}d.riderStatsPayload=r.data,Ls(),h("rider-stats-title").innerHTML=In(t,r.data),h("rider-stats-jersey").innerHTML="";const n=r.data.age?` · Alter ${r.data.age}`:t!=null&&t.age?` · Alter ${t.age}`:"",i=r.data.mentorName?` · Mentor: ${r.data.mentorName}`:"",l=r.data.mentoredRiderNames&&r.data.mentoredRiderNames.length>0?` · Mentor von: ${r.data.mentoredRiderNames.join(" - ")}`:"";h("rider-stats-meta").textContent=`${((m=t==null?void 0:t.role)==null?void 0:m.name)??"Fahrer"} · ${r.data.teamName??a??"Ohne aktives Team"}${n} · ${r.data.seasons.length} Saisons${i}${l}`,h("rider-stats-body").innerHTML=Le(t,r.data,!1)}function Qm(){h("rider-stats-body").addEventListener("click",e=>{var r;if(e.target&&e.target.id&&e.target.id.startsWith("toggle-chart-")){const n=e.target.id,i=e.target.checked;n==="toggle-chart-form"?Ee.form=i:n==="toggle-chart-combined-fatigue"?Ee.combinedFatigue=i:n==="toggle-chart-short-fatigue"?Ee.shortFatigue=i:n==="toggle-chart-long-fatigue"&&(Ee.longFatigue=i);const l=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(l,d.riderStatsPayload,!1);return}const t=e.target.closest("button[data-rider-stats-tab]");if(!t){const n=e.target.closest("button[data-remove-compare-id]");if(n){const c=Number(n.dataset.removeCompareId);at=at.filter(p=>p.riderId!==c);const o=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(o,d.riderStatsPayload,!1);return}const i=e.target.closest("button[data-top-results-page]");if(i){const c=Number(i.dataset.topResultsPage);if(!isNaN(c)&&c>=1){d.riderStatsTopResultsPage=c;const o=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(o,d.riderStatsPayload,!1)}return}const l=e.target.closest("button[data-stage-profile-id]");if(l){const c=Number(l.dataset.stageProfileId);Number.isFinite(c)&&qa(c);return}return}const a=t.dataset.riderStatsTab;if(a!=="results"&&a!=="program"&&a!=="form"&&a!=="topResults"&&a!=="skills"&&a!=="career"&&a!=="fatigue"||a==="program"&&(((r=d.riderStatsPayload)==null?void 0:r.programRaces.length)??0)===0)return;d.riderStatsTab=a,Ls();const s=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(s,d.riderStatsPayload,!1)}),h("rider-stats-body").addEventListener("change",async e=>{const t=e.target;if(t.id==="rider-stats-filter-category"){d.riderStatsTopResultsFilterCategory=t.value==="all"?null:t.value,d.riderStatsTopResultsPage=1;const a=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(a,d.riderStatsPayload,!1)}else if(t.id==="rider-stats-filter-season"){d.riderStatsTopResultsFilterSeason=t.value==="all"?null:Number(t.value),d.riderStatsTopResultsPage=1;const a=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(a,d.riderStatsPayload,!1)}else if(t.classList.contains("rider-stats-filter-checkbox")){const a=t.dataset.filterType;d.riderStatsTopResultsFilters[a]=t.checked,d.riderStatsTopResultsPage=1;const s=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(s,d.riderStatsPayload,!1)}else if(t.id==="rider-compare-team-select"){const a=t.value;Et=a?Number(a):null;const s=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(s,d.riderStatsPayload,!1)}else if(t.id==="rider-compare-rider-select"){const a=t.value;if(a){const s=Number(a);if(at.length>=10){alert("Sie können maximal 10 Fahrer vergleichen."),t.value="";return}const r=await O.getRiderStats(s,!0);r.success&&r.data?at.push({riderId:r.data.riderId,riderName:r.data.riderName,teamId:r.data.teamId,teamName:r.data.teamName,formHistory:r.data.formHistory??[],peakDates:r.data.peakDates??[],currentSeasonPoints:r.data.currentSeasonPoints??0,currentSeasonRank:r.data.currentSeasonRank??null}):alert("Formverlauf konnte nicht geladen werden: "+(r.error??""));const n=$e(d.riderStatsSelectedRiderId);h("rider-stats-body").innerHTML=Le(n,d.riderStatsPayload,!1)}}})}function Rn(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?0:t.includes("grand tour")?1:t.includes("monument")?2:t.includes("stage race high")?3:t.includes("one day high")?4:t.includes("stage race middle")?5:t.includes("one day middle")?6:t.includes("stage race low")?7:t.includes("one day low")?8:9}function ep(e){const t=[];for(const g of e.seasons)for(const b of g.raceBlocks)for(const y of b.rows)t.push({...y,season:g.season,isStageRace:b.isStageRace});const a=Array.from(new Set(t.map(g=>g.raceCategoryName).filter(Boolean)));a.sort((g,b)=>g.localeCompare(b,"de"));const s=Array.from(new Set(t.map(g=>g.season))).sort((g,b)=>b-g);let r=t.filter(g=>g.rowType!=="stage_result"?g.rowType==="gc_final"?d.riderStatsTopResultsFilters.gc:g.rowType==="mountain_final"?d.riderStatsTopResultsFilters.mountain:g.rowType==="points_final"?d.riderStatsTopResultsFilters.points:g.rowType==="youth_final"?d.riderStatsTopResultsFilters.youth:!0:g.isStageRace?d.riderStatsTopResultsFilters.stage:d.riderStatsTopResultsFilters.oneDay);if(d.riderStatsTopResultsFilterCategory){const g=d.riderStatsTopResultsFilterCategory;if(g.endsWith("-etappen")){const b=g.substring(0,g.length-8);r=r.filter(y=>y.raceCategoryName===b&&y.rowType==="stage_result")}else if(g.endsWith("-gc")){const b=g.substring(0,g.length-3);r=r.filter(y=>y.raceCategoryName===b&&y.rowType!=="stage_result")}else r=r.filter(b=>b.raceCategoryName===g)}d.riderStatsTopResultsFilterSeason!=null&&(r=r.filter(g=>g.season===d.riderStatsTopResultsFilterSeason)),r.sort((g,b)=>{if(b.seasonPoints!==g.seasonPoints)return b.seasonPoints-g.seasonPoints;const y=g.rowType!=="stage_result",v=b.rowType!=="stage_result",T=g.resultRank??9999,w=b.resultRank??9999;if(d.riderStatsTopResultsFilterCategory)return T!==w?T-w:y!==v?y?-1:1:0;{const M=Rn(g.raceCategoryName),$=Rn(b.raceCategoryName);return M!==$?M-$:y!==v?y?-1:1:T-w}});const n=200,i=r.slice(0,1e3),l=Math.max(1,Math.ceil(i.length/n));d.riderStatsTopResultsPage>l&&(d.riderStatsTopResultsPage=l);const c=(d.riderStatsTopResultsPage-1)*n,o=i.slice(c,c+n),m=`
  ...
  `}function tp(e){const t=e.careerStats||{breakawayAttempts:0,attacks:0,counterAttacks:0,crashes:0,defects:0,illnesses:0,illnessDays:0,injuries:0,injuryDays:0,dnsCount:0,dnfCount:0,otlCount:0,successfulBreakaways:0,superteamCount:0,categories:{}},a=(e.careerRaceDaysBySeason||[]).reduce((n,i)=>{const l=i.raceDays??i.race_days??i.racedays??0;return n+Number(l)},0),s=(n,i,l,c)=>{const o=typeof n=="number"?n:parseFloat(String(n))||0;let p="padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.8rem; font-weight: bold; min-width: 1.8rem; text-align: center; display: inline-block; box-sizing: border-box;";return o===0?p+="background: rgba(255, 255, 255, 0.05); color: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.1);":i==="gold"?p+="background: linear-gradient(135deg, #ffd700, #ffa500); color: #000; box-shadow: 0 0 5px rgba(255, 215, 0, 0.4); text-shadow: 0 0 1px rgba(255,255,255,0.3);":i==="silver"?p+="background: linear-gradient(135deg, #e5e7eb, #9ca3af); color: #000; box-shadow: 0 0 5px rgba(229, 231, 235, 0.4);":i==="bronze"?p+="background: linear-gradient(135deg, #d35400, #a04000); color: #fff; box-shadow: 0 0 5px rgba(211, 84, 0, 0.4);":i==="purple"?p+="background: linear-gradient(135deg, #a855f7, #7e22ce); color: #fff; box-shadow: 0 0 5px rgba(168, 85, 247, 0.4);":i==="green"?p+="background: #2ecc71; color: #fff; box-shadow: 0 0 5px rgba(46, 204, 113, 0.4);":i==="red"?p+="background: #e74c3c; color: #fff; box-shadow: 0 0 5px rgba(231, 76, 60, 0.4);":i==="white"?p+="background: #ffffff; color: #000; border: 1px solid #ccc; box-shadow: 0 0 5px rgba(255, 255, 255, 0.4);":i==="breakaway"&&(p+="background: linear-gradient(135deg, #7c3aed, #a855f7); color: #fff; box-shadow: 0 0 5px rgba(168, 85, 247, 0.4);"),`<span style="${p}" title="${S(l)}">${n}</span>`},r=[{key:"World Tour - Tour de France",name:"Tour de France",isStage:!0},{key:"World Tour - Grand Tour",name:"Grand Tour",isStage:!0},{key:"World Tour - Monument",name:"Monumente",isStage:!1},{key:"World Tour - Stage Race High",name:"Stage Race (High)",isStage:!0},{key:"World Tour - Stage Race Middle",name:"Stage Race (Middle)",isStage:!0},{key:"World Tour - Stage Race Low",name:"Stage Race (Low)",isStage:!0},{key:"World Tour - One Day High",name:"One Day (High)",isStage:!1},{key:"World Tour - One Day Middle",name:"One Day (Middle)",isStage:!1},{key:"World Tour - One Day Low",name:"One Day (Low)",isStage:!1}];return`
...
`+s.error);return}d.stageResults=s.data??null,d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId,d.selectedResultTypeId=((r=d.stageResults.classifications[0])==null?void 0:r.resultTypeId)??1,d.selectedResultsMarkerKey=We,d.selectedResultsSpecialView=null),d.selectedResultsRaceId!=null&&co(d.selectedResultsRaceId),Te()}async function co(e){if(!d.seasonStandings){const a=await O.getSeasonStandings();a.success&&a.data&&(d.seasonStandings=a.data)}const t=await O.getRaceResultsRoster(e);t.success&&t.data?d.resultsRoster=t.data:d.resultsRoster=null}function cp(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function Cn(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function up(){const e=d.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=ct(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=[...e.entries].sort((y,v)=>v.overallRating-y.overallRating),r=new Set(s.slice(0,5).map(y=>y.riderId)),n=y=>{var T;const v=d.riders.find(w=>w.id===y);return((T=v==null?void 0:v.skills)==null?void 0:T.sprint)??0},l=[...e.entries.filter(y=>!r.has(y.riderId))].sort((y,v)=>{const T=n(y.riderId),w=n(v.riderId);return w!==T?w-T:v.overallRating-y.overallRating}),c=new Set(l.slice(0,5).map(y=>y.riderId));function o(y){switch(y){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return y}}const p=new Map;for(const y of e.entries){const v=y.teamId;p.has(v)||p.set(v,{teamId:y.teamId,teamName:y.teamName,riders:[],avgRating:0}),p.get(v).riders.push(y)}for(const y of p.values())y.avgRating=y.riders.reduce((v,T)=>v+T.overallRating,0)/y.riders.length;const m=y=>{let v=Number.POSITIVE_INFINITY;for(const T of y)!T.hasDropped&&T.gcRank!=null&&T.gcRank<v&&(v=T.gcRank);return v},u=y=>{var T;if(!((T=d.seasonStandings)!=null&&T.riderStandings))return 0;let v=0;for(const w of y){const M=d.seasonStandings.riderStandings.find($=>$.riderId===w.riderId);M&&M.points>v&&(v=M.points)}return v},f=y=>{if(y==null)return 0;const v=d.riders.filter(M=>M.activeTeamId===y);if(v.length===0)return 0;const T=v.map(M=>M.overallRating??0);T.sort((M,$)=>$-M);const w=T.slice(0,10);return w.length===0?0:w.reduce((M,$)=>M+$,0)/w.length},g=[...p.values()].sort((y,v)=>{const T=m(y.riders),w=m(v.riders);if((T!==Number.POSITIVE_INFINITY||w!==Number.POSITIVE_INFINITY)&&T!==w)return T-w;const M=u(y.riders),$=u(v.riders);if((M>0||$>0)&&M!==$)return $-M;const E=f(y.teamId),R=f(v.teamId);return Math.abs(E-R)>1e-4?R-E:(y.teamName??"").localeCompare(v.teamName??"","de")});for(const y of g)y.riders.sort((v,T)=>Cn(v.roleId)-Cn(T.roleId)||T.overallRating-v.overallRating||v.lastName.localeCompare(T.lastName,"de"));return`<div class="results-roster-grid">${g.map(y=>{const v=y.teamId!=null?St(y.teamId,y.teamName):"",T=y.riders.map(M=>{var W;const $=cp(M.roleId),E=M.countryCode?je[M.countryCode]??M.countryCode.slice(0,2).toLowerCase():null,R=E?`<span class="fi fi-${E} results-roster-flag" title="${S(M.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',L=`${M.firstName.charAt(0)}. ${M.lastName}`,C=M.roleName??"–",D=M.specialization1?o(M.specialization1):null,B=M.specialization2?o(M.specialization2):null;let G=C;D&&(G+=` · ${D}`),B&&(G+=` · ${B}`);const H=`<span class="results-roster-overall-badge" style="color:${mp(M.overallRating)}" title="Gesamtstärke: ${M.overallRating.toFixed(2)}">${M.overallRating.toFixed(2)}</span>`,x=M.hasDropped?" dropped":"";let P="";M.hasDropped?M.dropoutStatus==="dns"?P="DNS":M.dropoutStatus==="dnf"?P=((W=M.dropoutReason)==null?void 0:W.startsWith("OTL"))??!1?"OTL":"DNF":P="OUT":M.gcRank!=null&&(P=`${M.gcRank}`);let V="";if(M.hasDropped)V=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(M.dropoutReason||"")}">${P}</span>`;else if(M.gcRank!=null){let F="rider-stats-rank-badge-gc";M.gcRank===1?F="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":M.gcRank===2?F="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":M.gcRank===3&&(F="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),V=`<span class="rider-stats-rank-badge ${F}" title="GC Stand: Platz ${M.gcRank}">${M.gcRank}</span>`}const se=`style="color: ${M.hasDropped?"var(--text-500)":$.color}; font-weight: bold;"`,X=r.has(M.riderId),ae=c.has(M.riderId);return`<div class="results-roster-rider${x}">
  ...
  `}function Nn(e){const t=e.title||"";return t.includes("guten Tag")?1:t.includes("schlechten Tag")?2:t.includes("Formhöhepunkt")||t.includes("Formhoehepunkt")?3:t.includes("nicht am Start")?4:5}function Na(e){var m,u,f,g,b,y,v,T,w,M;if(e==null||!d.stageResults)return"";const t=ct(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,s=d.stageResults.classifications,r=(u=(m=s.find($=>$.resultTypeId===Fa))==null?void 0:m.rows.find($=>$.rank===1))==null?void 0:u.riderId,n=(g=(f=s.find($=>$.resultTypeId===ws))==null?void 0:f.rows.find($=>$.rank===1))==null?void 0:g.riderId,i=(y=(b=s.find($=>$.resultTypeId===Qn))==null?void 0:b.rows.find($=>$.rank===1))==null?void 0:y.riderId,l=(T=(v=s.find($=>$.resultTypeId===5))==null?void 0:v.rows.find($=>$.rank===1))==null?void 0:T.riderId,c=(M=(w=s.find($=>$.resultTypeId===7))==null?void 0:w.rows.find($=>$.rank===1))==null?void 0:M.riderId,o=[],p=d.selectedResultTypeId;return e===r&&(p===Fa||p===1&&a||p!==1&&p!==Fa)&&o.push('<span class="jersey-dot jersey-dot-yellow" title="Gelbes Trikot (Gesamtwertung)"></span>'),e===n&&o.push('<span class="jersey-dot jersey-dot-green" title="Grünes Trikot (Punktewertung)"></span>'),e===i&&o.push('<span class="jersey-dot jersey-dot-red" title="Rotes Trikot (Bergwertung)"></span>'),e===l&&o.push('<span class="jersey-dot jersey-dot-white" title="Weißes Trikot (Nachwuchswertung)"></span>'),e===c&&o.push('<span class="jersey-dot jersey-dot-purple" title="Ausreißertrikot (Aktivste Fahrer)"></span>'),o.length===0?"":`<span class="jersey-dots-wrapper">${o.join("")}</span>`}function Pn(e){if(!e)return"";let t=e;const a=[],s=[...d.riders].sort((n,i)=>{const l=`${n.firstName} ${n.lastName}`;return`${i.firstName} ${i.lastName}`.length-l.length});for(const n of s){const l=`${n.firstName} ${n.lastName}`.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"),c=new RegExp(`${l}(\\s+\\(\\d+\\.\\))?`,"g");c.test(t)&&(t=t.replace(c,o=>{const p=`__RIDER_LINK_${a.length}__`,m=Fe(o,{riderId:n.id,teamId:n.activeTeamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return a.push(m),p}))}let r=S(t);for(let n=0;n<a.length;n++)r=r.replace(`__RIDER_LINK_${n}__`,a[n]);return r}function Te(){var N,I,j,_;d.riders.length===0&&O.getRiders().then(k=>{k.success&&k.data&&(d.riders=k.data,Te())});const e=h("results-race-select"),t=h("results-stage-select"),a=h("results-type-tabs"),s=h("results-marker-tabs"),r=h("results-stage-meta"),n=h("results-empty"),i=h("results-table"),l=i.querySelector("thead tr"),c=h("results-tbody"),o=h("results-marker-classifications"),p=h("results-roster"),m=i.querySelector("colgroup");m&&m.remove(),i.style.tableLayout="",d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId),e.innerHTML='<option value="">– Rennen auswählen –</option>'+d.races.filter(k=>{var A;return(((A=k.stages)==null?void 0:A.length)??0)>0}).map(k=>`<option value="${k.id}"${k.id===d.selectedResultsRaceId?" selected":""}>${S(k.name)}</option>`).join("");const u=ct(d.selectedResultsRaceId),f=u==null?"":(u.stages??[]).map(k=>`<option value="${k.id}"${k.id===d.selectedResultsStageId?" selected":""}>${S(dp(u,k))}</option>`).join("");t.innerHTML='<option value="">– Etappe auswählen –</option>'+f;const g=((N=d.stageResults)==null?void 0:N.classifications.filter(k=>!(u&&!u.isStageRace&&k.resultTypeId!==1&&k.resultTypeId!==6)))??[],b=g.find(k=>k.resultTypeId===d.selectedResultTypeId)??g[0]??null,y=d.selectedResultsSpecialView==="nonFinishers",v=d.selectedResultsSpecialView==="events",T=d.selectedResultsSpecialView==="roster";if(b&&!y&&!v&&!T&&(d.selectedResultTypeId=b.resultTypeId),v){i.style.tableLayout="fixed";const k=document.createElement("colgroup");k.innerHTML=`
      <col style="width: 100px;">
      <col style="width: 240px;">
      <col style="width: auto;">
    `,i.insertBefore(k,i.firstChild)}if(!d.stageResults&&!T||!b&&!y&&!v&&!T){const k=_a(d.selectedResultsStageId);r.textContent=k?`${k.race.name} · ${k.stage.profile} · ${re(k.stage.date)}`:"Noch keine Etappe ausgewählt.",a.innerHTML="",s.innerHTML="",s.classList.add("hidden"),c.innerHTML="",o.innerHTML="",o.classList.add("hidden"),i.classList.add("hidden"),p.innerHTML="",p.classList.add("hidden"),n.classList.remove("hidden"),n.textContent=d.selectedResultsStageId!=null?"Für diese Etappe liegen noch keine Ergebnisse vor.":"Noch keine Ergebnisse geladen.";return}T?d.resultsRoster&&(r.textContent=`${d.resultsRoster.raceName} · Starterfeld`):d.stageResults&&(r.textContent=`${d.stageResults.raceName} · Etappe ${d.stageResults.stageNumber} · ${d.stageResults.profile} · ${re(d.stageResults.date)}`);const w=d.stageResults?_a(d.stageResults.stageId):null,M=(w==null?void 0:w.stage.distanceKm)??null,$=new Map,E=new Map,R=new Map;if(d.stageResults){const k=d.stageResults.classifications.find(A=>A.resultTypeId===1);if(k)for(const A of k.rows)A.riderId!=null&&A.points!=null&&A.points>0&&$.set(A.riderId,A.points),A.riderId!=null&&A.breakawayKms!=null&&A.breakawayKms>0&&R.set(A.riderId,A.breakawayKms);if(d.stageResults.markerClassifications){for(const A of d.stageResults.markerClassifications)if(or(A.markerType,A.markerCategory)){for(const z of A.entries)if(z.riderId!=null&&z.pointsAwarded!=null&&z.pointsAwarded>0){const U=E.get(z.riderId)??0;E.set(z.riderId,U+z.pointsAwarded)}}}}const L=(b==null?void 0:b.resultTypeId)===Fa,C=(b==null?void 0:b.resultTypeId)===ws||(b==null?void 0:b.resultTypeId)===Qn,D=(b==null?void 0:b.resultTypeId)===5,B=(b==null?void 0:b.resultTypeId)===6,G=(b==null?void 0:b.resultTypeId)===7,H=L||C||D||B||G,x=g.map(k=>`
    <button
      type="button"
  ...
  `,K=`
    ...
    >Teilnehmer</button>
  `,se=g.findIndex(k=>k.resultTypeName.toLocaleLowerCase("de").includes("team"));se>=0?x.splice(se+1,0,P,V,K):x.push(P,V,K),a.innerHTML=x.join("");const X=ip(((I=d.stageResults)==null?void 0:I.markerClassifications)??[]);if(T){p.innerHTML=up(),p.classList.remove("hidden"),i.classList.add("hidden"),s.innerHTML="",s.classList.add("hidden"),o.innerHTML="",o.classList.add("hidden"),n.classList.add("hidden");return}else p.innerHTML="",p.classList.add("hidden");const ae=!y&&!v&&!T&&(b==null?void 0:b.resultTypeId)===1&&X.length>0,Y=ae?d.selectedResultsMarkerKey??We:null,W=ae&&Y!==We?X.find(k=>k.markerKey===Y)??null:null;if(ae&&(d.selectedResultsMarkerKey=(W==null?void 0:W.markerKey)??We),v){const k=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"},{key:"superteam",label:"Superteam"}];s.innerHTML=k.map(A=>`
      <button
        type="button"
    ...
    `).join("")}else s.innerHTML=ae?[`
        ...
        >${S(op(k))}</button>
      `)].join(""):"";s.classList.toggle("hidden",!v&&!ae);const F=y||v||!ae||d.selectedResultsMarkerKey===We;if(l&&F&&(l.innerHTML=y?`
        <th>Etappe</th>
        <th>Status</th>
      ...
      `:C?`
        ...
        <th class="results-points-cell">Punktewertung</th>
        <th>UCI Punkte</th>
      `),c.innerHTML=y?(((j=d.stageResults)==null?void 0:j.nonFinishers)??[]).map(k=>`
      <tr>
        <td>${k.stageNumber}</td>
        <td>${qo(k.isOtl)}</td>
    ...
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':v?[...((_=d.stageResults)==null?void 0:_.events)??[]].filter(k=>Re==="all"?!0:Re==="form"?!!(k.title&&(k.title.includes("guten Tag")||k.title.includes("schlechten Tag")||k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))):Re==="attack"?(k.type==="attack"||k.type==="counter_attack")&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Re==="breakaway"?!!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Re==="incident"?(k.type==="incident"||!!(k.title&&k.title.includes("Massensturz")))&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Re==="exit"?k.type==="dnf"||!!(k.title&&k.title.includes("nicht am Start")):Re==="home"?!!(k.title&&(k.title.includes("Heimvorteil")||k.title.includes("Heimdruck"))):Re==="weather"?!!(k.title&&k.title.startsWith("Wetterbericht:")):Re==="superteam"?k.type==="superteam":!0).sort((k,A)=>{const z=k.kmMark??0,U=A.kmMark??0;if(Math.abs(z-U)>1e-4)return z-U;if(z===0){const Ie=Nn(k),ke=Nn(A);if(Ie!==ke)return Ie-ke}const pe=k.riderName??"",Se=A.riderName??"";return pe.localeCompare(Se,"de")}).map(k=>{var Mr,xr,wr;const A=k.kmMark!=null?`${k.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",z=k.riderId,U=z!=null?$e(z):null,pe=k.riderTeamId??(U==null?void 0:U.activeTeamId)??null,Se=pe!=null?((Mr=d.teams.find(pa=>pa.id===pe))==null?void 0:Mr.name)??null:null;let Ie=jt(pe,Se);const ke=!!(k.title&&k.title.startsWith("Wetterbericht:"));let qe=k.title||"";if(ke){const pa=(xr=d.stageResults)==null?void 0:xr.rolledWeatherId,ds=(wr=d.stageResults)==null?void 0:wr.rolledWetterName;Ie=`<span class="results-jersey-cell">${sr(pa,ds)}</span>`,ds&&(qe=`Wetterbericht: ${ds}`)}const Ht=k.type==="superteam",Ge=Ht&&z==null,zt=ke||Ge?"":tt(z!=null?Ft(z):null),ma=ke?"":Ge?et(Se||"–",pe):z!=null?Ot(k.riderName??"",!0,!1,z,pe):S(k.riderName||"–");let me="";return k.title&&k.title.includes("guten Tag")?me='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':k.title&&k.title.includes("schlechten Tag")?me='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':k.title&&(k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))?me='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':k.title&&k.title.includes("nicht am Start")?me='<span class="event-badge event-badge-dns">DNS</span>':k.title&&k.title.includes("Massensturz")?me='<span class="event-badge event-badge-masscrash">Massensturz</span>':k.type==="dnf"?me='<span class="event-badge event-badge-dnf">DNF</span>':k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))?me='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':k.type==="attack"?me='<span class="event-badge event-badge-attack">Attacke</span>':k.type==="counter_attack"?me='<span class="event-badge event-badge-counter">Konterattacke</span>':k.type==="incident"?k.title&&(k.title.toLowerCase().includes("defekt")||k.title.toLowerCase().includes("panne")||k.title.toLowerCase().includes("technisch"))?me='<span class="event-badge event-badge-defect">Defekt</span>':me='<span class="event-badge event-badge-crash">Sturz</span>':k.title&&k.title.includes("Super-Heimvorteil")?me='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Heimbonus</span>':k.title&&k.title.includes("Heimdruck")?me='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimmalus</span>':k.title&&k.title.includes("Heimvorteil")?me='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':k.title&&k.title.startsWith("Wetterbericht:")?me='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>':Ht&&(me='<span class="event-badge event-badge-superteam"><span class="event-icon">⚡</span> Superteam</span>'),`
          ...
          </tr>`}).join("")||'<tr><td colspan="3" class="results-empty-cell">Keine Ereignisse für diese Etappe.</td></tr>':F&&b?b.rows.map(k=>{const A=k.riderName??k.teamName,z=k.riderName?k.teamName:"–",U=jt(k.teamId,k.teamName),pe=Ot(A,!0,k.isBreakaway===!0,k.riderId,k.teamId),Se=tt(Ft(k.riderId)),Ie=b.resultTypeId===1&&k.rank===1&&k.timeSeconds!=null&&M!=null,ke=k.timeSeconds!=null?`${Ba(k.timeSeconds)}${Ie?` (${lp(M,k.timeSeconds)})`:""}`:"–",qe=H?`<td class="results-gc-delta-cell">${Xo(k.previousRank,k.rankDelta)}</td>`:"";if(C){let Ge=k.points!=null?String(k.points):"–";if(k.points!=null&&k.riderId!=null&&b){const ma=b.resultTypeId===ws?$.get(k.riderId)??0:E.get(k.riderId)??0;ma>0&&(Ge+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${ma}</span>`)}return`
          <tr>
        ...
        <tr>
          ...
          <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
        </tr>`}).join(""):"",n.classList.toggle("hidden",!!b||y||v||T),i.classList.toggle("hidden",!F||T),W){const k=`
      <section class="results-marker-card">
        <div class="results-results-view-marker-card-head">
          <h4>${S(Qo(W.markerType,W.markerLabel))}</h4>
          <div class="results-marker-card-meta">${S(`${W.kmMark.toFixed(1).replace(".",",")} km${W.markerCategory?` · Kat. ${W.markerCategory}`:""}`)}</div>
        </div>
      </section>`,A=W.entries.map(z=>{var Ie;const U=$e(z.riderId),pe=U?`${U.firstName} ${U.lastName}`:`Fahrer ${z.riderId}`,Se=(U==null?void 0:U.activeTeamId)!=null?((Ie=d.teams.find(ke=>ke.id===U.activeTeamId))==null?void 0:Ie.name)??null:null;return`
    ...
    </div>`}const yo={flat:"Flach",mountain:"Berg",mediumMountain:"Mittlere Berge",hill:"Hügel",timeTrial:"Zeitfahren",prologue:"Prolog",cobble:"Pflaster",sprint:"Sprint",acceleration:"Antritt",downhill:"Abfahrt",attack:"Attacke",stamina:"Stamina",resistance:"Widerstand",recuperation:"Regeneration",bikeHandling:"Fahrtechnik"};function pr(e){return e==="name"?"Name":e==="countryCode"?"Herkunft":e==="birthYear"?"Geburtsjahr":e==="age"?"Alter":e==="overallRating"?"Stärke":e==="potOverall"?"Potenzial":e==="formBonus"?"Saisonform":e==="raceFormBonus"?"Rennform":e==="averageForm"?"Average Form":e==="longTermFatigueMalus"?"Langzeiterschöpfung":e==="shortTermFatigueMalus"?"Akute Erschöpfung":e==="seasonPoints"?"Saisonpunkte":e==="seasonRaceDays"?"Renntage":e==="seasonWins"?"Siege":e==="contractEndSeason"?"Vertragsende":e==="seasonFormPhase"?"Formphase":e==="roleName"?"Teamrolle":e==="riderType"?"Fahrertyp":e==="specialization1"?"Spec 1":e==="specialization2"?"Spec 2":e==="specialization3"?"Spec 3":e==="skillDevelopment"?"Entwicklung":e==="mentorName"?"Mentor":e==="peak1"?"Peak 1":e==="peak2"?"Peak 2":e==="peak3"?"Peak 3":yo[e]??String(e)}function vo(e){const t=[...e],a=d.teamTableSort.direction==="asc"?1:-1;return t.sort((s,r)=>{let n=0;switch(d.teamTableSort.key){case"name":n=te(s.lastName,r.lastName)||te(s.firstName,r.firstName);break;case"countryCode":n=te(kt(s),kt(r));break;case"birthYear":n=s.birthYear-r.birthYear;break;case"age":n=(s.age??0)-(r.age??0);break;case"overallRating":n=s.overallRating-r.overallRating;break;case"potOverall":n=(s.potential??0)-(r.potential??0);break;case"formBonus":n=(s.formBonus??0)-(r.formBonus??0);break;case"raceFormBonus":n=(s.raceFormBonus??0)-(r.raceFormBonus??0);break;case"longTermFatigueMalus":n=(s.longTermFatigueMalus??0)-(r.longTermFatigueMalus??0);break;case"shortTermFatigueMalus":n=(s.shortTermFatigueMalus??0)-(r.shortTermFatigueMalus??0);break;case"seasonPoints":n=(s.seasonPoints??0)-(r.seasonPoints??0);break;case"seasonRaceDays":n=(s.seasonRaceDays??0)-(r.seasonRaceDays??0);break;case"seasonWins":n=(s.seasonWins??0)-(r.seasonWins??0);break;case"contractEndSeason":n=(s.contractEndSeason??Number.MAX_SAFE_INTEGER)-(r.contractEndSeason??Number.MAX_SAFE_INTEGER);break;case"seasonFormPhase":n=te(s.seasonFormPhase??"neutral",r.seasonFormPhase??"neutral");break;case"roleName":n=te(dt(s),dt(r));break;case"riderType":n=te(s.riderType,r.riderType)||te(Ce(s),Ce(r));break;case"skillDevelopment":n=(s.skillDevelopment??0)-(r.skillDevelopment??0);break;case"specialization1":n=Me(xe(s.specialization1),xe(r.specialization1));break;case"specialization2":n=Me(xe(s.specialization2),xe(r.specialization2));break;case"specialization3":n=Me(xe(s.specialization3),xe(r.specialization3));break;case"peak1":n=Me(ge(s,0),ge(r,0));break;case"peak2":n=Me(ge(s,1),ge(r,1));break;case"peak3":n=Me(ge(s,2),ge(r,2));break;default:n=s.skills[d.teamTableSort.key]-r.skills[d.teamTableSort.key];break}return n===0&&(n=te(s.lastName,r.lastName)||te(s.firstName,r.firstName)),n*a}),t}function So(e){const t=[...e],a=d.riderMenuTableSort.direction==="asc"?1:-1;return t.sort((s,r)=>{let n=0;switch(d.riderMenuTableSort.key){case"name":n=te(s.lastName,r.lastName)||te(s.firstName,r.firstName);break;case"countryCode":n=te(kt(s),kt(r));break;case"birthYear":n=s.birthYear-r.birthYear;break;case"age":n=(s.age??0)-(r.age??0);break;case"overallRating":n=s.overallRating-r.overallRating;break;case"potOverall":n=(s.potential??0)-(r.potential??0);break;case"formBonus":n=(s.formBonus??0)-(r.formBonus??0);break;case"raceFormBonus":n=(s.raceFormBonus??0)-(r.raceFormBonus??0);break;case"longTermFatigueMalus":n=(s.longTermFatigueMalus??0)-(r.longTermFatigueMalus??0);break;case"shortTermFatigueMalus":n=(s.shortTermFatigueMalus??0)-(r.shortTermFatigueMalus??0);break;case"seasonPoints":n=(s.seasonPoints??0)-(r.seasonPoints??0);break;case"seasonRaceDays":n=(s.seasonRaceDays??0)-(r.seasonRaceDays??0);break;case"seasonWins":n=(s.seasonWins??0)-(r.seasonWins??0);break;case"contractEndSeason":n=(s.contractEndSeason??Number.MAX_SAFE_INTEGER)-(r.contractEndSeason??Number.MAX_SAFE_INTEGER);break;case"seasonFormPhase":n=te(s.seasonFormPhase??"neutral",r.seasonFormPhase??"neutral");break;case"roleName":n=te(dt(s),dt(r));break;case"riderType":n=te(s.riderType,r.riderType)||te(Ce(s),Ce(r));break;case"skillDevelopment":n=(s.skillDevelopment??0)-(r.skillDevelopment??0);break;case"specialization1":n=Me(xe(s.specialization1),xe(r.specialization1));break;case"specialization2":n=Me(xe(s.specialization2),xe(r.specialization2));break;case"specialization3":n=Me(xe(s.specialization3),xe(r.specialization3));break;case"peak1":n=Me(ge(s,0),ge(r,0));break;case"peak2":n=Me(ge(s,1),ge(r,1));break;case"peak3":n=Me(ge(s,2),ge(r,2));break;default:n=s.skills[d.riderMenuTableSort.key]-r.skills[d.riderMenuTableSort.key];break}return n===0&&(n=te(s.lastName,r.lastName)||te(s.firstName,r.firstName)),n*a}),t}function As(e){return e.length===0?"–":e.map(t=>{const a=d.races.find(s=>s.id===t);return a?S(a.name):`Rennen ${t}`}).join(", ")}function fp(e){const t=e.seasonFormPeakDates??[];return t.length===0?"–":t.join(" · ")}function gr(e,t){var a,s;switch(t.id){case"name":return`<td class="team-table-name-cell">${Fe(Ce(e),{riderId:e.id,teamId:e.activeTeamId,strong:d.teamDetailPage==="form"||d.teamDetailPage==="profile"||d.teamDetailPage==="preferences"})}${il(e)}</td>`;case"country":return`<td><span class="team-table-country-cell">${ie(kt(e))}<span>${S(kt(e))}</span></span></td>`;case"age":return`<td>${e.age??(d.gameState?d.gameState.season-e.birthYear:"–")}</td>`;case"roleName":return`<td class="team-table-wrap-cell">${S(dt(e))}</td>`;case"overallRating":return`<td><span style="font-weight:bold">${e.overallRating}</span></td>`;case"potOverall":return`<td>${e.potential!=null?e.potential.toFixed(2):"-"}</td>`;case"birthYear":return`<td>${e.birthYear}</td>`;case"contractEndSeason":return`<td>${e.contractEndSeason!=null?e.contractEndSeason:"–"}</td>`;case"formBonus":return`<td>${Nr(e.formBonus)}</td>`;case"raceFormBonus":return`<td>${rl(e.raceFormBonus)}</td>`;case"averageForm":return`<td>${Nr((e.formBonus??0)+(e.raceFormBonus??0))}</td>`;case"longTermFatigueMalus":return`<td>${Pr(e.longTermFatigueMalus,"none","Langzeit-Fatigue")}</td>`;case"shortTermFatigueMalus":return`<td>${Pr(e.shortTermFatigueMalus,e.shortTermFatigueWarning,"Kurzzeit-Fatigue")}</td>`;case"seasonFormPhase":return`<td>${ni(e)}</td>`;case"seasonPoints":return`<td>${e.seasonPoints??0}</td>`;case"seasonRaceDays":return`<td>${e.seasonRaceDays??0}</td>`;case"seasonWins":return`<td>${e.seasonWins??0}</td>`;case"peak1":return`<td class="team-table-wrap-cell">${S(ge(e,0)??"–")}</td>`;case"peak2":return`<td class="team-table-wrap-cell">${S(ge(e,1)??"–")}</td>`;case"peak3":return`<td class="team-table-wrap-cell">${S(ge(e,2)??"–")}</td>`;case"riderType":return`<td class="team-table-wrap-cell">${S(e.riderType??"–")}</td>`;case"specialization1":return`<td class="team-table-wrap-cell">${e.specialization1?S(Zt(e.specialization1)):"–"}</td>`;case"specialization2":return`<td class="team-table-wrap-cell">${e.specialization2?S(Zt(e.specialization2)):"–"}</td>`;case"specialization3":return`<td class="team-table-wrap-cell">${e.specialization3?S(Zt(e.specialization3)):"–"}</td>`;case"skillDevelopment":return`<td>${e.skillDevelopment!=null&&e.skillDevelopment>0?`<span class="race-sim-form-positive">+${e.skillDevelopment}</span>`:"–"}</td>`;case"seasonProgram":return`<td>${nl(e)}</td>`;case"mentorName":return e.mentorName?`<td><div style="display:flex;align-items:center;justify-content:flex-start;gap:0.4rem;">${ie(e.mentorCountryCode??"UNK")} <span>${S(e.mentorName)} (${e.mentorAge??"?"})</span></div></td>`:"<td>–</td>";case"favoriteRaces":return`<td class="team-table-wrap-cell">${As(e.favoriteRaces??[])}</td>`;case"nonFavoriteRaces":return`<td class="team-table-wrap-cell">${As(e.nonFavoriteRaces??[])}</td>`;default:{if(t.id.startsWith("skill-")){const r=t.sortKey;return r&&r in e.skills?`<td>${sl(e.skills[r],(a=e.yearStartSkills)==null?void 0:a[r],(s=e.potentials)==null?void 0:s[r])}</td>`:"<td>-</td>"}return"<td>–</td>"}}}async function Ja(){ve("Teams/Fahrer werden aktualisiert...");try{const e=await O.getRiders();if(e.success&&(d.riders=e.data??[]),await O.getTeams().then(t=>{t.success&&(d.teams=t.data??[])}),ye("teams")&&fr(),ye("riders")){const{renderRidersMenu:t}=await oi(async()=>{const{renderRidersMenu:a}=await Promise.resolve().then(()=>Gp);return{renderRidersMenu:a}},void 0);t()}}finally{fe()}}async function hp(e={}){const t=await O.getTeams();if(!t.success){console.error("loadTeams Fehler:",t.error),h("teams-detail").innerHTML=`<p class="error-msg">Teams konnten nicht geladen werden: ${S(t.error??"Unbekannt")}</p>`;return}d.teams=t.data??[],e.render!==!1&&ye("teams")&&fr()}function fr(){const e=h("teams-dropdown"),t=e.value;e.innerHTML='<option value="">– Team auswählen –</option>'+d.teams.map(s=>`<option value="${s.id}"${String(s.id)===t?" selected":""}>${S(s.name)} (${S(s.division??s.divisionName??"")}) · ${S(s.abbreviation)}</option>`).join("");const a=t?Number(t):null;Qt(a)}function Qt(e){const t=h("teams-detail");if(e===null){t.innerHTML='<p class="text-muted" style="padding:1rem 0">Team aus der Liste auswählen.</p>';return}const a=d.teams.find(i=>i.id===e);if(!a){t.innerHTML="";return}const s=vo(d.riders.filter(i=>i.activeTeamId===e)),r=a.division==="U23"?"badge-u23":"badge-classics",n=ur();t.innerHTML=`
    <div class="team-detail-card">
      ...
      <div class="team-detail-meta" style="margin-top:0.75rem">
        ...
        <span class="text-muted">Sortierung: ${S(pr(d.teamTableSort.key))} ${d.teamTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${bo()}
    ...
    </div>`}function ko(){h("teams-dropdown").addEventListener("change",e=>{const t=e.target.value;d.teamDetailPage="skills",Qt(t?Number(t):null)}),h("teams-detail").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const r=Number(t.dataset.riderProgramId);Number.isFinite(r)&&vr(r);return}const a=e.target.closest("button[data-team-detail-page]");if(a){const r=a.dataset.teamDetailPage;if(da.includes(r)){d.teamDetailPage=r,new Set(ur().map(l=>l.sortKey).filter(l=>l!=null)).has(d.teamTableSort.key)||(d.teamTableSort={key:"name",direction:"asc"});const i=Number(h("teams-dropdown").value);Qt(Number.isFinite(i)?i:null)}return}const s=e.target.closest("button[data-team-sort]");if(s){const r=s.dataset.teamSort;d.teamTableSort.key===r?d.teamTableSort.direction=d.teamTableSort.direction==="asc"?"desc":"asc":d.teamTableSort={key:r,direction:mr(r)};const n=Number(h("teams-dropdown").value);Qt(Number.isFinite(n)?n:null);return}})}const bp=Object.freeze(Object.defineProperty({__proto__:null,TEAM_DETAIL_PAGE_COLUMNS:cr,TEAM_DETAIL_PAGE_ORDER:da,TEAM_SKILL_COLUMNS:lr,TEAM_SKILL_TITLES:yo,TEAM_TABLE_COLUMNS:dr,compareOptionalStrings:Me,compareStrings:te,formatTeamAverage:go,formatTeamTopAverage:po,getActiveTeamTableColumns:ur,getDefaultTeamSortDirection:mr,getPeakDate:ge,getSortIndicator:fo,getSpecializationSortLabel:xe,getTeamAverage:mo,getTeamSortLabel:pr,getTeamTopAverage:uo,initTeamsListeners:ko,loadTeams:hp,refreshTeamsViewData:Ja,renderPeakDatesSummary:fp,renderRacePrefs:As,renderTeamDetail:Qt,renderTeamDetailPageTabs:bo,renderTeamTableCell:gr,renderTeamTableHeader:ho,renderTeams:fr,sortRiderMenuRiders:So,sortTeamRiders:vo},Symbol.toStringTag,{value:"Module"}));function yp(e,t,a){return`${e} · Etappe ${t} · ${a}`}function $o(e,t){return e.riders.map(a=>({riderId:a.riderId,finishTimeSeconds:t.stage.profile==="ITT"||t.stage.profile==="TTT"?a.riderClockSeconds:a.finishTimeSeconds,finishStatus:a.finishStatus??"finished",isBreakaway:a.isBreakaway,statusReason:a.statusReason??null,photoFinishScore:a.photoFinishScore,leadoutRiderId:a.leadoutRiderId,leadoutBonus:a.leadoutBonus})).filter(a=>a.finishStatus==="dnf"||a.finishTimeSeconds!=null)}function To(e,t){const a=[];for(const s of e.riders)if(s.leadoutBonus!=null&&s.leadoutBonus>0&&s.leadoutContributions&&s.leadoutContributions.length>0){const r=t.riders.find(i=>i.id===s.riderId),n=(r==null?void 0:r.activeTeamId)??null;n!=null&&a.push({teamId:n,sprinterId:s.riderId,leadoutBonus:s.leadoutBonus,contributorsJson:JSON.stringify(s.leadoutContributions)})}return a}async function Mo(e,t=!1){if(qn!=null||Ks)return!1;Rr(e),al(0);try{const a=await O.getRealtimeSimulation(e);if(!a.success||!a.data)return alert(`Instant-Simulation fehlgeschlagen:
`+(a.error??"Unbekannter Fehler")),!1;const s=a.data;d.realtimeBootstrap=s;const r=await ic(s,l=>ai(l)),n=$o(r,s),i=To(r,s);return await Fo(e,n,r.markerClassifications,r.incidents,r.allEvents,t,i,r.superTeamId),!0}catch(a){return alert("Unerwarteter Fehler bei der Instant-Simulation: "+a.message),!1}finally{Rr(null),fe()}}function xo(e){var s;const t=(s=d.rosterEditor)==null?void 0:s.teams.find(r=>r.team.id===e);if(!t)return 0;const a=new Set(d.rosterEditorSelectedRiderIds);return t.riders.filter(r=>a.has(r.rider.id)).length}function wo(){return d.rosterEditor?d.rosterEditor.teams.every(e=>xo(e.team.id)===e.riderLimit):!1}function ks(){const e=h("roster-editor-title"),t=h("roster-editor-meta"),a=h("roster-editor-body"),s=h("btn-apply-roster-editor"),r=d.rosterEditor;if(!r){e.textContent="Starterfeld bearbeiten",t.textContent="",a.innerHTML='<div class="results-empty">Kein Starterfeld geladen.</div>',s.disabled=!0;return}e.textContent="Starterfeld bearbeiten",t.textContent=r.race.isStageRace?`${r.race.name} · Etappe ${r.stage.stageNumber} · ${r.stage.profile}`:`${r.race.name} · ${r.stage.profile}`;const n=new Set(d.rosterEditorSelectedRiderIds);a.innerHTML=r.teams.map(i=>{const l=xo(i.team.id),c=l===i.riderLimit?"roster-editor-team-count-ok":"roster-editor-team-count-bad";return`
      <section class="roster-editor-team">
        ...
        <div class="roster-editor-riders">
          ${i.riders.map(o=>{var b;const m=["roster-editor-rider",n.has(o.rider.id)?"roster-editor-rider-selected":"",o.isLocked?"roster-editor-rider-locked":""].filter(Boolean).join(" "),u=o.rider.country?ie(o.rider.country.code3):"",f=[((b=o.rider.role)==null?void 0:b.name)??"Ohne Rolle",`OVR ${Math.round(o.rider.overallRating)}`].join(" · "),g=o.lockReason?`<span class="roster-editor-rider-lock">${S(o.lockReason)}</span>`:"";return`
              <button
                type="button"
                class="${m}"
...
`+(c.error??"Unbekannter Fehler"));return}const o=c.data;d.selectedResultsRaceId=(o==null?void 0:o.raceId)??d.selectedResultsRaceId,d.selectedResultsStageId=(o==null?void 0:o.stageId)??e,d.selectedResultTypeId=1,d.realtimeBootstrap=null,d.realtimeError=null,await Ds(e,!1),await br(),await yr(),await Ja(),Lt(),n||Mt("results")}catch(c){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+c.message)}finally{Ir(!1),fe()}}}function kp(){h("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);d.selectedRealtimeStageId=Number.isFinite(t)?t:null,d.realtimeBootstrap&&d.realtimeBootstrap.stage.id!==d.selectedRealtimeStageId&&(d.realtimeBootstrap=null),d.realtimeError=null,Eo(t,!1)})}function hr(e){var s;const t=ra((s=e.category)==null?void 0:s.name),a=es(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function ns(e){var r,n;const t=ra((r=e.category)==null?void 0:r.name),a=es(t),s=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(s)}</span>`}function $p(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(s=>s.date).sort((s,r)=>s.localeCompare(r));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function is(e){const{startDate:t,endDate:a}=$p(e);return t===a?re(t):`${re(t)} - ${re(a)}`}function Tp(e){return e.stageId>0}async function br(){const[e,t]=await Promise.all([O.getGameState(),O.getGameStatus()]);if(!e.success){console.error(e.error);return}d.gameState=e.data??null,d.gameStatus=t.success?t.data??null:null,Mp(),ye("dashboard")&&os()}function Mp(){var r;if(!d.gameState)return;h("meta-date").textContent=d.gameState.formattedDate,h("meta-season").textContent=`Saison ${d.gameState.season}`;const e=h("meta-race-hint"),t=h("btn-advance-day"),a=h("pending-stages-list"),s=((r=d.gameStatus)==null?void 0:r.pendingStages)??[];s.length>0?(e.textContent=`${s.length} offene Etappe${s.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=s.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${re(n.date)}`:`${n.profile} · ${re(n.date)}`,l=Tp(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
        ...
        </div>`}).join(""),a.classList.remove("hidden"),t.disabled=!0):d.gameState.hasRaceToday?(e.textContent="Heutige Rennen sind abgeschlossen. Tageswechsel ist wieder freigegeben.",e.classList.remove("hidden"),a.innerHTML="",a.classList.add("hidden"),t.disabled=!1):(e.textContent="",e.classList.add("hidden"),a.innerHTML="",a.classList.add("hidden"),t.disabled=!1)}function os(){var t,a,s,r,n;const e=d.teams.find(i=>i.isPlayerTeam)??d.teams.find(i=>{var l;return i.name===((l=d.currentSave)==null?void 0:l.teamName)})??null;h("dashboard-career").textContent=((t=d.currentSave)==null?void 0:t.careerName)??"–",h("dashboard-team").textContent=(e==null?void 0:e.name)??((a=d.currentSave)==null?void 0:a.teamName)??"–",h("dashboard-date").textContent=((s=d.gameState)==null?void 0:s.formattedDate)??"–",h("dashboard-season").textContent=d.gameState?`Saison ${d.gameState.season}`:"–",h("dashboard-races-today").textContent=String(((r=d.gameStatus)==null?void 0:r.pendingStages.length)??((n=d.gameState)==null?void 0:n.racesTodayCount)??0),Rp()}async function yr(){const e=await O.getRaces();if(!e.success){console.error(e.error);return}d.races=e.data??[],ye("dashboard")&&os(),xp(),wp()}async function xp(){var n;const e=(n=d.gameState)==null?void 0:n.season;if(!e||d.races.length===0)return;const t=`participantCountsLogged_${e}`;if(localStorage.getItem(t))return;const a=d.races.slice(0,30),s=await Promise.all(a.map(async i=>{var c;const l=await O.getRaceProgramParticipants(i.id);return{race:i,count:l.success?((c=l.data)==null?void 0:c.length)??0:-1}}));if(s.some(i=>i.count>0)){console.group(`[Velo] Teilnehmeranzahl Saison ${e}`);for(const{race:i,count:l}of s)l>=0&&console.log(`${i.name} (${i.startDate}): ${l} Programmfahrer`);console.groupEnd(),localStorage.setItem(t,"1")}}async function wp(){var i;const e=(i=d.gameState)==null?void 0:i.season;if(!e)return;const t=`programAssignmentsLogged_${e}`;if(localStorage.getItem(t))return;const a=await O.getRiders();if(!a.success||!a.data)return;const s=a.data,r=new Map;for(const l of s)if(l.seasonProgram){const c=l.seasonProgram;r.has(c.id)||r.set(c.id,{name:c.name,riders:[]}),r.get(c.id).riders.push(l)}if(r.size===0)return;console.group(`[Velo] Programmzuweisungen Saison ${e}`);const n=Array.from(r.keys()).sort((l,c)=>l-c);for(const l of n){const c=r.get(l);console.log(`Program: ${l} - ${c.name} (Count: ${c.riders.length})`)}console.groupEnd(),localStorage.setItem(t,"1")}function Ip(e,t){const[a,s,r]=e.split("-").map(Number),n=new Date(a,s-1,r);n.setDate(n.getDate()+t);const i=n.getFullYear(),l=String(n.getMonth()+1).padStart(2,"0"),c=String(n.getDate()).padStart(2,"0");return`${i}-${l}-${c}`}function Ln(e){var p,m,u,f;const t=d.gameState!=null&&e.startDate<=d.gameState.currentDate&&e.endDate>=d.gameState.currentDate,s=d.gameState!=null&&e.endDate<d.gameState.currentDate?'<span class="badge badge-done">Abgeschlossen</span>':t?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',r=((p=e.country)==null?void 0:p.name)??`Land ${e.countryId}`,n=(m=e.country)!=null&&m.code3?ie(e.country.code3):"",i=e.isStageRace?(e.stages??[]).reduce((g,b)=>g+(b.distanceKm??0),0):((u=e.upcomingStage)==null?void 0:u.distanceKm)??null,l=e.isStageRace?(e.stages??[]).reduce((g,b)=>g+(b.elevationGainMeters??0),0):((f=e.upcomingStage)==null?void 0:f.elevationGainMeters)??null,c=i!=null?String(i.toFixed(1)).replace(".",","):"-",o=l!=null?String(Math.round(l)):"-";return`
    <tr>
  ...
  `,r.length===0?n+=`
    ...
    `:n+=r.map(i=>Ln(i)).join(""),e.innerHTML=n}function ca(e){return`Etappe ${e.stageNumber}`}function Ep(e){if(e.length===0)return"Keine Etappen";const t=new Map;return e.forEach(a=>{t.set(a.profile,(t.get(a.profile)??0)+1)}),Array.from(t.entries()).sort((a,s)=>s[1]!==a[1]?s[1]-a[1]:a[0].localeCompare(s[0])).map(([a,s])=>`${s}x ${a}`).join(" · ")}function Fp(e){return`stage-profile-badge-${e.toLowerCase().replace(/_/g,"-")}`}function ua(e){return`<span class="stage-profile-badge ${Fp(e)}">${S(e)}</span>`}function ls(e,t){return`${e.name} · ${ca(t)} · ${t.profile}`}async function Cp(e){var r;const t=d.stageSummariesByStageId[e];if(t)return t;const a=await O.getStageSummary(e);if(a.success&&a.data)return d.stageSummariesByStageId[e]=a.data,d.stageSummaryErrorsByStageId&&delete d.stageSummaryErrorsByStageId[e],a.data;const s=await O.getRealtimeSimulation(e);return s.success&&((r=s.data)!=null&&r.stageSummary)?(d.stageSummariesByStageId[e]=s.data.stageSummary,d.stageSummaryErrorsByStageId&&delete d.stageSummaryErrorsByStageId[e],s.data.stageSummary):(d.stageSummaryErrorsByStageId&&(d.stageSummaryErrorsByStageId[e]=a.error??s.error??"Etappenprofil konnte nicht geladen werden."),console.error("Stage-Summary-Laden fehlgeschlagen:",{stageId:e,stageSummaryError:a.error,realtimeFallbackError:s.error}),d.stageSummariesByStageId&&delete d.stageSummariesByStageId[e],!a.success||!a.data?null:a.data)}function Np(){var c;const e=h("race-stages-title"),t=h("race-stages-meta"),a=h("race-stages-body"),s=ct(d.selectedDashboardRaceId);if(!s){e.textContent="Etappen",t.textContent="",a.innerHTML='<div class="results-empty">Rennen nicht gefunden.</div>';return}const r=s.stages??[],n=r.reduce((o,p)=>o+(p.distanceKm??0),0),i=r.reduce((o,p)=>o+(p.elevationGainMeters??0),0),l=Ep(r);if(e.textContent=s.name,t.textContent=`${is(s)} · ${((c=s.country)==null?void 0:c.name)??`Land ${s.countryId}`} · ${s.isStageRace?`${s.numberOfStages} Etappen`:"Eintagesrennen"} · ${Rs(n)} · ${Es(i)} · ${l}`,r.length===0){a.innerHTML='<div class="results-empty">Für dieses Rennen sind keine Etappen vorhanden.</div>';return}a.innerHTML=`
        ...
        <tbody>
          ${r.map(o=>`
              <tr class="dashboard-race-stage-row">
                <td>${re(o.date)}</td>
                <td><strong>${S(ca(o))}</strong></td>
                <td>${ua(o.profile)}</td>
                <td>${o.distanceKm!=null?Rs(o.distanceKm):"–"}</td>
                <td>${o.elevationGainMeters!=null?Es(o.elevationGainMeters):"–"}</td>
                <td>
                  <button
                    type="button"
                    class="dashboard-stage-profile-link"
                    data-dashboard-stage-profile-id="${o.id}"
                    aria-label="Profil von ${S(ls(s,o))} öffnen"
                  >
                    Profil anzeigen
                  </button>
                </td>
    ...
    </div>`}async function _s(e){ct(e)&&(d.selectedDashboardRaceId=e,Np(),Ve("raceStages"))}function Pp(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
    ...
    </th>`}function Dp(e){const t=d.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,s)=>{var n,i,l,c;let r=0;switch(d.raceParticipantsSort.key){case"team":r=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=s.team)==null?void 0:i.name)??"","de");break;case"rider":r=Ce(a.rider).localeCompare(Ce(s.rider),"de");break;case"spec1":r=Gs(a.rider).localeCompare(Gs(s.rider),"de");break;case"role":r=dt(a.rider).localeCompare(dt(s.rider),"de");break;case"overall":r=a.rider.overallRating-s.rider.overallRating;break;case"phase":r=(a.rider.seasonFormPhase??"neutral").localeCompare(s.rider.seasonFormPhase??"neutral","de");break;default:r=(((l=a.program)==null?void 0:l.name)??"").localeCompare(((c=s.program)==null?void 0:c.name)??"","de")}return r*t||Ce(a.rider).localeCompare(Ce(s.rider),"de")})}function Gs(e){return e.specialization1!=null?Zt(e.specialization1):"–"}async function Co(e){const t=ct(e);d.selectedRaceParticipantsRaceId=e,h("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",h("race-participants-meta").textContent="Lade Programmfahrer ...",h("race-participants-body").innerHTML="",d.raceParticipants=[],Ve("raceParticipants"),await No()}async function No(e=!1){const t=d.selectedRaceParticipantsRaceId;if(t==null)return;const a=ct(t);e&&(h("race-participants-meta").textContent="Lade Programmfahrer ...");const s=await O.getRaceProgramParticipants(t);if(!s.success||!s.data){h("race-participants-meta").textContent="",h("race-participants-body").innerHTML=`<div class="results-empty">${S(s.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}d.raceParticipants=s.data,h("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",h("race-participants-meta").textContent=`${s.data.length} Programmfahrer · ${a?is(a):""}`,h("race-participants-body").innerHTML=Lp(d.raceParticipants)}async function qa(e,t=null){let a=_a(e);if(!a&&d.stageEditorStageRows){const n=d.stageEditorStageRows.find(i=>i.stageId===e);n&&(a={race:{id:n.raceId,name:n.raceName,countryId:0,categoryId:0,isStageRace:!0,numberOfStages:1,startDate:"",endDate:"",prestige:0},stage:{id:n.stageId,raceId:n.raceId,stageNumber:n.stageNumber,date:"2026-01-01",profile:n.profile,startElevation:0,detailsCsvFile:"",distanceKm:n.distanceKm,elevationGainMeters:n.elevationGainMeters}})}if(!a)return;const s=await Cp(e);if(!s){alert(d.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}d.selectedDashboardProfileStageId=e,h("stage-profile-title").textContent=`${a.race.name} · ${ca(a.stage)}`;const r=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";h("stage-profile-meta").textContent=`${re(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?Rs(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?Es(a.stage.elevationGainMeters):"–"}${r}`,Ml(h("stage-profile-view"),s,a.stage.profile,ls(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),Ve("stageProfile")}function Ap(){h("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const r=Number(t.dataset.editStageRoster);if(!Number.isFinite(r))return;vp(r);return}const a=e.target.closest("button[data-live-stage]");if(a){const r=Number(a.dataset.liveStage);if(!Number.isFinite(r))return;Eo(r,!0);return}const s=e.target.closest("button[data-instant-stage]");if(s){const r=Number(s.dataset.instantStage);if(!Number.isFinite(r))return;Mo(r)}}),h("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const r=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(r)&&Co(r);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const s=Number(a.dataset.dashboardRaceId);Number.isFinite(s)&&_s(s)}),h("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&qa(a)}),h("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const r=Number(t.dataset.riderProgramId);Number.isFinite(r)&&vr(r);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const s=a.dataset.raceParticipantsSort;d.raceParticipantsSort.key===s?d.raceParticipantsSort.direction=d.raceParticipantsSort.direction==="asc"?"desc":"asc":d.raceParticipantsSort={key:s,direction:"asc"},No()}),h("btn-advance-day").addEventListener("click",async()=>{await Po()}),h("btn-auto-progress").addEventListener("click",()=>{Bp()})}async function Po(){ve("Tag wird fortgeschrieben...");try{const e=await O.advanceDay();if(!e.success)return alert(`Tageswechsel fehlgeschlagen:
`+(e.error??"Unbekannter Fehler")),!1;if(d.currentSave&&e.data&&(d.currentSave.currentSeason=e.data.season),await br(),await yr(),ye("teams")){const{refreshTeamsViewData:t}=await oi(async()=>{const{refreshTeamsViewData:a}=await Promise.resolve().then(()=>bp);return{refreshTeamsViewData:a}},void 0);await t()}return!0}catch(e){return alert("Unerwarteter Fehler beim Tageswechsel: "+e.message),!1}finally{fe()}}function Sr(){const e=document.getElementById("btn-auto-progress");e&&(rt?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function Bp(){rt?Xa():Lo()}function Lo(){rt||(Xn(!0),Sr(),_p())}function Xa(){rt&&(Xn(!1),d.autoProgressTargetDate=null,Sr())}async function _p(){var e,t;for(;rt;){const a=(e=d.gameState)==null?void 0:e.currentDate;if(d.autoProgressTargetDate&&a&&a>=d.autoProgressTargetDate){Xa();break}const s=((t=d.gameStatus)==null?void 0:t.pendingStages)??[];let r=!1;if(s.length>0){const n=s[0];r=await Mo(n.stageId,!0)}else r=await Po();if(!r){Xa();break}await new Promise(n=>setTimeout(n,100))}Sr()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&rt){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),Xa()}});const ea=50;function kr(){return[...dr,...cr[d.riderMenuDetailPage]]}function Do(e){return d.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${d.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function Ao(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=d.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </div>`}function Pa(){const e=h("riders-detail"),t=kr(),a=So(d.riders),s=a.length,r=Math.max(1,Math.ceil(s/ea));d.riderMenuPage=Math.min(r,Math.max(1,d.riderMenuPage));const n=(d.riderMenuPage-1)*ea,i=Math.min(s,n+ea),l=a.slice(n,i);e.innerHTML=`
    <div class="team-detail-card">
      <div class="team-detail-header">
        <h3>Alle Fahrer</h3>
      </div>
      <div class="team-detail-meta" style="margin-top:0.75rem">
        <span>${s} Fahrer</span>
        <span class="text-muted">Sortierung: ${S(pr(d.riderMenuTableSort.key))} ${d.riderMenuTableSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
      </div>
      ${Bo()}
      <div class="team-detail-table-scroll">
        <table class="data-table data-table-teams">
      ...
      <section class="rider-team-editor-main">
        <div class="team-detail-card">
          <div class="rider-team-editor-toolbar">
            ...
            <div class="team-detail-meta">
              <span>${i}</span>
              <span class="text-muted">Sortierung: ${S(d.riderTeamEditorSort.key==="teamName"?"Team":((l=Ra.find(c=>c.key===d.riderTeamEditorSort.key))==null?void 0:l.title)??d.riderTeamEditorSort.key)} ${d.riderTeamEditorSort.direction==="asc"?"aufsteigend":"absteigend"}</span>
...
`+a.error);return}d.draftHistory=a.data??null,ye("draft")&&Hs()}function Hs(){const e=h("draft-table-container"),t=h("draft-season-select");if(!d.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(t.options.length===0){const i=d.currentSave.startSeason??2026;for(let l=d.currentSave.currentSeason;l>=i;l--){const c=document.createElement("option");c.value=l.toString(),c.textContent=`Saison ${l}`,t.appendChild(c)}d.draftSelectedSeason||(d.draftSelectedSeason=d.currentSave.currentSeason),t.value=d.draftSelectedSeason.toString(),t.onchange=l=>{const c=l.target;d.draftSelectedSeason=parseInt(c.value,10),zo(d.draftSelectedSeason)}}if(!d.draftHistory){e.innerHTML='<div class="alert alert-info">Lade Draft Historie...</div>';return}if(d.draftHistory.rows.length===0){e.innerHTML='<div class="alert alert-info">Keine Draft-Einträge für diese Saison vorhanden.</div>';return}const a=[...d.draftHistory.rows].sort((i,l)=>{let c=0;const o=Qe.key;return o==="riderLastName"?c=i.riderLastName.localeCompare(l.riderLastName):o==="teamName"?c=i.teamName.localeCompare(l.teamName):o==="oldTeamName"?c=(i.oldTeamName||"").localeCompare(l.oldTeamName||""):o==="countryCode"?c=i.countryCode.localeCompare(l.countryCode):c=(i[o]??0)-(l[o]??0),Qe.asc?c:-c}),s=i=>Qe.key!==i?'<span class="sort-icon-placeholder"></span>':Qe.asc?" ▲":" ▼",r=i=>{Qe.key===i?Qe.asc=!Qe.asc:(Qe.key=i,Qe.asc=!0),Hs()};window.setDraftSort=r;let n=`
    <table class="data-table">
      ...
      <tbody>
  `;for(const i of a){const l=d.draftHistory.season-i.riderBirthYear;let c="-";i.oldTeamName&&(c=`<div style="display:flex; align-items:center; gap:0.5rem;">${St(i.oldTeamId,i.oldTeamName)} ${S(i.oldTeamName)}</div>`);const o=`<div style="display:flex; align-items:center; gap:0.5rem;">${St(i.teamId,i.teamName)} ${S(i.teamName)}</div>`;n+=`
      <tr>
    ...
    `}n+="</tbody></table>",e.innerHTML=n}async function tg(e=!1){const t=await O.getInjuries();if(!t.success){d.injuries=null,ye("injuries")&&Bn(),!e&&t.error&&alert(`Verletzungen konnten nicht geladen werden:
`+t.error);return}d.injuries=t.data??[],ye("injuries")&&Bn()}function Bn(){const e=h("injuries-table-container");if(!d.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(h("injuries-meta").textContent=d.injuries.length+" Ausfälle",d.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=_t;let t="";const a=d.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),s=new Map;for(const n of a){const i=n.teamId;s.has(i)||s.set(i,[]),s.get(i).push(n)}for(const n of s.keys())s.get(n).sort((i,l)=>l.overallRating-i.overallRating);const r=Array.from(s.keys()).sort((n,i)=>{const l=s.get(n)[0].teamAbbreviation||"",c=s.get(i)[0].teamAbbreviation||"";return l.localeCompare(c)});if(r.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of r){const i=s.get(n),l=i[0].teamAbbreviation;t+=`
        <div style="margin-bottom: 2rem;">
          ...
          <table class="data-table injuries-table">
            ...
            <tbody>
      `;for(const c of i){const o=c.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let p="";if(c.fitDate){const m=re(c.fitDate);if(c.missedRaces&&c.missedRaces.length>0){let u="";for(const f of c.missedRaces)u+=`
    ...
    </div>`}async function ig(e){const t=await O.getSeasonStandings();if(!t.success){d.seasonStandings=null,ye("season-standings")&&zs();return}d.seasonStandings=t.data??null,ye("season-standings")&&zs()}function zs(){var g,b,y,v,T,w;const e=h("season-standings-meta"),t=h("season-standings-scope-tabs"),a=h("season-standings-empty"),s=h("season-standings-table"),r=h("season-standings-tbody"),n=h("season-standings-jersey-header"),i=h("season-standings-primary-header"),l=h("season-standings-flag-header"),c=h("season-standings-secondary-header"),o=((g=d.seasonStandings)==null?void 0:g.season)??((b=d.gameState)==null?void 0:b.season)??((y=d.currentSave)==null?void 0:y.currentSeason)??null;e.textContent=o!=null?`Saison ${o} · Ergebnis- und Trikotpunkte kumuliert`:"Noch keine Saisonwertung geladen.",t.innerHTML=`
    <button
      type="button"
  ...
  `;const p=d.selectedSeasonStandingScope==="countries",m=p?((v=d.seasonStandings)==null?void 0:v.countryStandings)??[]:d.selectedSeasonStandingScope==="teams"?((T=d.seasonStandings)==null?void 0:T.teamStandings)??[]:((w=d.seasonStandings)==null?void 0:w.riderStandings)??[],u=p?m:[],f=p?[]:m;if(n.textContent="Trikot",i.textContent=p?"Land":d.selectedSeasonStandingScope==="teams"?"Team":"Fahrer",l.textContent="Flagge",c.textContent=d.selectedSeasonStandingScope==="teams"?"Land":"Team",n.classList.toggle("hidden",p),c.classList.toggle("hidden",p),!d.seasonStandings||m.length===0){r.innerHTML="",s.classList.add("hidden"),a.classList.remove("hidden"),a.textContent="Noch keine Saisonpunkte vorhanden.";return}r.innerHTML=p?u.map(M=>`
      ...
      </tr>`).join(""):f.map(M=>{var D;const $=M.riderName??M.teamName,E=jt(M.teamId,M.teamName),R=d.selectedSeasonStandingScope==="teams"?ng(M,((D=d.seasonStandings)==null?void 0:D.riderStandings)??[]):Ot($,!0,!1,M.riderId,M.teamId),L=tt(M.countryCode),C=d.selectedSeasonStandingScope==="teams"?S(M.countryName??M.countryCode??"–"):et(M.teamName??"–",M.teamId,!1);return`
        <tr>
          <td class="pos-${Math.min(M.rank,3)}">${M.rank}</td>
          ...
          <td>${M.points}</td>
          <td>${S(_n(M.gapPoints))}</td>
        </tr>`}).join(""),a.classList.add("hidden"),s.classList.remove("hidden")}function og(){h("season-standings-scope-tabs").addEventListener("click",e=>{const t=e.target.closest("button[data-season-scope]");if(!t)return;const a=t.dataset.seasonScope;a!=="riders"&&a!=="teams"&&a!=="countries"||(d.selectedSeasonStandingScope=a,zs())})}function Gn(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?0:t.includes("grand tour")?1:t.includes("monument")?2:t.includes("stage race high")?3:t.includes("one day high")?4:t.includes("stage race middle")?5:t.includes("one day middle")?6:t.includes("stage race low")?7:t.includes("one day low")?8:9}function lg(e){const t=o=>o.skills.mountain*.7+o.skills.timeTrial*.3,a=o=>o.skills.sprint*.7+o.skills.acceleration*.3,s=[...e].map(o=>({rider:o,score:t(o)})).sort((o,p)=>p.score-o.score).slice(0,10),r=[...e].map(o=>({rider:o,score:a(o)})).sort((o,p)=>p.score-o.score).slice(0,10),n=[...e].map(o=>({rider:o,score:o.skills.mountain})).sort((o,p)=>p.score-o.score).slice(0,10),i=[...e].map(o=>({rider:o,score:o.skills.hill})).sort((o,p)=>p.score-o.score).slice(0,10),l=[...e].map(o=>({rider:o,score:o.skills.cobble})).sort((o,p)=>p.score-o.score).slice(0,10),c=[...e].map(o=>({rider:o,score:o.skills.attack})).sort((o,p)=>p.score-o.score).slice(0,10);return{Gesamtklassement:s,Sprinter:r,Bergfahrer:n,Hügelspezialist:i,Pflasterspezialist:l,Angreifer:c}}function dg(e,t){const a=d.riders.filter(l=>l.activeTeamId===e);if(a.length===0)return 0;const s=l=>l.skills.mountain*.7+l.skills.timeTrial*.3,r=l=>l.skills.sprint*.7+l.skills.acceleration*.3;let n=[];t==="Gesamtklassement"?n=a.map(l=>s(l)):t==="Sprinter"?n=a.map(l=>r(l)):t==="Bergfahrer"?n=a.map(l=>l.skills.mountain):t==="Hügelspezialist"?n=a.map(l=>l.skills.hill):t==="Pflasterspezialist"?n=a.map(l=>l.skills.cobble):t==="Angreifer"&&(n=a.map(l=>l.skills.attack)),n.sort((l,c)=>c-l);const i=n.slice(0,8);return i.length===0?0:i.reduce((l,c)=>l+c,0)/i.length}function cg(e,t){var i;const s=d.teams.filter(l=>l.division==="WorldTour"||l.divisionName==="WorldTour").map(l=>({teamId:l.id,avgScore:dg(l.id,t)}));s.sort((l,c)=>c.avgScore-l.avgScore);const r=s.findIndex(l=>l.teamId===e)+1,n=((i=s.find(l=>l.teamId===e))==null?void 0:i.avgScore)??0;return{rank:r,total:s.length,average:n}}function ug(e){const t=d.riders.filter(r=>r.activeTeamId===e);if(t.length===0)return 0;const a=t.map(r=>r.overallRating??0);a.sort((r,n)=>n-r);const s=a.slice(0,10);return s.length===0?0:s.reduce((r,n)=>r+n,0)/s.length}function mg(e){var n;const a=d.teams.filter(i=>i.division==="WorldTour"||i.divisionName==="WorldTour").map(i=>({teamId:i.id,avgScore:ug(i.id)}));a.sort((i,l)=>l.avgScore-i.avgScore);const s=a.findIndex(i=>i.teamId===e)+1,r=((n=a.find(i=>i.teamId===e))==null?void 0:n.avgScore)??0;return{rank:s,total:a.length,average:r}}function Ea(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-200)",bg:"rgba(255, 255, 255, 0.05)"}}function $s(e){e.countryCode&&ie(e.countryCode);const t=lg(e.riders),a=[...e.riders].map(o=>({rider:o,formValue:o.formBonus+o.raceFormBonus})).sort((o,p)=>p.formValue-o.formValue).slice(0,10),s=[...e.riders].map(o=>({rider:o,uciRank:Za(o.id)})).filter(o=>o.uciRank!==null).sort((o,p)=>o.uciRank-p.uciRank).slice(0,10),r=Object.entries(t).map(([o,p])=>{const m=cg(e.teamId,o),u=m.average.toFixed(1).replace(".",","),f=p.map(({rider:g,score:b})=>{const y=`${g.firstName.charAt(0)}. ${g.lastName}`,v=Fe(y,{riderId:g.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),T=g.nationality?je[g.nationality]??g.nationality.slice(0,2).toLowerCase():null,w=T?`<span class="fi fi-${T} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(g.nationality)}"></span>`:"",M=d.riders.find(E=>E.id===g.id);return`
    ...
    `}).join(""),i=[...e.riders].sort((o,p)=>(p.overallRating??0)-(o.overallRating??0)).slice(0,10).map(o=>{const p=`${o.firstName.charAt(0)}. ${o.lastName}`,m=Fe(p,{riderId:o.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),u=o.nationality?je[o.nationality]??o.nationality.slice(0,2).toLowerCase():null,f=u?`<span class="fi fi-${u} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(o.nationality)}"></span>`:"",g=o.overallRating.toFixed(0),b=d.riders.find(v=>v.id===o.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
    ...
    `}).join(""),l=a.map(({rider:o,formValue:p})=>{const m=`${o.firstName.charAt(0)}. ${o.lastName}`,u=Fe(m,{riderId:o.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=o.nationality?je[o.nationality]??o.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(o.nationality)}"></span>`:"",b=(p>=0?"+":"")+p.toFixed(1).replace(".",","),y=`S-Form: ${o.formBonus>=0?"+":""}${o.formBonus.toFixed(1)} / R-Form: ${o.raceFormBonus>=0?"+":""}${o.raceFormBonus.toFixed(1)}`,v=d.riders.find(w=>w.id===o.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
    ...
    `}).join(""),c=s.map(({rider:o,uciRank:p})=>{const m=`${o.firstName.charAt(0)}. ${o.lastName}`,u=Fe(m,{riderId:o.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=o.nationality?je[o.nationality]??o.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(o.nationality)}"></span>`:"";let b="rider-stats-rank-badge-gc";p===1?b="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":p===2?b="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":p===3&&(b="rider-stats-rank-badge-place rider-stats-rank-badge-top-3");const y=`<span class="rider-stats-rank-badge ${b}" style="margin: 0; font-size: 0.75rem; padding: 0; min-width: 2rem; height: 1.35rem; display: inline-flex; align-items: center; justify-content: center; text-align: center; box-sizing: border-box; line-height: 1;" title="UCI Weltrangliste: Platz ${p}">${p}</span>`,v=d.riders.find(w=>w.id===o.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${Ea((v==null?void 0:v.roleId)??null).color};">
          ${g}
          ${u}
  ...
  `,p=l.length===0?'<tr><td colspan="11" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':l.map(u=>{const f=u.rowType!=="stage_result",g=f?`${u.raceName} · ${u.rowType==="gc_final"?"Gesamtwertung":u.rowType==="points_final"?"Punktewertung":u.rowType==="mountain_final"?"Bergwertung":"Nachwuchs"}`:u.stageNumber?`${u.raceName} · Etappe ${u.stageNumber}`:u.raceName;let b="–",y="–";u.finishStatus==="otl"?b=Tt("OTL","place"):u.finishStatus==="dnf"?b=Tt("DNF","place"):u.resultRank==null||(f?y=`<span class="rider-stats-final-type ${u.rowType==="gc_final"?"is-gc":u.rowType==="points_final"?"is-points":u.rowType==="mountain_final"?"is-mountain":"is-youth"}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${u.resultRank}</span>`:b=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${u.resultRank<=3?` rider-stats-rank-badge-top-${u.resultRank}`:""}">${S(String(u.resultRank))}</span>`);const v=u.profile?ua(u.profile):"–",T=!f&&u.stageScore!=null&&u.stageScore>0?rs(u.stageScore,0,350):"–",w=Ya(u.raceCategoryName),M=u.riderCountryCode?je[u.riderCountryCode]??u.riderCountryCode.slice(0,2).toLowerCase():null,$=M?`<span class="fi fi-${M} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px;" title="${S(u.riderCountryCode??"")}"></span>`:"–",E=Fe(u.riderName,{riderId:u.riderId,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return`
  ...
  `}function gg(e){const t=String(d.teamStatsSelectedSeason),a=e.successStats[t]||{breakawayAttempts:0,attacks:0,counterAttacks:0,crashes:0,defects:0,illnesses:0,illnessDays:0,injuries:0,injuryDays:0,dnsCount:0,dnfCount:0,otlCount:0,totalGcWins:0,totalStageWins:0,successfulBreakaways:0,raceDays:0,superteamCount:0,categories:{}},s=t==="all",r=m=>s?m:"–",n=(m,u)=>s?`${m} / ${u} T`:"–",i=s?"":' title="Dieser Wert wird systemweit nur all-time erfasst."',l=(m,u,f,g)=>{const b=typeof m=="number"?m:parseFloat(String(m))||0;let y="padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.8rem; font-weight: bold; min-width: 1.8rem; text-align: center; display: inline-block; box-sizing: border-box;";return b===0?y+="background: rgba(255, 255, 255, 0.05); color: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.1);":u==="gold"?y+="background: linear-gradient(135deg, #ffd700, #ffa500); color: #000; box-shadow: 0 0 5px rgba(255, 215, 0, 0.4); text-shadow: 0 0 1px rgba(255,255,255,0.3);":u==="silver"?y+="background: linear-gradient(135deg, #e5e7eb, #9ca3af); color: #000; box-shadow: 0 0 5px rgba(229, 231, 235, 0.4);":u==="bronze"?y+="background: linear-gradient(135deg, #d35400, #a04000); color: #fff; box-shadow: 0 0 5px rgba(211, 84, 0, 0.4);":u==="purple"?y+="background: linear-gradient(135deg, #a855f7, #7e22ce); color: #fff; box-shadow: 0 0 5px rgba(168, 85, 247, 0.4);":u==="green"?y+="background: #2ecc71; color: #fff; box-shadow: 0 0 5px rgba(46, 204, 113, 0.4);":u==="red"?y+="background: #e74c3c; color: #fff; box-shadow: 0 0 5px rgba(231, 76, 60, 0.4);":u==="white"&&(y+="background: #ffffff; color: #000; border: 1px solid #ccc; box-shadow: 0 0 5px rgba(255, 255, 255, 0.4);"),`<span style="${y}" title="${S(f)}: ${b} Siege">${m}</span>`},c=[{key:"World Tour - Tour de France",name:"Tour de France",isStage:!0},{key:"World Tour - Grand Tour",name:"Grand Tour",isStage:!0},{key:"World Tour - Monument",name:"Monumente",isStage:!1},{key:"World Tour - Stage Race High",name:"Stage Race (High)",isStage:!0},{key:"World Tour - Stage Race Middle",name:"Stage Race (Middle)",isStage:!0},{key:"World Tour - Stage Race Low",name:"Stage Race (Low)",isStage:!0},{key:"World Tour - One Day High",name:"One Day (High)",isStage:!1},{key:"World Tour - One Day Middle",name:"One Day (Middle)",isStage:!1},{key:"World Tour - One Day Low",name:"One Day (Low)",isStage:!1}],o=`
  ...
  `}function fg(e){var r;const t=((r=d.gameState)==null?void 0:r.season)??new Date().getFullYear(),a=[...e.riders].sort((n,i)=>{const l=n.contractEndSeason??9999,c=i.contractEndSeason??9999;return l!==c?l-c:i.overallRating-n.overallRating});return`
    <section class="rider-stats-contracts" style="margin-top: 1.5rem;">
      <div class="dashboard-race-stages-table-wrap rider-stats-table-wrap">
        <table class="data-table rider-stats-table">
          ...
          <tbody>
            ${a.length===0?'<tr><td colspan="6" class="text-center text-muted" style="padding: 2rem;">Keine Vertragsdaten verfügbar.</td></tr>':a.map(n=>{const i=n.nationality?je[n.nationality]??n.nationality.slice(0,2).toLowerCase():null,l=i?`<span class="fi fi-${i} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px;" title="${S(n.nationality)}"></span>`:"–",c=Fe(`${n.firstName} ${n.lastName}`,{riderId:n.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),o=d.riders.find(b=>b.id===n.id),p=`<span class="results-roster-overall-badge" style="color:${Hn(n.overallRating)}" title="Stärke: ${n.overallRating.toFixed(2)}">${n.overallRating.toFixed(1)}</span>`;let m="–";o&&o.potential!=null&&(m=`<span class="results-roster-overall-badge" style="color:${Hn(o.potential)}" title="Potential: ${o.potential.toFixed(2)}">${o.potential.toFixed(1)}</span>`);const u=n.contractEndSeason===t,f=n.contractEndSeason?`Saison ${n.contractEndSeason}`:"Ohne Vertrag",g=u?`<span class="badge badge-race-category" style="background: rgba(239, 68, 68, 0.15); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.4); font-weight: bold; animation: pulse 2s infinite;" title="Vertrag läuft in dieser Saison aus!">${S(f)}</span>`:`<span style="font-weight: 500;">${S(f)}</span>`;return`
  ...
  `,Ve("teamStats");const r=await O.getTeamStats(e);if(d.teamStatsSelectedTeamId===e){if(!r.success||!r.data){h("team-stats-body").innerHTML=`
    ...
    `;let o="",p=1;for(const g of i){const b=p++,v=`<span class="badge ${b===1?"badge-primary":b<=3?"badge-secondary":"badge-ghost"}" style="min-width: 28px; text-align: center; display: inline-block;">${b}</span>`,T=St(g.teamId,g.teamName);let w="";if(l){const $=g.stageNumber!=null?`Etappe ${g.stageNumber}`:"–";w=`<td style="vertical-align: middle;">${S(g.raceName??"–")} · ${S($)} · ${S(String(g.season??"–"))}</td>`}let M="";if(c)if(g.lieutenantDetails){const $=g.lieutenantDetails,E=$.leaderNationality?ie($.leaderNationality):"",R=$.leaderRoleName?` (${$.leaderRoleName})`:"";M=`
      ...
      `}else{let $="";if(g.leadoutDetails){const E=g.leadoutDetails,R=E.sprinterNationality?ie(E.sprinterNationality):"";$=`
        ...
        `}else $=`<strong>${S(g.teamName??"")}</strong>`;o+=`
        <tr>
          <td style="text-align: center; vertical-align: middle;">${v}</td>
          <td style="text-align: center; vertical-align: middle;">${T}</td>
      ...
      `}).join(""),p=l.map(m=>{var w;const u=m.race,f=a>=u.startDate&&a<=u.endDate,g=a>u.endDate,b=ra((w=u.category)==null?void 0:w.name),y=f?'<span class="calendar-live-dot"></span>':"",v=g?"opacity: 0.55;":"",T=m.endIdx-m.startIdx+1;return`
    ...
    `}t.innerHTML=s,jo()}function jo(){var n;const e=h("calendar-race-search"),t=e?e.value.toLowerCase().trim():"",a=h("calendar-races-tbody"),s=((n=d.gameState)==null?void 0:n.currentDate)??"",r=d.races.filter(i=>{var l;return t?i.name.toLowerCase().includes(t)||((l=i.category)==null?void 0:l.name)&&i.category.name.toLowerCase().includes(t):!0}).sort((i,l)=>i.startDate.localeCompare(l.startDate));if(r.length===0){a.innerHTML='<tr><td colspan="9" class="text-muted" style="text-align: center; padding: 20px;">Keine Rennen gefunden.</td></tr>';return}a.innerHTML=r.map(i=>{var y,v,T,w;const l=s>=i.startDate&&s<=i.endDate,o=s>i.endDate?'<span class="badge badge-done">Abgeschlossen</span>':l?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',p=((y=i.country)==null?void 0:y.name)??`Land ${i.countryId}`,m=(v=i.country)!=null&&v.code3?ie(i.country.code3):"",u=i.isStageRace?(i.stages??[]).reduce((M,$)=>M+($.distanceKm??0),0):((T=i.upcomingStage)==null?void 0:T.distanceKm)??null,f=i.isStageRace?(i.stages??[]).reduce((M,$)=>M+($.elevationGainMeters??0),0):((w=i.upcomingStage)==null?void 0:w.elevationGainMeters)??null,g=u!=null?String(u.toFixed(1)).replace(".",","):"-",b=f!=null?String(Math.round(f)):"-";return`
    ...
    `}).join("")}window.openTeamStats=Ko;async function Oo(){var e;for(let t=localStorage.length-1;t>=0;t--){const a=localStorage.key(t);a&&(a.startsWith("programAssignmentsLogged_")||a.startsWith("participantCountsLogged_"))&&localStorage.removeItem(a)}Ws("game"),h("meta-career").textContent=((e=d.currentSave)==null?void 0:e.careerName)??"",Mt("dashboard"),ve("Spiel wird geladen…");try{await br(),await yr(),os()}catch(t){alert("Fehler beim Laden des Spiels: "+t.message)}finally{fe()}}function Fg(){document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{var a;const t=e.dataset.view??"";Mt(t),t==="dashboard"&&os(),t==="teams"&&Ja(),t==="riders"&&Ja(),t==="rider-team-editor"&&Ho(),t==="live-race"&&Lt(),t==="results"&&Te(),t==="draft"&&zo(d.draftSelectedSeason||((a=d.currentSave)==null?void 0:a.currentSeason)||2026),t==="injuries"&&tg(),t==="season-standings"&&ig(),t==="leaderboards"&&vg(),t==="calendar"&&Eg(),(t==="stage-editor-stages"||t==="stage-editor-climbs")&&so()})}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-rider-link[data-rider-id]");if(!t)return;const a=Number(t.dataset.riderId);Number.isFinite(a)&&_t(a)}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-team-link[data-team-id]");if(!t)return;const a=Number(t.dataset.teamId);Number.isFinite(a)&&Ko(a)}),h("btn-cancel-new").addEventListener("click",()=>Ke("newCareer")),h("btn-close-race-stages").addEventListener("click",()=>Ke("raceStages")),h("btn-close-stage-profile").addEventListener("click",()=>Ke("stageProfile")),h("btn-close-rider-program").addEventListener("click",()=>Ke("riderProgram")),h("btn-close-rider-stats").addEventListener("click",()=>Ke("riderStats")),h("btn-close-team-stats").addEventListener("click",()=>Ke("teamStats")),h("btn-close-race-participants").addEventListener("click",()=>Ke("raceParticipants")),h("btn-close-roster-editor").addEventListener("click",()=>Bs()),h("btn-cancel-roster-editor").addEventListener("click",()=>Bs()),h("btn-apply-roster-editor").addEventListener("click",()=>{Sp()}),h("btn-back-menu").addEventListener("click",()=>{Yt==null||Yt.pause(),Ws("menu"),na()}),cl(),Ap(),Rg(),ko(),_o(),eg(),kp(),gp(),Bm(),Qm(),bg(),og(),yg()}(async()=>(lm(),ce(),Fg(),Ws("menu"),await na()))();
