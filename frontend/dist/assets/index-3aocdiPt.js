(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();function xi(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function es(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function lt(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function wa(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function Ne(e,t={}){const a=t.strong===!1?"span":"strong",r=es("app-rider-link-label",t.labelClassName),s=`<${a} class="${r}">${xi(e)}</${a}>`;if(t.riderId==null)return s;const n=['type="button"','class="'+es("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${s}</button>`}function Ze(e,t,a=!0,r=""){const s=a===!1?"span":"strong",n=`<${s} class="app-team-link-label">${xi(e)}</${s}>`;return t==null?n:`<button type="button" class="${es("app-team-link",r)}" data-team-id="${t}">${n}</button>`}function Ti(e,t){return t?t instanceof Map?t.get(e)??0:t[e]??0:0}function wi(e){return Math.round(e*10)/10}function Mi(e,t){const a=e;return(t==null?void 0:t.distanceKm)??a.distanceKm??0}function Ii(e,t){const a=e;return(t==null?void 0:t.elevationGainMeters)??a.elevationGainMeters??0}function Ri(e,t){return t+(e.formBonus??0)+(e.raceFormBonus??0)}function Fl(e,t){return e.skills.stamina*(t/300)}function Ci(e,t,a){return e.skills.timeTrial+Ri(e,t)+e.skills.mountain*(a/500)}function Pl(e,t,a,r){const s=Fl(e,a),n=Ri(e,r);switch(t.profile){case"Flat":return .8*e.skills.sprint+.15*e.skills.acceleration+.05*e.skills.flat+n+s;case"Rolling":return .7*e.skills.sprint+.2*e.skills.acceleration+.1*e.skills.hill+n+s;case"Hilly":return .45*e.skills.sprint+.1*e.skills.flat+.45*e.skills.hill+n+s;case"Hilly_Difficult":return .2*e.skills.sprint+.1*e.skills.flat+.7*e.skills.hill+n+s;case"Medium_Mountain":return .05*e.skills.sprint+.1*e.skills.flat+.35*e.skills.hill+.45*e.skills.mediumMountain+.05*e.skills.mountain+n+s;case"Mountain":return .05*e.skills.hill+.2*e.skills.mediumMountain+.75*e.skills.mountain+n+s;case"High_Mountain":return e.skills.mountain+n+s;case"Cobble":return .3*e.skills.sprint+.2*e.skills.flat+.5*e.skills.cobble+n+s;case"Cobble_Hill":return .3*e.skills.sprint+.2*e.skills.flat+.2*e.skills.hill+.3*e.skills.cobble+n+s;default:return .8*e.skills.sprint+.2*e.skills.flat+n+s}}function Nl(e,t,a,r,s){return t.profile==="ITT"||t.profile==="TTT"?Ci(e,s,r):Pl(e,t,a,s)}function Ll(e,t){var a;return{rank:t,kind:"rider",effectiveSkill:wi(e.effectiveSkill),teamId:e.rider.activeTeamId??0,teamName:e.teamName,displayName:`${e.rider.firstName} ${e.rider.lastName}`,roleLabel:((a=e.rider.role)==null?void 0:a.name)??"–",riderId:e.rider.id}}function Ei(e,t,a,r){Mi(a,r);const s=Ii(a,r),n=new Map(t.map(o=>[o.id,o]));if(a.profile==="TTT"){const o=new Map;for(const l of e){if(l.activeTeamId==null)continue;const p=o.get(l.activeTeamId)??[];p.push(l),o.set(l.activeTeamId,p)}return[...o.entries()].map(([l,p])=>{const u=n.get(l),f=p.map(h=>Ci(h,Ti(h.id,r==null?void 0:r.dailyFormByRiderId),s)).sort((h,$)=>$-h).slice(0,5),g=f.length,v=g>0?f.reduce((h,$)=>h+$,0)/g:0,b=Math.max(0,5-g)*2;return{team:u??{id:l,name:`Team ${l}`,abbreviation:"---",divisionId:0,u23TeamId:null,isPlayerTeam:!1,countryCode:"---",colorPrimary:"#000000",colorSecondary:"#ffffff",aiFocus1:0,aiFocus2:0,aiFocus3:0},score:v-b}}).sort((l,p)=>p.score-l.score||l.team.id-p.team.id).slice(0,20).map((l,p)=>({rank:p+1,kind:"team",effectiveSkill:wi(l.score),teamId:l.team.id,teamName:l.team.name,displayName:l.team.name,roleLabel:"TTT"}))}return(r!=null?rr(e,t,a,r):rr(e,t,a)).sort((o,c)=>c.effectiveSkill-o.effectiveSkill||o.rider.id-c.rider.id).slice(0,20).map((o,c)=>Ll(o,c+1))}function rr(e,t,a,r){const s=Mi(a,r),n=Ii(a,r),i=new Map(t.map(o=>[o.id,o]));return e.map(o=>{var c;return{rider:o,teamName:o.activeTeamId!=null?((c=i.get(o.activeTeamId))==null?void 0:c.name)??`Team ${o.activeTeamId}`:"—",effectiveSkill:Nl(o,a,s,n,Ti(o.id,r==null?void 0:r.dailyFormByRiderId))}}).sort((o,c)=>c.effectiveSkill-o.effectiveSkill||o.rider.id-c.rider.id)}const d={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,seasonStandingsSelectedSeason:null,draftHistory:null,injuries:null,draftSelectedSeason:null,draftOverlayActive:!1,draftOverlayAuto:!0,draftOverlayPicks:null,draftOverlayCurrentIndex:0,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorHideBoringSegments:!0,stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsSelectedSeason:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedRosterYear:null,teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1,autoProgressTargetDate:null,raceProgramsPayload:null,raceProgramsActiveTab:"calendar-cols",raceProgramsDirty:!1,raceProgramsSaving:!1};let Yt=null;function Fi(e){Yt=e}let Mr=!1;function ts(e){Mr=e}let vs=null;function as(e){vs=e}let sr=null;function rs(e){sr=e}let ct=!1;function Ss(e){ct=e}function y(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ie(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function va(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),r=Math.floor(e%60),s=String(a).padStart(2,"0"),n=String(r).padStart(2,"0");return t>0?`${t}:${s}:${n}`:`${a}:${n}`}function Za(e){return e==null||e===0?"–":`+${va(e)}`}const ma=2,nr=3,ks=4;function $s(e){return`/jersey/Jer_${e}.png`}function _e(e,t){var r;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((r=d.teams.find(s=>s.id===e))==null?void 0:r.name)??`Team ${e}`;return`
  ...
  `;for(const h of c){const $=e.riders.find(F=>F.id===h.riderId);if(!$)continue;const I=wt($.id)??"un",w=ze[I]??"un",x=e.teams.find(F=>F.id===$.activeTeamId),M=(x==null?void 0:x.abbreviation)??"—",T=l.get($.id),E=T?`GC ${T.rank} (${T.rank===1?"Gelb":dn(T.gapSeconds)})`:"GC –";p+=`
      <div class="instant-sim-rider-card">
        ...
        <div class="instant-sim-info-column">
          <div class="instant-sim-rider-header">
            <span class="instant-sim-rank-badge">${h.rank}</span>
          ...
          <div class="instant-sim-rider-meta">
            <span class="instant-sim-team-abbr">${S(M)}</span>
    ...
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const h of u){const $=e.riders.find(E=>E.id===h.riderId);if(!$)continue;const I=wt($.id)??"un",w=ze[I]??"un",x=e.teams.find(E=>E.id===$.activeTeamId),M=(x==null?void 0:x.abbreviation)??"—",T=h.rank===1?"Gelb":dn(h.gapSeconds);m+=`
      <div class="instant-sim-rider-card">
        <div class="instant-sim-jersey-column">
          <img src="/jersey/Jer_${$.activeTeamId}.png" class="instant-sim-large-jersey" onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';">
        </div>
    ...
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const h of f){if(h.riderId==null)continue;const $=e.riders.find(E=>E.id===h.riderId);if(!$)continue;const I=wt($.id)??"un",w=ze[I]??"un",x=e.teams.find(E=>E.id===$.activeTeamId),M=(x==null?void 0:x.abbreviation)??"—",T=`${h.points??0} Punkte`;g+=`
      <div class="instant-sim-rider-card">
        <div class="instant-sim-jersey-column">
          <img src="/jersey/Jer_${$.activeTeamId}.png" class="instant-sim-large-jersey" onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';">
        </div>
  ...
  `).join("")}async function Bl(e){$e("Karriere wird geladen…");const t=await V.loadSave(e);if(ye(),!t.success){alert("Fehler beim Laden: "+t.error);return}d.currentSave=t.data??null,await El()}async function Hl(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;$e("Löschen…");const a=await V.deleteSave(e);if(ye(),!a.success){alert("Fehler: "+a.error);return}await Ma()}async function zl(){const e=await V.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){y("btn-delete-all-careers").classList.add("hidden"),y("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){$e("Alle Karrieren werden gelöscht…");try{for(const a of t){const r=await V.deleteSave(a.filename);if(!r.success){alert(`Fehler beim Löschen von "${a.careerName}": ${r.error??"Unbekannter Fehler"}`);break}}}finally{ye()}await Ma()}}function Gl(){y("btn-new-career").addEventListener("click",async()=>{var s;aa("new-career-error"),y("input-career-name").value="";const a=y("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',Xe("newCareer");const r=await V.getAvailableTeams();if(!r.success||!((s=r.data)!=null&&s.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=r.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),y("btn-cancel-new").addEventListener("click",()=>Ue("newCareer")),y("btn-confirm-new").addEventListener("click",async()=>{const a=y("input-career-name").value.trim(),r=y("input-team-id").value;if(!a||!r){Mt("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const s=Number(r),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;aa("new-career-error"),$e("Neue Karriere wird erstellt…");const o=await V.createSave(i,a,s);if(!o.success){ye(),Mt("new-career-error",o.error??"Unbekannter Fehler.");return}const c=await V.loadSave(i);if(ye(),Ue("newCareer"),!c.success){alert("Fehler: "+c.error);return}d.currentSave=c.data??null,await El()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>Ma());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{zl()}),y("saves-list").addEventListener("click",async a=>{const r=a.target.closest("button[data-save-action]");if(!r)return;const{saveAction:s,filename:n,careerName:i}=r.dataset;if(n){if(s==="load"){await Bl(n);return}s==="delete"&&await Hl(n,i??n)}})}const Kl="modulepreload",Ol=function(e){return"/"+e},cn={},qa=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(a.map(c=>{if(c=Ol(c),c in cn)return;cn[c]=!0;const l=c.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":Kl,l||(u.as="script"),u.crossOrigin="",u.href=c,o&&u.setAttribute("nonce",o),document.head.appendChild(u),l)return new Promise((m,f)=>{u.addEventListener("load",m),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return s.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})},Wl={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function jl(e){const t=Wl[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const Vl=200;function Rs(e){if(e.length===0)return[];const t=[];for(const a of e){const r=t[t.length-1];if(!r||Math.abs(r.distanceMeter-a.distanceMeter)>=Vl){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}r.riderIds.push(...a.riderIds),r.riderCount+=a.riderCount,r.distanceSum+=a.distanceMeter*a.riderCount,r.distanceMeter=r.distanceSum/r.riderCount}return t.map(({distanceSum:a,...r})=>r)}function Cs(e){if(e.length===0)return[];let t=0;for(let s=1;s<e.length;s+=1)e[s].riderCount>e[t].riderCount&&(t=s);let a=0,r=0;return e.map((s,n)=>{const i=n===t;let o;return i?o="P":n<t?(a+=1,o=`E${a}`):(r+=1,o=`A${r}`),{...s,label:o,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-s.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,s.distanceMeter-e[n+1].distanceMeter):null}})}function Ul(e,t=null){var a,r,s;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((r=e.find(n=>n.label==="P"))==null?void 0:r.label)??((s=e[0])==null?void 0:s.label)??null}function Ct(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function un(e,t,a,r){return`${r.type}:${e}:${t}:${a}`}function Yl(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:Ct(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function dt(e){const t=[];e.segments.forEach((s,n)=>{const i=n*2;(s.start_markers??[]).forEach((o,c)=>{t.push({key:un(n,"start",c,o),label:"",marker:o,kmMark:s.start_km,elevation:s.start_elevation,boundary:"start",sequence:i+c/100})}),(s.end_markers??[]).forEach((o,c)=>{t.push({key:un(n,"end",c,o),label:"",marker:o,kmMark:s.end_km,elevation:s.end_elevation,boundary:"end",sequence:i+1+c/100})})});const a=t.sort((s,n)=>s.kmMark-n.kmMark||s.sequence-n.sequence),r=new Map;return a.map(s=>{const n=(r.get(s.marker.type)??0)+1;return r.set(s.marker.type,n),{...s,label:s.marker.name??Yl(s.marker,n)}})}function Zl(e){const t=dt(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>Ct(a)).length}}function ra(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Jl(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function Qe(e,t,a,r){return t<=0?r:r+e/t*(a-r*2)}function ur(e,t){const a=t/1e3,r=e.points;if(a<=r[0].kmMark)return r[0].elevation;for(let s=0;s<r.length-1;s+=1){const n=r[s],i=r[s+1];if(a>i.kmMark)continue;const o=Math.max(1e-4,i.kmMark-n.kmMark),c=(a-n.kmMark)/o;return n.elevation+(i.elevation-n.elevation)*c}return r[r.length-1].elevation}function Ki(e){const t=e.points.map(p=>p.elevation),a=Math.min(...t),r=Math.max(...t),s=Math.max(1,r-a),n=Math.max(40,s*.08),i=Math.max(0,a-n),o=r+n;let c=Math.floor(i/50)*50,l=Math.ceil(o/50)*50;return l<=c&&(l=c+100),{axisMinElevation:c,axisMaxElevation:l}}function nt(e,t,a,r,s,n){const i=Math.max(1,a-t);return r-n-(e-t)/i*(r-s-n)}function pa(e){return`${Math.round(e)} m`}function mn(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function pn(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function Oi(e,t,a,r,s,n,i,o,c){var g;const l=[],p=[];let u=null,m="#b91c1c";for(const v of dt(e)){const{marker:b,kmMark:h,elevation:$}=v;if(b.type==="climb_start"){p.push({kmMark:h,elevation:$,name:b.name});continue}if(Ct(b)){let I=-1;for(let T=p.length-1;T>=0;T-=1)if(b.name&&((g=p[T])==null?void 0:g.name)===b.name){I=T;break}const w=I>=0?p.splice(I,1)[0]:p.pop();w&&Math.max(0,h-w.kmMark),w&&Math.max(0,$-w.elevation);const x=pn(b.cat,b.type),M=mn(b.cat);if(b.type==="finish_hill"||b.type==="finish_mountain"){u=b.cat??null,m=x.accentColor;continue}l.push({x:Qe(h*1e3,t,a,r),anchorY:nt($,o,c,s,n,i),primaryLabel:M??"Berg",secondaryLabel:pa($),distanceLabel:`${h.toFixed(1).replace(".",",")} km`,accentColor:x.accentColor});continue}if(b.type==="sprint_intermediate"){const I=pn(b.cat,b.type);l.push({x:Qe(h*1e3,t,a,r),anchorY:nt($,o,c,s,n,i),primaryLabel:"Sprint",secondaryLabel:pa($),distanceLabel:`${h.toFixed(1).replace(".",",")} km`,accentColor:I.accentColor})}}const f=e.points[e.points.length-1];return l.push({x:Qe(f.kmMark*1e3,t,a,r),anchorY:nt(f.elevation,o,c,s,n,i),primaryLabel:u?`${mn(u)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:pa(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:m}),l.sort((v,b)=>v.x-b.x)}function Wi(e,t,a){const r=t+4,s=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
    ...
    </g>`}function ji(e,t){const a=new Set,r=t/1e3;for(let s=0;s<=r;s+=25)a.add(Math.round(s*1e3));return a.add(Math.round(t)),[...a].filter(s=>s>=0&&s<=t).sort((s,n)=>s-n)}function Vi(e,t,a,r,s,n){const i=new Set(dt(t).map(o=>Math.round(o.kmMark*1e3)));return e.map(o=>{const c=Qe(o,a,r,s),p=i.has(o)?18:12,u=n+p+26;return`
      <g class="race-sim-distance-tick">
        ...
        <text x="${c.toFixed(1)}" y="${u.toFixed(1)}" text-anchor="middle" class="race-sim-grid-label">${ra(Jl(o))}</text>
      </g>`}).join("")}function ql(e,t,a,r,s,n,i,o,c,l,p){const u=Qe(e.distanceMeter,a,r,n),m=ur(t,e.distanceMeter),f=nt(m,c,l,s,i,o),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),v=e.riderCount>1?`<text x="${u.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${v}
    </g>`}function Xl(e,t,a,r,s,n,i,o,c,l,p){const u=new Map(p.riders.map(f=>[f.id,f])),m=new Map((p.teams??[]).map(f=>[f.id,f.abbreviation]));return e.filter(f=>f.riderCount===1).map(f=>{const g=f.riderIds[0];if(g==null)return"";const v=u.get(g);if(!v)return"";const b=Qe(f.distanceMeter,a,r,n),h=ur(t,f.distanceMeter),$=nt(h,c,l,s,i,o),I=v.activeTeamId!=null?m.get(v.activeTeamId)??"":"",w=`${v.lastName} (${I})`,x=$-34,M=$-40;return`
        <g class="race-sim-itt-rider-label-group">
          ...
          <text x="${b.toFixed(1)}" y="${M.toFixed(1)}" text-anchor="middle" class="race-sim-marker-detail">${ra(w)}</text>
        </g>`}).join("")}function Ql(e,t,a,r,s,n,i,o,c,l,p){const u=Math.max(0,Math.min(l,e.distanceKm)),m=Math.max(0,Math.min(p,e.distanceKm));if(m<=u)return null;const f=[{kmMark:u,elevation:ur(e,u*1e3)},...e.points.filter($=>$.kmMark>u&&$.kmMark<m),{kmMark:m,elevation:ur(e,m*1e3)}];if(f.length<2)return null;const g=s-i,v=f.map(($,I)=>{const w=Qe($.kmMark*1e3,t,a,r),x=nt($.elevation,o,c,s,n,i);return`${I===0?"M":"L"} ${w.toFixed(1)} ${x.toFixed(1)}`}).join(" "),b=Qe(u*1e3,t,a,r),h=Qe(m*1e3,t,a,r);return`${v} L ${h.toFixed(1)} ${g.toFixed(1)} L ${b.toFixed(1)} ${g.toFixed(1)} Z`}function ed(e,t,a,r,s={}){const p=e.distanceKm*1e3,{axisMinElevation:u,axisMaxElevation:m}=Ki(e),f=533,g=12,b=e.points.map(T=>{const E=Qe(T.kmMark*1e3,p,1584,28),F=nt(T.elevation,u,m,634,168,101);return{x:E,y:F}}).map((T,E)=>`${E===0?"M":"L"} ${T.x.toFixed(1)} ${T.y.toFixed(1)}`).join(" "),h=`${b} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,$=s.selectedClimbRange!=null?Ql(e,p,1584,28,634,168,101,u,m,s.selectedClimbRange.startKm,s.selectedClimbRange.endKm):null,I=Oi(e,p,1584,28,634,168,101,u,m).map(T=>Wi(T,g,f)).join(""),x=Array.from({length:5},(T,E)=>u+(m-u)/4*E).map(T=>{const E=nt(T,u,m,634,168,101);return`
      ...
      <text x="${14 .toFixed(1)}" y="${(E+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${pa(T)}</text>`}).join(""),M=Vi(ji(e,p),e,p,1584,28,f);return`
    <svg viewBox="0 0 1584 634" role="img" aria-label="${ra(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
      ...
      <path d="${h}" fill="url(#dashboard-large-area)"></path>
    ...
    </svg>`}function td(e,t,a,r,s){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${ed(t,a,r,!1,s)}</div>`}function ad(e,t,a,r,s,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const o=1584,c=634,l=28,p=168,u=101,{axisMinElevation:m,axisMaxElevation:f}=Ki(t),g=c-u,v=12,b=Array.from({length:5},(O,G)=>m+(f-m)/4*G),h=Rs(a.clusters),$=Cs(h),I=ji(t,a.stageDistanceMeters),x=t.points.map(O=>{const G=Qe(O.kmMark*1e3,a.stageDistanceMeters,o,l),C=nt(O.elevation,m,f,c,p,u);return{x:G,y:C}}).map((O,G)=>`${G===0?"M":"L"} ${O.x.toFixed(1)} ${O.y.toFixed(1)}`).join(" "),M=`${x} L ${(o-l).toFixed(1)} ${g.toFixed(1)} L ${l.toFixed(1)} ${g.toFixed(1)} Z`,T=Oi(t,a.stageDistanceMeters,o,l,c,p,u,m,f).map(O=>Wi(O,v,g)).join(""),E=b.map(O=>{const G=nt(O,m,f,c,p,u);return`
      ...
      <text x="${(l-14).toFixed(1)}" y="${(G+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${pa(O)}</text>`}).join(""),F=Vi(I,t,a.stageDistanceMeters,o,l,g),A=new Map(h.map((O,G)=>[O,$[G]??null])),_=h.map(O=>{var G;return ql(O,t,a.stageDistanceMeters,o,c,l,p,u,m,f,((G=A.get(O))==null?void 0:G.label)===i)}).join(""),z=s.stage.profile==="ITT"?Xl(h,t,a.stageDistanceMeters,o,c,l,p,u,m,f,s):"";e.innerHTML=`
      ...
      <div class="race-sim-profile-canvas-wrap">
        <svg viewBox="0 0 ${o} ${c}" role="img" aria-label="${ra(r)}">
          ...
          <g clip-path="url(#race-sim-profile-plot-clip)">
            <path d="${M}" fill="url(#race-sim-area)"></path>
    ...
    <span class="${t}" aria-hidden="true">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function jc(e){return e.riderId==null||e.riderTeamId==null?"":oo(e.riderTeamId)}function Vc(e){const t=sa(e.title);return e.riderId==null?`<strong class="race-sim-message-title">${t}</strong>`:`<button type="button" class="race-sim-message-title race-sim-message-rider-link" data-race-sim-group-rider-id="${e.riderId}">${t}</button>`}function Uc(e,t){return`<button type="button" class="race-sim-message-inline-name race-sim-message-rider-link" data-race-sim-group-rider-name="${sa(e)}"${t!=null?` data-race-sim-group-rider-team-id="${t}"`:""}>${sa(e)}</button>`}function Yc(e,t){if(t==="all")return!0;const a=lo(e);return t==="attack"?a==="attack"||a==="counter_attack":a===t}function Zc(e){const t=e.detail?sa(e.detail):"",a=(e.secondaryRiders??[]).map(s=>`${s.riderTeamId!=null?oo(s.riderTeamId,"race-sim-message-inline-jersey"):""}${Uc(s.riderName,s.riderTeamId)}`).join(", ");if(!t&&a.length===0)return"";const r=a.length>0?`${t.length>0?" ":""}Reaktion: ${a}.`:"";return`<span class="race-sim-message-detail"> · ${t}${r}</span>`}function lo(e){return e.title.includes("stürzt")||e.title.includes("Sturz")?"crash":e.title.includes("Defekt")?"mechanical":e.title.includes("Ausreißer")?"breakaway":e.type}function _n(e,t,a="all"){const r=t.filter(n=>Yc(n,a)),s=t.length===0?"Noch keine Events in dieser Etappe.":"Keine Meldungen in dieser Kategorie.";e.innerHTML=`
    ...
    <div class="race-sim-message-list">
      ${r.length===0?`<div class="race-sim-message-empty">${s}</div>`:r.map(n=>`
        <article class="race-sim-message-item" data-tone="${n.tone}" data-message-kind="${sa(lo(n))}">
          <span class="race-sim-message-time">t=${Oc(n.elapsedSeconds)}</span>
          ${jc(n)}
      ...
      `).join("")}
    </div>`}const Jc=1,qc={Flat:14,Rolling:15,Hilly:16,Hilly_Difficult:17,Medium_Mountain:18,Mountain:25,High_Mountain:27,ITT:30,TTT:40,Cobble:18,Cobble_Hill:20};function Xc(e){return Math.max(0,Math.round(e))}function co(e){return e==="ITT"||e==="TTT"}function Qc(e){return qc[e]??20}function eu(e,t){if(t.length===0)return null;const a=Math.min(...t);return!Number.isFinite(a)||a<=0?null:Math.floor(a*(1+Qc(e)/100))}function tu(e,t){return e.stageTimeSeconds-t.stageTimeSeconds||t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function An(e,t){return t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function Vr(e,t){if(co(t))return[...e].sort(tu);const a=[...e].sort((o,c)=>o.stageTimeSeconds-c.stageTimeSeconds||An(o,c)),r=[];let s=[],n=null;const i=()=>{r.push(...s.sort(An))};for(const o of a){if(s.length===0){s=[o],n=o.stageTimeSeconds;continue}if(n!=null&&o.stageTimeSeconds-n<=Jc){s.push(o),n=o.stageTimeSeconds;continue}i(),s=[o],n=o.stageTimeSeconds}return s.length>0&&i(),r}function ee(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function au(e){return`/jersey/Jer_${e}.png`}function Ia(e,t){return e==null||e<=0?"—":`
    <span class="race-sim-team-visual" title="${ee(t??`Team ${e}`)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function Ra(e,t,a){return e==null?`<span class="${a}" title="${ee(t)}">${ee(t)}</span>`:`<button type="button" class="${a} race-sim-stage-overview-rider-link" data-race-sim-group-rider-id="${e}" title="${ee(t)}">${ee(t)}</button>`}function ru(e){return e.toFixed(1).replace(".",",")}function gr(e){if(e==null||e<=0)return"—";const t=Math.floor(e/60),a=Math.floor(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function su(e){return`${e??0} Pkt.`}function nu(e){if(e==null||!Number.isFinite(e))return"—";const t=Math.round(e);return t===0?"—":t>0?`+${t} m`:`-${Math.abs(t)} m`}function iu(e){return e==null||!Number.isFinite(e)?"":e<-100?"is-ahead":e>100?"is-behind":""}function uo(e){const t=Math.max(0,Math.round(e)),a=Math.floor(t/3600),r=Math.floor(t%3600/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function ou(e){if(e==null||e<=0)return uo(0);const t=Math.floor(e/60),a=Math.round(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Tt(e){return e?e.split("|").map(t=>Number.parseInt(t.trim(),10)).filter(Number.isFinite):[]}function Ba(e){return`${e.toFixed(1).replace(".",",")} km`}function Bn(e){return`${e.toFixed(1).replace(".",",")}%`}function Ha(e,t){return e.filter(a=>Number.isFinite(a)&&a>0).map(a=>({points:a,pointsKind:t}))}function Hn(e){return e==null?null:e==="HC"?"is-hc":`is-cat-${e}`}function lu(e){return e.accent==="sprint"?{label:"Sprint",className:"is-sprint"}:e.categoryLabel&&e.categoryClassName?{label:e.categoryLabel,className:e.categoryClassName}:null}function du(e,t){return e.riderId==null?null:t.gcLeaderRiderId===e.riderId?"gc":t.pointsLeaderRiderId===e.riderId?"points":t.mountainLeaderRiderId===e.riderId?"mountain":t.youthLeaderRiderId===e.riderId?"youth":null}function cu(e,t,a){return Array.from({length:t},(r,s)=>e.slice(s*a,(s+1)*a))}function uu(e,t,a){if(e.length===0)return'<div class="race-sim-favorites-empty">Noch keine Favoriten für diese Etappe.</div>';const r=cu(e,4,5),s=new Map(t.map(n=>[n.riderId,n]));return`<div class="race-sim-stage-favorites-grid">${r.map(n=>`
    <div class="race-sim-favorites-column">
      ${n.map(i=>`
        <article class="race-sim-favorite-item${(()=>{const o=du(i,a);return o?` is-${o}-leader`:""})()}">
          <strong class="race-sim-favorite-rank">${i.rank}.</strong>
          ${Ia(i.teamId,i.teamName)}
          <div class="race-sim-favorite-main">
                    ${Ra(i.riderId,i.displayName,"race-sim-favorite-name")}
          ...
          <strong class="race-sim-favorite-skill">${ru(i.effectiveSkill)}</strong>
        </article>
      `).join("")}
    </div>
  `).join("")}</div>`}function ka(e,t){const a=e.riders.find(r=>r.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function Er(e,t){const a=e.riders.find(n=>n.id===t),r=(a==null?void 0:a.activeTeamId)??null,s=r!=null?e.teams.find(n=>n.id===r)??null:null;return{teamId:r,teamName:(s==null?void 0:s.name)??null}}function mu(e,t,a,r={}){const s=(t??[]).slice(0,r.limit??8);return s.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${s.map(n=>{var u;const i=n.riderId??0,o=Er(e,i),c=ka(e,i),l=((u=r.distanceGapsByRiderId)==null?void 0:u.get(i))??null,p=[r.distanceGapClassName??"",iu(l)].filter(m=>m.length>0).join(" ");return`
      <article class="race-sim-classification-row">
        ...
        <span class="race-sim-classification-main">
          ${Ra(n.riderId,c,"race-sim-classification-name")}
          <span class="race-sim-classification-value">${a(n)}</span>
        </span>
        ${r.distanceGapsByRiderId?`<span class="race-sim-classification-distance-gap ${p}">${ee(nu(l))}</span>`:""}
    ...
    <details class="race-sim-overview-details ${a}" data-race-sim-overview-section="${r}" ${s?"open":""}>
      ...
      ${t}
    </details>`}function fr(e,t,a,r){const s=new Map(t.map(n=>[n.riderId,n]));return e.riders.map(n=>{var c;const i=s.get(n.id)??null,o=((c=a.get(n.id))==null?void 0:c[r])??0;return{riderId:n.id,rank:(i==null?void 0:i.rank)??Number.MAX_SAFE_INTEGER,points:((i==null?void 0:i.points)??0)+o,timeSeconds:(i==null?void 0:i.timeSeconds)??null,gapSeconds:(i==null?void 0:i.gapSeconds)??null,stagePoints:o}}).sort((n,i)=>(i.points??0)-(n.points??0)||n.rank-i.rank||ka(e,n.riderId).localeCompare(ka(e,i.riderId),"de")).map((n,i)=>({...n,rank:i+1}))}function zn(e){const t=pu(e)?e.stagePoints:0;return`${ee(su("points"in e?e.points:null))}${t>0?`<span class="race-sim-classification-stage-gain"><span class="race-sim-classification-stage-gain-arrow">▲</span><span class="race-sim-classification-stage-gain-amount">+${ee(t)}</span></span>`:""}`}function pu(e){return"stagePoints"in e&&typeof e.stagePoints=="number"}function Gn(e,t){if(t==null)return new Map;const a=e.riders.find(r=>r.riderId===t)??null;return a?new Map(e.riders.map(r=>[r.riderId,a.distanceCoveredMeters-r.distanceCoveredMeters])):new Map}function gu(e,t){return e.stageSummary.segments.find(a=>t>=a.start_km&&t<=a.end_km)??e.stageSummary.segments.find(a=>a.end_km>=t)??e.stageSummary.segments[e.stageSummary.segments.length-1]??null}function Xa(e,t){var r;const a=(r=e.race.category)==null?void 0:r.bonusSystem;return!a||t==null||t==="Sprint"?[]:Tt(t==="HC"?a.pointsMountainHc:t==="1"?a.pointsMountainCat1:t==="2"?a.pointsMountainCat2:t==="3"?a.pointsMountainCat3:a.pointsMountainCat4)}function Es(e){var r;const t=(r=e.race.category)==null?void 0:r.bonusSystem;if(!t||e.stage.profile==="TTT")return[];if(!e.race.isStageRace)return Tt(t.pointsOneDay);const a=!["ITT","TTT","Flat","Rolling","Hilly"].includes(e.stage.profile);return Tt(a?t.pointsMountainStage:t.pointsSprintFinish)}function mo(e){var t,a;return e.stage.profile==="ITT"||e.stage.profile==="TTT"?[]:Tt((a=(t=e.race.category)==null?void 0:t.bonusSystem)==null?void 0:a.pointsSprintIntermediate)}function fu(e,t,a){let r=null;for(const s of e.stageSummary.segments){const n=Math.max(t,s.start_km),i=Math.min(a,s.end_km),o=Math.max(0,i-n);if(o<=0)continue;const c={lengthKm:o,gradient:s.gradient_percent};(r==null||c.gradient>r.gradient||c.gradient===r.gradient&&c.lengthKm>r.lengthKm)&&(r=c)}return r}function Ur(e,t,a,r=null){return e.entries.filter(s=>r==null||r.has(s.riderId)).map((s,n)=>({riderId:s.riderId,rank:s.rank,points:t[n]??0,pointsKind:a,crossingTimeSeconds:s.crossingTimeSeconds,gapSeconds:s.gapSeconds})).filter(s=>s.points>0)}function Fs(e){const t=new Map;for(const a of e)for(const r of a.entries){const s=t.get(r.riderId)??{points:0,mountain:0};r.pointsKind==="mountain"?s.mountain+=r.points:s.points+=r.points,t.set(r.riderId,s)}return t}function hu(e){return dt(e.stageSummary).filter(({marker:t})=>t.type==="finish_flat"||t.type==="finish_TT"||t.type==="finish_hill"||t.type==="finish_mountain").sort((t,a)=>a.kmMark-t.kmMark)[0]??null}function hr(e,t){const a=co(e.stage.profile)?t.riderClockSeconds:t.finishTimeSeconds;return a!=null&&Number.isFinite(a)?Xc(a):null}function Fr(e,t){const a=t.riders.filter(n=>n.finishStatus!=="dnf").map(n=>{const i=hr(e,n);return i==null?null:{rider:n,stageTimeSeconds:i,photoFinishScore:n.photoFinishScore,riderId:n.riderId}}).filter(n=>n!=null);if(a.length===0)return[];const r=Math.min(...a.map(n=>n.stageTimeSeconds));if(!Number.isFinite(r)||r<=0)return Vr(a,e.stage.profile).map(n=>n.rider);const s=eu(e.stage.profile,a.map(n=>n.stageTimeSeconds));return s==null?Vr(a,e.stage.profile).map(n=>n.rider):Vr(a.filter(n=>n.stageTimeSeconds<=s),e.stage.profile).map(n=>n.rider)}function bu(e,t){const a=Es(e);return a.length===0?[]:Fr(e,t).map((r,s)=>({riderId:r.riderId,rank:s+1,points:a[s]??0,pointsKind:"points",crossingTimeSeconds:hr(e,r),gapSeconds:null})).filter(r=>r.points>0)}function yu(e,t){const a=Fr(e,t).slice(0,20),r=a[0]!=null?hr(e,a[0])??0:0;return a.map((s,n)=>{const i=hr(e,s)??0;return{riderId:s.riderId,rank:n+1,crossingTimeSeconds:i,gapSeconds:Math.max(0,i-r),photoFinishScore:s.photoFinishScore}})}function vu(e,t){var a;return((a=Fr(e,t)[0])==null?void 0:a.riderId)??null}function Ps(e,t,a){var I,w;const r=dt(e.stageSummary),s=e.stageSummary.distanceKm*.75,n=a.isFinished?new Set(Fr(e,a).map(x=>x.riderId)):null,i=r.filter(({marker:x})=>x.type==="climb_start"),o=r.filter(({marker:x})=>Ct(x)).sort((x,M)=>x.kmMark-M.kmMark).map((x,M)=>{var j,X;const T=[...i].reverse().find(J=>J.kmMark<=x.kmMark)??null,E=gu(e,x.kmMark),F=(T==null?void 0:T.kmMark)??(E==null?void 0:E.start_km)??x.kmMark,A=(T==null?void 0:T.elevation)??(E==null?void 0:E.start_elevation)??x.elevation,_=Math.max(0,x.kmMark-F),z=_>0?(x.elevation-A)/(_*1e3)*100:(E==null?void 0:E.gradient_percent)??0,O=fu(e,F,x.kmMark),G=t.find(J=>J.markerKey===x.key)??null,C=Xa(e,(G==null?void 0:G.markerCategory)??x.marker.cat??null),H=G?Ur(G,C,"mountain",n):[],U=(G==null?void 0:G.markerCategory)??x.marker.cat??null;return{key:x.key,title:`${M+1}. Bergwertung`,label:x.label,categoryLabel:U?`Kat. ${U}`:null,categoryClassName:Hn(U),kmMark:x.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-x.kmMark),climbLengthKm:_,averageGradient:z,steepestSegmentLengthKm:(O==null?void 0:O.lengthKm)??null,steepestSegmentGradient:(O==null?void 0:O.gradient)??null,highlightMeta:x.kmMark>=s,leaderRiderId:((j=H[0])==null?void 0:j.riderId)??((X=G==null?void 0:G.entries[0])==null?void 0:X.riderId)??null,displayBadges:Ha(C,"mountain"),entries:H,timingEntries:(G==null?void 0:G.entries)??[],accent:"mountain"}}),c=r.filter(({marker:x})=>x.type==="sprint_intermediate").sort((x,M)=>x.kmMark-M.kmMark).map((x,M)=>{var A,_;const T=t.find(z=>z.markerKey===x.key)??null,E=mo(e),F=T?Ur(T,E,"points",n):[];return{key:x.key,title:`${M+1}. Zwischensprint`,label:x.label,categoryLabel:null,categoryClassName:null,kmMark:x.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-x.kmMark),climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!1,leaderRiderId:((A=F[0])==null?void 0:A.riderId)??((_=T==null?void 0:T.entries[0])==null?void 0:_.riderId)??null,displayBadges:Ha(E,"points"),entries:F,timingEntries:(T==null?void 0:T.entries)??[],accent:"sprint"}}),l=hu(e),p=bu(e,a),u=l?t.find(x=>x.markerKey===l.key)??null:null,m=u?Ur(u,Xa(e,u.markerCategory),"mountain",n):[],f=Es(e),g=u?Xa(e,u.markerCategory):[],v=e.stage.profile==="ITT"||e.stage.profile==="TTT"?yu(e,a):(u==null?void 0:u.entries)??[],b=((I=p[0])==null?void 0:I.riderId)??((w=m[0])==null?void 0:w.riderId)??vu(e,a),h={key:"finish",title:"Zielsprint",label:(l==null?void 0:l.label)??"Ziel",categoryLabel:u!=null&&u.markerCategory?`Kat. ${u.markerCategory}`:null,categoryClassName:Hn((u==null?void 0:u.markerCategory)??null),kmMark:(l==null?void 0:l.kmMark)??e.stageSummary.distanceKm,kmToFinish:0,climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!!(u!=null&&u.markerCategory),leaderRiderId:b,displayBadges:[...Ha(f,"points"),...Ha(g,"mountain")],entries:[...p,...m],timingEntries:v,accent:"finish"};return[...[...c,...o].sort((x,M)=>x.kmMark-M.kmMark||x.title.localeCompare(M.title,"de")),h].filter(x=>x.entries.length>0||x.timingEntries.length>0||x.accent!=="finish"||l!=null||a.isFinished)}function Su(e,t){const a=new Map(t.entries.map(n=>[n.riderId,n])),r=(e.stage.profile==="ITT"||e.stage.profile==="TTT")&&t.key==="finish"?20:15,s=t.timingEntries.length>0?[...t.timingEntries].sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId).slice(0,r):t.entries.slice(0,r).map(n=>({riderId:n.riderId,rank:n.rank,crossingTimeSeconds:n.crossingTimeSeconds??0,gapSeconds:n.gapSeconds??0,photoFinishScore:0,pointsAwarded:n.points})).sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId);return s.length===0?'<div class="race-sim-stage-points-popover-empty">Noch keine Punkte vergeben.</div>':`
    <div class="race-sim-stage-points-popover-list">
      ${s.map(n=>{const i=Er(e,n.riderId),o=a.get(n.riderId)??null;return`
          <div class="race-sim-stage-points-popover-row">
            ...
            ${Ia(i.teamId,i.teamName)}
            ${Ra(n.riderId,ka(e,n.riderId),"race-sim-stage-scoring-name")}
            <strong>${n.rank===1?ee(uo(n.crossingTimeSeconds)):ee(ou(n.gapSeconds))}</strong>
            ${o?`<strong class="race-sim-stage-points-value-${o.pointsKind}">${o.points}</strong>`:"<strong>—</strong>"}
          </div>`}).join("")}
    </div>`}function Kn(e,t){var a;return((a=e==null?void 0:e.find(r=>r.riderId===t))==null?void 0:a.points)??0}function On(e,t){var a;return((a=e.filter(r=>r.riderId!=null&&t.has(r.riderId)).sort((r,s)=>r.rank-s.rank||r.riderId-s.riderId)[0])==null?void 0:a.riderId)??null}function Ga(e,t,a){if(!(!t||e.some(r=>r.riderId===t.riderId))){if(e.length<25){e.push(t);return}e[a]=t}}function ku(e,t,a,r,s){const n=new Set(e.riderIds),i=new Map(t.riders.map(f=>[f.riderId,f])),c=e.riderIds.map(f=>i.get(f)??null).filter(f=>f!=null).sort((f,g)=>{var v,b;return(((v=a.get(f.riderId))==null?void 0:v.rank)??Number.MAX_SAFE_INTEGER)-(((b=a.get(g.riderId))==null?void 0:b.rank)??Number.MAX_SAFE_INTEGER)||f.riderName.localeCompare(g.riderName,"de")||f.riderId-g.riderId}).slice(0,25),l=i.get(On(r,n)??-1)??null,p=i.get(On(s,n)??-1)??null,u=l!=null&&!c.some(f=>f.riderId===l.riderId),m=p!=null&&!c.some(f=>f.riderId===p.riderId);return c.length>=25&&u&&m&&l.riderId!==p.riderId?(Ga(c,l,23),Ga(c,p,24),c):(Ga(c,l,24),Ga(c,p,24),c)}function $u(e,t){const a=[];return t.gcLeaderRiderId===e&&a.push("gc"),t.mountainLeaderRiderId===e&&a.push("mountain"),t.pointsLeaderRiderId===e&&a.push("points"),t.youthLeaderRiderId===e&&a.push("youth"),a}function xu(e){return e.includes("gc")?" is-gc-leader":e.includes("mountain")?" is-mountain-leader":e.includes("points")?" is-points-leader":e.includes("youth")?" is-youth-leader":""}function Wn(e,t){return e==null?"—":`${t}${Math.round(e)} m`}function Tu(e,t){const a=t.riders.filter(s=>e.riderIds.includes(s.riderId)).reduce((s,n)=>Math.max(s,n.distanceCoveredMeters),0),r=Math.max(0,t.leaderDistanceMeters-a);return r>0?`-${Math.round(r)} m`:"—"}function wu(e,t,a,r,s,n,i){if(a.length===0||e.stage.profile==="ITT"||e.stage.profile==="TTT")return"";const o=Ul(a,r),c=a.find(m=>m.label===o)??a[0],l=new Map(e.gcStandings.map(m=>[m.riderId,m])),p=Fs(i),u=ku(c,t,l,s,n);return`
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-gap-row">
        ...
        <span>Leader ${ee(Tu(c,t))}</span>
        <span>Hinten ${ee(Wn(c.nextGapMeters,"+"))}</span>
      </div>
      <div class="race-sim-group-grid">
        ${u.map((m,f)=>{const g=l.get(m.riderId)??null,v=Er(e,m.riderId),b=p.get(m.riderId)??{points:0,mountain:0},h=Kn(s,m.riderId),$=Kn(n,m.riderId),I=$u(m.riderId,e.classificationLeaders),w=I.length>0?I.map(x=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[x]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${xu(I)}" title="${ee(w)}">${f+1}.</strong>
              ${Ia(v.teamId,v.teamName)}
              <span class="race-sim-classification-main">
                ${Ra(m.riderId,m.riderName,`race-sim-group-rider-name${m.isBreakaway?" is-breakaway":""}`)}
                <strong class="race-sim-group-detail">GC ${g?g.rank:"—"} · ${ee(g?gr(g.gapSeconds):"—")} · ${ee(m.gapToLeaderMeters>0?`+${Math.round(m.gapToLeaderMeters)} m`:"—")}</strong>
              </span>
              <span class="race-sim-breakaway-points-panel">
                <span class="race-sim-breakaway-badges">
                  <span class="race-sim-stage-points-header-badge is-points">Sprint ${h}</span>
    ...
    </section>`}function Mu(e,t,a,r){const s=Ps(t,a.markerClassifications,a),n=Fs(s),i=fr(t,t.pointsStandings,n,"points"),o=fr(t,t.mountainStandings,n,"mountain"),c=Cs(Rs(a.clusters));e.innerHTML=wu(t,a,c,r,i,o,s)}function Iu(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function Ru(e){const t=dt(e.stageSummary),a=mo(e)[0]??0,r=Es(e)[0]??0,s=t.filter(({marker:n})=>Ct(n)).reduce((n,{marker:i})=>n+(Xa(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+r,mountain:s}}function jn(e){const t=Ru(e);return`
    ...
    </span>`}function Eu(e,t,a,r=null){const s=r??Ps(e,t,a);return s.length===0?`
        ...
        ${s.map(n=>{const i=n.leaderRiderId!=null?Er(e,n.leaderRiderId):{teamId:null,teamName:null},o=n.leaderRiderId!=null?ka(e,n.leaderRiderId):"Noch offen";return`
          <details class="race-sim-mountain-prime-row race-sim-stage-points-event race-sim-stage-points-event-${n.accent}">
            ...
            <span class="race-sim-stage-points-leader">
              ${Ia(i.teamId,i.teamName)}
              ${n.leaderRiderId!=null?Ra(n.leaderRiderId,o,"race-sim-stage-scoring-leader-name"):`<strong>${ee(o)}</strong>`}
            </span>
            </summary>
  ...
  `}const Vn=new WeakMap,it=new WeakMap,Un=new WeakMap,po=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function Q(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function go(e){return e<=0?"—":`+${Math.round(e)} m`}function fa(e){const t=po.format(e);return e>0?`+${t}`:t}function Yr(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function me(e){return po.format(e)}function Bt(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),r=Math.floor(t%3600/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function fo(e){return`+${Bt(e)}`}function ho(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Ns(e){return`${(e*3.6).toFixed(1)} km/h`}function Pu(e){return`${fa(e)}%`}function ls(e){return`${e.toFixed(1).replace(".",",")} km`}function bo(e){return`${ls(e.segmentStartKm)} - ${ls(e.segmentEndKm)}`}function Nu(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function yo(e){return e.replace(/_/g," ")}function vo(e){return yo(e)}function Lu(e){return yo(e)}function So(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function Du(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function _u(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function ko(e){return dt(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||Ct(t)).map(({key:t,label:a})=>({key:t,label:a}))}function Au(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function Bu(e,t,a,r){var s;return a!=="ITT"&&a!=="TTT"?((s=r.get(t))==null?void 0:s.get(e.riderId))??null:e.splitTimes[t]??null}function $o(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(s=>({label:s.key,displayLabel:s.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${s.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function Hu(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function zu(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function xo(e){const t=Vn.get(e);if(t)return t;const a=ko(e),r={splitMarkers:a,columns:$o(e,a,!1),riderById:new Map(e.riders.map(s=>[s.id,s])),teamById:new Map((e.teams??[]).map(s=>[s.id,s])),teamAbbreviationById:new Map((e.teams??[]).map(s=>[s.id,s.abbreviation])),teamNameById:new Map((e.teams??[]).map(s=>[s.id,s.name])),gcByRiderId:new Map((e.gcStandings??[]).map(s=>[s.riderId,s]))};return Vn.set(e,r),r}function To(e,t){const a=e.parentElement,r=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!r)return"";const s=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const l=document.createElement("div");return l.className="race-sim-leaderboard-toolbar",r.insertAdjacentElement("beforebegin",l),l})(),n=Ls(e),i=Hu(t),o=zu(i,n),c=it.get(e);return(c==null?void 0:c.layoutKey)===o||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(l=>l.width).join(" ")),s.innerHTML=`
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,r.innerHTML=t.map(l=>Gu(l,n)).join(""),it.set(e,{layoutKey:o,orderedRiderIds:(c==null?void 0:c.orderedRiderIds)??[],rowsByRiderId:(c==null?void 0:c.rowsByRiderId)??new Map,openDetailRiderId:(c==null?void 0:c.openDetailRiderId)??null,openTeamId:(c==null?void 0:c.openTeamId)??null})),o}function ut(e,t){e.textContent!==t&&(e.textContent=t)}function Ka(e,t){e.title!==t&&(e.title=t)}function Oa(e,t){e.className!==t&&(e.className=t)}function Wa(e,t,a){return e.lastValues[t]!==a}function ja(e,t,a){e.lastValues[t]=a}function Ls(e){const t=Un.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return Un.set(e,a),a}function Gu(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${Q(e.label)}">${Q(a)}</span>`;const r=!t.autoSort&&t.manualSortKey===e.sortKey,s=r?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
...
`)}function Zu(e){return fa(Math.max(-2.5,Math.min(2.5,e*2.5)))}function Ju(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function Io(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${Q(e.riderName)}">${Q(e.riderName)}</button>`}function qu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId)??"—",s=a.get(e.activeTeamId)??r;return`<span class="race-sim-team-code" title="${Q(s)}">${Q(r)}</span>`}function Ro(e){return`/jersey/Jer_${e}.png`}function Xu(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId);if(!r)return"—";const s=a.get(e.activeTeamId)??r.name,n=Ro(e.activeTeamId);return`
    <span class="race-sim-team-visual" title="${Q(s)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function Qu(e){return e.hasSuperform?'<span class="race-sim-special-form-dot race-sim-special-form-dot-good" title="Superform"></span>':e.hasSupermalus?'<span class="race-sim-special-form-dot race-sim-special-form-dot-bad" title="Supermalus"></span>':""}function em(e,t,a,r){var n;if(a!=="ITT"&&a!=="TTT"){const i=(n=r.get(t))==null?void 0:n.get(e.riderId);return i!=null?`${i}.`:"—"}const s=e.splitTimes[t];return s!=null?Bt(s):"—"}function Co(e,t,a){const r=Mo(e,t),s=[{label:"Terrain / Skill",value:`${vo(e.activeTerrain)} / ${Lu(e.skillName)}`},{label:"Aktiver Abschnitt",value:bo(e)},{label:"Segmenthöhe",value:Nu(e)},{label:"Basis",value:me(e.baseSkill)},{label:"Team+",value:e.teamGroupBonus>0?`+${me(e.teamGroupBonus)}`:"—"},{label:"S-Form",value:fa((t==null?void 0:t.formBonus)??0)},{label:"R-Form",value:fa((t==null?void 0:t.raceFormBonus)??0)},{label:"Fatigue",value:Yr((t==null?void 0:t.fatigueMalus)??0)},{label:"Langzeit",value:Yr((t==null?void 0:t.longTermFatigueMalus)??0)},{label:"Akut",value:Yr((t==null?void 0:t.shortTermFatigueMalus)??0)},{label:"Stamina",value:me(e.staminaPenalty)},{label:"HM",value:me(e.elevationPenalty)},{label:"T-Form",value:fa(e.dailyForm)},{label:"Zufall",value:Zu(e.microForm)},{label:"M_grad",value:`x${e.gradientModifier.toFixed(2).replace(".",",")}`},{label:"M_wind",value:`x${e.windModifier.toFixed(2).replace(".",",")}`},{label:"Draft",value:`x${e.draftModifier.toFixed(2).replace(".",",")}`},{label:"Draft Pack",value:Ju(e)},{label:"GC",value:a?String(a.rank):"—"},{label:"GC Gap",value:a?ho(a.gapSeconds):"—"}];return`
    ...
    </section>`}function tm(e,t,a,r,s,n,i){const o=document.createElement("article");o.dataset.raceSimRiderRow=String(e.riderId);const c=document.createElement("div");c.className="race-sim-row-grid",o.appendChild(c);const l=document.createElement("strong");l.className="race-sim-row-rank",l.textContent="0.",c.appendChild(l);const p=document.createElement("span");p.className="race-sim-row-flag",p.innerHTML=t?jl(_u(t)):"—",c.appendChild(p);const u=document.createElement("span");u.className="race-sim-row-name",u.innerHTML=Io(e,a),c.appendChild(u);const m=u.querySelector(".race-sim-row-name-btn");if(!m)throw new Error("race-sim-row-name-btn not found");const f=document.createElement("span");f.className="race-sim-row-team-visual",f.innerHTML=Xu(t,s,i),c.appendChild(f);const g=document.createElement("strong");g.className="race-sim-row-team",g.innerHTML=qu(t,n,i),c.appendChild(g);const v=(A="")=>{const _=document.createElement("strong");return A&&(_.className=A),c.appendChild(_),_},b=v("race-sim-gap"),h=v("race-sim-cell-effective-skill"),$=v(),I=v(),w=v(),x=r.map(()=>v()),M=v(),T=v(),E=v("race-sim-form-state-cell"),F=document.createElement("div");return F.className="race-sim-row-detail-popover hidden",o.appendChild(F),{row:o,rankField:l,nameButton:m,gapField:b,clockField:w,splitFields:x,effectiveSkillField:h,gcRankField:$,gcGapField:I,gradientPercentField:M,speedField:T,formStateField:E,detailPanel:F,initialized:!1,lastValues:{}}}function am(e,t,a,r,s,n,i,o,c,l,p){const u=(r==null?void 0:r.formBonus)??0,m=(r==null?void 0:r.raceFormBonus)??0,f=c&&l>1?p.get(a.riderId)??null:null,g=De(a),v=i!=="ITT"&&i!=="TTT"?g?"DNF":"—":a.hasStarted?g?"DNF":a.riderClockSeconds!=null?Bt(a.riderClockSeconds):"—":fo(a.startOffsetSeconds);Oa(e.row,`race-sim-row${t===1&&!g?" race-sim-row-leader":""}${s?" race-sim-row-detail-open":""}${g?" race-sim-row-dnf":""}`),ut(e.rankField,`${t}.`),ut(e.gapField,g?"DNF":go(a.gapToLeaderMeters)),ut(e.clockField,v),e.nameButton.setAttribute("aria-expanded",s?"true":"false"),Oa(e.nameButton,`race-sim-row-name-btn${a.isAttacking?" is-attacking":""}${a.isBreakaway?" is-breakaway":""}`),Ka(e.nameButton,a.isBreakaway?`${a.riderName} (Ausreißer)`:a.isAttacking?`${a.riderName} (Attacke aktiv)`:a.riderName),n.forEach((I,w)=>{const x=e.splitFields[w];if(!x)return;const M=em(a,I.key,i,o);ut(x,M),Ka(x,I.label)}),Wa(e,"effectiveSkillValue",a.effectiveSkill)&&(ut(e.effectiveSkillField,me(a.effectiveSkill)),ja(e,"effectiveSkillValue",a.effectiveSkill));const b=`race-sim-cell-effective-skill ${So(a)}`;Wa(e,"effectiveSkillClass",b)&&(Oa(e.effectiveSkillField,b),ja(e,"effectiveSkillClass",b));const h=[a.baseSkill,a.effectiveSkill,a.teamGroupBonus,u,m,a.dailyForm,a.microForm,(r==null?void 0:r.fatigueMalus)??0,(r==null?void 0:r.longTermFatigueMalus)??0,(r==null?void 0:r.shortTermFatigueMalus)??0,a.staminaPenalty].join("|");Wa(e,"effectiveSkillTitleKey",h)&&(Ka(e.effectiveSkillField,Yu(a,r)),ja(e,"effectiveSkillTitleKey",h)),ut(e.gcRankField,f?String(f.rank):"—"),ut(e.gcGapField,f?ho(f.gapSeconds):"—"),ut(e.gradientPercentField,Pu(a.gradientPercent)),Oa(e.gradientPercentField,Du(a.gradientPercent)),Ka(e.gradientPercentField,`${vo(a.activeTerrain)} · ${bo(a)}`),ut(e.speedField,Ns(a.currentSpeedMps)),e.formStateField.innerHTML=Qu(a);const $=[s?"open":"closed",a.activeTerrain,a.segmentStartKm,a.segmentEndKm,a.segmentStartElevation,a.segmentEndElevation,a.skillName,a.baseSkill,a.teamGroupBonus,u,m,(r==null?void 0:r.fatigueMalus)??0,a.staminaPenalty,a.elevationPenalty,a.dailyForm,a.microForm,a.gradientModifier,a.windModifier,a.draftModifier,a.draftNearbyRiderCount,a.draftPackFactor,(f==null?void 0:f.rank)??"—",(f==null?void 0:f.gapSeconds)??"—",a.skillBreakdown].join("|");Wa(e,"detailKey",$)&&(e.detailPanel.innerHTML=s?Co(a,r,f):"",e.detailPanel.classList.toggle("hidden",!s),ja(e,"detailKey",$)),e.detailPanel.classList.toggle("hidden",!s),e.initialized=!0}function rm(e,t){return`<button type="button" class="race-sim-row-name-btn" data-race-sim-ttt-team-toggle="${e.id}" aria-expanded="${t?"true":"false"}" title="${Q(e.name)}">${Q(e.name)}</button>`}function sm(e){const t=Ro(e.id);return`
    <span class="race-sim-team-visual" title="${Q(e.name)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function nm(e,t,a){const r=new Map;for(const s of e.riders){const n=a.get(s.riderId),i=n==null?void 0:n.activeTeamId;if(i==null)continue;const o=r.get(i)??[];o.push(s),r.set(i,o)}return t.teams.filter(s=>r.has(s.id)).map(s=>{const n=(r.get(s.id)??[]).slice().sort((p,u)=>u.effectiveSkill-p.effectiveSkill||p.riderId-u.riderId),i=n[0]??e.riders[0],o=Math.min(5,n.length),c=n.slice(0,o).reduce((p,u)=>p+u.effectiveSkill,0)/Math.max(o,1),l=Math.max(0,8-n.length);return{team:s,riders:n,representative:i,teamClockSeconds:(i==null?void 0:i.riderClockSeconds)??null,teamDistanceMeters:(i==null?void 0:i.distanceCoveredMeters)??0,teamEffectiveSkill:Math.max(1,c-l),teamSpeedMps:(i==null?void 0:i.currentSpeedMps)??0,splitTimes:(i==null?void 0:i.splitTimes)??{},finishedRiders:n.filter(p=>p.isFinished).length}}).sort((s,n)=>wo(s.representative,n.representative,ko(t))||s.team.id-n.team.id)}function im(e,t,a,r,s){return`
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${Q(e.team.name)}">
    ...
    </section>`}function om(e,t,a){var f,g;const r=performance.now(),s=xo(a),n=s.splitMarkers,i=[{label:"Pos",width:"50px",className:"race-sim-col-rank"},{label:"Team",width:"220px",className:"race-sim-col-name"},{label:"Jer",width:"46px",className:"race-sim-col-team-visual"},{label:"Abr.",width:"58px",className:"race-sim-col-team"},{label:"Gap",width:"72px"},{label:"Uhr",width:"96px"},...n.map(v=>({label:v.key,displayLabel:v.label,width:"92px",className:"race-sim-col-split"})),{label:"Eff.",width:"74px"},{label:"Speed",width:"82px"}],o=(f=it.get(e))==null?void 0:f.layoutKey,c=To(e,i),l=it.get(e)??{openDetailRiderId:null,openTeamId:null};o!=null&&o!==c&&(e.innerHTML="");const p=nm(t,a,s.riderById),u=((g=p[0])==null?void 0:g.teamDistanceMeters)??0;return e.innerHTML=p.map((v,b)=>{const h=l.openTeamId===v.team.id;return`
      <article class="race-sim-row${b===0?" race-sim-row-leader":""}${h?" race-sim-row-detail-open":""}">
        <div class="race-sim-row-grid">
          <strong class="race-sim-row-rank">${b+1}.</strong>
          <span class="race-sim-row-name">${rm(v.team,h)}</span>
          <span class="race-sim-row-team-visual">${sm(v.team)}</span>
          <strong class="race-sim-row-team"><span class="race-sim-team-code" title="${Q(v.team.name)}">${Q(v.team.abbreviation)}</span></strong>
          <strong class="race-sim-gap">${Q(go(Math.max(0,u-v.teamDistanceMeters)))}</strong>
        ...
        <div class="race-sim-row-detail-popover${h?"":" hidden"}">${h?im(v,s,a.race.isStageRace,a.stage.stageNumber,l.openDetailRiderId):""}</div>
      </article>`}).join(""),it.set(e,{layoutKey:c,orderedRiderIds:[],rowsByRiderId:new Map,openDetailRiderId:l.openDetailRiderId,openTeamId:l.openTeamId}),{totalMs:performance.now()-r,prepMs:0,sortMs:0,layoutMs:0,createRowsMs:0,removeRowsMs:0,orderCheckMs:0,reorderMs:0,visibilityMs:0,updateRowsMs:0,finalizeMs:0,rowsTotal:p.length,rowsCreated:p.length,rowsRemoved:0,rowsUpdated:p.length,rowsSkippedInvisible:0,orderChanged:1}}function qn(e,t,a){if(a.stage.profile==="TTT")return om(e,t,a);const r=performance.now(),s={totalMs:0,prepMs:0,sortMs:0,layoutMs:0,createRowsMs:0,removeRowsMs:0,orderCheckMs:0,reorderMs:0,visibilityMs:0,updateRowsMs:0,finalizeMs:0,rowsTotal:t.riders.length,rowsCreated:0,rowsRemoved:0,rowsUpdated:0,rowsSkippedInvisible:0,orderChanged:0},n=performance.now(),i=xo(a),{splitMarkers:o}=i,c=Au(t),l=Ls(e),p=l.showSplitColumns?o:[],u=it.get(e);s.prepMs=performance.now()-n;const m=performance.now(),f=ju(t.riders,a,o,c,l,i.riderById,i.gcByRiderId,i.teamAbbreviationById,(u==null?void 0:u.orderedRiderIds)??[]);s.sortMs=performance.now()-m;const g=u==null?void 0:u.layoutKey,v=performance.now(),b=To(e,$o(a,p,l.showSplitColumns));s.layoutMs=performance.now()-v;const h=it.get(e)??{orderedRiderIds:[],rowsByRiderId:new Map,openDetailRiderId:null,openTeamId:null};g!=null&&g!==b&&(e.innerHTML="",h.rowsByRiderId.clear(),h.orderedRiderIds=[]);const $=f.map(F=>F.riderId),I=new Set($),w=performance.now();for(const[F,A]of h.rowsByRiderId)I.has(F)||(A.row.remove(),h.rowsByRiderId.delete(F),s.rowsRemoved+=1);s.removeRowsMs=performance.now()-w;const x=performance.now();for(let F=0;F<f.length;F+=1){const A=f[F],_=i.riderById.get(A.riderId)??null;let z=h.rowsByRiderId.get(A.riderId);z||(z=tm(A,_,h.openDetailRiderId===A.riderId,p,i.teamById,i.teamAbbreviationById,i.teamNameById),h.rowsByRiderId.set(A.riderId,z),s.rowsCreated+=1)}s.createRowsMs=performance.now()-x;const M=performance.now(),T=h.orderedRiderIds.length===$.length&&h.orderedRiderIds.every((F,A)=>F===$[A]);s.orderCheckMs=performance.now()-M;const E=performance.now();if(!T){const F=document.createDocumentFragment();for(const A of $){const _=h.rowsByRiderId.get(A);_&&F.appendChild(_.row)}e.replaceChildren(F),s.orderChanged=1}s.reorderMs=performance.now()-E;for(let F=0;F<f.length;F+=1){const A=f[F],_=h.rowsByRiderId.get(A.riderId),z=i.riderById.get(A.riderId)??null;if(!_)continue;const O=performance.now();am(_,F+1,A,z,h.openDetailRiderId===A.riderId,p,a.stage.profile,c,a.race.isStageRace,a.stage.stageNumber,i.gcByRiderId),s.updateRowsMs+=performance.now()-O,s.rowsUpdated+=1}return it.set(e,{layoutKey:b,orderedRiderIds:$,rowsByRiderId:h.rowsByRiderId,openDetailRiderId:h.openDetailRiderId,openTeamId:h.openTeamId}),s.finalizeMs=performance.now()-(r+s.prepMs+s.sortMs+s.layoutMs+s.removeRowsMs+s.createRowsMs+s.orderCheckMs+s.reorderMs+s.visibilityMs+s.updateRowsMs),s.totalMs=performance.now()-r,s.finalizeMs=Math.max(0,s.totalMs-s.prepMs-s.sortMs-s.layoutMs-s.removeRowsMs-s.createRowsMs-s.orderCheckMs-s.reorderMs-s.visibilityMs-s.updateRowsMs),s}const lm=["Flat","Rolling","Hilly","Hilly_Difficult","Medium_Mountain","Mountain","High_Mountain","ITT","TTT","Cobble","Cobble_Hill"],dm=["Flat","Hill","Medium_Mountain","Mountain","High_Mountain","Cobble","Cobble_Hill","Abfahrt","Sprint"],Eo=["start","climb_start","climb_top","sprint_intermediate","finish_flat","finish_TT","finish_hill","finish_mountain"],Fo=["Sprint","4","3","2","1","HC"],br=.2,cm=7,um=100,mm=3,pm=50,gm=-2,fm=1,hm=2.5,bm=-3,ym=15,vm=200,Sm=600,km=850;function Ge(e){return["finish_flat","finish_TT","finish_hill","finish_mountain"].includes(e)}function yr(e){return e==="finish_hill"||e==="finish_mountain"}function vr(e){return e!=null&&["HC","1","2","3","4"].includes(e)}function Pr(e,t){return e==="climb_top"||yr(e)&&vr(t)}function Ca(e){return Math.round(e*10)/10}function Ke(e){return Number(e.toFixed(2))}function Dt(e){return`${e.toFixed(2).replace(".",",")} km`}function Po(e){return`${Math.round(e)} hm`}function $m(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,60)||"stage_details"}function Ds(e){return lm.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`).join("")}function xm(e){return dm.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`).join("")}function Tm(e,t="start",a=0,r=1){const s=Eo.filter(i=>t==="start"?i==="start"?a===0:i==="climb_start":i==="start"||i==="climb_start"?!1:Ge(i)?a===r-1:i==="climb_top"||i==="sprint_intermediate");return(s.includes(e)?s:[e,...s.filter(i=>i!==e)]).map(i=>`<option value="${i}"${i===e?" selected":""}>${S(i)}</option>`).join("")}function wm(e){return['<option value="">–</option>',...Fo.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`)].join("")}function Xn(e){return Eo.indexOf(e)}function et(e){return[...e].sort((t,a)=>Xn(t.type)-Xn(a.type))}function $a(e){if(e.length===0)return[];const t=[{kmMark:0,elevation:e[0].startElevation,terrain:e[0].terrain,techLevel:e[0].techLevel,windExp:e[0].windExp,markers:et(e[0].markers)}];let a=0;return e.forEach(r=>{a=Ke(a+r.lengthKm);const s=Math.round(r.startElevation+r.lengthKm*1e3*(r.gradientPercent/100)),n=t[t.length-1];n.terrain=r.terrain,n.techLevel=r.techLevel,n.windExp=r.windExp,n.markers=et([...n.markers,...r.markers]),t.push({kmMark:a,elevation:s,terrain:r.terrain,techLevel:r.techLevel,windExp:r.windExp,markers:et(r.endMarkers)})}),t}function Mm(e){return e?" stage-editor-input-invalid":""}function _s(e,t){const a=e.segments[t];if(!a)return[];const r=[],s=Im(e).get(t)??[];return a.lengthKm<br&&r.push(`Laenge unter ${br.toFixed(1).replace(".",",")} km.`),(a.techLevel<1||a.techLevel>10)&&r.push("Tech ausserhalb 1-10."),(a.windExp<1||a.windExp>10)&&r.push("Wind ausserhalb 1-10."),t===0&&!a.markers.some(n=>n.type==="start")&&r.push("Startmarker fehlt am ersten Segment."),t<e.segments.length-1&&a.endMarkers.some(n=>Ge(n.type))&&r.push("Finish nur am Endmarker des letzten Segments."),t>0&&a.markers.some(n=>n.type==="start")&&r.push("Startmarker nur am ersten Segment erlaubt."),t===e.segments.length-1&&!a.endMarkers.some(n=>Ge(n.type))&&r.push("Finishmarker fehlt am letzten Segmentende."),a.markers.forEach(n=>{Ge(n.type)&&r.push("Finishmarker gehoert in den Endmarker-Slot."),n.type==="climb_top"&&r.push("climb_top gehoert in den Endmarker-Slot."),n.type==="sprint_intermediate"&&r.push("Sprintmarker gehoert in den Endmarker-Slot.")}),a.endMarkers.forEach(n=>{(n.type==="start"||n.type==="climb_start")&&r.push(`${n.type} gehoert in den Startmarker-Slot.`),Pr(n.type,n.cat)&&!vr(n.cat)&&r.push(`${n.type} braucht Kategorie HC oder 1-4.`)}),[...a.markers,...a.endMarkers].forEach(n=>{n.type==="sprint_intermediate"&&n.cat!=null&&n.cat!=="Sprint"&&r.push("Sprintmarker erlaubt nur Kategorie Sprint."),Ge(n.type)&&!yr(n.type)&&n.cat!=null&&r.push("finish_flat und finish_TT duerfen keine Kategorie haben."),yr(n.type)&&n.cat!=null&&!vr(n.cat)&&r.push(`${n.type} erlaubt nur Kategorie HC oder 1-4.`)}),r.push(...s),[...new Set(r)]}function Im(e){const t=new Map,a=[],r=(s,n)=>{const i=t.get(s)??[];i.push(n),t.set(s,i)};return e.segments.forEach((s,n)=>{s.markers.forEach(i=>{i.type==="climb_start"&&a.push({name:i.name??null,segmentIndex:n})}),s.endMarkers.forEach(i=>{var l;if(!Pr(i.type,i.cat))return;if(!i.name){r(n,`${i.type} braucht einen Namen fuer die Paarbildung.`);return}let o=-1;for(let p=a.length-1;p>=0;p-=1)if(((l=a[p])==null?void 0:l.name)===i.name){o=p;break}const c=o>=0?o:a.length-1;if(c<0){r(n,`${i.type} "${i.name}" braucht einen vorherigen climb_start.`);return}a.splice(c,1)})}),a.forEach(s=>{const n=s.name?` "${s.name}"`:"";r(s.segmentIndex,`climb_start${n} braucht einen spaeteren climb_top oder kategorisierten finish_hill/finish_mountain.`)}),t}function Rm(e){return e.type==="climb_top"?{...e,cat:e.cat&&["HC","1","2","3","4"].includes(e.cat)?e.cat:"4"}:yr(e.type)?{...e,cat:vr(e.cat)?e.cat:null}:e.type==="sprint_intermediate"?{...e,cat:e.cat==="Sprint"?e.cat:"Sprint"}:{...e,cat:null}}function No(e){var a;const t={...e,segments:((a=e.segments)!=null&&a.length?e.segments:Cm(e.waypoints??[])).map(r=>({...r,startElevation:Math.round(r.startElevation),lengthKm:Number.isFinite(r.lengthKm)?Ke(r.lengthKm):br,gradientPercent:Number.isFinite(r.gradientPercent)?Ca(r.gradientPercent):0,techLevel:Number.isFinite(r.techLevel)?r.techLevel:5,windExp:Number.isFinite(r.windExp)?r.windExp:5,markers:Qn(r.markers),endMarkers:Qn(r.endMarkers)})),waypoints:[]};return Et(t),t}function Cm(e){if(e.length<2)return[];const t=[];for(let a=0;a<e.length-1;a++){const r=e[a],s=e[a+1],n=Ke(s.kmMark-r.kmMark),i=s.elevation-r.elevation,o=Ca(n>0?i/(n*10):0);t.push({startElevation:r.elevation,lengthKm:n,gradientPercent:o,techLevel:r.techLevel??5,windExp:r.windExp??5,terrain:r.terrain??"Flat",markers:r.markers??[],endMarkers:s.markers??[]})}return t}function Qn(e){return e?e.map(t=>({type:t.type,name:t.name??null,cat:t.cat??null})):[]}function Em(e,t,a){const r=e*a*8+t/12;return r>=95?"HC":r>=68?"1":r>=46?"2":r>=28?"3":"4"}function ei(e){const t=[];let a=null,r=null,s=0;const n=i=>{if(a==null||i==null||i<=a){a=null,r=null,s=0;return}const o=e[a],c=e[i],l=c.kmMark-o.kmMark,p=Math.max(0,c.elevation-o.elevation),u=l>0?p/(l*10):0;p>=um&&u>=mm&&t.push({startKm:Ke(o.kmMark),endKm:Ke(c.kmMark),distanceKm:Ke(l),gainMeters:Math.round(p),avgGradient:Ca(u),category:Em(l,p,u),startIndex:a,topIndex:i,topElevation:Math.round(c.elevation)}),a=null,r=null,s=0};for(let i=1;i<e.length;i+=1){const o=e[i-1],c=e[i],l=c.elevation-o.elevation;if(a==null&&l>0){a=i-1,r=i,s=0;continue}if(a!=null){if(l>=0){(r==null||c.elevation>=e[r].elevation)&&(r=i),s=0;continue}s+=Math.abs(l),s>=pm&&n(r)}}return n(r),t}function Fm(e){const t=e.segments.some(s=>s.terrain==="Cobble_Hill"),a=e.segments.some(s=>s.terrain==="Cobble"),r=e.climbs.some(s=>s.category==="HC"||s.category==="1");return t?"Cobble_Hill":a?"Cobble":e.totalDistanceKm<=25&&e.elevationGainMeters<250?"ITT":r&&e.elevationGainMeters>=2800?"High_Mountain":r||e.elevationGainMeters>=1800?"Mountain":e.elevationGainMeters>=1100?"Medium_Mountain":e.elevationGainMeters>=700?"Hilly":e.elevationGainMeters>=350?"Rolling":"Flat"}function Va(e){return e==="Cobble"||e==="Cobble_Hill"||e==="Sprint"}function Pm(e){return e.gainMeters>=Sm&&e.topElevation>=km?"Mountain":e.gainMeters>vm?"Medium_Mountain":"Hill"}function Nm(e){return e.gradientPercent<bm?"Abfahrt":e.gradientPercent<hm||Math.max(0,e.lengthKm*1e3*(e.gradientPercent/100))<ym?"Flat":"Hill"}function Lm(e){if(e.segments.length===0)return;if(e.waypoints=$a(e.segments),e.sourceFormat==="csv"){const i=ei(e.waypoints);e.climbs=i.map(({startIndex:o,topIndex:c,topElevation:l,...p})=>p);return}const t=e.segments.map(i=>i.manualTerrain||Va(i.terrain)?i.terrain:Nm(i)),a=ei(e.waypoints);e.climbs=a.map(({startIndex:i,topIndex:o,topElevation:c,...l})=>l),a.forEach(i=>{const o=Pm(i);if(o)for(let c=i.startIndex;c<i.topIndex;c+=1)e.segments[c].manualTerrain||Va(t[c])||(t[c]=o)});let r=null,s=0;const n=i=>{if(r==null||s<=fm){r=null,s=0;return}for(let o=r;o<i;o+=1)!(e.segments[o].manualTerrain||Va(t[o]))&&t[o]==="Flat"&&(t[o]="Abfahrt");r=null,s=0};for(let i=0;i<e.segments.length;i+=1){const o=e.segments[i];if(o&&o.gradientPercent<gm){r==null&&(r=i),s+=o.lengthKm;continue}n(i)}n(e.segments.length),e.segments.forEach((i,o)=>{Va(i.terrain)||(i.terrain=t[o])}),e.waypoints=$a(e.segments),e.suggestedProfile=Fm(e)}function Et(e){Dm(e),ti(e),Lm(e),e.waypoints=$a(e.segments),ti(e)}function Dm(e){if(e.segments.length===0){e.waypoints=[];return}let t=e.segments[0].startElevation;e.segments=e.segments.map((a,r)=>{const s={...a,startElevation:Math.round(r===0?a.startElevation:t),lengthKm:Ke(a.lengthKm),gradientPercent:Ca(a.gradientPercent),markers:et(a.markers),endMarkers:et(a.endMarkers)};return t=Math.round(s.startElevation+s.lengthKm*1e3*(s.gradientPercent/100)),s}),e.waypoints=$a(e.segments)}function ti(e){e.totalDistanceKm=Ke(e.segments.reduce((t,a)=>t+a.lengthKm,0)),e.elevationGainMeters=e.waypoints.reduce((t,a,r)=>{if(r===0)return 0;const s=a.elevation-e.waypoints[r-1].elevation;return t+Math.max(0,s)},0)}function bt(e){const t=e.segments[0],a=e.segments[e.segments.length-1];!t||!a||(t.markers.some(r=>r.type==="start")||(t.markers=et([{type:"start",name:null,cat:null},...t.markers])),a.endMarkers.some(r=>Ge(r.type))||(a.endMarkers=et([...a.endMarkers,{type:"finish_flat",name:null,cat:null}])),e.waypoints=$a(e.segments))}function _m(e,t,a,r){return e.length===0?"":`<div class="stage-editor-marker-list">${e.map((s,n)=>{const i=r==="start"&&t===0&&s.type==="start",o=e.filter(p=>Ge(p.type)).length,c=r==="end"&&t===a-1&&Ge(s.type)&&o===1,l=!(i||c);return`
      <div class="stage-editor-marker-row">
        ...
        <select data-field="markerCat" data-marker-scope="${r}" data-marker-index="${n}">${wm(s.cat)}</select>
    ...
    </div>`}function Am(e,t,a,r,s){if(!d.stageEditorDraft)return;const n=d.stageEditorDraft.segments[e];if(!n)return;const i=a==="start"?n.markers:n.endMarkers,o=i[t];if(o){if(r==="markerType"){o.type=s;const c=Rm(o);if(o.name=c.name,o.cat=c.cat,Ge(o.type)){const l=i.filter((p,u)=>u===t||!Ge(p.type));a==="start"?n.markers=l:n.endMarkers=l}}else r==="markerName"?o.name=s.trim()||null:r==="markerCat"&&(o.cat=s||null);a==="start"?n.markers=et(n.markers):n.endMarkers=et(n.endMarkers),Et(d.stageEditorDraft),bt(d.stageEditorDraft),pe()}}function Bm(e,t){if(!d.stageEditorDraft)return;const a=d.stageEditorDraft.segments[e];if(!a)return;const r=t==="start"?e===0&&!a.markers.some(s=>s.type==="start")?{type:"start",name:"Start",cat:null}:{type:"climb_start",name:null,cat:null}:e===d.stageEditorDraft.segments.length-1&&!a.endMarkers.some(s=>Ge(s.type))?{type:"finish_flat",name:"Ziel",cat:null}:{type:"sprint_intermediate",name:null,cat:"Sprint"};t==="start"?(a.markers.push(r),a.markers=et(a.markers)):(a.endMarkers.push(r),a.endMarkers=et(a.endMarkers)),Et(d.stageEditorDraft),bt(d.stageEditorDraft),pe()}function Hm(e,t,a){if(!d.stageEditorDraft)return;const r=d.stageEditorDraft.segments[e];r&&(a==="start"?r.markers.splice(t,1):r.endMarkers.splice(t,1),Et(d.stageEditorDraft),bt(d.stageEditorDraft),pe())}let qt=0,Xt=0;async function zm(){y("stage-editor-profile").innerHTML=Ds("Flat"),y("stage-editor-chart").innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>',y("stage-editor-climbs").innerHTML='<p class="text-muted">Climb-Vorschläge erscheinen nach dem Import.</p>';const[e,t,a]=await Promise.all([V.listStageEditorCountries(),V.listStageEditorRaceCategories(),V.listStageEditorRacePrograms()]);if(e.success&&e.data){const r=y("stage-editor-race-country");r.innerHTML=e.data.map(s=>`<option value="${s.id}">${S(s.name)} (${S(s.code3)})</option>`).join("")}if(t.success&&t.data){const r=y("stage-editor-race-category");r.innerHTML=t.data.map(s=>`<option value="${s.id}">${S(s.name)}</option>`).join("")}a.success&&a.data&&(d.stageEditorPrograms=a.data,Gm())}function Gm(){const e=y("stage-editor-programs-list");d.stageEditorPrograms&&(e.innerHTML=d.stageEditorPrograms.map(t=>`
    ...
    `).join(""))}function Km(){const e=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked'),t=y("stage-editor-programs-selected-text");if(e.length===0)t.textContent="Keine Programme ausgewählt",t.classList.add("text-muted");else{const a=Array.from(e).map(r=>{var n;const s=(n=d.stageEditorPrograms)==null?void 0:n.find(i=>String(i.id)===r.value);return s?s.name:r.value});t.textContent=`${e.length} ausgewählt: ${a.join(", ")}`,t.classList.remove("text-muted")}}function As(e){return Math.round(e.startElevation+e.lengthKm*1e3*(e.gradientPercent/100))}function Lo(){const e=d.stageEditorExistingStages.map(t=>t.stageId);return e.length>0?Math.max(...e)+1:1}function Om(){const e=[...d.stageEditorExistingStages.map(t=>t.raceId),...d.races.map(t=>t.id)];return e.length>0?Math.max(...e)+1:1}function Wm(e,t){let a=e;const r=new Set(d.stageEditorExistingStages.map(s=>s.stageId));for(;a>0&&r.has(a);)a+=t;if(a<=0)for(a=1;r.has(a);)a+=1;return a}function jm(e,t){let a=e;const r=new Set([...d.stageEditorExistingStages.map(s=>s.raceId),...d.races.map(s=>s.id)]);for(;a>0&&r.has(a);)a+=t;if(a<=0)for(a=1;r.has(a);)a+=1;return a}function Vm(e){var o;const t=y("stage-editor-profile");t.innerHTML=Ds(e.suggestedProfile),t.value=e.suggestedProfile;const a=Lo(),r=Om();y("stage-editor-stage-id").value=String(a),y("stage-editor-race-id").value=String(r),qt=a,Xt=r;const s=y("stage-editor-details-file");s.value.trim()||(s.value=`${$m(e.routeName)}.csv`);const n=y("stage-editor-date");!n.value&&((o=d.gameState)!=null&&o.currentDate)&&(n.value=d.gameState.currentDate),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(c=>{c.checked=!0})}function Um(e){y("stage-editor-stage-id").value=String(e.stageId),y("stage-editor-race-id").value=String(e.raceId),qt=e.stageId,Xt=e.raceId,y("stage-editor-stage-number").value=String(e.stageNumber),y("stage-editor-date").value=e.date,y("stage-editor-details-file").value=e.detailsCsvFile;const t=y("stage-editor-profile");t.innerHTML=Ds(e.profile),t.value=e.profile,y("stage-editor-final-spread-start").value=String(e.finalSpreadStartPercent),y("stage-editor-final-push-start").value=String(e.finalPushStartPercent),y("stage-editor-final-spread-difficulty").value=String(e.finalSpreadDifficultyMultiplier),y("stage-editor-crash-multiplier").value=String(e.crashIncidentMultiplier),y("stage-editor-mechanical-multiplier").value=String(e.mechanicalIncidentMultiplier);const a=(e.allowedWeather||"1|2|3|4|5|6|7").split("|").map(s=>s.trim());document.querySelectorAll('input[name="stage-editor-weather"]').forEach(s=>{s.checked=a.includes(s.value)})}function Do(e){var r;if(!e)return["Noch keine Strecke importiert."];const t=[];return e.segments.length===0?(t.push("Mindestens ein Segment ist erforderlich."),t):((r=e.segments[0])!=null&&r.markers.some(s=>s.type==="start")||t.push("Das erste Segment muss als Start markiert sein."),(e.segments[e.segments.length-1].endMarkers??[]).some(s=>Ge(s.type))||t.push("Das letzte Segment muss per Endmarker als Ziel markiert sein."),e.segments.forEach((s,n)=>{_s(e,n).forEach(i=>{t.push(`Segment ${n+1}: ${i}`)}),[...s.markers??[],...s.endMarkers??[]].forEach(i=>{i.cat!=null&&!Fo.includes(i.cat)&&t.push(`Segment ${n+1}: Ungültige Marker-Kategorie ${i.cat}.`)})}),t)}function _o(){const e=[],t=Number(y("stage-editor-stage-id").value),a=Number(y("stage-editor-race-id").value),r=Number(y("stage-editor-stage-number").value),s=y("stage-editor-date").value.trim(),n=y("stage-editor-details-file").value.trim(),i=Number(y("stage-editor-final-spread-start").value),o=Number(y("stage-editor-final-push-start").value),c=Number(y("stage-editor-final-spread-difficulty").value),l=Number(y("stage-editor-crash-multiplier").value),p=Number(y("stage-editor-mechanical-multiplier").value);(!Number.isInteger(t)||t<=0)&&e.push("Stage-ID fehlt oder ist ungültig."),(!Number.isInteger(a)||a<=0)&&e.push("Race-ID fehlt oder ist ungültig."),(!Number.isInteger(r)||r<=0)&&e.push("Etappennummer fehlt oder ist ungültig."),/^\d{4}-\d{2}-\d{2}$/.test(s)||e.push("Datum muss im Format YYYY-MM-DD vorliegen."),(!/^[A-Za-z0-9_.-]+\.csv$/.test(n)||n.includes("/"))&&e.push("Details-Datei muss ein Dateiname mit .csv-Endung ohne Pfad sein."),(!Number.isFinite(i)||i<0||i>100)&&e.push("Final Spread Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(o)||o<0||o>100)&&e.push("Final Push Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(c)||c<=0)&&e.push("Final Spread Multiplikator muss groesser als 0 sein."),(!Number.isFinite(l)||l<=0)&&e.push("Sturz-Multiplikator muss groesser als 0 sein."),(!Number.isFinite(p)||p<=0)&&e.push("Defekt-Multiplikator muss groesser als 0 sein."),document.querySelectorAll('input[name="stage-editor-weather"]:checked').length===0&&e.push("Mindestens eine Wetterart muss ausgewählt sein."),d.stageEditorExistingStages.map(b=>b.stageId).includes(t)&&e.push(`Die Stage-ID ${t} existiert bereits in stages.csv.`);const f=y("stage-editor-new-race-checkbox").checked,g=[...d.stageEditorExistingStages.map(b=>b.raceId),...d.races.map(b=>b.id)];if(f){g.includes(a)&&e.push(`Die Race-ID ${a} existiert bereits.`);const b=y("stage-editor-race-name").value.trim(),h=Number(y("stage-editor-race-country").value),$=Number(y("stage-editor-race-category").value),I=Number(y("stage-editor-race-num-stages").value),w=y("stage-editor-race-start-date").value.trim(),x=y("stage-editor-race-end-date").value.trim(),M=Number(y("stage-editor-race-prestige").value);b||e.push("Rennname fehlt."),(!Number.isInteger(h)||h<=0)&&e.push("Land fehlt oder ist ungültig."),(!Number.isInteger($)||$<=0)&&e.push("Kategorie fehlt oder ist ungültig."),(!Number.isInteger(I)||I<=0)&&e.push("Etappenanzahl muss eine positive Ganzzahl sein."),/^\d{4}-\d{2}-\d{2}$/.test(w)||e.push("Startdatum muss im Format YYYY-MM-DD vorliegen."),/^\d{4}-\d{2}-\d{2}$/.test(x)||e.push("Enddatum muss im Format YYYY-MM-DD vorliegen."),(!Number.isInteger(M)||M<1||M>100)&&e.push("Prestige muss zwischen 1 und 100 liegen.")}else g.includes(a)||e.push(`Die Race-ID ${a} existiert nicht. Wenn Sie ein neues Rennen erstellen möchten, aktivieren Sie bitte 'Neues Rennen anlegen'.`);return y("stage-editor-program-checkbox").checked&&document.querySelectorAll('input[name="stage-editor-program-selection"]:checked').length===0&&e.push("Mindestens ein Programm muss ausgewählt sein."),e}function Ym(){var a,r;const e=document.querySelectorAll('input[name="stage-editor-weather"]:checked'),t=Array.from(e).map(s=>s.value).join("|");return{stageId:Number(y("stage-editor-stage-id").value),raceId:Number(y("stage-editor-race-id").value),stageNumber:Number(y("stage-editor-stage-number").value),date:y("stage-editor-date").value.trim(),profile:y("stage-editor-profile").value,detailsCsvFile:y("stage-editor-details-file").value.trim(),startElevation:((r=(a=d.stageEditorDraft)==null?void 0:a.segments[0])==null?void 0:r.startElevation)??0,finalSpreadStartPercent:Number(y("stage-editor-final-spread-start").value),finalPushStartPercent:Number(y("stage-editor-final-push-start").value),finalSpreadDifficultyMultiplier:Number(y("stage-editor-final-spread-difficulty").value),crashIncidentMultiplier:Number(y("stage-editor-crash-multiplier").value),mechanicalIncidentMultiplier:Number(y("stage-editor-mechanical-multiplier").value),allowedWeather:t}}function Zm(e){return["distanceKm","elevationGainMeters","sprintCount","climbCount","profileScore"].includes(e)?"desc":"asc"}function Jm(e){return["gainMeters","elevationAtTop","distanceKm","avgGradient","maxGradient","climbScore"].includes(e)?"desc":"asc"}function Nr(e,t,a){const s=(Math.max(t,Math.min(a,e))-t)/Math.max(1,a-t),n=Math.round(124-s*118),i=54,o=.14+s*.12,c=.26+s*.18;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${n};--stage-editor-score-lightness:${i}%;--stage-editor-score-bg-alpha:${o};--stage-editor-score-border-alpha:${c};`}">${Math.round(e)}</span>`}function Bs(e){let t;e<=100?t=e/100*.45:e<=250?t=.45+(e-100)/150*.35:t=.8+Math.min(e-250,100)/100*.2;const a=Math.round(122-t*122),r=Math.round(40-t*22),s=.18+t*.3,n=.3+t*.4;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${s};--stage-editor-score-border-alpha:${n};`}">${Math.round(e)}</span>`}function qm(e){if(e==null)return'<span class="stage-editor-category-empty">—</span>';const t=e==="HC"?"is-hc":`is-cat-${e}`,a=e==="HC"?"HC":String(e);return`<span class="stage-editor-climb-category-badge ${t}">${a}</span>`}function Xm(e,t,a,r){const s=r!=null?` data-stage-profile-open-climb-id="${S(r)}"`:"";return`<button class="dashboard-stage-profile-link" type="button" data-stage-profile-open-stage-id="${t}"${s}>${e}</button>`}function Qm(e){const t=i=>i!=null?`${i.toFixed(1).replace(".",",")} km`:"—",a=i=>i!=null?`${Math.round(i).toLocaleString("de-DE")} m`:"—",r=e.profileScore??e.score,s=[...d.stageEditorClimbRows??[]].filter(i=>i.stageId===e.stageId).sort((i,o)=>i.climbIndex-o.climbIndex),n=s.length===0?'<div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-compact"><span class="text-muted" style="grid-column:1/-1">Keine Bergwertungen</span></div>':`
    ...
    <div class="stage-editor-score-popover-card">
      ...
      ${n}
    </div>`}function ep(e){const t=s=>s!=null?`${s.toFixed(1).replace(".",",")} km`:"—",a=s=>s!=null?`${Math.round(s).toLocaleString("de-DE")} m`:"—",r=s=>s!=null?`${s.toFixed(1).replace(".",",")} %`:"—";return`
    <div class="stage-editor-score-popover-card">
      <div class="stage-editor-score-popover-head">
    ...
    <tr>
      ...
      <td>${Ao(c.profileScore,0,100,c.stageId,Qm(c),Ar({name:c.raceName},{stageNumber:c.stageNumber,profile:c.profile}))}</td>
      <td>${Pa(c.profile)}</td>
    ...
    </tr>`);const o=rp(d.stageEditorClimbRows);s.innerHTML=o.map(c=>`
    <tr>
      <td>${c.placementKm.toFixed(1).replace(".",",")} km</td>
      <td><strong>${S(c.name)}</strong></td>
      <td>${qm(c.category)}</td>
      <td>${Ao(c.climbScore,0,350,c.stageId,ep(c),Ar({name:c.raceName},{stageNumber:c.stageNumber,profile:"Mountain"}),c.id,Bs(c.climbScore))}</td>
      <td>${oe(c.countryCode||"")}</td>
      <td><strong>${S(c.raceName)}</strong></td>
      <td><strong>${S(Fa({stageNumber:c.stageNumber}))}</strong></td>
        ...
        ${g.map(I=>`
          <div class="stage-editor-climb" style="padding: 0.5rem; background: rgba(255,255,255,0.03); border-radius: var(--radius-sm); border-left: 3px solid var(--accent);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem;">
              <strong style="color: #fff; font-size: 0.85rem;">${S(I.name)}</strong>
              <span class="stage-editor-climb-category-badge ${I.category==="HC"?"is-hc":`is-cat-${I.category}`}" style="font-size: 0.7rem; padding: 0.1rem 0.35rem;">
                Kat. ${S(I.category)}
              </span>
            </div>
            <div style="font-size: 0.75rem; color: var(--text-300); display: flex; flex-wrap: wrap; gap: 0.5rem;">
              <span>${Dt(I.startKm)} - ${Dt(I.endKm)}</span>
              <span>·</span>
              <span><strong>${I.distanceKm.toFixed(1).replace(".",",")} km</strong></span>
              <span>·</span>
              <span><strong>${I.gainMeters} hm</strong></span>
              <span>·</span>
              <span><strong>${I.avgGradient.toFixed(1).replace(".",",")}%</strong></span>
            </div>
          </div>
        `).join("")}
      </div>
    ...
    `;const h=y("stage-editor-hide-boring-segments-checkbox");h&&(h.checked=d.stageEditorHideBoringSegments),r.innerHTML=b,n.innerHTML=ri(e);const $=op(e);i.innerHTML=e.segments.map((I,w)=>{const x=d.stageEditorHideBoringSegments&&lp(e,w,$);return`
    <tr data-segment-index="${w}" class="${_s(e,w).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;${x?" display: none;":""}">
      <td class="stage-editor-cell-nr text-muted" style="text-align:center; font-weight:700;">${w+1}</td>
      <td class="stage-editor-cell-length"><input type="number" step="0.01" min="0.2" value="${I.lengthKm.toFixed(2)}" data-field="segmentLengthKm" class="${Mm(I.lengthKm<br)}"></td>
      <td class="stage-editor-cell-gradient"><input type="number" step="0.1" value="${I.gradientPercent.toFixed(1)}" data-field="segmentGradientPercent"></td>
      <td class="stage-editor-cell-terrain"><select data-field="terrain">${xm(I.terrain)}</select></td>
      <td class="stage-editor-cell-start-markers">
        ${ai(I.markers,w,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${ai(I.endMarkers,w,e.segments.length,"end")}
      </td>
      <td class="stage-editor-row-actions">
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          <div class="text-muted" style="min-width:3.5rem;">${As(I)} m</div>
          ${dp(e,w)}
    ...
    </svg>`}function cp(e,t,a){const r=d.stageEditorDraft;if(!r)return;const s=r.segments[e];s&&(t==="startElevation"?s.startElevation=Math.max(-500,Math.min(9e3,Number.parseInt(a||"0",10))):t==="lengthKm"?s.lengthKm=Math.max(.01,Number.parseFloat(a||"0.1")):t==="gradientPercent"?s.gradientPercent=Number.parseFloat(a||"0"):t==="terrain"?(s.terrain=a,s.manualTerrain=!0):t==="techLevel"?s.techLevel=Math.max(1,Math.min(10,Number.parseInt(a||"5",10))):t==="windExp"&&(s.windExp=Math.max(1,Math.min(10,Number.parseInt(a||"5",10)))),Et(r),bt(r),pe())}function up(e){const t=d.stageEditorDraft;if(!t)return;const a=t.segments[e];if(!a)return;const r={startElevation:a.startElevation,lengthKm:1,gradientPercent:0,techLevel:5,windExp:5,terrain:"Flat",markers:[],endMarkers:[]};t.segments.splice(e,0,r),Et(t),bt(t),pe()}function mp(){const e=d.stageEditorDraft;if(!e)return;const t=e.segments[e.segments.length-1],r={startElevation:t?As(t):100,lengthKm:1,gradientPercent:0,techLevel:5,windExp:5,terrain:"Flat",markers:[],endMarkers:[]};e.segments.push(r),Et(e),bt(e),pe()}function pp(e){const t=d.stageEditorDraft;t&&(t.segments.length<=1||(t.segments.splice(e,1),Et(t),bt(t),pe()))}async function gp(){var a;const t=(a=y("stage-editor-file").files)==null?void 0:a[0];if(!t){alert("Bitte zuerst eine GPX- oder TCX-Datei auswählen.");return}y("stage-editor-file-hint").textContent=`${t.name} · ${(t.size/1024).toFixed(1).replace(".",",")} KB`,$e("Route wird importiert……");try{const r=await t.text(),s=await V.importStageRoute({fileName:t.name,fileContent:r});if(!s.success||!s.data){alert(`Import fehlgeschlagen: ${s.error??"Unbekannter Fehler"}`);return}const n=No(s.data);d.stageEditorDraft=n,bt(n),Vm(n),pe(),Rt("stage-editor")}finally{ye()}}async function fp(){const e=Number(y("stage-editor-existing-stage").value);if(!Number.isInteger(e)||e<=0){alert("Bitte zuerst eine vorhandene CSV-Stage auswählen.");return}$e("CSV-Stage wird geladen...");try{const t=await V.loadStageEditorStage(e);if(!t.success||!t.data){alert(`Stage konnte nicht geladen werden: ${t.error??"Unbekannter Fehler"}`);return}const a=No(t.data.draft);d.stageEditorDraft=a,bt(a),Um(t.data.metadata),pe(),Rt("stage-editor")}finally{ye()}}async function hp(){if(!d.stageEditorDraft){alert("Es gibt noch keine importierte oder geladene Strecke.");return}const e=[...Do(d.stageEditorDraft),..._o()];if(e.length>0){alert(`Export blockiert:

${e.join(`
`)}`),pe();return}const t=y("stage-editor-new-race-checkbox").checked,a=y("stage-editor-program-checkbox").checked;let r;t&&(r={name:y("stage-editor-race-name").value.trim(),countryId:Number(y("stage-editor-race-country").value),categoryId:Number(y("stage-editor-race-category").value),isStageRace:Number(y("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(y("stage-editor-race-num-stages").value),startDate:y("stage-editor-race-start-date").value.trim(),endDate:y("stage-editor-race-end-date").value.trim(),prestige:Number(y("stage-editor-race-prestige").value)});let s;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');s=Array.from(n).map(i=>Number(i.value))}$e("CSV-Dateien werden erstellt……");try{const n=await V.exportStageRoute({metadata:Ym(),draft:d.stageEditorDraft,newRace:t,raceDetails:r,updatePrograms:a,programIds:s});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}cr(n.data.stagesFileName,n.data.stagesCsv),cr(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=y("stage-editor-stage-number"),o=Number(i.value)||1;i.value=String(o+1);const c=y("stage-editor-date"),l=c.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const b=new Date(l);b.setDate(b.getDate()+1);const h=b.getFullYear(),$=String(b.getMonth()+1).padStart(2,"0"),I=String(b.getDate()).padStart(2,"0");c.value=`${h}-${$}-${I}`}await Promise.all([Bo(!0),tp(!0)]);const p=Lo();y("stage-editor-stage-id").value=String(p),qt=p;const u=y("stage-editor-new-race-checkbox");u&&(u.checked=!1);const m=y("stage-editor-new-race-details");m&&(m.classList.add("hidden"),m.style.display="none");const f=y("stage-editor-program-checkbox");f&&(f.checked=!1);const g=y("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),Xt=Number(y("stage-editor-race-id").value),pe()}finally{ye()}}function bp(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",x=>{const M=x.target.closest("button[data-stage-profile-open-stage-id]");if(M){const F=Number(M.dataset.stageProfileOpenStageId);Number.isFinite(F)&&xr(F);return}const T=x.target.closest("button[data-stage-editor-stages-sort]");if(!T)return;const E=T.dataset.stageEditorStagesSort;d.stageEditorStagesSort.key===E?d.stageEditorStagesSort.direction=d.stageEditorStagesSort.direction==="asc"?"desc":"asc":d.stageEditorStagesSort={key:E,direction:Zm(E)},ca()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",x=>{const M=x.target.closest("button[data-stage-profile-open-stage-id]");if(M){const F=Number(M.dataset.stageProfileOpenStageId),A=M.dataset.stageProfileOpenClimbId??null;if(Number.isFinite(F)){let _=null;A&&d.stageEditorClimbRows&&(_=d.stageEditorClimbRows.find(z=>z.id===A)??null),xr(F,_)}return}const T=x.target.closest("button[data-stage-editor-climbs-sort]");if(!T)return;const E=T.dataset.stageEditorClimbsSort;d.stageEditorClimbsSort.key===E?d.stageEditorClimbsSort.direction=d.stageEditorClimbsSort.direction==="asc"?"desc":"asc":d.stageEditorClimbsSort={key:E,direction:Jm(E)},ua()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{gp()});const r=document.getElementById("btn-stage-editor-load-existing");r&&r.addEventListener("click",()=>{fp()});const s=document.getElementById("btn-stage-editor-export");s&&s.addEventListener("click",()=>{hp()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",x=>{var T;const M=((T=x.target.files)==null?void 0:T[0])??null;y("stage-editor-file-hint").textContent=M?`${M.name} · ${(M.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",x=>{const M=x.target,T=M.closest("tr[data-segment-index]"),E=M.dataset.field;if(!T||!E)return;const F=Number(T.dataset.segmentIndex);if(Number.isInteger(F)){if(E==="markerType"||E==="markerName"||E==="markerCat"){const A=Number(M.dataset.markerIndex),_=M.dataset.markerScope;if(!Number.isInteger(A)||_!=="start"&&_!=="end")return;Am(F,A,_,E,M.value);return}cp(F,E,M.value)}}),i.addEventListener("click",x=>{const M=x.target.closest("button[data-segment-action]");if(!M)return;const T=Number(M.dataset.segmentIndex);if(Number.isInteger(T)){if(M.dataset.segmentAction==="insert"){up(T);return}if(M.dataset.segmentAction==="append"){mp();return}if(M.dataset.segmentAction==="add-marker"){const E=M.dataset.markerScope;if(E!=="start"&&E!=="end")return;Bm(T,E);return}if(M.dataset.segmentAction==="remove-marker"){const E=Number(M.dataset.markerIndex),F=M.dataset.markerScope;if(!Number.isInteger(E)||F!=="start"&&F!=="end")return;Hm(T,E,F);return}M.dataset.segmentAction==="delete"&&pp(T)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(x=>{const M=document.getElementById(x);M&&M.addEventListener("change",()=>pe())}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(x=>{x.addEventListener("change",()=>pe())});const c=y("stage-editor-new-race-checkbox"),l=y("stage-editor-new-race-details"),p=y("stage-editor-program-checkbox"),u=y("stage-editor-program-details");c&&c.addEventListener("change",()=>{c.checked?(l&&(l.classList.remove("hidden"),l.style.display="grid"),p&&(p.checked=!0,u&&(u.classList.remove("hidden"),u.style.display="block"))):l&&(l.classList.add("hidden"),l.style.display="none"),pe()}),p&&p.addEventListener("change",()=>{p.checked?u&&(u.classList.remove("hidden"),u.style.display="block"):u&&(u.classList.add("hidden"),u.style.display="none"),pe()});const m=y("stage-editor-programs-dropdown-trigger"),f=y("stage-editor-programs-dropdown-menu"),g=y("btn-stage-editor-programs-ok");m&&f&&(m.addEventListener("click",x=>{x.stopPropagation();const M=f.style.display==="none"||!f.style.display;f.style.display=M?"flex":"none"}),g&&g.addEventListener("click",x=>{x.stopPropagation(),f.style.display="none",pe()}),document.addEventListener("click",x=>{const M=x.target;f.style.display==="flex"&&!f.contains(M)&&M!==m&&!m.contains(M)&&(f.style.display="none",pe())}));const v=y("stage-editor-programs-list");v&&v.addEventListener("change",x=>{x.target.name==="stage-editor-program-selection"&&Km()});let b=!1,h=null;const $=y("stage-editor-stage-id"),I=y("stage-editor-race-id");if($&&I){[$,I].forEach(M=>{M.addEventListener("keydown",T=>{T.key!=="ArrowUp"&&T.key!=="ArrowDown"&&(b=!0,h&&clearTimeout(h))}),M.addEventListener("keyup",T=>{T.key!=="ArrowUp"&&T.key!=="ArrowDown"&&(h&&clearTimeout(h),h=setTimeout(()=>{b=!1},150))}),M.addEventListener("blur",()=>{b=!1})});const x=(M,T)=>{const E=Number(M.value);if(!Number.isInteger(E)||E<=0){T==="stage"?qt=E:Xt=E;return}const A=E-(T==="stage"?qt:Xt);if(!b&&(A===1||A===-1)){let _=E;T==="stage"?_=Wm(E,A):y("stage-editor-new-race-checkbox").checked&&(_=jm(E,A)),M.value=String(_)}T==="stage"?qt=Number(M.value):Xt=Number(M.value)};$.addEventListener("input",()=>{x($,"stage"),pe()}),I.addEventListener("input",()=>{x(I,"race"),pe()})}const w=y("stage-editor-hide-boring-segments-checkbox");w&&w.addEventListener("change",()=>{d.stageEditorHideBoringSegments=w.checked,pe()})}let pt=[],Ut=null,He={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const Kt=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"],si={1:{pref:[1,2],malus:[4,7],neutral:[3,5,6]},2:{pref:[3,5],malus:[2,7],neutral:[1,4,6]},3:{pref:[4,7],malus:[2,5],neutral:[1,3,6]},4:{pref:[6,7],malus:[2,5],neutral:[1,3,4]},5:{pref:[1,5],malus:[6,7],neutral:[2,3,4]},6:{pref:[1,3],malus:[4,7],neutral:[2,5,6]},7:{pref:[3,4],malus:[2,7],neutral:[1,5,6]}},ni={1:"Sonnig",2:"Extreme Hitze",3:"Leichter Regen",4:"Starkregen",5:"Starker Wind",6:"Dichter Nebel",7:"Schnee/Eis"};function xa(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
    ...
    <div class="rider-stats-header-grid">
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill" title="Formphase">${Is(u)} <span>Form</span></span>
        ${N}
      </div>
      <div class="rider-stats-header-col align-left">
      ...
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width ${b>14?"text-warning":""}" title="30-Tage Renntage">${re.rollingRaceDays} <span class="rider-stats-icon-pill-value">${b}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Langzeit-Fatigue">${re.longFatigue} <span class="rider-stats-icon-pill-value">${h}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width ${I!=="none"?"text-error":""}" title="Kurzzeitfatigue">${re.shortFatigue} <span class="rider-stats-icon-pill-value">${$}</span></span>
      </div>
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonpunkte">${re.seasonPoints} <span class="rider-stats-icon-pill-value">${w}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonplatzierung">${re.rank} <span class="rider-stats-icon-pill-value">${vp(x)}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Renntage">${re.raceDays} <span class="rider-stats-icon-pill-value">${M}</span></span>
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Siege">${re.wins} <span class="rider-stats-icon-pill-value">${T}</span></span>
      </div>
      <div class="rider-stats-header-col align-left">
      ...
      <div class="rider-stats-header-col align-left">
        ${vt(re.stageRace,"Rundfahrten Punkte",_.stageRace,z)}
        ${vt(re.oneDay,"Eintagesrennen Punkte",_.oneDay,z)}
      ...
      <div class="rider-stats-header-col align-left">
        ${vt(re.flat,"Flach-Punkte",F.flat,A)}
        ${vt(re.hilly,"Hügel-Punkte",F.hilly,A)}
        ${vt(re.mediumMountain,"Mittelgebirge-Punkte",F.mediumMountain,A)}
      </div>
      <div class="rider-stats-header-col align-left">
        ${vt(re.mountain,"Hochgebirge-Punkte",F.mountain,A)}
        ${vt(re.timetrial,"Zeitfahren-Punkte",F.timetrial,A)}
        ${vt(re.cobble,"Kopfsteinpflaster-Punkte",F.cobble,A)}
      </div>
    </div>
  `}function oi(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",r=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(r)}</strong>`}function je(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </div>`}function Tp(e){const t=[{score:55,hue:0,lightness:28},{score:60,hue:0,lightness:40},{score:68,hue:30,lightness:42},{score:74,hue:60,lightness:42},{score:80,hue:120,lightness:36}];let a=120,r=36;const s=Math.max(55,Math.min(80,e));for(let c=1;c<t.length;c++){const l=t[c-1],p=t[c];if(s<=p.score){const u=(s-l.score)/(p.score-l.score);a=Math.round(l.hue+(p.hue-l.hue)*u),r=Math.round(l.lightness+(p.lightness-l.lightness)*u);break}}return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${.44};--stage-editor-score-border-alpha:${.72};`}">${e.toFixed(0)}</span>`}function wp(e,t){const a=(e==null?void 0:e.skills)??{mountain:60,hill:60,sprint:60,timeTrial:60,cobble:60,attack:60,mediumMountain:60,flat:60,prologue:60,acceleration:60},r=["mountain","hill","sprint","timeTrial","cobble","attack"],s=["Berg (MTN)","Hügel (HIL)","Sprint (SPR)","Zeitfahren (TT)","Pflaster (COB)","Angriff (ATT)"],n=540,i=440,o=n/2,c=i/2,l=160,p=60,u=85,m=u-p,f=_=>{const z=[];for(let O=0;O<6;O++){const G=O*Math.PI/3-Math.PI/2;z.push(`${o+_*Math.cos(G)},${c+_*Math.sin(G)}`)}return z},g=`
    <defs>
    ...
    </defs>`,v=`<circle cx="${o}" cy="${c}" r="${l+8}" fill="url(#radarBgGrad)" stroke="rgba(255,255,255,0.06)" stroke-width="1" />`;let b="";for(let _=p;_<=u;_+=2.5){const z=l*((_-p)/m);if(z<1){b+=`<circle cx="${o}" cy="${c}" r="2" fill="rgba(255,255,255,0.25)" />`;continue}const O=f(z),G=_%5===0,C=G?1:.6,H=G?"none":"4,4",U=G?.4:.18;b+=`<polygon points="${O.join(" ")}" fill="none" stroke="rgba(255,255,255,${U})" stroke-width="${C}" stroke-dasharray="${H}" />`,G&&_>p&&(b+=`<text x="${o+5}" y="${c-z+4}" fill="rgba(255,255,255,0.45)" font-size="9" font-family="Inter, sans-serif" text-anchor="start">${_}</text>`)}let h="",$="";for(let _=0;_<6;_++){const z=_*Math.PI/3-Math.PI/2,O=o+l*Math.cos(z),G=c+l*Math.sin(z);h+=`<line x1="${o}" y1="${c}" x2="${O}" y2="${G}" stroke="rgba(255,255,255,0.15)" stroke-width="1" />`;const C=l+28,H=o+C*Math.cos(z),U=c+C*Math.sin(z),j=Math.cos(z);let X="middle";j>.15?X="start":j<-.15&&(X="end");const J=a[r[_]]??p;$+=`<text x="${H}" y="${U}" fill="rgba(255,255,255,0.92)" font-size="11.5" font-weight="700" font-family="Inter, sans-serif" text-anchor="${X}" dominant-baseline="middle">${s[_]}</text>`,$+=`<text x="${H}" y="${U+14}" fill="rgba(255,255,255,0.50)" font-size="10" font-weight="500" font-family="Inter, sans-serif" text-anchor="${X}" dominant-baseline="middle">${J}</text>`}const I=[],w=[];r.forEach((_,z)=>{const O=a[_]??p,G=l*((Math.max(p,Math.min(u,O))-p)/m),C=z*Math.PI/3-Math.PI/2,H=o+G*Math.cos(C),U=c+G*Math.sin(C);I.push(`${H},${U}`),w.push(`<circle cx="${H}" cy="${U}" r="5" fill="#818cf8" stroke="#fff" stroke-width="2" filter="url(#dotGlow)"><title>${s[z]}: ${O}</title></circle>`)});const x=`<polygon points="${I.join(" ")}" fill="url(#riderFillGrad)" stroke="#818cf8" stroke-width="2.5" stroke-linejoin="round" filter="url(#radarGlow)" />`,T=[...[{key:"mountain",label:"Berg (MTN)"},{key:"hill",label:"Hügel (HIL)"},{key:"sprint",label:"Sprint (SPR)"},{key:"timeTrial",label:"Zeitfahren (TT)"},{key:"cobble",label:"Pflaster (COB)"},{key:"attack",label:"Angriff (ATT)"},{key:"mediumMountain",label:"Mittelgebirge (MDM)"},{key:"flat",label:"Flach (FLA)"},{key:"prologue",label:"Prolog (PRO)"},{key:"acceleration",label:"Beschleunigung (ACC)"}]].sort((_,z)=>{const O=a[_.key]??60;return(a[z.key]??60)-O}),E=[],F=[];T.forEach((_,z)=>{const O=a[_.key]??60,G=`
  ...
  `}function Mp(e,t){const a=t.shortTermFatigueMalus??0,r=t.longTermFatigueDecayable??0,s=t.longTermFatigueLocked??0,n=t.longTermFatigueMalus??0,i=t.totalFatigueLoadMalus??0,o=(a/.2).toFixed(1).replace(".",","),c=(r/.01).toFixed(0);let l="#fff";t.shortTermFatigueWarning==="critical"?l="#ef4444":t.shortTermFatigueWarning==="warning"&&(l="#fbbf24");const p=t.fatigueHistory??[];let u="";return p.length===0?u='<tr><td colspan="6" class="text-center text-muted" style="padding: 2rem; color: #888;">Keine Erschöpfungshistorie für diesen Fahrer vorhanden.</td></tr>':u=p.map(m=>{const f=ie(m.date);let g="";m.type==="race"?g=`${S(m.raceName)}${m.stageNumber!=null?` - Etappe ${m.stageNumber}`:""}`:g=m.raceName?S(m.raceName):"Regeneration";const v=m.type==="race"&&m.stageScore!=null?`<span class="badge" style="background: rgba(255,255,255,0.08); color: #fff; padding: 0.25rem 0.5rem; border-radius: 4px; font-weight: 600;">${m.stageScore.toFixed(0)}</span>`:'<span style="color: #666;">–</span>';let b="";m.shortChange>0?b=`<span style="color: #ef4444; font-weight: 600;">+${m.shortChange.toFixed(2).replace(".",",")}</span>`:m.shortChange<0?b=`<span style="color: #2ecc71; font-weight: 600;">${m.shortChange.toFixed(2).replace(".",",")}</span>`:b='<span style="color: #666;">0,00</span>';const h=[];if(m.longDecayableChange!==0){const w=m.longDecayableChange>0?"+":"",x=m.longDecayableChange>0?"#ef4444":"#2ecc71";h.push(`<span style="color: ${x}; font-weight: 500;">${w}${m.longDecayableChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Abbau.)</span></span>`)}if(m.longLockedChange!==0){const w=m.longLockedChange>0?"+":"",x=m.longLockedChange>0?"#a855f7":"#2ecc71";h.push(`<span style="color: ${x}; font-weight: 500;">${w}${m.longLockedChange.toFixed(2).replace(".",",")} <span style="font-size: 0.8rem; color: #999;">(Gesp.)</span></span>`)}const $=h.length>0?`<div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.1rem;">${h.join("")}</div>`:'<span style="color: #666;">0,00</span>',I=m.shortAfter+m.longAfter;return`
        <tr>
          ...
          <td style="text-align: right; padding: 0.75rem 0.5rem; border-bottom: 1px solid rgba(255,255,255,0.05);">
            <strong style="color: #ef4444; font-size: 0.95rem;">-${I.toFixed(2).replace(".",",")}</strong>
  ...
  `}function Ip(e){var W;if(!e)return`
      ...
      </section>`;const a=(e.formHistory??[]).filter((P,L)=>L%2===0),r=((W=d.gameState)==null?void 0:W.currentDate)??new Date().toISOString(),s=a.length>0?new Date(a[a.length-1].date).getUTCFullYear():new Date(r).getUTCFullYear(),n=new Date(Date.UTC(s,0,1)).getTime(),i=864e5,o=1260,c=384,l=40,p=20,u=a.map(P=>{const N=(new Date(P.date).getTime()-n)/i,Y=l+N/365*o,K=p+c-Math.min(8,Math.max(0,P.totalForm))/8*c;return{x:Y,y:K,form:P.totalForm,date:P.date}});let m="",f="",g="";He.form&&u.length>0&&(m=`M ${u.map(P=>`${P.x},${P.y}`).join(" L ")}`,f=u.map(P=>`<circle cx="${P.x}" cy="${P.y}" r="3" fill="#fff" stroke="var(--accent-primary)" stroke-width="2"><title>${e.riderName} (${P.date}): ${P.form}</title></circle>`).join(""),g=`${m} L ${u[u.length-1].x},${p+c} L ${u[0].x},${p+c} Z`);let v="",b="";if(He.combinedFatigue&&u.length>0){const P=a.map(N=>{const K=(new Date(N.date).getTime()-n)/i,k=l+K/365*o,R=(N.shortFatigue??0)+(N.longFatigue??0),D=p+c-Math.min(25,Math.max(0,R))/25*c;return{x:k,y:D,val:R,date:N.date}});v=`<path d="${`M ${P.map(N=>`${N.x},${N.y}`).join(" L ")}`}" fill="none" stroke="#ef4444" stroke-width="2" />`,b=P.map(N=>`<circle cx="${N.x}" cy="${N.y}" r="3" fill="#fff" stroke="#ef4444" stroke-width="2"><title>Gesamtfatigue (${N.date}): ${N.val.toFixed(2)}</title></circle>`).join("")}let h="",$="";if(He.shortFatigue&&u.length>0){const P=a.map(N=>{const K=(new Date(N.date).getTime()-n)/i,k=l+K/365*o,R=N.shortFatigue??0,D=p+c-Math.min(25,Math.max(0,R))/25*c;return{x:k,y:D,val:R,date:N.date}});h=`<path d="${`M ${P.map(N=>`${N.x},${N.y}`).join(" L ")}`}" fill="none" stroke="#facc15" stroke-width="2" />`,$=P.map(N=>`<circle cx="${N.x}" cy="${N.y}" r="3" fill="#fff" stroke="#facc15" stroke-width="2"><title>Kurzzeitfatigue (${N.date}): ${N.val.toFixed(2)}</title></circle>`).join("")}let I="",w="";if(He.longFatigue&&u.length>0){const P=a.map(N=>{const K=(new Date(N.date).getTime()-n)/i,k=l+K/365*o,R=N.longFatigue??0,D=p+c-Math.min(25,Math.max(0,R))/25*c;return{x:k,y:D,val:R,date:N.date}});I=`<path d="${`M ${P.map(N=>`${N.x},${N.y}`).join(" L ")}`}" fill="none" stroke="#a855f7" stroke-width="2" />`,w=P.map(N=>`<circle cx="${N.x}" cy="${N.y}" r="3" fill="#fff" stroke="#a855f7" stroke-width="2"><title>Langzeitfatigue (${N.date}): ${N.val.toFixed(2)}</title></circle>`).join("")}const x="rgba(251, 191, 36, 0.15)";let M="";for(let P=0;P<=8;P+=2){const L=p+c-P/8*c;M+=`<line x1="${l}" y1="${L}" x2="${l+o}" y2="${L}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,M+=`<text x="${l-5}" y="${L+4}" fill="#ffffff" font-size="10" text-anchor="end">${P}</text>`}for(let P=0;P<=25;P+=5){const L=p+c-P/25*c;M+=`<text x="${l+o+5}" y="${L+4}" fill="#ef4444" font-size="10" text-anchor="start">${P}</text>`}let T="";for(let P=0;P<=52;P+=5){const L=l+P/52*o;M+=`<line x1="${L}" y1="${p}" x2="${L}" y2="${p+c}" stroke="var(--border-primary)" stroke-dasharray="2,2" />`,T+=`<text x="${L}" y="${p+c+15}" fill="#ffffff" font-size="10" text-anchor="middle">W${P}</text>`}let E="",F="";if(e.peakDates){const P=[...e.peakDates].sort((L,N)=>new Date(L).getTime()-new Date(N).getTime());for(let L=0;L<P.length;L++){const N=P[L],K=(new Date(N).getTime()-n)/i,k=l+K/365*o;E+=`<line x1="${k}" y1="${p}" x2="${k}" y2="${p+c}" stroke="#ffffff" stroke-width="2"><title>Peak: ${N}</title></line>`;const R=L>0?(new Date(P[L-1]).getTime()-n)/i:Number.NEGATIVE_INFINITY,D=K-56,B=R+14,Z=Math.max(0,Math.max(D,B)),ne=K-Z,fe=l+Z/365*o,ge=ne/365*o;F+=`<rect x="${fe}" y="${p}" width="${ge}" height="${c}" fill="rgba(16, 185, 129, 0.1)" />`;const xe=14/365*o;F+=`<rect x="${k}" y="${p}" width="${xe}" height="${c}" fill="rgba(239, 68, 68, 0.1)" />`}}const _=(new Date(r).getTime()-n)/i,z=l+_/365*o;E+=`<line x1="${z}" y1="${p}" x2="${z}" y2="${p+c}" stroke="#ef4444" stroke-width="3"><title>Heute: ${r}</title></line>`,pt.forEach((P,L)=>{const N=Kt[L%Kt.length];P.peakDates&&P.peakDates.forEach(Y=>{const k=(new Date(Y).getTime()-n)/i,R=l+k/365*o;E+=`<line x1="${R}" y1="${p}" x2="${R}" y2="${p+c}" stroke="${N}" stroke-width="1.5" stroke-dasharray="3,3"><title>${P.riderName} Peak: ${Y}</title></line>`})});let O="",G="";pt.forEach((P,L)=>{const N=Kt[L%Kt.length],Y=P.formHistory.filter((K,k)=>k%2===0).map(K=>{const R=(new Date(K.date).getTime()-n)/i,D=l+R/365*o,B=p+c-Math.min(8,Math.max(0,K.totalForm))/8*c;return{x:D,y:B,form:K.totalForm,date:K.date}});if(Y.length>0){const K=`M ${Y.map(k=>`${k.x},${k.y}`).join(" L ")}`;O+=`<path d="${K}" fill="none" stroke="${N}" stroke-width="2" />`,G+=Y.map(k=>`<circle cx="${k.x}" cy="${k.y}" r="3" fill="#fff" stroke="${N}" stroke-width="2"><title>${P.riderName} (${k.date}): ${k.form}</title></circle>`).join("")}});const C=d.teams.filter(P=>P.division==="WorldTour"||P.divisionName==="WorldTour");let H='<option value="">-- Team auswählen --</option>';for(const P of C){const L=Ut===P.id?" selected":"";H+=`<option value="${P.id}"${L}>${S(P.name)}</option>`}let U='<option value="">-- Fahrer auswählen --</option>';if(Ut!=null){const P=d.riders.filter(L=>L.activeTeamId===Ut&&L.id!==e.riderId&&!pt.some(N=>N.riderId===L.id));for(const L of P)U+=`<option value="${L.id}">${S(L.firstName)} ${S(L.lastName)}</option>`}const j=`
  ...
  `,X=e.currentSeasonRank??kr(e.riderId)??"–",J=[`
    ...
    `];pt.forEach((P,L)=>{const N=Kt[L%Kt.length],Y=P.currentSeasonRank??kr(P.riderId)??"–";J.push(`
  ...
  `}function Ht(e,t){return`<span class="rider-stats-rank-badge rider-stats-rank-badge-${t}">${S(e)}</span>`}function Cp(e){return!e.isBreakaway||e.rowType!=="stage_result"||e.finishStatus!=="classified"?"–":'<span class="rider-stats-breakaway-icon" aria-label="Ausreißer" title="Ausreißer"><svg class="rider-stats-icon" viewBox="0 0 24 24" style="fill:#ef4444; width:1em; height:1em; vertical-align:middle;"><path d="M12 21L2 3h20L12 21z"/></svg></span>'}function Ep(e){return e.finishStatus==="otl"?Ht("OTL","place"):e.finishStatus==="dnf"?Ht("DNF","place"):e.resultRank==null?"–":`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${e.resultRank<=3?` rider-stats-rank-badge-top-${e.resultRank}`:""}">${S(String(e.resultRank))}</span>`}function Fp(e){return e.finishStatus!=="classified"||e.gcRank==null?"–":Ht(String(e.gcRank),"gc")}function Pp(e){return e.finishStatus==="otl"?ir(e.statusReason,!0):e.finishStatus==="dnf"?ir(e.statusReason,!1):e.stageTimeSeconds!=null?`${e.resultLabel} · ${va(e.stageTimeSeconds)}`:e.resultLabel}function Ae(e,t,a=!1){var f,g,v;const r=(e==null?void 0:e.activeTeamId)!=null?((f=d.teams.find(b=>b.id===e.activeTeamId))==null?void 0:f.name)??null:null,s=((g=e==null?void 0:e.country)==null?void 0:g.code3)??(e==null?void 0:e.nationality)??null,n=s?oe(s):"",i=t==null?[]:[...t.seasons].map(b=>({...b,raceBlocks:xp(b.raceBlocks)})).sort((b,h)=>h.season-b.season);if(a)return`
      ...
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${wp(e)}`;if(d.riderStatsTab==="fatigue")return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${Mp(e,t)}`;if(d.riderStatsTab==="program")return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${Rp(t)}`;if(d.riderStatsTab==="form")return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${Ip(t)}`;if(d.riderStatsTab==="topResults")return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${Lp(t)}`;if(d.riderStatsTab==="career")return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${_p(t)}`;if(d.riderStatsTab==="contracts")return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      ${Dp(t)}`;const o=((v=d.gameState)==null?void 0:v.season)??2026,c=Array.from(new Set([o,...i.map(b=>b.season)])).sort((b,h)=>h-b);(d.riderStatsSelectedSeason===null||!c.includes(d.riderStatsSelectedSeason))&&(d.riderStatsSelectedSeason=o);const l=d.riderStatsSelectedSeason,p=i.find(b=>b.season===l);if(t.seasons.length===0)return`
      ${We(e,t,r,s,n)}
      ${je(t)}
      <section class="rider-stats-placeholder">
        <h3>Keine Historie vorhanden</h3>
        ...
        ${p.raceBlocks.map(b=>`
          <section class="rider-stats-race-block">
            <div class="rider-stats-race-head">
              ...
              ${Sr(b.raceCategoryName,b.isStageRace,b.rows.filter(h=>h.rowType==="stage_result").length||null)}
            </div>
            <div class="dashboard-race-stages-table-wrap rider-stats-table-wrap">
              <table class="data-table rider-stats-table">
                <colgroup>
                ...
                <tbody>
                  ${b.rows.map(h=>{const $=h.rowType!=="stage_result",I=$?`${h.raceName} · ${zs(h.rowType)}`:h.stageNumber&&h.isStageRace?`${h.raceName} · Etappe ${h.stageNumber}`:h.raceName;return`
                      <tr class="rider-stats-row${$?" rider-stats-row-final":""}">
                        <td>${S(ie(h.date))}</td>
                        <td>${Ep(h)}</td>
                        <td>${Fp(h)}</td>
                        <td class="rider-stats-breakaway-col">${Cp(h)}</td>
                        <td>${$?"":xa(h.rolledWeatherId,h.rolledWetterName)}</td>
                        <td>${$?Sp(h.rowType):Sr(h.raceCategoryName?h.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):h.raceCategoryName,h.isStageRace)}</td>
                        <td>${S(I)}</td>
                        <td class="status-cell">${Gs(h)}</td>
                        <td>${$?"–":h.profile?`<button type="button" class="rider-stats-profile-badge-link" data-stage-profile-id="${h.stageId}" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex;">${Pa(h.profile)}</button>`:"–"}</td>
                        <td>${$?"-":h.distanceKm!=null?S(h.distanceKm.toFixed(1).replace(".",",")):"–"}</td>
                        <td>${$?"-":h.elevationGainMeters!=null?S(String(Math.round(h.elevationGainMeters))):"–"}</td>
                        <td>${S(Pp(h))}</td>
                        <td>${h.seasonPoints}</td>
                      </tr>`}).join("")}
                </tbody>
              </table>
            </div>
  ...
  `;return`
    ...
    ${u}
    ${m}
  `}function cs(){const e=document.querySelector(".rider-stats-modal-card");if(!e)return;["results","topResults","career","form","fatigue"].includes(d.riderStatsTab)?(e.style.minWidth="min(1475px, 95vw)",e.style.maxWidth="1687px"):(e.style.minWidth="",e.style.maxWidth="")}async function na(e){var c,l,p,u,m;const t=we(e),a=(t==null?void 0:t.activeTeamId)!=null?((c=d.teams.find(f=>f.id===t.activeTeamId))==null?void 0:c.name)??null:null;pt=[],Ut=null,d.riderStatsSelectedRiderId=e,d.riderStatsTab="results",d.riderStatsSelectedSeason=((l=d.gameState)==null?void 0:l.season)??2026,cs(),d.riderStatsTopResultsFilterCategory=null,d.riderStatsTopResultsFilterSeason=null,d.riderStatsTopResultsPage=1,y("rider-stats-title").innerHTML=oi(t,null),y("rider-stats-jersey").innerHTML="";const r=t!=null&&t.age?` · Alter ${t.age}`:"";y("rider-stats-meta").textContent=t?`${((p=t.role)==null?void 0:p.name)??"Fahrer"} · ${a??"Team unbekannt"}${r}`:"Historie wird geladen",y("rider-stats-body").innerHTML=Ae(t,null,!0),Xe("riderStats");const s=await V.getRiderStats(e);if(d.riderStatsSelectedRiderId!==e)return;if(!s.success||!s.data){const f=t!=null&&t.age?` · Alter ${t.age}`:"";y("rider-stats-meta").textContent=t?`${((u=t.role)==null?void 0:u.name)??"Fahrer"} · ${a??"Team unbekannt"}${f}`:"Fehler beim Laden",y("rider-stats-body").innerHTML=`
      <section class="rider-stats-placeholder">
        <h3>Historie konnte nicht geladen werden</h3>
        <p>${S(s.error??"Unbekannter Fehler")}</p>
      </section>`;return}d.riderStatsPayload=s.data,cs(),y("rider-stats-title").innerHTML=oi(t,s.data),y("rider-stats-jersey").innerHTML="";const n=s.data.age?` · Alter ${s.data.age}`:t!=null&&t.age?` · Alter ${t.age}`:"",i=s.data.mentorName?` · Mentor: ${s.data.mentorName}`:"",o=s.data.mentoredRiderNames&&s.data.mentoredRiderNames.length>0?` · Mentor von: ${s.data.mentoredRiderNames.join(" - ")}`:"";y("rider-stats-meta").textContent=`${((m=t==null?void 0:t.role)==null?void 0:m.name)??"Fahrer"} · ${s.data.teamName??a??"Ohne aktives Team"}${n} · ${s.data.seasons.length} Saisons${i}${o}`,y("rider-stats-body").innerHTML=Ae(t,s.data,!1)}function Np(){y("rider-stats-body").addEventListener("click",e=>{var s;if(e.target&&e.target.id&&e.target.id.startsWith("toggle-chart-")){const n=e.target.id,i=e.target.checked;n==="toggle-chart-form"?He.form=i:n==="toggle-chart-combined-fatigue"?He.combinedFatigue=i:n==="toggle-chart-short-fatigue"?He.shortFatigue=i:n==="toggle-chart-long-fatigue"&&(He.longFatigue=i);const o=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(o,d.riderStatsPayload,!1);return}const t=e.target.closest("button[data-rider-stats-tab]");if(!t){const n=e.target.closest("button[data-remove-compare-id]");if(n){const c=Number(n.dataset.removeCompareId);pt=pt.filter(p=>p.riderId!==c);const l=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(l,d.riderStatsPayload,!1);return}const i=e.target.closest("button[data-top-results-page]");if(i){const c=Number(i.dataset.topResultsPage);if(!isNaN(c)&&c>=1){d.riderStatsTopResultsPage=c;const l=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(l,d.riderStatsPayload,!1)}return}const o=e.target.closest("button[data-stage-profile-id]");if(o){const c=Number(o.dataset.stageProfileId);Number.isFinite(c)&&xr(c);return}return}const a=t.dataset.riderStatsTab;if(a!=="results"&&a!=="program"&&a!=="form"&&a!=="topResults"&&a!=="skills"&&a!=="career"&&a!=="fatigue"&&a!=="contracts"||a==="program"&&(((s=d.riderStatsPayload)==null?void 0:s.programRaces.length)??0)===0)return;d.riderStatsTab=a,cs();const r=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(r,d.riderStatsPayload,!1)}),y("rider-stats-body").addEventListener("change",async e=>{const t=e.target;if(t.id==="rider-stats-filter-category"){d.riderStatsTopResultsFilterCategory=t.value==="all"?null:t.value,d.riderStatsTopResultsPage=1;const a=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(a,d.riderStatsPayload,!1)}else if(t.id==="rider-stats-filter-season"){d.riderStatsTopResultsFilterSeason=t.value==="all"?null:Number(t.value),d.riderStatsTopResultsPage=1;const a=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(a,d.riderStatsPayload,!1)}else if(t.id==="rider-stats-results-season-select"){d.riderStatsSelectedSeason=Number(t.value);const a=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(a,d.riderStatsPayload,!1)}else if(t.classList.contains("rider-stats-filter-checkbox")){const a=t.dataset.filterType;d.riderStatsTopResultsFilters[a]=t.checked,d.riderStatsTopResultsPage=1;const r=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(r,d.riderStatsPayload,!1)}else if(t.id==="rider-compare-team-select"){const a=t.value;Ut=a?Number(a):null;const r=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(r,d.riderStatsPayload,!1)}else if(t.id==="rider-compare-rider-select"){const a=t.value;if(a){const r=Number(a);if(pt.length>=10){alert("Sie können maximal 10 Fahrer vergleichen."),t.value="";return}const s=await V.getRiderStats(r,!0);s.success&&s.data?pt.push({riderId:s.data.riderId,riderName:s.data.riderName,teamId:s.data.teamId,teamName:s.data.teamName,formHistory:s.data.formHistory??[],peakDates:s.data.peakDates??[],currentSeasonPoints:s.data.currentSeasonPoints??0,currentSeasonRank:s.data.currentSeasonRank??null}):alert("Formverlauf konnte nicht geladen werden: "+(s.error??""));const n=we(d.riderStatsSelectedRiderId);y("rider-stats-body").innerHTML=Ae(n,d.riderStatsPayload,!1)}}})}function li(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?0:t.includes("grand tour")?1:t.includes("monument")?2:t.includes("stage race high")?3:t.includes("one day high")?4:t.includes("stage race middle")?5:t.includes("one day middle")?6:t.includes("stage race low")?7:t.includes("one day low")?8:9}function Lp(e){const t=[];for(const g of e.seasons)for(const v of g.raceBlocks)for(const b of v.rows)t.push({...b,season:g.season,isStageRace:v.isStageRace});const a=Array.from(new Set(t.map(g=>g.raceCategoryName).filter(Boolean)));a.sort((g,v)=>g.localeCompare(v,"de"));const r=Array.from(new Set(t.map(g=>g.season))).sort((g,v)=>v-g);let s=t.filter(g=>g.rowType!=="stage_result"?g.rowType==="gc_final"?d.riderStatsTopResultsFilters.gc:g.rowType==="mountain_final"?d.riderStatsTopResultsFilters.mountain:g.rowType==="points_final"?d.riderStatsTopResultsFilters.points:g.rowType==="youth_final"?d.riderStatsTopResultsFilters.youth:!0:g.isStageRace?d.riderStatsTopResultsFilters.stage:d.riderStatsTopResultsFilters.oneDay);if(d.riderStatsTopResultsFilterCategory){const g=d.riderStatsTopResultsFilterCategory;if(g.endsWith("-etappen")){const v=g.substring(0,g.length-8);s=s.filter(b=>b.raceCategoryName===v&&b.rowType==="stage_result")}else if(g.endsWith("-gc")){const v=g.substring(0,g.length-3);s=s.filter(b=>b.raceCategoryName===v&&b.rowType!=="stage_result")}else s=s.filter(v=>v.raceCategoryName===g)}d.riderStatsTopResultsFilterSeason!=null&&(s=s.filter(g=>g.season===d.riderStatsTopResultsFilterSeason)),s.sort((g,v)=>{if(v.seasonPoints!==g.seasonPoints)return v.seasonPoints-g.seasonPoints;const b=g.rowType!=="stage_result",h=v.rowType!=="stage_result",$=g.resultRank??9999,I=v.resultRank??9999;if(d.riderStatsTopResultsFilterCategory)return $!==I?$-I:b!==h?b?-1:1:0;{const w=li(g.raceCategoryName),x=li(v.raceCategoryName);return w!==x?w-x:b!==h?b?-1:1:$-I}});const n=200,i=s.slice(0,1e3),o=Math.max(1,Math.ceil(i.length/n));d.riderStatsTopResultsPage>o&&(d.riderStatsTopResultsPage=o);const c=(d.riderStatsTopResultsPage-1)*n,l=i.slice(c,c+n),u=`
    <div class="rider-stats-top-results-filters" style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; align-items: center; flex-wrap: wrap; background: rgba(255, 255, 255, 0.03); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.05);">
      <div class="form-group" style="margin: 0; display: flex; align-items: center;">
        ...
        <select id="rider-stats-filter-category" class="form-control" style="width: auto; display: inline-block; background: #222; color: #fff; border-color: #444;">
          ...
          ${a.map(g=>{if(g.toLowerCase().includes("stage race")||g.toLowerCase().includes("grand tour")||g.toLowerCase().includes("tour de france")){const b=`${g}-etappen`,h=`${g}-gc`;return`
        <option value="${S(b)}" ${d.riderStatsTopResultsFilterCategory===b?"selected":""}>${S(g)} - Etappen</option>
        <option value="${S(h)}" ${d.riderStatsTopResultsFilterCategory===h?"selected":""}>${S(g)} - GC</option>
  ...
  `,m=l.length===0?'<tr><td colspan="9" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':l.map(g=>{const v=g.rowType!=="stage_result",b=v?`${g.raceName} · ${zs(g.rowType)}`:g.stageNumber&&g.isStageRace?`${g.raceName} · Etappe ${g.stageNumber}`:g.raceName;let h="–",$="–";g.finishStatus==="otl"?h=Ht("OTL","place"):g.finishStatus==="dnf"?h=Ht("DNF","place"):g.resultRank==null||(v?$=`<span class="rider-stats-final-type ${Ho(g.rowType)}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${g.resultRank}</span>`:h=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${g.resultRank<=3?` rider-stats-rank-badge-top-${g.resultRank}`:""}">${S(String(g.resultRank))}</span>`);const I=v?"–":g.profile?`<button type="button" class="rider-stats-profile-badge-link" data-stage-profile-id="${g.stageId}" style="background: none; border: none; padding: 0; cursor: pointer; display: inline-flex;">${Pa(g.profile)}</button>`:"–",w=!v&&g.stageScore!=null&&g.stageScore>0?Nr(g.stageScore,0,350):"–",x=Sr(g.raceCategoryName?g.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):g.raceCategoryName,g.isStageRace);return`
          <tr class="rider-stats-row${v?" rider-stats-row-final":""}">
            <td>${h}</td>
            <td>${$}</td>
            <td><strong>${S(b)}</strong>${v?"":xa(g.rolledWeatherId,g.rolledWetterName)}</td>
  ...
  `}function Dp(e){var n,i,o,c,l;const t=(e==null?void 0:e.contracts)||[];if(t.length===0)return`
      <section class="rider-stats-placeholder">
        <h3>Keine Vertragsdaten vorhanden</h3>
        <p>Für diesen Fahrer wurden keine Verträge in der Datenbank erfasst.</p>
      </section>
    `;const a=((n=d.gameState)==null?void 0:n.season)??2026,r=[];for(const p of t)for(let u=p.startSeason;u<=p.endSeason;u++){let m=null;u>a?m="-":u===a?m=(e==null?void 0:e.roleName)||((o=(i=e==null?void 0:e.seasonRoles)==null?void 0:i.find(g=>g.season===u))==null?void 0:o.roleName)||"-":m=((l=(c=e==null?void 0:e.seasonRoles)==null?void 0:c.find(g=>g.season===u))==null?void 0:l.roleName)||"-";const f=u===a?'<span style="color: #22c55e; font-weight: bold;">Aktiv</span>':u>a?'<span style="color: #60a5fa; font-weight: bold;">Zukünftig</span>':'<span style="color: #94a3b8;">Abgelaufen</span>';r.push({season:u,teamId:p.teamId,teamName:p.teamName,roleName:m,statusText:f})}return r.sort((p,u)=>u.season-p.season),`
    <section class="rider-stats-section" style="margin-top: 1.5rem;">
      ...
      <div class="dashboard-race-stages-table-wrap rider-stats-table-wrap">
        <table class="data-table" style="width: 100%; border-collapse: collapse; text-align: left;">
          ...
          <tbody>
            ${r.map(p=>{const u=p.teamId?_e(p.teamId,p.teamName):"",m=p.teamId?Ze(p.teamName||"",p.teamId,!0,"results-rider-link"):"Freier Fahrer (Free Agent)",f=p.teamId?`<div style="display: flex; align-items: center; gap: 0.5rem;">${u} <span style="vertical-align: middle;">${m}</span></div>`:`<span style="color: #94a3b8; font-style: italic;">${m}</span>`;return`
      <tr>
        ...
        ${s.map(n=>{const i=t.categories[n.key]||{gcWins:0,gcSecond:0,gcThird:0,gcTopTen:0,stageWins:0,stageSecond:0,stageThird:0,stageTopTen:0,oneDayWins:0,oneDaySecond:0,oneDayThird:0,oneDayTopTen:0,mountainWins:0,pointsWins:0,youthWins:0,breakawayWins:0,raceDays:0,leaderJerseys:0,pointsJerseys:0,mountainJerseys:0,youthJerseys:0,breakawayJerseys:0,sprintWins:0,climbWinsHC:0,climbWins1:0,climbWins2:0,climbWins3:0,climbWins4:0,winFlat:0,winRolling:0,winHilly:0,winHillyDifficult:0,winMediumMountain:0,winMountain:0,winHighMountain:0,winCobble:0,winCobbleHill:0,winITT:0,winTTT:0,winWeather1:0,winWeather2:0,winWeather3:0,winWeather4:0,winWeather5:0,winWeather6:0,winWeather7:0};return`
            <div style="position: relative; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 8px; padding: 1rem; height: 415px; box-sizing: border-box; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 4px 6px rgba(0,0,0,0.15);">
              ...
              <div style="overflow: hidden; white-space: nowrap;">
                ...
                <div style="display: flex; gap: 0.25rem; align-items: center; overflow: hidden; white-space: nowrap; flex-wrap: nowrap;">
                  ${Re(i.winWeather1||0,1,"Sonnig")}
                  ${Re(i.winWeather2||0,2,"Extreme Hitze")}
                  ${Re(i.winWeather3||0,3,"Leichter Regen")}
                  ${Re(i.winWeather4||0,4,"Starkregen")}
                  ${Re(i.winWeather5||0,5,"Starker Wind")}
                  ${Re(i.winWeather6||0,6,"Dichter Nebel")}
                  ${Re(i.winWeather7||0,7,"Schnee/Eis")}
                </div>
              </div>
...
`+r.error);return}d.stageResults=r.data??null,d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId,d.selectedResultTypeId=((s=d.stageResults.classifications[0])==null?void 0:s.resultTypeId)??1,d.selectedResultsMarkerKey=at,d.selectedResultsSpecialView=null),d.selectedResultsRaceId!=null&&Wo(d.selectedResultsRaceId),Ce()}async function Wo(e){if(!d.seasonStandings){const a=await V.getSeasonStandings();a.success&&a.data&&(d.seasonStandings=a.data)}const t=await V.getRaceResultsRoster(e);t.success&&t.data?d.resultsRoster=t.data:d.resultsRoster=null}function jp(e){return e===1?{color:"#fbbf24",bg:"rgba(251, 191, 36, 0.1)"}:e===2?{color:"#cbd5e1",bg:"rgba(203, 213, 225, 0.1)"}:e===6?{color:"#4ade80",bg:"rgba(74, 222, 128, 0.1)"}:e===3?{color:"#c084fc",bg:"rgba(192, 132, 252, 0.1)"}:e===4?{color:"#38bdf8",bg:"rgba(56, 189, 248, 0.1)"}:e===5?{color:"#fb923c",bg:"rgba(251, 146, 60, 0.1)"}:{color:"var(--text-300)",bg:"transparent"}}function ui(e){return e==null?99:{1:0,2:1,3:2,4:3,5:4,6:5}[e]??99}function Vp(){const e=d.resultsRoster;if(!e||e.entries.length===0)return'<div class="results-roster-empty">Noch keine Teilnehmerdaten (Rennen noch nicht gestartet oder kein Starterfeld gefunden).</div>';const t=ht(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,r=[...e.entries].sort((b,h)=>h.overallRating-b.overallRating),s=new Set(r.slice(0,5).map(b=>b.riderId)),n=b=>{var $;const h=d.riders.find(I=>I.id===b);return(($=h==null?void 0:h.skills)==null?void 0:$.sprint)??0},o=[...e.entries.filter(b=>!s.has(b.riderId))].sort((b,h)=>{const $=n(b.riderId),I=n(h.riderId);return I!==$?I-$:h.overallRating-b.overallRating}),c=new Set(o.slice(0,5).map(b=>b.riderId));function l(b){switch(b){case"Berg":return"Berg";case"Hill":return"Hügel";case"Sprint":return"Sprinter";case"Cobble":return"Pflaster";case"Timetrial":return"Zeitfahrer";case"Attacker":return"Ausreißer";default:return b}}const p=new Map;for(const b of e.entries){const h=b.teamId;p.has(h)||p.set(h,{teamId:b.teamId,teamName:b.teamName,riders:[],avgRating:0}),p.get(h).riders.push(b)}for(const b of p.values())b.avgRating=b.riders.reduce((h,$)=>h+$.overallRating,0)/b.riders.length;const u=b=>{let h=Number.POSITIVE_INFINITY;for(const $ of b)!$.hasDropped&&$.gcRank!=null&&$.gcRank<h&&(h=$.gcRank);return h},m=b=>{var $;if(!(($=d.seasonStandings)!=null&&$.riderStandings))return 0;let h=0;for(const I of b){const w=d.seasonStandings.riderStandings.find(x=>x.riderId===I.riderId);w&&w.points>h&&(h=w.points)}return h},f=b=>{if(b==null)return 0;const h=d.riders.filter(w=>w.activeTeamId===b);if(h.length===0)return 0;const $=h.map(w=>w.overallRating??0);$.sort((w,x)=>x-w);const I=$.slice(0,10);return I.length===0?0:I.reduce((w,x)=>w+x,0)/I.length},g=[...p.values()].sort((b,h)=>{const $=u(b.riders),I=u(h.riders);if(($!==Number.POSITIVE_INFINITY||I!==Number.POSITIVE_INFINITY)&&$!==I)return $-I;const w=m(b.riders),x=m(h.riders);if((w>0||x>0)&&w!==x)return x-w;const M=f(b.teamId),T=f(h.teamId);return Math.abs(M-T)>1e-4?T-M:(b.teamName??"").localeCompare(h.teamName??"","de")});for(const b of g)b.riders.sort((h,$)=>ui(h.roleId)-ui($.roleId)||$.overallRating-h.overallRating||h.lastName.localeCompare($.lastName,"de"));return`<div class="results-roster-grid">${g.map(b=>{const h=b.teamId!=null?_e(b.teamId,b.teamName):"",$=b.riders.map(w=>{var W;const x=jp(w.roleId),M=w.countryCode?ze[w.countryCode]??w.countryCode.slice(0,2).toLowerCase():null,T=M?`<span class="fi fi-${M} results-roster-flag" title="${S(w.countryCode??"")}"></span>`:'<span class="results-roster-flag-placeholder"></span>',E=`${w.firstName.charAt(0)}. ${w.lastName}`,F=w.roleName??"–",A=w.specialization1?l(w.specialization1):null,_=w.specialization2?l(w.specialization2):null;let z=F;A&&(z+=` · ${A}`),_&&(z+=` · ${_}`);const O=`<span class="results-roster-overall-badge" style="color:${Up(w.overallRating)}" title="Gesamtstärke: ${w.overallRating.toFixed(2)}">${w.overallRating.toFixed(2)}</span>`,G=w.hasDropped?" dropped":"";let C="";w.hasDropped?w.dropoutStatus==="dns"?C="DNS":w.dropoutStatus==="dnf"?C=((W=w.dropoutReason)==null?void 0:W.startsWith("OTL"))??!1?"OTL":"DNF":C="OUT":w.gcRank!=null&&(C=`${w.gcRank}`);let H="";if(w.hasDropped)H=`<span class="rider-stats-rank-badge" style="color: var(--danger, #ef4444); border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.1);" title="Ausgeschieden: ${S(w.dropoutReason||"")}">${C}</span>`;else if(w.gcRank!=null){let P="rider-stats-rank-badge-gc";w.gcRank===1?P="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":w.gcRank===2?P="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":w.gcRank===3&&(P="rider-stats-rank-badge-place rider-stats-rank-badge-top-3"),H=`<span class="rider-stats-rank-badge ${P}" title="GC Stand: Platz ${w.gcRank}">${w.gcRank}</span>`}const j=`style="color: ${w.hasDropped?"var(--text-500)":x.color}; font-weight: bold;"`,X=s.has(w.riderId),J=c.has(w.riderId);return`<div class="results-roster-rider${G}">
      ...
      </div>`}).join(""),I=b.avgRating.toFixed(1).replace(".",",");return`<div class="results-roster-team">
      <div class="results-roster-team-header">
        <div class="results-roster-jersey">${h}</div>
        <div class="results-roster-team-name" title="${S(b.teamName??"–")}">${Ze(b.teamName??"–",b.teamId)} <span style="font-size: 0.7rem; color: var(--text-400); font-weight: 500;">(Ø ${I})</span></div>
      </div>
      <div class="results-roster-riders${a?"":" results-roster-riders-oneday"}">${$}</div>
    </div>`}).join("")}</div>`}function Up(e){return e>=90?"#22c55e":e>=80?"#86efac":e>=70?"#fbbf24":e>=60?"#fb923c":e>=50?"#f87171":"#94a3b8"}function Yp(e){var l,p;if(e.leadoutBonus==null||!(e.leadoutBonus>0)||e.leadoutRiderId==null||e.teamId==null)return"";const t=(l=d.stageResults)==null?void 0:l.classifications.find(u=>u.resultTypeId===1),a=new Set(t?t.rows.map(u=>u.riderId).filter(u=>u!=null):[]),r=d.riders.filter(u=>u.activeTeamId===e.teamId&&a.has(u.id)),s=new Set((((p=d.stageResults)==null?void 0:p.nonFinishers)??[]).map(u=>u.riderId)),n=[];for(const u of r){if(u.id===e.riderId||s.has(u.id))continue;let m=0;const f=u.skills.sprint>=72,g=u.skills.flat>=78,v=u.skills.timeTrial>=76,b=u.skills.acceleration>=80;if(f&&m++,g&&m++,v&&m++,b&&m++,m>0){let h=1;m===2?h=1.25:m===3?h=1.5:m===4&&(h=2),n.push({id:u.id,firstName:u.firstName,lastName:u.lastName,countryCode:u.nationality??null,isSprinter:f,multiplier:h,contribution:0})}}const i=e.leadoutBonus;if(n.length>0){const u=n.filter(b=>b.isSprinter).reduce((b,h)=>b+h.multiplier,0),m=n.filter(b=>!b.isSprinter).reduce((b,h)=>b+h.multiplier,0);let f=0,g=0;u>0&&m>0?(f=i/(2.125*u+m),g=2.125*f,f=Math.max(.1,Math.min(.3,f)),g=Math.max(.25,Math.min(.6,g))):u>0?(g=i/u,g=Math.max(.25,Math.min(.6,g)),f=g/2.125):m>0&&(f=i/m,f=Math.max(.1,Math.min(.3,f)),g=2.125*f);for(const b of n)b.contribution=b.isSprinter?g*b.multiplier:f*b.multiplier;const v=n.reduce((b,h)=>b+h.contribution,0);if(v>0){const b=i/v;for(const h of n)h.contribution*=b}n.sort((b,h)=>h.contribution-b.contribution)}else n.push({id:e.leadoutRiderId,firstName:"",lastName:e.leadoutRiderLastName??"Teampartner",countryCode:e.leadoutRiderCountryCode,isSprinter:!1,multiplier:1,contribution:i});const o=i.toFixed(2).replace(".",","),c=n.map(u=>{const m=rt(wt(u.id)??u.countryCode),f=u.firstName?`${u.firstName.charAt(0)}. ${u.lastName}`:u.lastName,g=u.contribution.toFixed(2).replace(".",",");return`
  ...
  `}function mi(e){const t=e.title||"";return t.includes("guten Tag")?1:t.includes("schlechten Tag")?2:t.includes("Formhöhepunkt")||t.includes("Formhoehepunkt")?3:t.includes("nicht am Start")?4:5}function Qa(e){var u,m,f,g,v,b,h,$,I,w;if(e==null||!d.stageResults)return"";const t=ht(d.selectedResultsRaceId),a=(t==null?void 0:t.isStageRace)??!1,r=d.stageResults.classifications,s=(m=(u=r.find(x=>x.resultTypeId===ma))==null?void 0:u.rows.find(x=>x.rank===1))==null?void 0:m.riderId,n=(g=(f=r.find(x=>x.resultTypeId===nr))==null?void 0:f.rows.find(x=>x.rank===1))==null?void 0:g.riderId,i=(b=(v=r.find(x=>x.resultTypeId===ks))==null?void 0:v.rows.find(x=>x.rank===1))==null?void 0:b.riderId,o=($=(h=r.find(x=>x.resultTypeId===5))==null?void 0:h.rows.find(x=>x.rank===1))==null?void 0:$.riderId,c=(w=(I=r.find(x=>x.resultTypeId===7))==null?void 0:I.rows.find(x=>x.rank===1))==null?void 0:w.riderId,l=[],p=d.selectedResultTypeId;return e===s&&(p===ma||p===1&&a||p!==1&&p!==ma)&&l.push('<span class="jersey-dot jersey-dot-yellow" title="Gelbes Trikot (Gesamtwertung)"></span>'),e===n&&l.push('<span class="jersey-dot jersey-dot-green" title="Grünes Trikot (Punktewertung)"></span>'),e===i&&l.push('<span class="jersey-dot jersey-dot-red" title="Rotes Trikot (Bergwertung)"></span>'),e===o&&l.push('<span class="jersey-dot jersey-dot-white" title="Weißes Trikot (Nachwuchswertung)"></span>'),e===c&&l.push('<span class="jersey-dot jersey-dot-purple" title="Ausreißertrikot (Aktivste Fahrer)"></span>'),l.length===0?"":`<span class="jersey-dots-wrapper">${l.join("")}</span>`}function pi(e){if(!e)return"";let t=e;const a=[],r=[...d.riders].sort((n,i)=>{const o=`${n.firstName} ${n.lastName}`;return`${i.firstName} ${i.lastName}`.length-o.length});for(const n of r){const o=`${n.firstName} ${n.lastName}`.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"),c=new RegExp(`${o}(\\s+\\(\\d+\\.\\))?`,"g");c.test(t)&&(t=t.replace(c,l=>{const p=`__RIDER_LINK_${a.length}__`,u=Ne(l,{riderId:n.id,teamId:n.activeTeamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return a.push(u),p}))}let s=S(t);for(let n=0;n<a.length;n++)s=s.replace(`__RIDER_LINK_${n}__`,a[n]);return s}function Ce(){var L,N,Y,K;d.riders.length===0&&V.getRiders().then(k=>{k.success&&k.data&&(d.riders=k.data,Ce())});const e=y("results-race-select"),t=y("results-stage-select"),a=y("results-type-tabs"),r=y("results-marker-tabs"),s=y("results-stage-meta"),n=y("results-empty"),i=y("results-table"),o=i.querySelector("thead tr"),c=y("results-tbody"),l=y("results-marker-classifications"),p=y("results-roster"),u=i.querySelector("colgroup");u&&u.remove(),i.style.tableLayout="",d.stageResults&&(d.selectedResultsRaceId=d.stageResults.raceId,d.selectedResultsStageId=d.stageResults.stageId),e.innerHTML='<option value="">– Rennen auswählen –</option>'+d.races.filter(k=>{var R;return(((R=k.stages)==null?void 0:R.length)??0)>0}).map(k=>`<option value="${k.id}"${k.id===d.selectedResultsRaceId?" selected":""}>${S(k.name)}</option>`).join("");const m=ht(d.selectedResultsRaceId),f=m==null?"":(m.stages??[]).map(k=>`<option value="${k.id}"${k.id===d.selectedResultsStageId?" selected":""}>${S(Wp(m,k))}</option>`).join("");t.innerHTML='<option value="">– Etappe auswählen –</option>'+f;const g=((L=d.stageResults)==null?void 0:L.classifications.filter(k=>!(m&&!m.isStageRace&&k.resultTypeId!==1&&k.resultTypeId!==6)))??[],v=g.find(k=>k.resultTypeId===d.selectedResultTypeId)??g[0]??null,b=d.selectedResultsSpecialView==="nonFinishers",h=d.selectedResultsSpecialView==="events",$=d.selectedResultsSpecialView==="roster";if(v&&!b&&!h&&!$&&(d.selectedResultTypeId=v.resultTypeId),h){i.style.tableLayout="fixed";const k=document.createElement("colgroup");k.innerHTML=`
      <col style="width: 100px;">
      <col style="width: 240px;">
      <col style="width: auto;">
    `,i.insertBefore(k,i.firstChild)}if(!d.stageResults&&!$||!v&&!b&&!h&&!$){const k=Sa(d.selectedResultsStageId);s.textContent=k?`${k.race.name} · ${k.stage.profile} · ${ie(k.stage.date)}`:"Noch keine Etappe ausgewählt.",a.innerHTML="",r.innerHTML="",r.classList.add("hidden"),c.innerHTML="",l.innerHTML="",l.classList.add("hidden"),i.classList.add("hidden"),p.innerHTML="",p.classList.add("hidden"),n.classList.remove("hidden"),n.textContent=d.selectedResultsStageId!=null?"Für diese Etappe liegen noch keine Ergebnisse vor.":"Noch keine Ergebnisse geladen.";return}$?d.resultsRoster&&(s.textContent=`${d.resultsRoster.raceName} · Starterfeld`):d.stageResults&&(s.textContent=`${d.stageResults.raceName} · Etappe ${d.stageResults.stageNumber} · ${d.stageResults.profile} · ${ie(d.stageResults.date)}`);const I=d.stageResults?Sa(d.stageResults.stageId):null,w=(I==null?void 0:I.stage.distanceKm)??null,x=new Map,M=new Map,T=new Map;if(d.stageResults){const k=d.stageResults.classifications.find(R=>R.resultTypeId===1);if(k)for(const R of k.rows)R.riderId!=null&&R.points!=null&&R.points>0&&x.set(R.riderId,R.points),R.riderId!=null&&R.breakawayKms!=null&&R.breakawayKms>0&&T.set(R.riderId,R.breakawayKms);if(d.stageResults.markerClassifications){for(const R of d.stageResults.markerClassifications)if(Ks(R.markerType,R.markerCategory)){for(const D of R.entries)if(D.riderId!=null&&D.pointsAwarded!=null&&D.pointsAwarded>0){const B=M.get(D.riderId)??0;M.set(D.riderId,B+D.pointsAwarded)}}}}const E=(v==null?void 0:v.resultTypeId)===ma,F=(v==null?void 0:v.resultTypeId)===nr||(v==null?void 0:v.resultTypeId)===ks,A=(v==null?void 0:v.resultTypeId)===5,_=(v==null?void 0:v.resultTypeId)===6,z=(v==null?void 0:v.resultTypeId)===7,O=E||F||A||_||z,G=g.map(k=>`
    <button
      type="button"
      class="results-type-btn${!b&&!h&&!$&&k.resultTypeId===d.selectedResultTypeId?" active":""}"
  ...
  `,U=`
    ...
    >Teilnehmer</button>
  `,j=g.findIndex(k=>k.resultTypeName.toLocaleLowerCase("de").includes("team"));j>=0?G.splice(j+1,0,C,H,U):G.push(C,H,U),a.innerHTML=G.join("");const X=Gp(((N=d.stageResults)==null?void 0:N.markerClassifications)??[]);if($){p.innerHTML=Vp(),p.classList.remove("hidden"),i.classList.add("hidden"),r.innerHTML="",r.classList.add("hidden"),l.innerHTML="",l.classList.add("hidden"),n.classList.add("hidden");return}else p.innerHTML="",p.classList.add("hidden");const J=!b&&!h&&!$&&(v==null?void 0:v.resultTypeId)===1&&X.length>0,te=J?d.selectedResultsMarkerKey??at:null,W=J&&te!==at?X.find(k=>k.markerKey===te)??null:null;if(J&&(d.selectedResultsMarkerKey=(W==null?void 0:W.markerKey)??at),h){const k=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"},{key:"superteam",label:"Superteam"}];r.innerHTML=k.map(R=>`
      <button
        type="button"
        class="results-type-btn${R.key===Be?" active":""}"
        data-event-filter="${R.key}"
      >${S(R.label)}</button>
    `).join("")}else r.innerHTML=J?[`
        ...
        >${S(Kp(k))}</button>
      `)].join(""):"";r.classList.toggle("hidden",!h&&!J);const P=b||h||!J||d.selectedResultsMarkerKey===at;if(o&&P&&(o.innerHTML=b?`
        <th>Etappe</th>
        <th>Status</th>
      ...
      `:F?`
        ...
        <th class="results-points-cell">Punktewertung</th>
        <th>UCI Punkte</th>
      `),c.innerHTML=b?(((Y=d.stageResults)==null?void 0:Y.nonFinishers)??[]).map(k=>`
      <tr>
        <td>${k.stageNumber}</td>
        <td>${Pi(k.isOtl)}</td>
    ...
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':h?[...((K=d.stageResults)==null?void 0:K.events)??[]].filter(k=>Be==="all"?!0:Be==="form"?!!(k.title&&(k.title.includes("guten Tag")||k.title.includes("schlechten Tag")||k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))):Be==="attack"?(k.type==="attack"||k.type==="counter_attack")&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Be==="breakaway"?!!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Be==="incident"?(k.type==="incident"||!!(k.title&&k.title.includes("Massensturz")))&&!(k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))):Be==="exit"?k.type==="dnf"||!!(k.title&&k.title.includes("nicht am Start")):Be==="home"?!!(k.title&&(k.title.includes("Heimvorteil")||k.title.includes("Heimdruck"))):Be==="weather"?!!(k.title&&k.title.startsWith("Wetterbericht:")):Be==="superteam"?k.type==="superteam":!0).sort((k,R)=>{const D=k.kmMark??0,B=R.kmMark??0;if(Math.abs(D-B)>1e-4)return D-B;if(D===0){const fe=mi(k),ge=mi(R);if(fe!==ge)return fe-ge}const Z=k.riderName??"",ne=R.riderName??"";return Z.localeCompare(ne,"de")}).map(k=>{var oa,yt,la;const R=k.kmMark!=null?`${k.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",D=k.riderId,B=D!=null?we(D):null,Z=k.riderTeamId??(B==null?void 0:B.activeTeamId)??null,ne=Z!=null?((oa=d.teams.find(Te=>Te.id===Z))==null?void 0:oa.name)??null:null;let fe=jt(Z,ne);const ge=!!(k.title&&k.title.startsWith("Wetterbericht:"));let xe=k.title||"";if(ge){const Te=(yt=d.stageResults)==null?void 0:yt.rolledWeatherId,Ft=(la=d.stageResults)==null?void 0:la.rolledWetterName;fe=`<span class="results-jersey-cell">${xa(Te,Ft)}</span>`,Ft&&(xe=`Wetterbericht: ${Ft}`)}const ve=k.type==="superteam",he=ve&&D==null,Se=ge||he?"":rt(D!=null?wt(D):null),tt=ge?"":he?Ze(ne||"–",Z):D!=null?Vt(k.riderName??"",!0,!1,D,Z):S(k.riderName||"–");let le="";return k.title&&k.title.includes("guten Tag")?le='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':k.title&&k.title.includes("schlechten Tag")?le='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':k.title&&(k.title.includes("Formhöhepunkt")||k.title.includes("Formhoehepunkt"))?le='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':k.title&&k.title.includes("nicht am Start")?le='<span class="event-badge event-badge-dns">DNS</span>':k.title&&k.title.includes("Massensturz")?le='<span class="event-badge event-badge-masscrash">Massensturz</span>':k.type==="dnf"?le='<span class="event-badge event-badge-dnf">DNF</span>':k.title&&(k.title.toLowerCase().includes("ausreiß")||k.title.toLowerCase().includes("ausreiss"))?le='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':k.type==="attack"?le='<span class="event-badge event-badge-attack">Attacke</span>':k.type==="counter_attack"?le='<span class="event-badge event-badge-counter">Konterattacke</span>':k.type==="incident"?k.title&&(k.title.toLowerCase().includes("defekt")||k.title.toLowerCase().includes("panne")||k.title.toLowerCase().includes("technisch"))?le='<span class="event-badge event-badge-defect">Defekt</span>':le='<span class="event-badge event-badge-crash">Sturz</span>':k.title&&k.title.includes("Super-Heimvorteil")?le='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Heimbonus</span>':k.title&&k.title.includes("Heimdruck")?le='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimmalus</span>':k.title&&k.title.includes("Heimvorteil")?le='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':k.title&&k.title.startsWith("Wetterbericht:")?le='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>':ve&&(le='<span class="event-badge event-badge-superteam"><span class="event-icon">⚡</span> Superteam</span>'),`
            ...
            <td>
              <div class="event-content">
                <div class="event-title-wrapper">
                  <span class="event-title">${pi(xe)}</span>
                  ${le}
                </div>
                ${k.detail?`<div class="event-detail">${pi(k.detail)}</div>`:""}
              </div>
            </td>
          </tr>`}).join("")||'<tr><td colspan="3" class="results-empty-cell">Keine Ereignisse für diese Etappe.</td></tr>':P&&v?v.rows.map(k=>{const R=k.riderName??k.teamName,D=k.riderName?k.teamName:"–",B=jt(k.teamId,k.teamName),Z=Vt(R,!0,k.isBreakaway===!0,k.riderId,k.teamId),ne=rt(wt(k.riderId)),fe=v.resultTypeId===1&&k.rank===1&&k.timeSeconds!=null&&w!=null,ge=k.timeSeconds!=null?`${va(k.timeSeconds)}${fe?` (${Op(w,k.timeSeconds)})`:""}`:"–",xe=O?`<td class="results-gc-delta-cell">${or(k.previousRank,k.rankDelta)}</td>`:"";if(F){let he=k.points!=null?String(k.points):"–";if(k.points!=null&&k.riderId!=null&&v){const tt=v.resultTypeId===nr?x.get(k.riderId)??0:M.get(k.riderId)??0;tt>0&&(he+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${tt}</span>`)}return`
          <tr>
          ...
          </tr>`}if(z){let he=k.breakawayKms!=null?`${k.breakawayKms.toFixed(1).replace(".",",")} km`:"–";if(k.breakawayKms!=null&&k.riderId!=null){const Se=T.get(k.riderId)??0;Se>0&&(he+=` <span style="font-size: 0.67em; color: var(--success, #22c55e); font-weight: bold; margin-left: 2px;">+${Se.toFixed(1).replace(".",",")} km</span>`)}return`
          <tr>
            <td class="pos-${Math.min(k.rank,3)}">${k.rank}</td>
            ${xe}
            <td class="results-jersey-col-cell">${B}</td>
          ...
          <tr>
            ...
            <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
          </tr>`;let ve=k.points!=null?String(k.points):"–";if(k.leadoutBonus!=null&&k.leadoutBonus>0&&k.leadoutRiderId!=null){const he=Yp(k);ve=`
        ...
        <tr>
          ...
          <td>${k.uciPoints!=null?k.uciPoints:"–"}</td>
        </tr>`}).join(""):"",n.classList.toggle("hidden",!!v||b||h||$),i.classList.toggle("hidden",!P||$),W){const k=`
      ...
      </section>`,R=W.entries.map(D=>{var fe;const B=we(D.riderId),Z=B?`${B.firstName} ${B.lastName}`:`Fahrer ${D.riderId}`,ne=(B==null?void 0:B.activeTeamId)!=null?((fe=d.teams.find(ge=>ge.id===B.activeTeamId))==null?void 0:fe.name)??null:null;return`
...
`+(a.error??"Unbekannter Fehler")),!1;const r=a.data;d.realtimeBootstrap=r;const s=await Bc(r,o=>xs(o)),n=al(s,r),i=rl(s,r);return await cl(e,n,s.markerClassifications,s.incidents,s.allEvents,t,i,s.superTeamId),!0}catch(a){return alert("Unerwarteter Fehler bei der Instant-Simulation: "+a.message),!1}finally{as(null),ye()}}function nl(e){var r;const t=(r=d.rosterEditor)==null?void 0:r.teams.find(s=>s.team.id===e);if(!t)return 0;const a=new Set(d.rosterEditorSelectedRiderIds);return t.riders.filter(s=>a.has(s.rider.id)).length}function il(){return d.rosterEditor?d.rosterEditor.teams.every(e=>nl(e.team.id)===e.riderLimit):!1}function qr(){const e=y("roster-editor-title"),t=y("roster-editor-meta"),a=y("roster-editor-body"),r=y("btn-apply-roster-editor"),s=d.rosterEditor;if(!s){e.textContent="Starterfeld bearbeiten",t.textContent="",a.innerHTML='<div class="results-empty">Kein Starterfeld geladen.</div>',r.disabled=!0;return}e.textContent="Starterfeld bearbeiten",t.textContent=s.race.isStageRace?`${s.race.name} · Etappe ${s.stage.stageNumber} · ${s.stage.profile}`:`${s.race.name} · ${s.stage.profile}`;const n=new Set(d.rosterEditorSelectedRiderIds);a.innerHTML=s.teams.map(i=>{const o=nl(i.team.id),c=o===i.riderLimit?"roster-editor-team-count-ok":"roster-editor-team-count-bad";return`
      <section class="roster-editor-team">
        ...
        <div class="roster-editor-riders">
          ${i.riders.map(l=>{var v;const u=["roster-editor-rider",n.has(l.rider.id)?"roster-editor-rider-selected":"",l.isLocked?"roster-editor-rider-locked":""].filter(Boolean).join(" "),m=l.rider.country?oe(l.rider.country.code3):"",f=[((v=l.rider.role)==null?void 0:v.name)??"Ohne Rolle",`OVR ${Math.round(l.rider.overallRating)}`].join(" · "),g=l.lockReason?`<span class="roster-editor-rider-lock">${S(l.lockReason)}</span>`:"";return`
              <button
                type="button"
                class="${u}"
...
`+(c.error??"Unbekannter Fehler"));return}const l=c.data;d.selectedResultsRaceId=(l==null?void 0:l.raceId)??d.selectedResultsRaceId,d.selectedResultsStageId=(l==null?void 0:l.stageId)??e,d.selectedResultTypeId=1,d.realtimeBootstrap=null,d.realtimeError=null,await us(e,!1),await Xs(),await Qs(),await $r(),Qt(),n||Rt("results")}catch(c){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+c.message)}finally{ts(!1),ye()}}}function ag(){y("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);d.selectedRealtimeStageId=Number.isFinite(t)?t:null,d.realtimeBootstrap&&d.realtimeBootstrap.stage.id!==d.selectedRealtimeStageId&&(d.realtimeBootstrap=null),d.realtimeError=null,dl(t,!1)})}function qs(e){var r;const t=lt((r=e.category)==null?void 0:r.name),a=wa(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function Lr(e){var s,n;const t=lt((s=e.category)==null?void 0:s.name),a=wa(t),r=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(r)}</span>`}function rg(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(r=>r.date).sort((r,s)=>r.localeCompare(s));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function Dr(e){const{startDate:t,endDate:a}=rg(e);return t===a?ie(t):`${ie(t)} - ${ie(a)}`}function sg(e){return e.stageId>0}async function Xs(){const[e,t]=await Promise.all([V.getGameState(),V.getGameStatus()]);if(!e.success){console.error(e.error);return}d.gameState=e.data??null,d.gameStatus=t.success?t.data??null:null,ng(),Ie("dashboard")&&_r()}function ng(){var s;if(!d.gameState)return;y("meta-date").textContent=d.gameState.formattedDate,y("meta-season").textContent=`Saison ${d.gameState.season}`;const e=y("meta-race-hint"),t=y("btn-advance-day"),a=y("pending-stages-list"),r=((s=d.gameStatus)==null?void 0:s.pendingStages)??[];r.length>0?(e.textContent=`${r.length} offene Etappe${r.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=r.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${ie(n.date)}`:`${n.profile} · ${ie(n.date)}`,o=sg(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
    ...
    <tr>
      ...
      <td>${l}</td>
      <td>${r}</td>
    </tr>`}function dg(){const e=y("dashboard-races-tbody");if(!d.gameState){e.innerHTML='<tr><td colspan="9" class="text-muted">Kein Spiel geladen.</td></tr>';return}const t=d.gameState.currentDate,a=lg(t,7),r=d.races.filter(i=>i.startDate<=t&&i.endDate>=t),s=d.races.filter(i=>i.startDate>t&&i.startDate<=a);let n="";n+=`
  ...
  `,s.length===0?n+=`
    ...
    </div>`}async function gs(e){ht(e)&&(d.selectedDashboardRaceId=e,pg(),Xe("raceStages"))}function gg(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
        ...
        <tbody>
          ${t.map(a=>{var r,s;return`
            <tr class="race-participants-row">
              ...
              <td><span class="race-participant-rider-cell">${oe(It(a.rider))}<strong>${S(Le(a.rider))}</strong></span></td>
              <td>${S(fs(a.rider))}</td>
              <td>${S(ft(a.rider))}</td>
    ...
    </th>`}function hg(e){const t=d.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,r)=>{var n,i,o,c;let s=0;switch(d.raceParticipantsSort.key){case"team":s=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=r.team)==null?void 0:i.name)??"","de");break;case"rider":s=Le(a.rider).localeCompare(Le(r.rider),"de");break;case"spec1":s=fs(a.rider).localeCompare(fs(r.rider),"de");break;case"role":s=ft(a.rider).localeCompare(ft(r.rider),"de");break;case"overall":s=a.rider.overallRating-r.rider.overallRating;break;case"phase":s=(a.rider.seasonFormPhase??"neutral").localeCompare(r.rider.seasonFormPhase??"neutral","de");break;default:s=(((o=a.program)==null?void 0:o.name)??"").localeCompare(((c=r.program)==null?void 0:c.name)??"","de")}return s*t||Le(a.rider).localeCompare(Le(r.rider),"de")})}function fs(e){return e.specialization1!=null?Zt(e.specialization1):"–"}async function ul(e){const t=ht(e);d.selectedRaceParticipantsRaceId=e,y("race-participants-title").textContent=(t==null?void 0:t.name)??"Teilnehmer",y("race-participants-meta").textContent="Lade Programmfahrer ...",y("race-participants-body").innerHTML="",d.raceParticipants=[],Xe("raceParticipants"),await ml()}async function ml(e=!1){const t=d.selectedRaceParticipantsRaceId;if(t==null)return;const a=ht(t);e&&(y("race-participants-meta").textContent="Lade Programmfahrer ...");const r=await V.getRaceProgramParticipants(t);if(!r.success||!r.data){y("race-participants-meta").textContent="",y("race-participants-body").innerHTML=`<div class="results-empty">${S(r.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}d.raceParticipants=r.data,y("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",y("race-participants-meta").textContent=`${r.data.length} Programmfahrer · ${a?Dr(a):""}`,y("race-participants-body").innerHTML=fg(d.raceParticipants)}async function xr(e,t=null){let a=Sa(e);if(!a&&d.stageEditorStageRows){const n=d.stageEditorStageRows.find(i=>i.stageId===e);n&&(a={race:{id:n.raceId,name:n.raceName,countryId:0,categoryId:0,isStageRace:!0,numberOfStages:1,startDate:"",endDate:"",prestige:0},stage:{id:n.stageId,raceId:n.raceId,stageNumber:n.stageNumber,date:"2026-01-01",profile:n.profile,startElevation:0,detailsCsvFile:"",distanceKm:n.distanceKm,elevationGainMeters:n.elevationGainMeters}})}if(!a)return;const r=await mg(e);if(!r){alert(d.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}d.selectedDashboardProfileStageId=e,y("stage-profile-title").textContent=`${a.race.name} · ${Fa(a.stage)}`;const s=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";y("stage-profile-meta").textContent=`${ie(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?lr(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?dr(a.stage.elevationGainMeters):"–"}${s}`,td(y("stage-profile-view"),r,a.stage.profile,Ar(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),Xe("stageProfile")}function bg(){y("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const s=Number(t.dataset.editStageRoster);if(!Number.isFinite(s))return;eg(s);return}const a=e.target.closest("button[data-live-stage]");if(a){const s=Number(a.dataset.liveStage);if(!Number.isFinite(s))return;dl(s,!0);return}const r=e.target.closest("button[data-instant-stage]");if(r){const s=Number(r.dataset.instantStage);if(!Number.isFinite(s))return;sl(s)}}),y("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-participants-id]");if(t){const s=Number(t.dataset.dashboardRaceParticipantsId);Number.isFinite(s)&&ul(s);return}const a=e.target.closest("button[data-dashboard-race-id]");if(!a)return;const r=Number(a.dataset.dashboardRaceId);Number.isFinite(r)&&gs(r)}),y("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&xr(a)}),y("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const s=Number(t.dataset.riderProgramId);Number.isFinite(s)&&en(s);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const r=a.dataset.raceParticipantsSort;d.raceParticipantsSort.key===r?d.raceParticipantsSort.direction=d.raceParticipantsSort.direction==="asc"?"desc":"asc":d.raceParticipantsSort={key:r,direction:"asc"},ml()}),y("btn-advance-day").addEventListener("click",async()=>{await pl()}),y("btn-auto-progress").addEventListener("click",()=>{yg()})}async function pl(){var t,a;$e("Tag wird fortgeschrieben...");const e=(t=d.gameState)==null?void 0:t.season;try{const r=await V.advanceDay();if(!r.success)return alert(`Tageswechsel fehlgeschlagen:
`+(r.error??"Unbekannter Fehler")),!1;if(d.currentSave&&r.data&&(d.currentSave.currentSeason=r.data.season),await Xs(),await Qs(),Ie("teams")){const{refreshTeamsViewData:n}=await qa(async()=>{const{refreshTeamsViewData:i}=await Promise.resolve().then(()=>Xp);return{refreshTeamsViewData:i}},void 0);await n()}const s=(a=d.gameState)==null?void 0:a.season;if(e&&s&&s>e){Ta();const{startDraftPresentation:n}=await qa(async()=>{const{startDraftPresentation:o}=await Promise.resolve().then(()=>Gg);return{startDraftPresentation:o}},void 0),{activateView:i}=await qa(async()=>{const{activateView:o}=await Promise.resolve().then(()=>Al);return{activateView:o}},void 0);i("draft"),n(s)}return!0}catch(r){return alert("Unerwarteter Fehler beim Tageswechsel: "+r.message),!1}finally{ye()}}function tn(){const e=document.getElementById("btn-auto-progress");e&&(ct?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function yg(){ct?Ta():gl()}function gl(){ct||(Ss(!0),tn(),vg())}function Ta(){ct&&(Ss(!1),d.autoProgressTargetDate=null,tn())}async function vg(){var e,t;for(;ct;){const a=(e=d.gameState)==null?void 0:e.currentDate;if(d.autoProgressTargetDate&&a&&a>=d.autoProgressTargetDate){Ta();break}const r=((t=d.gameStatus)==null?void 0:t.pendingStages)??[];let s=!1;if(r.length>0){const n=r[0];s=await sl(n.stageId,!0)}else s=await pl();if(!s){Ta();break}await new Promise(n=>setTimeout(n,100))}tn()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&ct){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),Ta()}});const ba=50;function an(){return[...Ws,...js[d.riderMenuDetailPage]]}function fl(e){return d.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${d.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function hl(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=d.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
...
`+a.error);return}d.draftHistory=a.data??null,Ie("draft")&&Tr()}function Tr(){const e=y("draft-table-container"),t=y("draft-season-select");if(!d.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(t.options.length===0){const s=(d.currentSave.startSeason??2026)+1;for(let n=d.currentSave.currentSeason;n>=s;n--){const i=document.createElement("option");i.value=n.toString(),i.textContent=`Saison ${n}`,t.appendChild(i)}d.draftSelectedSeason||(d.draftSelectedSeason=Math.max(s,d.currentSave.currentSeason)),t.value=d.draftSelectedSeason.toString(),t.onchange=n=>{const i=n.target;d.draftSelectedSeason=parseInt(i.value,10),Br(d.draftSelectedSeason)}}if(!d.draftHistory){e.innerHTML='<div class="alert alert-info">Lade Draft Historie...</div>';return}if(d.draftHistory.rows.length===0){e.innerHTML='<div class="alert alert-info">Keine Draft-Einträge für diese Saison vorhanden.</div>';return}const a=[...d.draftHistory.rows].sort((s,n)=>{let i=0;const o=qe.key;return o==="riderLastName"?i=s.riderLastName.localeCompare(n.riderLastName):o==="teamName"?i=s.teamName.localeCompare(n.teamName):o==="oldTeamName"?i=(s.oldTeamName||"").localeCompare(n.oldTeamName||""):o==="countryCode"?i=s.countryCode.localeCompare(n.countryCode):i=(s[o]??0)-(n[o]??0),qe.asc?i:-i});let r=`
  ...
  `;for(const s of a){const n=d.draftHistory.season-s.riderBirthYear;let i="-";s.oldTeamName&&(i=`
    ...
    `}r+="</tbody></table>",e.innerHTML=r}function $l(){y("draft-table-container").addEventListener("click",t=>{const a=t.target.closest("button[data-draft-sort]");if(a){const r=a.dataset.draftSort;r&&(qe.key===r?qe.asc=!qe.asc:(qe.key=r,qe.asc=!0),Tr())}})}function Hr(){d.draftOverlayTimer1&&(clearTimeout(d.draftOverlayTimer1),d.draftOverlayTimer1=null),d.draftOverlayTimer2&&(clearTimeout(d.draftOverlayTimer2),d.draftOverlayTimer2=null)}function xl(e,t,a){const r=d.teams.find(c=>c.id===e),s=(r==null?void 0:r.division)==="U23"?20:(r==null?void 0:r.division)==="ProTour"?30:32,n=d.riders.filter(c=>c.activeTeamId===e).length,i=a.slice(t+1).filter(c=>c.teamId===e).length,o=n-i;return Math.max(0,s-o)}function _g(e,t){return e==null||e<=0?`
    ...
    `:_e(e,t||"")}function Ag(e,t){const a=t?"border: 2px solid var(--accent, #38bdf8); background: rgba(56, 189, 248, 0.08);":"border: 1px solid rgba(255,255,255,0.08); background: rgba(255,255,255,0.02);",r=e.uciRank?`UCI: #${e.uciRank}`:"UCI: -",s=e.specialization?S(e.specialization):"Allrounder";return`
  ...
  `}function Bg(e){const t=d.draftHistory?d.draftHistory.season-e.riderBirthYear:0,a=e.riderSpecialization||"Allrounder";return`
  ...
  `}function Hg(e){let t=document.getElementById("draft-overlay");return t||(t=document.createElement("div"),t.id="draft-overlay",t.style.cssText=`
...
`+t.error);return}d.injuries=t.data??[],Ie("injuries")&&hi()}function hi(){const e=y("injuries-table-container");if(!d.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(y("injuries-meta").textContent=d.injuries.length+" Ausfälle",d.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=na;let t="";const a=d.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),r=new Map;for(const n of a){const i=n.teamId;r.has(i)||r.set(i,[]),r.get(i).push(n)}for(const n of r.keys())r.get(n).sort((i,o)=>o.overallRating-i.overallRating);const s=Array.from(r.keys()).sort((n,i)=>{const o=r.get(n)[0].teamAbbreviation||"",c=r.get(i)[0].teamAbbreviation||"";return o.localeCompare(c)});if(s.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of s){const i=r.get(n),o=i[0].teamAbbreviation;t+=`
        <div style="margin-bottom: 2rem;">
          ...
          <table class="data-table injuries-table">
            ...
            <tbody>
      `;for(const c of i){const l=c.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let p="";if(c.fitDate){const u=ie(c.fitDate);if(c.missedRaces&&c.missedRaces.length>0){let m="";for(const f of c.missedRaces)m+=`
    ...
    </div>`}async function Tl(e){const t=d.seasonStandingsSelectedSeason??void 0,a=await V.getSeasonStandings(t);if(!a.success){d.seasonStandings=null,Ie("season-standings")&&bs(),!e&&a.error&&alert(`Saisonwertung konnte nicht geladen werden:
`+a.error);return}d.seasonStandings=a.data??null,Ie("season-standings")&&bs()}function bs(){var v,b,h,$,I,w,x,M;const e=y("season-standings-meta"),t=y("season-standings-scope-tabs"),a=y("season-standings-empty"),r=y("season-standings-table"),s=y("season-standings-tbody"),n=y("season-standings-jersey-header"),i=y("season-standings-primary-header"),o=y("season-standings-flag-header"),c=y("season-standings-secondary-header"),l=((v=d.seasonStandings)==null?void 0:v.season)??((b=d.gameState)==null?void 0:b.season)??((h=d.currentSave)==null?void 0:h.currentSeason)??null;e.textContent=l!=null?`Saison ${l} · Ergebnis- und Trikotpunkte kumuliert`:"Noch keine Saisonwertung geladen.";const p=y("season-standings-year-select");if(p){const T=(($=d.seasonStandings)==null?void 0:$.availableSeasons)||[],E=d.seasonStandingsSelectedSeason??((I=d.gameState)==null?void 0:I.season)??2026;p.innerHTML=T.map(F=>`
    ...
    >Country</button>
  `;const u=d.selectedSeasonStandingScope==="countries",m=u?((w=d.seasonStandings)==null?void 0:w.countryStandings)??[]:d.selectedSeasonStandingScope==="teams"?((x=d.seasonStandings)==null?void 0:x.teamStandings)??[]:((M=d.seasonStandings)==null?void 0:M.riderStandings)??[],f=u?m:[],g=u?[]:m;if(n.textContent="Trikot",i.textContent=u?"Land":d.selectedSeasonStandingScope==="teams"?"Team":"Fahrer",o.textContent="Flagge",c.textContent=d.selectedSeasonStandingScope==="teams"?"Land":"Team",n.classList.toggle("hidden",u),c.classList.toggle("hidden",u),!d.seasonStandings||m.length===0){s.innerHTML="",r.classList.add("hidden"),a.classList.remove("hidden"),a.textContent="Noch keine Saisonpunkte vorhanden.";return}s.innerHTML=u?f.map(T=>`
      <tr>
        <td class="pos-${Math.min(T.rank,3)}">${T.rank}</td>
        <td class="results-jersey-col-cell hidden"></td>
        <td class="season-standings-country-cell">${Wg(T)}</td>
        <td class="results-flag-col-cell">${rt(T.countryCode)}</td>
        <td class="hidden"></td>
        <td>${T.points}</td>
        <td>${S(bi(T.gapPoints))}</td>
      </tr>`).join(""):g.map(T=>{var O;const E=T.riderName??T.teamName,F=jt(T.teamId,T.teamName),A=d.selectedSeasonStandingScope==="teams"?Vg(T,((O=d.seasonStandings)==null?void 0:O.riderStandings)??[]):Vt(E,!0,!1,T.riderId,T.teamId),_=rt(T.countryCode),z=d.selectedSeasonStandingScope==="teams"?S(T.countryName??T.countryCode??"–"):Ze(T.teamName??"–",T.teamId,!1);return`
        <tr>
          <td class="pos-${Math.min(T.rank,3)}">${T.rank}</td>
    ...
    `}).join(""),i=[...e.riders].sort((l,p)=>(p.overallRating??0)-(l.overallRating??0)).slice(0,10).map(l=>{const p=`${l.firstName.charAt(0)}. ${l.lastName}`,u=Ne(p,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),m=l.nationality?ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,f=m?`<span class="fi fi-${m} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",g=l.overallRating.toFixed(0),v=d.riders.find(h=>h.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
    ...
    `}).join(""),o=a.map(({rider:l,formValue:p})=>{const u=`${l.firstName.charAt(0)}. ${l.lastName}`,m=Ne(u,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=l.nationality?ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"",v=(p>=0?"+":"")+p.toFixed(1).replace(".",","),b=`S-Form: ${l.formBonus>=0?"+":""}${l.formBonus.toFixed(1)} / R-Form: ${l.raceFormBonus>=0?"+":""}${l.raceFormBonus.toFixed(1)}`,h=d.riders.find(I=>I.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${Ya((h==null?void 0:h.roleId)??null).color};">
          ${g}
          ${m}
        </span>
        <span style="font-weight: 700; color: #fbbf24;" title="${b}">${v}</span>
      </li>
    `}).join(""),c=r.map(({rider:l,uciRank:p})=>{const u=`${l.firstName.charAt(0)}. ${l.lastName}`,m=Ne(u,{riderId:l.id,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),f=l.nationality?ze[l.nationality]??l.nationality.slice(0,2).toLowerCase():null,g=f?`<span class="fi fi-${f} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px; margin-right: 0.25rem;" title="${S(l.nationality)}"></span>`:"";let v="rider-stats-rank-badge-gc";p===1?v="rider-stats-rank-badge-place rider-stats-rank-badge-top-1":p===2?v="rider-stats-rank-badge-place rider-stats-rank-badge-top-2":p===3&&(v="rider-stats-rank-badge-place rider-stats-rank-badge-top-3");const b=`<span class="rider-stats-rank-badge ${v}" style="margin: 0; font-size: 0.75rem; padding: 0; min-width: 2rem; height: 1.35rem; display: inline-flex; align-items: center; justify-content: center; text-align: center; box-sizing: border-box; line-height: 1;" title="UCI Weltrangliste: Platz ${p}">${p}</span>`,h=d.riders.find(I=>I.id===l.id);return`
      <li style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem; font-size: 0.85rem;">
        <span style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 75%; display: flex; align-items: center; color: ${Ya((h==null?void 0:h.roleId)??null).color};">
          ${g}
          ${m}
  ...
  `}function Qr(){return`
    ...
    </div>`}function Qg(e){const t=Array.from(new Set(e.topResults.map(m=>m.raceCategoryName).filter(Boolean)));t.sort((m,f)=>m.localeCompare(f,"de"));const a=Array.from(new Set(e.topResults.map(m=>m.season))).sort((m,f)=>f-m);let r=e.topResults.filter(m=>m.rowType!=="stage_result"?m.rowType==="gc_final"?d.teamStatsTopResultsFilters.gc:m.rowType==="mountain_final"?d.teamStatsTopResultsFilters.mountain:m.rowType==="points_final"?d.teamStatsTopResultsFilters.points:m.rowType==="youth_final"?d.teamStatsTopResultsFilters.youth:!0:m.isStageRace?d.teamStatsTopResultsFilters.stage:d.teamStatsTopResultsFilters.oneDay);if(d.teamStatsTopResultsFilterCategory){const m=d.teamStatsTopResultsFilterCategory;if(m.endsWith("-etappen")){const f=m.substring(0,m.length-8);r=r.filter(g=>g.raceCategoryName===f&&g.rowType==="stage_result")}else if(m.endsWith("-gc")){const f=m.substring(0,m.length-3);r=r.filter(g=>g.raceCategoryName===f&&g.rowType!=="stage_result")}else r=r.filter(f=>f.raceCategoryName===m)}d.teamStatsTopResultsFilterSeason!=null&&(r=r.filter(m=>m.season===d.teamStatsTopResultsFilterSeason)),r.sort((m,f)=>{if(f.seasonPoints!==m.seasonPoints)return f.seasonPoints-m.seasonPoints;const g=m.rowType!=="stage_result",v=f.rowType!=="stage_result",b=m.resultRank??9999,h=f.resultRank??9999;if(d.teamStatsTopResultsFilterCategory)return b!==h?b-h:g!==v?g?-1:1:0;{const $=yi(m.raceCategoryName),I=yi(f.raceCategoryName);return $!==I?$-I:g!==v?g?-1:1:b-h}});const s=20,n=Math.max(1,Math.min(10,Math.ceil(r.length/s)));d.teamStatsTopResultsPage>n&&(d.teamStatsTopResultsPage=n);const i=(d.teamStatsTopResultsPage-1)*s,o=r.slice(i,i+s),l=`
    <div class="rider-stats-top-results-filters" style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; align-items: center; flex-wrap: wrap; background: rgba(255, 255, 255, 0.03); padding: 0.75rem 1rem; border-radius: 8px; border: 1px solid rgba(255, 255, 255, 0.05);">
      <div class="form-group" style="margin: 0; display: flex; align-items: center;">
        <label style="margin-right: 0.5rem; font-weight: 600; white-space: nowrap; color: #ccc;">Rennklasse:</label>
        <select id="team-stats-filter-category" class="form-control" style="width: auto; display: inline-block; background: #222; color: #fff; border-color: #444;">
          <option value="all">Alle Rennklassen</option>
          ${t.map(m=>{if(m.toLowerCase().includes("stage race")||m.toLowerCase().includes("grand tour")||m.toLowerCase().includes("tour de france")){const g=`${m}-etappen`,v=`${m}-gc`;return`
        <option value="${S(g)}" ${d.teamStatsTopResultsFilterCategory===g?"selected":""}>${S(m)} - Etappen</option>
        <option value="${S(v)}" ${d.teamStatsTopResultsFilterCategory===v?"selected":""}>${S(m)} - GC</option>
  ...
  `,p=o.length===0?'<tr><td colspan="11" class="text-center text-muted" style="padding: 2rem;">Keine Ergebnisse für diese Filterkombination.</td></tr>':o.map(m=>{const f=m.rowType!=="stage_result",g=f?`${m.raceName} · ${m.rowType==="gc_final"?"Gesamtwertung":m.rowType==="points_final"?"Punktewertung":m.rowType==="mountain_final"?"Bergwertung":"Nachwuchs"}`:m.stageNumber&&m.isStageRace?`${m.raceName} · Etappe ${m.stageNumber}`:m.raceName;let v="–",b="–";m.finishStatus==="otl"?v=Ht("OTL","place"):m.finishStatus==="dnf"?v=Ht("DNF","place"):m.resultRank==null||(f?b=`<span class="rider-stats-final-type ${m.rowType==="gc_final"?"is-gc":m.rowType==="points_final"?"is-points":m.rowType==="mountain_final"?"is-mountain":"is-youth"}" style="font-weight: 700; padding: 0.15rem 0.45rem; border-radius: 4px; border: 1px solid; display: inline-block; min-width: 1.8rem; text-align: center;">${m.resultRank}</span>`:v=`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${m.resultRank<=3?` rider-stats-rank-badge-top-${m.resultRank}`:""}">${S(String(m.resultRank))}</span>`);const h=m.profile?Pa(m.profile):"–",$=!f&&m.stageScore!=null&&m.stageScore>0?Nr(m.stageScore,0,350):"–",I=Sr(m.raceCategoryName),w=m.riderCountryCode?ze[m.riderCountryCode]??m.riderCountryCode.slice(0,2).toLowerCase():null,x=w?`<span class="fi fi-${w} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px;" title="${S(m.riderCountryCode??"")}"></span>`:"–",M=Ne(m.riderName,{riderId:m.riderId,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return`
  ...
  `}function ef(e){const t=String(d.teamStatsSelectedSeason),a=e.successStats[t]||{breakawayAttempts:0,attacks:0,counterAttacks:0,crashes:0,defects:0,illnesses:0,illnessDays:0,injuries:0,injuryDays:0,dnsCount:0,dnfCount:0,otlCount:0,totalGcWins:0,totalStageWins:0,successfulBreakaways:0,raceDays:0,superteamCount:0,categories:{}},r=t==="all",s=u=>r?u:"–",n=(u,m)=>r?`${u} / ${m} T`:"–",i=r?"":' title="Dieser Wert wird systemweit nur all-time erfasst."',o=(u,m,f,g)=>{const v=typeof u=="number"?u:parseFloat(String(u))||0;let b="padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.8rem; font-weight: bold; min-width: 1.8rem; text-align: center; display: inline-block; box-sizing: border-box;";return v===0?b+="background: rgba(255, 255, 255, 0.05); color: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.1);":m==="gold"?b+="background: linear-gradient(135deg, #ffd700, #ffa500); color: #000; box-shadow: 0 0 5px rgba(255, 215, 0, 0.4); text-shadow: 0 0 1px rgba(255,255,255,0.3);":m==="silver"?b+="background: linear-gradient(135deg, #e5e7eb, #9ca3af); color: #000; box-shadow: 0 0 5px rgba(229, 231, 235, 0.4);":m==="bronze"?b+="background: linear-gradient(135deg, #d35400, #a04000); color: #fff; box-shadow: 0 0 5px rgba(211, 84, 0, 0.4);":m==="purple"?b+="background: linear-gradient(135deg, #a855f7, #7e22ce); color: #fff; box-shadow: 0 0 5px rgba(168, 85, 247, 0.4);":m==="green"?b+="background: #2ecc71; color: #fff; box-shadow: 0 0 5px rgba(46, 204, 113, 0.4);":m==="red"?b+="background: #e74c3c; color: #fff; box-shadow: 0 0 5px rgba(231, 76, 60, 0.4);":m==="white"&&(b+="background: #ffffff; color: #000; border: 1px solid #ccc; box-shadow: 0 0 5px rgba(255, 255, 255, 0.4);"),`<span style="${b}" title="${S(f)}: ${v} Siege">${u}</span>`},c=[{key:"World Tour - Tour de France",name:"Tour de France",isStage:!0},{key:"World Tour - Grand Tour",name:"Grand Tour",isStage:!0},{key:"World Tour - Monument",name:"Monumente",isStage:!1},{key:"World Tour - Stage Race High",name:"Stage Race (High)",isStage:!0},{key:"World Tour - Stage Race Middle",name:"Stage Race (Middle)",isStage:!0},{key:"World Tour - Stage Race Low",name:"Stage Race (Low)",isStage:!0},{key:"World Tour - One Day High",name:"One Day (High)",isStage:!1},{key:"World Tour - One Day Middle",name:"One Day (Middle)",isStage:!1},{key:"World Tour - One Day Low",name:"One Day (Low)",isStage:!1}],l=`
        ...
        ${c.map(u=>{const m=a.categories[u.key]||{gcWins:0,gcSecond:0,gcThird:0,gcTopTen:0,stageWins:0,stageSecond:0,stageThird:0,stageTopTen:0,oneDayWins:0,oneDaySecond:0,oneDayThird:0,oneDayTopTen:0,mountainWins:0,pointsWins:0,youthWins:0,breakawayWins:0,raceDays:0,leaderJerseys:0,pointsJerseys:0,mountainJerseys:0,youthJerseys:0,breakawayJerseys:0,sprintWins:0,climbWinsHC:0,climbWins1:0,climbWins2:0,climbWins3:0,climbWins4:0,winFlat:0,winRolling:0,winHilly:0,winHillyDifficult:0,winMediumMountain:0,winMountain:0,winHighMountain:0,winCobble:0,winCobbleHill:0,winITT:0,winTTT:0,winWeather1:0,winWeather2:0,winWeather3:0,winWeather4:0,winWeather5:0,winWeather6:0,winWeather7:0};return`
            <div style="position: relative; background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 8px; padding: 1rem; height: 415px; box-sizing: border-box; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 4px 6px rgba(0,0,0,0.15);">
              ...
              <div style="overflow: hidden; white-space: nowrap;">
                <div style="font-size: 0.7rem; color: #888; text-transform: uppercase; margin-bottom: 0.2rem; letter-spacing: 0.5px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">Profil Siege</div>
                <div style="display: flex; gap: 0.25rem; align-items: center; overflow: hidden; white-space: nowrap; flex-wrap: nowrap;">
                  ${ue(m.winFlat||0,"flat","Flach (Flat)")}
                  ${ue(m.winRolling||0,"rolling","Hügelig leicht (Rolling)")}
                  ${ue(m.winHilly||0,"hilly","Hügelig (Hilly)")}
                  ${ue(m.winHillyDifficult||0,"hilly_difficult","Hügelig schwer (Hilly Difficult)")}
                  ${ue(m.winMediumMountain||0,"medium_mountain","Mittelgebirge (Medium Mountain)")}
                  ${ue(m.winMountain||0,"mountain","Hochgebirge (Mountain)")}
                  ${ue(m.winHighMountain||0,"high_mountain","Hochgebirge schwer (High Mountain)")}
                  ${ue(m.winCobble||0,"cobble","Kopfsteinpflaster (Cobble)")}
                  ${ue(m.winCobbleHill||0,"cobble_hill","Kopfsteinpflaster Hügel (Cobble Hill)")}
                  ${ue(m.winITT||0,"itt","Einzelzeitfahren (ITT)")}
                  ${ue(m.winTTT||0,"ttt","Mannschaftszeitfahren (TTT)")}
                </div>
              </div>
              ...
              <div style="overflow: hidden; white-space: nowrap;">
                <div style="font-size: 0.7rem; color: #888; text-transform: uppercase; margin-bottom: 0.2rem; letter-spacing: 0.5px; white-space: nowrap; text-overflow: ellipsis; overflow: hidden;">Wetter Siege</div>
                <div style="display: flex; gap: 0.25rem; align-items: center; overflow: hidden; white-space: nowrap; flex-wrap: nowrap;">
                  ${Re(m.winWeather1||0,1,"Sonnig")}
                  ${Re(m.winWeather2||0,2,"Extreme Hitze")}
                  ${Re(m.winWeather3||0,3,"Leichter Regen")}
                  ${Re(m.winWeather4||0,4,"Starkregen")}
                  ${Re(m.winWeather5||0,5,"Starker Wind")}
                  ${Re(m.winWeather6||0,6,"Dichter Nebel")}
                  ${Re(m.winWeather7||0,7,"Schnee/Eis")}
                </div>
              </div>
  ...
  `}function tf(e){var o;const t=e.historyRosters||{},a=Object.keys(t).map(Number).sort((c,l)=>c-l);if(a.length===0)return`
      <section class="rider-stats-placeholder">
        <h3>Keine Kader- und Vertragsdaten vorhanden</h3>
        <p>Für dieses Team wurden keine Verträge in der Datenbank erfasst.</p>
      </section>
    `;if(d.teamStatsSelectedRosterYear===null||!a.includes(d.teamStatsSelectedRosterYear)){const c=((o=d.gameState)==null?void 0:o.season)??2026;a.includes(c)?d.teamStatsSelectedRosterYear=c:d.teamStatsSelectedRosterYear=a[0]}const r=d.teamStatsSelectedRosterYear,s=t[r]||[],n=a.map(c=>`
    <option value="${c}" ${c===r?"selected":""}>Kader ${c}</option>
  `).join(""),i=s.length===0?'<tr><td colspan="6" class="text-center text-muted" style="padding: 2rem;">Keine Fahrer für dieses Jahr unter Vertrag.</td></tr>':s.map(c=>{const l=c.nationality?ze[c.nationality]??c.nationality.slice(0,2).toLowerCase():null,p=l?`<span class="fi fi-${l} results-roster-flag" style="display:inline-block; vertical-align:middle; width:16px; height:12px;" title="${S(c.nationality)}"></span>`:"–",u=Ne(`${c.firstName} ${c.lastName}`,{riderId:c.riderId,teamId:e.teamId,strong:!0,linkClassName:"results-rider-link",labelClassName:"results-participant-label"}),m=`<span class="results-roster-overall-badge" style="color:${vi(c.overallRating)}" title="Stärke: ${c.overallRating.toFixed(2)}">${c.overallRating.toFixed(1)}</span>`;let f="–";c.potential!=null&&(f=`<span class="results-roster-overall-badge" style="color:${vi(c.potential)}" title="Potential: ${c.potential.toFixed(2)}">${c.potential.toFixed(1)}</span>`);const g=S(c.roleName||"-"),v=c.contractEndSeason?`Saison ${c.contractEndSeason}`:"Ohne Vertrag",h=c.contractEndSeason===r?`<span class="badge badge-race-category" style="background: rgba(239, 68, 68, 0.15); color: #ef4444; border: 1px solid rgba(239, 68, 68, 0.4); font-weight: bold; animation: pulse 2s infinite;" title="Vertrag läuft in dieser Saison aus!">${S(v)}</span>`:`<span style="font-weight: 500;">${S(v)}</span>`;return`
          <tr class="rider-stats-row">
            <td style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(255, 255, 255, 0.05); text-align: center;">${p}</td>
            <td style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(255, 255, 255, 0.05); white-space: nowrap;">${u}</td>
            <td style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(255, 255, 255, 0.05); text-align: center;">${m}</td>
            <td style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(255, 255, 255, 0.05); text-align: center;">${f}</td>
            <td style="padding: 0.75rem 1rem; border-bottom: 1px solid rgba(255, 255, 255, 0.05); text-align: center; color: #ccc;">${g}</td>
  ...
  `}function vi(e){return e>=85?"#22c55e":e>=78?"#86efac":e>=72?"#fbbf24":e>=66?"#fb923c":e>=60?"#f87171":"#94a3b8"}function St(e){return d.teamStatsTab==="career"?`
      ${Xr(e)}
      ${Qr()}
      ${ef(e)}
  ...
  `,Xe("teamStats");const s=await V.getTeamStats(e);if(d.teamStatsSelectedTeamId===e){if(!s.success||!s.data){y("team-stats-body").innerHTML=`
    ...
    `;return}d.teamStatsPayload=s.data,y("team-stats-body").innerHTML=St(s.data)}}function rf(){y("team-stats-body").addEventListener("click",e=>{const t=e.target,a=t.closest("button[data-team-stats-tab]");if(a){const s=a.dataset.teamStatsTab;(s==="topResults"||s==="career"||s==="contracts")&&(d.teamStatsTab=s,d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload)));return}const r=t.closest("button[data-team-top-results-page]");if(r){const s=Number(r.dataset.teamTopResultsPage);!isNaN(s)&&s>=1&&(d.teamStatsTopResultsPage=s,d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload)));return}}),y("team-stats-body").addEventListener("change",e=>{const t=e.target;if(t.id==="team-stats-filter-category"){const a=t;d.teamStatsTopResultsFilterCategory=a.value==="all"?null:a.value,d.teamStatsTopResultsPage=1,d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload))}else if(t.id==="team-stats-filter-season"){const a=t;d.teamStatsTopResultsFilterSeason=a.value==="all"?null:Number(a.value),d.teamStatsTopResultsPage=1,d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload))}else if(t.classList.contains("team-stats-filter-checkbox")){const a=t,r=a.dataset.filterType;d.teamStatsTopResultsFilters[r]=a.checked,d.teamStatsTopResultsPage=1,d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload))}else if(t.id==="team-stats-success-season-select"){const a=t;d.teamStatsSelectedSeason=a.value==="all"?"all":Number(a.value),d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload))}else if(t.id==="team-stats-roster-year-select"){const a=t;d.teamStatsSelectedRosterYear=Number(a.value),d.teamStatsPayload&&(y("team-stats-body").innerHTML=St(d.teamStatsPayload))}})}let Wt="riders",gt="season",nn="season",st="";const wr=["leaderboard-select-performance","leaderboard-select-load","leaderboard-select-physis","leaderboard-select-action","leaderboard-select-jersey","leaderboard-select-events"];function sf(){const e=y("leaderboards-scope-tabs");if(e){const n=e.querySelectorAll("button");n.forEach(i=>{i.addEventListener("click",()=>{n.forEach(c=>c.classList.remove("active")),i.classList.add("active");const o=i.getAttribute("data-scope");of(o)})})}const t=y("leaderboards-period-tabs");if(t){const n=t.querySelectorAll("button");n.forEach(i=>{i.addEventListener("click",()=>{if(i.hasAttribute("disabled"))return;n.forEach(c=>c.classList.remove("active")),i.classList.add("active");const o=i.getAttribute("data-period");lf(o)})})}wr.forEach(n=>{const i=y(n);i&&i.addEventListener("change",()=>{const o=i.value;o?df(o,n):wr.some(l=>{const p=y(l);return p&&p.value!==""})||(st="",ia())})}),window.openRiderStatsFromLeaderboard=na,window.openTeamStatsFromLeaderboard=sn;const a=y("leaderboard-filter-wt"),r=y("leaderboard-filter-pt"),s=y("leaderboard-filter-other");[a,r,s].forEach(n=>{n&&n.addEventListener("change",()=>{ia()})})}function nf(){ia()}function of(e){Wt=e;const t=y("leaderboard-group-physis");t&&(t.style.display=e==="teams"?"none":"block"),e==="teams"&&((cf(st)||st==="strongest_lieutenants")&&(uf(),st=""),gt==="live"&&(gt=nn,tr())),ia()}function lf(e){gt=e,nn=e,ia()}function df(e,t){st=e,wr.forEach(a=>{if(a!==t){const r=y(a);r&&(r.value="")}}),wl(e)?(gt="live",tr()):on(e)?(gt="alltime",tr()):(gt=nn,tr()),ia()}function wl(e){return["fatigue_short","fatigue_long","fatigue_combined","form_r","form_s","form_combined"].includes(e)}function on(e){return["max_short_term_fatigue","max_long_term_fatigue","max_combined_fatigue","max_s_form","max_r_form","max_combined_form","mentors_ranking"].includes(e)||e.startsWith("youngest_winners")}function cf(e){return wl(e)||on(e)||e==="mentors_ranking"}function uf(){wr.forEach(e=>{const t=y(e);t&&(t.value="")})}function tr(){const e=y("leaderboards-period-tabs");if(!e)return;const t=e.querySelector('button[data-period="season"]'),a=e.querySelector('button[data-period="alltime"]');gt==="live"?e.style.display="none":(e.style.display="flex",on(st)?(t&&(t.disabled=!0,t.classList.remove("active"),t.style.opacity="0.5",t.style.cursor="not-allowed"),a&&(a.disabled=!1,a.classList.add("active"),a.style.opacity="1",a.style.cursor="pointer")):(t&&(t.disabled=!1,t.style.opacity="1",t.style.cursor="pointer"),a&&(a.disabled=!1,a.style.opacity="1",a.style.cursor="pointer"),gt==="season"?(t&&t.classList.add("active"),a&&a.classList.remove("active")):(t&&t.classList.remove("active"),a&&a.classList.add("active"))))}async function ia(){var u,m,f;const e=y("leaderboard-empty"),t=y("leaderboard-table"),a=y("leaderboard-thead"),r=y("leaderboard-tbody");if(!e||!t||!a||!r)return;const s=y("leaderboard-filter-container");if(s&&(s.style.display=Wt==="teams"?"none":"flex"),!st){e.textContent="Wähle eine Statistik aus den Dropdowns oben aus, um die Rangliste zu laden.",e.classList.remove("hidden"),t.classList.add("hidden");return}e.textContent="Lade Daten...",e.classList.remove("hidden"),t.classList.add("hidden");const n=await V.getLeaderboards(Wt,st,gt);if(!Ie("leaderboards"))return;if(!n.success||!n.data||n.data.length===0){e.textContent=n.error||"Keine Einträge für diese Rangliste gefunden.",e.classList.remove("hidden"),t.classList.add("hidden");return}let i=n.data;if(Wt==="riders"){const g=((u=y("leaderboard-filter-wt"))==null?void 0:u.checked)??!0,v=((m=y("leaderboard-filter-pt"))==null?void 0:m.checked)??!0,b=((f=y("leaderboard-filter-other"))==null?void 0:f.checked)??!1;if(i=n.data.filter(h=>{const $=h.teamDivisionId===1&&!h.isRetired,I=h.teamDivisionId===2&&!h.isRetired,w=h.teamDivisionId===null||h.teamDivisionId===void 0||h.isRetired||h.teamDivisionId!==1&&h.teamDivisionId!==2;return!!($&&g||I&&v||w&&b)}),i.length===0){e.textContent="Keine Einträge für die ausgewählten Filter gefunden.",e.classList.remove("hidden"),t.classList.add("hidden");return}}e.classList.add("hidden"),t.classList.remove("hidden");const o=st==="highest_leadout_bonus",c=st==="strongest_lieutenants";Wt==="riders"?a.innerHTML=`
      <tr>
    ...
    `;let l="",p=1;for(const g of i){const v=p++,h=`<span class="badge ${v===1?"badge-primary":v<=3?"badge-secondary":"badge-ghost"}" style="min-width: 28px; text-align: center; display: inline-block;">${v}</span>`,$=_e(g.teamId,g.teamName);let I="";if(o){const x=g.stageNumber!=null?`Etappe ${g.stageNumber}`:"–";I=`<td style="vertical-align: middle;">${S(g.raceName??"–")} · ${S(x)} · ${S(String(g.season??"–"))}</td>`}let w="";if(c)if(g.lieutenantDetails){const x=g.lieutenantDetails,M=x.leaderNationality?oe(x.leaderNationality):"",T=x.leaderRoleName?` (${x.leaderRoleName})`:"";w=`
          <td style="vertical-align: middle;">
            <span style="display: inline-flex; align-items: center; gap: 0.25rem;">
              ...
              <span class="text-muted" style="font-size: 0.85em;">${S(T)}</span>
            </span>
          </td>
        `}else w='<td style="vertical-align: middle;">–</td>';if(Wt==="riders"){const x=g.nationality?oe(g.nationality):"—",M=`<a href="#" onclick="event.preventDefault(); openRiderStatsFromLeaderboard(${g.riderId})" style="color: #60a5fa; text-decoration: none; font-weight: bold; hover: text-decoration: underline;">${S(g.firstName)} ${S(g.lastName)}</a>`,T=g.teamAbbr&&g.teamId!=null?`<a href="#" onclick="event.preventDefault(); openTeamStatsFromLeaderboard(${g.teamId})" style="color: #94a3b8; text-decoration: none; hover: text-decoration: underline;" title="${S(g.teamName??"")}">${S(g.teamAbbr)}</a>`:g.teamAbbr?`<span class="text-muted" title="${S(g.teamName??"")}">${S(g.teamAbbr)}</span>`:"—";l+=`
        <tr>
      ...
      `}else{let x="";if(g.leadoutDetails){const M=g.leadoutDetails,T=M.sprinterNationality?oe(M.sprinterNationality):"";x=`
    ...
    `}t.innerHTML=r,Ml()}function Ml(){var n;const e=y("calendar-race-search"),t=e?e.value.toLowerCase().trim():"",a=y("calendar-races-tbody"),r=((n=d.gameState)==null?void 0:n.currentDate)??"",s=d.races.filter(i=>{var o;return t?i.name.toLowerCase().includes(t)||((o=i.category)==null?void 0:o.name)&&i.category.name.toLowerCase().includes(t):!0}).sort((i,o)=>i.startDate.localeCompare(o.startDate));if(s.length===0){a.innerHTML='<tr><td colspan="9" class="text-muted" style="text-align: center; padding: 20px;">Keine Rennen gefunden.</td></tr>';return}a.innerHTML=s.map(i=>{var b,h,$,I;const o=r>=i.startDate&&r<=i.endDate,l=r>i.endDate?'<span class="badge badge-done">Abgeschlossen</span>':o?'<span class="badge badge-live">Läuft</span>':'<span class="badge badge-todo">Geplant</span>',p=((b=i.country)==null?void 0:b.name)??`Land ${i.countryId}`,u=(h=i.country)!=null&&h.code3?oe(i.country.code3):"",m=i.isStageRace?(i.stages??[]).reduce((w,x)=>w+(x.distanceKm??0),0):(($=i.upcomingStage)==null?void 0:$.distanceKm)??null,f=i.isStageRace?(i.stages??[]).reduce((w,x)=>w+(x.elevationGainMeters??0),0):((I=i.upcomingStage)==null?void 0:I.elevationGainMeters)??null,g=m!=null?String(m.toFixed(1)).replace(".",","):"-",v=f!=null?String(Math.round(f)):"-";return`
...
${e.error??"Unbekannter Fehler"}`),Pe();return}d.raceProgramsDirty=!1,ln(!0)}function Gr(e,t){let a=0,r=0,s=0;const n=new Set(t.raceProgramRaces.filter(o=>o.program_id===e.id).map(o=>o.race_id)),i=t.races.filter(o=>n.has(o.id));for(const o of i){const c=new Date(o.start_date),l=new Date(o.end_date);for(let p=new Date(c);p<=l;p.setDate(p.getDate()+1)){const u=p.getFullYear(),m=String(p.getMonth()+1).padStart(2,"0"),f=String(p.getDate()).padStart(2,"0"),g=zt(`${u}-${m}-${f}`),v=zr(e,g);v==="peak"?a++:v==="prep"?r++:s++}}return{peak:a,prep:r,none:s}}function Pe(){const e=y("race-programs-root"),t=d.raceProgramsPayload;if(!t){e.innerHTML='<div class="results-empty">Keine Daten geladen.</div>';return}const a=window.scrollX,r=window.scrollY,s={},n=document.querySelector(".team-detail-table-scroll");n&&(s.table={scrollTop:n.scrollTop,scrollLeft:n.scrollLeft}),document.querySelectorAll(".popover-program-list-scroll").forEach(f=>{const g=f.getAttribute("data-race-id");g&&(s[`popover-${g}`]={scrollTop:f.scrollTop,scrollLeft:f.scrollLeft})});const o=d.raceProgramsDirty,c=d.raceProgramsSaving,l=d.raceProgramsActiveTab;let p=`
  ...
  `;l==="calendar-cols"?p+=Mf(t):l==="calendar-rows"?p+=If(t):l==="peak-editor"?p+=Rf(t):l==="rider-role"?p+=Ef(t):l==="program-roles"&&(p+=Pf(t)),p+="</div>",e.innerHTML=p;const u=document.querySelector(".team-detail-table-scroll");u&&s.table&&(u.scrollTop=s.table.scrollTop,u.scrollLeft=s.table.scrollLeft),document.querySelectorAll(".popover-program-list-scroll").forEach(f=>{const g=f.getAttribute("data-race-id");g&&s[`popover-${g}`]&&(f.scrollTop=s[`popover-${g}`].scrollTop,f.scrollLeft=s[`popover-${g}`].scrollLeft)}),window.scrollTo(a,r)}function Mf(e){var o,c,l;const t=e.programs,a=e.raceProgramRaces,r=e.races,s=t.map(p=>({id:p.id,stats:Gr(p,e)}));let n=`<tr>
  ...
  `;for(const p of t){const u=(o=s.find(m=>m.id===p.id))==null?void 0:o.stats;n+=`
    ...
    `}n+="</tr>";let i="";for(const p of ys){const u=r.filter(b=>b.start_date<=p.dateStr&&b.end_date>=p.dateStr),m=u.length>0,f=m?"row-has-races":"";let g="";if(m){g='<div style="display: flex; flex-direction: column; gap: 0.15rem; margin-top: 0.15rem;">';for(const b of u){const h=lt((c=b.category)==null?void 0:c.name);g+=`
          <span class="race-id-badge" style="background-color: ${h.background}; border: 1px solid ${h.border}; color: ${h.color}; font-size: 0.65rem; padding: 0.05rem 0.2rem; text-align: left; display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 140px;" title="${S(b.name)}">
            ${S(b.name)}
          </span>
        `}g+="</div>"}let v=`
    ...
    `;for(const b of t){const h=zr(b,p.weekNum),$=Il(h),I=a.find(T=>T.program_id===b.id&&u.some(E=>E.id===T.race_id));let w="",x=`toggleable-race-cell ${$}`,M=`data-day="${p.dateStr}" data-program-id="${b.id}"`;if(I){const T=r.find(F=>F.id===I.race_id),E=lt((l=T==null?void 0:T.category)==null?void 0:l.name);w=`
          <span class="race-program-badge" style="background-color: ${E.background}; border: 1px solid ${E.border}; color: ${E.color};" title="${S(T==null?void 0:T.name)}">
            ${S(T==null?void 0:T.name)}
          </span>
        `}else m?w='<span class="race-cell-placeholder" title="Klicken zum Zuweisen">＋</span>':(x=$,M="");v+=`<td class="${x}" ${M} style="text-align: center; vertical-align: middle;">${w}</td>`}i+=`<tr>${v}</tr>`}return`
  ...
  `}function If(e){var f;const t=e.programs,a=e.raceProgramRaces,r=e.races;let s='<th class="sticky-col-header" style="z-index: 15;">Monat</th>',n='<th class="sticky-col-header" style="z-index: 15;">Tag / KW</th>',i='<th class="sticky-col-header" style="z-index: 15;">Rennen Anzahl</th>',o='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #1</th>',c='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #2</th>',l='<th class="sticky-col-header" style="z-index: 15; font-size: 0.75rem; color: var(--text-500);">Rennen #3</th>';const p=[],u=["Jan","Feb","Mär","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"];for(const g of ys){const v=parseInt(g.dateStr.split("-")[1],10)-1,b=u[v];p.length===0||p[p.length-1].name!==b?p.push({name:b,span:1}):p[p.length-1].span++;const h=r.filter(M=>M.start_date<=g.dateStr&&M.end_date>=g.dateStr),$=h.length>0,I=$?`${h.length} R`:"",w=$?"race-count-active":"";n+=`<th style="text-align: center; min-width: 40px; font-variant-numeric: tabular-nums;">
    ...
    </th>`,i+=`<th class="${w}" style="text-align: center; font-size: 0.72rem; font-weight: bold;">${I}</th>`;const x=M=>{var A;const T=h[M];if(!T)return"";const E=lt((A=T.category)==null?void 0:A.name),F=a.filter(_=>_.race_id===T.id).length;return`
...
Zugelassene Programme: ${F}">
      ...
      `};o+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${x(0)}</th>`,c+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${x(1)}</th>`,l+=`<th style="text-align: center; vertical-align: middle; padding: 0.2rem 0;">${x(2)}</th>`}for(const g of p)s+=`<th colspan="${g.span}" style="text-align: center; font-weight: bold; border-left: 1px solid var(--border);">${g.name}</th>`;let m="";for(const g of t){const v=Gr(g,e);let b=`
    ...
    `;for(const h of ys){const $=zr(g,h.weekNum),I=Il($),w=r.filter(A=>A.start_date<=h.dateStr&&A.end_date>=h.dateStr),x=w.length>0,M=a.find(A=>A.program_id===g.id&&w.some(_=>_.id===A.race_id));let T="",E=`toggleable-race-cell ${I}`,F=`data-day="${h.dateStr}" data-program-id="${g.id}"`;if(M){const A=r.find(z=>z.id===M.race_id),_=lt((f=A==null?void 0:A.category)==null?void 0:f.name);T=`
        ...
        `}else x?T='<span style="font-size: 0.72rem; color: var(--text-500); opacity: 0.5;">＋</span>':(E=I,F="");b+=`<td class="${E}" ${F} style="text-align: center; vertical-align: middle; padding: 0.35rem 0;">${T}</td>`}m+=`<tr>${b}</tr>`}return`
    <div class="team-detail-card" style="margin-top: 1rem;">
    ...
    <div class="team-detail-card" style="margin-top: 1rem;">
      <div class="team-detail-table-scroll" style="max-height: 75vh;">
        <table class="data-table">
          ...
          <tbody>
            ${e.programs.map(r=>{const s=[{min:r.peak1_min,max:r.peak1_max},{min:r.peak2_min,max:r.peak2_max},{min:r.peak3_min,max:r.peak3_max}].sort((p,u)=>p.min-u.min),n=s[1].min-s[0].max<8,i=s[2].min-s[1].max<8,c=n||i?'<span style="color: #f97316; font-size: 1.1rem; cursor: help;" title="Warnung: Peakbereiche liegen weniger als 8 Wochen auseinander!">⚠️</span>':'<span style="color: #22c55e;">✔ OK</span>',l=p=>{const u=r[`peak${p}_min`]??1,m=r[`peak${p}_max`]??1;return`
        <div style="display: flex; align-items: center; gap: 0.4rem;">
  ...
  `).join("");return{countHtml:n,stagesListHtml:i}}function Ef(e){const t=[...e.races].sort((i,o)=>i.start_date.localeCompare(o.start_date)),a=e.raceProgramRaces,r=e.stages,s=e.programDistribution;return`
    <div class="team-detail-card" style="margin-top: 1rem; position: relative;">
      <div class="team-detail-table-scroll" style="max-height: 75vh;">
        <table class="data-table">
          ...
          <tbody>
            ${t.map(i=>{const o=new Set(a.filter(R=>R.race_id===i.id).map(R=>R.program_id)),c=s.filter(R=>o.has(R.program_id)),u=e.programs.map(R=>{const D=a.some(yt=>yt.program_id===R.id&&yt.race_id===i.id),B=s.find(yt=>yt.program_id===R.id),Z=B?parseInt(B.deterministic_rider_count||"0",10):0,ne=B?parseInt(B.deterministic_role_Kapitaen||"0",10):0,fe=B?parseInt(B.deterministic_role_Co_Kapitaen||"0",10):0,ge=B?parseInt(B.deterministic_role_Edelhelfer||"0",10):0,xe=B?parseInt(B.deterministic_role_Starke_Helfer||"0",10):0,ve=B?parseInt(B.deterministic_role_Wassertraeger||"0",10):0,he=B?parseInt(B.deterministic_role_Sprinter||"0",10):0,Se=[];ne>0&&Se.push(`${ne} Kapitän`),fe>0&&Se.push(`${fe} Co-Kapitän`),ge>0&&Se.push(`${ge} Edelhelfer`),xe>0&&Se.push(`${xe} Starke Helfer`),ve>0&&Se.push(`${ve} Wasserträger`),he>0&&Se.push(`${he} Sprinter`);const tt=Se.length>0?`(${Se.join(", ")})`:"",le=Gr(R,e),oa=le.peak+le.prep+le.none;return{program:R,isAssigned:D,count:Z,rolesStr:tt,totalDays:oa}}).sort((R,D)=>R.isAssigned!==D.isAssigned?R.isAssigned?-1:1:D.count-R.count).filter(R=>$i(R.program,i)||R.isAssigned).map(R=>{const D=R.program,B=$i(D,i);let Z="";B||(Z='<span style="color: #fb923c; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(251, 146, 60, 0.15); border: 1px solid #fb923c; border-radius: 50%; font-size: 0.65rem;" title="Dieses Rennen liegt außerhalb der Peak- und Aufbauphase dieses Programms!">!</span>');let ne="";yf(D,i)||(ne='<span style="color: #c084fc; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(192, 132, 252, 0.15); border: 1px solid #c084fc; border-radius: 50%; font-size: 0.65rem;" title="Dieses Rennen liegt außerhalb des Peakbereichs und der 6-wöchigen Anstiegsphase dieses Programms!">!</span>');let ge="";vf(D,i,e)||(ge='<span style="color: #38bdf8; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(56, 189, 248, 0.15); border: 1px solid #38bdf8; border-radius: 50%; font-size: 0.65rem;" title="Achtung: Dieses Programm hat in diesem Saisonabschnitt bereits das Limit an Renntagen erreicht (max. 36 Tage bzw. 35 Tage für Rundfahrten)!">!</span>');let ve="";if(!R.isAssigned){const la=a.filter(Te=>Te.program_id===D.id&&Te.race_id!==i.id).map(Te=>e.races.find(Ft=>Ft.id===Te.race_id)).filter(Te=>Te&&Te.start_date<=i.end_date&&Te.end_date>=i.start_date);if(la.length>0){const Te=la.map(Ft=>Ft.name).join(", ");ve=`<span style="color: #ef4444; font-weight: bold; margin-left: 0.35rem; display: inline-flex; align-items: center; justify-content: center; width: 14px; height: 14px; background: rgba(239, 68, 68, 0.15); border: 1px solid #ef4444; border-radius: 50%; font-size: 0.65rem;" title="Kollision: Dieses Programm ist bereits einem zeitlich parallelen Rennen zugewiesen: ${S(Te)}!">!</span>`}}const he=R.isAssigned?"font-weight: bold; color: var(--text-100);":"color: var(--text-500);",Se=R.isAssigned?"☑":"☐",tt=B||R.isAssigned,le=tt?"cursor: pointer;":"cursor: not-allowed; opacity: 0.4; pointer-events: none;";return`
        <div class="popover-program-toggle${tt?"":" disabled"}" data-program-id="${D.id}" data-race-id="${i.id}" 
          ...
          <div style="display: flex; align-items: center; gap: 0.5rem; flex: 1; min-width: 0; overflow: hidden;">
            <span style="font-size: 1.15rem; line-height: 1; user-select: none; color: ${R.isAssigned?"var(--accent-h)":"var(--text-500)"};">${Se}</span>
            <span style="${he} font-size: 0.85rem; overflow: hidden; text-overflow: ellipsis;" title="${S(D.name)} (${R.totalDays} Renntage)">
              ${S(D.name)} (${R.totalDays} RT)
            </span>
            ${Z}
            ${ne}
            ${ge}
          ...
          <div style="display: flex; align-items: center; gap: 0.6rem; flex-shrink: 0;">
            <strong style="font-size: 0.8rem; color: var(--accent-h);">${R.count} Fahrer</strong>
            <span style="font-size: 0.72rem; color: var(--text-500); font-weight: normal;" title="${S(R.rolesStr)}">${S(R.rolesStr)}</span>
          </div>
        </div>
      `}).join(""),m=xt===i.id;let f=0,g=0,v=0,b=0,h=0,$=0,I=0;const w={Kapitaen:{},Co_Kapitaen:{},Sprinter:{},Edelhelfer:{},Starke_Helfer:{},Wassertraeger:{}},x=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],M=["Berg","Hill","Sprint","Timetrial","Cobble","Attacker"];for(const R of c){f+=parseInt(R.deterministic_rider_count||"0",10),g+=parseInt(R.deterministic_role_Kapitaen||"0",10),v+=parseInt(R.deterministic_role_Co_Kapitaen||"0",10),b+=parseInt(R.deterministic_role_Sprinter||"0",10),h+=parseInt(R.deterministic_role_Edelhelfer||"0",10),$+=parseInt(R.deterministic_role_Starke_Helfer||"0",10),I+=parseInt(R.deterministic_role_Wassertraeger||"0",10);for(const D of x)for(const B of M){const Z=`deterministic_${D}_spec1_${B}`,ne=parseInt(R[Z]||"0",10);w[D][B]=(w[D][B]||0)+ne}}let T=0;i.is_stage_race===1&&(T=r.filter(D=>D.race_id===i.id).filter(D=>{const B=(D.profile||"").toLowerCase();return B==="flat"||B==="rolling"}).length);let E=!1,F=0;if(i.is_stage_race===0){const R=r.find(B=>B.race_id===i.id),D=((R==null?void 0:R.profile)||"").toLowerCase();E=D==="cobble"||D==="cobble_hill",E&&(F=(e.roleSpecCombinations||[]).filter(Z=>o.has(Z.program_id)).filter(Z=>Z.spec1==="Cobble"||Z.spec2==="Cobble"||Z.spec3==="Cobble").reduce((Z,ne)=>Z+ne.count,0))}let A="<strong>Rennprogramme verwalten</strong>";i.is_stage_race===0&&E?A=`
    ...
    `;let z="text-align: center; font-variant-numeric: tabular-nums;";i.is_stage_race===1&&T>=2&&(b<=7?z+=" background-color: rgba(239, 68, 68, 0.2); color: #ef4444; font-weight: bold;":b>7&&b<10&&(z+=" background-color: rgba(234, 179, 8, 0.2); color: #eab308; font-weight: bold;"));let O="position: relative; text-align: center; font-variant-numeric: tabular-nums; vertical-align: middle;",G="font-weight: bold; border: none; background: transparent; padding: 0.15rem 0.4rem; cursor: pointer; color: var(--accent-h); text-decoration: underline;";i.is_stage_race===0&&E&&F<20&&(O+=" background-color: rgba(239, 68, 68, 0.2);",G+=" color: #ef4444; font-weight: bold;");const C=`
      <button type="button" class="race-rider-count-trigger btn-link" data-race-id="${i.id}" 
              style="${G}">
        ${f}
      </button>
    `;let H="—";if(i.is_stage_race===0){const R=r.find(D=>D.race_id===i.id);H=(R==null?void 0:R.profile)??"Flat"}let U="",j=`<strong>${S(i.name)}</strong>`;if(i.is_stage_race===1){const R=$t===i.id,{countHtml:D,stagesListHtml:B}=Cf(i.id,r);U=`
        <div class="race-stages-popover-card ${R?"":"hidden"}">
      ...
      `}let X=["Berg","Hill","Sprint","Cobble","Timetrial","Attacker"];if(i.is_stage_race===0){const R=r.find(B=>B.race_id===i.id),D=((R==null?void 0:R.profile)??"").toLowerCase();D.includes("cobble")?X=["Cobble","Sprint","Hill","Attacker","Timetrial","Berg"]:(D.includes("flat")||D.includes("rolling"))&&(X=["Sprint","Timetrial","Attacker","Hill","Cobble","Berg"])}const J=[],te=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],W={Kapitaen:"Kapitän",Co_Kapitaen:"Co-Kapitän",Sprinter:"Sprinter",Edelhelfer:"Edelhelfer",Starke_Helfer:"Starke Helfer",Wassertraeger:"Wasserträger"},P={Berg:"Berg",Hill:"Hügel",Sprint:"Sprint",Cobble:"Cobble",Timetrial:"Timetrial",Attacker:"Attacker"},L=(e.roleSpecCombinations||[]).filter(R=>o.has(R.program_id)),N=new Map;for(const R of L){const D=R.spec2||"—",B=`${R.role}|${R.spec1}|${D}`;N.set(B,(N.get(B)||0)+R.count)}const Y=[...N.entries()].map(([R,D])=>{const[B,Z,ne]=R.split("|");return{role:B,spec1:Z,spec2:ne,count:D}}).sort((R,D)=>{const B=te.indexOf(R.role)-te.indexOf(D.role);if(B!==0)return B;const Z=X.indexOf(R.spec1)-X.indexOf(D.spec1);return Z!==0?Z:D.count-R.count}),K=(R,D)=>{const B=P[R]??R,Z=D!=="—"?P[D]??D:"—";return`${B} / ${Z}`};for(const R of Y)if(R.count>0){const D=R.spec1==="Berg"&&R.spec2==="Cobble"||R.spec1==="Cobble"&&R.spec2==="Berg",B=D?"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem; background: rgba(249, 115, 22, 0.12); color: #f97316;":"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem;",Z=D?"color: #f97316; font-weight: bold;":"color: var(--text-100);",ne=D?"color: #f97316; font-weight: bold;":"color: var(--accent-h);",fe=`${R.role}_${R.spec1}_${R.spec2.replace(/[^a-zA-Z0-9]/g,"_")}`,xe=L.filter(ve=>ve.role===R.role&&ve.spec1===R.spec1&&(ve.spec2||"—")===R.spec2).map(ve=>{const he=e.programs.find(Se=>Se.id===ve.program_id);return`<span style="white-space: nowrap; margin-right: 0.8rem;">${S((he==null?void 0:he.name)??"Unbekannt")}: <strong>${ve.count}</strong></span>`}).join(" ");J.push(`
          <div style="${B}">
            <span style="${Z}">${W[R.role]||R.role} <span class="text-muted">(${K(R.spec1,R.spec2)})</span></span>
      ...
      <tr style="position: relative;">
        ...
        <td style="text-align: center; font-variant-numeric: tabular-nums;">${I}</td>
      </tr>
  ...
  `}function Cl(e){return Je!==e?'<span style="opacity:0.35; margin-left:4px;">↕</span>':`<span style="color:var(--accent-h); margin-left:4px; font-weight:bold;">${ya?"↑":"↓"}</span>`}function mt(e,t,a=""){return`
  ...
  `}function Pf(e){const t=e.programs,a=e.roleSpecCombinations||[],r={Kapitaen:"Kapitän",Co_Kapitaen:"Co-Kapitän",Sprinter:"Sprinter",Edelhelfer:"Edelhelfer",Starke_Helfer:"Starke Helfer",Wassertraeger:"Wasserträger"},s={Berg:"Berg",Hill:"Hügel",Sprint:"Sprint",Cobble:"Cobble",Timetrial:"Timetrial",Attacker:"Attacker"},n=t.map(o=>{const c=a.filter(f=>f.program_id===o.id);let l=0;const p={Kapitaen:0,Co_Kapitaen:0,Sprinter:0,Edelhelfer:0,Starke_Helfer:0,Wassertraeger:0};for(const f of c)l+=f.count,p[f.role]!==void 0&&(p[f.role]+=f.count);const u=Gr(o,e),m=u.peak+u.prep+u.none;return{program:o,totalRiders:l,roleCounts:p,progCombos:c,raceDays:m}});n.sort((o,c)=>{let l=0;return Je==="id"?l=o.program.id-c.program.id:Je==="name"?l=o.program.name.localeCompare(c.program.name):Je==="total"?l=o.totalRiders-c.totalRiders:Je==="raceDays"?l=o.raceDays-c.raceDays:l=(o.roleCounts[Je]||0)-(c.roleCounts[Je]||0),l===0&&(l=o.program.id-c.program.id),ya?l:-l});const i=n.map(o=>{const c=o.program,l=o.progCombos,p=o.totalRiders,u=o.roleCounts,m=o.raceDays,f=new Set(e.raceProgramRaces.filter(M=>M.program_id===c.id).map(M=>M.race_id)),g=Rl(c,f,e),v=["Kapitaen","Co_Kapitaen","Sprinter","Edelhelfer","Starke_Helfer","Wassertraeger"],b=["Berg","Hill","Sprint","Cobble","Timetrial","Attacker"],h=new Map;for(const M of l){const T=M.spec2||"—",E=`${M.role}|${M.spec1}|${T}`;h.set(E,(h.get(E)||0)+M.count)}const $=[...h.entries()].map(([M,T])=>{const[E,F,A]=M.split("|");return{role:E,spec1:F,spec2:A,count:T}}).sort((M,T)=>{const E=v.indexOf(M.role)-v.indexOf(T.role);if(E!==0)return E;const F=b.indexOf(M.spec1)-b.indexOf(T.spec1);return F!==0?F:T.count-M.count}),I=(M,T)=>{const E=s[M]??M,F=T!=="—"?s[T]??T:"—";return`${E} / ${F}`},w=[];for(const M of $)if(M.count>0){const T=M.spec1==="Berg"&&M.spec2==="Cobble"||M.spec1==="Cobble"&&M.spec2==="Berg",E=T?"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem; background: rgba(249, 115, 22, 0.12); color: #f97316;":"display: flex; justify-content: space-between; padding: 0.25rem 0.5rem; border-bottom: 1px solid rgba(148, 163, 184, 0.08); font-size: 0.8rem;",F=T?"color: #f97316; font-weight: bold;":"color: var(--text-100);",A=T?"color: #f97316; font-weight: bold;":"color: var(--accent-h);",_=`${M.role}_${M.spec1}_${M.spec2.replace(/[^a-zA-Z0-9]/g,"_")}`;w.push(`
          <div style="${E}">
            <span style="${F}">${r[M.role]||M.role} <span class="text-muted">(${I(M.spec1,M.spec2)})</span></span>
          ...
          <div id="combo-origin-prog-${c.id}-${_}" class="hidden" style="padding: 0.25rem 0.75rem; font-size: 0.75rem; color: var(--text-400); background: rgba(0, 0, 0, 0.18); border-left: 2px solid var(--accent-h); text-align: left; line-height: 1.4;">
            Herkunft: <span style="white-space: nowrap; margin-right: 0.8rem;">${S(c.name)}: <strong>${M.count}</strong></span>
          </div>
        `)}const x=w.length>0?w.join(""):'<div class="text-muted" style="padding: 0.5rem; font-size: 0.8rem;">Keine Fahrer zugewiesen.</div>';return`
      <tr style="position: relative;">
        <td style="text-align: center; vertical-align: middle;">
...
Jenseits Peak 3: ${g.phase4} Tage">
  ...
  `}window.openTeamStats=sn;async function El(){var e;for(let t=localStorage.length-1;t>=0;t--){const a=localStorage.key(t);a&&(a.startsWith("programAssignmentsLogged_")||a.startsWith("participantCountsLogged_"))&&localStorage.removeItem(a)}Ir("game"),y("meta-career").textContent=((e=d.currentSave)==null?void 0:e.careerName)??"",d.seasonStandingsSelectedSeason=null,d.riderStatsSelectedSeason=null,Rt("dashboard"),$e("Spiel wird geladen…");try{await Xs(),await Qs(),_r()}catch(t){alert("Fehler beim Laden des Spiels: "+t.message)}finally{ye()}}function Nf(){document.querySelectorAll(".nav-btn").forEach(e=>{e.addEventListener("click",()=>{var a;const t=e.dataset.view??"";Rt(t),t==="dashboard"&&_r(),t==="teams"&&$r(),t==="riders"&&$r(),t==="rider-team-editor"&&Sl(),t==="live-race"&&Qt(),t==="results"&&Ce(),t==="draft"&&Br(d.draftSelectedSeason||((a=d.currentSave)==null?void 0:a.currentSeason)||2026),t==="injuries"&&Kg(),t==="season-standings"&&Tl(!0),t==="leaderboards"&&nf(),t==="calendar"&&hf(),t==="race-programs"&&ln(),(t==="stage-editor-stages"||t==="stage-editor-climbs")&&Bo()})}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-rider-link[data-rider-id]");if(!t)return;const a=Number(t.dataset.riderId);Number.isFinite(a)&&na(a)}),document.body.addEventListener("click",e=>{const t=e.target.closest("button.app-team-link[data-team-id]");if(!t)return;const a=Number(t.dataset.teamId);Number.isFinite(a)&&sn(a)}),y("btn-cancel-new").addEventListener("click",()=>Ue("newCareer")),y("btn-close-race-stages").addEventListener("click",()=>Ue("raceStages")),y("btn-close-stage-profile").addEventListener("click",()=>Ue("stageProfile")),y("btn-close-rider-program").addEventListener("click",()=>Ue("riderProgram")),y("btn-close-rider-stats").addEventListener("click",()=>Ue("riderStats")),y("btn-close-team-stats").addEventListener("click",()=>Ue("teamStats")),y("btn-close-race-participants").addEventListener("click",()=>Ue("raceParticipants")),y("btn-close-roster-editor").addEventListener("click",()=>ps()),y("btn-cancel-roster-editor").addEventListener("click",()=>ps()),y("btn-apply-roster-editor").addEventListener("click",()=>{tg()}),y("btn-back-menu").addEventListener("click",()=>{Yt==null||Yt.pause(),Ir("menu"),Ma()}),Gl(),bg(),ff(),tl(),yl(),Dg(),ag(),Zp(),bp(),Np(),rf(),Ug(),sf(),kf(),$l()}(async()=>(zm(),pe(),Nf(),Ir("menu"),await Ma()))();
