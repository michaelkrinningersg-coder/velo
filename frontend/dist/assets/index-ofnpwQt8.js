(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=a(s);fetch(s.href,n)}})();function ho(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Ds(...e){return e.filter(t=>!!(t&&t.trim())).join(" ")}function lt(e){const t=(e??"").toLowerCase();return t.includes("tour de france")?{background:"rgba(253, 224, 71, .25)",color:"#fef08a",border:"rgba(234, 179, 8, .6)"}:t.includes("grand tour")?{background:"rgba(6, 182, 212, .16)",color:"#a5f3fc",border:"rgba(34, 211, 238, .34)"}:t.includes("monument")?{background:"rgba(234, 179, 8, .18)",color:"#fde68a",border:"rgba(250, 204, 21, .38)"}:t.includes("stage race high")?{background:"rgba(37, 99, 235, .18)",color:"#bfdbfe",border:"rgba(96, 165, 250, .36)"}:t.includes("stage race middle")?{background:"rgba(79, 70, 229, .18)",color:"#c7d2fe",border:"rgba(129, 140, 248, .36)"}:t.includes("stage race low")?{background:"rgba(124, 58, 237, .18)",color:"#ddd6fe",border:"rgba(167, 139, 250, .38)"}:t.includes("one day high")?{background:"rgba(220, 38, 38, .18)",color:"#fecaca",border:"rgba(248, 113, 113, .36)"}:t.includes("one day middle")?{background:"rgba(234, 88, 12, .18)",color:"#fed7aa",border:"rgba(251, 146, 60, .36)"}:t.includes("one day low")?{background:"rgba(22, 163, 74, .16)",color:"#bbf7d0",border:"rgba(74, 222, 128, .34)"}:{background:"rgba(100, 116, 139, .2)",color:"#cbd5e1",border:"rgba(148, 163, 184, .3)"}}function qa(e){return`--dashboard-race-category-badge-bg:${e.background};--dashboard-race-category-badge-color:${e.color};--dashboard-race-category-badge-border:${e.border};`}function Le(e,t={}){const a=t.strong===!1?"span":"strong",r=Ds("app-rider-link-label",t.labelClassName),s=`<${a} class="${r}">${ho(e)}</${a}>`;if(t.riderId==null)return s;const n=['type="button"','class="'+Ds("app-rider-link",t.linkClassName)+'"',`data-rider-id="${t.riderId}"`];return t.teamId!=null&&n.push(`data-team-id="${t.teamId}"`),`<button ${n.join(" ")}>${s}</button>`}function rt(e,t,a=!0,r=""){const s=a===!1?"span":"strong",n=`<${s} class="app-team-link-label">${ho(e)}</${s}>`;return t==null?n:`<button type="button" class="${Ds("app-team-link",r)}" data-team-id="${t}">${n}</button>`}function bo(e,t){return t?t instanceof Map?t.get(e)??0:t[e]??0:0}function yo(e){return Math.round(e*10)/10}function vo(e,t){const a=e;return(t==null?void 0:t.distanceKm)??a.distanceKm??0}function So(e,t){const a=e;return(t==null?void 0:t.elevationGainMeters)??a.elevationGainMeters??0}function ko(e,t){return t+(e.formBonus??0)+(e.raceFormBonus??0)}function kd(e,t){return e.skills.stamina*(t/300)}function $o(e,t,a){return e.skills.timeTrial+ko(e,t)+e.skills.mountain*(a/500)}function $d(e,t,a,r){const s=kd(e,a),n=ko(e,r);switch(t.profile){case"Flat":return .8*e.skills.sprint+.15*e.skills.acceleration+.05*e.skills.flat+n+s;case"Rolling":return .7*e.skills.sprint+.2*e.skills.acceleration+.1*e.skills.hill+n+s;case"Hilly":return .45*e.skills.sprint+.1*e.skills.flat+.45*e.skills.hill+n+s;case"Hilly_Difficult":return .2*e.skills.sprint+.1*e.skills.flat+.7*e.skills.hill+n+s;case"Medium_Mountain":return .05*e.skills.sprint+.1*e.skills.flat+.35*e.skills.hill+.45*e.skills.mediumMountain+.05*e.skills.mountain+n+s;case"Mountain":return .05*e.skills.hill+.2*e.skills.mediumMountain+.75*e.skills.mountain+n+s;case"High_Mountain":return e.skills.mountain+n+s;case"Cobble":return .3*e.skills.sprint+.2*e.skills.flat+.5*e.skills.cobble+n+s;case"Cobble_Hill":return .3*e.skills.sprint+.2*e.skills.flat+.2*e.skills.hill+.3*e.skills.cobble+n+s;default:return .8*e.skills.sprint+.2*e.skills.flat+n+s}}function xd(e,t,a,r,s){return t.profile==="ITT"||t.profile==="TTT"?$o(e,s,r):$d(e,t,a,s)}function Td(e,t){var a;return{rank:t,kind:"rider",effectiveSkill:yo(e.effectiveSkill),teamId:e.rider.activeTeamId??0,teamName:e.teamName,displayName:`${e.rider.firstName} ${e.rider.lastName}`,roleLabel:((a=e.rider.role)==null?void 0:a.name)??"–",riderId:e.rider.id}}function xo(e,t,a,r){vo(a,r);const s=So(a,r),n=new Map(t.map(l=>[l.id,l]));if(a.profile==="TTT"){const l=new Map;for(const o of e){if(o.activeTeamId==null)continue;const m=l.get(o.activeTeamId)??[];m.push(o),l.set(o.activeTeamId,m)}return[...l.entries()].map(([o,m])=>{const p=n.get(o),f=m.map(y=>$o(y,bo(y.id,r==null?void 0:r.dailyFormByRiderId),s)).sort((y,k)=>k-y).slice(0,5),g=f.length,h=g>0?f.reduce((y,k)=>y+k,0)/g:0,b=Math.max(0,5-g)*2;return{team:p??{id:o,name:`Team ${o}`,abbreviation:"---",divisionId:0,u23TeamId:null,isPlayerTeam:!1,countryCode:"---",colorPrimary:"#000000",colorSecondary:"#ffffff",aiFocus1:0,aiFocus2:0,aiFocus3:0},score:h-b}}).sort((o,m)=>m.score-o.score||o.team.id-m.team.id).slice(0,20).map((o,m)=>({rank:m+1,kind:"team",effectiveSkill:yo(o.score),teamId:o.team.id,teamName:o.team.name,displayName:o.team.name,roleLabel:"TTT"}))}return(r!=null?Ar(e,t,a,r):Ar(e,t,a)).sort((l,c)=>c.effectiveSkill-l.effectiveSkill||l.rider.id-c.rider.id).slice(0,20).map((l,c)=>Td(l,c+1))}function Ar(e,t,a,r){const s=vo(a,r),n=So(a,r),i=new Map(t.map(l=>[l.id,l]));return e.map(l=>{var c;return{rider:l,teamName:l.activeTeamId!=null?((c=i.get(l.activeTeamId))==null?void 0:c.name)??`Team ${l.activeTeamId}`:"—",effectiveSkill:xd(l,a,s,n,bo(l.id,r==null?void 0:r.dailyFormByRiderId))}}).sort((l,c)=>c.effectiveSkill-l.effectiveSkill||l.rider.id-c.rider.id)}const d={currentSave:null,gameState:null,gameStatus:null,races:[],riders:[],teams:[],selectedResultsRaceId:null,selectedResultsStageId:null,selectedResultTypeId:1,selectedResultsMarkerKey:null,selectedResultsSpecialView:null,selectedDashboardRaceId:null,selectedRaceParticipantsRaceId:null,selectedDashboardProfileStageId:null,stageSummariesByStageId:{},stageSummaryErrorsByStageId:{},selectedRealtimeStageId:null,stageResults:null,resultsRoster:null,seasonStandings:null,seasonStandingsSelectedSeason:null,draftHistory:null,injuries:null,draftSelectedSeason:null,draftOverlayActive:!1,draftOverlayAuto:!0,draftOverlayPicks:null,draftOverlayCurrentIndex:0,draftSpeedMultiplier:1,draftPaused:!1,selectedSeasonStandingScope:"riders",teamTableSort:{key:"name",direction:"asc"},teamDetailPage:"skills",riderMenuTableSort:{key:"name",direction:"asc"},riderMenuDetailPage:"skills",riderMenuPage:1,stageEditorDraft:null,stageEditorExistingStages:[],stageEditorExistingStagesLoaded:!1,stageEditorOverviewLoaded:!1,stageEditorOverviewLoading:!1,stageEditorStageRows:[],stageEditorClimbRows:[],stageEditorPrograms:[],stageEditorHideBoringSegments:!0,stageEditorStagesSort:{key:"stageId",direction:"asc"},stageEditorClimbsSort:{key:"placementKm",direction:"asc"},realtimeBootstrap:null,realtimeError:null,rosterEditor:null,rosterEditorSelectedRiderIds:[],raceParticipants:[],raceParticipantsSort:{key:"team",direction:"asc"},riderStatsPayload:null,riderStatsTab:"results",riderStatsSelectedRiderId:null,riderStatsSelectedSeason:null,riderStatsTopResultsFilterCategory:null,riderStatsTopResultsFilterSeason:null,riderStatsTopResultsFilterRank:null,riderStatsTopResultsFilterProfile:null,riderStatsTopResultsPage:1,riderStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,breakaway:!0,oneDay:!0,stage:!0},teamStatsPayload:null,teamStatsTab:"topResults",teamStatsSelectedTeamId:null,teamStatsSelectedRosterYear:null,teamStatsRosterSort:{key:"overallRating",direction:"desc"},teamStatsSelectedSeason:"all",teamStatsTopResultsFilterCategory:null,teamStatsTopResultsFilterSeason:null,teamStatsTopResultsFilterRank:null,teamStatsTopResultsFilterProfile:null,teamStatsTopResultsPage:1,teamStatsTopResultsFilters:{gc:!0,mountain:!0,points:!0,youth:!0,breakaway:!0,oneDay:!0,stage:!0},riderTeamEditorPayload:null,riderTeamEditorSelectedTeamKey:"",riderTeamEditorSort:{key:"lastName",direction:"asc"},riderTeamEditorDirtyRiderIds:[],riderTeamEditorSaving:!1,riderTeamEditorExporting:!1,autoProgressTargetDate:null,raceProgramsPayload:null,raceProgramsActiveTab:"calendar-cols",raceProgramsDirty:!1,raceProgramsSaving:!1};let oa=null;function To(e){oa=e}let is=!1;function _s(e){is=e}let rn=null;function As(e){rn=e}let Br=null;function Bs(e){Br=e}let vt=!1;function sn(e){vt=e}function v(e){const t=document.getElementById(e);if(!t)throw new Error(`Element mit ID "${e}" wurde nicht gefunden.`);return t}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ce(e){return new Date(e).toLocaleDateString("de-DE",{day:"2-digit",month:"short",year:"numeric"})}function Oa(e){const t=Math.floor(e/3600),a=Math.floor(e%3600/60),r=Math.floor(e%60),s=String(a).padStart(2,"0"),n=String(r).padStart(2,"0");return t>0?`${t}:${s}:${n}`:`${a}:${n}`}function Cr(e){return e==null||e===0?"–":`+${Oa(e)}`}const Aa=2,Hr=3,nn=4;function on(e){return`/jersey/Jer_${e}.png`}function Mt(e,t){var r;if(e==null)return'<span class="results-team-jersey-placeholder" aria-hidden="true"></span>';const a=t??((r=d.teams.find(s=>s.id===e))==null?void 0:r.name)??`Team ${e}`;return`
    <span class="results-team-jersey" title="${S(a)}" aria-label="${S(a)}">
      ...
      >
    </span>`}function aa(e,t){return`<span class="results-jersey-cell">${Mt(e,t)}</span>`}function mt(e){return e&&de(e)||'<span class="results-flag-placeholder" aria-hidden="true"></span>'}function At(e){var a;if(e==null)return null;const t=Ce(e);return((a=t==null?void 0:t.country)==null?void 0:a.code3)??(t==null?void 0:t.nationality)??null}function Ce(e){return e==null?null:d.riders.find(t=>t.id===e)??null}function zt(e){return e==null?null:d.races.find(t=>t.id===e)??null}function ja(e){var t;if(e==null)return null;for(const a of d.races){const r=(t=a.stages)==null?void 0:t.find(s=>s.id===e);if(r)return{race:a,stage:r}}return null}function ra(e,t=!0,a=!1,r=null,s=null){const n=Le(e,{riderId:r,teamId:s,strong:t,linkClassName:"results-rider-link",labelClassName:"results-participant-label"});return`<span class="results-participant${a?" is-breakaway":""}">${n}</span>`}function wo(e){return`<span class="results-status-badge ${e?"results-status-badge-otl":"results-status-badge-dnf"}">${e?"OTL":"DNF"}</span>`}function zr(e,t){return e?e.startsWith("crash:")?`Sturz · ${e.slice(6)}`:e==="mechanical"?"Defekt":e:t?"Außerhalb des Zeitlimits":"Aufgegeben"}function Gr(e,t){return e==null||t==null||t===0?'<span class="results-gc-delta results-gc-delta-neutral">●</span>':t>0?`<span class="results-gc-delta results-gc-delta-up"><span class="results-gc-delta-symbol">▲</span><span>${t}</span></span>`:`<span class="results-gc-delta results-gc-delta-down"><span class="results-gc-delta-symbol">▼</span><span>${Math.abs(t)}</span></span>`}function Mo(e,t){return e==="sprint_intermediate"?`Sprint · ${t}`:e==="climb_top"||e==="finish_hill"||e==="finish_mountain"?`Bergwertung · ${t}`:t}let or=new Map,Xn=null;function ln(e){if(d.riders!==Xn){or.clear(),Xn=d.riders;for(let t=0;t<d.riders.length;t++){const a=d.riders[t];if(a.activeTeamId!=null){let r=or.get(a.activeTeamId);r||(r=[],or.set(a.activeTeamId,r)),r.push(a)}}}return or.get(e)||[]}const He={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OMA:"om",OTH:"un"};function de(e){const t=He[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}function Ro(e,t){return e?`<span class="country-chip">${de(e.code3)}<span>${S(e.name)}</span></span>`:t?S(t):"–"}function Kr(e){return`${e.toFixed(2).replace(".",",")} km`}function Or(e){return`${Math.round(e)} hm`}function wd(e){return`${e>0?"+":""}${e.toFixed(1).replace(".",",")}%`}const Io=new Set;function Md(e){Io.add(e)}function os(e){document.querySelectorAll(".screen").forEach(t=>t.classList.add("hidden")),v(`screen-${e}`).classList.remove("hidden")}function gt(e){v(`modal-${e}`).classList.remove("hidden")}function tt(e){v(`modal-${e}`).classList.add("hidden")}function Qn(e){if(e==null||e<=0)return"—";const t=Math.floor(e/60),a=Math.floor(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Co(){var h,b;const e=d.realtimeBootstrap;if(!e)return;const t=v("instant-sim-favorites"),a=v("instant-sim-gc"),r=v("instant-sim-points");if(!t||!a||!r)return;const s=v("instant-sim-race"),n=v("instant-sim-stage-desc"),i=v("instant-sim-date");s&&(s.textContent=e.race.name),n&&(n.textContent=`Etappe ${e.stage.stageNumber} · ${e.stage.profile}`),i&&(i.textContent=ce(e.stage.date));const c=xo(e.riders,e.teams,e.stage,{distanceKm:(h=e.stageSummary)==null?void 0:h.distanceKm,elevationGainMeters:(b=e.stageSummary)==null?void 0:b.elevationGainMeters}).slice(0,10),o=new Map(e.gcStandings.map(y=>[y.riderId,y]));let m=`
    <h3>
      <span>Etappen-Favoriten</span>
      <span style="font-size: 0.75rem; color: #94a3b8; font-weight: normal;">Top 10</span>
    </h3>
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const y of c){const k=e.riders.find(I=>I.id===y.riderId);if(!k)continue;const T=At(k.id)??"un",x=He[T]??"un",$=e.teams.find(I=>I.id===k.activeTeamId),P=($==null?void 0:$.abbreviation)??"—",E=o.get(k.id),R=E?`GC ${E.rank} (${E.rank===1?"Gelb":Qn(E.gapSeconds)})`:"GC –";m+=`
    ...
    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
  `;for(const y of p){const k=e.riders.find(R=>R.id===y.riderId);if(!k)continue;const T=At(k.id)??"un",x=He[T]??"un",$=e.teams.find(R=>R.id===k.activeTeamId),P=($==null?void 0:$.abbreviation)??"—",E=y.rank===1?"Gelb":Qn(y.gapSeconds);u+=`
      <div class="instant-sim-rider-card">
        <div class="instant-sim-jersey-column">
          <img src="/jersey/Jer_${k.activeTeamId}.png" class="instant-sim-large-jersey" onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';">
        </div>
  ...
  `).join("")}async function Id(e){Te("Karriere wird geladen…");const t=await Y.loadSave(e);if(me(),!t.success){alert("Fehler beim Laden: "+t.error);return}d.currentSave=t.data??null,await Sd()}async function Cd(e,t){if(!confirm(`Karriere "${t}" wirklich löschen?`))return;Te("Löschen…");const a=await Y.deleteSave(e);if(me(),!a.success){alert("Fehler: "+a.error);return}await Xa()}async function Fd(){const e=await Y.listSaves(),t=e.success?e.data??[]:[];if(t.length===0){v("btn-delete-all-careers").classList.add("hidden"),v("saves-list").classList.add("hidden");return}if(confirm(`Wirklich alle ${t.length} Karrieren löschen?`)&&confirm("Dieser Schritt löscht alle Spielstände dauerhaft. Wirklich fortfahren?")){Te("Alle Karrieren werden gelöscht…");try{for(const a of t){const r=await Y.deleteSave(a.filename);if(!r.success){alert(`Fehler beim Löschen von "${a.careerName}": ${r.error??"Unbekannter Fehler"}`);break}}}finally{me()}await Xa()}}function Ed(){v("btn-new-career").addEventListener("click",async()=>{var s;va("new-career-error"),v("input-career-name").value="";const a=v("input-team-id");a.innerHTML='<option value="">Wird geladen…</option>',gt("newCareer");const r=await Y.getAvailableTeams();if(!r.success||!((s=r.data)!=null&&s.length)){a.innerHTML='<option value="">Fehler beim Laden der Teams</option>';return}a.innerHTML=r.data.map(n=>`<option value="${n.id}">${S(n.name)} (${S(n.division??n.divisionName??"")})</option>`).join("")}),v("btn-cancel-new").addEventListener("click",()=>tt("newCareer")),v("btn-confirm-new").addEventListener("click",async()=>{const a=v("input-career-name").value.trim(),r=v("input-team-id").value;if(!a||!r){Bt("new-career-error","Bitte Karriere-Name und Team auswählen.");return}const s=Number(r),i=`${a.toLowerCase().replace(/[^a-z0-9]/g,"_").slice(0,20)}_${Date.now()}.db`;va("new-career-error"),Te("Neue Karriere wird erstellt…");const l=await Y.createSave(i,a,s);if(!l.success){me(),Bt("new-career-error",l.error??"Unbekannter Fehler.");return}const c=await Y.loadSave(i);if(me(),tt("newCareer"),!c.success){alert("Fehler: "+c.error);return}d.currentSave=c.data??null,await Sd()});const e=document.getElementById("btn-load-career");e&&e.addEventListener("click",()=>Xa());const t=document.getElementById("btn-delete-all-careers");t&&t.addEventListener("click",()=>{Fd()}),v("saves-list").addEventListener("click",async a=>{const r=a.target.closest("button[data-save-action]");if(!r)return;const{saveAction:s,filename:n,careerName:i}=r.dataset;if(n){if(s==="load"){await Id(n);return}s==="delete"&&await Cd(n,i??n)}})}const Pd="modulepreload",Nd=function(e){return"/"+e},ei={},Er=function(t,a,r){let s=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=Promise.allSettled(a.map(c=>{if(c=Nd(c),c in ei)return;ei[c]=!0;const o=c.endsWith(".css"),m=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const p=document.createElement("link");if(p.rel=o?"stylesheet":Pd,o||(p.as="script"),p.crossOrigin="",p.href=c,l&&p.setAttribute("nonce",l),document.head.appendChild(p),o)return new Promise((u,f)=>{p.addEventListener("load",u),p.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function n(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&n(l.reason);return t().catch(n)})},Ld={BEL:"be",FRA:"fr",ITA:"it",ESP:"es",NED:"nl",GER:"de",GBR:"gb",USA:"us",CAN:"ca",MEX:"mx",COL:"co",ECU:"ec",VEN:"ve",ARG:"ar",AUS:"au",NZL:"nz",DEN:"dk",NOR:"no",SLO:"si",POR:"pt",SWI:"ch",POL:"pl",AUT:"at",LUX:"lu",IRL:"ie",EST:"ee",LTU:"lt",LAT:"lv",CZE:"cz",SVK:"sk",KAZ:"kz",SWD:"se",FIN:"fi",UKR:"ua",MOL:"md",CRO:"hr",HUN:"hu",ERI:"er",RWA:"rw",ETH:"et",CMR:"cm",SAR:"za",JPN:"jp",UAE:"ae",BHR:"bh",SUI:"ch",IRE:"ie",RSA:"za",OTH:"un"};function Dd(e){const t=Ld[e]??null;return t?`<span class="fi fi-${t} country-flag" aria-hidden="true"></span>`:""}const _d=200;function gn(e){if(e.length===0)return[];const t=[];for(const a of e){const r=t[t.length-1];if(!r||Math.abs(r.distanceMeter-a.distanceMeter)>=_d){t.push({riderIds:[...a.riderIds],riderCount:a.riderCount,distanceMeter:a.distanceMeter,distanceSum:a.distanceMeter*a.riderCount});continue}r.riderIds.push(...a.riderIds),r.riderCount+=a.riderCount,r.distanceSum+=a.distanceMeter*a.riderCount,r.distanceMeter=r.distanceSum/r.riderCount}return t.map(({distanceSum:a,...r})=>r)}function fn(e){if(e.length===0)return[];let t=0;for(let s=1;s<e.length;s+=1)e[s].riderCount>e[t].riderCount&&(t=s);let a=0,r=0;return e.map((s,n)=>{const i=n===t;let l;return i?l="P":n<t?(a+=1,l=`E${a}`):(r+=1,l=`A${r}`),{...s,label:l,isPeloton:i,previousGapMeters:n>0?Math.max(0,e[n-1].distanceMeter-s.distanceMeter):null,nextGapMeters:n<e.length-1?Math.max(0,s.distanceMeter-e[n+1].distanceMeter):null}})}function Ad(e,t=null){var a,r,s;return t!=null&&e.some(n=>n.label===t)?t:((a=e.find(n=>n.label.startsWith("E")))==null?void 0:a.label)??((r=e.find(n=>n.label==="P"))==null?void 0:r.label)??((s=e[0])==null?void 0:s.label)??null}function Gt(e){return e.type==="climb_top"||(e.type==="finish_hill"||e.type==="finish_mountain")&&e.cat!=null&&e.cat!=="Sprint"}function ti(e,t,a,r){return`${r.type}:${e}:${t}:${a}`}function Bd(e,t){return e.type==="sprint_intermediate"?`SZ ${t}`:Gt(e)?`Berg ${t}`:e.type==="climb_start"?`Anstieg ${t}`:e.type==="start"?"Start":"Ziel"}function yt(e){const t=[];e.segments.forEach((s,n)=>{const i=n*2;(s.start_markers??[]).forEach((l,c)=>{t.push({key:ti(n,"start",c,l),label:"",marker:l,kmMark:s.start_km,elevation:s.start_elevation,boundary:"start",sequence:i+c/100})}),(s.end_markers??[]).forEach((l,c)=>{t.push({key:ti(n,"end",c,l),label:"",marker:l,kmMark:s.end_km,elevation:s.end_elevation,boundary:"end",sequence:i+1+c/100})})});const a=t.sort((s,n)=>s.kmMark-n.kmMark||s.sequence-n.sequence),r=new Map;return a.map(s=>{const n=(r.get(s.marker.type)??0)+1;return r.set(s.marker.type,n),{...s,label:s.marker.name??Bd(s.marker,n)}})}function Hd(e){const t=yt(e);return{segmentCount:e.segments.length,sprintCount:t.filter(({marker:a})=>a.type==="sprint_intermediate").length,climbCount:t.filter(({marker:a})=>Gt(a)).length}}function Sa(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function zd(e){return`${(e/1e3).toFixed(1).replace(".",",")} km`}function it(e,t,a,r){return t<=0?r:r+e/t*(a-r*2)}function Wr(e,t){const a=t/1e3,r=e.points;if(a<=r[0].kmMark)return r[0].elevation;for(let s=0;s<r.length-1;s+=1){const n=r[s],i=r[s+1];if(a>i.kmMark)continue;const l=Math.max(1e-4,i.kmMark-n.kmMark),c=(a-n.kmMark)/l;return n.elevation+(i.elevation-n.elevation)*c}return r[r.length-1].elevation}function Do(e){const t=e.points.map(m=>m.elevation),a=Math.min(...t),r=Math.max(...t),s=Math.max(1,r-a),n=Math.max(40,s*.08),i=Math.max(0,a-n),l=r+n;let c=Math.floor(i/50)*50,o=Math.ceil(l/50)*50;return o<=c&&(o=c+100),{axisMinElevation:c,axisMaxElevation:o}}function ft(e,t,a,r,s,n){const i=Math.max(1,a-t);return r-n-(e-t)/i*(r-s-n)}function Ba(e){return`${Math.round(e)} m`}function ai(e){return!e||e==="Sprint"?null:`Kat. ${e}`}function ri(e,t){if(t==="sprint_intermediate")return{accentColor:"#15803d",fillColor:"#ecfdf5"};switch(e){case"HC":return{accentColor:"#b91c1c",fillColor:"#fef2f2"};case"1":return{accentColor:"#ea580c",fillColor:"#fff7ed"};case"2":return{accentColor:"#d97706",fillColor:"#fffbeb"};case"3":return{accentColor:"#ca8a04",fillColor:"#fefce8"};case"4":return{accentColor:"#65a30d",fillColor:"#f7fee7"};default:return{accentColor:"#1f2937",fillColor:"#f8fafc"}}}function _o(e,t,a,r,s,n,i,l,c){var g;const o=[],m=[];let p=null,u="#b91c1c";for(const h of yt(e)){const{marker:b,kmMark:y,elevation:k}=h;if(b.type==="climb_start"){m.push({kmMark:y,elevation:k,name:b.name});continue}if(Gt(b)){let T=-1;for(let E=m.length-1;E>=0;E-=1)if(b.name&&((g=m[E])==null?void 0:g.name)===b.name){T=E;break}const x=T>=0?m.splice(T,1)[0]:m.pop();x&&Math.max(0,y-x.kmMark),x&&Math.max(0,k-x.elevation);const $=ri(b.cat,b.type),P=ai(b.cat);if(b.type==="finish_hill"||b.type==="finish_mountain"){p=b.cat??null,u=$.accentColor;continue}o.push({x:it(y*1e3,t,a,r),anchorY:ft(k,l,c,s,n,i),primaryLabel:P??"Berg",secondaryLabel:Ba(k),distanceLabel:`${y.toFixed(1).replace(".",",")} km`,accentColor:$.accentColor});continue}if(b.type==="sprint_intermediate"){const T=ri(b.cat,b.type);o.push({x:it(y*1e3,t,a,r),anchorY:ft(k,l,c,s,n,i),primaryLabel:"Sprint",secondaryLabel:Ba(k),distanceLabel:`${y.toFixed(1).replace(".",",")} km`,accentColor:T.accentColor})}}const f=e.points[e.points.length-1];return o.push({x:it(f.kmMark*1e3,t,a,r),anchorY:ft(f.elevation,l,c,s,n,i),primaryLabel:p?`${ai(p)??"Ziel"} · Ziel`:"Ziel",secondaryLabel:Ba(f.elevation),distanceLabel:`${f.kmMark.toFixed(1).replace(".",",")} km`,accentColor:u}),o.sort((h,b)=>h.x-b.x)}function Ao(e,t,a){const r=t+4,s=a+38,n=e.secondaryLabel?`${e.primaryLabel} · ${e.secondaryLabel}`:e.primaryLabel;return`
    <g class="race-sim-marker-group">
    ...
    </g>`}function Bo(e,t){const a=new Set,r=t/1e3;for(let s=0;s<=r;s+=25)a.add(Math.round(s*1e3));return a.add(Math.round(t)),[...a].filter(s=>s>=0&&s<=t).sort((s,n)=>s-n)}function Ho(e,t,a,r,s,n){const i=new Set(yt(t).map(l=>Math.round(l.kmMark*1e3)));return e.map(l=>{const c=it(l,a,r,s),m=i.has(l)?18:12,p=n+m+26;return`
      <g class="race-sim-distance-tick">
        ...
        <text x="${c.toFixed(1)}" y="${p.toFixed(1)}" text-anchor="middle" class="race-sim-grid-label">${Sa(zd(l))}</text>
      </g>`}).join("")}function Gd(e,t,a,r,s,n,i,l,c,o,m){const p=it(e.distanceMeter,a,r,n),u=Wr(t,e.distanceMeter),f=ft(u,c,o,s,i,l),g=e.riderCount===1?2.2:Math.min(6.6,3.4+e.riderCount*.28),h=e.riderCount>1?`<text x="${p.toFixed(1)}" y="${(f+2.6).toFixed(1)}" class="race-sim-cluster-label">${e.riderCount}</text>`:"";return`
    <g class="race-sim-cluster-group">
      ...
      ${h}
        ...
        </g>`}).join("")}function Od(e,t,a,r,s,n,i,l,c,o,m){const p=Math.max(0,Math.min(o,e.distanceKm)),u=Math.max(0,Math.min(m,e.distanceKm));if(u<=p)return null;const f=[{kmMark:p,elevation:Wr(e,p*1e3)},...e.points.filter(k=>k.kmMark>p&&k.kmMark<u),{kmMark:u,elevation:Wr(e,u*1e3)}];if(f.length<2)return null;const g=s-i,h=f.map((k,T)=>{const x=it(k.kmMark*1e3,t,a,r),$=ft(k.elevation,l,c,s,n,i);return`${T===0?"M":"L"} ${x.toFixed(1)} ${$.toFixed(1)}`}).join(" "),b=it(p*1e3,t,a,r),y=it(u*1e3,t,a,r);return`${h} L ${y.toFixed(1)} ${g.toFixed(1)} L ${b.toFixed(1)} ${g.toFixed(1)} Z`}function jd(e,t,a,r,s={}){const m=e.distanceKm*1e3,{axisMinElevation:p,axisMaxElevation:u}=Do(e),f=533,g=12,b=e.points.map(E=>{const R=it(E.kmMark*1e3,m,1584,28),I=ft(E.elevation,p,u,634,168,101);return{x:R,y:I}}).map((E,R)=>`${R===0?"M":"L"} ${E.x.toFixed(1)} ${E.y.toFixed(1)}`).join(" "),y=`${b} L ${1556 .toFixed(1)} ${f.toFixed(1)} L ${28 .toFixed(1)} ${f.toFixed(1)} Z`,k=s.selectedClimbRange!=null?Od(e,m,1584,28,634,168,101,p,u,s.selectedClimbRange.startKm,s.selectedClimbRange.endKm):null,T=_o(e,m,1584,28,634,168,101,p,u).map(E=>Ao(E,g,f)).join(""),$=Array.from({length:5},(E,R)=>p+(u-p)/4*R).map(E=>{const R=ft(E,p,u,634,168,101);return`
      ...
      <text x="${14 .toFixed(1)}" y="${(R+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Ba(E)}</text>`}).join(""),P=Ho(Bo(e,m),e,m,1584,28,f);return`
    <svg viewBox="0 0 1584 634" role="img" aria-label="${Sa(a)}" class="dashboard-stage-profile-svg dashboard-stage-profile-svg-large" data-stage-profile="${t}">
    ...
    </svg>`}function Wd(e,t,a,r,s){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}e.innerHTML=`<div class="dashboard-stage-profile-wrap">${jd(t,a,r,!1,s)}</div>`}function Vd(e,t,a,r,s,n="finish",i=null){if(t.points.length<2){e.innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>';return}const l=1584,c=634,o=28,m=168,p=101,{axisMinElevation:u,axisMaxElevation:f}=Do(t),g=c-p,h=12,b=Array.from({length:5},(G,B)=>u+(f-u)/4*B),y=gn(a.clusters),k=fn(y),T=Bo(t,a.stageDistanceMeters),$=t.points.map(G=>{const B=it(G.kmMark*1e3,a.stageDistanceMeters,l,o),q=ft(G.elevation,u,f,c,m,p);return{x:B,y:q}}).map((G,B)=>`${B===0?"M":"L"} ${G.x.toFixed(1)} ${G.y.toFixed(1)}`).join(" "),P=`${$} L ${(l-o).toFixed(1)} ${g.toFixed(1)} L ${o.toFixed(1)} ${g.toFixed(1)} Z`,E=_o(t,a.stageDistanceMeters,l,o,c,m,p,u,f).map(G=>Ao(G,h,g)).join(""),R=b.map(G=>{const B=ft(G,u,f,c,m,p);return`
      ...
      <text x="${(o-14).toFixed(1)}" y="${(B+4).toFixed(1)}" text-anchor="end" class="race-sim-grid-label race-sim-elevation-label">${Ba(G)}</text>`}).join(""),I=Ho(T,t,a.stageDistanceMeters,l,o,g),_=new Map(y.map((G,B)=>[G,k[B]??null])),N=y.map(G=>{var B;return Gd(G,t,a.stageDistanceMeters,l,c,o,m,p,u,f,((B=_.get(G))==null?void 0:B.label)===i)}).join(""),L=s.stage.profile==="ITT"?Kd(y,t,a.stageDistanceMeters,l,c,o,m,p,u,f,s):"";e.innerHTML=`
    ...
    </div>`;const a={timeField:e.querySelector('[data-race-sim-field="time"]'),finishedField:e.querySelector('[data-race-sim-field="finished"]'),distanceField:e.querySelector('[data-race-sim-field="distance"]'),toggleButton:e.querySelector('[data-race-sim-action="toggle"]'),speedButtons:Array.from(e.querySelectorAll("[data-race-sim-speed]"))};return Ti.set(e,a),a}function Mi(e,t){const a=Pu(e);a.timeField&&(a.timeField.textContent=Eu(t.snapshot.elapsedSeconds)),a.finishedField&&(a.finishedField.textContent=`${t.snapshot.finishedRiders} / ${t.totalRiders} im Ziel`),a.distanceField&&(a.distanceField.textContent=`${wi(t.snapshot.leaderDistanceMeters)} / ${wi(t.snapshot.stageDistanceMeters)}`),a.toggleButton&&(a.toggleButton.textContent=t.isRunning?"Pause":t.snapshot.isFinished?"Fertig":"Start",a.toggleButton.classList.toggle("active",!t.isRunning&&!t.snapshot.isFinished)),a.speedButtons.forEach(r=>{const s=Number(r.dataset.raceSimSpeed);r.classList.toggle("active",s===t.timeMultiplier)})}const Nu=[{key:"all",label:"Alle"},{key:"attack",label:"Attacken"},{key:"crash",label:"Stürze"},{key:"mechanical",label:"Defekte"},{key:"breakaway",label:"Ausreißer"}];function Lu(e){const t=Math.max(0,Math.round(e)),a=Math.floor(t/60),r=t%60;return`${a}:${String(r).padStart(2,"0")}`}function ka(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Du(e){return`/jersey/Jer_${e}.png`}function el(e,t="race-sim-message-jersey"){return`
    <span class="${t}" aria-hidden="true">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function _u(e){return e.riderId==null||e.riderTeamId==null?"":el(e.riderTeamId)}function Au(e){const t=ka(e.title);return e.riderId==null?`<strong class="race-sim-message-title">${t}</strong>`:`<button type="button" class="race-sim-message-title race-sim-message-rider-link" data-race-sim-group-rider-id="${e.riderId}">${t}</button>`}function Bu(e,t){return`<button type="button" class="race-sim-message-inline-name race-sim-message-rider-link" data-race-sim-group-rider-name="${ka(e)}"${t!=null?` data-race-sim-group-rider-team-id="${t}"`:""}>${ka(e)}</button>`}function Hu(e,t){if(t==="all")return!0;const a=tl(e);return t==="attack"?a==="attack"||a==="counter_attack":a===t}function zu(e){const t=e.detail?ka(e.detail):"",a=(e.secondaryRiders??[]).map(s=>`${s.riderTeamId!=null?el(s.riderTeamId,"race-sim-message-inline-jersey"):""}${Bu(s.riderName,s.riderTeamId)}`).join(", ");if(!t&&a.length===0)return"";const r=a.length>0?`${t.length>0?" ":""}Reaktion: ${a}.`:"";return`<span class="race-sim-message-detail"> · ${t}${r}</span>`}function tl(e){return e.title.includes("stürzt")||e.title.includes("Sturz")?"crash":e.title.includes("Defekt")?"mechanical":e.title.includes("Ausreißer")?"breakaway":e.type}function Ri(e,t,a="all"){const r=t.filter(n=>Hu(n,a)),s=t.length===0?"Noch keine Events in dieser Etappe.":"Keine Meldungen in dieser Kategorie.";e.innerHTML=`
    ...
    <div class="race-sim-message-list">
      ${r.length===0?`<div class="race-sim-message-empty">${s}</div>`:r.map(n=>`
        <article class="race-sim-message-item" data-tone="${n.tone}" data-message-kind="${ka(tl(n))}">
          <span class="race-sim-message-time">t=${Lu(n.elapsedSeconds)}</span>
          ${_u(n)}
      ...
      `).join("")}
    </div>`}const Gu=1,Ku={Flat:14,Rolling:15,Hilly:16,Hilly_Difficult:17,Medium_Mountain:18,Mountain:25,High_Mountain:27,ITT:30,TTT:40,Cobble:18,Cobble_Hill:20};function Ou(e){return Math.max(0,Math.round(e))}function al(e){return e==="ITT"||e==="TTT"}function ju(e){return Ku[e]??20}function Wu(e,t){if(t.length===0)return null;const a=Math.min(...t);return!Number.isFinite(a)||a<=0?null:Math.floor(a*(1+ju(e)/100))}function Vu(e,t){return e.stageTimeSeconds-t.stageTimeSeconds||t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function Ii(e,t){return t.photoFinishScore-e.photoFinishScore||e.riderId-t.riderId}function Rs(e,t){if(al(t))return[...e].sort(Vu);const a=[...e].sort((l,c)=>l.stageTimeSeconds-c.stageTimeSeconds||Ii(l,c)),r=[];let s=[],n=null;const i=()=>{r.push(...s.sort(Ii))};for(const l of a){if(s.length===0){s=[l],n=l.stageTimeSeconds;continue}if(n!=null&&l.stageTimeSeconds-n<=Gu){s.push(l),n=l.stageTimeSeconds;continue}i(),s=[l],n=l.stageTimeSeconds}return s.length>0&&i(),r}function ne(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Uu(e){return`/jersey/Jer_${e}.png`}function Qa(e,t){return e==null||e<=0?"—":`
    <span class="race-sim-team-visual" title="${ne(t??`Team ${e}`)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function er(e,t,a){return e==null?`<span class="${a}" title="${ne(t)}">${ne(t)}</span>`:`<button type="button" class="${a} race-sim-stage-overview-rider-link" data-race-sim-group-rider-id="${e}" title="${ne(t)}">${ne(t)}</button>`}function Yu(e){return e.toFixed(1).replace(".",",")}function Ur(e){if(e==null||e<=0)return"—";const t=Math.floor(e/60),a=Math.floor(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Zu(e){return`${e??0} Pkt.`}function Ju(e){if(e==null||!Number.isFinite(e))return"—";const t=Math.round(e);return t===0?"—":t>0?`+${t} m`:`-${Math.abs(t)} m`}function qu(e){return e==null||!Number.isFinite(e)?"":e<-100?"is-ahead":e>100?"is-behind":""}function rl(e){const t=Math.max(0,Math.round(e)),a=Math.floor(t/3600),r=Math.floor(t%3600/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Xu(e){if(e==null||e<=0)return rl(0);const t=Math.floor(e/60),a=Math.round(e%60);return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function Dt(e){return e?e.split("|").map(t=>Number.parseInt(t.trim(),10)).filter(Number.isFinite):[]}function hr(e){return`${e.toFixed(1).replace(".",",")} km`}function Ci(e){return`${e.toFixed(1).replace(".",",")}%`}function br(e,t){return e.filter(a=>Number.isFinite(a)&&a>0).map(a=>({points:a,pointsKind:t}))}function Fi(e){return e==null?null:e==="HC"?"is-hc":`is-cat-${e}`}function Qu(e){return e.accent==="sprint"?{label:"Sprint",className:"is-sprint"}:e.categoryLabel&&e.categoryClassName?{label:e.categoryLabel,className:e.categoryClassName}:null}function em(e,t){return e.riderId==null?null:t.gcLeaderRiderId===e.riderId?"gc":t.pointsLeaderRiderId===e.riderId?"points":t.mountainLeaderRiderId===e.riderId?"mountain":t.youthLeaderRiderId===e.riderId?"youth":null}function tm(e,t,a){return Array.from({length:t},(r,s)=>e.slice(s*a,(s+1)*a))}function am(e,t,a){if(e.length===0)return'<div class="race-sim-favorites-empty">Noch keine Favoriten für diese Etappe.</div>';const r=tm(e,4,5),s=new Map(t.map(n=>[n.riderId,n]));return`<div class="race-sim-stage-favorites-grid">${r.map(n=>`
    <div class="race-sim-favorites-column">
      ${n.map(i=>`
        <article class="race-sim-favorite-item${(()=>{const l=em(i,a);return l?` is-${l}-leader`:""})()}">
  ...
  `).join("")}</div>`}function Wa(e,t){const a=e.riders.find(r=>r.id===t);return a?`${a.firstName} ${a.lastName}`:`Fahrer ${t}`}function cs(e,t){const a=e.riders.find(n=>n.id===t),r=(a==null?void 0:a.activeTeamId)??null,s=r!=null?e.teams.find(n=>n.id===r)??null:null;return{teamId:r,teamName:(s==null?void 0:s.name)??null}}function rm(e,t,a,r={}){const s=(t??[]).slice(0,r.limit??8);return s.length===0?'<div class="race-sim-classification-empty">Noch keine Vorwertung.</div>':`<div class="race-sim-classification-grid">${s.map(n=>{var p;const i=n.riderId??0,l=cs(e,i),c=Wa(e,i),o=((p=r.distanceGapsByRiderId)==null?void 0:p.get(i))??null,m=[r.distanceGapClassName??"",qu(o)].filter(u=>u.length>0).join(" ");return`
      <article class="race-sim-classification-row">
        ...
        ${r.distanceGapsByRiderId?`<span class="race-sim-classification-distance-gap ${m}">${ne(Ju(o))}</span>`:""}
    ...
    <details class="race-sim-overview-details ${a}" data-race-sim-overview-section="${r}" ${s?"open":""}>
      ...
      ${t}
    </details>`}function Yr(e,t,a,r){const s=new Map(t.map(n=>[n.riderId,n]));return e.riders.map(n=>{var c;const i=s.get(n.id)??null,l=((c=a.get(n.id))==null?void 0:c[r])??0;return{riderId:n.id,rank:(i==null?void 0:i.rank)??Number.MAX_SAFE_INTEGER,points:((i==null?void 0:i.points)??0)+l,timeSeconds:(i==null?void 0:i.timeSeconds)??null,gapSeconds:(i==null?void 0:i.gapSeconds)??null,stagePoints:l}}).sort((n,i)=>(i.points??0)-(n.points??0)||n.rank-i.rank||Wa(e,n.riderId).localeCompare(Wa(e,i.riderId),"de")).map((n,i)=>({...n,rank:i+1}))}function Ei(e){const t=sm(e)?e.stagePoints:0;return`${ne(Zu("points"in e?e.points:null))}${t>0?`<span class="race-sim-classification-stage-gain"><span class="race-sim-classification-stage-gain-arrow">▲</span><span class="race-sim-classification-stage-gain-amount">+${ne(t)}</span></span>`:""}`}function sm(e){return"stagePoints"in e&&typeof e.stagePoints=="number"}function Pi(e,t){if(t==null)return new Map;const a=e.riders.find(r=>r.riderId===t)??null;return a?new Map(e.riders.map(r=>[r.riderId,a.distanceCoveredMeters-r.distanceCoveredMeters])):new Map}function nm(e,t){return e.stageSummary.segments.find(a=>t>=a.start_km&&t<=a.end_km)??e.stageSummary.segments.find(a=>a.end_km>=t)??e.stageSummary.segments[e.stageSummary.segments.length-1]??null}function Pr(e,t){var r;const a=(r=e.race.category)==null?void 0:r.bonusSystem;return!a||t==null||t==="Sprint"?[]:Dt(t==="HC"?a.pointsMountainHc:t==="1"?a.pointsMountainCat1:t==="2"?a.pointsMountainCat2:t==="3"?a.pointsMountainCat3:a.pointsMountainCat4)}function hn(e){var r;const t=(r=e.race.category)==null?void 0:r.bonusSystem;if(!t||e.stage.profile==="TTT")return[];if(!e.race.isStageRace)return Dt(t.pointsOneDay);const a=!["ITT","TTT","Flat","Rolling","Hilly"].includes(e.stage.profile);return Dt(a?t.pointsMountainStage:t.pointsSprintFinish)}function sl(e){var t,a;return e.stage.profile==="ITT"||e.stage.profile==="TTT"?[]:Dt((a=(t=e.race.category)==null?void 0:t.bonusSystem)==null?void 0:a.pointsSprintIntermediate)}function im(e,t,a){let r=null;for(const s of e.stageSummary.segments){const n=Math.max(t,s.start_km),i=Math.min(a,s.end_km),l=Math.max(0,i-n);if(l<=0)continue;const c={lengthKm:l,gradient:s.gradient_percent};(r==null||c.gradient>r.gradient||c.gradient===r.gradient&&c.lengthKm>r.lengthKm)&&(r=c)}return r}function Is(e,t,a,r=null){return e.entries.filter(s=>r==null||r.has(s.riderId)).map((s,n)=>({riderId:s.riderId,rank:s.rank,points:t[n]??0,pointsKind:a,crossingTimeSeconds:s.crossingTimeSeconds,gapSeconds:s.gapSeconds})).filter(s=>s.points>0)}function bn(e){const t=new Map;for(const a of e)for(const r of a.entries){const s=t.get(r.riderId)??{points:0,mountain:0};r.pointsKind==="mountain"?s.mountain+=r.points:s.points+=r.points,t.set(r.riderId,s)}return t}function om(e){return yt(e.stageSummary).filter(({marker:t})=>t.type==="finish_flat"||t.type==="finish_TT"||t.type==="finish_hill"||t.type==="finish_mountain").sort((t,a)=>a.kmMark-t.kmMark)[0]??null}function Zr(e,t){const a=al(e.stage.profile)?t.riderClockSeconds:t.finishTimeSeconds;return a!=null&&Number.isFinite(a)?Ou(a):null}function us(e,t){const a=t.riders.filter(n=>n.finishStatus!=="dnf").map(n=>{const i=Zr(e,n);return i==null?null:{rider:n,stageTimeSeconds:i,photoFinishScore:n.photoFinishScore,riderId:n.riderId}}).filter(n=>n!=null);if(a.length===0)return[];const r=Math.min(...a.map(n=>n.stageTimeSeconds));if(!Number.isFinite(r)||r<=0)return Rs(a,e.stage.profile).map(n=>n.rider);const s=Wu(e.stage.profile,a.map(n=>n.stageTimeSeconds));return s==null?Rs(a,e.stage.profile).map(n=>n.rider):Rs(a.filter(n=>n.stageTimeSeconds<=s),e.stage.profile).map(n=>n.rider)}function lm(e,t){const a=hn(e);return a.length===0?[]:us(e,t).map((r,s)=>({riderId:r.riderId,rank:s+1,points:a[s]??0,pointsKind:"points",crossingTimeSeconds:Zr(e,r),gapSeconds:null})).filter(r=>r.points>0)}function dm(e,t){const a=us(e,t).slice(0,20),r=a[0]!=null?Zr(e,a[0])??0:0;return a.map((s,n)=>{const i=Zr(e,s)??0;return{riderId:s.riderId,rank:n+1,crossingTimeSeconds:i,gapSeconds:Math.max(0,i-r),photoFinishScore:s.photoFinishScore}})}function cm(e,t){var a;return((a=us(e,t)[0])==null?void 0:a.riderId)??null}function yn(e,t,a){var T,x;const r=yt(e.stageSummary),s=e.stageSummary.distanceKm*.75,n=a.isFinished?new Set(us(e,a).map($=>$.riderId)):null,i=r.filter(({marker:$})=>$.type==="climb_start"),l=r.filter(({marker:$})=>Gt($)).sort(($,P)=>$.kmMark-P.kmMark).map(($,P)=>{var M,z;const E=[...i].reverse().find(V=>V.kmMark<=$.kmMark)??null,R=nm(e,$.kmMark),I=(E==null?void 0:E.kmMark)??(R==null?void 0:R.start_km)??$.kmMark,_=(E==null?void 0:E.elevation)??(R==null?void 0:R.start_elevation)??$.elevation,N=Math.max(0,$.kmMark-I),L=N>0?($.elevation-_)/(N*1e3)*100:(R==null?void 0:R.gradient_percent)??0,G=im(e,I,$.kmMark),B=t.find(V=>V.markerKey===$.key)??null,q=Pr(e,(B==null?void 0:B.markerCategory)??$.marker.cat??null),te=B?Is(B,q,"mountain",n):[],ae=(B==null?void 0:B.markerCategory)??$.marker.cat??null;return{key:$.key,title:`${P+1}. Bergwertung`,label:$.label,categoryLabel:ae?`Kat. ${ae}`:null,categoryClassName:Fi(ae),kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:N,averageGradient:L,steepestSegmentLengthKm:(G==null?void 0:G.lengthKm)??null,steepestSegmentGradient:(G==null?void 0:G.gradient)??null,highlightMeta:$.kmMark>=s,leaderRiderId:((M=te[0])==null?void 0:M.riderId)??((z=B==null?void 0:B.entries[0])==null?void 0:z.riderId)??null,displayBadges:br(q,"mountain"),entries:te,timingEntries:(B==null?void 0:B.entries)??[],accent:"mountain"}}),c=r.filter(({marker:$})=>$.type==="sprint_intermediate").sort(($,P)=>$.kmMark-P.kmMark).map(($,P)=>{var _,N;const E=t.find(L=>L.markerKey===$.key)??null,R=sl(e),I=E?Is(E,R,"points",n):[];return{key:$.key,title:`${P+1}. Zwischensprint`,label:$.label,categoryLabel:null,categoryClassName:null,kmMark:$.kmMark,kmToFinish:Math.max(0,e.stageSummary.distanceKm-$.kmMark),climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!1,leaderRiderId:((_=I[0])==null?void 0:_.riderId)??((N=E==null?void 0:E.entries[0])==null?void 0:N.riderId)??null,displayBadges:br(R,"points"),entries:I,timingEntries:(E==null?void 0:E.entries)??[],accent:"sprint"}}),o=om(e),m=lm(e,a),p=o?t.find($=>$.markerKey===o.key)??null:null,u=p?Is(p,Pr(e,p.markerCategory),"mountain",n):[],f=hn(e),g=p?Pr(e,p.markerCategory):[],h=e.stage.profile==="ITT"||e.stage.profile==="TTT"?dm(e,a):(p==null?void 0:p.entries)??[],b=((T=m[0])==null?void 0:T.riderId)??((x=u[0])==null?void 0:x.riderId)??cm(e,a),y={key:"finish",title:"Zielsprint",label:(o==null?void 0:o.label)??"Ziel",categoryLabel:p!=null&&p.markerCategory?`Kat. ${p.markerCategory}`:null,categoryClassName:Fi((p==null?void 0:p.markerCategory)??null),kmMark:(o==null?void 0:o.kmMark)??e.stageSummary.distanceKm,kmToFinish:0,climbLengthKm:null,averageGradient:null,steepestSegmentLengthKm:null,steepestSegmentGradient:null,highlightMeta:!!(p!=null&&p.markerCategory),leaderRiderId:b,displayBadges:[...br(f,"points"),...br(g,"mountain")],entries:[...m,...u],timingEntries:h,accent:"finish"};return[...[...c,...l].sort(($,P)=>$.kmMark-P.kmMark||$.title.localeCompare(P.title,"de")),y].filter($=>$.entries.length>0||$.timingEntries.length>0||$.accent!=="finish"||o!=null||a.isFinished)}function um(e,t){const a=new Map(t.entries.map(n=>[n.riderId,n])),r=(e.stage.profile==="ITT"||e.stage.profile==="TTT")&&t.key==="finish"?20:15,s=t.timingEntries.length>0?[...t.timingEntries].sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId).slice(0,r):t.entries.slice(0,r).map(n=>({riderId:n.riderId,rank:n.rank,crossingTimeSeconds:n.crossingTimeSeconds??0,gapSeconds:n.gapSeconds??0,photoFinishScore:0,pointsAwarded:n.points})).sort((n,i)=>n.rank-i.rank||n.crossingTimeSeconds-i.crossingTimeSeconds||n.riderId-i.riderId);return s.length===0?'<div class="race-sim-stage-points-popover-empty">Noch keine Punkte vergeben.</div>':`
    <div class="race-sim-stage-points-popover-list">
      ${s.map(n=>{const i=cs(e,n.riderId),l=a.get(n.riderId)??null;return`
          <div class="race-sim-stage-points-popover-row">
            ...
            <strong>${n.rank===1?ne(rl(n.crossingTimeSeconds)):ne(Xu(n.gapSeconds))}</strong>
            ${l?`<strong class="race-sim-stage-points-value-${l.pointsKind}">${l.points}</strong>`:"<strong>—</strong>"}
          </div>`}).join("")}
    </div>`}function Ni(e,t){var a;return((a=e==null?void 0:e.find(r=>r.riderId===t))==null?void 0:a.points)??0}function Li(e,t){var a;return((a=e.filter(r=>r.riderId!=null&&t.has(r.riderId)).sort((r,s)=>r.rank-s.rank||r.riderId-s.riderId)[0])==null?void 0:a.riderId)??null}function vr(e,t,a){if(!(!t||e.some(r=>r.riderId===t.riderId))){if(e.length<25){e.push(t);return}e[a]=t}}function mm(e,t,a,r,s){const n=new Set(e.riderIds),i=new Map(t.riders.map(f=>[f.riderId,f])),c=e.riderIds.map(f=>i.get(f)??null).filter(f=>f!=null).sort((f,g)=>{var h,b;return(((h=a.get(f.riderId))==null?void 0:h.rank)??Number.MAX_SAFE_INTEGER)-(((b=a.get(g.riderId))==null?void 0:b.rank)??Number.MAX_SAFE_INTEGER)||f.riderName.localeCompare(g.riderName,"de")||f.riderId-g.riderId}).slice(0,25),o=i.get(Li(r,n)??-1)??null,m=i.get(Li(s,n)??-1)??null,p=o!=null&&!c.some(f=>f.riderId===o.riderId),u=m!=null&&!c.some(f=>f.riderId===m.riderId);return c.length>=25&&p&&u&&o.riderId!==m.riderId?(vr(c,o,23),vr(c,m,24),c):(vr(c,o,24),vr(c,m,24),c)}function pm(e,t){const a=[];return t.gcLeaderRiderId===e&&a.push("gc"),t.mountainLeaderRiderId===e&&a.push("mountain"),t.pointsLeaderRiderId===e&&a.push("points"),t.youthLeaderRiderId===e&&a.push("youth"),a}function gm(e){return e.includes("gc")?" is-gc-leader":e.includes("mountain")?" is-mountain-leader":e.includes("points")?" is-points-leader":e.includes("youth")?" is-youth-leader":""}function Di(e,t){return e==null?"—":`${t}${Math.round(e)} m`}function fm(e,t){const a=t.riders.filter(s=>e.riderIds.includes(s.riderId)).reduce((s,n)=>Math.max(s,n.distanceCoveredMeters),0),r=Math.max(0,t.leaderDistanceMeters-a);return r>0?`-${Math.round(r)} m`:"—"}function hm(e,t,a,r,s,n,i){if(a.length===0||e.stage.profile==="ITT"||e.stage.profile==="TTT")return"";const l=Ad(a,r),c=a.find(u=>u.label===l)??a[0],o=new Map(e.gcStandings.map(u=>[u.riderId,u])),m=bn(i),p=mm(c,t,o,s,n);return`
    <section class="race-sim-classification-box race-sim-classification-box-group">
      ...
      <div class="race-sim-group-gap-row">
        <span>Vorne ${ne(Di(c.previousGapMeters,"-"))}</span>
        <span>Leader ${ne(fm(c,t))}</span>
        <span>Hinten ${ne(Di(c.nextGapMeters,"+"))}</span>
      </div>
      <div class="race-sim-group-grid">
        ${p.map((u,f)=>{const g=o.get(u.riderId)??null,h=cs(e,u.riderId),b=m.get(u.riderId)??{points:0,mountain:0},y=Ni(s,u.riderId),k=Ni(n,u.riderId),T=pm(u.riderId,e.classificationLeaders),x=T.length>0?T.map($=>({gc:"GC-Leader",mountain:"Bergwertungs-Leader",points:"Punktewertungs-Leader",youth:"Nachwuchs-Leader"})[$]).join(", "):"";return`
            <article class="race-sim-group-row">
              <strong class="race-sim-group-position${gm(T)}" title="${ne(x)}">${f+1}.</strong>
    ...
    </section>`}function bm(e,t,a,r){const s=yn(t,a.markerClassifications,a),n=bn(s),i=Yr(t,t.pointsStandings,n,"points"),l=Yr(t,t.mountainStandings,n,"mountain"),c=fn(gn(a.clusters));e.innerHTML=hm(t,a,c,r,i,l,s)}function ym(e){return e.length===0?"":e.map(t=>`<span class="race-sim-stage-points-badge race-sim-stage-points-badge-${t.pointsKind}">${t.points}</span>`).join("")}function vm(e){const t=yt(e.stageSummary),a=sl(e)[0]??0,r=hn(e)[0]??0,s=t.filter(({marker:n})=>Gt(n)).reduce((n,{marker:i})=>n+(Pr(e,i.cat??null)[0]??0),0);return{points:t.filter(({marker:n})=>n.type==="sprint_intermediate").length*a+r,mountain:s}}function _i(e){const t=vm(e);return`
    ...
    </span>`}function Sm(e){const t=Qu(e),a=[`<span class="race-sim-stage-points-meta-pill">${ne(hr(e.kmMark))}</span>`,`<span class="race-sim-stage-points-meta-pill">${ne(`${hr(e.kmToFinish)} bis Ziel`)}</span>`,e.climbLengthKm!=null?`<span class="race-sim-stage-points-meta-pill">${ne(`Länge ${hr(e.climbLengthKm)}`)}</span>`:"",e.averageGradient!=null?`<span class="race-sim-stage-points-meta-pill">${ne(`Ø ${Ci(e.averageGradient)}`)}</span>`:"",e.steepestSegmentLengthKm!=null&&e.steepestSegmentGradient!=null?`<span class="race-sim-stage-points-meta-pill is-steepest">${ne(`Steilstes ${hr(e.steepestSegmentLengthKm)}`)}</span>`:"",e.steepestSegmentLengthKm!=null&&e.steepestSegmentGradient!=null?`<span class="race-sim-stage-points-meta-pill is-steepest">${ne(Ci(e.steepestSegmentGradient))}</span>`:""].filter(r=>r.length>0);return`
    ...
    </span>`}function km(e,t,a,r=null){const s=r??yn(e,t,a);return s.length===0?`
      <section class="race-sim-mountain-primes-box">
        <h4>Etappenwertungen${_i(e)}</h4>
    ...
    </section>`}function $m(e,t,a,r,s,n=new Set){var f,g;const i=yn(a,r,s),l=bn(i),c=Yr(a,a.pointsStandings,l,"points"),o=Yr(a,a.mountainStandings,l,"mountain"),m=Pi(s,((f=a.gcStandings[0])==null?void 0:f.riderId)??null),p=Pi(s,((g=a.youthStandings[0])==null?void 0:g.riderId)??null),u=h=>!n.has(h);e.innerHTML=`
    ${Xt("Stage Favorites",am(t,a.gcStandings,a.classificationLeaders),"race-sim-favorites-section","favorites",u("favorites"))}
    <section class="race-sim-classifications-section">
      ...
      ${Xt("Punktewertung",yr("Punktewertung","points",a,c,Ei),"race-sim-overview-classification race-sim-overview-points","points",u("points"))}
      ${Xt("Bergwertung",yr("Bergwertung","mountain",a,o,Ei),"race-sim-overview-classification race-sim-overview-mountain","mountain",u("mountain"))}
    ...
    ${Xt("Etappenwertungen",km(a,r,s,i),"race-sim-overview-stage-scoring","stageScoring",u("stageScoring"))}
  `}const Ai=new WeakMap,ht=new WeakMap,Bi=new WeakMap,nl=new Intl.NumberFormat("de-DE",{minimumFractionDigits:0,maximumFractionDigits:2});function se(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function il(e){return e<=0?"—":`+${Math.round(e)} m`}function za(e){const t=nl.format(e);return e>0?`+${t}`:t}function Cs(e){return e<=0?"0,0":`-${e.toFixed(1).replace(".",",")}`}function ye(e){return nl.format(e)}function Yt(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/3600),r=Math.floor(t%3600/60),s=t%60;return`${String(a).padStart(2,"0")}:${String(r).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function ol(e){return`+${Yt(e)}`}function ll(e){if(e<=0)return"—";const t=Math.floor(e/60),a=e%60;return t>0?`+${t}:${String(a).padStart(2,"0")}`:`+${a}s`}function vn(e){return`${(e*3.6).toFixed(1)} km/h`}function xm(e){return`${za(e)}%`}function Os(e){return`${e.toFixed(1).replace(".",",")} km`}function dl(e){return`${Os(e.segmentStartKm)} - ${Os(e.segmentEndKm)}`}function Tm(e){return`${Math.round(e.segmentStartElevation)} - ${Math.round(e.segmentEndElevation)} m`}function cl(e){return e.replace(/_/g," ")}function ul(e){return cl(e)}function wm(e){return cl(e)}function ml(e){return e.effectiveSkill>e.baseSkill?"race-sim-skill-effective-good":e.effectiveSkill<e.baseSkill?"race-sim-skill-effective-bad":"race-sim-skill-effective-equal"}function Mm(e){return e>10?"race-sim-slope-climb-hard":e>3?"race-sim-slope-climb-light":e<-10?"race-sim-slope-descent-hard":e<-3?"race-sim-slope-descent-light":""}function Rm(e){var t;return((t=e.country)==null?void 0:t.code3)??e.nationality}function pl(e){return yt(e.stageSummary).filter(({marker:t})=>t.type==="sprint_intermediate"||Gt(t)).map(({key:t,label:a})=>({key:t,label:a}))}function Im(e){return new Map(e.markerClassifications.map(t=>[t.markerKey,new Map(t.entries.map(a=>[a.riderId,a.rank]))]))}function Cm(e,t,a,r){var s;return a!=="ITT"&&a!=="TTT"?((s=r.get(t))==null?void 0:s.get(e.riderId))??null:e.splitTimes[t]??null}function gl(e,t,a){return[{label:"Pos",width:"50px",className:"race-sim-col-rank",sortKey:"gap"},{label:"Flag",width:"40px",className:"race-sim-col-flag"},{label:"Fahrer",width:"196px",className:"race-sim-col-name",sortKey:"name"},{label:"Jersey",displayLabel:"Jer",width:"46px",className:"race-sim-col-team-visual",sortKey:"team"},{label:"Team",width:"58px",className:"race-sim-col-team",sortKey:"team"},{label:"Gap",width:"72px",sortKey:"gap"},{label:"Eff.",width:"74px",sortKey:"effectiveSkill"},{label:"GC",width:"52px",sortKey:"gcRank"},{label:"GC Gap",width:"70px",sortKey:"gcGap"},{label:"Uhr",width:"96px",sortKey:"clock"},...a?t.map(s=>({label:s.key,displayLabel:s.label,width:"92px",className:"race-sim-col-split",sortKey:`split:${s.key}`})):[],{label:"Aktive Segment-Steigung",displayLabel:"Grad",width:"72px",sortKey:"gradientPercent"},{label:"Speed",width:"82px",sortKey:"speed"},{label:"Sonderform",displayLabel:"",width:"28px",className:"race-sim-col-form-state",sortKey:"specialForm"}]}function Fm(e){return e.map(t=>`${t.label}:${t.width}:${t.className??""}`).join("|")}function Em(e,t){return`${e}|${t.autoSort?"auto":"manual"}|${t.showSplitColumns?"splits":"no-splits"}|${t.manualSortKey??""}|${t.manualSortDirection}`}function fl(e){const t=Ai.get(e);if(t)return t;const a=pl(e),r={splitMarkers:a,columns:gl(e,a,!1),riderById:new Map(e.riders.map(s=>[s.id,s])),teamById:new Map((e.teams??[]).map(s=>[s.id,s])),teamAbbreviationById:new Map((e.teams??[]).map(s=>[s.id,s.abbreviation])),teamNameById:new Map((e.teams??[]).map(s=>[s.id,s.name])),gcByRiderId:new Map((e.gcStandings??[]).map(s=>[s.riderId,s]))};return Ai.set(e,r),r}function hl(e,t){const a=e.parentElement,r=a==null?void 0:a.querySelector(".race-sim-leaderboard-head");if(!a||!r)return"";const s=a.querySelector(".race-sim-leaderboard-toolbar")??(()=>{const o=document.createElement("div");return o.className="race-sim-leaderboard-toolbar",r.insertAdjacentElement("beforebegin",o),o})(),n=Sn(e),i=Fm(t),l=Em(i,n),c=ht.get(e);return(c==null?void 0:c.layoutKey)===l||(a.style.setProperty("--race-sim-leaderboard-columns",t.map(o=>o.width).join(" ")),s.innerHTML=`
    <button
      type="button"
    ...
    >Auto-Sort ${n.autoSort?"AN":"AUS"}</button>`,r.innerHTML=t.map(o=>Pm(o,n)).join(""),ht.set(e,{layoutKey:l,orderedRiderIds:(c==null?void 0:c.orderedRiderIds)??[],rowsByRiderId:(c==null?void 0:c.rowsByRiderId)??new Map,openDetailRiderId:(c==null?void 0:c.openDetailRiderId)??null,openTeamId:(c==null?void 0:c.openTeamId)??null})),l}function St(e,t){e.textContent!==t&&(e.textContent=t)}function Sr(e,t){e.title!==t&&(e.title=t)}function kr(e,t){e.className!==t&&(e.className=t)}function $r(e,t,a){return e.lastValues[t]!==a}function xr(e,t,a){e.lastValues[t]=a}function Sn(e){const t=Bi.get(e);if(t)return t;const a={autoSort:!0,showSplitColumns:!1,manualSortKey:null,manualSortDirection:"asc",frozenOrder:[]};return Bi.set(e,a),a}function Pm(e,t){const a=e.displayLabel??e.label;if(!e.sortKey)return`<span class="${e.className??""}" title="${se(e.label)}">${se(a)}</span>`;const r=!t.autoSort&&t.manualSortKey===e.sortKey,s=r?t.manualSortDirection==="asc"?" ▲":" ▼":"";return`
    <button
      type="button"
      ...
      ${t.autoSort?"disabled":""}
    >${se(a)}<span class="race-sim-leaderboard-sort-indicator">${se(s)}</span></button>`}function Nm(e){return e==="name"||e==="team"||e==="terrainSkill"||e==="clock"||e==="gap"||e==="gcRank"||e==="gcGap"||e.startsWith("split:")?"asc":"desc"}function Lm(e,t){return e==null&&t==null?0:e==null?1:t==null?-1:typeof e=="number"&&typeof t=="number"?e-t:String(e).localeCompare(String(t),"de")}function Hi(e,t,a,r,s,n,i){if(r.autoSort)return(c,o)=>e.stage.profile==="ITT"?bl(c,o,t):Bm(c,o);if(!r.manualSortKey)return null;const l=r.manualSortDirection==="asc"?1:-1;return(c,o)=>{if(Ge(c)!==Ge(o))return Ge(c)?1:-1;const m=s.get(c.riderId)??null,p=s.get(o.riderId)??null,u=zi(c,m,r.manualSortKey??"",e,a,n,i),f=zi(o,p,r.manualSortKey??"",e,a,n,i);return Lm(u,f)*l||c.riderId-o.riderId}}function Dm(e,t,a){if(e.length!==t.size)return!1;let r=null;for(const s of e){const n=t.get(s);if(!n||r&&a(r,n)>0)return!1;r=n}return!0}function zi(e,t,a,r,s,n,i){const l=r.race.isStageRace&&r.stage.stageNumber>1?n.get(e.riderId)??null:null;switch(a){case"name":return e.riderName;case"team":return(t==null?void 0:t.activeTeamId)!=null?i.get(t.activeTeamId)??"":null;case"gap":return e.gapToLeaderMeters;case"clock":return r.stage.profile==="ITT"?e.riderClockSeconds??(e.hasStarted?null:e.startOffsetSeconds):e.finishTimeSeconds;case"terrainSkill":return`${e.activeTerrain}-${e.skillName}`;case"baseSkill":return e.baseSkill;case"effectiveSkill":return e.effectiveSkill;case"teamBonus":return e.teamGroupBonus;case"seasonForm":return(t==null?void 0:t.formBonus)??0;case"raceForm":return(t==null?void 0:t.raceFormBonus)??0;case"fatigue":return(t==null?void 0:t.fatigueMalus)??0;case"staminaPenalty":return e.staminaPenalty;case"elevationPenalty":return e.elevationPenalty;case"dailyForm":return e.dailyForm;case"microForm":return e.microForm;case"gcRank":return(l==null?void 0:l.rank)??null;case"gcGap":return(l==null?void 0:l.gapSeconds)??null;case"gradientPercent":return e.gradientPercent;case"gradientModifier":return e.gradientModifier;case"windModifier":return e.windModifier;case"draftModifier":return e.draftModifier;case"speed":return e.currentSpeedMps;case"specialForm":return e.hasSuperform?1:e.hasSupermalus?-1:0;default:return a.startsWith("split:")?Cm(e,a.slice(6),r.stage.profile,s):null}}function _m(e,t,a,r,s,n,i,l,c){if(!s.manualSortKey){if(s.autoSort){const u=Hi(t,a,r,s,n,i,l);return u?[...e].sort(u):[...e]}const p=new Map(s.frozenOrder.map((u,f)=>[u,f]));return[...e].sort((u,f)=>(Ge(u)===Ge(f)?0:Ge(u)?1:-1)||(p.get(u.riderId)??Number.MAX_SAFE_INTEGER)-(p.get(f.riderId)??Number.MAX_SAFE_INTEGER)||u.riderId-f.riderId)}const o=Hi(t,a,r,s,n,i,l);if(!o)return[...e];const m=new Map(e.map(p=>[p.riderId,p]));return Dm(c,m,o)?c.map(p=>m.get(p)).filter(p=>p!=null):[...e].sort(o)}function Am(e,t){var o;const a=t.closest("button[data-race-sim-ttt-team-toggle]");if(a){const m=Number(a.dataset.raceSimTttTeamToggle);if(!Number.isFinite(m))return!1;const p=ht.get(e);return p?(p.openTeamId=p.openTeamId===m?null:m,p.openTeamId==null&&(p.openDetailRiderId=null),!0):!1}const r=t.closest("button[data-race-sim-rider-toggle]");if(r){const m=Number(r.dataset.raceSimRiderToggle);if(!Number.isFinite(m))return!1;const p=ht.get(e);return p?(p.openDetailRiderId=p.openDetailRiderId===m?null:m,!0):!1}const s=Sn(e);if(t.closest("button[data-race-sim-splits-toggle]"))return s.showSplitColumns=!s.showSplitColumns,!s.showSplitColumns&&((o=s.manualSortKey)!=null&&o.startsWith("split:"))&&(s.manualSortKey=null,s.manualSortDirection="asc"),!0;if(t.closest("button[data-race-sim-auto-sort]"))return s.autoSort=!s.autoSort,s.autoSort?(s.manualSortKey=null,s.frozenOrder=[]):(s.manualSortKey=null,s.manualSortDirection="asc",s.frozenOrder=Array.from(e.querySelectorAll("[data-race-sim-rider-row]")).map(m=>Number(m.dataset.raceSimRiderRow)).filter(m=>Number.isFinite(m))),!0;const l=t.closest("button[data-race-sim-sort-key]");if(!l||s.autoSort)return!1;const c=l.dataset.raceSimSortKey;return c?(s.manualSortKey===c?s.manualSortDirection=s.manualSortDirection==="asc"?"desc":"asc":(s.manualSortKey=c,s.manualSortDirection=Nm(c)),s.frozenOrder=[],!0):!1}function Gi(e,t){return t.some(a=>e.splitTimes[a.key]!=null)}function Ge(e){return e.finishStatus==="dnf"}function bl(e,t,a){if(Ge(e)!==Ge(t))return Ge(e)?1:-1;if(e.finishTimeSeconds!=null&&t.finishTimeSeconds!=null)return(e.riderClockSeconds??e.finishTimeSeconds??Number.POSITIVE_INFINITY)-(t.riderClockSeconds??t.finishTimeSeconds??Number.POSITIVE_INFINITY)||e.riderId-t.riderId;if(e.finishTimeSeconds!=null)return-1;if(t.finishTimeSeconds!=null)return 1;for(let l=a.length-1;l>=0;l-=1){const c=a[l];if(!c)continue;const o=e.splitTimes[c.key],m=t.splitTimes[c.key];if(o!=null&&m!=null&&o!==m)return o-m;if(o!=null&&m==null)return-1;if(o==null&&m!=null)return 1}const r=Gi(e,a),s=Gi(t,a);if(r!==s)return r?-1:1;const n=e.riderClockSeconds,i=t.riderClockSeconds;return n!=null&&i!=null&&n!==i?n-i:n!=null&&i==null?-1:n==null&&i!=null?1:e.startOffsetSeconds-t.startOffsetSeconds||e.riderId-t.riderId}function Bm(e,t){return Ge(e)!==Ge(t)?Ge(e)?1:-1:e.isFinished!==t.isFinished?e.isFinished?-1:1:e.isFinished&&t.isFinished?(e.finishTimeSeconds??Number.POSITIVE_INFINITY)-(t.finishTimeSeconds??Number.POSITIVE_INFINITY)||e.riderId-t.riderId:e.gapToLeaderMeters-t.gapToLeaderMeters||e.riderId-t.riderId}function yl(e,t){const a=(t==null?void 0:t.formBonus)??0,r=(t==null?void 0:t.raceFormBonus)??0,s=((t==null?void 0:t.fatigueMalus)??0)*.5,n=((t==null?void 0:t.longTermFatigueMalus)??0)*.5,i=((t==null?void 0:t.shortTermFatigueMalus)??0)*.5,l=e.teamGroupBonus,c=Math.max(-2.5,Math.min(2.5,e.microForm*2.5)),o=e.isAttacking?10:0,m=e.baseSkill+o+a+r+e.dailyForm+e.microForm+l-s-n-i,p=Math.max(0,m-e.staminaPenalty),u=m-p,f=p-e.effectiveSkill;return[`Basis ${ye(e.baseSkill)}`,e.isAttacking?`+ Attacke ${ye(o)}`:null,`+ S-Form ${ye(a)}`,`+ R-Form ${ye(r)}`,`+ T-Form ${ye(e.dailyForm)}`,`+ Zufällige Form ${ye(c)} (skaliert)`,`+ Teambonus ${ye(l)}`,`- Fatigue ${ye(s)}`,`- Langzeit ${ye(n)}`,`- Akut ${ye(i)}`,`- Stamina ${ye(u)}`,`- HM ${ye(f)}`,`= Effektiv ${ye(e.effectiveSkill)}`].filter(g=>g!=null)}function Hm(e,t){return yl(e,t).join(`
`)}function zm(e){return za(Math.max(-2.5,Math.min(2.5,e*2.5)))}function Gm(e){return e.draftNearbyRiderCount<=0||e.draftModifier<=1?"—":`${e.draftNearbyRiderCount} · x${e.draftPackFactor.toFixed(2).replace(".",",")}`}function vl(e,t){const a=["race-sim-row-name-btn"];return e.isAttacking&&a.push("is-attacking"),e.isBreakaway&&a.push("is-breakaway"),`<button type="button" class="${a.join(" ")}" data-race-sim-rider-toggle="${e.riderId}" aria-expanded="${t?"true":"false"}" title="${se(e.riderName)}">${se(e.riderName)}</button>`}function Km(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId)??"—",s=a.get(e.activeTeamId)??r;return`<span class="race-sim-team-code" title="${se(s)}">${se(r)}</span>`}function Sl(e){return`/jersey/Jer_${e}.png`}function Om(e,t,a){if((e==null?void 0:e.activeTeamId)==null)return"—";const r=t.get(e.activeTeamId);if(!r)return"—";const s=a.get(e.activeTeamId)??r.name,n=Sl(e.activeTeamId);return`
    <span class="race-sim-team-visual" title="${se(s)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function jm(e){return e.hasSuperform?'<span class="race-sim-special-form-dot race-sim-special-form-dot-good" title="Superform"></span>':e.hasSupermalus?'<span class="race-sim-special-form-dot race-sim-special-form-dot-bad" title="Supermalus"></span>':""}function Wm(e,t,a,r){var n;if(a!=="ITT"&&a!=="TTT"){const i=(n=r.get(t))==null?void 0:n.get(e.riderId);return i!=null?`${i}.`:"—"}const s=e.splitTimes[t];return s!=null?Yt(s):"—"}function kl(e,t,a){const r=yl(e,t),s=[{label:"Terrain / Skill",value:`${ul(e.activeTerrain)} / ${wm(e.skillName)}`},{label:"Aktiver Abschnitt",value:dl(e)},{label:"Segmenthöhe",value:Tm(e)},{label:"Basis",value:ye(e.baseSkill)},{label:"Team+",value:e.teamGroupBonus>0?`+${ye(e.teamGroupBonus)}`:"—"},{label:"S-Form",value:za((t==null?void 0:t.formBonus)??0)},{label:"R-Form",value:za((t==null?void 0:t.raceFormBonus)??0)},{label:"Fatigue",value:Cs((t==null?void 0:t.fatigueMalus)??0)},{label:"Langzeit",value:Cs((t==null?void 0:t.longTermFatigueMalus)??0)},{label:"Akut",value:Cs((t==null?void 0:t.shortTermFatigueMalus)??0)},{label:"Stamina",value:ye(e.staminaPenalty)},{label:"HM",value:ye(e.elevationPenalty)},{label:"T-Form",value:za(e.dailyForm)},{label:"Zufall",value:zm(e.microForm)},{label:"M_grad",value:`x${e.gradientModifier.toFixed(2).replace(".",",")}`},{label:"M_wind",value:`x${e.windModifier.toFixed(2).replace(".",",")}`},{label:"Draft",value:`x${e.draftModifier.toFixed(2).replace(".",",")}`},{label:"Draft Pack",value:Gm(e)},{label:"GC",value:a?String(a.rank):"—"},{label:"GC Gap",value:a?ll(a.gapSeconds):"—"}];return`
    ...
    </section>`}function Vm(e,t,a,r,s,n,i){const l=document.createElement("article");l.dataset.raceSimRiderRow=String(e.riderId);const c=document.createElement("div");c.className="race-sim-row-grid",l.appendChild(c);const o=document.createElement("strong");o.className="race-sim-row-rank",o.textContent="0.",c.appendChild(o);const m=document.createElement("span");m.className="race-sim-row-flag",m.innerHTML=t?Dd(Rm(t)):"—",c.appendChild(m);const p=document.createElement("span");p.className="race-sim-row-name",p.innerHTML=vl(e,a),c.appendChild(p);const u=p.querySelector(".race-sim-row-name-btn");if(!u)throw new Error("race-sim-row-name-btn not found");const f=document.createElement("span");f.className="race-sim-row-team-visual",f.innerHTML=Om(t,s,i),c.appendChild(f);const g=document.createElement("strong");g.className="race-sim-row-team",g.innerHTML=Km(t,n,i),c.appendChild(g);const h=(_="")=>{const N=document.createElement("strong");return _&&(N.className=_),c.appendChild(N),N},b=h("race-sim-gap"),y=h("race-sim-cell-effective-skill"),k=h(),T=h(),x=h(),$=r.map(()=>h()),P=h(),E=h(),R=h("race-sim-form-state-cell"),I=document.createElement("div");return I.className="race-sim-row-detail-popover hidden",l.appendChild(I),{row:l,rankField:o,nameButton:u,gapField:b,clockField:x,splitFields:$,effectiveSkillField:y,gcRankField:k,gcGapField:T,gradientPercentField:P,speedField:E,formStateField:R,detailPanel:I,initialized:!1,lastValues:{}}}function Um(e,t,a,r,s,n,i,l,c,o,m){const p=(r==null?void 0:r.formBonus)??0,u=(r==null?void 0:r.raceFormBonus)??0,f=c&&o>1?m.get(a.riderId)??null:null,g=Ge(a),h=i!=="ITT"&&i!=="TTT"?g?"DNF":"—":a.hasStarted?g?"DNF":a.riderClockSeconds!=null?Yt(a.riderClockSeconds):"—":ol(a.startOffsetSeconds);kr(e.row,`race-sim-row${t===1&&!g?" race-sim-row-leader":""}${s?" race-sim-row-detail-open":""}${g?" race-sim-row-dnf":""}`),St(e.rankField,`${t}.`),St(e.gapField,g?"DNF":il(a.gapToLeaderMeters)),St(e.clockField,h),e.nameButton.setAttribute("aria-expanded",s?"true":"false"),kr(e.nameButton,`race-sim-row-name-btn${a.isAttacking?" is-attacking":""}${a.isBreakaway?" is-breakaway":""}`),Sr(e.nameButton,a.isBreakaway?`${a.riderName} (Ausreißer)`:a.isAttacking?`${a.riderName} (Attacke aktiv)`:a.riderName),n.forEach((T,x)=>{const $=e.splitFields[x];if(!$)return;const P=Wm(a,T.key,i,l);St($,P),Sr($,T.label)}),$r(e,"effectiveSkillValue",a.effectiveSkill)&&(St(e.effectiveSkillField,ye(a.effectiveSkill)),xr(e,"effectiveSkillValue",a.effectiveSkill));const b=`race-sim-cell-effective-skill ${ml(a)}`;$r(e,"effectiveSkillClass",b)&&(kr(e.effectiveSkillField,b),xr(e,"effectiveSkillClass",b));const y=[a.baseSkill,a.effectiveSkill,a.teamGroupBonus,p,u,a.dailyForm,a.microForm,(r==null?void 0:r.fatigueMalus)??0,(r==null?void 0:r.longTermFatigueMalus)??0,(r==null?void 0:r.shortTermFatigueMalus)??0,a.staminaPenalty].join("|");$r(e,"effectiveSkillTitleKey",y)&&(Sr(e.effectiveSkillField,Hm(a,r)),xr(e,"effectiveSkillTitleKey",y)),St(e.gcRankField,f?String(f.rank):"—"),St(e.gcGapField,f?ll(f.gapSeconds):"—"),St(e.gradientPercentField,xm(a.gradientPercent)),kr(e.gradientPercentField,Mm(a.gradientPercent)),Sr(e.gradientPercentField,`${ul(a.activeTerrain)} · ${dl(a)}`),St(e.speedField,vn(a.currentSpeedMps)),e.formStateField.innerHTML=jm(a);const k=[s?"open":"closed",a.activeTerrain,a.segmentStartKm,a.segmentEndKm,a.segmentStartElevation,a.segmentEndElevation,a.skillName,a.baseSkill,a.teamGroupBonus,p,u,(r==null?void 0:r.fatigueMalus)??0,a.staminaPenalty,a.elevationPenalty,a.dailyForm,a.microForm,a.gradientModifier,a.windModifier,a.draftModifier,a.draftNearbyRiderCount,a.draftPackFactor,(f==null?void 0:f.rank)??"—",(f==null?void 0:f.gapSeconds)??"—",a.skillBreakdown].join("|");$r(e,"detailKey",k)&&(e.detailPanel.innerHTML=s?kl(a,r,f):"",e.detailPanel.classList.toggle("hidden",!s),xr(e,"detailKey",k)),e.detailPanel.classList.toggle("hidden",!s),e.initialized=!0}function Ym(e,t){return`<button type="button" class="race-sim-row-name-btn" data-race-sim-ttt-team-toggle="${e.id}" aria-expanded="${t?"true":"false"}" title="${se(e.name)}">${se(e.name)}</button>`}function Zm(e){const t=Sl(e.id);return`
    <span class="race-sim-team-visual" title="${se(e.name)}">
      <img
        ...
        onerror="this.onerror=null;this.src='/jersey/Jer_placeholder.svg';"
      >
    </span>`}function Jm(e,t,a){const r=new Map;for(const s of e.riders){const n=a.get(s.riderId),i=n==null?void 0:n.activeTeamId;if(i==null)continue;const l=r.get(i)??[];l.push(s),r.set(i,l)}return t.teams.filter(s=>r.has(s.id)).map(s=>{const n=(r.get(s.id)??[]).slice().sort((m,p)=>p.effectiveSkill-m.effectiveSkill||m.riderId-p.riderId),i=n[0]??e.riders[0],l=Math.min(5,n.length),c=n.slice(0,l).reduce((m,p)=>m+p.effectiveSkill,0)/Math.max(l,1),o=Math.max(0,8-n.length);return{team:s,riders:n,representative:i,teamClockSeconds:(i==null?void 0:i.riderClockSeconds)??null,teamDistanceMeters:(i==null?void 0:i.distanceCoveredMeters)??0,teamEffectiveSkill:Math.max(1,c-o),teamSpeedMps:(i==null?void 0:i.currentSpeedMps)??0,splitTimes:(i==null?void 0:i.splitTimes)??{},finishedRiders:n.filter(m=>m.isFinished).length}}).sort((s,n)=>bl(s.representative,n.representative,pl(t))||s.team.id-n.team.id)}function qm(e,t,a,r,s){return`
    <section class="race-sim-rider-detail-panel" aria-label="Teamdetails ${se(e.team.name)}">
      ...
      <div class="race-sim-rider-detail-grid">
        ...
        <div class="race-sim-rider-detail-item"><span>Speed</span><strong>${se(vn(e.teamSpeedMps))}</strong></div>
      ...
      <article class="race-sim-row${b===0?" race-sim-row-leader":""}${y?" race-sim-row-detail-open":""}">
        <div class="race-sim-row-grid">
          ...
          <span class="race-sim-row-name">${Ym(h.team,y)}</span>
          <span class="race-sim-row-team-visual">${Zm(h.team)}</span>
          <strong class="race-sim-row-team"><span class="race-sim-team-code" title="${se(h.team.name)}">${se(h.team.abbreviation)}</span></strong>
          <strong class="race-sim-gap">${se(il(Math.max(0,p-h.teamDistanceMeters)))}</strong>
          <strong>${se(h.teamClockSeconds!=null?Yt(h.teamClockSeconds):ol(h.representative.startOffsetSeconds))}</strong>
          ${n.map(k=>`<strong>${se(h.splitTimes[k.key]!=null?Yt(h.splitTimes[k.key]):"—")}</strong>`).join("")}
          <strong class="race-sim-cell-effective-skill ${ml(h.representative)}">${se(ye(h.teamEffectiveSkill))}</strong>
          <strong>${se(vn(h.teamSpeedMps))}</strong>
        </div>
        <div class="race-sim-row-detail-popover${y?"":" hidden"}">${y?qm(h,s,a.race.isStageRace,a.stage.stageNumber,o.openDetailRiderId):""}</div>
      </article>`}).join(""),ht.set(e,{layoutKey:c,orderedRiderIds:[],rowsByRiderId:new Map,openDetailRiderId:o.openDetailRiderId,openTeamId:o.openTeamId}),{totalMs:performance.now()-r,prepMs:0,sortMs:0,layoutMs:0,createRowsMs:0,removeRowsMs:0,orderCheckMs:0,reorderMs:0,visibilityMs:0,updateRowsMs:0,finalizeMs:0,rowsTotal:m.length,rowsCreated:m.length,rowsRemoved:0,rowsUpdated:m.length,rowsSkippedInvisible:0,orderChanged:1}}function Ki(e,t,a){if(a.stage.profile==="TTT")return Xm(e,t,a);const r=performance.now(),s={totalMs:0,prepMs:0,sortMs:0,layoutMs:0,createRowsMs:0,removeRowsMs:0,orderCheckMs:0,reorderMs:0,visibilityMs:0,updateRowsMs:0,finalizeMs:0,rowsTotal:t.riders.length,rowsCreated:0,rowsRemoved:0,rowsUpdated:0,rowsSkippedInvisible:0,orderChanged:0},n=performance.now(),i=fl(a),{splitMarkers:l}=i,c=Im(t),o=Sn(e),m=o.showSplitColumns?l:[],p=ht.get(e);s.prepMs=performance.now()-n;const u=performance.now(),f=_m(t.riders,a,l,c,o,i.riderById,i.gcByRiderId,i.teamAbbreviationById,(p==null?void 0:p.orderedRiderIds)??[]);s.sortMs=performance.now()-u;const g=p==null?void 0:p.layoutKey,h=performance.now(),b=hl(e,gl(a,m,o.showSplitColumns));s.layoutMs=performance.now()-h;const y=ht.get(e)??{orderedRiderIds:[],rowsByRiderId:new Map,openDetailRiderId:null,openTeamId:null};g!=null&&g!==b&&(e.innerHTML="",y.rowsByRiderId.clear(),y.orderedRiderIds=[]);const k=f.map(I=>I.riderId),T=new Set(k),x=performance.now();for(const[I,_]of y.rowsByRiderId)T.has(I)||(_.row.remove(),y.rowsByRiderId.delete(I),s.rowsRemoved+=1);s.removeRowsMs=performance.now()-x;const $=performance.now();for(let I=0;I<f.length;I+=1){const _=f[I],N=i.riderById.get(_.riderId)??null;let L=y.rowsByRiderId.get(_.riderId);L||(L=Vm(_,N,y.openDetailRiderId===_.riderId,m,i.teamById,i.teamAbbreviationById,i.teamNameById),y.rowsByRiderId.set(_.riderId,L),s.rowsCreated+=1)}s.createRowsMs=performance.now()-$;const P=performance.now(),E=y.orderedRiderIds.length===k.length&&y.orderedRiderIds.every((I,_)=>I===k[_]);s.orderCheckMs=performance.now()-P;const R=performance.now();if(!E){const I=document.createDocumentFragment();for(const _ of k){const N=y.rowsByRiderId.get(_);N&&I.appendChild(N.row)}e.replaceChildren(I),s.orderChanged=1}s.reorderMs=performance.now()-R;for(let I=0;I<f.length;I+=1){const _=f[I],N=y.rowsByRiderId.get(_.riderId),L=i.riderById.get(_.riderId)??null;if(!N)continue;const G=performance.now();Um(N,I+1,_,L,y.openDetailRiderId===_.riderId,m,a.stage.profile,c,a.race.isStageRace,a.stage.stageNumber,i.gcByRiderId),s.updateRowsMs+=performance.now()-G,s.rowsUpdated+=1}return ht.set(e,{layoutKey:b,orderedRiderIds:k,rowsByRiderId:y.rowsByRiderId,openDetailRiderId:y.openDetailRiderId,openTeamId:y.openTeamId}),s.finalizeMs=performance.now()-(r+s.prepMs+s.sortMs+s.layoutMs+s.removeRowsMs+s.createRowsMs+s.orderCheckMs+s.reorderMs+s.visibilityMs+s.updateRowsMs),s.totalMs=performance.now()-r,s.finalizeMs=Math.max(0,s.totalMs-s.prepMs-s.sortMs-s.layoutMs-s.removeRowsMs-s.createRowsMs-s.orderCheckMs-s.reorderMs-s.visibilityMs-s.updateRowsMs),s}const Qm=["Flat","Rolling","Hilly","Hilly_Difficult","Medium_Mountain","Mountain","High_Mountain","ITT","TTT","Cobble","Cobble_Hill"],ep=["Flat","Hill","Medium_Mountain","Mountain","High_Mountain","Cobble","Cobble_Hill","Abfahrt","Sprint"],$l=["start","climb_start","climb_top","sprint_intermediate","finish_flat","finish_TT","finish_hill","finish_mountain"],xl=["Sprint","4","3","2","1","HC"],Jr=.2,tp=7,ap=100,rp=3,sp=50,np=-2,ip=1,op=2.5,lp=-3,dp=15,cp=200,up=600,mp=850;function Ze(e){return["finish_flat","finish_TT","finish_hill","finish_mountain"].includes(e)}function qr(e){return e==="finish_hill"||e==="finish_mountain"}function Xr(e){return e!=null&&["HC","1","2","3","4"].includes(e)}function ms(e,t){return e==="climb_top"||qr(e)&&Xr(t)}function tr(e){return Math.round(e*10)/10}function Ke(e){return Number(e.toFixed(2))}function _t(e){return`${e.toFixed(2).replace(".",",")} km`}function Tl(e){return`${Math.round(e)} hm`}function pp(e){return e.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").slice(0,60)||"stage_details"}function kn(e){return Qm.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`).join("")}function gp(e){return ep.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`).join("")}function fp(e,t="start",a=0,r=1){const s=$l.filter(i=>t==="start"?i==="start"?a===0:i==="climb_start":i==="start"||i==="climb_start"?!1:Ze(i)?a===r-1:i==="climb_top"||i==="sprint_intermediate");return(s.includes(e)?s:[e,...s.filter(i=>i!==e)]).map(i=>`<option value="${i}"${i===e?" selected":""}>${S(i)}</option>`).join("")}function hp(e){return['<option value="">–</option>',...xl.map(t=>`<option value="${t}"${t===e?" selected":""}>${S(t)}</option>`)].join("")}function Oi(e){return $l.indexOf(e)}function ot(e){return[...e].sort((t,a)=>Oi(t.type)-Oi(a.type))}function Va(e){if(e.length===0)return[];const t=[{kmMark:0,elevation:e[0].startElevation,terrain:e[0].terrain,techLevel:e[0].techLevel,windExp:e[0].windExp,markers:ot(e[0].markers)}];let a=0;return e.forEach(r=>{a=Ke(a+r.lengthKm);const s=Math.round(r.startElevation+r.lengthKm*1e3*(r.gradientPercent/100)),n=t[t.length-1];n.terrain=r.terrain,n.techLevel=r.techLevel,n.windExp=r.windExp,n.markers=ot([...n.markers,...r.markers]),t.push({kmMark:a,elevation:s,terrain:r.terrain,techLevel:r.techLevel,windExp:r.windExp,markers:ot(r.endMarkers)})}),t}function bp(e){return e?" stage-editor-input-invalid":""}function $n(e,t){const a=e.segments[t];if(!a)return[];const r=[],s=yp(e).get(t)??[];return a.lengthKm<Jr&&r.push(`Laenge unter ${Jr.toFixed(1).replace(".",",")} km.`),(a.techLevel<1||a.techLevel>10)&&r.push("Tech ausserhalb 1-10."),(a.windExp<1||a.windExp>10)&&r.push("Wind ausserhalb 1-10."),t===0&&!a.markers.some(n=>n.type==="start")&&r.push("Startmarker fehlt am ersten Segment."),t<e.segments.length-1&&a.endMarkers.some(n=>Ze(n.type))&&r.push("Finish nur am Endmarker des letzten Segments."),t>0&&a.markers.some(n=>n.type==="start")&&r.push("Startmarker nur am ersten Segment erlaubt."),t===e.segments.length-1&&!a.endMarkers.some(n=>Ze(n.type))&&r.push("Finishmarker fehlt am letzten Segmentende."),a.markers.forEach(n=>{Ze(n.type)&&r.push("Finishmarker gehoert in den Endmarker-Slot."),n.type==="climb_top"&&r.push("climb_top gehoert in den Endmarker-Slot."),n.type==="sprint_intermediate"&&r.push("Sprintmarker gehoert in den Endmarker-Slot.")}),a.endMarkers.forEach(n=>{(n.type==="start"||n.type==="climb_start")&&r.push(`${n.type} gehoert in den Startmarker-Slot.`),ms(n.type,n.cat)&&!Xr(n.cat)&&r.push(`${n.type} braucht Kategorie HC oder 1-4.`)}),[...a.markers,...a.endMarkers].forEach(n=>{n.type==="sprint_intermediate"&&n.cat!=null&&n.cat!=="Sprint"&&r.push("Sprintmarker erlaubt nur Kategorie Sprint."),Ze(n.type)&&!qr(n.type)&&n.cat!=null&&r.push("finish_flat und finish_TT duerfen keine Kategorie haben."),qr(n.type)&&n.cat!=null&&!Xr(n.cat)&&r.push(`${n.type} erlaubt nur Kategorie HC oder 1-4.`)}),r.push(...s),[...new Set(r)]}function yp(e){const t=new Map,a=[],r=(s,n)=>{const i=t.get(s)??[];i.push(n),t.set(s,i)};return e.segments.forEach((s,n)=>{s.markers.forEach(i=>{i.type==="climb_start"&&a.push({name:i.name??null,segmentIndex:n})}),s.endMarkers.forEach(i=>{var o;if(!ms(i.type,i.cat))return;if(!i.name){r(n,`${i.type} braucht einen Namen fuer die Paarbildung.`);return}let l=-1;for(let m=a.length-1;m>=0;m-=1)if(((o=a[m])==null?void 0:o.name)===i.name){l=m;break}const c=l>=0?l:a.length-1;if(c<0){r(n,`${i.type} "${i.name}" braucht einen vorherigen climb_start.`);return}a.splice(c,1)})}),a.forEach(s=>{const n=s.name?` "${s.name}"`:"";r(s.segmentIndex,`climb_start${n} braucht einen spaeteren climb_top oder kategorisierten finish_hill/finish_mountain.`)}),t}function vp(e){return e.type==="climb_top"?{...e,cat:e.cat&&["HC","1","2","3","4"].includes(e.cat)?e.cat:"4"}:qr(e.type)?{...e,cat:Xr(e.cat)?e.cat:null}:e.type==="sprint_intermediate"?{...e,cat:e.cat==="Sprint"?e.cat:"Sprint"}:{...e,cat:null}}function wl(e){var a;const t={...e,segments:((a=e.segments)!=null&&a.length?e.segments:Sp(e.waypoints??[])).map(r=>({...r,startElevation:Math.round(r.startElevation),lengthKm:Number.isFinite(r.lengthKm)?Ke(r.lengthKm):Jr,gradientPercent:Number.isFinite(r.gradientPercent)?tr(r.gradientPercent):0,techLevel:Number.isFinite(r.techLevel)?r.techLevel:5,windExp:Number.isFinite(r.windExp)?r.windExp:5,markers:ji(r.markers),endMarkers:ji(r.endMarkers)})),waypoints:[]};return Kt(t),t}function Sp(e){if(e.length<2)return[];const t=[];for(let a=0;a<e.length-1;a++){const r=e[a],s=e[a+1],n=Ke(s.kmMark-r.kmMark),i=s.elevation-r.elevation,l=tr(n>0?i/(n*10):0);t.push({startElevation:r.elevation,lengthKm:n,gradientPercent:l,techLevel:r.techLevel??5,windExp:r.windExp??5,terrain:r.terrain??"Flat",markers:r.markers??[],endMarkers:s.markers??[]})}return t}function ji(e){return e?e.map(t=>({type:t.type,name:t.name??null,cat:t.cat??null})):[]}function kp(e,t,a){const r=e*a*8+t/12;return r>=95?"HC":r>=68?"1":r>=46?"2":r>=28?"3":"4"}function Wi(e){const t=[];let a=null,r=null,s=0;const n=i=>{if(a==null||i==null||i<=a){a=null,r=null,s=0;return}const l=e[a],c=e[i],o=c.kmMark-l.kmMark,m=Math.max(0,c.elevation-l.elevation),p=o>0?m/(o*10):0;m>=ap&&p>=rp&&t.push({startKm:Ke(l.kmMark),endKm:Ke(c.kmMark),distanceKm:Ke(o),gainMeters:Math.round(m),avgGradient:tr(p),category:kp(o,m,p),startIndex:a,topIndex:i,topElevation:Math.round(c.elevation)}),a=null,r=null,s=0};for(let i=1;i<e.length;i+=1){const l=e[i-1],c=e[i],o=c.elevation-l.elevation;if(a==null&&o>0){a=i-1,r=i,s=0;continue}if(a!=null){if(o>=0){(r==null||c.elevation>=e[r].elevation)&&(r=i),s=0;continue}s+=Math.abs(o),s>=sp&&n(r)}}return n(r),t}function $p(e){const t=e.segments.some(s=>s.terrain==="Cobble_Hill"),a=e.segments.some(s=>s.terrain==="Cobble"),r=e.climbs.some(s=>s.category==="HC"||s.category==="1");return t?"Cobble_Hill":a?"Cobble":e.totalDistanceKm<=25&&e.elevationGainMeters<250?"ITT":r&&e.elevationGainMeters>=2800?"High_Mountain":r||e.elevationGainMeters>=1800?"Mountain":e.elevationGainMeters>=1100?"Medium_Mountain":e.elevationGainMeters>=700?"Hilly":e.elevationGainMeters>=350?"Rolling":"Flat"}function Tr(e){return e==="Cobble"||e==="Cobble_Hill"||e==="Sprint"}function xp(e){return e.gainMeters>=up&&e.topElevation>=mp?"Mountain":e.gainMeters>cp?"Medium_Mountain":"Hill"}function Tp(e){return e.gradientPercent<lp?"Abfahrt":e.gradientPercent<op||Math.max(0,e.lengthKm*1e3*(e.gradientPercent/100))<dp?"Flat":"Hill"}function wp(e){if(e.segments.length===0)return;if(e.waypoints=Va(e.segments),e.sourceFormat==="csv"){const i=Wi(e.waypoints);e.climbs=i.map(({startIndex:l,topIndex:c,topElevation:o,...m})=>m);return}const t=e.segments.map(i=>i.manualTerrain||Tr(i.terrain)?i.terrain:Tp(i)),a=Wi(e.waypoints);e.climbs=a.map(({startIndex:i,topIndex:l,topElevation:c,...o})=>o),a.forEach(i=>{const l=xp(i);if(l)for(let c=i.startIndex;c<i.topIndex;c+=1)e.segments[c].manualTerrain||Tr(t[c])||(t[c]=l)});let r=null,s=0;const n=i=>{if(r==null||s<=ip){r=null,s=0;return}for(let l=r;l<i;l+=1)!(e.segments[l].manualTerrain||Tr(t[l]))&&t[l]==="Flat"&&(t[l]="Abfahrt");r=null,s=0};for(let i=0;i<e.segments.length;i+=1){const l=e.segments[i];if(l&&l.gradientPercent<np){r==null&&(r=i),s+=l.lengthKm;continue}n(i)}n(e.segments.length),e.segments.forEach((i,l)=>{Tr(i.terrain)||(i.terrain=t[l])}),e.waypoints=Va(e.segments),e.suggestedProfile=$p(e)}function Kt(e){Mp(e),Vi(e),wp(e),e.waypoints=Va(e.segments),Vi(e)}function Mp(e){if(e.segments.length===0){e.waypoints=[];return}let t=e.segments[0].startElevation;e.segments=e.segments.map((a,r)=>{const s={...a,startElevation:Math.round(r===0?a.startElevation:t),lengthKm:Ke(a.lengthKm),gradientPercent:tr(a.gradientPercent),markers:ot(a.markers),endMarkers:ot(a.endMarkers)};return t=Math.round(s.startElevation+s.lengthKm*1e3*(s.gradientPercent/100)),s}),e.waypoints=Va(e.segments)}function Vi(e){e.totalDistanceKm=Ke(e.segments.reduce((t,a)=>t+a.lengthKm,0)),e.elevationGainMeters=e.waypoints.reduce((t,a,r)=>{if(r===0)return 0;const s=a.elevation-e.waypoints[r-1].elevation;return t+Math.max(0,s)},0)}function Ct(e){const t=e.segments[0],a=e.segments[e.segments.length-1];!t||!a||(t.markers.some(r=>r.type==="start")||(t.markers=ot([{type:"start",name:null,cat:null},...t.markers])),a.endMarkers.some(r=>Ze(r.type))||(a.endMarkers=ot([...a.endMarkers,{type:"finish_flat",name:null,cat:null}])),e.waypoints=Va(e.segments))}function Rp(e,t,a,r){return e.length===0?"":`<div class="stage-editor-marker-list">${e.map((s,n)=>{const i=r==="start"&&t===0&&s.type==="start",l=e.filter(m=>Ze(m.type)).length,c=r==="end"&&t===a-1&&Ze(s.type)&&l===1,o=!(i||c);return`
      <div class="stage-editor-marker-row">
        <select data-field="markerType" data-marker-scope="${r}" data-marker-index="${n}">${fp(s.type,r,t,a)}</select>
        <input type="text" value="${S(s.name??"")}" data-field="markerName" data-marker-scope="${r}" data-marker-index="${n}" placeholder="Name" />
        <select data-field="markerCat" data-marker-scope="${r}" data-marker-index="${n}">${hp(s.cat)}</select>
      ...
      </div>`}).join("")}</div>`}function Ui(e,t,a,r){const s=r==="start"?"Start / Berg+":"Sprint / Berg / Ziel+";return`
    ...
    </div>`}function Ip(e,t,a,r,s){if(!d.stageEditorDraft)return;const n=d.stageEditorDraft.segments[e];if(!n)return;const i=a==="start"?n.markers:n.endMarkers,l=i[t];if(l){if(r==="markerType"){l.type=s;const c=vp(l);if(l.name=c.name,l.cat=c.cat,Ze(l.type)){const o=i.filter((m,p)=>p===t||!Ze(m.type));a==="start"?n.markers=o:n.endMarkers=o}}else r==="markerName"?l.name=s.trim()||null:r==="markerCat"&&(l.cat=s||null);a==="start"?n.markers=ot(n.markers):n.endMarkers=ot(n.endMarkers),Kt(d.stageEditorDraft),Ct(d.stageEditorDraft),ve()}}function Cp(e,t){if(!d.stageEditorDraft)return;const a=d.stageEditorDraft.segments[e];if(!a)return;const r=t==="start"?e===0&&!a.markers.some(s=>s.type==="start")?{type:"start",name:"Start",cat:null}:{type:"climb_start",name:null,cat:null}:e===d.stageEditorDraft.segments.length-1&&!a.endMarkers.some(s=>Ze(s.type))?{type:"finish_flat",name:"Ziel",cat:null}:{type:"sprint_intermediate",name:null,cat:"Sprint"};t==="start"?(a.markers.push(r),a.markers=ot(a.markers)):(a.endMarkers.push(r),a.endMarkers=ot(a.endMarkers)),Kt(d.stageEditorDraft),Ct(d.stageEditorDraft),ve()}function Fp(e,t,a){if(!d.stageEditorDraft)return;const r=d.stageEditorDraft.segments[e];r&&(a==="start"?r.markers.splice(t,1):r.endMarkers.splice(t,1),Kt(d.stageEditorDraft),Ct(d.stageEditorDraft),ve())}let ca=0,ua=0;async function Ep(){v("stage-editor-profile").innerHTML=kn("Flat"),v("stage-editor-chart").innerHTML='<div class="stage-editor-empty">Noch keine Profildaten vorhanden.</div>',v("stage-editor-climbs").innerHTML='<p class="text-muted">Climb-Vorschläge erscheinen nach dem Import.</p>';const[e,t,a]=await Promise.all([Y.listStageEditorCountries(),Y.listStageEditorRaceCategories(),Y.listStageEditorRacePrograms(),wn()]);if(e.success&&e.data){const r=v("stage-editor-race-country");r.innerHTML=e.data.map(s=>`<option value="${s.id}">${S(s.name)} (${S(s.code3)})</option>`).join("")}if(t.success&&t.data){const r=v("stage-editor-race-category");r.innerHTML=t.data.map(s=>`<option value="${s.id}">${S(s.name)}</option>`).join("")}a.success&&a.data&&(d.stageEditorPrograms=a.data,Pp())}function Pp(){const e=v("stage-editor-programs-list");d.stageEditorPrograms&&(e.innerHTML=d.stageEditorPrograms.map(t=>`
    ...
    `).join(""))}function Np(){const e=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked'),t=v("stage-editor-programs-selected-text");if(e.length===0)t.textContent="Keine Programme ausgewählt",t.classList.add("text-muted");else{const a=Array.from(e).map(r=>{var n;const s=(n=d.stageEditorPrograms)==null?void 0:n.find(i=>String(i.id)===r.value);return s?s.name:r.value});t.textContent=`${e.length} ausgewählt: ${a.join(", ")}`,t.classList.remove("text-muted")}}function Lp(e,t){var r;let a=0;for(let s=0;s<t;s+=1)a+=((r=e.segments[s])==null?void 0:r.lengthKm)??0;return Ke(a)}function xn(e){return Math.round(e.startElevation+e.lengthKm*1e3*(e.gradientPercent/100))}function Ml(){const e=d.stageEditorExistingStages.map(t=>t.stageId);return e.length>0?Math.max(...e)+1:1}function Dp(){const e=[...d.stageEditorExistingStages.map(t=>t.raceId),...d.races.map(t=>t.id)];return e.length>0?Math.max(...e)+1:1}function _p(e,t){let a=e;const r=new Set(d.stageEditorExistingStages.map(s=>s.stageId));for(;a>0&&r.has(a);)a+=t;if(a<=0)for(a=1;r.has(a);)a+=1;return a}function Ap(e,t){let a=e;const r=new Set([...d.stageEditorExistingStages.map(s=>s.raceId),...d.races.map(s=>s.id)]);for(;a>0&&r.has(a);)a+=t;if(a<=0)for(a=1;r.has(a);)a+=1;return a}function na(){const e=v("stage-editor-date");if(!e)return;const t=e.value.trim();if(!/^\d{4}-\d{2}-\d{2}$/.test(t))return;const a=document.getElementById("stage-editor-new-race-checkbox");if(!a||!a.checked)return;const r=document.getElementById("stage-editor-race-is-stage-race");if(!r)return;const s=Number(r.value)===1,n=v("stage-editor-race-start-date"),i=v("stage-editor-race-end-date");if(!(!n||!i))if(!s)n.value=t,i.value=t;else{n.value=t;const l=document.getElementById("stage-editor-race-num-stages"),c=l&&Number(l.value)||1,[o,m,p]=t.split("-").map(Number),u=new Date(o,m-1,p);let f=0;c===21?f=2:c>=14&&(f=1);const g=c+f;u.setDate(u.getDate()+g-1);const h=u.getFullYear(),b=String(u.getMonth()+1).padStart(2,"0"),y=String(u.getDate()).padStart(2,"0");i.value=`${h}-${b}-${y}`}}function Bp(e){var l;const t=v("stage-editor-profile");t.innerHTML=kn(e.suggestedProfile),t.value=e.suggestedProfile;const a=Ml(),r=Dp();v("stage-editor-stage-id").value=String(a),v("stage-editor-race-id").value=String(r),ca=a,ua=r;const s=v("stage-editor-details-file");s.value.trim()||(s.value=`${pp(e.routeName)}.csv`);const n=v("stage-editor-date");!n.value&&((l=d.gameState)!=null&&l.currentDate)&&(n.value=d.gameState.currentDate),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(c=>{c.checked=!0}),na()}function Hp(e){v("stage-editor-stage-id").value=String(e.stageId),v("stage-editor-race-id").value=String(e.raceId),ca=e.stageId,ua=e.raceId,v("stage-editor-stage-number").value=String(e.stageNumber),v("stage-editor-date").value=e.date,v("stage-editor-details-file").value=e.detailsCsvFile;const t=v("stage-editor-profile");t.innerHTML=kn(e.profile),t.value=e.profile,v("stage-editor-final-spread-start").value=String(e.finalSpreadStartPercent),v("stage-editor-final-push-start").value=String(e.finalPushStartPercent),v("stage-editor-final-spread-difficulty").value=String(e.finalSpreadDifficultyMultiplier),v("stage-editor-crash-multiplier").value=String(e.crashIncidentMultiplier),v("stage-editor-mechanical-multiplier").value=String(e.mechanicalIncidentMultiplier);const a=(e.allowedWeather||"1|2|3|4|5|6|7").split("|").map(s=>s.trim());document.querySelectorAll('input[name="stage-editor-weather"]').forEach(s=>{s.checked=a.includes(s.value)}),na()}function Rl(e){var r;if(!e)return["Noch keine Strecke importiert."];const t=[];return e.segments.length===0?(t.push("Mindestens ein Segment ist erforderlich."),t):((r=e.segments[0])!=null&&r.markers.some(s=>s.type==="start")||t.push("Das erste Segment muss als Start markiert sein."),(e.segments[e.segments.length-1].endMarkers??[]).some(s=>Ze(s.type))||t.push("Das letzte Segment muss per Endmarker als Ziel markiert sein."),e.segments.forEach((s,n)=>{$n(e,n).forEach(i=>{t.push(`Segment ${n+1}: ${i}`)}),[...s.markers??[],...s.endMarkers??[]].forEach(i=>{i.cat!=null&&!xl.includes(i.cat)&&t.push(`Segment ${n+1}: Ungültige Marker-Kategorie ${i.cat}.`)})}),t)}function Il(){const e=[],t=Number(v("stage-editor-stage-id").value),a=Number(v("stage-editor-race-id").value),r=Number(v("stage-editor-stage-number").value),s=v("stage-editor-date").value.trim(),n=v("stage-editor-details-file").value.trim(),i=Number(v("stage-editor-final-spread-start").value),l=Number(v("stage-editor-final-push-start").value),c=Number(v("stage-editor-final-spread-difficulty").value),o=Number(v("stage-editor-crash-multiplier").value),m=Number(v("stage-editor-mechanical-multiplier").value);(!Number.isInteger(t)||t<=0)&&e.push("Stage-ID fehlt oder ist ungültig."),(!Number.isInteger(a)||a<=0)&&e.push("Race-ID fehlt oder ist ungültig."),(!Number.isInteger(r)||r<=0)&&e.push("Etappennummer fehlt oder ist ungültig."),/^\d{4}-\d{2}-\d{2}$/.test(s)||e.push("Datum muss im Format YYYY-MM-DD vorliegen."),(!/^[A-Za-z0-9_.-]+\.csv$/.test(n)||n.includes("/"))&&e.push("Details-Datei muss ein Dateiname mit .csv-Endung ohne Pfad sein."),(!Number.isFinite(i)||i<0||i>100)&&e.push("Final Spread Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(l)||l<0||l>100)&&e.push("Final Push Start % muss zwischen 0 und 100 liegen."),(!Number.isFinite(c)||c<=0)&&e.push("Final Spread Multiplikator muss groesser als 0 sein."),(!Number.isFinite(o)||o<=0)&&e.push("Sturz-Multiplikator muss groesser als 0 sein."),(!Number.isFinite(m)||m<=0)&&e.push("Defekt-Multiplikator muss groesser als 0 sein."),document.querySelectorAll('input[name="stage-editor-weather"]:checked').length===0&&e.push("Mindestens eine Wetterart muss ausgewählt sein."),d.stageEditorExistingStages.map(b=>b.stageId).includes(t)&&e.push(`Die Stage-ID ${t} existiert bereits in stages.csv.`);const f=v("stage-editor-new-race-checkbox").checked,g=[...d.stageEditorExistingStages.map(b=>b.raceId),...d.races.map(b=>b.id)];if(f){g.includes(a)&&e.push(`Die Race-ID ${a} existiert bereits.`);const b=v("stage-editor-race-name").value.trim(),y=Number(v("stage-editor-race-country").value),k=Number(v("stage-editor-race-category").value),T=Number(v("stage-editor-race-num-stages").value),x=v("stage-editor-race-start-date").value.trim(),$=v("stage-editor-race-end-date").value.trim(),P=Number(v("stage-editor-race-prestige").value);b||e.push("Rennname fehlt."),(!Number.isInteger(y)||y<=0)&&e.push("Land fehlt oder ist ungültig."),(!Number.isInteger(k)||k<=0)&&e.push("Kategorie fehlt oder ist ungültig."),(!Number.isInteger(T)||T<=0)&&e.push("Etappenanzahl muss eine positive Ganzzahl sein."),/^\d{4}-\d{2}-\d{2}$/.test(x)||e.push("Startdatum muss im Format YYYY-MM-DD vorliegen."),/^\d{4}-\d{2}-\d{2}$/.test($)||e.push("Enddatum muss im Format YYYY-MM-DD vorliegen."),(!Number.isInteger(P)||P<1||P>100)&&e.push("Prestige muss zwischen 1 und 100 liegen.")}else g.includes(a)||e.push(`Die Race-ID ${a} existiert nicht. Wenn Sie ein neues Rennen erstellen möchten, aktivieren Sie bitte 'Neues Rennen anlegen'.`);return v("stage-editor-program-checkbox").checked&&document.querySelectorAll('input[name="stage-editor-program-selection"]:checked').length===0&&e.push("Mindestens ein Programm muss ausgewählt sein."),e}function zp(){var a,r;const e=document.querySelectorAll('input[name="stage-editor-weather"]:checked'),t=Array.from(e).map(s=>s.value).join("|");return{stageId:Number(v("stage-editor-stage-id").value),raceId:Number(v("stage-editor-race-id").value),stageNumber:Number(v("stage-editor-stage-number").value),date:v("stage-editor-date").value.trim(),profile:v("stage-editor-profile").value,detailsCsvFile:v("stage-editor-details-file").value.trim(),startElevation:((r=(a=d.stageEditorDraft)==null?void 0:a.segments[0])==null?void 0:r.startElevation)??0,finalSpreadStartPercent:Number(v("stage-editor-final-spread-start").value),finalPushStartPercent:Number(v("stage-editor-final-push-start").value),finalSpreadDifficultyMultiplier:Number(v("stage-editor-final-spread-difficulty").value),crashIncidentMultiplier:Number(v("stage-editor-crash-multiplier").value),mechanicalIncidentMultiplier:Number(v("stage-editor-mechanical-multiplier").value),allowedWeather:t}}function Gp(e){return["distanceKm","elevationGainMeters","sprintCount","climbCount","profileScore"].includes(e)?"desc":"asc"}function Kp(e){return["gainMeters","elevationAtTop","distanceKm","avgGradient","maxGradient","climbScore"].includes(e)?"desc":"asc"}function ps(e,t,a){const s=(Math.max(t,Math.min(a,e))-t)/Math.max(1,a-t),n=Math.round(124-s*118),i=54,l=.14+s*.12,c=.26+s*.18;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${n};--stage-editor-score-lightness:${i}%;--stage-editor-score-bg-alpha:${l};--stage-editor-score-border-alpha:${c};`}">${Math.round(e)}</span>`}function Tn(e){let t;e<=100?t=e/100*.45:e<=250?t=.45+(e-100)/150*.35:t=.8+Math.min(e-250,100)/100*.2;const a=Math.round(122-t*122),r=Math.round(40-t*22),s=.18+t*.3,n=.3+t*.4;return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${s};--stage-editor-score-border-alpha:${n};`}">${Math.round(e)}</span>`}function Op(e){if(e==null)return'<span class="stage-editor-category-empty">—</span>';const t=e==="HC"?"is-hc":`is-cat-${e}`,a=e==="HC"?"HC":String(e);return`<span class="stage-editor-climb-category-badge ${t}">${a}</span>`}function jp(e,t,a,r){const s=r!=null?` data-stage-profile-open-climb-id="${S(r)}"`:"";return`<button class="dashboard-stage-profile-link" type="button" data-stage-profile-open-stage-id="${t}"${s}>${e}</button>`}function Wp(e){const t=i=>i!=null?`${i.toFixed(1).replace(".",",")} km`:"—",a=i=>i!=null?`${Math.round(i).toLocaleString("de-DE")} m`:"—",r=e.profileScore??e.score,s=[...d.stageEditorClimbRows??[]].filter(i=>i.stageId===e.stageId).sort((i,l)=>i.climbIndex-l.climbIndex),n=s.length===0?'<div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-compact"><span class="text-muted" style="grid-column:1/-1">Keine Bergwertungen</span></div>':`
      ...
      ${s.map(i=>`
        <div class="stage-editor-score-popover-grid stage-editor-score-popover-grid-climbs">
          ...
          <span>${S(i.name)}</span>
          <span class="text-right">${Tn(i.climbScore)}</span>
    ...
    <div class="stage-editor-score-popover-card">
      ...
      ${n}
    </div>`}function Vp(e){const t=s=>s!=null?`${s.toFixed(1).replace(".",",")} km`:"—",a=s=>s!=null?`${Math.round(s).toLocaleString("de-DE")} m`:"—",r=s=>s!=null?`${s.toFixed(1).replace(".",",")} %`:"—";return`
    <div class="stage-editor-score-popover-card">
      <div class="stage-editor-score-popover-head">
    ...
    </div>`}function Cl(e,t,a,r,s,n,i,l){const c=l??ps(e,t,a);return`
    ...
    </tr>`);const l=Up(d.stageEditorStageRows);s.innerHTML=l.map(c=>`
    <tr>
      <td>${c.stageId}</td>
      <td>${de(c.countryCode||"")}</td>
      <td><strong>${S(c.raceName)}</strong></td>
      <td><strong>${S(sr({stageNumber:c.stageNumber}))}</strong></td>
      <td>${Cl(c.profileScore,0,100,c.stageId,Wp(c),ys({name:c.raceName},{stageNumber:c.stageNumber,profile:c.profile}))}</td>
      <td>${nr(c.profile)}</td>
    ...
    </tr>`);const l=Yp(d.stageEditorClimbRows);s.innerHTML=l.map(c=>`
    <tr>
      <td>${c.placementKm.toFixed(1).replace(".",",")} km</td>
      <td><strong>${S(c.name)}</strong></td>
      <td>${Op(c.category)}</td>
      <td>${Cl(c.climbScore,0,350,c.stageId,Vp(c),ys({name:c.raceName},{stageNumber:c.stageNumber,profile:"Mountain"}),c.id,Tn(c.climbScore))}</td>
      <td>${de(c.countryCode||"")}</td>
      <td><strong>${S(c.raceName)}</strong></td>
      <td><strong>${S(sr({stageNumber:c.stageNumber}))}</strong></td>
    ...
    `;const y=v("stage-editor-hide-boring-segments-checkbox");y&&(y.checked=d.stageEditorHideBoringSegments),r.innerHTML=b,n.innerHTML=Yi(e);const k=Xp(e);i.innerHTML=e.segments.map((T,x)=>{const $=d.stageEditorHideBoringSegments&&Qp(e,x,k);return`
    <tr data-segment-index="${x}" class="${$n(e,x).length>0?"stage-editor-segment-row-invalid":""}" style="height: 3.5rem;${$?" display: none;":""}">
      <td class="stage-editor-cell-nr text-muted" style="text-align:center; font-weight:700;">${x+1}</td>
      <td class="stage-editor-cell-length"><input type="number" step="0.01" min="0.2" value="${T.lengthKm.toFixed(2)}" data-field="segmentLengthKm" class="${bp(T.lengthKm<Jr)}"></td>
      ...
      <td class="stage-editor-cell-terrain"><select data-field="terrain">${gp(T.terrain)}</select></td>
      <td class="stage-editor-cell-start-markers">
        ${Ui(T.markers,x,e.segments.length,"start")}
      </td>
      <td class="stage-editor-cell-end-markers">
        ${Ui(T.endMarkers,x,e.segments.length,"end")}
      </td>
      <td class="stage-editor-row-actions">
        <div style="display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
          <div style="display: flex; flex-direction: column; min-width: 3.5rem; justify-content: center; line-height: 1.2;">
            <span class="text-muted" style="font-size: 0.85rem;">${xn(T)} m</span>
            <span style="font-size: 0.7rem; color: #888; font-weight: normal;">${_t(Lp(e,x)+T.lengthKm)}</span>
          </div>
          ${eg(e,x)}
...
`)}`),ve();return}const t=v("stage-editor-new-race-checkbox").checked,a=v("stage-editor-program-checkbox").checked;let r;t&&(r={name:v("stage-editor-race-name").value.trim(),countryId:Number(v("stage-editor-race-country").value),categoryId:Number(v("stage-editor-race-category").value),isStageRace:Number(v("stage-editor-race-is-stage-race").value)===1,numberOfStages:Number(v("stage-editor-race-num-stages").value),startDate:v("stage-editor-race-start-date").value.trim(),endDate:v("stage-editor-race-end-date").value.trim(),prestige:Number(v("stage-editor-race-prestige").value)});let s;if(a){const n=document.querySelectorAll('input[name="stage-editor-program-selection"]:checked');s=Array.from(n).map(i=>Number(i.value))}Te("CSV-Dateien werden erstellt……");try{const n=await Y.exportStageRoute({metadata:zp(),draft:d.stageEditorDraft,newRace:t,raceDetails:r,updatePrograms:a,programIds:s});if(!n.success||!n.data){alert(`Export fehlgeschlagen: ${n.error??"Unbekannter Fehler"}`);return}jr(n.data.stagesFileName,n.data.stagesCsv),jr(n.data.stageDetailsFileName,n.data.stageDetailsCsv);const i=v("stage-editor-stage-number"),l=Number(i.value)||1;i.value=String(l+1);const c=v("stage-editor-date"),o=c.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(o)){const b=new Date(o);b.setDate(b.getDate()+1);const y=b.getFullYear(),k=String(b.getMonth()+1).padStart(2,"0"),T=String(b.getDate()).padStart(2,"0");c.value=`${y}-${k}-${T}`}await Promise.all([Fl(!0),wn(!0)]);const m=Ml();v("stage-editor-stage-id").value=String(m),ca=m;const p=v("stage-editor-new-race-checkbox");p&&(p.checked=!1);const u=v("stage-editor-new-race-details");u&&(u.classList.add("hidden"),u.style.display="none");const f=v("stage-editor-program-checkbox");f&&(f.checked=!1);const g=v("stage-editor-program-details");g&&(g.classList.add("hidden"),g.style.display="none"),ua=Number(v("stage-editor-race-id").value),ve()}finally{me()}}function lg(){const e=document.getElementById("stage-editor-stages-table");e&&e.addEventListener("click",R=>{const I=R.target.closest("button[data-stage-profile-open-stage-id]");if(I){const L=Number(I.dataset.stageProfileOpenStageId);Number.isFinite(L)&&as(L);return}const _=R.target.closest("button[data-stage-editor-stages-sort]");if(!_)return;const N=_.dataset.stageEditorStagesSort;d.stageEditorStagesSort.key===N?d.stageEditorStagesSort.direction=d.stageEditorStagesSort.direction==="asc"?"desc":"asc":d.stageEditorStagesSort={key:N,direction:Gp(N)},La()});const t=document.getElementById("stage-editor-climbs-table");t&&t.addEventListener("click",R=>{const I=R.target.closest("button[data-stage-profile-open-stage-id]");if(I){const L=Number(I.dataset.stageProfileOpenStageId),G=I.dataset.stageProfileOpenClimbId??null;if(Number.isFinite(L)){let B=null;G&&d.stageEditorClimbRows&&(B=d.stageEditorClimbRows.find(q=>q.id===G)??null),as(L,B)}return}const _=R.target.closest("button[data-stage-editor-climbs-sort]");if(!_)return;const N=_.dataset.stageEditorClimbsSort;d.stageEditorClimbsSort.key===N?d.stageEditorClimbsSort.direction=d.stageEditorClimbsSort.direction==="asc"?"desc":"asc":d.stageEditorClimbsSort={key:N,direction:Kp(N)},Da()});const a=document.getElementById("btn-stage-editor-import");a&&a.addEventListener("click",()=>{ng()});const r=document.getElementById("btn-stage-editor-load-existing");r&&r.addEventListener("click",()=>{ig()});const s=document.getElementById("btn-stage-editor-export");s&&s.addEventListener("click",()=>{og()});const n=document.getElementById("stage-editor-file");n&&n.addEventListener("change",R=>{var _;const I=((_=R.target.files)==null?void 0:_[0])??null;v("stage-editor-file-hint").textContent=I?`${I.name} · ${(I.size/1024).toFixed(1).replace(".",",")} KB`:"Noch keine Datei ausgewählt."});const i=document.getElementById("stage-editor-waypoints");i&&(i.addEventListener("change",R=>{const I=R.target,_=I.closest("tr[data-segment-index]"),N=I.dataset.field;if(!_||!N)return;const L=Number(_.dataset.segmentIndex);if(Number.isInteger(L)){if(N==="markerType"||N==="markerName"||N==="markerCat"){const G=Number(I.dataset.markerIndex),B=I.dataset.markerScope;if(!Number.isInteger(G)||B!=="start"&&B!=="end")return;Ip(L,G,B,N,I.value);return}tg(L,N,I.value)}}),i.addEventListener("click",R=>{const I=R.target.closest("button[data-segment-action]");if(!I)return;const _=Number(I.dataset.segmentIndex);if(Number.isInteger(_)){if(I.dataset.segmentAction==="insert"){ag(_);return}if(I.dataset.segmentAction==="append"){rg();return}if(I.dataset.segmentAction==="add-marker"){const N=I.dataset.markerScope;if(N!=="start"&&N!=="end")return;Cp(_,N);return}if(I.dataset.segmentAction==="remove-marker"){const N=Number(I.dataset.markerIndex),L=I.dataset.markerScope;if(!Number.isInteger(N)||L!=="start"&&L!=="end")return;Fp(_,N,L);return}I.dataset.segmentAction==="delete"&&sg(_)}})),["stage-editor-stage-id","stage-editor-race-id","stage-editor-stage-number","stage-editor-date","stage-editor-details-file","stage-editor-profile"].forEach(R=>{const I=document.getElementById(R);I&&I.addEventListener("change",()=>{R==="stage-editor-date"&&na(),ve()})}),document.querySelectorAll('input[name="stage-editor-weather"]').forEach(R=>{R.addEventListener("change",()=>ve())});const c=v("stage-editor-new-race-checkbox"),o=v("stage-editor-new-race-details"),m=v("stage-editor-program-checkbox"),p=v("stage-editor-program-details");c&&c.addEventListener("change",()=>{c.checked?(o&&(o.classList.remove("hidden"),o.style.display="grid"),m&&(m.checked=!0,p&&(p.classList.remove("hidden"),p.style.display="block")),na()):o&&(o.classList.add("hidden"),o.style.display="none"),ve()});const u=document.getElementById("stage-editor-race-is-stage-race");u&&u.addEventListener("change",()=>{na()});const f=document.getElementById("stage-editor-race-num-stages");f&&f.addEventListener("input",()=>{na()});const g=document.getElementById("stage-editor-race-start-date");g&&g.addEventListener("change",()=>{const R=g.value.trim();if(/^\d{4}-\d{2}-\d{2}$/.test(R)){const I=document.getElementById("stage-editor-race-is-stage-race"),_=I?Number(I.value)===1:!1,N=v("stage-editor-race-end-date");if(N)if(!_)N.value=R;else{const L=document.getElementById("stage-editor-race-num-stages"),G=L&&Number(L.value)||1,[B,q,te]=R.split("-").map(Number),ae=new Date(B,q-1,te);let M=0;G===21?M=2:G>=14&&(M=1);const z=G+M;ae.setDate(ae.getDate()+z-1);const V=ae.getFullYear(),U=String(ae.getMonth()+1).padStart(2,"0"),X=String(ae.getDate()).padStart(2,"0");N.value=`${V}-${U}-${X}`}}}),m&&m.addEventListener("change",()=>{m.checked?p&&(p.classList.remove("hidden"),p.style.display="block"):p&&(p.classList.add("hidden"),p.style.display="none"),ve()});const h=v("stage-editor-programs-dropdown-trigger"),b=v("stage-editor-programs-dropdown-menu"),y=v("btn-stage-editor-programs-ok");h&&b&&(h.addEventListener("click",R=>{R.stopPropagation();const I=b.style.display==="none"||!b.style.display;b.style.display=I?"flex":"none"}),y&&y.addEventListener("click",R=>{R.stopPropagation(),b.style.display="none",ve()}),document.addEventListener("click",R=>{const I=R.target;b.style.display==="flex"&&!b.contains(I)&&I!==h&&!h.contains(I)&&(b.style.display="none",ve())}));const k=v("stage-editor-programs-list");k&&k.addEventListener("change",R=>{R.target.name==="stage-editor-program-selection"&&Np()});let T=!1,x=null;const $=v("stage-editor-stage-id"),P=v("stage-editor-race-id");if($&&P){[$,P].forEach(I=>{I.addEventListener("keydown",_=>{_.key==="ArrowUp"||_.key==="ArrowDown"?(T=!1,x&&clearTimeout(x)):(T=!0,x&&clearTimeout(x))}),I.addEventListener("keyup",_=>{_.key!=="ArrowUp"&&_.key!=="ArrowDown"&&(x&&clearTimeout(x),x=setTimeout(()=>{T=!1},150))}),I.addEventListener("mousedown",()=>{T=!1}),I.addEventListener("blur",()=>{T=!1})});const R=(I,_)=>{const N=Number(I.value);if(!Number.isInteger(N)||N<=0){_==="stage"?ca=N:ua=N;return}const G=N-(_==="stage"?ca:ua);if(!T&&(G===1||G===-1)){let B=N;_==="stage"?B=_p(N,G):v("stage-editor-new-race-checkbox").checked&&(B=Ap(N,G)),I.value=String(B)}_==="stage"?ca=Number(I.value):ua=Number(I.value)};$.addEventListener("input",()=>{R($,"stage"),ve()}),P.addEventListener("input",()=>{R(P,"race"),ve()})}const E=v("stage-editor-hide-boring-segments-checkbox");E&&E.addEventListener("change",()=>{d.stageEditorHideBoringSegments=E.checked,ve()})}let xt=[],ia=null,Ye={form:!0,combinedFatigue:!0,shortFatigue:!1,longFatigue:!1};const Qt=["#3b82f6","#ec4899","#8b5cf6","#06b6d4","#10b981","#f43f5e","#ef4444","#f59e0b","#84cc16","#a855f7"],Zi={1:{pref:[1,2],malus:[4,7],neutral:[3,5,6]},2:{pref:[3,5],malus:[2,7],neutral:[1,4,6]},3:{pref:[4,7],malus:[2,5],neutral:[1,3,6]},4:{pref:[6,7],malus:[2,5],neutral:[1,3,4]},5:{pref:[1,5],malus:[6,7],neutral:[2,3,4]},6:{pref:[1,3],malus:[4,7],neutral:[2,5,6]},7:{pref:[3,4],malus:[2,7],neutral:[1,5,6]}},Ji={1:"Sonnig",2:"Extreme Hitze",3:"Leichter Regen",4:"Starkregen",5:"Starker Wind",6:"Dichter Nebel",7:"Schnee/Eis"};function Ua(e,t){if(e==null)return"";const a=t?S(t):"Wetter";switch(e){case 1:return`
  ...
  `}function Rn(e){switch(e){case"gc_final":return"is-gc";case"points_final":return"is-points";case"mountain_final":return"is-mountain";case"youth_final":return"is-youth";case"breakaway_final":return"is-breakaway";default:return""}}function gs(e){switch(e){case"gc_final":return"Gesamtwertung";case"points_final":return"Punktewertung";case"mountain_final":return"Bergwertung";case"youth_final":return"Nachwuchs";case"breakaway_final":return"Ausreißer";default:return"Etappe"}}function ug(e){return`<span class="rider-stats-final-type ${Rn(e)}">${S(gs(e))}</span>`}function be(e,t,a){let r="padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.8rem; font-weight: bold; min-width: 1.8rem; text-align: center; display: inline-block; box-sizing: border-box;";return e===0?r+="background: rgba(255, 255, 255, 0.05); color: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.1);":t==="flat"||t==="rolling"?r+="background: #2ecc71; color: #fff; box-shadow: 0 0 5px rgba(46, 204, 113, 0.4);":t==="hilly"||t==="hilly_difficult"?r+="background: linear-gradient(135deg, #fef08a, #facc15); color: #854d0e; border: 1px solid #f59e0b; box-shadow: 0 0 5px rgba(250, 204, 21, 0.4);":t==="medium_mountain"?r+="background: #e67e22; color: #fff; box-shadow: 0 0 5px rgba(230, 126, 34, 0.4);":t==="mountain"||t==="high_mountain"?r+="background: #95a5a6; color: #fff; box-shadow: 0 0 5px rgba(149, 165, 166, 0.4);":t==="cobble"||t==="cobble_hill"?r+="background: #34495e; color: #fff; box-shadow: 0 0 5px rgba(52, 73, 94, 0.4);":(t==="itt"||t==="ttt")&&(r+="background: #e74c3c; color: #fff; box-shadow: 0 0 5px rgba(231, 76, 60, 0.4);"),`<span style="${r}" title="${S(a)}: ${e} Siege">${e}</span>`}function Ne(e,t,a){let r="padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.8rem; font-weight: bold; min-width: 1.8rem; text-align: center; display: inline-block; box-sizing: border-box;";return e===0?r+="background: rgba(255, 255, 255, 0.05); color: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.1);":t===1?r+="background: linear-gradient(135deg, #fbbf24, #f59e0b); color: #000; box-shadow: 0 0 5px rgba(251, 191, 36, 0.4);":t===2?r+="background: linear-gradient(135deg, #f97316, #ea580c); color: #fff; box-shadow: 0 0 5px rgba(249, 115, 22, 0.4);":t===3?r+="background: linear-gradient(135deg, #38bdf8, #0284c7); color: #fff; box-shadow: 0 0 5px rgba(56, 189, 248, 0.4);":t===4?r+="background: linear-gradient(135deg, #2563eb, #1d4ed8); color: #fff; box-shadow: 0 0 5px rgba(37, 99, 235, 0.4);":t===5?r+="background: linear-gradient(135deg, #0d9488, #0f766e); color: #fff; box-shadow: 0 0 5px rgba(13, 148, 136, 0.4);":t===6?r+="background: linear-gradient(135deg, #8b5cf6, #6d28d9); color: #fff; box-shadow: 0 0 5px rgba(139, 92, 246, 0.4);":t===7&&(r+="background: linear-gradient(135deg, #cbd5e1, #94a3b8); color: #000; box-shadow: 0 0 5px rgba(203, 213, 225, 0.4);"),`<span style="${r}" title="${S(a)}: ${e} Siege">${e}</span>`}function mg(e){return`${e.startDate===e.endDate?ce(e.startDate):`${ce(e.startDate)} - ${ce(e.endDate)}`} · ${e.isStageRace?"Etappenrennen":"Eintagesrennen"}`}function es(e){if(e==null||d.riders.length===0)return null;const a=[...d.riders].sort((r,s)=>(s.seasonPoints??0)-(r.seasonPoints??0)||(s.seasonWins??0)-(r.seasonWins??0)||s.overallRating-r.overallRating||`${r.lastName} ${r.firstName}`.localeCompare(`${s.lastName} ${s.firstName}`,"de")||r.id-s.id).findIndex(r=>r.id===e);return a>=0?a+1:null}function qi(e){switch(e){case"gc_final":return 0;case"points_final":return 1;case"mountain_final":return 2;case"youth_final":return 3;case"breakaway_final":return 4;default:return 5}}function pg(e){return[...e].sort((t,a)=>a.date.localeCompare(t.date)||(a.stageNumber??-1)-(t.stageNumber??-1)||qi(t.rowType)-qi(a.rowType)||(t.resultRank??999)-(a.resultRank??999))}function gg(e){return[...e].map(t=>({...t,rows:pg(t.rows)})).sort((t,a)=>a.endDate.localeCompare(t.endDate)||a.startDate.localeCompare(t.startDate)||a.raceName.localeCompare(t.raceName,"de")||a.raceId-t.raceId)}function El(e){const t=[{score:50,hue:0,lightness:28},{score:55,hue:0,lightness:40},{score:65,hue:30,lightness:42},{score:75,hue:60,lightness:42},{score:85,hue:120,lightness:36}];let a=120,r=36;const s=Math.max(50,Math.min(85,e));for(let c=1;c<t.length;c++){const o=t[c-1],m=t[c];if(s<=m.score){const p=(s-o.score)/(m.score-o.score);a=Math.round(o.hue+(m.hue-o.hue)*p),r=Math.round(o.lightness+(m.lightness-o.lightness)*p);break}}return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${.44};--stage-editor-score-border-alpha:${.72};`}">${e.toFixed(1)}</span>`}function Et(e,t,a,r){const s=r>0?Math.max(0,Math.min(1,a/r)):.5,n=Math.round(6+s*118),i=.26+s*.18,l=.14+s*.12;return`<span class="rider-stats-icon-pill rider-stats-summary-pill-heat" style="${`--rider-stats-pill-hue:${n};--rider-stats-pill-border-alpha:${i};--rider-stats-pill-bg-alpha:${l};`}" title="${S(t)}">${e} ${a}</span>`}function Fs(e){if(typeof e=="string")switch(e){case"Berg":return"Bergfahrer";case"Hill":return"Hügelspezialist";case"Sprint":return"Sprinter";case"Timetrial":return"Zeitfahrer";case"Cobble":return"Pflasterspezialist";case"Attacker":return"Angreifer";case"Flat":return"Flachlandspezialist";default:return e}return e.name}function Es(e){if(!e)return"";switch(typeof e=="string"?e:e.key||e.name){case"Berg":return oe.mountain;case"Hill":return oe.hilly;case"Sprint":return oe.sprint;case"Timetrial":return oe.timetrial;case"Cobble":return oe.cobble;case"Attacker":return oe.attacker;case"Flat":return oe.flat;default:return""}}function qe(e,t,a,r,s){var F,j,O;const n=(t==null?void 0:t.countryCode)??r??null,i=n?de(n):s,l=(t==null?void 0:t.roleName)??((F=e==null?void 0:e.role)==null?void 0:F.name)??"Ohne Rolle",c=(t==null?void 0:t.overallRating)??(e==null?void 0:e.overallRating)??0,o=(t==null?void 0:t.teamId)??(e==null?void 0:e.activeTeamId)??null,m=(t==null?void 0:t.teamName)??a??"Ohne aktives Team",p=(t==null?void 0:t.seasonFormPhase)??(e==null?void 0:e.seasonFormPhase)??"neutral",u=((j=t==null?void 0:t.program)==null?void 0:j.name)??((O=e==null?void 0:e.seasonProgram)==null?void 0:O.name)??"-",f=(t==null?void 0:t.formBonus)??(e==null?void 0:e.formBonus)??0,g=(t==null?void 0:t.raceFormBonus)??(e==null?void 0:e.raceFormBonus)??0,h=(t==null?void 0:t.seasonRaceDaysTotal)??(e==null?void 0:e.seasonRaceDaysTotal)??0;(t==null?void 0:t.rolling30dRaceDays)??(e==null||e.rolling30dRaceDays);const b=(t==null?void 0:t.longTermFatigueMalus)??(e==null?void 0:e.longTermFatigueMalus)??0,y=(t==null?void 0:t.shortTermFatigueMalus)??(e==null?void 0:e.shortTermFatigueMalus)??0,k=(t==null?void 0:t.shortTermFatigueWarning)??(e==null?void 0:e.shortTermFatigueWarning)??"none",T=(t==null?void 0:t.currentSeasonPoints)??(e==null?void 0:e.seasonPoints)??0,x=(t==null?void 0:t.currentSeasonRank)??es((e==null?void 0:e.id)??(t==null?void 0:t.riderId)??null),$=(t==null?void 0:t.currentSeasonRaceDays)??(e==null?void 0:e.seasonRaceDays)??0,P=(t==null?void 0:t.careerWins)??(e==null?void 0:e.seasonWins)??0,E=(t==null?void 0:t.currentSeasonBreakawayAttempts)??0,R=(t==null?void 0:t.pointsByTerrain)??{flat:0,hilly:0,mediumMountain:0,mountain:0,timetrial:0,cobble:0},I=Math.max(R.flat,R.hilly,R.mediumMountain,R.mountain,R.timetrial,R.cobble),_=(t==null?void 0:t.pointsByRaceFormat)??{stageRace:0,oneDay:0},N=Math.max(_.stageRace,_.oneDay),L=e!=null&&e.specialization1?Fs(e.specialization1):"-",G=e!=null&&e.specialization2?Fs(e.specialization2):"-",B=e!=null&&e.specialization3?Fs(e.specialization3):"-",q=Es((e==null?void 0:e.specialization1)??null),te=Es((e==null?void 0:e.specialization2)??null),ae=Es((e==null?void 0:e.specialization3)??null),M=(e==null?void 0:e.weatherProfileId)??(t==null?void 0:t.weatherProfileId)??1,z=Zi[M]||Zi[1],V=z.pref[0],U=z.pref[1],X=Ji[V],A=Ji[U];let D="";return t!=null&&t.lieutenantInfo?D=`
    ...
    <div class="rider-stats-header-grid">
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill" title="Formphase">${pn(p)} <span>Form</span></span>
        ${D}
      </div>
      <div class="rider-stats-header-col align-left">
        <span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;" title="Overall-Stärke">${El(c)}</span>
      ...
      <div class="rider-stats-header-col align-left">
        ...
        <span class="rider-stats-icon-pill rider-stats-icon-pill-fixed-width" title="Saisonplatzierung">${oe.rank} <span class="rider-stats-icon-pill-value">${cg(x)}</span></span>
  ...
  `}function Xi(e,t){const a=(t==null?void 0:t.firstName)??(e==null?void 0:e.firstName)??"",r=(t==null?void 0:t.lastName)??(e==null?void 0:e.lastName)??"";return`${S(a)} <strong>${S(r)}</strong>`}function Xe(e){const t=((e==null?void 0:e.programRaces.length)??0)>0;return`
    ...
    </div>`}function fg(e){const t=[{score:55,hue:0,lightness:28},{score:60,hue:0,lightness:40},{score:68,hue:30,lightness:42},{score:74,hue:60,lightness:42},{score:80,hue:120,lightness:36}];let a=120,r=36;const s=Math.max(55,Math.min(80,e));for(let c=1;c<t.length;c++){const o=t[c-1],m=t[c];if(s<=m.score){const p=(s-o.score)/(m.score-o.score);a=Math.round(o.hue+(m.hue-o.hue)*p),r=Math.round(o.lightness+(m.lightness-o.lightness)*p);break}}return`<span class="stage-editor-score-badge" style="${`--stage-editor-score-hue:${a};--stage-editor-score-lightness:${r}%;--stage-editor-score-bg-alpha:${.44};--stage-editor-score-border-alpha:${.72};`}">${e.toFixed(0)}</span>`}function hg(e,t){const a=(e==null?void 0:e.skills)??{mountain:60,hill:60,sprint:60,timeTrial:60,cobble:60,attack:60,mediumMountain:60,flat:60,prologue:60,acceleration:60},r=["mountain","hill","sprint","timeTrial","cobble","attack"],s=["Berg (MTN)","Hügel (HIL)","Sprint (SPR)","Zeitfahren (TT)","Pflaster (COB)","Angriff (ATT)"],n=540,i=440,l=n/2,c=i/2,o=160,m=60,p=85,u=p-m,f=N=>{const L=[];for(let G=0;G<6;G++){const B=G*Math.PI/3-Math.PI/2;L.push(`${l+N*Math.cos(B)},${c+N*Math.sin(B)}`)}return L},g=`
    <defs>
  ...
  `}function yg(e){var X;if(!e)return`
  ...
  `}function vg(e){const t=(e==null?void 0:e.programRaces)??[];return e!=null&&e.program?t.length===0?`
      <section class="rider-stats-placeholder">
  ...
  `}function Zt(e,t){return`<span class="rider-stats-rank-badge rider-stats-rank-badge-${t}">${S(e)}</span>`}function Sg(e){return!e.isBreakaway||e.rowType!=="stage_result"||e.finishStatus!=="classified"?"–":'<span class="rider-stats-breakaway-icon" aria-label="Ausreißer" title="Ausreißer"><svg class="rider-stats-icon" viewBox="0 0 24 24" style="fill:#ef4444; width:1em; height:1em; vertical-align:middle;"><path d="M12 21L2 3h20L12 21z"/></svg></span>'}function kg(e){return e.finishStatus==="otl"?Zt("OTL","place"):e.finishStatus==="dnf"?Zt("DNF","place"):e.resultRank==null?"–":`<span class="rider-stats-rank-badge rider-stats-rank-badge-place${e.resultRank<=3?` rider-stats-rank-badge-top-${e.resultRank}`:""}">${S(String(e.resultRank))}</span>`}function $g(e){return e.finishStatus!=="classified"||e.gcRank==null?"–":Zt(String(e.gcRank),"gc")}function xg(e){return e.finishStatus==="otl"?zr(e.statusReason,!0):e.finishStatus==="dnf"?zr(e.statusReason,!1):e.stageTimeSeconds!=null?`${e.resultLabel} · ${Oa(e.stageTimeSeconds)}`:e.resultLabel}function Pe(e,t,a=!1){var f,g,h;const r=(e==null?void 0:e.activeTeamId)!=null?((f=d.teams.find(b=>b.id===e.activeTeamId))==null?void 0:f.name)??null:null,s=((g=e==null?void 0:e.country)==null?void 0:g.code3)??(e==null?void 0:e.nationality)??null,n=s?de(s):"",i=t==null?[]:[...t.seasons].map(b=>({...b,raceBlocks:gg(b.raceBlocks)})).sort((b,y)=>y.season-b.season);if(a)return`
      ...
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${hg(e)}`;if(d.riderStatsTab==="fatigue")return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${bg(e,t)}`;if(d.riderStatsTab==="program")return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${vg(t)}`;if(d.riderStatsTab==="form")return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${yg(t)}`;if(d.riderStatsTab==="topResults")return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${wg(t)}`;if(d.riderStatsTab==="career")return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${Rg(t)}`;if(d.riderStatsTab==="contracts")return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      ${Mg(t)}`;const l=((h=d.gameState)==null?void 0:h.season)??2026,c=Array.from(new Set([l,...i.map(b=>b.season)])).sort((b,y)=>y-b);(d.riderStatsSelectedSeason===null||!c.includes(d.riderStatsSelectedSeason))&&(d.riderStatsSelectedSeason=l);const o=d.riderStatsSelectedSeason,m=i.find(b=>b.season===o);if(t.seasons.length===0)return`
      ${qe(e,t,r,s,n)}
      ${Xe(t)}
      <section class="rider-stats-placeholder">
        <h3>Keine Historie vorhanden</h3>
                ...
                <tbody>
                  ${b.rows.map(y=>{const k=y.rowType!=="stage_result",T=k?`${y.raceName} · ${gs(y.rowType)}`:y.stageNumber&&y.isStageRace?`${y.raceName} · Etappe ${y.stageNumber}`:y.raceName;return`
                      <tr class="rider-stats-row${k?" rider-stats-row-final":""}">
                        ...
                        <td>${kg(y)}</td>
                        <td>${$g(y)}</td>
                        <td class="rider-stats-breakaway-col">${Sg(y)}</td>
                        <td>${k?"":Ua(y.rolledWeatherId,y.rolledWetterName)}</td>
                        <td>${k?ug(y.rowType):Qr(y.raceCategoryName?y.raceCategoryName.replace(/^world\s*tour\s*-\s*/i,""):y.raceCategoryName,y.isStageRace)}</td>
                        <td>${S(T)}</td>
                        <td class="status-cell">${In(y)}</td>
  ...
  `}function Mg(e){var n,i,l,c,o;const t=(e==null?void 0:e.contracts)||[];if(t.length===0)return`
      <section class="rider-stats-placeholder">
  ...
  `,M=g.findIndex(w=>w.resultTypeName.toLocaleLowerCase("de").includes("team"));M>=0?B.splice(M+1,0,q,te,ae):B.push(q,te,ae),a.innerHTML=B.join("");const z=Pg(((F=d.stageResults)==null?void 0:F.markerClassifications)??[]);if(k){m.innerHTML=Ag(),m.classList.remove("hidden"),i.classList.add("hidden"),r.innerHTML="",r.classList.add("hidden"),o.innerHTML="",o.classList.add("hidden"),n.classList.add("hidden");return}else m.innerHTML="",m.classList.add("hidden");const V=!b&&!y&&!k&&(h==null?void 0:h.resultTypeId)===1&&z.length>0,U=V?d.selectedResultsMarkerKey??ut:null,X=V&&U!==ut?z.find(w=>w.markerKey===U)??null:null;if(V&&(d.selectedResultsMarkerKey=(X==null?void 0:X.markerKey)??ut),y){const w=[{key:"all",label:"Alle"},{key:"form",label:"Tagesform"},{key:"attack",label:"Attacken"},{key:"breakaway",label:"Fluchtgruppe"},{key:"incident",label:"Stürze/Defekte"},{key:"exit",label:"Ausgeschieden"},{key:"home",label:"Heimvorteil"},{key:"weather",label:"Wetter"},{key:"superteam",label:"Superteam"}];r.innerHTML=w.map(C=>`
    ...
    `).join("")||'<tr><td colspan="7" class="results-empty-cell">Keine OTL/DNF bis zu dieser Etappe.</td></tr>':y?[...((O=d.stageResults)==null?void 0:O.events)??[]].filter(w=>Ue==="all"?!0:Ue==="form"?!!(w.title&&(w.title.includes("guten Tag")||w.title.includes("schlechten Tag")||w.title.includes("Formhöhepunkt")||w.title.includes("Formhoehepunkt"))):Ue==="attack"?(w.type==="attack"||w.type==="counter_attack")&&!(w.title&&(w.title.toLowerCase().includes("ausreiß")||w.title.toLowerCase().includes("ausreiss"))):Ue==="breakaway"?!!(w.title&&(w.title.toLowerCase().includes("ausreiß")||w.title.toLowerCase().includes("ausreiss"))):Ue==="incident"?(w.type==="incident"||!!(w.title&&w.title.includes("Massensturz")))&&!(w.title&&(w.title.toLowerCase().includes("ausreiß")||w.title.toLowerCase().includes("ausreiss"))):Ue==="exit"?w.type==="dnf"||!!(w.title&&w.title.includes("nicht am Start")):Ue==="home"?!!(w.title&&(w.title.includes("Heimvorteil")||w.title.includes("Heimdruck"))):Ue==="weather"?!!(w.title&&w.title.startsWith("Wetterbericht:")):Ue==="superteam"?w.type==="superteam":!0).sort((w,C)=>{const J=w.kmMark??0,re=C.kmMark??0;if(Math.abs(J-re)>1e-4)return J-re;if(J===0){const pe=ro(w),Se=ro(C);if(pe!==Se)return pe-Se}const Q=w.riderName??"",we=C.riderName??"";return Q.localeCompare(we,"de")}).map(w=>{var ue,Me,je;const C=w.kmMark!=null?`${w.kmMark.toFixed(1).replace(".",",")} km`:"0,0 km",J=w.riderId,re=J!=null?Ce(J):null,Q=w.riderTeamId??(re==null?void 0:re.activeTeamId)??null,we=Q!=null?((ue=d.teams.find(De=>De.id===Q))==null?void 0:ue.name)??null:null;let pe=aa(Q,we);const Se=!!(w.title&&w.title.startsWith("Wetterbericht:"));let Oe=w.title||"";if(Se){const De=(Me=d.stageResults)==null?void 0:Me.rolledWeatherId,$e=(je=d.stageResults)==null?void 0:je.rolledWetterName;pe=`<span class="results-jersey-cell">${Ua(De,$e)}</span>`,$e&&(Oe=`Wetterbericht: ${$e}`)}const dt=w.type==="superteam",H=dt&&J==null,K=Se||H?"":mt(J!=null?At(J):null),W=Se?"":H?rt(we||"–",Q):J!=null?ra(w.riderName??"",!0,!1,J,Q):S(w.riderName||"–");let Z="";return w.title&&w.title.includes("guten Tag")?Z='<span class="event-badge event-badge-superform"><span class="event-icon">▲</span> Guten Tag</span>':w.title&&w.title.includes("schlechten Tag")?Z='<span class="event-badge event-badge-supermalus"><span class="event-icon">▼</span> Schlechten Tag</span>':w.title&&(w.title.includes("Formhöhepunkt")||w.title.includes("Formhoehepunkt"))?Z='<span class="event-badge event-badge-peak"><span class="event-icon">★</span> Formhöhepunkt</span>':w.title&&w.title.includes("nicht am Start")?Z='<span class="event-badge event-badge-dns">DNS</span>':w.title&&w.title.includes("Massensturz")?Z='<span class="event-badge event-badge-masscrash">Massensturz</span>':w.type==="dnf"?Z='<span class="event-badge event-badge-dnf">DNF</span>':w.title&&(w.title.toLowerCase().includes("ausreiß")||w.title.toLowerCase().includes("ausreiss"))?Z='<span class="event-badge event-badge-breakaway">Fluchtgruppe</span>':w.type==="attack"?Z='<span class="event-badge event-badge-attack">Attacke</span>':w.type==="counter_attack"?Z='<span class="event-badge event-badge-counter">Konterattacke</span>':w.type==="incident"?w.title&&(w.title.toLowerCase().includes("defekt")||w.title.toLowerCase().includes("panne")||w.title.toLowerCase().includes("technisch"))?Z='<span class="event-badge event-badge-defect">Defekt</span>':Z='<span class="event-badge event-badge-crash">Sturz</span>':w.title&&w.title.includes("Super-Heimvorteil")?Z='<span class="event-badge event-badge-superhome"><span class="event-icon">♥</span> Heimbonus</span>':w.title&&w.title.includes("Heimdruck")?Z='<span class="event-badge event-badge-homepressure"><span class="event-icon">♦</span> Heimmalus</span>':w.title&&w.title.includes("Heimvorteil")?Z='<span class="event-badge event-badge-normalhome"><span class="event-icon">♥</span> Heimvorteil</span>':w.title&&w.title.startsWith("Wetterbericht:")?Z='<span class="event-badge event-badge-weather"><span class="event-icon">🌤️</span> Wetter</span>':dt&&(Z='<span class="event-badge event-badge-superteam"><span class="event-icon">⚡</span> Superteam</span>'),`
          ...
          <tr>
            ...
            <td>${C.uciPoints!=null?C.uciPoints:"–"}</td>
          </tr>`;let H=C.points!=null?String(C.points):"–";if(C.leadoutBonus!=null&&C.leadoutBonus>0&&C.leadoutRiderId!=null){const K=Hg(C);H=`
      ...
      <section class="results-marker-card">
        <div class="results-results-view-marker-card-head">
          <h4>${S(Mo(X.markerType,X.markerLabel))}</h4>
    ...
    <div class="team-detail-card">
      <div class="team-detail-header">
        ...
        <div class="team-detail-meta">
          ...
          <span>Kürzel: ${S(a.abbreviation)} · Top 12 ${S(Bl(a.id))} (${S(Hl(a.id))})</span>
    ...
    </div>`}function Vl(){v("teams-dropdown").addEventListener("change",e=>{const t=e.target.value;d.teamDetailPage="skills",ma(t?Number(t):null)}),v("teams-detail").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const s=Number(t.dataset.riderProgramId);Number.isFinite(s)&&zn(s);return}const a=e.target.closest("button[data-team-detail-page]");if(a){const s=a.dataset.teamDetailPage;if(ar.includes(s)){d.teamDetailPage=s,new Set(Nn().map(l=>l.sortKey).filter(l=>l!=null)).has(d.teamTableSort.key)||(d.teamTableSort={key:"name",direction:"asc"});const i=Number(v("teams-dropdown").value);ma(Number.isFinite(i)?i:null)}return}const r=e.target.closest("button[data-team-sort]");if(r){const s=r.dataset.teamSort;d.teamTableSort.key===s?d.teamTableSort.direction=d.teamTableSort.direction==="asc"?"desc":"asc":d.teamTableSort={key:s,direction:Ln(s)};const n=Number(v("teams-dropdown").value);ma(Number.isFinite(n)?n:null);return}})}const Og=Object.freeze(Object.defineProperty({__proto__:null,TEAM_DETAIL_PAGE_COLUMNS:Pn,TEAM_DETAIL_PAGE_ORDER:ar,TEAM_SKILL_COLUMNS:Fn,TEAM_SKILL_TITLES:Ol,TEAM_TABLE_COLUMNS:En,compareOptionalStrings:Ae,compareStrings:le,formatTeamAverage:Hl,formatTeamTopAverage:Bl,getActiveTeamTableColumns:Nn,getDefaultTeamSortDirection:Ln,getPeakDate:Ee,getSortIndicator:zl,getSpecializationSortLabel:Be,getTeamAverage:Al,getTeamSortLabel:Dn,getTeamTopAverage:_l,initTeamsListeners:Vl,loadTeams:Kg,refreshTeamsViewData:ts,renderPeakDatesSummary:Gg,renderRacePrefs:Us,renderTeamDetail:ma,renderTeamDetailPageTabs:Kl,renderTeamTableCell:_n,renderTeamTableHeader:Gl,renderTeams:An,sortRiderMenuRiders:Wl,sortTeamRiders:jl},Symbol.toStringTag,{value:"Module"}));function jg(e,t,a){return`${e} · Etappe ${t} · ${a}`}function Ul(e,t){return e.riders.map(a=>({riderId:a.riderId,finishTimeSeconds:t.stage.profile==="ITT"||t.stage.profile==="TTT"?a.riderClockSeconds:a.finishTimeSeconds,finishStatus:a.finishStatus??"finished",isBreakaway:a.isBreakaway,statusReason:a.statusReason??null,photoFinishScore:a.photoFinishScore,leadoutRiderId:a.leadoutRiderId,leadoutBonus:a.leadoutBonus})).filter(a=>a.finishStatus==="dnf"||a.finishTimeSeconds!=null)}function Yl(e,t){const a=[];for(const r of e.riders)if(r.leadoutBonus!=null&&r.leadoutBonus>0&&r.leadoutContributions&&r.leadoutContributions.length>0){const s=t.riders.find(i=>i.id===r.riderId),n=(s==null?void 0:s.activeTeamId)??null;n!=null&&a.push({teamId:n,sprinterId:r.riderId,leadoutBonus:r.leadoutBonus,contributorsJson:JSON.stringify(r.leadoutContributions)})}return a}async function Zl(e,t=!1){if(rn!=null||is)return!1;As(e),Fo(0);try{const a=await Y.getRealtimeSimulation(e);if(!a.success||!a.data)return alert(`Instant-Simulation fehlgeschlagen:
`+(a.error??"Unbekannter Fehler")),!1;const r=a.data;d.realtimeBootstrap=r;const s=await Cu(r,l=>dn(l)),n=Ul(s,r),i=Yl(s,r);return await td(e,n,s.markerClassifications,s.incidents,s.allEvents,t,i,s.superTeamId),!0}catch(a){return alert("Unerwarteter Fehler bei der Instant-Simulation: "+a.message),!1}finally{As(null),me()}}function Jl(e){var r;const t=(r=d.rosterEditor)==null?void 0:r.teams.find(s=>s.team.id===e);if(!t)return 0;const a=new Set(d.rosterEditorSelectedRiderIds);return t.riders.filter(s=>a.has(s.rider.id)).length}function ql(){return d.rosterEditor?d.rosterEditor.teams.every(e=>Jl(e.team.id)===e.riderLimit):!1}function Ns(){const e=v("roster-editor-title"),t=v("roster-editor-meta"),a=v("roster-editor-body"),r=v("btn-apply-roster-editor"),s=d.rosterEditor;if(!s){e.textContent="Starterfeld bearbeiten",t.textContent="",a.innerHTML='<div class="results-empty">Kein Starterfeld geladen.</div>',r.disabled=!0;return}e.textContent="Starterfeld bearbeiten",t.textContent=s.race.isStageRace?`${s.race.name} · Etappe ${s.stage.stageNumber} · ${s.stage.profile}`:`${s.race.name} · ${s.stage.profile}`;const n=new Set(d.rosterEditorSelectedRiderIds);a.innerHTML=s.teams.map(i=>{const l=Jl(i.team.id),c=l===i.riderLimit?"roster-editor-team-count-ok":"roster-editor-team-count-bad";return`
...
`+(c.error??"Unbekannter Fehler"));return}const o=c.data;d.selectedResultsRaceId=(o==null?void 0:o.raceId)??d.selectedResultsRaceId,d.selectedResultsStageId=(o==null?void 0:o.stageId)??e,d.selectedResultTypeId=1,d.realtimeBootstrap=null,d.realtimeError=null,await Vs(e,!1),await rr(),await Hn(),(Re("teams")||Re("riders"))&&await ts(),pa(),n||Rt("results")}catch(c){alert("Unerwarteter Fehler beim Speichern des Live-Ergebnisses: "+c.message)}finally{_s(!1),me()}}}function Ug(){v("race-sim-stage-select").addEventListener("change",e=>{const t=Number(e.target.value);d.selectedRealtimeStageId=Number.isFinite(t)?t:null,d.realtimeBootstrap&&d.realtimeBootstrap.stage.id!==d.selectedRealtimeStageId&&(d.realtimeBootstrap=null),d.realtimeError=null,ed(t,!1)})}function Bn(e){var r;const t=lt((r=e.category)==null?void 0:r.name),a=qa(t);return e.isStageRace?`<span class="badge badge-race-category" style="${a}">Etappenrennen · ${e.numberOfStages} · Etappen</span>`:`<span class="badge badge-race-category" style="${a}">Eintagesrennen</span>`}function fs(e){var s,n;const t=lt((s=e.category)==null?void 0:s.name),a=qa(t),r=((n=e.category)==null?void 0:n.name)??`Kategorie ${e.categoryId}`;return`<span class="badge badge-race-category" style="${a}">${S(r)}</span>`}function Yg(e){const t=e.stages??[];if(t.length===0)return{startDate:e.startDate,endDate:e.endDate};const a=t.map(r=>r.date).sort((r,s)=>r.localeCompare(s));return{startDate:a[0]??e.startDate,endDate:a[a.length-1]??e.endDate}}function hs(e){const{startDate:t,endDate:a}=Yg(e);return t===a?ce(t):`${ce(t)} - ${ce(a)}`}function Zg(e){return e.stageId>0}async function rr(){const[e,t]=await Promise.all([Y.getGameState(),Y.getGameStatus()]);if(!e.success){console.error(e.error);return}d.gameState=e.data??null,d.gameStatus=t.success?t.data??null:null,Jg(),Re("dashboard")&&bs()}function Jg(){var s;if(!d.gameState)return;v("meta-date").textContent=d.gameState.formattedDate,v("meta-season").textContent=`Saison ${d.gameState.season}`;const e=v("meta-race-hint"),t=v("btn-advance-day"),a=v("pending-stages-list"),r=((s=d.gameStatus)==null?void 0:s.pendingStages)??[];r.length>0?(e.textContent=`${r.length} offene Etappe${r.length===1?"":"n"} heute. Tageswechsel ist gesperrt.`,e.classList.remove("hidden"),a.innerHTML=r.map(n=>{const i=n.isStageRace?`Etappe ${n.stageNumber} · ${n.profile} · ${ce(n.date)}`:`${n.profile} · ${ce(n.date)}`,l=Zg(n)?`<button class="btn btn-ghost btn-sm" data-edit-stage-roster="${n.stageId}">Starterfeld bearbeiten</button>`:"";return`
    ...
    <tr>
      ...
      <td>${o}</td>
      <td>${r}</td>
    </tr>`}function Xg(){const e=v("dashboard-races-tbody");if(!d.gameState){e.innerHTML='<tr><td colspan="8" class="text-muted">Kein Spiel geladen.</td></tr>';return}const t=d.gameState.currentDate,a=qg(t,7),r=d.races.filter(i=>i.startDate<=t&&i.endDate>=t),s=d.races.filter(i=>i.startDate>t&&i.startDate<=a);let n="";n+=`
  ...
  `,s.length===0?n+=`
    ...
    `:n+=s.map(i=>no(i)).join(""),e.innerHTML=n}function sr(e){return`Etappe ${e.stageNumber}`}function Qg(e){if(e.length===0)return"Keine Etappen";const t=new Map;return e.forEach(a=>{t.set(a.profile,(t.get(a.profile)??0)+1)}),Array.from(t.entries()).sort((a,r)=>r[1]!==a[1]?r[1]-a[1]:a[0].localeCompare(r[0])).map(([a,r])=>`${r}x ${a}`).join(" · ")}function ef(e){return`stage-profile-badge-${e.toLowerCase().replace(/_/g,"-")}`}function nr(e){return`<span class="stage-profile-badge ${ef(e)}">${S(e)}</span>`}function ys(e,t){return`${e.name} · ${sr(t)} · ${t.profile}`}async function tf(e){var s;const t=d.stageSummariesByStageId[e];if(t)return t;const a=await Y.getStageSummary(e);if(a.success&&a.data)return d.stageSummariesByStageId[e]=a.data,d.stageSummaryErrorsByStageId&&delete d.stageSummaryErrorsByStageId[e],a.data;const r=await Y.getRealtimeSimulation(e);return r.success&&((s=r.data)!=null&&s.stageSummary)?(d.stageSummariesByStageId[e]=r.data.stageSummary,d.stageSummaryErrorsByStageId&&delete d.stageSummaryErrorsByStageId[e],r.data.stageSummary):(d.stageSummaryErrorsByStageId&&(d.stageSummaryErrorsByStageId[e]=a.error??r.error??"Etappenprofil konnte nicht geladen werden."),console.error("Stage-Summary-Laden fehlgeschlagen:",{stageId:e,stageSummaryError:a.error,realtimeFallbackError:r.error}),d.stageSummariesByStageId&&delete d.stageSummariesByStageId[e],!a.success||!a.data?null:a.data)}function af(){var c;const e=v("race-stages-title"),t=v("race-stages-meta"),a=v("race-stages-body"),r=zt(d.selectedDashboardRaceId);if(!r){e.textContent="Etappen",t.textContent="",a.innerHTML='<div class="results-empty">Rennen nicht gefunden.</div>';return}const s=r.stages??[],n=s.reduce((o,m)=>o+(m.distanceKm??0),0),i=s.reduce((o,m)=>o+(m.elevationGainMeters??0),0),l=Qg(s);if(e.textContent=r.name,t.textContent=`${hs(r)} · ${((c=r.country)==null?void 0:c.name)??`Land ${r.countryId}`} · ${r.isStageRace?`${r.numberOfStages} Etappen`:"Eintagesrennen"} · ${Kr(n)} · ${Or(i)} · ${l}`,s.length===0){a.innerHTML='<div class="results-empty">Für dieses Rennen sind keine Etappen vorhanden.</div>';return}a.innerHTML=`
    ...
    </div>`}async function Zs(e){zt(e)&&(d.selectedDashboardRaceId=e,af(),gt("raceStages"))}function rf(e){return e.races.length===0?'<div class="results-empty">Keine Rennen in diesem Programm.</div>':`
    <div class="dashboard-race-stages-table-wrap">
      <table class="data-table dashboard-race-stages-table">
        ...
        <tbody>
          ${t.map(a=>{var r,s;return`
            <tr class="race-participants-row">
              ...
              <td>${S(Js(a.rider))}</td>
              <td>${S(It(a.rider))}</td>
              <td>${un(a.rider.overallRating)}</td>
              <td>${mn(a.rider)}</td>
    ...
    </th>`}function nf(e){const t=d.raceParticipantsSort.direction==="asc"?1:-1;return[...e].sort((a,r)=>{var n,i,l,c;let s=0;switch(d.raceParticipantsSort.key){case"team":s=(((n=a.team)==null?void 0:n.name)??"").localeCompare(((i=r.team)==null?void 0:i.name)??"","de");break;case"rider":s=ze(a.rider).localeCompare(ze(r.rider),"de");break;case"spec1":s=Js(a.rider).localeCompare(Js(r.rider),"de");break;case"role":s=It(a.rider).localeCompare(It(r.rider),"de");break;case"overall":s=a.rider.overallRating-r.rider.overallRating;break;case"phase":s=(a.rider.seasonFormPhase??"neutral").localeCompare(r.rider.seasonFormPhase??"neutral","de");break;default:s=(((l=a.program)==null?void 0:l.name)??"").localeCompare(((c=r.program)==null?void 0:c.name)??"","de")}return s*t||ze(a.rider).localeCompare(ze(r.rider),"de")})}function Js(e){return e.specialization1!=null?la(e.specialization1):"–"}async function of(e=!1){const t=d.selectedRaceParticipantsRaceId;if(t==null)return;const a=zt(t);e&&(v("race-participants-meta").textContent="Lade Programmfahrer ...");const r=await Y.getRaceProgramParticipants(t);if(!r.success||!r.data){v("race-participants-meta").textContent="",v("race-participants-body").innerHTML=`<div class="results-empty">${S(r.error??"Teilnehmer konnten nicht geladen werden.")}</div>`;return}d.raceParticipants=r.data,v("race-participants-title").textContent=(a==null?void 0:a.name)??"Teilnehmer",v("race-participants-meta").textContent=`${r.data.length} Programmfahrer · ${a?hs(a):""}`,v("race-participants-body").innerHTML=sf(d.raceParticipants)}async function as(e,t=null){let a=ja(e);if(!a&&d.stageEditorStageRows){const n=d.stageEditorStageRows.find(i=>i.stageId===e);n&&(a={race:{id:n.raceId,name:n.raceName,countryId:0,categoryId:0,isStageRace:!0,numberOfStages:1,startDate:"",endDate:"",prestige:0},stage:{id:n.stageId,raceId:n.raceId,stageNumber:n.stageNumber,date:"2026-01-01",profile:n.profile,startElevation:0,detailsCsvFile:"",distanceKm:n.distanceKm,elevationGainMeters:n.elevationGainMeters}})}if(!a)return;const r=await tf(e);if(!r){alert(d.stageSummaryErrorsByStageId[e]??"Etappenprofil konnte nicht geladen werden.");return}d.selectedDashboardProfileStageId=e,v("stage-profile-title").textContent=`${a.race.name} · ${sr(a.stage)}`;const s=t!=null?` · Anstieg ${t.climbIndex}: ${t.name}${t.category!=null?` · Kat. ${t.category}`:""} · ${t.startKm.toFixed(1).replace(".",",")}-${t.endKm.toFixed(1).replace(".",",")} km · Climb Score ${t.climbScore}`:"";v("stage-profile-meta").textContent=`${ce(a.stage.date)} · ${a.stage.profile} · ${a.stage.distanceKm!=null?Kr(a.stage.distanceKm):"–"} · ${a.stage.elevationGainMeters!=null?Or(a.stage.elevationGainMeters):"–"}${s}`,Wd(v("stage-profile-view"),r,a.stage.profile,ys(a.race,a.stage),t!=null?{selectedClimbRange:{startKm:t.startKm,endKm:t.endKm}}:void 0),gt("stageProfile")}function lf(){v("pending-stages-list").addEventListener("click",e=>{const t=e.target.closest("button[data-edit-stage-roster]");if(t){const s=Number(t.dataset.editStageRoster);if(!Number.isFinite(s))return;Wg(s);return}const a=e.target.closest("button[data-live-stage]");if(a){const s=Number(a.dataset.liveStage);if(!Number.isFinite(s))return;ed(s,!0);return}const r=e.target.closest("button[data-instant-stage]");if(r){const s=Number(r.dataset.instantStage);if(!Number.isFinite(s))return;Zl(s)}}),v("dashboard-races-tbody").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-race-id]");if(!t)return;const a=Number(t.dataset.dashboardRaceId);Number.isFinite(a)&&Zs(a)}),v("race-stages-body").addEventListener("click",e=>{const t=e.target.closest("button[data-dashboard-stage-profile-id]");if(!t)return;const a=Number(t.dataset.dashboardStageProfileId);Number.isFinite(a)&&as(a)}),v("race-participants-body").addEventListener("click",e=>{const t=e.target.closest("button[data-rider-program-id]");if(t){const s=Number(t.dataset.riderProgramId);Number.isFinite(s)&&zn(s);return}const a=e.target.closest("button[data-race-participants-sort]");if(!a)return;const r=a.dataset.raceParticipantsSort;d.raceParticipantsSort.key===r?d.raceParticipantsSort.direction=d.raceParticipantsSort.direction==="asc"?"desc":"asc":d.raceParticipantsSort={key:r,direction:"asc"},of()}),v("btn-advance-day").addEventListener("click",async()=>{await ad()}),v("btn-auto-progress").addEventListener("click",()=>{df()})}async function ad(){var t,a;Te("Tag wird fortgeschrieben...");const e=(t=d.gameState)==null?void 0:t.season;try{const r=await Y.advanceDay();if(!r.success)return alert(`Tageswechsel fehlgeschlagen:
`+(r.error??"Unbekannter Fehler")),!1;if(d.currentSave&&r.data&&(d.currentSave.currentSeason=r.data.season),await rr(),await Hn(),Re("teams")){const{refreshTeamsViewData:n}=await Er(async()=>{const{refreshTeamsViewData:i}=await Promise.resolve().then(()=>Og);return{refreshTeamsViewData:i}},void 0);await n()}const s=(a=d.gameState)==null?void 0:a.season;if(e&&s&&s>e){Ya();const{startDraftPresentation:n}=await Er(async()=>{const{startDraftPresentation:l}=await Promise.resolve().then(()=>Pf);return{startDraftPresentation:l}},void 0),{activateView:i}=await Er(async()=>{const{activateView:l}=await Promise.resolve().then(()=>Rd);return{activateView:l}},void 0);i("draft"),await n(s)}return!0}catch(r){return alert("Unerwarteter Fehler beim Tageswechsel: "+r.message),!1}finally{me()}}function Gn(){const e=document.getElementById("btn-auto-progress");e&&(vt?(e.textContent="Stoppen (Leertaste)",e.classList.remove("btn-secondary"),e.classList.add("btn-danger")):(e.textContent="Auto Progress",e.classList.remove("btn-danger"),e.classList.add("btn-secondary")))}function df(){vt?Ya():rd()}function rd(){vt||(sn(!0),Gn(),cf())}function Ya(){vt&&(sn(!1),d.autoProgressTargetDate=null,Gn())}async function cf(){var e,t;for(;vt;){const a=(e=d.gameState)==null?void 0:e.currentDate;if(d.autoProgressTargetDate&&a&&a>=d.autoProgressTargetDate){Ya();break}const r=((t=d.gameStatus)==null?void 0:t.pendingStages)??[];let s=!1;if(r.length>0){const n=r[0];s=await Zl(n.stageId,!0)}else s=await ad();if(!s){Ya();break}await new Promise(n=>setTimeout(n,100))}Gn()}window.addEventListener("keydown",e=>{if((e.code==="Space"||e.key===" ")&&vt){const t=e.target;if(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable)return;e.preventDefault(),Ya()}});const Ga=50;function Kn(){return[...En,...Pn[d.riderMenuDetailPage]]}function sd(e){return d.riderMenuTableSort.key!==e?'<span class="team-table-sort-indicator">↕</span>':`<span class="team-table-sort-indicator team-table-sort-indicator-active">${d.riderMenuTableSort.direction==="asc"?"↑":"↓"}</span>`}function nd(e){if(!e.sortKey)return`<th class="${S(e.className??"")}" title="${S(e.title)}">${S(e.label)}</th>`;const t=d.riderMenuTableSort.key===e.sortKey?" team-table-sort-active":"";return`
    <th class="${S(e.className??"")}" title="${S(e.title)}">
      <button
        type="button"
        class="team-table-sort${t}"
    ...
    </div>`}function Lr(){const e=v("riders-detail"),t=Kn(),a=Wl(d.riders),r=a.length,s=Math.max(1,Math.ceil(r/Ga));d.riderMenuPage=Math.min(s,Math.max(1,d.riderMenuPage));const n=(d.riderMenuPage-1)*Ga,i=Math.min(r,n+Ga),l=a.slice(n,i);e.innerHTML=`
    <div class="team-detail-card">
      <div class="team-detail-header">
        <h3>Alle Fahrer</h3>
      </div>
    ...
    <th class="${e.className??""}">
      ...
      >
        ...
        ${gf(e.key)}
          ...
          </td>`:`<td><input type="number" class="rider-team-editor-input${a}" data-rider-team-editor-field="${t.key}" data-rider-team-editor-rider-id="${e.riderId}" value="${r}"></td>`}case"text":{const r=String(e[t.key]??"");return`<td><input type="text" class="rider-team-editor-input${a}" data-rider-team-editor-field="${t.key}" data-rider-team-editor-rider-id="${e.riderId}" value="${S(r)}"></td>`}default:return"<td>–</td>"}}function kf(e){const t=[...e.teams].sort((a,r)=>a.rank-r.rank||le(a.name,r.name));return`
            ...
            <table class="data-table data-table-teams rider-team-editor-table">
              ...
              <tbody>
                ${s.length===0?`<tr><td colspan="${wr.length}" class="text-muted">${d.riderTeamEditorSelectedTeamKey?"Keine Fahrer im aktuellen Team.":"Bitte zuerst ein Team im Dropdown auswählen."}</td></tr>`:s.map(c=>`
                    <tr class="team-detail-row${ld(c.riderId)?" rider-team-editor-row-dirty":""}">
                      ${wr.map(o=>Sf(c,o)).join("")}
                    </tr>
                  `).join("")}
              </tbody>
            </table>
...
`+a.error);return}d.draftHistory=a.data??null,Re("draft")&&rs()}function rs(){var n,i;const e=v("draft-table-container"),t=v("draft-season-select"),a=document.querySelector("#view-draft .results-toolbar");if(!d.currentSave){e.innerHTML='<div class="alert alert-info">Kein Spiel geladen.</div>';return}if(((n=d.gameState)==null?void 0:n.draftStatus)==="active"){a&&a.classList.add("hidden");const l=d.gameState.draftSeason||((i=d.currentSave)==null?void 0:i.currentSeason)||2026;e.innerHTML=`
  ...
  `;for(const l of r){const c=d.draftHistory.season-l.riderBirthYear;let o="-";l.oldTeamName&&(o=`
    ...
    `}s+="</tbody></table>",e.innerHTML=s}function md(){v("draft-table-container").addEventListener("click",a=>{const r=a.target.closest("button[data-draft-sort]");if(r){const s=r.dataset.draftSort;s&&(nt.key===s?nt.asc=!nt.asc:(nt.key=s,nt.asc=!0),rs())}});const t=v("draft-replay-btn");t&&t.addEventListener("click",()=>{const a=v("draft-season-select");if(a){const r=Number(a.value);isNaN(r)||Wn(r)}})}function Ca(){d.draftOverlayTimer1&&(clearTimeout(d.draftOverlayTimer1),d.draftOverlayTimer1=null),d.draftOverlayTimer2&&(clearTimeout(d.draftOverlayTimer2),d.draftOverlayTimer2=null)}function Rf(e,t,a){const r=d.teams.find(c=>c.id===e),s=(r==null?void 0:r.division)==="U23"?20:(r==null?void 0:r.division)==="ProTour"?30:40,n=d.riders.filter(c=>c.activeTeamId===e).length,i=a.slice(t+1).filter(c=>c.teamId===e).length,l=n-i;return Math.max(0,s-l)}function $t(e,t,a=50){var n;const r=e==null||e<=0?"Freier Fahrer":t??((n=d.teams.find(i=>i.id===e))==null?void 0:n.name)??`Team ${e}`,s=e==null||e<=0?"/jersey/Jer_placeholder.svg":`/jersey-large/Jer_${e}.png`;return`
  ...
  `}function pd(e){var n;const a=(d.draftSelectedSeason??((n=d.currentSave)==null?void 0:n.currentSeason)??2026)-e.riderBirthYear,r=fa(e.riderSpecialization)||"Allrounder";let s="";return e.oldTeamId===e.teamId?s=`
  ...
  `}function If(e){let t=document.getElementById("draft-overlay");return t||(t=document.createElement("div"),t.id="draft-overlay",t.style.cssText=`
  ...
  `,t.addEventListener("click",a=>{var i,l;const r=a.target;if(r.id==="draft-overlay-quick-btn"){((i=d.gameState)==null?void 0:i.draftStatus)==="active"?confirm("Möchtest du den Draft wirklich abkürzen? Die KI wird alle restlichen Runden automatisch für dein Team und alle anderen simulieren.")&&Ef():wa();return}if(r.id==="draft-overlay-finish-btn"){(async()=>(Te("Spielstand wird aktualisiert..."),await rr(),wa(),me()))();return}if(r.id==="draft-overlay-confirm-btn"){const c=Number(r.dataset.riderId);isNaN(c)||Ff(c);return}const s=r.closest(".draft-candidate-clickable");if(s){const c=Number(s.dataset.riderId);d.selectedDraftRiderId=c,Ma();return}if(r.id==="draft-overlay-pause-btn"){d.draftPaused=!d.draftPaused,r.textContent=d.draftPaused?"Weiter":"Pause",r.classList.toggle("btn-primary",d.draftPaused),ha();return}const n=r.closest(".draft-speed-btn");if(n){const c=parseFloat(n.dataset.speed||"1");d.draftSpeedMultiplier=c,t.querySelectorAll(".draft-speed-btn").forEach(o=>{o.classList.remove("draft-speed-btn-active"),o.style.color="",o.style.fontWeight=""}),n.classList.add("draft-speed-btn-active"),n.style.color="var(--accent, #38bdf8)",n.style.fontWeight="bold",ha();return}if(r.id==="draft-overlay-prev-btn"||r.closest("#draft-overlay-prev-btn")){if(d.draftOverlayCurrentIndex>0){const c=document.getElementById("draft-overlay-auto-checkbox");c&&(c.checked=!1,d.draftOverlayAuto=!1),Ta(d.draftOverlayCurrentIndex-1)}return}if(r.id==="draft-overlay-next-btn"||r.closest("#draft-overlay-next-btn")){if(d.draftOverlayPicks&&d.draftOverlayCurrentIndex+1<d.draftOverlayPicks.length){const c=document.getElementById("draft-overlay-auto-checkbox");c&&(c.checked=!1,d.draftOverlayAuto=!1),Ta(d.draftOverlayCurrentIndex+1)}else if(d.draftOverlayPicks&&d.draftOverlayCurrentIndex+1===d.draftOverlayPicks.length&&((l=d.gameState)==null?void 0:l.draftStatus)==="active"){const c=document.getElementById("draft-overlay-auto-checkbox");c&&(c.checked=!1,d.draftOverlayAuto=!1),d.draftOverlayCurrentIndex=d.draftOverlayCurrentIndex+1,Ma()}return}}),t.addEventListener("change",a=>{const r=a.target;r.id==="draft-overlay-auto-checkbox"&&(d.draftOverlayAuto=r.checked,d.draftOverlayAuto?ha():Ca())}),t)}function ha(){if(Ca(),d.draftPaused)return;const e=d.draftSpeedMultiplier,t=d.draftOverlayCurrentIndex;if(d.draftRevealShown){if(d.draftOverlayAuto){const a=3e3/e;d.draftOverlayTimer2=window.setTimeout(()=>{var s;const r=t+1;if(r<d.draftOverlayPicks.length)Ta(r);else if(((s=d.gameState)==null?void 0:s.draftStatus)==="active"){d.draftOverlayAuto=!1;const n=document.getElementById("draft-overlay-auto-checkbox");n&&(n.checked=!1),d.draftOverlayCurrentIndex=r,Ma()}else wa()},a)}}else{const a=2e3/e;d.draftOverlayTimer1=window.setTimeout(()=>{jn()},a)}}function jn(){const e=d.draftOverlayCurrentIndex,t=d.draftOverlayPicks[e];d.draftRevealShown=!0;const a=xa(t.teamId,e,!1),r=xa(t.teamId,e,!0),s=Za(a),n=Za(r),i=document.getElementById("draft-overlay-specs-header");i&&(i.innerHTML=On(t.teamId,s,n,!0));const l=document.getElementById("draft-overlay-pick-display");if(l){const c=[...r].sort((k,T)=>T.overallRating-k.overallRating),o=c.slice(0,10),m=o.some(k=>k.id===t.riderId),p=c.findIndex(k=>k.id===t.riderId)+1;let u=o.map((k,T)=>ga(k,T+1,e,t.riderId,t.teamId)).join("");if(!m){const k=c.find(T=>T.id===t.riderId);k&&(u+=`
    ...
    `}ha()}function Qs(e){const t=[...e].sort((i,l)=>l.overallRating-i.overallRating),a=t.length;if(a<=1)return t;const r=3,s=Math.ceil(a/r),n=[];for(let i=0;i<s;i++)for(let l=0;l<r;l++){const c=l*s+i;c<a&&n.push(t[c])}return n}function Ta(e){if(!d.draftOverlayPicks||e<0||e>=d.draftOverlayPicks.length)return;Ca(),d.draftOverlayCurrentIndex=e,d.draftRevealShown=!1;const t=d.draftOverlayPicks[e];if(!document.getElementById("draft-overlay"))return;const r=document.getElementById("draft-overlay-round-title");r&&(r.textContent=`Runde ${t.draftRound} - Pick #${t.pickNumber}`);const s=document.getElementById("draft-overlay-team-subtitle");s&&(s.textContent=t.teamName);const n=document.getElementById("draft-overlay-team-jersey-wrap");n&&(n.innerHTML=$t(t.teamId,t.teamName,72));const i=document.getElementById("draft-overlay-progress-label");i&&(i.textContent=`${e+1} / ${d.draftOverlayPicks.length}`);const l=xa(t.teamId,e,!1),c=Za(l),o=document.getElementById("draft-overlay-specs-header");o&&(o.innerHTML=On(t.teamId,c,c,!1));const m=document.getElementById("draft-overlay-prev-btn");m&&(m.disabled=e===0);const p=document.getElementById("draft-overlay-next-btn");p&&(p.disabled=e===d.draftOverlayPicks.length-1);const u=Qs(t.candidates),f=document.getElementById("draft-overlay-candidates-list");f&&(f.innerHTML=u.map(h=>{const b=h.riderId===t.riderId;return Xs(h,b,t.teamId)}).join(""));const g=document.getElementById("draft-overlay-pick-display");g&&(g.innerHTML=`
...
`+t.error);return}d.injuries=t.data??[],Re("injuries")&&oo()}function oo(){const e=v("injuries-table-container");if(!d.injuries){e.innerHTML='<div class="alert alert-info">Lade Daten...</div>';return}if(v("injuries-meta").textContent=d.injuries.length+" Ausfälle",d.injuries.length===0){e.innerHTML='<div class="alert alert-info">Aktuell gibt es keine kranken oder verletzten Fahrer.</div>';return}window.openRiderStatsFromInjuries=$a;let t="";const a=d.injuries.filter(n=>n.teamId!=null&&n.teamDivisionTier===1),r=new Map;for(const n of a){const i=n.teamId;r.has(i)||r.set(i,[]),r.get(i).push(n)}for(const n of r.keys())r.get(n).sort((i,l)=>l.overallRating-i.overallRating);const s=Array.from(r.keys()).sort((n,i)=>{const l=r.get(n)[0].teamAbbreviation||"",c=r.get(i)[0].teamAbbreviation||"";return l.localeCompare(c)});if(s.length===0)t+='<div class="alert alert-info">Keine verletzten Fahrer in Division 1 Teams.</div>';else for(const n of s){const i=r.get(n),l=i[0].teamAbbreviation;t+=`
      ...
      `;for(const c of i){const o=c.healthStatus==="injured"?'<span class="badge badge-error">Verletzung 🤕</span>':'<span class="badge badge-warning">Krankheit 🤒</span>';let m="";if(c.fitDate){const p=ce(c.fitDate);if(c.missedRaces&&c.missedRaces.length>0){let u="";for(const f of c.missedRaces)u+=`
          ...
          <tr>
            ...
            <td>${c.age}</td>
            <td><span class="rider-stats-icon-pill" style="padding:0; border:none; background:none;">${El(c.overallRating)}</span></td>
            <td>${o}</td>
            <td><strong>${c.unavailableDays} Tage</strong></td>
            <td>${m}</td>
          </tr>
        `}t+="</tbody></table></div>"}e.innerHTML=t}function lo(e){return e===0?"–":`-${e}`}function Lf(e){return e.length===0?'<div class="season-standings-country-popover-empty">Noch keine Fahrer mit Saisonpunkten.</div>':`
    ...
    </div>`}async function gd(e){const t=d.seasonStandingsSelectedSeason??void 0,a=await Y.getSeasonStandings(t);if(!a.success){d.seasonStandings=null,Re("season-standings")&&en(),!e&&a.error&&alert(`Saisonwertung konnte nicht geladen werden:
`+a.error);return}d.seasonStandings=a.data??null,Re("season-standings")&&en()}function en(){var h,b,y,k,T,x,$,P;const e=v("season-standings-meta"),t=v("season-standings-scope-tabs"),a=v("season-standings-empty"),r=v("season-standings-table"),s=v("season-standings-tbody"),n=v("season-standings-jersey-header"),i=v("season-standings-primary-header"),l=v("season-standings-flag-header"),c=v("season-standings-secondary-header"),o=((h=d.seasonStandings)==null?void 0:h.season)??((b=d.gameState)==null?void 0:b.season)??((y=d.currentSave)==null?void 0:y.currentSeason)??null;e.textContent=o!=null?`Saison ${o} · Ergebnis- und Trikotpunkte kumuliert`:"Noch keine Saisonwertung geladen.";const m=v("season-standings-year-select");if(m){const E=((k=d.seasonStandings)==null?void 0:k.availableSeasons)||[],R=d.seasonStandingsSelectedSeason??((T=d.gameState)==null?void 0:T.season)??2026;m.innerHTML=E.map(I=>`
...
Zugelassene Programme: ${q}">
  ...
  `}function vd(e){return st!==e?'<span style="opacity:0.35; margin-left:4px;">↕</span>':`<span style="color:var(--accent-h); margin-left:4px; font-weight:bold;">${Ka?"↑":"↓"}</span>`}function kt(e,t,a=""){return`
