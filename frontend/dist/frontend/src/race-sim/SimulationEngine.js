...
function normalizeMarkerClassificationEntries(entries, applyTimeTieGroups) {
...
function orderRoadRiders(riders) {
...
export class SimulationEngine {
    ...
    logFinishSprintTieBreakIfNeeded() {
        ...
        console.log(`[FinishSprintTieBreak] Sortierung: erst Zielzeit, dann Photo-Finish-Score absteigend, dann Fahrer-ID aufsteigend als letzter Tiebreak.`);
        orderedFirstFinishGroup.forEach((rider, index) => {
            ...
            console.log(`#${index + 1} Zielsprint | ${rider.riderName} | Zeit ${timeLabel} | Score ${rider.photoFinishScore.toFixed(2)} | ID-Tiebreak ${rider.rider.id} | (${breakdown})`);
        });
        console.groupEnd();
    }
    ...
    applyIncident(rider, incident, eventTimeSeconds) {
