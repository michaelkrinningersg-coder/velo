 ...
 */
export async function runInstantSimulation(bootstrap, onProgress) {
    const engine = new SimulationEngine(bootstrap, { maxSubstepSeconds: 5, isInstantSimulation: true });
