...
function renderSingleMessageJersey(teamId, className = 'race-sim-message-jersey') {
    return `
...
function renderSecondaryMessageRiderName(riderName, riderTeamId) {
...
export function renderRaceMessages(container, messages, activeFilter = 'all') {
