import { api } from '../api';
import { $, esc, state, showModal, hideModal, showLoading, hideLoading, showError, hideError, showInstantProgress, updateInstantProgress, renderFlag, raceSimView, setRaceSimView, setRealtimeCompletionInFlight, realtimeCompletionInFlight, setInstantStageInFlightId, instantStageInFlightId, setRealtimeStageLoadInFlightId, realtimeStageLoadInFlightId, activateView, } from '../state';
...
export async function completeRealtimeStage(stageId, entries, markerClassifications, incidents, events, skipViewActivation = false) {
