import { api } from '../api';
import { $, esc, state, formatDate, showLoading, hideLoading, showModal, hideModal, showError, hideError, } from '../state';
...
export async function onLoadSave(filename) {
...
export async function onDeleteSave(filename, name) {
...
export async function onDeleteAllSaves() {
    const res = await api.listSaves();
...
export function initSavegameListeners() {
