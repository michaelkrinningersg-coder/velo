import { api } from '../api';
import { $, esc, state, clamp, getSkillColor, downloadTextFile, } from '../state';
import { compareStrings } from './teams';
export const RIDER_TEAM_EDITOR_COLUMNS = [
...
export function resolveRiderTeamEditorTeamKey(teamId) {
    return teamId == null ? 'free-agents' : String(teamId);
}
export function getRiderTeamEditorTeamName(teamId) {
...
export function calculateEditorOverall(rider) {
...
export function getDefaultRiderTeamEditorSortDirection(sortKey) {
    return [
        'riderId',
        'countryId',
        'birthYear',
...
export function getRiderTeamEditorSortIndicator(sortKey) {
...
export function renderRiderTeamEditorHeader(column) {
...
export function compareRiderTeamEditorRows(left, right) {
...
export function sortRiderTeamEditorRows(rows) {
...
export function getFilteredRiderTeamEditorRows(payload) {
...
export function renderRiderTeamEditorTeamOptions(teamId) {
    const payload = state.riderTeamEditorPayload;
    if (!payload) {
...
export function isDirtyRiderTeamEditorRow(riderId) {
    return state.riderTeamEditorDirtyRiderIds.includes(riderId);
}
export function renderRiderTeamEditorCell(rider, column) {
...
export function renderRiderTeamEditorSidebar(payload) {
...
export function renderRiderTeamEditor() {
...
export function rebuildRiderTeamEditorTeams(payload) {
...
export async function loadRiderTeamEditorData(force = false) {
...
export function updateRiderTeamEditorField(riderId, field, rawValue) {
    const payload = state.riderTeamEditorPayload;
    if (!payload) {
        return;
    }
...
export async function saveRiderTeamEditorData() {
...
export async function exportRiderTeamEditorData() {
...
export function initRiderTeamEditorListeners() {
    ...
    $('view-rider-team-editor').addEventListener('change', (event) => {
        ...
        const input = event.target.closest('.rider-team-editor-input');
        if (input) {
            const riderId = Number(input.dataset['riderTeamEditorRiderId']);
            const field = input.dataset['riderTeamEditorField'];
