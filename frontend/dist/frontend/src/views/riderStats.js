import { api } from '../api';
import { $, esc, state, formatDate, formatRaceTime, renderFlag, renderMiniJersey, findRiderById, showModal, resolveRaceCategoryBadgeStyle, buildRaceCategoryBadgeCssVariables, formatNonFinisherReason, renderSeasonFormPhaseIndicator, } from '../state';
import { formatRaceDateRange, renderStageProfileBadge, raceCategoryNameBadge } from './dashboard';
    ...
    <section class="rider-stats-career" style="margin-top: 1.5rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-auto-rows: 1fr; gap: 1.25rem;">
        ...
        return `
            ...
            : 'background: linear-gradient(135deg, #fef08a, #facc15); color: #854d0e; border: 1px solid #f59e0b; box-shadow: 0 0 4px rgba(250, 204, 21, 0.4);'}" title="Tage im Führungstrikot (P1 GC)">
