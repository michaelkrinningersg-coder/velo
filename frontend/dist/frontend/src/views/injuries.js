import { api } from '../api';
import { $, esc, state, renderFlag, isActiveView, formatDate, } from '../state';
import { renderRiderStatsCategoryBadge, renderRiderOverallRatingBadge, openRiderStats } from './riderStats';
export let currentInjuriesSort = { key: 'unavailableDays', asc: false };
export async function loadInjuries(silent = false) {
...
export let currentInjuriesTab = 'all';
export function renderInjuriesView() {
    ...
    window.openRiderStatsFromInjuries = openRiderStats;
    let html = '';
