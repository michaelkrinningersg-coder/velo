...
function joinClassNames(...classNames) {
    return classNames.filter((className) => Boolean(className && className.trim())).join(' ');
}
export function resolveRaceCategoryBadgeStyle(categoryName) {
...
export function buildRaceCategoryBadgeCssVariables(style) {
...
export function renderRiderNameLink(name, options = {}) {
...
export function renderTeamNameLink(name, teamId, strong = true, extraClass = '') {
