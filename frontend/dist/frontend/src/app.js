...
import { loadDraftHistory, initDraftListeners, } from './views/draft';
...
import { initializeStageEditorForm, renderStageEditor, loadStageEditorExistingStages, loadStageEditorOverview, initStageEditorListeners, } from './views/stageEditor';
import { openRiderStats, initRiderStatsListeners, } from './views/riderStats';
import { openTeamStats, initTeamStatsListeners, } from './views/teamStats';
import { initLeaderboardsView, showLeaderboardsView, } from './views/leaderboards';
import { initCalendarView, showCalendarView, } from './views/calendar';
import { initRaceProgramsView, loadRaceProgramsData, } from './views/racePrograms';
...
function initAppListeners() {
    ...
    document.body.addEventListener('click', (event) => {
        const teamButton = event.target.closest('button.app-team-link[data-team-id]');
        if (!teamButton) {
            return;
        }
